...
class ExtensionCommandsLoader(AzCommandsLoader):
    ...
    def load_arguments(self, command):
        ...
        with self.argument_context('extension') as c:
            ...
            c.argument('install_setup_extras', options_list=['--install-setup-extras', '--setup-extras'], nargs='+',
                       help='Space-separated list of extras to install as defined by the extension setup. Each value should be a keyword defined in the extension metadata extras.', arg_group='Experimental Pip')
