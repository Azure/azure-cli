...
class ActionGroupIdentityAssign(_ActionGroupUpdate):
    """Add managed identities to an existing action group.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        args_schema.incident_receivers._registered = False
        args_schema.group_short_name._registered = False
...
class ActionGroupIdentityRemove(_ActionGroupUpdate):
    """Remove managed identities from an existing action group.
...
class ActionGroupIdentityShow(_ActionGroupShow):
