...
examples:
  ...
  - name: Create a Key Vault certificate. (autogenerated)
    text: "az keyvault certificate create --name cert1 \\\n  --policy \"$(az keyvault certificate get-default-policy)\" --vault-name vaultname"
    crafted: true
"""
...
examples:
  ...
  - name: Download the public portion of a Key Vault certificate. (autogenerated)
    text: "az keyvault certificate download --file cert.pem && \\\nopenssl x509 --name cert-name --vault-name vault"
    crafted: true
"""
...
examples:
  - name: Create a service principal with a certificate, add the certificate to Key Vault and provision a VM with that certificate.
    text: |-
        ...
        az vm create -g group-name -n vm-name --admin-username deploy  \\
          --image debian --secrets "$vm_secrets"
  - name: Import a certificate into KeyVault. (autogenerated)
    text: "az keyvault certificate import --file cert_file\n\nsecrets=$( --name vaultname --vault-name vaultname"
    crafted: true
"""
