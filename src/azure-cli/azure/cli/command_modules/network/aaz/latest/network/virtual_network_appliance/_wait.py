...
@register_command(
    "network virtual-network-appliance wait",
)
class Wait(AAZWaitCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VirtualNetworkAppliancesGet(ctx=self.ctx)()
    ...
    class VirtualNetworkAppliancesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_common_subnet_read(properties.subnet)
