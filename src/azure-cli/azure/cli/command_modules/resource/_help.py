...
examples:
  ...
  - name: Create a resource policy assignment with a system assigned identity.
    text: >
        az policy assignment create --name myPolicy --policy {PolicyName} --assign-identity [system] --location eastus
  - name: Create a resource policy assignment with a system assigned identity. The identity will have 'Contributor' role access to the subscription.
    text: >
        az policy assignment create --name myPolicy --policy {PolicyName} --assign-identity [system] --identity-scope /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx --role Contributor --location eastus
  - name: Create a resource policy assignment with a user assigned identity.
    text: >
        az policy assignment create --name myPolicy --policy {PolicyName} -g MyResourceGroup --assign-identity myAssignedId --location westus
...
examples:
  ...
  - name: Add a system assigned managed identity to a policy assignment and grant it the 'Contributor' role for the current resource group.
    text: >
        az policy assignment identity assign --identity [system] -g MyResourceGroup -n MyPolicyAssignment --role Contributor --identity-scope /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/MyResourceGroup
  - name: Add a user assigned managed identity to a policy assignment.
    text: >
        az policy assignment identity assign --identity MyAssignedId -g MyResourceGroup -n MyPolicyAssignment
"""
