...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr cache') as c:
        ...
        c.argument('source_repo', options_list=['--source-repo', '-s'], help='The source repository namespace.')
        c.argument('target_repo', options_list=['--target-repo', '-t'], help='The target repository namespace.')
