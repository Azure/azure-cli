...
cli_command(__name__, 'ad group list',
            ...
            get_graph_client_groups)
cli_command(__name__, 'ad group get-member-groups',
...
cli_command(__name__, 'ad group member list',
            ...
            get_graph_client_groups)
cli_command(__name__, 'ad group member add', 'azure.graphrbac.operations.groups_operations#GroupsOperations.add_member',
            get_graph_client_groups)
cli_command(__name__, 'ad group member remove', 'azure.graphrbac.operations.groups_operations#GroupsOperations.remove_member',
            get_graph_client_groups)
