...
examples:
  ...
  - name: Create a managed application. (autogenerated)
    text: |
        az managedapp create --kind MarketPlace --location westcentralus --managed-rg-id "/subscriptions/{SubID}/resourceGroups/{ManagedResourceGroup}" --managedapp-definition-id "/subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Solutions/applianceDefinitions/{ApplianceDefinition}" --name MyManagedApp --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a policy set definition. (autogenerated)
    text: az policy set-definition delete --management-group 'MyManagementGroup' --name MyPolicySetDefinition
    crafted: true
"""
