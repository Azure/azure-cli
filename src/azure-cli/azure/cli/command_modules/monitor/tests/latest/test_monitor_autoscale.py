...
class TestMonitorAutoscaleScenario(ScenarioTest):
    ...
    def test_monitor_autoscale_rule_with_dimensions(self, resource_group):
        ...
        self.cmd(
            'vmss create -g {rg} -n {vmss} --image Canonical:UbuntuServer:18.04-LTS:latest --admin-username testadmin --admin-password TestTest12#$ --instance-count 2')
        self.kwargs['vmss_id'] = self.cmd('vmss show -g {rg} -n {vmss}').get_output_in_json()['id']
    ...
    def test_monitor_autoscale_recurring(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --image Canonical:UbuntuServer:18.04-LTS:latest --admin-username testname --admin-password TestTest12#$')
        self.kwargs['vmss_id'] = self.cmd('vmss show -g {rg} -n {vmss}').get_output_in_json()['id']
    ...
    def test_monitor_autoscale_predictive_policy(self, resource_group):
        ...
        self.cmd(
            'vmss create -g {rg} -n {vmss} --image Canonical:UbuntuServer:18.04-LTS:latest --admin-username testadmin --admin-password TestTest12#$')
        self.kwargs['vmss_id'] = self.cmd('vmss show -g {rg} -n {vmss}').get_output_in_json()['id']
