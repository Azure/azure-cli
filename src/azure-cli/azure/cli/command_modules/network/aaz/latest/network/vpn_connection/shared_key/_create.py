...
@register_command(
    "network vpn-connection shared-key create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.id = AAZResourceIdArg(
            ...
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/connections/{}/sharedkey",
            ),
        )
    ...
    class VirtualNetworkGatewayConnectionsSetSharedKey(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _schema_on_200_201.value = AAZStrType(
                flags={"required": True},
            )
