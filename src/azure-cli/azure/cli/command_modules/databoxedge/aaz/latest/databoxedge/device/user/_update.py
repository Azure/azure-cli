...
@register_command(
    "databoxedge device user update",
)
...
class _UpdateHelper:
    ...
    def _build_schema_user_read(cls, _schema):
        ...
        encrypted_password = _schema_user_read.properties.encrypted_password
        ...
        share_access_rights = _schema_user_read.properties.share_access_rights
        share_access_rights.Element = AAZObjectType()

        _element = _schema_user_read.properties.share_access_rights.Element
