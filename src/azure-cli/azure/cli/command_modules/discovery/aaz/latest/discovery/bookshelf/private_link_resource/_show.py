...
@register_command(
    "discovery bookshelf private-link-resource show",
)
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BookshelfPrivateLinkResourcesGet(ctx=self.ctx)()
    ...
    class BookshelfPrivateLinkResourcesGet(AAZHttpOperation):
