...
class VirtualMachineScheduleOperations(object):
    """VirtualMachineScheduleOperations operations.
    ...
    def list(
            self, resource_group_name, lab_name, virtual_machine_name, expand=None, filter=None, top=None, order_by=None, custom_headers=None, raw=False, **operation_config):
