...
class ContainerappIngressTests(ScenarioTest):
    ...
    def test_containerapp_custom_domains_app_in_different_rg(self, resource_group, laworkspace_customer_id, laworkspace_shared_key):
        ...
        testpassword = 'test12'
        cert_id = self.cmd('containerapp ssl upload -n {} -g {} --environment {} --hostname {} --certificate-file "{}" --password {}'.format(ca_name, app_rg_name, env_id, hostname_1, pfx_file, testpassword), checks=[
