...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        nsg.network_interfaces = AAZListArg(
        ...
        network_interfaces = cls._args_schema.nsg.network_interfaces
        ...
        subnets = cls._args_schema.nsg.subnets
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if network_interfaces is not None:
                _UpdateHelper._build_schema_network_interface_update(network_interfaces.set_elements(AAZObjectType, "."))
            ...
            if subnets is not None:
                _UpdateHelper._build_schema_subnet_update(subnets.set_elements(AAZObjectType, "."))
