...
examples:
  - name: Show the details of a Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb cassandra keyspace show --account-name MyAccount --name MyKeyspace --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb cassandra keyspace throughput show --account-name MyAccount --name MyKeyspace --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: |
        az cosmosdb cassandra table create --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --schema @indexes-file.json --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete the Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: |
        az cosmosdb cassandra table delete --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: |
        az cosmosdb cassandra table show --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Creates an Azure Cosmos DB database (autogenerated)
    text: |
        az cosmosdb database create --db-name MyDatabase --name MyCosmosDBDatabaseAccount --resource-group-name MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb gremlin database create --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb gremlin database delete --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the Gremlin databases under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb gremlin database list --account-name MyAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb gremlin database show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb gremlin database throughput show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: |
        az cosmosdb gremlin graph delete --account-name MyAccount --database-name MyDatabase --name MyGraph --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the Gremlin graphs under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: |
        az cosmosdb gremlin graph list --account-name MyAccount --database-name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: |
        az cosmosdb gremlin graph show --account-name MyAccount --database-name MyDatabase --name MyGraph --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the read-only access keys for a Azure Cosmos DB database account. (autogenerated)
    text: |
        az cosmosdb list-read-only-keys --name MyCosmosDBDatabaseAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete the MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: |
        az cosmosdb mongodb collection delete --account-name MyAccount --database-name MyDatabase --name MyCollection --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the MongoDB collections under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: |
        az cosmosdb mongodb collection list --account-name MyAccount --database-name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: |
        az cosmosdb mongodb collection show --account-name MyAccount --database-name MyDatabase --name MyCollection --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the throughput of the MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: |
        az cosmosdb mongodb collection throughput show --account-name MyAccount --database-name MyDatabase --name MyCollection --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: |
        az cosmosdb mongodb collection update --account-name MyAccount --database-name MyDatabase --idx @indexes-file.json --name MyCollection --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb mongodb database create --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb mongodb database show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the throughput of the MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb mongodb database throughput show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: |
        az cosmosdb sql container delete --account-name MyAccount --database-name MyDatabase --name MyContainer --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List the SQL containers under an Azure Cosmos DB SQL database. (autogenerated)
    text: |
        az cosmosdb sql container list --account-name MyAccount --database-name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: |
        az cosmosdb sql container show --account-name MyAccount --database-name MyDatabase --name MyContainer --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the throughput of the SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: |
        az cosmosdb sql container throughput show --account-name MyAccount --database-name MyDatabase --name MyContainer --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: |
        az cosmosdb sql container update --account-name MyAccount --database-name MyDatabase --name MyContainer --resource-group MyResourceGroup --ttl 1000
    crafted: true
"""
...
examples:
  - name: Create an SQL database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb sql database create --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the SQL database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb sql database delete --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a SQL database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb sql database show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the throughput of the SQL database under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb sql database throughput show --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an Table under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb table create --account-name MyAccount --name MyTable --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the Table under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb table delete --account-name MyAccount --name MyTable --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the Tables under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb table list --account-name MyAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a Table under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb table show --account-name MyAccount --name MyTable --resource-group MyResourceGroup
    crafted: true
"""
