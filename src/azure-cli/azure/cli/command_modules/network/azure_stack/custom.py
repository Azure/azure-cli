...
def create_ag_waf_policy(cmd, resource_group_name, policy_name,
    ...
    from azure.cli.command_modules.network.aaz.latest.network.application_gateway.waf_policy import Create
...
def add_waf_managed_rule_set(cmd, resource_group_name, policy_name,
    ...
    from azure.cli.command_modules.network.aaz.latest.network.application_gateway.waf_policy import Update
...
def list_waf_managed_rule_set(cmd, resource_group_name, policy_name):
    from azure.cli.command_modules.network.aaz.latest.network.application_gateway.waf_policy import Show
