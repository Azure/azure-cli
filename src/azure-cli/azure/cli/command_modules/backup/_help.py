...
examples:
  - name: Move a particular recovery point of a backed up item. (autogenerated)
    text: az backup recoverypoint move --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault --rp-name RpId --source-tier SourceTier --destination-tier DestinationTier
    crafted: true
"""
