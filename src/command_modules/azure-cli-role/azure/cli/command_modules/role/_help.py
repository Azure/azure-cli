...
"examples":
-   "name": |-
        remove an AAD graph permission
    "text": |-
...
-   "name": |-
    ...
    "text": |-
        az ad group show --output json --group <group> --query [0]
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az ad group member add --group <group> --member-id <member-id>
    "crafted": |-
        True
-   "name": |-
...
-   "name": |-
    ...
    "text": |-
        az ad user create --output json --password <password> --user-principal-name MyUserPrincipal --display-name MyDisplay
    "crafted": |-
        True
-   "name": |-
        Delete a user.
    "text": |-
        az ad user delete --upn-or-object-id <upn-or-object-id>
    "crafted": |-
        True
-   "name": |-
        Gets user information from the directory.
    "text": |-
        az ad user show --upn-or-object-id <upn-or-object-id>
    "crafted": |-
        True
"""
