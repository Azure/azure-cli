...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="The name of the load balancing rule.",
            required=True,
        )

        # define Arg Group "Parameters.properties.loadBalancingRules[]"
        ...
        _args_schema.load_distribution = AAZStrArg(
        ...
        _args_schema.probe_name = AAZStrArg(
            options=["--probe", "--probe-name"],
            arg_group="Properties",
            help="The ID or Name of an existing probe to associate with this rule.",
        )
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.loadBalancingRules
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if probe is not None:
                probe.set_prop("id", AAZStrType, ".probe_name")
