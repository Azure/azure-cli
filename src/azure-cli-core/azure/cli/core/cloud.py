...
AZURE_BLEU_CLOUD = Cloud(
    ...
    endpoints=CloudEndpoints(
        ...
        active_directory_data_lake_resource_id='https://datalake.sovcloud.fr/',
        ...
        app_insights_resource_id='https://api.applicationinsights.sovcloud-api.fr',
        log_analytics_resource_id='https://api.loganalytics.sovcloud-api.fr',
        app_insights_telemetry_channel_resource_id='https://dc.applicationinsights.sovcloud-api.fr/v2/track',
        synapse_analytics_resource_id='https://dev.azuresynapse.sovcloud-api.fr',
        attestation_resource_id='https://attest.sovcloud-api.fr',
    ...
    suffixes=CloudSuffixes(
        ...
        azure_datalake_store_file_system_endpoint='azuredatalakestore.sovcloud-api.fr',
