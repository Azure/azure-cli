...
@register_command(
    "network application-gateway redirect-config list",
)
class List(AAZCommand):
    """List redirect configurations.

    :example: List redirect configurations.
    ...
    _aaz_info = {
        "version": "2025-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2025-07-01", "properties.redirectConfigurations"],
        ]
    }
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.redirectConfigurations

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.redirectConfigurations = value
            return
