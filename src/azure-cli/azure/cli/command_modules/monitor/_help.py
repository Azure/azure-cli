...
type: command
short-summary: Retrieve a list of all log profiles in your Azure account.
long-summary: Log profiles define and manage settings and destinations for your activity logs, providing insights into operations performed within your Azure resources.
examples:
  - name: List all log profiles
    text: az monitor log-profiles list
  - name: List log profiles with output formatted as table
...
helps['monitor log-profiles show'] = """
type: command
short-summary: Retrieve a specific log profile from Azure Monitor.
parameters:
  - name: --name | -n
    short-summary: Specifies the name of the log profile to be retrieved.
examples:
  - name: Retrieve a log profile by name
    text: az monitor log-profiles show --name MyLogProfile
  - name: Retrieve a log profile using short option
    text: az monitor log-profiles show -n MyLogProfile
"""

helps['monitor diagnostic-settings subscription list'] = """
type: command
short-summary: Retrieves the list of active diagnostic settings for a specified subscription ID.
parameters:
  - name: --subscription-id
    short-summary: The unique identifier of the Azure subscription for which you want to list the diagnostic settings.
examples:
  ...
  - name: Using Environment Variable for Subscription ID
    text: |
        az monitor diagnostic-settings subscription list --subscription-id $AZURE_SUBSCRIPTION_ID
"""

helps['monitor diagnostic-settings subscription show'] = """
type: command
short-summary: Retrieve the active diagnostic settings for a subscription-level resource.
parameters:
  - name: --name | -n
    short-summary: Specify the name of the diagnostic setting to retrieve.
examples:
  - name: Show the diagnostic settings for a subscription resource
    text: |
        az monitor diagnostic-settings subscription show --name MyDiagnosticSetting
  - name: Using the short-form parameter
    text: |
...
type: command
short-summary: Retrieve a list of event categories supported in the Azure Activity Logs Service.
parameters:
  - name: --change-reference
    short-summary: Specify the related change reference ID for this resource operation.
  - name: --acquire-policy-token
    short-summary: Use to automatically acquire an Azure Policy token for this resource operation.
examples:
  - name: Basic Use
    text: az monitor activity-log list-categories
  - name: Specifying a Change Reference
    text: az monitor activity-log list-categories --change-reference actual_change_reference_id
  - name: Acquiring Policy Token
