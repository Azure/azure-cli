...
@register_command(
    "monitor account metrics-container list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MetricsContainersListByAzureMonitorWorkspace(ctx=self.ctx)()
    ...
    class MetricsContainersListByAzureMonitorWorkspace(AAZHttpOperation):
