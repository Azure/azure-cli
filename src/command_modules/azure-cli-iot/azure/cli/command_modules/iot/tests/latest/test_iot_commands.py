...
class IoTHubTest(ScenarioTest):
    ...
    def test_iot_hub(self, resource_group, resource_group_location):
        ...
        # Test 'az iot hub policy key-renew'
        policy = self.cmd('iot hub policy key-renew --hub-name {0} -n {1} --regenerate-key Primary'.format(hub, policy_name),
        ...
        # Test swap keys 'az iot hub policy key-renew'
        self.cmd('iot hub policy key-renew --hub-name {0} -n {1} --regenerate-key Swap'.format(hub, policy_name),
