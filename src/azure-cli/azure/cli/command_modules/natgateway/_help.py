...
examples:
  ...
  - name: Create a NAT gateway. (autogenerated)
    text: az network nat gateway create --name MyNatGateway --public-ip-addresses MyPublicIp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Show details of a NAT gateway. (autogenerated)
    text: az network nat gateway show --name MyNatGateway --resource-group MyResourceGroup
    crafted: true
"""
