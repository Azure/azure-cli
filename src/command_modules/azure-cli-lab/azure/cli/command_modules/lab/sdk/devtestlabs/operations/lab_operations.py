...
class LabOperations(object):
    ...
    def export_lab_resource_usage(
            self, resource_group_name, name, export_lab_resource_usage_parameters, custom_headers=None, raw=False, **operation_config):
        ...
        :param name: The name of the lab.
        :type name: str
        :param export_lab_resource_usage_parameters:
        :type export_lab_resource_usage_parameters:
         :class:`ExportLabResourceUsageParameters
         <azure.mgmt.devtestlabs.models.ExportLabResourceUsageParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def generate_upload_uri(
            self, resource_group_name, name, generate_upload_uri_parameter, custom_headers=None, raw=False, **operation_config):
        ...
        :type generate_upload_uri_parameter:
         :class:`GenerateUploadUriParameter
         <azure.mgmt.devtestlabs.models.GenerateUploadUriParameter>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
