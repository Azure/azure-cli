...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.billing_sku = AAZStrArg(
            options=["--billing-sku"],
            arg_group="Properties",
            help="The billing sku of the private endpoint.",
            enum={"Fixed": "Fixed", "PayAsYouGo": "PayAsYouGo"},
        )
        _args_schema.ip_version_type = AAZStrArg(
            options=["--ip-version-type"],
            arg_group="Properties",
            help="Specifies the IP version type for the private IPs of the private endpoint. If not defined, this defaults to IPv4.",
            default="IPv4",
        ...
        _args_schema.application_gateway_ip_configurations = AAZListArg(
            options=["--app-gateway-ip-configs", "--application-gateway-ip-configurations"],
            arg_group="Properties",
            help="Application gateway IP configurations of virtual network resource.",
        )
        _args_schema.default_outbound_access = AAZBoolArg(
            options=["--outbound-access", "--default-outbound-access"],
            arg_group="Properties",
        ...
        _args_schema.ipam_pool_prefix_allocations = AAZListArg(
            options=["--ipam-prefix-allocs", "--ipam-pool-prefix-allocations"],
            arg_group="Properties",
        ...
        cls._build_args_common_private_link_service_connection_create(manual_private_link_service_connections.Element)
        ...
        cls._build_args_common_private_link_service_connection_create(private_link_service_connections.Element)

        application_gateway_ip_configurations = cls._args_schema.application_gateway_ip_configurations
        application_gateway_ip_configurations.Element = AAZObjectArg()

        _element = cls._args_schema.application_gateway_ip_configurations.Element
    ...
    _args_common_private_link_service_connection_create = None

    @classmethod
    def _build_args_common_private_link_service_connection_create(cls, _schema):
        if cls._args_common_private_link_service_connection_create is not None:
            _schema.approval_reference = cls._args_common_private_link_service_connection_create.approval_reference
            _schema.group_ids = cls._args_common_private_link_service_connection_create.group_ids
            _schema.id = cls._args_common_private_link_service_connection_create.id
            _schema.name = cls._args_common_private_link_service_connection_create.name
            _schema.private_link_service_connection_state = cls._args_common_private_link_service_connection_create.private_link_service_connection_state
            _schema.private_link_service_id = cls._args_common_private_link_service_connection_create.private_link_service_id
            _schema.request_message = cls._args_common_private_link_service_connection_create.request_message
            return

        cls._args_common_private_link_service_connection_create = AAZObjectArg()

        common_private_link_service_connection_create = cls._args_common_private_link_service_connection_create
        common_private_link_service_connection_create.id = AAZStrArg(
            options=["id"],
            help="Resource ID.",
        )
        common_private_link_service_connection_create.name = AAZStrArg(
            options=["name"],
            help="The name of the resource that is unique within a resource group. This name can be used to access the resource.",
        )
        common_private_link_service_connection_create.approval_reference = AAZObjectArg(
        ...
        common_private_link_service_connection_create.group_ids = AAZListArg(
            options=["group-ids"],
            help="The ID(s) of the group(s) obtained from the remote resource that this private endpoint should connect to.",
        )
        common_private_link_service_connection_create.private_link_service_connection_state = AAZObjectArg(
        ...
        common_private_link_service_connection_create.private_link_service_id = AAZStrArg(
            options=["private-link-service-id"],
            help="The resource id of private link service.",
        )
        common_private_link_service_connection_create.request_message = AAZStrArg(
        ...
        approval_reference = cls._args_common_private_link_service_connection_create.approval_reference
        ...
        group_ids = cls._args_common_private_link_service_connection_create.group_ids
        group_ids.Element = AAZStrArg()

        private_link_service_connection_state = cls._args_common_private_link_service_connection_create.private_link_service_connection_state
    ...
    class PrivateEndpointsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("billingSku", AAZStrType, ".billing_sku")
                ...
                properties.set_prop("ipVersionType", AAZStrType, ".ip_version_type")
            ...
            if manual_private_link_service_connections is not None:
                _CreateHelper._build_schema_common_private_link_service_connection_create(manual_private_link_service_connections.set_elements(AAZObjectType, "."))
            ...
            if private_link_service_connections is not None:
                _CreateHelper._build_schema_common_private_link_service_connection_create(private_link_service_connections.set_elements(AAZObjectType, "."))
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_common_private_endpoint_read(cls._schema_on_200_201)
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_common_private_link_service_connection_create(cls, _builder):
        if _builder is None:
            return
