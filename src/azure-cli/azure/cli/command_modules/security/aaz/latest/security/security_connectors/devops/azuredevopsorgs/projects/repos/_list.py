...
@register_command(
    "security security-connectors devops azuredevopsorgs projects repos list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AzureDevOpsReposList(ctx=self.ctx)()
    ...
    class AzureDevOpsReposList(AAZHttpOperation):
