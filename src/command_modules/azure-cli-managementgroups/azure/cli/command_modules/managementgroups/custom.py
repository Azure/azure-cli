...
def cli_managementgroups_group_get(
        cmd,
        client,
        group_name,
        expand=False,
...
def cli_managementgroups_group_new(
        cmd,
        client,
        group_name,
        display_name=None,
...
def cli_managementgroups_group_update(
        cmd,
        client,
        group_name,
        display_name=None,
...
def cli_managementgroups_subscription_new(
        cmd, client, group_name, subscription_id):
    _register_rp(cmd.cli_ctx)
