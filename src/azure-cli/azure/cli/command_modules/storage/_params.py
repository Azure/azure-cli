...
def load_arguments(self, _):  # pylint: disable=too-many-locals, too-many-statements
    ...
    with self.argument_context('storage account create', resource_type=ResourceType.MGMT_STORAGE) as c:
        ...
        c.argument('enable_hierarchical_namespace', options_list=['--enable-hierarchical-namespace', '--hns'],
                   action='store_true', help=" Allow the blob service to exhibit filesystem semantics",
