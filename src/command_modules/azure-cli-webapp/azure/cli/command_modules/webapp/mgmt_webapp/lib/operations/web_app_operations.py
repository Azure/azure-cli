...
class WebAppOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, deployment_name, name, content_version=None, hosting_plan_name=None, hosting_plan_type="new", number_of_workers="1", sku_capacity="1", sku_name="F1", custom_headers={}, raw=False, **operation_config):
        """
