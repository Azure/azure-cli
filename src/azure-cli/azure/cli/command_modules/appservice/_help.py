...
examples:
  - name: Add a storage mount to a managed instance App Service plan.
    text: az appservice plan managed-instance storage-mount add --name MyAppServicePlan --resource-group MyResourceGroup --mount-name MyMount --type AzureFiles --source //myaccount.file.core.windows.net/myshare --destination-path /mnt/myshare --credentials-secret-uri https://myvault.vault.azure.net/secrets/storage-credentials/myversion
"""
