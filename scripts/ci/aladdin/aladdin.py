...
aladdin_helps['acr replication delete'] = """
type: command
short-summary: Delete a replicated region from an Azure Container Registry.
examples:
  - name: Delete a replicated region from an Azure Container Registry. (autogenerated)
    text: az acr replication delete --name MyReplication --registry MyRegistry --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Remove a timer trigger from a task. (autogenerated)
    text: az acr task timer remove --name taskname --registry registryname --resource-group MyResourceGroup --subscription MySubscription --timer-name t2
    crafted: true
"""
...
examples:
  - name: Attach a secondary storage to an Azure Media Services account. (autogenerated)
    text: az ams account storage add --account-name MyAccount --name MyResourceIDSecondaryStorageAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete an asset. (autogenerated)
    text: az ams asset delete --account-name MyAccount --name MyAsset --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a live event. (autogenerated)
    text: az ams live-event show --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['appservice ase list-addresses'] = """
type: command
short-summary: List VIPs associated with an app service environment.
examples:
  - name: List VIPs associated with an app service environment (autogenerated)
    text: az appservice ase list-addresses --name MyAseName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Set the function app's configuration. (autogenerated)
    ...
    crafted: true
  - name: Set the function app's configuration. (autogenerated)
    text: az functionapp config set --ftps-state AllAllowed --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the policy associated with this item (autogenerated)
    text: az backup item set-policy --backup-management-type AzureIaasVM --container-name MyContainer --name MyItem --policy-name MyPolicy --resource-group MyResourceGroup --subscription MySubscription --vault-name MyVault
    crafted: true
"""
...
aladdin_helps['bot facebook create'] = """
type: command
short-summary: Create the Facebook Channel on a bot.
examples:
  - name: Create the Facebook Channel on a bot. (autogenerated)
    text: az bot facebook create --add-disabled true --appid myAppId --name botName --page-id myPageId --resource-group MyResourceGroup --secret mySecret --subscription MySubscription --token myToken
    crafted: true
"""
...
aladdin_helps['cdn endpoint delete'] = """
type: command
short-summary: Delete a CDN endpoint.
examples:
  - name: Delete a CDN endpoint. (autogenerated)
    text: az cdn endpoint delete --name endpoint --profile-name profile-name --resource-group group --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['cdn endpoint rule remove'] = """
type: command
short-summary: Remove a delivery rule from an endpoint.
examples:
  - name: Remove a delivery rule from an endpoint. (autogenerated)
    text: az cdn endpoint rule remove --name endpoint --profile-name profile --resource-group group --rule-name Global --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Lists firewall rules in a Data Lake Store account. (autogenerated)
    text: az dls account firewall list --account mydatalakestoragegen1 --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['iot hub route show'] = """
type: command
...
examples:
  - name: Get information about the route in IoT Hub. (autogenerated)
    text: az iot hub route show --hub-name MyIotHub --resource-group MyResourceGroup --route-name R1 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a fixed or recurring autoscale profile. (autogenerated)
    text: |
        az monitor autoscale profile create --autoscale-name MyAutoscale --count 2 --end 2018-12-26 --name Christmas --recurrence week sat sun --resource-group MyResourceGroup --start 2018-12-24 --subscription MySubscription --timezone "Pacific Standard Time"
    crafted: true
"""
...
examples:
  - name: Delete an autoscale profile. (autogenerated)
    text: az monitor autoscale profile delete --autoscale-name MyAutoscale --name MyAutoscaleProfile --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['network nat gateway create'] = """
type: command
short-summary: Create a NAT gateway.
examples:
  - name: Create a NAT gateway. (autogenerated)
    text: az network nat gateway create --idle-timeout 4 --location MyLocation --name MyNatGateway --public-ip-addresses MyPublicIp --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""

aladdin_helps['netappfiles snapshot list'] = """
type: command
...
examples:
  - name: List the snapshots of an ANF volume (autogenerated)
    text: az netappfiles snapshot list --account-name myaccname --pool-name mypoolname --resource-group mygroup --subscription MySubscription --volume-name myvolname
    crafted: true
"""
...
examples:
  - name: Update a probe. (autogenerated)
    text: az network application-gateway probe update --gateway-name MyAppGateway --host 127.0.0.1 --name MyProbe --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule update --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  ...
  - name: Update an inbound NAT rule. (autogenerated)
    ...
    crafted: true
  - name: Update an inbound NAT rule. (autogenerated)
    text: az network lb inbound-nat-rule update --enable-tcp-reset true --lb-name MyLb --name MyNatRule --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a service endpoint policy. (autogenerated)
    text: az network service-endpoint policy create --location westus2 --name MyServiceEndpointPolicy --resource-group MyResourceGroup --tags super_secure no_80 no_22
    crafted: true
"""
...
aladdin_helps['network service-endpoint policy update'] = """
type: command
short-summary: Update a service endpoint policy.
examples:
  - name: Update a service endpoint policy. (autogenerated)
    text: az network service-endpoint policy update --name MyServiceEndpointPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['security atp storage show'] = """
type: command
short-summary: Display Advanced Threat Protection settings for a storage account.
examples:
  - name: Display Advanced Threat Protection settings for a storage account. (autogenerated)
    text: az security atp storage show --resource-group MyResourceGroup --storage-account MyStorageAccount --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['security topology show'] = """
type: command
short-summary: Shows the network topology in your subscription.
examples:
  - name: Shows the network topology in your subscription (autogenerated)
    text: az security topology show --name default --resource-group myService1 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an elastic pool. (autogenerated)
    text: az sql elastic-pool update --name mypool --resource-group mygroup --server myserver --set tags.tagName=tagValue
    crafted: true
"""
...
examples:
  - name: Creates a new share under the specified account. (autogenerated)
    ...
    crafted: true
  - name: Creates a new share under the specified account. (autogenerated)
    text: az storage share create --connection-string $connectionString --name MyFileShare
    crafted: true
"""
