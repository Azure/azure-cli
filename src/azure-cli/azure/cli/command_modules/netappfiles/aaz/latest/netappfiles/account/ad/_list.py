...
class List(AAZCommand):
    ...
    :example: List the active directories of an account.
    ...
    _aaz_info = {
        "version": "2025-12-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}", "2025-12-01", "properties.activeDirectories"],
        ]
    }
    ...
    class AccountsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_net_app_account_read(cls._schema_on_200)
