...
examples:
  ...
  - name: Create Authorization Rule 'myrule' for the given Relay Service Namespace 'mynamespace' in resourcegroup (autogenerated)
    text: az relay namespace authorization-rule create --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --rights Manage
    crafted: true
"""
