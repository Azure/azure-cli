...
examples:
  ...
  - name: Cancels the asynchronous operation on the database. (autogenerated)
    text: az sql db op cancel --database mydb --name d2896mydb-2ba8-4c84-bac1-387c430cce40 --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  - name: Create a new database by restoring from a backup. (autogenerated)
    text: |
        az sql db restore --dest-name MyDest --name MyAzureSQLDatabase --resource-group MyResourceGroup --server myserver --time "2018-05-20T05:34:22"
    crafted: true
  - name: Create a new database by restoring from a backup. (autogenerated)
    text: |
...
examples:
  ...
  - name: Generates a connection string to a database. (autogenerated)
    text: az sql db show-connection-string --client ado.net --name mydb --server myserver
    crafted: true
"""
...
examples:
  ...
  - name: Delete a managed instance. (autogenerated)
    text: az sql mi delete --name myinstance --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: Get the details for a managed instance. (autogenerated)
    text: az sql mi show --name myinstance --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete a managed database. (autogenerated)
    text: az sql midb delete --managed-instance myinstance --name mymanageddb --resource-group mygroup --yes
    crafted: true
"""
...
examples:
  ...
  - name: List maanged databases on a managed instance. (autogenerated)
    text: az sql midb list --managed-instance myinstance --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: Get the details for a managed database. (autogenerated)
    text: az sql midb show --managed-instance myinstance --name mymanageddb --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: List a server's firewall rules. (autogenerated)
    text: az sql server firewall-rule list --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  ...
  - name: Shows the details for a firewall rule. (autogenerated)
    text: az sql server firewall-rule show --name myrule --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  ...
  - name: Update a firewall rule. (autogenerated)
    text: az sql server firewall-rule update --end-ip-address 5.4.3.2 --name myrule --resource-group mygroup --server myserver --start-ip-address 9.8.7.6
    crafted: true
"""
...
examples:
  ...
  - name: Delete a virtual cluster. (autogenerated)
    text: az sql virtual-cluster delete --name mycluster --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: List available virtual clusters. (autogenerated)
    text: az sql virtual-cluster list --resource-group mygroup
    crafted: true
"""
