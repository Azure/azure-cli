...
examples:
  ...
  - name: Creates an Azure Container Registry. (autogenerated)
    text: az acr create --name MyRegistry --resource-group MyResourceGroup --sku Standard
    crafted: true
"""
...
examples:
  ...
  - name: Untag an image in an Azure Container Registry. (autogenerated)
...
examples:
  ...
  - name: Manually trigger a task that might otherwise be waiting for git commits or base image update triggers. (autogenerated)
    text: az acr task run --name MyTask --registry MyRegistry
    crafted: true
"""
