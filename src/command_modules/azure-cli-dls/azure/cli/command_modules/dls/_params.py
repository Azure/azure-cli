...
register_cli_argument('dls', 'skip', help='The number of items to skip over before returning elements. Optional.', type=int)
register_cli_argument('dls', 'count', help='The Boolean value of true or false to request a count of the matching resources included with the resources in the response, e.g. Categories?$count=true. Optional.', type=bool)
...
register_cli_argument('dls account update', 'trusted_id_provider_state', help='Optionally enable/disable the existing trusted ID providers.', **enum_choice_list(TrustedIdProviderState))
register_cli_argument('dls account update', 'firewall_state', help='Optionally enable/disable existing firewall rules.', **enum_choice_list(FirewallState))
register_cli_argument('dls account update', 'allow_azure_ips', help='Optionally allow/block Azure originating IPs through the firewall', **enum_choice_list(FirewallAllowAzureIpsState))
...
register_cli_argument('dls fs create', 'folder', help='Optionally indicates that this new item is a folder and not a file.', action='store_true')
register_cli_argument('dls fs delete', 'recurse', help='Optionally indicates this should be a recursive delete of the folder.', action='store_true')
register_cli_argument('dls fs upload', 'overwrite', help='Optionally indicates that, if the destination file or folder exists, it should be overwritten', action='store_true')
register_cli_argument('dls fs upload', 'thread_count', help='Optionally specify the parallelism of the upload. Default is the number of cores in the local machine.', type=int)
register_cli_argument('dls fs download', 'overwrite', help='Optionally indicates that, if the destination file or folder exists, it should be overwritten', action='store_true')
register_cli_argument('dls fs download', 'thread_count', help='Optionally specify the parallelism of the download. Default is the number of cores in the local machine.', type=int)
