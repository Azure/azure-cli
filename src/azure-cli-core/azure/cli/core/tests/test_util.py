...
class TestUtils(unittest.TestCase):
    ...
    def test_send_raw_requests(self, send_mock, get_raw_token_mock):
        ...
        # Test basic usage
        # Mock Put Blob https://learn.microsoft.com/rest/api/storageservices/put-blob
        # Authenticate with service SAS https://learn.microsoft.com/rest/api/storageservices/create-service-sas
        ...
        # https://learn.microsoft.com/rest/api/resources/tenants/list
