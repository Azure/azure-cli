...
@register_command(
    "netappfiles volume bucket refresh-certificate",
)
class RefreshCertificate(AAZCommand):
    """This operation will fetch the certificate from Azure Key Vault and install it on the bucket server.

    :example: Buckets_RefreshCertificate
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BucketsRefreshCertificate(ctx=self.ctx)()
    ...
    class BucketsRefreshCertificate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/buckets/{bucketName}/refreshCertificate",
                **self.url_parameters
            )
...
class _RefreshCertificateHelper:
    """Helper class for RefreshCertificate"""


__all__ = ["RefreshCertificate"]
