...
-   "name": |-
        Creates Authorizationrule for the given Eventhub.
    "text": |-
        az eventhubs eventhub authorization-rule create --namespace-name mynamespace --eventhub-name myeventhub --rights Listen --name myauthorule --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Shows the list of Authorization-rules by Eventhub.
    "text": |-
        az eventhubs eventhub authorization-rule list --namespace-name mynamespace --eventhub-name myeventhub --query [0] --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Creates the EventHub ConsumerGroup.
    "text": |-
        az eventhubs eventhub consumer-group create --namespace-name mynamespace --eventhub-name myeventhub --name myconsumergroup --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az eventhubs georecovery-alias authorization-rule keys list --resource-group myresourcegroup --namespace-name mynamespace --name myauthorule
"""
...
-   "name": |-
        List of Authorizationrule by Event Hubs Namespace
    "text": |-
        az eventhubs georecovery-alias authorization-rule list --resource-group myresourcegroup --namespace-name mynamespace
"""
...
"examples":
-   "name": |-
        Show properties Authorizationrule by Event Hubs Namespace
    "text": |-
        az eventhubs georecovery-alias authorization-rule show --resource-group myresourcegroup --namespace-name mynamespace
"""
...
-   "name": |-
        Disables Geo-Disaster Recovery Configuration Alias and stops replicating changes from primary to secondary namespaces
    "text": |-
        az eventhubs georecovery-alias break-pair --resource-group myresourcegroup --namespace-name primarynamespace --alias myaliasname
"""
...
-   "name": |-
        Delete Geo-Disaster Recovery Configuration Alias
    "text": |-
        az eventhubs georecovery-alias delete --resource-group myresourcegroup --namespace-name secondarynamespace --alias myaliasname
"""
...
-   "name": |-
        Check the availability of Geo-Disaster Recovery Configuration Alias Name
    "text": |-
        az eventhubs georecovery-alias exists --resource-group myresourcegroup --namespace-name primarynamespace --alias myaliasname
"""
...
-   "name": |-
    ...
    "text": |-
        az eventhubs georecovery-alias fail-over --resource-group myresourcegroup --namespace-name secondarynamespace --alias myaliasname
"""
...
-   "name": |-
    ...
    "text": |-
        az eventhubs georecovery-alias show --resource-group myresourcegroup --namespace-name primarynamespace --alias myaliasname
-   "name": |-
        Shows properties of Geo-Disaster Recovery Configuration Alias of the Secondary Namespace
    "text": |-
        az eventhubs georecovery-alias show --resource-group myresourcegroup --namespace-name secondarynamespace --alias myaliasname
"""
...
-   "name": |-
        Shows the connection strings for namespace.
    "text": |-
        az eventhubs namespace authorization-rule keys list --namespace-name mynamespace --name myauthorule --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az eventhubs namespace create --resource-group myresourcegroup --name mynamespace --location westus --tags tag1=value1 tag2=value2 --sku Standard --enable-auto-inflate False --maximum-throughput-units 30
"""
