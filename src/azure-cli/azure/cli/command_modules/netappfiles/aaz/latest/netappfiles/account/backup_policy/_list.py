...
class List(AAZCommand):
    ...
    :example: List the ANF backup policy for the specified account
    ...
    class BackupPoliciesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            volume_backups = cls._schema_on_200.value.Element.properties.volume_backups
            volume_backups.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.volume_backups.Element
