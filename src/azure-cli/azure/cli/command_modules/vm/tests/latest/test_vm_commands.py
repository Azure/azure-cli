...
class VMManagedDiskScenarioTest(ScenarioTest):
    ...
    def test_vm_disk_max_shares_etc(self, resource_group):
        ...
        self.cmd('sig image-definition create -g {rg} --gallery-name {g1} --gallery-image-definition image --os-type linux -p publisher1 -f offer1 -s sku1 --features "IsSecureBootSupported=true IsMeasuredBootSupported=false"')
