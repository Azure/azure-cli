...
examples:
  ...
  - name: Update a task for an Azure Container Registry. (autogenerated)
    text: |
        az acr task update --image MyImage --name MyTask --registry MyRegistry      --context https://github.com/Azure-Samples/acr-build-helloworld-node.git
    crafted: true
  - name: Update a task for an Azure Container Registry. (autogenerated)
    text: |
        az acr task update --base-image-trigger-enabled true --name MyTask --registry MyRegistry
    crafted: true
"""
