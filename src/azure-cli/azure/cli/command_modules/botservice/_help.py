...
helps['bot create'] = """
    ...
    examples:
      - name: Create a new v4 SDK bot. (autogenerated)
        text: |
            az bot create --appid myAppId --kind registration --lang Csharp --name MyResourceBot --password password --resource-group MyResourceGroup
        crafted: true
"""
helps['bot show'] = """
    type: command
    ...
    - name: Get an existing bot. (autogenerated)
      text: |
          az bot show --name botName --resource-group MyResourceGroup --subscription MySubscription
      crafted: true
"""
...
helps['bot delete'] = """
    ...
    examples:
      - name: Delete an existing bot. (autogenerated)
        text: |
            az bot delete --name MyResourceBot --resource-group MyResourceGroup
        crafted: true
"""
helps['bot update'] = """
    type: command
...
helps['bot skype create'] = """
    ...
    examples:
        ...
        - name: Create the Skype Channel on a bot. (autogenerated)
          text: |
              az bot skype create --add-disabled true --enable-media-cards true --enable-messaging true --name botName --resource-group MyResourceGroup --subscription MySubscription
          crafted: true
"""
...
helps['bot authsetting show'] = """
    ...
    examples:
      - name: Show details of an OAuth connection setting on a bot. (autogenerated)
        text: |
            az bot authsetting show --name MyResourceBot --resource-group MyResourceGroup --setting-name MySetting
        crafted: true
"""
helps['bot authsetting list'] = """
    ...
    examples:
      - name: Show all OAuth connection settings on a bot. (autogenerated)
        text: |
            az bot authsetting list --name MyResourceBot --resource-group MyResourceGroup
        crafted: true
"""
helps['bot authsetting delete'] = """
    ...
    examples:
      - name: Delete an OAuth connection setting on a bot. (autogenerated)
        text: |
            az bot authsetting delete --name MyResourceBot --resource-group MyResourceGroup --setting-name MySetting
        crafted: true
"""
...
helps['bot msteams delete'] = """
    ...
    examples:
      - name: Delete the Microsoft Teams Channel on a bot (autogenerated)
        text: |
            az bot msteams delete --name MyResourceBot --resource-group MyResourceGroup --subscription MySubscription
        crafted: true
"""
helps['bot msteams show'] = """
    ...
    examples:
      - name: Get details of the Microsoft Teams Channel on a bot (autogenerated)
        text: |
            az bot msteams show --name MyResourceBot --resource-group MyResourceGroup
        crafted: true
"""
helps['bot msteams'] = """
    type: group
...
helps['bot webchat show'] = """
    ...
    examples:
      - name: Get details of the Webchat Channel on a bot (autogenerated)
        text: |
            az bot webchat show --name MyResourceBot --resource-group MyResourceGroup --with-secrets true
        crafted: true
"""
helps['bot webchat'] = """
    type: group
