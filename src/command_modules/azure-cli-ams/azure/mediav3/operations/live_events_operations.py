...
class LiveEventsOperations(object):
    ...
    def list(
        ...
        :rtype: ~encoding.models.LiveEventPaged[~encoding.models.LiveEvent]
    ...
    def get(
        ...
        :rtype: ~encoding.models.LiveEvent or
    ...
    def create(
        ...
        :type parameters: ~encoding.models.LiveEvent
        :param auto_start: The flag indicates if auto start the Live Event.
        :type auto_start: bool
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns LiveEvent or
         ClientRawResponse if raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~encoding.models.LiveEvent]
