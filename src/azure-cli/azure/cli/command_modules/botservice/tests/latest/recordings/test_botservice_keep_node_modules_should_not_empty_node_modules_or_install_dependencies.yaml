...
- request:
    body: '{"location": "global", "sku": {"name": "F0"}, "kind": "azurebot", "properties":
      ...
      "f695c4cd-7f11-4d6a-9dcb-3e8e5165750c", "isCmekEnabled": false, "publicNetworkAccess":
  ...
  response:
    ...
    headers:
      ...
      - application/json; charset=utf-8
      date:
      - Fri, 24 Jun 2022 06:05:18 GMT
      etag:
      - '"b700ce74-0000-1800-0000-62b5541c0000"'
      expires:
      - '-1'
      pragma:
      - no-cache
