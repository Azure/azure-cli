...
examples:
  - name: Set the block or page tiers on the blob. (autogenerated)
    ...
    crafted: true
  - name: Set the block or page tiers on the blob. (autogenerated)
    text: az storage blob set-tier --connection-string $connectionString --container-name MyContainer --name MyBlob --tier P10
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage directory (autogenerated)
    text: az storage directory exists --account-key 00000000 --account-name MyAccount --name MyDirectory --share-name MyShare --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file (autogenerated)
    text: az storage file generate-sas --account-key 00000000 --account-name MyStorageAccount --expiry 2020-01-01 --path path/file.txt --permissions rcdw --share-name MyShare
    crafted: true
"""
