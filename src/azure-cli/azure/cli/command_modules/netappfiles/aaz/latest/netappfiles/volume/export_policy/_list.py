...
@register_command(
    "netappfiles volume export-policy list",
)
class List(AAZCommand):
    """List the export policy rules for a volume.

    :example: List the export policy rules for an ANF volume
    ...
    _aaz_info = {
        "version": "2026-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}", "2026-07-01", "properties.exportPolicy.rules"],
        ]
    }
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.exportPolicy.rules

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.exportPolicy.rules = value
            return
    ...
    class VolumesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_volume_read(cls._schema_on_200)
