...
def cf_sf_client(_):
    ...
    from azure.cli.command_modules.sf.custom import (sf_get_cert_info, sf_get_connection_endpoint,
    ...
    def mock_get_cert_info():
        return None

    def mock_get_endpoint():
        return "http://eddertester.westus2.cloudapp.azure.com:19080"

    def mock_get_verify_setting():
        return None

    with patch("__main__", sf_get_cert_info=mock_get_cert_info,
               sf_get_connection_endpoint=mock_get_endpoint,
               sf_get_verify_setting=mock_get_verify_setting):
