...
@register_command(
    "netappfiles volume reset-cifs-pw",
)
class ResetCifsPw(AAZCommand):
    """Reset cifs password from volume

    :example: Reset the CIFS password for volume
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesResetCifsPassword(ctx=self.ctx)()
    ...
    class VolumesResetCifsPassword(AAZHttpOperation):
...
class _ResetCifsPwHelper:
    """Helper class for ResetCifsPw"""
