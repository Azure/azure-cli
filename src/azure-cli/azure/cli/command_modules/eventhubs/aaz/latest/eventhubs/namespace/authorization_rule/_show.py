...
class Show(AAZCommand):
    ...
    :example: NameSpaceAuthorizationRuleGet
        az eventhubs namespace authorization-rule show --resource-group ArunMonocle --namespace-name sdk-Namespace-2702 --authorization-rule-name sdk-Authrules-1746
    """
