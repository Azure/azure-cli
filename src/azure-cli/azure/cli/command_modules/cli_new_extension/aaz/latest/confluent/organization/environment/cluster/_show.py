...
class Show(AAZCommand):
    ...
    class OrganizationGetClusterById(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_sc_cluster_network_environment_entity_read(spec.environment)
            ...
            byok = cls._schema_on_200.properties.spec.byok
            byok.id = AAZStrType()
            ...
            config = cls._schema_on_200.properties.spec.config
