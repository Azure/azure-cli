...
examples:
  ...
  - name: List the access keys for a SignalR Service. (autogenerated)
    text: az signalr key list --name MySignalR --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a SignalR Service. (autogenerated)
    text: az signalr show --name MySignalR --resource-group MyResourceGroup
    crafted: true
"""
