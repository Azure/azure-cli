...
class StreamingEndpoint(TrackedResource):
    ...
    :param access_control: The access control definition of the
     StreamingEndpoint.
    :type access_control: ~encoding.models.StreamingEndpointAccessControl
    ...
    :vartype resource_state: str or
     ~encoding.models.StreamingEndpointResourceState
    ...
    def __init__(self, tags=None, location=None, description=None, scale_units=None, availability_set_name=None, access_control=None, max_cache_age=None, custom_host_names=None, cdn_enabled=None, cdn_provider=None, cdn_profile=None, cross_site_access_policies=None):
        super(StreamingEndpoint, self).__init__(tags=tags, location=location)
