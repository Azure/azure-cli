...
examples:
  ...
  - name: Create an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table create --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --schema @indexes-file.json
    crafted: true
  - name: Create an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: |
        az cosmosdb cassandra table create --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --schema @indexes-file.json --throughput "500"
    crafted: true
"""
...
examples:
  - name: Show the details of a Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table show --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create an Azure Cosmos DB MongoDB collection.
    ...
    crafted: true
  - name: Create an MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: |
        az cosmosdb mongodb collection create --account-name MyAccount --database-name MyDatabase --idx @indexes-file.json --name MyCollection --resource-group MyResourceGroup --shard "ShardingKey" --throughput "500"
    crafted: true
"""
