...
class CreateAndAssociatePlFilter(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.private_endpoint_guid = AAZStrArg(
            options=["--private-endpoint-guid"],
            help="Guid of the private endpoint",
        )
        _args_schema.private_endpoint_name = AAZStrArg(
            options=["--private-endpoint-name"],
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CreateAndAssociatePLFilterCreate(ctx=self.ctx)()
    ...
    class CreateAndAssociatePLFilterCreate(AAZHttpOperation):
        ...
        def query_parameters(self):
            parameters = {
                ...
                **self.serialize_query_param(
                    "privateEndpointGuid", self.ctx.args.private_endpoint_guid,
                ),
                **self.serialize_query_param(
...
class _CreateAndAssociatePlFilterHelper:
    """Helper class for CreateAndAssociatePlFilter"""


__all__ = ["CreateAndAssociatePlFilter"]
