...
def load_arguments(self, _):
    ...
    with self.argument_context('databoxedge device create') as c:
        ...
        c.argument('model_description', options_list=['--model-description'], type=str,
                   help='The description of the Data Box Edge/Gateway device model.')
        c.argument('friendly_name', options_list=['--friendly-name'], type=str,
                   help='The Data Box Edge/Gateway device name.')
    ...
    with self.argument_context('databoxedge bandwidth-schedule create') as c:
        ...
        c.argument('name', options_list=['--name', '-n'], type=str, help='The bandwidth schedule name which needs to '
                   'be added/updated.')
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('start', options_list=['--start'], type=str, help='The start time of the schedule in UTC.')
        c.argument('stop', options_list=['--stop'], type=str, help='The stop time of the schedule in UTC.')
        c.argument('rate_in_mbps', options_list=['--rate-in-mbps'], type=int, help='The bandwidth rate in Mbps.')
        c.argument('days', options_list=['--days'], nargs='+',
                   help='The days of the week when this schedule is applicable.')
    ...
    with self.argument_context('databoxedge order create') as c:
        ...
        c.argument('address_line1', options_list=['--address-line1'], type=str,
                   help='The address line1.', arg_group='Shipping Address')
        c.argument('address_line2', options_list=['--address-line2'], type=str,
                   help='The address line2.', arg_group='Shipping Address')
        c.argument('address_line3', options_list=['--address-line3'], type=str,
                   help='The address line3.', arg_group='Shipping Address')
        c.argument('postal_code', options_list=['--postal-code'], type=str,
                   help='The postal code.', arg_group='Shipping Address')
        c.argument('city', options_list=['--city'], type=str,
                   help='The city name.', arg_group='Shipping Address')
        c.argument('state', options_list=['--state'], type=str,
                   help='The state name.', arg_group='Shipping Address')
        c.argument('country', options_list=['--country'], type=str,
                   help='The country name.', arg_group='Shipping Address')
        c.argument('contact_person', options_list=['--contact-person'], type=str,
                   help='The contact person name.', arg_group='Contact Information')
        c.argument('company_name', options_list=['--company-name'], type=str,
                   help='The name of the company.', arg_group='Contact Information')
        c.argument('phone', options_list=['--phone'], type=str,
                   help='The phone number.', arg_group='Contact Information')
        c.argument('email_list', options_list=['--email-list'], nargs='+',
                   help='The email list.', arg_group='Contact Information')
