...
# region - Eventhub Create
    ...
    for scope in ['eventhubs eventhub create']:
        with self.argument_context(scope) as c:
            ...
            c.argument('retention_time_in_hours', arg_group='Retention-Description', options_list=['--retention-time-in-hours', '--retention-time'], help="Number of hours to retain the events for this Event Hub. This value is only used when cleanupPolicy is Delete. If cleanupPolicy is Compaction the returned value of this property is Long.MaxValue")
