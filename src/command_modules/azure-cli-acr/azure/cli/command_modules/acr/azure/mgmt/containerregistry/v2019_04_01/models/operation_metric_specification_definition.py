...
class OperationMetricSpecificationDefinition(Model):
    ...
    def __init__(self, name=None, display_name=None, display_description=None, unit=None, aggregation_type=None, internal_metric_name=None):
        super(OperationMetricSpecificationDefinition, self).__init__()
        self.name = name
