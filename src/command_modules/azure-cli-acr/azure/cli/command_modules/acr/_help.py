...
"examples":
-   "name": |-
        Create a build definition without git commits and base image updates.
    "text": |
...
-   "name": |-
        Create a build definition which updates on git commits and base image updates (--git-access-token must have permissions to create github webhooks).
    "text": |
...
"examples":
-   "name": |-
        List build tasks and show the results in a table.
    "text": |
...
"examples":
-   "name": |-
        List builds for a build task and show the results in a table.
    "text": |
        az acr build-task list-builds -n MyBuildTask -r MyRegistry -o table
-   "name": |-
        List all of the builds for a registry displaying the results in a table.
    "text": |
        az acr build-task list-builds -r MyRegistry -o table
-   "name": |-
        List the last 10 successful builds for a registry displaying the results in a table.
    "text": |
        az acr build-task list-builds -r MyRegistry --build-status Succeeded --top 10 -o table
-   "name": |-
        List all of the builds that built the image 'hello-world' for an Azure Container Registry, displaying the results in a table.
    "text": |
...
"examples":
-   "name": |-
        Show logs for the last created build in the registry.
    "text": |
        az acr build-task logs -r MyRegistry
-   "name": |-
        Show logs for the last created build in the registry, filtered by build task.
    "text": |
        az acr build-task logs -r MyRegistry -n MyBuildTask
-   "name": |-
        Show logs for a particular build.
    "text": |
        az acr build-task logs -r MyRegistry --build-id aa1b
-   "name": |-
        Show logs for the last created build in the registry that built the image 'hello-world'.
    "text": |
...
"examples":
-   "name": |-
        Get the details of a build task, displaying the results in a table.
    "text": |
        az acr build-task show -n MyBuildTask -r MyRegistry -o table
-   "name": |-
        Get the details of a build task including secure properties.
    "text": |
...
"examples":
-   "name": |-
        Get the details of a build, displaying the results in a table.
    "text": |
...
"examples":
-   "name": |-
        Update the git access token for a build definition in an Azure Container Registry.
    "text": |
...
"examples":
-   "name": |-
        Update an existing build to be archived.
    "text": |
...
-   "name": |-
        Checks if an Azure Container Registry name is valid and available for use.
    "text": |-
        az acr check-name --name doesthisnameexist
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete an image by tag. This deletes the manifest referenced by 'hello-world:latest' and all other tags referencing the manifest.
    "text": |-
        az acr repository delete -n MyRegistry --image hello-world:latest
-   "name": |-
        Delete an image by sha256-based manifest digest. This deletes the manifest identified by 'hello-world@sha256:abc123' and all tags referencing the manifest.
    "text": |-
...
-   "name": |-
        Create a Linux task using a private GitHub repository which builds the hello-world image without triggers
    "text": |
...
-   "name": |-
        Create a Linux task from a public GitHub repository which builds the hello-world image with a git commit trigger
    "text": |
...
-   "name": |-
        Create a Windows task from a public GitHub repository which builds the Azure Container Builder image.
    "text": |
