...
class MetricOperations(object):
    ...
    def get(
            self, resource_uri, filter=None, api_version="2016-06-01", custom_headers=None, raw=False, **operation_config):
        """
        ...
        :rtype: :class:`MetricPaged <insights.models.MetricPaged>`
        """
