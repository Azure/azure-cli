...
class ScanForUpdate(AAZCommand):
    """Scans for updates on a Data Box Edge/Data Box Gateway device.

    :example: Scan for updates on a Data Box Edge/Data Box Gateway device.
        az databoxedge device scan-for-update --device-name testedgedevice --resource-group GroupForEdgeAutomation
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevicesScanForUpdates(ctx=self.ctx)()
    ...
    class DevicesScanForUpdates(AAZHttpOperation):
...
class _ScanForUpdateHelper:
    """Helper class for ScanForUpdate"""


__all__ = ["ScanForUpdate"]
