...
examples:
  ...
  - name: Shows the connection strings of Authorizationrule for the Eventhub. (autogenerated)
    text: az eventhubs eventhub authorization-rule keys list --eventhub-name myeventhub --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows the list of Authorization-rules by Eventhub (autogenerated)
    text: az eventhubs eventhub authorization-rule list --eventhub-name myeventhub --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows the details of Authorizationrule (autogenerated)
    text: az eventhubs eventhub authorization-rule show --eventhub-name myeventhub --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Updates Authorizationrule for the given Eventhub (autogenerated)
    text: az eventhubs eventhub authorization-rule update --eventhub-name myeventhub --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --rights Manage
    crafted: true
"""
...
examples:
  ...
  - name: Deletes the ConsumerGroup (autogenerated)
    text: az eventhubs eventhub consumer-group delete --eventhub-name myeventhub --name myconsumergroup --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the ConsumerGroup by Eventhub (autogenerated)
    text: az eventhubs eventhub consumer-group list --eventhub-name myeventhub --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the ConsumerGroup Details (autogenerated)
    text: az eventhubs eventhub consumer-group show --eventhub-name myeventhub --name myconsumergroup --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Updates the EventHub ConsumerGroup (autogenerated)
    text: az eventhubs eventhub consumer-group update --eventhub-name myeventhub --name myconsumergroup --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the EventHub by Namepsace (autogenerated)
    text: az eventhubs eventhub list --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows the Eventhub Details (autogenerated)
    text: az eventhubs eventhub show --name myeventhub --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Disables Geo-Disaster Recovery Configuration Alias and stops replicating changes from primary to secondary namespaces (autogenerated)
    text: az eventhubs georecovery-alias break-pair --alias myaliasname --namespace-name primarynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Sets a Geo-Disaster Recovery Configuration Alias for the give Namespace (autogenerated)
    text: az eventhubs georecovery-alias set --alias myaliasname --namespace-name primarynamespace --partner-namespace resourcearmid --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows properties of Geo-Disaster Recovery Configuration Alias for Primay or Secondary Namespace (autogenerated)
    text: az eventhubs georecovery-alias show --alias myaliasname --namespace-name primarynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the connection strings for namespace (autogenerated)
    text: az eventhubs namespace authorization-rule keys list --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Regenerate the connection strings of Authorizationrule for the namespace. (autogenerated)
    text: az eventhubs namespace authorization-rule keys renew --key PrimaryKey --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the list of Authorizationrule by Namespace (autogenerated)
    text: az eventhubs namespace authorization-rule list --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the details of Authorizationrule (autogenerated)
    text: az eventhubs namespace authorization-rule show --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows the Event Hubs Namespace Details (autogenerated)
    text: az eventhubs namespace show --name mynamespace --resource-group myresourcegroup
    crafted: true
"""
