...
class Create(AAZCommand):
    ...
    class PublicIPPrefixesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            load_balancer_frontend_ip_configuration = cls._schema_on_200_201.properties.load_balancer_frontend_ip_configuration
...
class List(AAZCommand):
    ...
    class PublicIPPrefixesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            load_balancer_frontend_ip_configuration = cls._schema_on_200.value.Element.properties.load_balancer_frontend_ip_configuration
            load_balancer_frontend_ip_configuration.id = AAZStrType()
...
class _UpdateHelper:
    ...
    def _build_schema_public_ip_prefix_read(cls, _schema):
        ...
        load_balancer_frontend_ip_configuration = _schema_public_ip_prefix_read.properties.load_balancer_frontend_ip_configuration
        load_balancer_frontend_ip_configuration.id = AAZStrType()
