...
examples:
  - name: Generate or replace one or both passwords of a token for an Azure Container Registry (autogenerated)
    text: az acr token credential generate --name MyToken --password1 --password2 --registry MyRegistry
    crafted: true
"""
...
examples:
  - name: Add a node pool to the managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool add --cluster-name mycluster --name mynodepool --node-count 7 --os-type Windows --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['advisor configuration list'] = """
type: command
short-summary: List Azure Advisor configuration for the entire subscription.
examples:
  - name: List Azure Advisor configuration for the entire subscription. (autogenerated)
    text: az advisor configuration list --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a migration Project. (autogenerated)
    text: az dms project show --name MyProject --resource-group MyResourceGroup --service-name MyService --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Remove a Key Vault managed Azure Storage Account and all associated SAS definitions (autogenerated)
    text: az keyvault storage remove --name mystorage --vault-name myvault
    crafted: true
"""
...
examples:
  - name: Creates a new registration assignment. (autogenerated)
    text: |
        az managedservices assignment create --definition "/subscriptions/00000000-0000-0000-0000-00000000000000000/providers/Microsoft.ManagedServices/registrationDefinitions/00000000-0000-0000-0000-00000000000000000" --resource-group mygroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update the details of this activity log alert (autogenerated)
    ...
    crafted: true
  - name: Update the details of this activity log alert. (autogenerated)
    text: az monitor activity-log alert update --condition category=ServiceHealth and level=Error --enabled true --name MyActivityLogAlerts --resource-group MyResourceGroup
    crafted: true
  - name: Update the details of this activity log alert. (autogenerated)
    text: az monitor activity-log alert update --enabled true --name MyActivityLogAlerts --resource-group MyResourceGroup --set retentionPolicy.days=365
    crafted: true
"""
...
examples:
  - name: Create some linked storage accounts for log analytics workspace. (autogenerated)
    text: az monitor log-analytics workspace linked-storage create --resource-group MyResourceGroup --storage-accounts SA1 SA2 --subscription mysubscription --type CustomLogs --workspace-name MyWorkspace
    crafted: true
"""
...
aladdin_helps['network nat gateway show'] = """
type: command
short-summary: Show details of a NAT gateway.
examples:
  - name: Show details of a NAT gateway. (autogenerated)
    text: az network nat gateway show --name MyNatGateway --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create an HTTP listener. (autogenerated)
    text: az network application-gateway http-listener create --frontend-ip MyAppGatewayPublicIp --frontend-port MyFrontendPort --gateway-name MyAppGateway --host-name myhost --name MyHttpListener --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule show --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['network route-filter list'] = """
type: command
short-summary: List route filters.
examples:
  - name: List route filters. (autogenerated)
    text: az network route-filter list --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the virtual network gateway is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of the virtual network gateway is met (autogenerated)
    text: az network vnet-gateway wait --exists --name MyVnetGateway --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show a resource policy remediation. (autogenerated)
    text: az policy remediation show --name myremediation --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the Private DNS zone is met. (autogenerated)
    text: az network private-dns zone wait --exists --name www.mysite.com --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['mariadb server create'] = """
type: command
short-summary: Create a server.
examples:
  - name: Create a server. (autogenerated)
    text: az mariadb server create --admin-password password --admin-user username --location northeurope --name testsvr --resource-group testgroup --sku-name B_Gen5_1 --subscription mysubscription --version 10.2
    crafted: true
"""
...
examples:
  - name: Delete the specified private endpoint connection associated with a PostgreSQL server. (autogenerated)
    text: az postgres server private-endpoint-connection delete --name myprivateendpointconnectionassociatedserver --resource-group myresourcegroup --server-name myserver
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at resource group. (autogenerated)
    text: |
        az deployment group validate --parameters exampleString='inline string' exampleArray='("value1", "value2")' --resource-group testrg --template-file demotemplate.json
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at management group. (autogenerated)
    text: az deployment mg validate --location WestUS --management-group-id testmg --parameters MyValue=This MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Shows a security contact. (autogenerated)
    text: |
        az security contact show --name "default1" --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Upload a file to a storage blob. (autogenerated)
    text: az storage blob upload --account-key 00000000 --account-name myaccount --container-name MyContainer --file /path/to/file --name MyBlob
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file. (autogenerated)
    text: az storage file generate-sas --account-key 00000000 --account-name MyStorageAccount --expiry 2037-12-31T23:59:00Z --path path/file.txt --permissions rcdw --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Turn off logging for a storage account (autogenerated)
    text: az storage logging off --account-key 00000000 --account-name MyAccount --services qt
    crafted: true
"""
...
examples:
  - name: Show metrics settings for a storage account. (autogenerated)
    ...
    crafted: true
  - name: Show metrics settings for a storage account. (autogenerated)
    text: az storage metrics show --connection-string myconnectionstring
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    text: az disk wait --created --name MyManagedDisk --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
