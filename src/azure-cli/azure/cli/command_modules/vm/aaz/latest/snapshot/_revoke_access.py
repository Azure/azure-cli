...
class RevokeAccess(AAZCommand):
    """Revoke access to a snapshot.

    :example: Revoke read access to a snapshot.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SnapshotsRevokeAccess(ctx=self.ctx)()
    ...
    class SnapshotsRevokeAccess(AAZHttpOperation):
...
class _RevokeAccessHelper:
    """Helper class for RevokeAccess"""


__all__ = ["RevokeAccess"]
