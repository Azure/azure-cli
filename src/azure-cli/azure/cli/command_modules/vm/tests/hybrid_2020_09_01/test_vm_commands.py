...
class VMSSCreateOptions(ScenarioTest):
    ...
    def test_vmss_update_instance_disks(self, resource_group):
        ...
        self.cmd('vmss create --image Debian --admin-username clitest1 --admin-password testPassword0 -l westus -g {rg} -n {vmss}  --storage-sku {sku} --orchestration-mode Uniform')
    ...
    def test_vmss_create_auth(self, resource_group):
        ...
        self.cmd('vmss create --image Debian -l westus -g {rg} -n {vmss_1} --authentication-type all '
                 ' --admin-username myadmin --admin-password testPassword0 --ssh-key-value \'{ssh_key}\' --orchestration-mode Uniform',
                 checks=[
        ...
        self.cmd('vmss create --image Debian -l westus -g {rg} -n {vmss_2} --authentication-type ssh '
                 ' --admin-username myadmin --ssh-key-value \'{ssh_key}\' --orchestration-mode Uniform',
                 checks=[
...
class VMSSCreateBalancerOptionsTest(ScenarioTest):  # pylint: disable=too-many-instance-attributes
    ...
    def test_vmss_create_none_options(self, resource_group):
        ...
        self.cmd('vmss create -n {vmss} -g {rg} --image Debian --load-balancer {quotes} --admin-username ubuntu --ssh-key-value \'{ssh_key}\' --public-ip-address {quotes} --tags {quotes} --vm-sku Basic_A1 --orchestration-mode Uniform')
    ...
    def test_vmss_create_with_app_gateway(self, resource_group):
        ...
        self.cmd("vmss create -n {vmss} -g {rg} --image Debian --admin-username clittester --ssh-key-value '{ssh_key}' --app-gateway apt1 --instance-count 5 --orchestration-mode Uniform",
    ...
    def test_vmss_existing_lb(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --load-balancer {lb} --image UbuntuLTS --admin-username clitester --admin-password TestTest12#$ --orchestration-mode Uniform')
    ...
    def test_vmss_single_placement_group_default_to_std_lb(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --admin-username clitester --admin-password PasswordPassword1! --image debian --single-placement-group false --orchestration-mode Uniform')
        self.cmd('vmss show -g {rg} -n {vmss}', checks=[
...
class VMSSCreatePublicIpPerVm(ScenarioTest):  # pylint: disable=too-many-instance-attributes
    ...
    def test_vmss_public_ip_per_vm_custom_domain_name(self, resource_group):
        ...
        self.cmd("vmss create -n {vmss} -g {rg} --image Debian --admin-username clittester --ssh-key-value '{ssh_key}' --vm-domain-name {dns_label} --public-ip-per-vm --dns-servers 10.0.0.6 10.0.0.5 --nsg {nsg} --orchestration-mode Uniform",
                 checks=self.check('vmss.provisioningState', 'Succeeded'))
...
class VMSSCreateExistingOptions(ScenarioTest):
    ...
    def test_vmss_create_existing_options(self):
        ...
        self.cmd('vmss create --image CentOS --os-disk-name {os_disk} --admin-username ubuntu --vnet-name {vnet} --subnet {subnet} -l "West US" --vm-sku {sku} --storage-container-name {container} -g {rg} --name {vmss} --load-balancer {lb} --ssh-key-value \'{ssh_key}\' --backend-pool-name {bepool} --use-unmanaged-disk --orchestration-mode Uniform')
        self.cmd('vmss show --name {vmss} -g {rg}', checks=[
...
class VMSSCreateExistingIdsOptions(ScenarioTest):
    ...
    def test_vmss_create_existing_ids_options(self, resource_group):
        ...
        self.cmd('vmss create --image CentOS --os-disk-name {os_disk} --admin-username ubuntu --subnet {subnet_id} -l "West US" --vm-sku {sku} --storage-container-name {container} -g {rg} --name {vmss} --load-balancer {lb_id} --ssh-key-value \'{ssh_key}\' --backend-pool-name {bepool} --use-unmanaged-disk --orchestration-mode Uniform')
        self.cmd('vmss show --name {vmss} -g {rg}', checks=[
            self.check('sku.name', '{sku}'),
            self.check('virtualMachineProfile.storageProfile.osDisk.name', '{os_disk}'),
            self.check('virtualMachineProfile.storageProfile.osDisk.vhdContainers[0].ends_with(@, \'{container}\')', True)
...
class VMSSVMsScenarioTest(ScenarioTest):
    ...
    def test_vmss_vms(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --image UbuntuLTS --authentication-type password --admin-username admin123 --admin-password TestTest12#$ --instance-count {count} --orchestration-mode Uniform')
...
class VMSSCreateIdempotentTest(ScenarioTest):
    ...
    def test_vmss_create_idempotent(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --authentication-type password --admin-username admin123 --admin-password PasswordPassword1!  --image UbuntuLTS --use-unmanaged-disk --orchestration-mode Uniform')
        self.cmd('vmss create -g {rg} -n {vmss} --authentication-type password --admin-username admin123 --admin-password PasswordPassword1!  --image UbuntuLTS --use-unmanaged-disk --orchestration-mode Uniform')
...
class VMSSILBTest(ScenarioTest):
    ...
    def test_vmss_with_ilb(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --admin-username admin123 --admin-password PasswordPassword1! --image centos --instance-count 1 --public-ip-address "" --orchestration-mode Uniform')
...
class VMSSLoadBalancerWithSku(ScenarioTest):
    ...
    def test_vmss_lb_sku(self, resource_group):
        ...
        # default to Basic
        self.cmd('vmss create -g {rg} -l {loc} -n {vmss0} --image UbuntuLTS --admin-username admin123 --admin-password PasswordPassword1! --orchestration-mode Uniform')
        ...
        self.cmd('vmss create -g {rg} -l {loc} -n {vmss} --lb {lb} --lb-sku {sku} --public-ip-address {ip} --image UbuntuLTS --admin-username admin123 --admin-password PasswordPassword1! --orchestration-mode Uniform')
...
class VMSSRollingUpgrade(ScenarioTest):
    ...
    def test_vmss_rolling_upgrade(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --image ubuntults --admin-username clitester1 --admin-password Testqwer1234! --lb {lb} --health-probe {probe} --orchestration-mode Uniform')
...
class ProximityPlacementGroupScenarioTest(ScenarioTest):
    ...
    def test_ppg_with_related_resources(self, resource_group):
        ...
        self.cmd(
            'vmss create -g {rg} -n {vmss} --image debian --admin-username debian --ssh-key-value \'{ssh_key}\' --ppg {ppg_id} --orchestration-mode Uniform')
    ...
    def test_ppg_update(self, resource_group):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --image debian --admin-username debian --ssh-key-value \'{ssh_key}\' --orchestration-mode Uniform')
        self.kwargs['vmss_id'] = self.cmd('vmss show -g {rg} -n {vmss}').get_output_in_json()['id']
