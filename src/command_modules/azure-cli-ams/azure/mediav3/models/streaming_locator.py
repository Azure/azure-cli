...
class StreamingLocator(ProxyResource):
    ...
    :type content_keys:
     list[~encoding.models.StreamingLocatorUserDefinedContentKey]
    """
    ...
    def __init__(self, asset_name=None, start_time=None, end_time=None, streaming_locator_id=None, streaming_policy_name=None, default_content_key_policy_name=None, content_keys=None):
        super(StreamingLocator, self).__init__()
