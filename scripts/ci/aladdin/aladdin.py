...
examples:
  - name: Get the properties of a specified agent pool for an Azure Container Registry. (autogenerated)
    text: az acr agentpool show --name MyAgentName --registry MyRegistry --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['acr encryption rotate-key'] = """
type: command
...
examples:
  - name: Rotate (update) the container registry's encryption key. (autogenerated)
    text: az acr encryption rotate-key --identity MyIdentities --key-encryption-key PrimaryKey --name MyRegistry
    crafted: true
"""
...
examples:
  - name: Show the container registry's encryption details. (autogenerated)
    text: az acr encryption show --name MyRegistry
    crafted: true
"""

aladdin_helps['acr identity assign'] = """
type: command
...
examples:
  - name: Assign a managed identity to a container registry. (autogenerated)
    text: |
        az acr identity assign --identities "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/MyRG/providers/Microsoft.ManagedIdentity/userAssignedIdentities/MyManagedIdentity" "/subscriptions/{SUBSCRIPTON ID}/resourcegroups/{RESOURCE GROUP}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUserAssignedIdentitiy" --name MyRegistry
    crafted: true
"""

aladdin_helps['acr identity remove'] = """
type: command
short-summary: Remove a managed identity from a container registry
examples:
  - name: Remove a managed identity from a container registry. (autogenerated)
    text: |
        az acr identity remove --identities "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/MyRG/providers/Microsoft.ManagedIdentity/userAssignedIdentities/MyManagedIdentity" "/subscriptions/{SUBSCRIPTON ID}/resourcegroups/{RESOURCE GROUP}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUserAssignedIdentitiy" --name MyRegistry --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the container registry's identity details. (autogenerated)
    text: az acr identity show --name MyRegistry
    crafted: true
"""

aladdin_helps['acr pack build'] = """
type: command
short-summary: Queues a quick build task that builds an app and pushes it into an Azure Container Registry.
examples:
  - name: Queues a quick build task that builds an app and pushes it into an Azure Container Registry. (autogenerated)
    text: az acr pack build --builder MyContainer . --image hello-world:{{.Run.ID}} --pack-image-tag hello-world:{{.Run.ID}} --platform linux/arm/v7 --pull --registry MyRegistry
    crafted: true
"""

aladdin_helps['acr private-endpoint-connection approve'] = """
type: command
...
examples:
  - name: Approve a private endpoint connection request for a container registry. (autogenerated)
    text: az acr private-endpoint-connection approve --name MyPrivateEndpoint --registry-name MyRegistry
    crafted: true
"""
...
examples:
  - name: list the private link resources supported for a registry. (autogenerated)
    text: az acr private-link-resource list --name MyRegistry
    crafted: true
"""
...
aladdin_helps['acr scope-map update'] = """
type: command
short-summary: Update a scope map for an Azure Container Registry.
examples:
  - name: Update a scope map for an Azure Container Registry. (autogenerated)
    text: az acr scope-map update --add communities='12076:5010' --name MyScopeMap --registry MyRegistry
    crafted: true
"""
...
examples:
  - name: Display registry endpoints. (autogenerated)
    text: az acr show-endpoints --name MyRegistry
    crafted: true
"""
...
examples:
  - name: Download and install credentials to access a cluster (autogenerated)
    text: az acs kubernetes get-credentials --name MyContainerService --resource-group MyResourceGroup --ssh-key-file /path/to/publickey
    crafted: true
"""
...
examples:
  - name: Add a node pool to the managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool add --cluster-name MyManagedCluster --name nodepool1 --node-count 5 --os-type Linux --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the agent pool in the managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool delete --cluster-name MyManagedCluster --name nodepool1 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List node pools in the managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool list --cluster-name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Scale the node pool in a managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool scale --cluster-name MyManagedCluster --name nodepool1 --node-count 5 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details for a node pool in the managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool show --cluster-name MyManagedCluster --name nodepool1 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Upgrade the node pool in a managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool upgrade --cluster-name MyManagedCluster --kubernetes-version 1.16.9 --name nodepool1 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Enable Azure Advisor recommendations. (autogenerated)
    ...
    crafted: true
  - name: Enable Azure Advisor recommendations. (autogenerated)
    text: az advisor recommendation enable --ids /subscriptions/{SubID}
    crafted: true
"""
...
examples:
  - name: Checks whether the Media Service resource name is available. (autogenerated)
    text: az ams account check-name --location westus --name MyamsAccount
    crafted: true
"""

aladdin_helps['ams account create'] = """
type: command
short-summary: Create an Azure Media Services account.
examples:
  - name: Create an Azure Media Services account. (autogenerated)
    text: az ams account create --location westus2 --name MyamsAccount --resource-group MyResourceGroup --storage-account MyStorageAccount
    crafted: true
"""
...
examples:
  - name: Delete an Azure Media Services account. (autogenerated)
    text: az ams account delete --name myAmsAccount --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['ams account mru set'] = """
type: command
...
examples:
  - name: Set the type and number of media reserved units for an Azure Media Services account. (autogenerated)
    text: az ams account mru set --count 3 --name MyAmsAccount --resource-group MyResourceGroup --type Microsoft.Storage/storageAccounts
    crafted: true
"""
...
examples:
  - name: Show the details of media reserved units for an Azure Media Services account. (autogenerated)
    text: az ams account mru show --name MyAmsAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of an Azure Media Services account. (autogenerated)
    text: az ams account show --name $amsAccountName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Generate a new client secret for a service principal configured for an Azure Media Services account. (autogenerated)
    text: az ams account sp reset-credentials --account-name amsAccount --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an account filter. (autogenerated)
    text: az ams account-filter delete --account-name myAmsAccount --name myAmsFilter --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: List all the account filters of an Azure Media Services account. (autogenerated)
    text: az ams account-filter list --account-name MyamsAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an asset. (autogenerated)
    text: az ams asset create --account-name myAmsAccount --name myAmsName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an asset. (autogenerated)
    text: az ams asset delete --account-name myAmsAccount --name myAmsName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content (autogenerated)
    text: az ams asset get-sas-urls --account-name myAmsAccount --expiry 2020-01-01 --name myAmsAsset --permissions acuw --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: List streaming locators which are associated with this asset. (autogenerated)
    text: az ams asset list-streaming-locators --account-name MyAmsAccount --name MyAsset
    crafted: true
"""
...
examples:
  - name: Show the details of an asset. (autogenerated)
    text: az ams asset show --account-name myAmsAccount --name myAmsName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the details of an asset. (autogenerated)
    text: |
        az ams asset update --description "MyAsset" --ids /subscriptions/{SubID}/resourceGroups/{ResourceGroup}
    crafted: true
"""

aladdin_helps['ams asset-filter create'] = """
type: command
short-summary: Create an asset filter.
examples:
  - name: Create an asset filter. (autogenerated)
    text: az ams asset-filter create --account-name myamsAccount --asset-name myScaleSet --end-timestamp 2018-12-24 --force-end-timestamp 2018-12-26 --name myScaleSet --resource-group myResourceGroup --start-timestamp 2018-12-26 --timescale 60
    crafted: true
"""
...
examples:
  - name: Delete a content key policy. (autogenerated)
    text: az ams content-key-policy delete --account-name myAmsAccount --name contentKeyPolicyName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: List all the content key policies within an Azure Media Services account. (autogenerated)
    text: az ams content-key-policy list --account-name myAmsAccount --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Show an existing content key policy. (autogenerated)
    text: az ams content-key-policy show --account-name myAmsAccount --name contentKeyPolicyName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a job. (autogenerated)
    text: az ams job delete --account-name myAmsAccount --name myFirstJob_007 --resource-group myResourceGroup --transform-name transformName
    crafted: true
"""
...
examples:
  - name: Show the details of a job. (autogenerated)
    text: az ams job show --account-name myAmsAccount --name myAmsJob --resource-group myResourceGroup --transform-name transformName
    crafted: true
"""
...
examples:
  - name: Start a job. (autogenerated)
    text: az ams job start --account-name myAmsAccount --base-uri 'https://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/00000000-b215-4409-80af-529c3e853622/' --files 'Ignite-short.mp4' --name myFirstJob_007 --output-assets $outputAssetName --resource-group $resourceGroup --transform-name $transformName
    crafted: true
"""
...
examples:
  - name: Create a live event. (autogenerated)
    text: az ams live-event create --account-name amsAccount --auto-start --ips 1.2.3.4 5.6.7.8/30 --name liveEventName --preview-ips 10.0.0.11 --resource-group resourceGroup --streaming-protocol https://ams.windows.net/54826b22-38d6-4fb2-bad9-b7983a3e853622/
    crafted: true
"""
...
examples:
  - name: Delete a live event. (autogenerated)
    text: az ams live-event delete --account-name amsAccount --name liveEventName --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a live event. (autogenerated)
    text: az ams live-event show --account-name amsAccount --name liveEventName --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Start a live event. (autogenerated)
    text: az ams live-event start --account-name amsAccount --name liveEventName --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Stop a live event. (autogenerated)
    text: az ams live-event stop --account-name amsAccount --name liveEventName --resource-group resourceGroup
    crafted: true
"""

aladdin_helps['ams live-output create'] = """
type: command
short-summary: Create a live output.
examples:
  - name: Create a live output. (autogenerated)
    text: az ams live-output create --account-name amsAccount --archive-window-length 10 --asset-name assetName --fragments-per-ts-segment 1 --live-event-name liveEventName --name liveOutbound --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a live output. (autogenerated)
    text: az ams live-output delete --account-name amsAccount --live-event-name liveEventName --name liveoutput --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: List all the live outputs in a live event. (autogenerated)
    text: az ams live-output list --account-name amsAccount --live-event-name liveEventName --resource-group resourceGroup
    crafted: true
"""

aladdin_helps['ams streaming-endpoint create'] = """
type: command
short-summary: Create a streaming endpoint.
examples:
  - name: Create a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint create --account-name MyamsAccount --auto-start --name MyStreamingEndpoint --resource-group MyResourceGroup --scale-units 1
    crafted: true
"""
...
examples:
  - name: Delete a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint delete --account-name MyamsAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List all the streaming endpoints within an Azure Media Services account. (autogenerated)
    text: az ams streaming-endpoint list --account-name MyamsAccount --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['ams streaming-endpoint scale'] = """
type: command
short-summary: Set the scale of a streaming endpoint.
examples:
  - name: Set the scale of a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint scale --account-name MyamsAccount --name MyStreamingEndpoint --resource-group MyResourceGroup --scale-units 1
    crafted: true
"""
...
examples:
  - name: Show the details of a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint show --account-name MyamsAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Start a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint start --account-name MyamsAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Stop a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint stop --account-name MyamsAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the details of a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint update --account-name $amsAccountName --cdn-profile $amsProfileName --cdn-provider $amsServiceName --name $amsEndpointName --resource-group $resourceGroup --subscription $amsSubscription
    crafted: true
"""
...
examples:
  - name: Create a streaming locator. (autogenerated)
    text: az ams streaming-locator create --account-name $amsAccountName --asset-name $amsAssetName --name $amsLocationName --resource-group $resourceGroup --streaming-policy-name $amsPolicyName
    crafted: true
"""
...
examples:
  - name: List paths supported by a streaming locator. (autogenerated)
    text: az ams streaming-locator get-paths --account-name MyAmsAccount --name MyStreamingLocation --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List all the streaming locators within an Azure Media Services account. (autogenerated)
    text: az ams streaming-locator list --account-name MyAmsAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List content keys used by a streaming locator. (autogenerated)
    text: az ams streaming-locator list-content-keys --account-name MyAmsAccount --name MyStreamingLocation --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a streaming locator (autogenerated)
    text: az ams streaming-locator show --account-name MyamsAccount --name MyStreamingLocation --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['ams streaming-policy create'] = """
type: command
short-summary: Create a streaming policy.
examples:
  - name: Create a streaming policy. (autogenerated)
    text: az ams streaming-policy create --account-name myAmsAccount --cbcs-protocols '*' --cenc-protocols '*' --name '*' --resource-group $resource
    crafted: true
"""
...
examples:
  - name: List all the streaming policies within an Azure Media Services account. (autogenerated)
    text: az ams streaming-policy list --account-name MyamsAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a transform. (autogenerated)
    text: az ams transform create --account-name myAmsAccount --description transformName --name transformName --preset AdaptiveStreaming --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a transform. (autogenerated)
    text: az ams transform delete --account-name myAmsAccount --name transformName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: List all the transforms of an Azure Media Services account. (autogenerated)
    text: az ams transform list --account-name myAmsAccount --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a transform. (autogenerated)
    text: az ams transform show --account-name myAmsAccount --name transformName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Show details of an API Management service instance. (autogenerated)
    text: az apim show --name MyApim --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an API Management service instance. (autogenerated)
    text: az apim update --enable-managed-identity true --name MyApim --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete app service environment. (autogenerated)
    text: az appservice ase delete --name MyAseName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Unbind a hostname from a function app. (autogenerated)
    text: az functionapp config hostname delete --hostname 127.0.0.1 --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a function app. (autogenerated)
    ...
    crafted: true
  - name: Create a function app. (autogenerated)
    text: az functionapp create --consumption-plan-location westus --functions-version 2 --name MyUniqueAppName --resource-group MyResourceGroup --runtime python --storage-account MyStorageAccount
    crafted: true
"""
...
aladdin_helps['functionapp deployment user set'] = """
type: command
...
examples:
  - name: Update deployment credentials. (autogenerated)
    text: az functionapp deployment user set --password MyPassword --user-name MyUser
    crafted: true
"""
...
examples:
  - name: Create an App Service Plan for an Azure Function. (autogenerated)
    text: az functionapp plan create --is-linux true --location westus --name MyPlan --number-of-workers 1 --resource-group MyResourceGroup --sku B1
    crafted: true
"""
...
examples:
  - name: Delete an App Service Plan. (autogenerated)
    text: az functionapp plan delete --name MyPlan --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['functionapp plan update'] = """
type: command
...
examples:
  - name: Update an App Service plan for an Azure Function. (autogenerated)
    text: az functionapp plan update --name MyPlan --number-of-workers 1 --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['webapp config backup restore'] = """
type: command
short-summary: Restore a web app from a backup.
examples:
  - name: Restore a web app from a backup. (autogenerated)
    text: az webapp config backup restore --backup-name $backupname --container-url $sasurl --ignore-hostname-conflict --overwrite --resource-group myResourceGroup --subscription MySubscription --webapp-name $webappname
    crafted: true
"""
...
aladdin_helps['webapp config hostname delete'] = """
type: command
short-summary: Unbind a hostname from a web app.
examples:
  - name: Unbind a hostname from a web app. (autogenerated)
    text: az webapp config hostname delete --hostname 80 --resource-group MyResourceGroup --webapp-name MyWebapp
    crafted: true
"""
...
examples:
  - name: Restore a web app snapshot. (autogenerated)
    text: |
        az webapp config snapshot restore --name MyWebapp --resource-group MyResourceGroup --slot Staging --source-name MySourceApp --source-resource-group MyResourceGroup --time "2018-05-20T11:24:12Z"
    crafted: true
"""
...
aladdin_helps['webapp deployment user set'] = """
type: command
short-summary: Update deployment credentials.
long-summary: All function and web apps in the subscription will be impacted since they share the same deployment credentials.
examples:
  - name: Update deployment credentials. (autogenerated)
    text: az webapp deployment user set --password $password --user-name $username
    crafted: true
"""
...
aladdin_helps['webapp log tail'] = """
type: command
short-summary: Start live log tracing for a web app.
long-summary: This command may not work with web apps running on Linux.
examples:
  - name: Start live log tracing for a web app. (autogenerated)
    text: az webapp log tail --ids $(az --name MyWebapp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show details of a particular backed up item. (autogenerated)
    ...
    crafted: true
  - name: Show details of a particular backed up item. (autogenerated)
    text: az backup item show --backup-management-type AzureIaasVM --container-name MyContainer --name MyItem --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Update the existing policy with the provided details. (autogenerated)
    text: az backup policy set --name MyBackup --policy MyPolicy --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Trigger the discovery of any unprotected items of the given workload type in the given container. (autogenerated)
    text: az backup protectable-item initialize --container-name MyContainer --resource-group MyResourceGroup --subscription MySubscription --vault-name MyVault --workload-type MSSQL
    crafted: true
"""
...
examples:
  - name: Perform an on-demand backup of a backed up item. (autogenerated)
    text: az backup protection backup-now --backup-management-type AzureIaasVM --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --retain-until 10 --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Stop protecting a backed up item (autogenerated)
    text: az backup protection disable --backup-management-type AzureFiles --container-name MyContainer --delete-backup-data false --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Construct the recovery configuration of an Azure workload backed up item. (autogenerated)
    text: az backup recoveryconfig show --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --restore-mode OriginalLocation --rp-name recoverypoint --target-item-name OriginalItem --target-server-name bing --target-server-type bing.com --vault-name MyVault --workload-type MSSQL
    crafted: true
"""
...
examples:
  - name: Restore disks of the backed VM from the specified recovery point. (autogenerated)
    text: az backup restore restore-disks --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --rp-name recoverypoint --storage-account 'https://storageacc.blob.core.windows.net/' --target-resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Create a Batch account with the specified parameters. (autogenerated)
    text: az batch account create --location westus --name MybatchAccount --resource-group MyResourceGroup --storage-account MyStorageAccount
    crafted: true
"""
...
aladdin_helps['batch application package create'] = """
type: command
short-summary: Create a Batch application package record and activate it.
examples:
  - name: Create a Batch application package record and activate it. (autogenerated)
    text: az batch application package create --application-name mybatchaccount --name mybatchaccount --package-file mybatchaccount.zip --resource-group myResourceGroup --version-name 1.0
    crafted: true
"""

aladdin_helps['batch application set'] = """
type: command
short-summary: Update properties for a Batch application.
examples:
  - name: Update properties for a Batch application. (autogenerated)
    text: az batch application set --application-name mybatchaccount --default-version 1.0 --name mybatchaccount --resource-group myResourceGroup
    crafted: true
"""

aladdin_helps['batch application summary list'] = """
type: command
...
examples:
  - name: Lists all of the applications available in the specified account. (autogenerated)
    text: az batch application summary list --account-endpoint https://contoso.azurewebsites.net/api/f1?code=code --account-name contoso
    crafted: true
"""

aladdin_helps['batch job create'] = """
type: command
short-summary: Add a job to a Batch account.
examples:
  - name: Add a job to a Batch account. (autogenerated)
    text: az batch job create --id mybatchjob --pool-id mypool
    crafted: true
"""

aladdin_helps['batch job set'] = """
type: command
...
examples:
  - name: Update the properties of a Batch job (autogenerated)
    text: az batch job set --job-id mybatchjob --on-all-tasks-complete on
    crafted: true
"""

aladdin_helps['batch job-schedule create'] = """
type: command
short-summary: Add a Batch job schedule to an account.
examples:
  - name: Add a Batch job schedule to an account. (autogenerated)
    text: az batch job-schedule create --account-endpoint https://contoso.azurewebsites.net/api/f1?code=code --account-name mystorageaccount --json-file job.json
    crafted: true
"""

aladdin_helps['batch node user create'] = """
type: command
short-summary: Add a user account to a Batch compute node.
examples:
  - name: Add a user account to a Batch compute node. (autogenerated)
    text: |
        az batch node user create --account-endpoint https://contoso.azurewebsites.net/api/f1?code=code --account-key 00000000 --account-name MyAccount --is-admin --name MyNFS --node-id 4 --password "?sr=b&sp=rw&se=2018-01-01T00:00:00Z" --pool-id MyPool --subscription MySubscription
    crafted: true
"""

aladdin_helps['batch pool resize'] = """
type: command
short-summary: Resize or stop resizing a Batch pool.
examples:
  - name: Resize or stop resizing a Batch pool. (autogenerated)
    text: az batch pool resize --abort --pool-id mypool
    crafted: true
"""

aladdin_helps['batch pool set'] = """
type: command
...
examples:
  - name: Update the properties of a Batch pool (autogenerated)
    text: az batch pool set --account-endpoint https://contoso.azurewebsites.net/api/f1?code=code --account-key 00000000 --account-name MyNFS --pool-id MyPool --start-task-command-line mytask
    crafted: true
"""

aladdin_helps['batch task create'] = """
type: command
short-summary: Create Batch tasks.
examples:
  - name: Create Batch tasks. (autogenerated)
    text: az batch task create --job-id MyJob --json-file task.json
    crafted: true
"""

aladdin_helps['batch task file download'] = """
type: command
short-summary: Download the content of a Batch task file.
examples:
  - name: Download the content of a Batch task file. (autogenerated)
    text: az batch task file download --destination . --file-path log.txt --job-id MyJob --task-id MyTask
    crafted: true
"""
...
examples:
  - name: List experiments (autogenerated)
    text: az batchai experiment list --only-show-errors --resource-group MyResourceGroup --subscription MySubscription --workspace MyWorkspace
    crafted: true
"""
...
examples:
  - name: List workspaces (autogenerated)
    text: az batchai workspace list --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete an OAuth connection setting on a bot. (autogenerated)
    text: az bot authsetting delete --name botName --resource-group MyResourceGroup --setting-name MyAuthorization
    crafted: true
"""
...
examples:
  - name: Show all OAuth connection settings on a bot. (autogenerated)
    text: az bot authsetting list --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show details of an OAuth connection setting on a bot. (autogenerated)
    text: az bot authsetting show --name botName --resource-group MyResourceGroup --setting-name MyAuthorization
    crafted: true
"""
...
examples:
  - name: Create a new v4 SDK bot. (autogenerated)
    text: |
        az bot create --appid MyAppId --description "MyBot" --kind ServiceCatalog --location westus --name Mybot --resource-group MyResourceGroup --sku B_Gen5_1 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete an existing bot. (autogenerated)
    text: az bot delete --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the Directline Channel on a bot. (autogenerated)
    text: az bot directline delete --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details of the Directline Channel on a bot. (autogenerated)
    text: az bot directline show --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the DirectLine Channel on a bot with only v3 protocol enabled (autogenerated)
    text: az bot directline update --enable-enhanced-auth true --name MyBot --resource-group MyResourceGroup --trusted-origins /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Solutions/s1/providers/Microsoft.Solutions/s1
    crafted: true
"""
...
examples:
  - name: Get details of the Facebook Channel on a bot. (autogenerated)
    text: az bot facebook show --name botName --resource-group MyResourceGroup --with-secrets mySecret
    crafted: true
"""
...
examples:
  - name: Delete the Microsoft Teams Channel on a bot. (autogenerated)
    text: az bot msteams delete --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details of the Microsoft Teams Channel on a bot. (autogenerated)
    text: az bot msteams show --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Publish to a bot's associated app service. (autogenerated)
    text: az bot publish --code-dir /subscriptions/{SubID}/resourceGroups/{ResourceGroup} --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details of the Webchat Channel on a bot. (autogenerated)
    text: az bot webchat show --name botName --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['cdn endpoint rule action add'] = """
type: command
short-summary: Add an action to a delivery rule.
examples:
  - name: Add an action to a delivery rule. (autogenerated)
    text: |
        az cdn endpoint rule action add --action-name "UrlRedirect" --header-action "UrlRedirect" --header-name name --header-value "?sr=b&sp=rw&se=2018-01-01T00:00:00Z" --name endpoint --profile-name profile --resource-group resource --rule-name name
    crafted: true
"""
...
examples:
  - name: Add a condition to a delivery rule. (autogenerated)
    text: az cdn endpoint rule condition add --match-values match-variable --match-variable RemoteAddress --name endpoint --negate-condition name --operator GeoMatch --profile-name profile --resource-group resourceGroup --rule-name name
    crafted: true
"""

aladdin_helps['cdn endpoint stop'] = """
type: command
short-summary: Stop a CDN endpoint.
examples:
  - name: Stop a CDN endpoint. (autogenerated)
    text: az cdn endpoint stop --name endpoint --profile-name profile --resource-group group --subscription MySubscription
    crafted: true
"""

aladdin_helps['cdn endpoint update'] = """
type: command
short-summary: Update a CDN endpoint to manage how content is delivered.
examples:
  - name: Update a CDN endpoint to manage how content is delivered. (autogenerated)
    text: az cdn endpoint update --content-types-to-compress Dockerfile --enable-compression true --name MyEndpoint --profile-name MyProfile --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Set the CDN WAF policy applied to a CDN endpoint. (autogenerated)
    text: az cdn endpoint waf policy set --endpoint-name endpoint --only-show-errors --profile-name profile --resource-group group --waf-policy-id policyId
    crafted: true
"""
...
examples:
  - name: Update a CDN profile. (autogenerated)
    text: az cdn profile update --name profile --resource-group group --tags key=value
    crafted: true
"""
...
examples:
  - name: Add a custom rule to a CDN WAF policy. (autogenerated)
    text: |
        az cdn waf policy custom-rule set --action Redirect --match-condition match-variable=RequestUri operator=Contains "match-value= " --name customrule --only-show-errors --policy-name policy --priority 100 --resource-group group
    crafted: true
"""

aladdin_helps['cloud register'] = """
type: command
...
examples:
  - name: Register a cloud. (autogenerated)
    text: az cloud register --endpoint-active-directory MyCloud --endpoint-active-directory-graph-resource-id MyLogAnalysisWorkspaceID --endpoint-active-directory-resource-id MyLogAnalysisWorkspaceID --endpoint-gallery MyGallery --endpoint-resource-manager MyResourceGroup --name MyManagedCluster
    crafted: true
"""
...
aladdin_helps['cognitiveservices account update'] = """
type: command
short-summary: Manage Azure Cognitive Services accounts.
long-summary: This article lists the Azure CLI commands for Azure Cognitive Services account and subscription management only. Refer to the documentation at https://docs.microsoft.com/azure/cognitive-services/ for individual services to learn how to use the APIs and supported SDKs.
parameters:
...
examples:
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account update --custom-domain MyDomain --name MyAccount --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['cache delete'] = """
type: command
short-summary: Delete an object from the cache.
examples:
  - name: Delete an object from the cache. (autogenerated)
    text: az cache delete --name MyCache --resource-group MyResourceGroup --resource-type Microsoft.Compute/snapshots
    crafted: true
"""

aladdin_helps['cache show'] = """
type: command
short-summary: Show the contents of a specific object in the cache.
examples:
  - name: Show the contents of a specific object in the cache. (autogenerated)
    text: az cache show --name MyCache --resource-group MyResourceGroup --resource-type Microsoft.Compute/snapshots
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb cassandra keyspace throughput show --account-name $accountName --name $keySpaceName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Update the throughput of the Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb cassandra keyspace throughput update --account-name $accountName --name $keySpaceName --resource-group $resourceGroupName --throughput 400
    crafted: true
"""
...
examples:
  - name: Delete the Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table delete --account-name $accountName --keyspace-name $keySpaceName --name $tableName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table show --account-name $accountName --keyspace-name $keySpaceName --name $tableName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Creates an Azure Cosmos DB database. (autogenerated)
    text: az cosmosdb database create --db-name $accountName --name $databaseName --resource-group-name $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Deletes an Azure Cosmos DB database (autogenerated)
    ...
    crafted: true
  - name: Deletes an Azure Cosmos DB database. (autogenerated)
    text: az cosmosdb database delete --db-name $accountName --key $key --url-connection $connectionName
    crafted: true
"""
...
examples:
  - name: Shows an Azure Cosmos DB database (autogenerated)
    ...
    crafted: true
  - name: Shows an Azure Cosmos DB database. (autogenerated)
    text: az cosmosdb database show --db-name $accountName --key $key --url-connection $connectionName
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb gremlin database delete --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Show the details of a Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb gremlin database show --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb gremlin database throughput show --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph delete --account-name $accountName --database-name $databaseName --name $graphName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: List the Gremlin graphs under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph list --account-name $accountName --database-name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Show the details of a Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph show --account-name $accountName --database-name $databaseName --name $graphName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: az cosmosdb mongodb collection delete --account-name $accountName --database-name $databaseName --name $collectionName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: List the MongoDB collections under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: az cosmosdb mongodb collection list --account-name $accountName --database-name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Show the details of a MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: az cosmosdb mongodb collection show --account-name $accountName --database-name $databaseName --name $collectionName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Get the throughput of the MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: az cosmosdb mongodb collection throughput show --account-name $accountName --database-name $databaseName --name $collectionName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Update the throughput of the MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: az cosmosdb mongodb collection throughput update --account-name $accountName --database-name $databaseName --name $collectionName --resource-group $resourceGroupName --throughput 400
    crafted: true
"""
...
examples:
  - name: Create an MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb mongodb database create --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Show the details of a MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb mongodb database show --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Get the throughput of the MongoDB database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb mongodb database throughput show --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Regenerate an access key for a Azure Cosmos DB database account. (autogenerated)
    text: az cosmosdb regenerate-key --key-kind PrimaryKey --name MyCosmosDBAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: az cosmosdb sql container show --account-name $accountName --database-name $databaseName --name $containerName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Get the throughput of the SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: az cosmosdb sql container throughput show --account-name $accountName --database-name $databaseName --name $containerName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Update the throughput of the SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: az cosmosdb sql container throughput update --account-name $accountName --database-name $databaseName --name $containerName --resource-group $resourceGroupName --throughput 400
    crafted: true
"""
...
examples:
  - name: Create an SQL database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb sql database create --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Delete the SQL database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb sql database delete --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Show the details of a SQL database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb sql database show --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Get the throughput of the SQL database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb sql database throughput show --account-name $accountName --name $databaseName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Update the throughput of the SQL database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb sql database throughput update --account-name $accountName --name $databaseName --resource-group $resourceGroupName --throughput 400
    crafted: true
"""
...
examples:
  - name: Create an SQL trigger under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql trigger create --account-name MyAccount --body TriggerBody --container-name MyContainer --database-name MyDatabase --name MyTrigger --operation TriggerWithTags --resource-group MyResourceGroup --type TriggerType
    crafted: true
"""
...
examples:
  - name: Delete the SQL trigger under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql trigger delete --account-name $accountName --container-name $containerName --database-name $databaseName --name $triggerName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: List the SQL triggers under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql trigger list --account-name $accountName --container-name $containerName --database-name $databaseName --resource-group $resourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a SQL trigger under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql trigger show --account-name $accountName --container-name $containerName --database-name $databaseName --name $triggerName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Delete the SQL user defined function under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql user-defined-function delete --account-name MyAccount --container-name MyContainer --database-name MyDatabase --name MyUserDef --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a SQL user defined function under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql user-defined-function show --account-name $account --container-name $container --database-name $database --name $function --resource-group $resource
    crafted: true
"""
...
examples:
  - name: Create an Table under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb table create --account-name $accountName --name $tableName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Delete the Table under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb table delete --account-name $accountName --name $tableName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: List the Tables under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb table list --account-name $accountName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Show the details of a Table under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb table show --account-name $accountName --name $tableName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Table under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb table throughput show --account-name $accountName --name $tableName --resource-group $resourceGroupName
    crafted: true
"""
...
examples:
  - name: Update the throughput of the Table under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb table throughput update --account-name $accountName --name $tableName --resource-group $resourceGroupName --throughput 400
    crafted: true
"""
...
examples:
  - name: Update an Azure Cosmos DB database account. (autogenerated)
    ...
    crafted: true
  - name: Update an Azure Cosmos DB database account. (autogenerated)
    text: az cosmosdb update --ip-range-filter MyIprange --name MyCosmosDBAccount --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['dla account create'] = """
type: command
...
examples:
  - name: Create a Data Lake Analytics account. (autogenerated)
    text: az dla account create --account mydatalakestoragegen1 --default-data-lake-store MyStorageAccount --location westus --resource-group MyResourceGroup --tier Standard
    crafted: true
"""

aladdin_helps['dla account show'] = """
type: command
...
examples:
  - name: Get the details of a Data Lake Analytics account. (autogenerated)
    text: az dla account show --account MyDatalakestorage
    crafted: true
"""

aladdin_helps['dla catalog credential create'] = """
type: command
...
examples:
  - name: Create a new catalog credential for use with an external data source. (autogenerated)
    text: az dla catalog credential create --account mydatalakestoragegen1 --credential-name mycredential --database-name mydb --password password --uri https://datalakestorage.blob.core.windows.net/ --user-name myusername
    crafted: true
"""

aladdin_helps['dla catalog credential delete'] = """
type: command
short-summary: Delete a catalog credential.
examples:
  - name: Delete a catalog credential. (autogenerated)
    text: az dla catalog credential delete --account mydatalakestoragegen1 --credential-name mycredential --database-name mydb
    crafted: true
"""

aladdin_helps['dla job list'] = """
type: command
short-summary: List Data Lake Analytics jobs.
examples:
  - name: List Data Lake Analytics jobs. (autogenerated)
    text: az dla job list --account MyDlaAccount
    crafted: true
"""

aladdin_helps['dla job submit'] = """
type: command
...
examples:
  - name: Submit a job to a Data Lake Analytics account. (autogenerated)
    text: az dla job submit --account mydatalakestoragegen1 --job-name mydatalakestoragegen1 --script myscript
    crafted: true
"""
...
aladdin_helps['dls account firewall create'] = """
type: command
...
examples:
  - name: Creates a firewall rule in a Data Lake Store account. (autogenerated)
    text: az dls account firewall create --account mydatalakestoragegen1 --end-ip-address 107.46.14.1 --firewall-rule-name myrule --start-ip-address 107.46.14.1
    crafted: true
"""

aladdin_helps['dls account firewall delete'] = """
type: command
short-summary: Deletes a firewall rule in a Data Lake Store account.
examples:
  - name: Deletes a firewall rule in a Data Lake Store account. (autogenerated)
    text: az dls account firewall delete --account mydatalakestoragegen1 --firewall-rule-name myrule
    crafted: true
"""
...
aladdin_helps['dls account firewall update'] = """
type: command
short-summary: Updates a firewall rule in a Data Lake Store account.
examples:
  - name: Updates a firewall rule in a Data Lake Store account. (autogenerated)
    text: az dls account firewall update --account mydatalakestoragegen1 --end-ip-address 107.46.14.1 --firewall-rule-name myrule --resource-group myresourcegroup --start-ip-address 107.46.14.1 --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['dls account network-rule create'] = """
type: command
...
examples:
  - name: Creates a virtual network rule in a Data Lake Store account. (autogenerated)
    text: az dls account network-rule create --account-name MyDatalakestoragegen1 --name MyNetworkRule --resource-group MyResourceGroup --subnet MySubnet
    crafted: true
"""
...
aladdin_helps['dls fs access set-owner'] = """
type: command
...
examples:
  - name: Set the owner information for a file or folder in a Data Lake Store account. (autogenerated)
    text: az dls fs access set-owner --account mydatalakestoragegen1 --owner owner --path /
    crafted: true
"""
...
examples:
  - name: Preview the content of a file in a Data Lake Store account. (autogenerated)
    text: az dls fs preview --account mydatalakestoragegen1 --path /
    crafted: true
"""
...
examples:
  - name: Check if a given Project name is available within a given instance of DMS as well as the name's validity (autogenerated)
    text: az dms project check-name --name mydms --resource-group myresourcegroup --service-name mydms
    crafted: true
"""
...
examples:
  - name: Show the details for an instance of the Data Migration Service. (autogenerated)
    text: az dms show --name MyDms --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['eventgrid domain topic delete'] = """
type: command
short-summary: Delete a domain topic under a domain.
examples:
  - name: Delete a domain topic under a domain. (autogenerated)
    text: az eventgrid domain topic delete --domain-name MyDomain --name MyTopic --only-show-errors --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Regenerate a shared access key of a topic (autogenerated)
    text: az eventgrid topic key regenerate --key-name 00000000 --name MyTopic --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['eventhubs georecovery-alias break-pair'] = """
type: command
...
examples:
  - name: Disables Geo-Disaster Recovery Configuration Alias and stops replicating changes from primary to secondary namespaces. (autogenerated)
    text: az eventhubs georecovery-alias break-pair --ids $(az
    crafted: true
"""
...
examples:
  - name: Regenerate the connection strings of Authorizationrule for the namespace. (autogenerated)
    text: az eventhubs namespace authorization-rule keys renew --key PrimaryKey --key-value PrimaryKey --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['hdinsight monitor enable'] = """
type: command
short-summary: Enable the Azure Monitor logs integration on an HDInsight cluster.
examples:
  - name: Enable the Azure Monitor logs integration on an HDInsight cluster (autogenerated)
    text: az hdinsight monitor enable --name MyCluster --resource-group MyResourceGroup --workspace MyWorkspace
    crafted: true
"""



aladdin_helps['iot central app delete'] = """
type: command
short-summary: Delete an IoT Central application.
examples:
  - name: Delete an IoT Central application. (autogenerated)
    text: az iot central app delete --name MyIotcApp --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['iot dps linked-hub update'] = """
type: command
short-summary: Update a linked IoT hub in an Azure IoT Hub device provisioning service.
examples:
  - name: Update a linked IoT hub in an Azure IoT Hub device provisioning service. (autogenerated)
    text: az iot dps linked-hub update --apply-allocation-policy true --dps-name MyDps --linked-hub MyLinkedHub --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Deletes an Azure IoT Hub certificate. (autogenerated)
    text: az iot hub certificate delete --etag AAAAAAAAAAA= --hub-name MyIotHub --name MyCert --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an Azure IoT Hub certificate. (autogenerated)
    text: az iot hub certificate update --etag AAAAAAAAAAA= --hub-name MyIotHub --name MyCert --path /certificates/NewCertificate.pem --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an event hub consumer group. (autogenerated)
    text: az iot hub consumer-group delete --hub-name MyIotHub --name MyConsumerGroup
    crafted: true
"""
...
examples:
  - name: Create an Azure IoT hub. (autogenerated)
    text: az iot hub create --location westus2 --name MyIotHub --resource-group MyResourceGroup --sku Standard
    crafted: true
"""
...
examples:
  - name: Update a route in IoT Hub (autogenerated)
    text: |
        az iot hub route update --condition "ToLocalClusterNode" --enabled true --endpoint-name $endpoint --hub-name $iotHubName --resource-group $resource --route-name $route --source-type DeviceMessages
    crafted: true
"""
...
aladdin_helps['keyvault secret set'] = """
type: command
short-summary: Create a secret (if one doesn't exist) or update a secret in a KeyVault.
examples:
  - name: Create a secret (if one doesn't exist) or update a secret in a KeyVault. (autogenerated)
    text: az keyvault secret set --name mySecret --value mySecret --vault-name myKeyVault
    crafted: true
"""
...
examples:
  - name: Remove a Key Vault managed Azure Storage Account and all associated SAS definitions (autogenerated)
    text: az keyvault storage remove --id 00000000-0000-0000-0000-000000000000
    crafted: true
"""
...
examples:
  - name: Update the properties of a key vault. (autogenerated)
    ...
    crafted: true
  - name: Update the properties of a key vault. (autogenerated)
    text: az keyvault update --name MyKeyVault --set tags.no_80
    crafted: true
"""
...
examples:
  - name: Create a maps account. (autogenerated)
    ...
    crafted: true
  - name: Create a maps account. (autogenerated)
    text: az maps account create --accept-tos --name MyMapAccount --resource-group MyResourceGroup --sku Standard
    crafted: true
"""
...
examples:
  - name: Delete a maps account. (autogenerated)
    ...
    crafted: true
  - name: Delete a maps account. (autogenerated)
    text: az maps account delete --ids $(az
    crafted: true
"""
...
examples:
  - name: Renew either the primary or secondary key for use with the Maps APIs. (autogenerated)
    text: az maps account keys renew --key PrimaryKey --name MyMapAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['monitor activity-log alert action-group remove'] = """
type: command
...
examples:
  - name: Remove action groups from this activity log alert. (autogenerated)
    text: az monitor activity-log alert action-group remove --action-group MyActionGroup --name MyActivityLogAlertName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show details of an autoscale profile. (autogenerated)
    text: az monitor autoscale profile show --autoscale-name MyAutoscale --name Christmas --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['monitor autoscale rule delete'] = """
type: command
short-summary: Remove autoscale rules from a profile.
examples:
  - name: Remove autoscale rules from a profile. (autogenerated)
    text: az monitor autoscale rule delete --autoscale-name MyAutoscale --index 2 --profile-name MyAutoscaleProfile --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a workspace instance. (autogenerated)
    text: az monitor log-analytics workspace delete --force true --resource-group MyResourceGroup --workspace-name MyWorkspace
    crafted: true
"""
...
aladdin_helps['monitor log-analytics workspace linked-service create'] = """
type: command
short-summary: Create a linked service.
examples:
  - name: Create a linked service. (autogenerated)
    text: az monitor log-analytics workspace linked-service create --name MyLinkedService --resource-group MyResourceGroup --resource-id /subscriptions/{SubID}/resourceGroups/{ResourceGroup} --workspace-name MyWorkspace
    crafted: true
"""

aladdin_helps['monitor log-analytics workspace linked-service delete'] = """
type: command
short-summary: Delete a linked service.
examples:
  - name: Delete a linked service. (autogenerated)
    text: az monitor log-analytics workspace linked-service delete --name MyLinkedService --resource-group MyResourceGroup --subscription MySubscription --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update a workspace instance. (autogenerated)
    text: az monitor log-analytics workspace update --ingestion-access Allow --resource-group MyResourceGroup --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  ...
  - name: Create a log profile. (autogenerated)
    text: |
        az monitor log-profiles create --categories "Delete" --days 0 --enabled true --location westus2 --locations westus --name MyLogProfile --only-show-errors --storage-account-id MyStorageAccount --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a private link scope resource. (autogenerated)
    text: az monitor private-link-scope create --name MyPLSName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a monitor private link scope resource. (autogenerated)
    text: az monitor private-link-scope delete --name MyPLSName --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['monitor private-link-scope scoped-resource create'] = """
type: command
...
examples:
  - name: Create a scoped resource for a private link scope resource. (autogenerated)
    text: az monitor private-link-scope scoped-resource create --linked-resource MyLinkedResource --name MySub --resource-group MyResourceGroup --scope-name MySub
    crafted: true
"""

aladdin_helps['monitor private-link-scope scoped-resource list'] = """
type: command
...
examples:
  - name: List all scoped resource of a private link scope resource (autogenerated)
    text: az monitor private-link-scope scoped-resource list --resource-group MyResourceGroup --scope-name MySub
    crafted: true
"""
...
examples:
  - name: Show a monitor private link scope resource. (autogenerated)
    text: az monitor private-link-scope show --name MyPLSName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a NAT gateway. (autogenerated)
    text: az network nat gateway update --name MyNatGateway --public-ip-addresses MyPublicIp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the tags of the specified ANF pool. (autogenerated)
    text: az netappfiles pool update --account-name myaccountname --pool-name mypoolname --resource-group mygroupname --size 8
    crafted: true
"""
...
examples:
  - name: Update a frontend IP address. (autogenerated)
    ...
    crafted: true
  - name: Update a frontend IP address. (autogenerated)
    text: az network application-gateway frontend-ip update --gateway-name MyAppGateway --name MyFrontendIp --remove tags.no_80 --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['network application-gateway http-listener create'] = """
type: command
short-summary: Create an HTTP listener.
examples:
  - name: Create an HTTP listener. (autogenerated)
    text: az network application-gateway http-listener create --frontend-ip MyFrontendIp --frontend-port 80 --gateway-name MyAppGateway --host-name 127.0.0.1 --name MyHttpListener --resource-group MyResourceGroup --ssl-cert 111_aaa
    crafted: true
"""

aladdin_helps['network application-gateway http-listener update'] = """
type: command
short-summary: Update an HTTP listener.
examples:
  - name: Update an HTTP listener. (autogenerated)
    text: az network application-gateway http-listener update --gateway-name MyAppGateway --host-names 127.0.0.1 --name MyHttpListener --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a probe. (autogenerated)
    text: az network application-gateway probe update --gateway-name MyAppGateway --name MyProbe --path / --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['network application-gateway rewrite-rule condition create'] = """
...
examples:
  - name: Create a rewrite rule condition. (autogenerated)
    text: az network application-gateway rewrite-rule condition create --gateway-name MyAppGateway --ignore-case true --negate MyAppGateway --pattern *.py --resource-group MyResourceGroup --rule-name MyRewriteRule --rule-set-name MyRuleSet --variable MyValue
    crafted: true
"""

aladdin_helps['network application-gateway rewrite-rule condition delete'] = """
short-summary: Delete a rewrite rule condition.
type: command
examples:
  - name: Delete a rewrite rule condition. (autogenerated)
    text: az network application-gateway rewrite-rule condition delete --gateway-name MyAppGateway --resource-group MyResourceGroup --rule-name MyRewriteRule --rule-set-name MyRuleSet --variable RemoteAddress
    crafted: true
"""
...
aladdin_helps['network application-gateway rewrite-rule condition show'] = """
short-summary: Get the details of a rewrite rule condition.
type: command
examples:
  - name: Get the details of a rewrite rule condition. (autogenerated)
    text: az network application-gateway rewrite-rule condition show --gateway-name MyAppGateway --resource-group MyResourceGroup --rule-name MyRewriteRule --rule-set-name MyRuleSet --variable RemoteAddress
    crafted: true
"""

aladdin_helps['network application-gateway rewrite-rule condition update'] = """
...
parameters:
  - name: --variable
    populator-commands:
      - az network application-gateway rewrite-rule condition list-server-variables
examples:
  - name: Update a rewrite rule condition. (autogenerated)
    text: az network application-gateway rewrite-rule condition update --gateway-name MyAppGateway --negate MyAppGateway --pattern *.py --resource-group MyResourceGroup --rule-name MyRewriteRule --rule-set-name MyRuleSet --variable MyValue
    crafted: true
"""

aladdin_helps['network application-gateway rewrite-rule create'] = """
...
examples:
  - name: Create a rewrite rule. (autogenerated)
    text: az network application-gateway rewrite-rule create --gateway-name MyAppGateway --name MyRewriteRule --resource-group MyResourceGroup --response-headers @indexes-file.json --rule-set-name MyRuleSet --sequence 1
    crafted: true
"""
...
examples:
  - name: Delete a rewrite rule. (autogenerated)
    text: az network application-gateway rewrite-rule delete --gateway-name MyAppGateway --name MyRewriteRule --resource-group MyResourceGroup --rule-set-name MyRuleSet
    crafted: true
"""
...
aladdin_helps['network application-gateway rewrite-rule set delete'] = """
short-summary: Delete a rewrite rule set.
type: command
examples:
  - name: Delete a rewrite rule set. (autogenerated)
    text: az network application-gateway rewrite-rule set delete --gateway-name MyAppGateway --name MyRewriteRuleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a rewrite rule set. (autogenerated)
    text: az network application-gateway rewrite-rule set update --gateway-name MyAppGateway --name MyRewriteRuleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a rewrite rule. (autogenerated)
    text: az network application-gateway rewrite-rule update --enable-reroute true --gateway-name MyAppGateway --modified-path / --name MyRewriteRule --request-headers 200 --resource-group MyResourceGroup --rule-set-name MyRule
    crafted: true
"""
...
examples:
  - name: Update a trusted root certificate. (autogenerated)
    text: az network application-gateway root-cert update --cert-file /path/to/cert/file --gateway-name MyAppGateway --name MyRootCert --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a rule. (autogenerated)
    ...
    crafted: true
  - name: Update a rule. (autogenerated)
    text: az network application-gateway rule update --gateway-name MyAppGateway --name MyRule --resource-group MyResourceGroup --rewrite-rule-set MyRewriteRuleSet
    crafted: true
"""
...
examples:
  - name: Update an application gateway. (autogenerated)
    text: az network application-gateway update --name MyAppGateway --resource-group MyResourceGroup --set tags.CostCenter --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule create --action Allow --name CustomRule --policy-name MyPolicy --priority 100 --resource-group MyResourceGroup --rule-type OWASP
    crafted: true
"""
...
aladdin_helps['network application-gateway waf-policy custom-rule match-condition add'] = """
type: command
short-summary: A match condition to an application gateway WAF policy custom rule.
examples:
  - name: A match condition to an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule match-condition add --match-variables match-variable --name CustomRule --negate MyAppGateway --operator MyRegistry --policy-name MyPolicy --resource-group MyResourceGroup --values @key-file
    crafted: true
"""
...
aladdin_helps['network application-gateway waf-policy managed-rule exclusion add'] = """
type: command
short-summary: Add an OWASP CRS exclusion rule to the WAF policy managed rules.
examples:
  - name: Add an OWASP CRS exclusion rule to the WAF policy managed rules. (autogenerated)
    text: az network application-gateway waf-policy managed-rule exclusion add --match-variable MyMatch-variable --policy-name MyPolicy --resource-group MyResourceGroup --selector [].{SubId} --selector-match-operator [].{SubId}
    crafted: true
"""
...
aladdin_helps['network application-gateway waf-policy managed-rule exclusion remove'] = """
type: command
short-summary: List all OWASP CRS exclusion rules that are applied on a Waf policy managed rules.
examples:
  - name: List all OWASP CRS exclusion rules that are applied on a Waf policy managed rules. (autogenerated)
    text: az network application-gateway waf-policy managed-rule exclusion remove --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Add managed rule set to the WAF policy managed rules (commonly used with --output). (autogenerated)
    text: az network application-gateway waf-policy managed-rule rule-set add --policy-name MyPolicy --resource-group MyResourceGroup --type OWASP --version 3.0
    crafted: true
"""
...
examples:
  - name: Remove a managed rule set by rule set group name if rule_group_name is specified (autogenerated)
    text: az network application-gateway waf-policy managed-rule rule-set remove --group-name MyAppGateway --policy-name MyPolicy --resource-group MyResourceGroup --type OWASP --version 3.0
    crafted: true
"""
...
short-summary: >
    ...
    https://docs.microsoft.com/en-us/azure/web-application-firewall/ag/application-gateway-crs-rulegroups-rules
examples:
  - name: Update(Override) existing rule set of a WAF policy managed rules (commonly used with --output). (autogenerated)
    text: az network application-gateway waf-policy managed-rule rule-set update --group-name MyAppGateway --policy-name MyPolicy --resource-group MyResourceGroup --rules SQLI --type OWASP --version 3.0
    crafted: true
"""
...
examples:
  - name: Update properties of a web application firewall global configuration. (autogenerated)
    text: az network application-gateway waf-policy policy-setting update --mode Enabled --policy-name MyPolicy --resource-group MyResourceGroup --state Enabled
    crafted: true
"""
...
examples:
  - name: Create a Azure bastion host machine. (autogenerated)
    text: az network bastion create --location westus2 --name MyBacpac --public-ip-address MyPublicIp --resource-group MyResourceGroup --vnet-name MyVnet
    crafted: true
"""
...
examples:
  - name: Delete a Azure bastion host machine. (autogenerated)
    text: az network bastion delete --name MyBacpac --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show a Azure bastion host machine. (autogenerated)
    text: az network bastion show --name MyBacpac --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a DDoS protection plan. (autogenerated)
    ...
    crafted: true
  - name: Create a DDoS protection plan. (autogenerated)
    text: az network ddos-protection create --name MyDdosPlan --resource-group MyResourceGroup --vnets MyVnet
    crafted: true
"""

aladdin_helps['network ddos-protection delete'] = """
type: command
short-summary: Delete a DDoS protection plan.
examples:
  - name: Delete a DDoS protection plan. (autogenerated)
    text: az network ddos-protection delete --ids /subscriptions/00000000-0000-0000-0000-000000000000
    crafted: true
"""
...
examples:
  - name: Update a DDoS protection plan. (autogenerated)
    ...
    crafted: true
  - name: Update a DDoS protection plan. (autogenerated)
    text: az network ddos-protection update --ids $(az --vnets $vnet
    crafted: true
"""
...
examples:
  - name: Update an A record set. (autogenerated)
    ...
    crafted: true
  - name: Update an A record set. (autogenerated)
    text: az network dns record-set a update --name MyRecordSet --resource-group MyResourceGroup --target-resource $site --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network dns record-set aaaa add-record'] = """
type: command
short-summary: Add an AAAA record.
examples:
  - name: Add an AAAA record. (autogenerated)
    text: az network dns record-set aaaa add-record --ipv6-address MyIpv6Address --record-set-name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['network dns record-set caa list'] = """
type: command
short-summary: List all CAA record sets in a zone.
examples:
  - name: List all CAA record sets in a zone. (autogenerated)
    text: az network dns record-set caa list --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty NS record set. (autogenerated)
    ...
    crafted: true
  - name: Create an empty NS record set (autogenerated)
    text: az network dns record-set ns create --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update properties of an SOA record. (autogenerated)
    text: az network dns record-set soa update --expire-time 30 --minimum-ttl 30 --refresh-time 60 --resource-group MyResourceGroup --retry-time 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty SRV record set. (autogenerated)
    text: az network dns record-set srv create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network dns record-set srv list'] = """
type: command
short-summary: List all SRV record sets in a zone.
examples:
  - name: List all SRV record sets in a zone. (autogenerated)
    text: az network dns record-set srv list --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['network dns record-set txt remove-record'] = """
type: command
...
examples:
  - name: Remove a TXT record from its record set. (autogenerated)
    text: az network dns record-set txt remove-record --keep-empty-record-set --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --value owner=WebTeam --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update a TXT record set. (autogenerated)
    text: az network dns record-set txt update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['network express-route auth delete'] = """
type: command
...
examples:
  - name: Delete a link authorization of an ExpressRoute circuit. (autogenerated)
    text: az network express-route auth delete --circuit-name MyCircuit --name MyAuthorization --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete an ExpressRoute circuit. (autogenerated)
    text: az network express-route delete --ids $(az
    crafted: true
"""
...
aladdin_helps['network express-route gateway create'] = """
type: command
short-summary: Create an ExpressRoute gateway.
examples:
  - name: Create an ExpressRoute gateway (autogenerated)
    text: az network express-route gateway create --location westus2 --max-val 10 --min-val 1 --name MyCircuit --resource-group MyResourceGroup --tags key=value no_80 no_22 --virtual-hub MyVirtualHub
    crafted: true
"""
...
examples:
  - name: Get the details of an ExpressRoute gateway. (autogenerated)
    ...
    crafted: true
  - name: Get the details of an ExpressRoute gateway. (autogenerated)
    text: az network express-route gateway show --ids $GW2Id
    crafted: true
"""
...
examples:
  - name: Create peering settings for an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering create --circuit-name MyCircuit --peer-asn 62000 --peering-type VirtualAppliance --primary-peer-subnet MySubnet --resource-group MyResourceGroup --secondary-peer-subnet MySubnet --subscription MySubscription --vlan-id MyVnetId
    crafted: true
"""
...
examples:
  - name: List ExpressRoute ports. (autogenerated)
    text: az network express-route port list --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update an inbound NAT rule. (autogenerated)
    ...
    crafted: true
  - name: Update an inbound NAT rule. (autogenerated)
    text: az network lb inbound-nat-rule update --backend-port 8080 --frontend-port 80 --lb-name MyLb --name MyNatRule --only-show-errors --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an outbound-rule. (autogenerated)
    text: az network lb outbound-rule update --lb-name MyLb --name MyOutboundRule --outbound-ports 10000 --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a probe. (autogenerated)
    text: az network lb probe update --lb-name MyLb --name MyProbe --port 80 --protocol http --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a load balancing rule. (autogenerated)
    ...
    crafted: true
  - name: Update a load balancing rule. (autogenerated)
    text: az network lb rule update --backend-port 8080 --lb-name MyLb --name MyLbRule --probe-name MyProbe --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List available service aliases in the region which can be used for Service Endpoint Policies. (autogenerated)
    text: az network list-service-aliases --location westus
    crafted: true
"""
...
examples:
  - name: Delete a private endpoint dns zone group. (autogenerated)
    text: az network private-endpoint dns-zone-group delete --endpoint-name MyPE --name MyZoneGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List all private endpoint dns zone groups. (autogenerated)
    text: az network private-endpoint dns-zone-group list --endpoint-name MyPE --resource-group MyRG
    crafted: true
"""
...
examples:
  - name: Show a private endpoint dns zone group. (autogenerated)
    text: az network private-endpoint dns-zone-group show --endpoint-name MyPE --name MyZoneGroup --resource-group MyRG
    crafted: true
"""
...
aladdin_helps['network public-ip update'] = """
type: command
short-summary: Update a public IP address.
examples:
  - name: Update a public IP address. (autogenerated)
    text: az network public-ip update --dns-name MyUniqueDnsName --ids MyIp
    crafted: true
"""
...
examples:
  - name: Update a route in a route table. (autogenerated)
    ...
    crafted: true
  - name: Update a route in a route table. (autogenerated)
    text: az network route-table route update --name RouteToInternet --next-hop-ip-address 10.0.0.11 --next-hop-type VirtualAppliance --resource-group $resource --route-table-name $route
    crafted: true
"""
...
aladdin_helps['network traffic-manager endpoint create'] = """
type: command
...
examples:
  - name: Create a traffic manager endpoint. (autogenerated)
    text: az network traffic-manager endpoint create --endpoint-status Enabled --name MyEndpoint --priority 300 --profile-name MyTmProfile --resource-group MyResourceGroup --target-resource-id $MyWebApp1Id --type azureEndpoints
    crafted: true
"""
...
examples:
  - name: Update a traffic manager profile. (autogenerated)
    ...
    crafted: true
  - name: Update a traffic manager profile. (autogenerated)
    text: az network traffic-manager profile update --name MyTmProfile --resource-group MyResourceGroup --set allowGatewayTransit=true
    crafted: true
"""
...
examples:
  - name: Update a virtual network gateway. (autogenerated)
    ...
    crafted: true
  - name: Update a virtual network gateway. (autogenerated)
    text: az network vnet-gateway update --custom-routes MyRg --name MyVnetGateway --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a connection monitor. (autogenerated)
    text: az network watcher connection-monitor create --dest-address 10.0.0.11 --dest-port 80 --dest-resource MyDestinationResource --name MyConnectionMonitor --protocol http --resource-group MyResourceGroup --source-resource MySourceResource --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List all endpoints form a connection monitor. (autogenerated)
    text: az network watcher connection-monitor endpoint list --connection-monitor MyConnectionMonitor --location westus
    crafted: true
"""
...
examples:
  - name: List all test configurations of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-configuration list --connection-monitor MyConnectionMonitor --location westus
    crafted: true
"""
...
examples:
  - name: List all test groups of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-group list --connection-monitor MyConnectionMonitor --location westus
    crafted: true
"""
...
examples:
  - name: Show a test group of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-group show --connection-monitor MyConnectionMonitor --location westus --name MyHTTPTestGroup
    crafted: true
"""

aladdin_helps['network watcher flow-log create'] = """
type: command
short-summary: Create a flow log on a network security group.
examples:
  - name: Create a flow log on a network security group. (autogenerated)
    text: az network watcher flow-log create --enabled true --format json --location westus --log-version 5.7 --name MyFlowLog --nsg MyNsg --retention 10 --storage-account MyStorageAccount --tags key=value no_80 no_22 --traffic-analytics true --workspace MyWorkspace
    crafted: true
"""
...
examples:
  - name: Delete the specified flow log resource. (autogenerated)
    text: az network watcher flow-log delete --location westus --name MyFlowLog
    crafted: true
"""
...
examples:
  - name: List all flow log resources for the specified Network Watcher. (autogenerated)
    text: az network watcher flow-log list --location westus
    crafted: true
"""
...
aladdin_helps['network watcher run-configuration-diagnostic'] = """
type: command
...
examples:
  - name: Run a configuration diagnostic on a target resource (autogenerated)
    text: az network watcher run-configuration-diagnostic --destination 10.0.0.11 --direction Inbound --port 80 --protocol TCP --resource myScaleSet --resource-group MyResourceGroup --resource-type Microsoft.Compute/virtualMachines --source 10.0.100.4
    crafted: true
"""
...
examples:
  - name: Get information on the 'next hop' of a VM (autogenerated)
    text: az network watcher show-next-hop --dest-ip MyDest --nic MyNic --resource-group MyResourceGroup --source-ip MySourceIp --vm MyVm
    crafted: true
"""
...
examples:
  - name: Update an A record set. (autogenerated)
    text: az network private-dns record-set a update --if-match true --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network private-dns record-set aaaa list'] = """
type: command
short-summary: List all AAAA record sets in a zone.
examples:
  - name: List all AAAA record sets in a zone. (autogenerated)
    text: az network private-dns record-set aaaa list --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network private-dns record-set aaaa update'] = """
type: command
short-summary: Update an AAAA record set.
examples:
  - name: Update an AAAA record set. (autogenerated)
    text: az network private-dns record-set aaaa update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty CNAME record set (autogenerated)
    text: az network private-dns record-set cname create --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['network private-dns record-set cname update'] = """
type: command
short-summary: Update a CNAME record set.
examples:
  - name: Update a CNAME record set. (autogenerated)
    text: az network private-dns record-set cname update --if-match true --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network private-dns record-set mx create'] = """
type: command
short-summary: Create an empty MX record set.
examples:
  - name: Create an empty MX record set. (autogenerated)
    text: az network private-dns record-set mx create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty SRV record set. (autogenerated)
    text: az network private-dns record-set srv create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the Private DNS zone is met. (autogenerated)
    text: az network private-dns zone wait --exists --name MyZone --resource-group MyResourceGroup --timeout 1800
    crafted: true
"""
...
aladdin_helps['mariadb db create'] = """
type: command
short-summary: Create a MariaDB database.
examples:
  - name: Create a MariaDB database. (autogenerated)
    text: az mariadb db create --name $database --resource-group $resource --server-name $server --subscription $subscription
    crafted: true
"""

aladdin_helps['mariadb db show'] = """
type: command
short-summary: Show the details of a database.
examples:
  - name: Show the details of a database. (autogenerated)
    text: az mariadb db show --name MyDatabase --resource-group MyResourceGroup --server-name MyServer --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a server. (autogenerated)
    text: az mariadb server delete --name MyServer --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a new firewall rule for a server. (autogenerated)
    text: az mariadb server firewall-rule create --end-ip-address 0.0.0.0 --name AllowIps --resource-group MyResourceGroup --server-name MyServer --start-ip-address 0.0.0.0 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Get the details of a firewall rule. (autogenerated)
    text: az mariadb server firewall-rule show --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a read replica for a server. (autogenerated)
    text: az mariadb server replica create --location northeurope --name testreplsvr --resource-group testgroup --source-server testsvr --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a server. (autogenerated)
    ...
    crafted: true
  - name: Update a server. (autogenerated)
    text: az mariadb server update --name MyServer --public-network-access Disabled --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a virtual network rule to allows access to a MariaDB server. (autogenerated)
    text: az mariadb server vnet-rule create --ignore-missing-endpoint true --name MyVnetRule --resource-group MyResourceGroup --server-name MyServer --subnet MySubnet --subscription MySubscription --vnet-name MyVnet
    crafted: true
"""
...
examples:
  - name: Delete a firewall rule. (autogenerated)
    text: az mysql server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['mysql server key create'] = """
type: command
short-summary: Create server key.
examples:
  - name: Create server key. (autogenerated)
    text: az mysql server key create --kid 00000000 --name MyServerKey --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a read replica for a server. (autogenerated)
    text: az mysql server replica create --location northeurope --name testreplsvr --resource-group testgroup --source-server testsvr
    crafted: true
"""
...
examples:
  - name: Wait for server to satisfy certain conditions. (autogenerated)
    ...
    crafted: true
  - name: Wait for server to satisfy certain conditions. (autogenerated)
    text: az mysql server wait --custom CustomScript --name testsvrnew --resource-group testgroup
    crafted: true
"""
...
examples:
  - name: Get Active Directory Administrator information for a PostgreSQL server (autogenerated)
    text: az postgres server ad-admin show --resource-group MyResourceGroup --server-name MyServer --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['postgres server key create'] = """
type: command
short-summary: Create server key.
examples:
  - name: Create server key. (autogenerated)
    text: az postgres server key create --kid 00000000 --name MyServer --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['postgres server key show'] = """
type: command
short-summary: Show server key.
examples:
  - name: Show server key. (autogenerated)
    text: az postgres server key show --kid 00000000 --name MyServer --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the specified private endpoint connection associated with a PostgreSQL server. (autogenerated)
    text: az postgres server private-endpoint-connection delete --name MyPrivateEndpoint --resource-group MyResourceGroup --server-name MyServer --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['postgres server wait'] = """
type: command
short-summary: Wait for server to satisfy certain conditions.
examples:
  - name: Wait for server to satisfy certain conditions. (autogenerated)
    text: az postgres server wait --custom MyCloudInitScript --name MyCloudInitScript --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['redis export'] = """
type: command
short-summary: Export data stored in a Redis cache.
examples:
  - name: Export data stored in a Redis cache. (autogenerated)
    text: az redis export --container MyContainer --file-format Dockerfile --ids @indexes-file.json --prefix 10.0.0.1
    crafted: true
"""

aladdin_helps['redis firewall-rules create'] = """
type: command
...
examples:
  - name: Create a redis cache firewall rule. (autogenerated)
    text: az redis firewall-rules create --end-ip 80 --name MyRedisRule --resource-group MyResourceGroup --rule-name MyRedisRule --start-ip 80
    crafted: true
"""

aladdin_helps['redis firewall-rules update'] = """
type: command
short-summary: Update a redis cache firewall rule.
examples:
  - name: Update a redis cache firewall rule. (autogenerated)
    text: az redis firewall-rules update --end-ip $endIP --name $rule --resource-group $resource --rule-name $rule --start-ip $startIP --subscription $subscription
    crafted: true
"""

aladdin_helps['redis import'] = """
type: command
short-summary: Import data into a Redis cache.
examples:
  - name: Import data into a Redis cache. (autogenerated)
    text: az redis import --file-format contosoCache --files contosoCache --name contosoCache --resource-group contosoGroup
    crafted: true
"""

aladdin_helps['redis server-link create'] = """
type: command
...
examples:
  - name: Adds a server link to the Redis cache (requires Premium SKU). (autogenerated)
    text: az redis server-link create --name MyRedisServer --replication-role Owner --resource-group MyResourceGroup --server-to-link MyServer --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a Redis cache. (autogenerated)
    text: az redis update --name contosoCache --resource-group contosoGroup --set tags.no_80
    crafted: true
"""
...
aladdin_helps['relay namespace show'] = """
type: command
short-summary: Shows the Relay Service Namespace details
examples:
  - name: Shows the Relay Service Namespace details (autogenerated)
    text: az relay namespace show --name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at resource group. (autogenerated)
    text: |
        az deployment group validate --parameters 'a:string string' exampleArray='("value1", "value2")' --resource-group MyResourceGroup --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a deployment condition is met. (autogenerated)
    text: az deployment group wait --created --custom CustomScript --deleted --name MyDeployment --resource-group MyResourceGroup --timeout 1800
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at management group. (autogenerated)
    text: az deployment mg validate --location westus --management-group-id testmg --name rollout01 --parameters @params.json MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
aladdin_helps['deployment operation mg list'] = """
type: command
...
examples:
  - name: List deployment operations at management group. (autogenerated)
    text: az deployment operation mg list --management-group-id testmg --name rollout01
    crafted: true
"""

aladdin_helps['deployment operation mg show'] = """
type: command
short-summary: Show a deployment operation at management group.
examples:
  - name: Show a deployment operation at management group. (autogenerated)
    text: az deployment operation mg show --management-group-id testmg --name rollout01 --operation-ids operationId
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at subscription scope. (autogenerated)
    text: az deployment sub validate --location westus --parameters MyValue=This MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at tenant scope. (autogenerated)
    text: az deployment tenant validate --location westus --name MyDeployment --parameters MyValue=This MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a deployment condition is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a deployment condition is met. (autogenerated)
    text: az group deployment wait --created --custom CustomScript --deleted --name MyDeployment --resource-group MyResourceGroup --timeout 1800
    crafted: true
"""
...
aladdin_helps['lock update'] = """
type: command
short-summary: Update a lock.
examples:
  - name: Update a lock. (autogenerated)
    text: az lock update --lock-type ReadOnly --name lockName --resource-group MyResourceGroup --resource-name myvnet --resource-type Microsoft.Network/virtualNetworks --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a managed application definition. (autogenerated)
    ...
    crafted: true
  - name: Delete a managed application definition (autogenerated)
    text: az managedapp definition delete --ids $(az
    crafted: true
"""
...
examples:
  - name: Update a resource-level lock. (autogenerated)
    text: az resource lock update --ids $(az --lock-type ReadOnly
    crafted: true
"""
...
examples:
  ...
  - name: Update a resource. (autogenerated)
    text: |
        az resource update --name MyManagedCluster --resource-group MyResourceGroup --resource-type "Microsoft.Compute/virtualMachines" --set key0=value0
    crafted: true
"""
...
examples:
  - name: Create an Azure Active Directory user. (autogenerated)
    text: az ad user create --display-name MyDisplay --password password --user-principal-name MyPrincipalName
    crafted: true
"""
...
examples:
  - name: Get groups of which the user is a member. (autogenerated)
    text: az ad user get-member-groups --id /subscriptions/{SubID}
    crafted: true
"""
...
examples:
  - name: Update Azure Active Directory users. (autogenerated)
    text: az ad user update --force-change-password-next-login MyNewPassword --id MyNewId --password MyNewPassword
    crafted: true
"""
...
aladdin_helps['search service update'] = """
type: command
...
examples:
  - name: Update partition and replica of the given search service. (autogenerated)
    text: az search service update --name MyService --resource-group MyResourceGroup --set allowGatewayTransit=true
    crafted: true
"""

aladdin_helps['security alert show'] = """
type: command
short-summary: Shows a security alert.
examples:
  - name: Shows a security alert. (autogenerated)
    text: az security alert show --location westus --name MyAlert --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Shows a Just in Time network access policy (autogenerated)
    text: az security jit-policy show --location westus --name MyJitPolicy --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Regenerate keys of Authorization Rule for the Service Bus Namespace (autogenerated)
    ...
    crafted: true
  - name: Regenerate keys of Authorization Rule for the Service Bus Namespace. (autogenerated)
    text: az servicebus namespace authorization-rule keys renew --key PrimaryKey --key-value PrimaryKey --name Myauthorule --namespace-name Mynamespace --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Updates existing Service Bus Queue. (autogenerated)
    text: az servicebus queue update --max-delivery-count 10 --name MyQueue --namespace-name MyNamespace --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['servicebus topic subscription rule update'] = """
type: command
...
examples:
  - name: Updates the ServiceBus Rule for Subscription. (autogenerated)
    text: az servicebus topic subscription rule update --enable-action-preprocessing true --enable-correlation-preprocessing true --name myrule --namespace-name mynamespace --resource-group myresourcegroup --subscription-name mysubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  - name: Updates the ServiceBus Subscription (autogenerated)
    ...
    crafted: true
  - name: Updates the ServiceBus Subscription. (autogenerated)
    text: az servicebus topic subscription update --auto-delete-on-idle 5 --dead-letter-on-filter-exceptions myfun --default-message-time-to-live 2018-12-24 --enable-session true --max-delivery-count 10 --name MySubscription --namespace-name Mynamespace --resource-group MyResourceGroup --topic-name MyTopic
    crafted: true
"""
...
examples:
  ...
  - name: Updates the Service Bus Topic (autogenerated)
    ...
    crafted: true
  - name: Updates the Service Bus Topic. (autogenerated)
    text: az servicebus topic update --duplicate-detection-history-time-window 60 --name mytopic --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['sf cluster node add'] = """
type: command
short-summary: Add nodes to a node type in a cluster.
examples:
  - name: Add nodes to a node type in a cluster. (autogenerated)
    text: az sf cluster node add --cluster-name MyCluster --node-type 'n2' --number-of-nodes-to-add 1 --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List allowed origins of a SignalR Service. (autogenerated)
    text: az signalr cors list --name MySignalR --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a copy of a database. (autogenerated)
    text: az sql db copy --dest-name MyDest --dest-resource-group MyResourceGroup --dest-server myserver --name MyAzureSQLDatabase --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  - name: Permanently stop data replication between two database replicas. (autogenerated)
    text: az sql db replica delete-link --ids $originalId --partner-server $secondaryServer
    crafted: true
"""
...
examples:
  - name: Update an elastic pool. (autogenerated)
    text: az sql elastic-pool update --capacity 10 --db-max-capacity 10 --name MyAzureSQLDatabase --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  - name: Creates a failover group. (autogenerated)
    ...
    crafted: true
  - name: Creates a failover group. (autogenerated)
    text: az sql failover-group create --failover-policy Automatic --name $failover --partner-resource-group $failoverResource --partner-server $failoverServer --resource-group $resource --server $server
    crafted: true
"""
...
aladdin_helps['sql failover-group update'] = """
type: command
short-summary: Updates the failover group.
examples:
  - name: Updates the failover group. (autogenerated)
    text: az sql failover-group update --add-db mydb --name myfailover --resource-group myresourcegroup --server myserver
    crafted: true
"""

aladdin_helps['sql instance-failover-group create'] = """
type: command
...
examples:
  - name: Creates an instance failover group between two connected managed instances. (autogenerated)
    text: az sql instance-failover-group create --failover-policy $failover --grace-period 1 --name $failover --partner-mi $failoverInstance --partner-resource-group $failoverResource --resource-group $failoverResource --source-mi $failoverInstance
    crafted: true
"""
...
examples:
  - name: Set the primary of the instance failover group by failing over all databases from the current primary managed instance. (autogenerated)
    text: az sql instance-failover-group set-primary --location westus --name Myfailover --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['sql mi ad-admin create'] = """
type: command
short-summary: Creates a new managed instance Active Directory administrator.
examples:
  - name: Creates a new managed instance Active Directory administrator. (autogenerated)
    text: az sql mi ad-admin create --display-name MyAdminName --managed-instance myinstance --object-id /subscriptions/{SubID}/resourceGroups/{ResourceGroup} --resource-group MySubscription
    crafted: true
"""
...
examples:
  - name: Returns a list of managed instance Active Directory Administrators. (autogenerated)
    text: az sql mi ad-admin list --managed-instance myinstance --resource-group mygroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a managed instance. (autogenerated)
    text: az sql mi create --admin-password $password --admin-user $login --assign-identity --capacity 2 --collation $collation --edition GeneralPurpose --family Gen5 --license-type PAYG --location westus2 --name $instance --resource-group $resource --storage 'https://storacc.blob.core.windows.net/' --subnet $subnet --subscription $subscription --timezone-id 2
    crafted: true
"""

aladdin_helps['sql mi key create'] = """
type: command
short-summary: Creates a SQL Instance key.
examples:
  - name: Creates a SQL Instance key. (autogenerated)
    text: az sql mi key create --kid $instance --managed-instance $instance --resource-group $resource
    crafted: true
"""

aladdin_helps['sql mi tde-key set'] = """
type: command
short-summary: Sets the SQL Instance's encryption protector.
examples:
  - name: Sets the SQL Instance's encryption protector. (autogenerated)
    text: az sql mi tde-key set --kid 00000000 --managed-instance myinstance --resource-group mygroup --server-key-type StorageAccessKey
    crafted: true
"""
...
examples:
  ...
  - name: Update a managed instance. (autogenerated)
    ...
    crafted: true
  - name: Update a managed instance. (autogenerated)
    text: az sql mi update --admin-password $password --capacity 2 --edition GeneralPurpose --family Gen5 --name MyInstance --resource-group MyResourceGroup --storage 'https://storacc.blob.core.windows.net/'
    crafted: true
"""
...
aladdin_helps['sql server dns-alias set'] = """
type: command
short-summary: Sets a server to which DNS alias should point
examples:
  - name: Sets a server to which DNS alias should point. (autogenerated)
    text: az sql server dns-alias set --name myalias --original-server myoriginalserver --resource-group myresourcegroup --server myserver
    crafted: true
"""

aladdin_helps['sql server key create'] = """
type: command
short-summary: Creates a server key.
examples:
  - name: Creates a server key. (autogenerated)
    text: az sql server key create --kid 00000000 --resource-group MyResourceGroup --server myserver
    crafted: true
"""

aladdin_helps['sql server key delete'] = """
type: command
short-summary: Deletes a server key.
examples:
  - name: Deletes a server key. (autogenerated)
    text: az sql server key delete --kid 00000000 --resource-group MyResourceGroup --server myserver
    crafted: true
"""

aladdin_helps['sql server tde-key set'] = """
type: command
short-summary: Sets the server's encryption protector.
examples:
  - name: Sets the server's encryption protector. (autogenerated)
    text: az sql server tde-key set --kid 00000000 --resource-group MyResourceGroup --server MyServer --server-key-type StorageAccessKey
    crafted: true
"""
...
examples:
  - name: Update a server. (autogenerated)
    ...
    crafted: true
  - name: Update a server. (autogenerated)
    text: az sql server update --name MyServer --resource-group MyResourceGroup --set allowGatewayTransit=true
    crafted: true
"""

aladdin_helps['sql virtual-cluster delete'] = """
type: command
short-summary: Delete a virtual cluster.
examples:
  - name: Delete a virtual cluster. (autogenerated)
    text: az sql virtual-cluster delete --ids $clusterId
    crafted: true
"""
...
examples:
  - name: Creates the data policy rules associated with the specified storage account. (autogenerated)
    text: az storage account management-policy create --account-name MyStorageAccount --policy MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Updates the data policy rules associated with the specified storage account. (autogenerated)
    text: az storage account management-policy update --account-name MyStorageAccount --resource-group MyResourceGroup --set tags.no_80
    crafted: true
"""
...
examples:
  - name: Upload a file to a storage blob. (autogenerated)
    text: az storage blob upload --account-key 00000000 --account-name MyStorageAccount --container-name MyContainer --file MyBlob --name MyBlob
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage container. (autogenerated)
    ...
    crafted: true
  - name: Check for the existence of a storage container. (autogenerated)
    text: az storage container exists --account-name MyStorageAccount --auth-mode login --name mycontainer
    crafted: true
"""
...
examples:
  ...
  - name: Generate a SAS token for a storage container. (autogenerated)
    text: az storage container generate-sas --account-name MyStorageAccount --as-user --auth-mode login --expiry 2020-01-01 --name MyContainer --permissions dlrw
    crafted: true
"""
...
examples:
  - name: List all CORS rules for a storage account. (autogenerated)
    text: az storage cors list --account-key 00000000 --account-name MyStorageAccount
    crafted: true
"""
...
examples:
  - name: List entities which satisfy a query. (autogenerated)
    text: az storage entity query --connection-string $connectionString --filter MyFilter --table-name MyTable
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file (autogenerated)
    text: az storage file generate-sas --account-name MyStorageAccount --expiry 2037-12-31 --https-only --path path/file.txt --permissions rcdw --share-name MyShare --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create file system for Azure Data Lake Storage Gen2 account. (autogenerated)
    text: az storage fs create --account-name myadlsaccount --auth-mode login --name myadls
    crafted: true
"""
...
examples:
  - name: Delete a file system in ADLS Gen2 account. (autogenerated)
    text: az storage fs delete --account-name myadlsaccount --auth-mode login --name myadls
    crafted: true
"""
...
examples:
  - name: Create a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory create --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name mydir
    crafted: true
"""
...
examples:
  - name: Delete a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory delete --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name mydir
    crafted: true
"""
...
examples:
  - name: Check for the existence of a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory exists --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name mydir
    crafted: true
"""
...
examples:
  - name: List directories in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory list --account-name myadlsaccount --auth-mode login --file-system myfilesystem
    crafted: true
"""
...
examples:
  - name: Move a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory move --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name mydir --new-directory mynew
    crafted: true
"""
...
examples:
  - name: Show properties of a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory show --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name mydir
    crafted: true
"""

aladdin_helps['storage fs file exists'] = """
type: command
short-summary: Check for the existence of a file in ADLS Gen2 file system.
examples:
  - name: Check for the existence of a file in ADLS Gen2 file system. (autogenerated)
    text: az storage fs file exists --account-name myadlsaccount --auth-mode login --file-system myfilesystem --path path/file.txt
    crafted: true
"""
...
examples:
  - name: Show properties of file in ADLS Gen2 file system. (autogenerated)
    text: az storage fs file show --account-name myadlsaccount --auth-mode login --file-system myfilesystem --path /
    crafted: true
"""
...
examples:
  - name: Upload a file to a file path in ADLS Gen2 file system. (autogenerated)
    text: az storage fs file upload --account-name myadlsaccount --auth-mode login --file-system myfilesystem --path path/file.txt --source /
    crafted: true
"""
...
examples:
  - name: Show properties of file system in ADLS Gen2 account. (autogenerated)
    text: az storage fs show --account-name myadlsaccount --auth-mode login --name myadls
    crafted: true
"""
...
aladdin_helps['storage logging update'] = """
type: command
...
examples:
  - name: Update logging settings for a storage account. (autogenerated)
    text: az storage logging update --account-name MyStorageAccount --log MyLog --retention 10 --services qt --version 1.0
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a managed disk is met (autogenerated)
    text: az disk wait --exists --name MyDisk --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a disk encryption set. (autogenerated)
    text: az disk-encryption-set create --key-url $key --location $region --name $encryption --resource-group $resource --source-vault $vault
    crafted: true
"""
...
aladdin_helps['image builder customizer clear'] = """
type: command
short-summary: Remove all image builder customizers from an image builder template.
long-summary: Must be used with --defer
examples:
  - name: Remove all image builder customizers from an image builder template. (autogenerated)
    text: az image builder customizer clear --defer true --name CustomScript --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete image builder template. (autogenerated)
    text: az image builder delete --name MyImage --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update custom VM images. (autogenerated)
    text: az image update --name ImageName --resource-group MyResourceGroup --set tags.no_80
    crafted: true
"""
...
examples:
  - name: Create a proximity placement group. (autogenerated)
    text: az ppg create --location westus2 --name MyManagedCluster --resource-group MyResourceGroup --type Microsoft.Compute/virtualMachines
    crafted: true
"""
...
examples:
  - name: create a gallery image definition. (autogenerated)
    text: az sig image-definition create --gallery-image-definition MyImage --gallery-name MyGallery --offer GreatOffer --os-state Enabled --os-type Linux --publisher GreatPublisher --resource-group MyResourceGroup --sku Standard_DS1_v2
    crafted: true
"""
...
examples:
  - name: update a share image version. (autogenerated)
    text: az sig image-version update --gallery-image-definition MyImage --gallery-image-version 1.0.0 --gallery-name MyGallery --resource-group MyResourceGroup --set allowGatewayTransit=true
    crafted: true
"""
...
examples:
  - name: wait for image version related operation. (autogenerated)
    text: az sig image-version wait --created --gallery-image-definition MyImage --gallery-image-version 1.0.0 --gallery-name MyGallery --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['vm host update'] = """
type: command
short-summary: Update a dedicated host.
examples:
  - name: Update a dedicated host. (autogenerated)
    text: az vm host update --host-group MyHostGroup --name MyVm --remove tags.no_80 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the metric definitions for a VM. (autogenerated)
    text: az vm monitor metrics list-definitions --name MyVm --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['vm secret remove'] = """
type: command
short-summary: Remove a secret from a VM.
examples:
  - name: Remove a secret from a VM. (autogenerated)
    text: az vm secret remove --certificate MyCertificate --keyvault MyKeyVault --name MySecret --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the VM is met. (autogenerated)
    text: az vm wait --custom CustomName --name MyVm --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Detach managed data disks from a scale set or its instances. (autogenerated)
    text: az vmss disk detach --instance-id 1 --lun 1 --resource-group MyResourceGroup --vmss-name MyVmss
    crafted: true
"""
...
aladdin_helps['vmss extension set'] = """
type: command
...
examples:
  - name: Add an extension to a VMSS or update an existing extension. (autogenerated)
    text: az vmss extension set --name VMAccessForLinux --protected-settings protected --publisher Microsoft.Azure.Extensions --resource-group MyResourceGroup --version 1.0 --vmss-name MyVmss
    crafted: true
"""
