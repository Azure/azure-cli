...
@register_command(
    "netappfiles volume revert",
)
class Revert(AAZCommand):
    """Revert a volume to the snapshot specified in the body

    :example: Revert a volume to one of its snapshots
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/revert", "2025-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesRevert(ctx=self.ctx)()
    ...
    class VolumesRevert(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("snapshotId", AAZStrType, ".snapshot_id")
