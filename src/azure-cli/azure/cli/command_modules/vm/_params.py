...
def load_arguments(self, _):
    ...
    with self.argument_context('vmss create', arg_group='Network Balancer') as c:
        ...
        c.argument('load_balancer_sku', resource_type=ResourceType.MGMT_NETWORK, min_api='2017-08-01', options_list=['--lb-sku'], arg_type=get_enum_type(['Basic', 'Standard', 'Gateway']),
