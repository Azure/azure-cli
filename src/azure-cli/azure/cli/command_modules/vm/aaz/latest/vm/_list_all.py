...
class ListAll(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.status_only = AAZStrArg(
            options=["--status-only"],
            help="statusOnly=true enables fetching run time status of all Virtual Machines in the subscription.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.VirtualMachinesListAll(ctx=self.ctx)()
    ...
    class VirtualMachinesListAll(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.availability_set)
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.host)
            properties.host_group = AAZObjectType(
                serialized_name="hostGroup",
            )
            _ListAllHelper._build_schema_sub_resource_read(properties.host_group)
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.virtual_machine_scale_set)
            ...
            _ListAllHelper._build_schema_instance_view_status_read(boot_diagnostics.status)
            ...
            _ListAllHelper._build_schema_disk_encryption_settings_read(encryption_settings.Element)
            ...
            _ListAllHelper._build_schema_api_error_read(available_patch_summary.error)
            ...
            _ListAllHelper._build_schema_instance_view_status_read(configuration_statuses.Element)
            ...
            _ListAllHelper._build_schema_api_error_read(last_patch_installation_summary.error)
            ...
            _ListAllHelper._build_schema_instance_view_status_read(_element.status)
            _element.type = AAZStrType()
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.dscp_configuration)
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.network_security_group)
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.subnet)
            ...
            _ListAllHelper._build_schema_sub_resource_read(application_gateway_backend_address_pools.Element)
            ...
            _ListAllHelper._build_schema_sub_resource_read(application_security_groups.Element)
            ...
            _ListAllHelper._build_schema_sub_resource_read(load_balancer_backend_address_pools.Element)
            ...
            _ListAllHelper._build_schema_sub_resource_read(properties.public_ip_prefix)
            ...
            _ListAllHelper._build_schema_virtual_hard_disk_read(_element.image)
            ...
            _ListAllHelper._build_schema_virtual_hard_disk_read(_element.vhd)
            ...
            _ListAllHelper._build_schema_disk_encryption_settings_read(os_disk.encryption_settings)
            os_disk.image = AAZObjectType()
            _ListAllHelper._build_schema_virtual_hard_disk_read(os_disk.image)
            ...
            _ListAllHelper._build_schema_key_vault_secret_reference_read(properties.protected_settings_from_key_vault)
