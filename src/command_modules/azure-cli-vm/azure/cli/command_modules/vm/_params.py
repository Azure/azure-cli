...
register_cli_argument('vm create', 'attach_data_disks', nargs='+', help='Attach existing managed data disks to the VM. Can use the name or ID or the URI to an unmanaged disk VHD.')
