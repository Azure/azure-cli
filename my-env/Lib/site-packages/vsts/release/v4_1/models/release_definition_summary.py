...
class ReleaseDefinitionSummary(Model):
    ...
    :param environments:
    :type environments: list of :class:`ReleaseDefinitionEnvironmentSummary <release.v4_1.models.ReleaseDefinitionEnvironmentSummary>`
    ...
    :param releases:
    :type releases: list of :class:`Release <release.v4_1.models.Release>`
    """
