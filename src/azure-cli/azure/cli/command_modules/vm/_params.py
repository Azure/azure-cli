...
def load_arguments(self, _):
    ...
    with self.argument_context('vmss create', operation_group='virtual_machine_scale_sets') as c:
        ...
        c.argument('skuprofile_allostrat', options_list=['--skuprofile-allostrat'], arg_type=get_enum_type(['LowestPrice', 'CapacityOptimized']), min_api='2024-07-01', help='Allocation strategy for skuprofile_vmsizes: LowestPrice or CapacityOptimized.')
