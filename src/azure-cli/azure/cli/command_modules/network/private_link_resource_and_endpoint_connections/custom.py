...
resource_providers_mapping = {
    'microsoft.keyvault/vaults': KeyVaultPrivateEndpointClient
}
...
def show_private_link_resource(cmd, resource_group_name, name, resource_provider):
    client = _get_client(resource_providers_mapping, resource_provider)()
    return client.show_private_link_resource(cmd, resource_group_name, name)
