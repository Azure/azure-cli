...
examples:
  ...
  - name: Create a new route "R1" with all parameters. (autogenerated)
    text: az iot hub route create --condition true --enabled true --endpoint-name E2 --hub-name MyIotHub --resource-group MyResourceGroup --route-name R1 --source-type invalid
    crafted: true
"""
