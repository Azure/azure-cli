...
examples:
  - name: Show the details of an action group. (autogenerated)
    text: az monitor action-group show --name MyActionGroup --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a classic metric-based alert rule. (autogenerated)
    text: az monitor alert update --name MyAlertRule --resource-group MyResourceGroup --set {set} --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a log profile. (autogenerated)
    text: |
        az monitor log-profiles create --categories "Delete" "Write" "Action" --days 0 --enabled true --location westus2 --locations westus --name MyLogProfile --service-bus-rule-id "/subscriptions/{YOUR SUBSCRIPTION ID}/resourceGroups/{RESOURCE GROUP NAME}/providers/Microsoft.EventHub/namespaces/{EVENT HUB NAME SPACE}/authorizationrules/RootManageSharedAccessKey"
    crafted: true
"""
...
examples:
  - name: Update a log profile. (autogenerated)
    text: az monitor log-profiles update --name MyLogProfile --set {set}
    crafted: true
"""
