...
cli_command(__name__, 'appservice web config appsettings show', custom_path + 'get_app_settings', exception_handler=empty_on_404, deprecate_info='az webapp config appsettings show')
