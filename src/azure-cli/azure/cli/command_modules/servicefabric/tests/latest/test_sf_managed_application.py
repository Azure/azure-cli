...
class ServiceFabricManagedApplicationTests(ScenarioTest):
    ...
    def test_managed_service(self):
        self.kwargs.update({
            ...
            'app_type_name': 'VotingType',
            'v1': '1.0.0',
            'app_package_v1': 'https://azclistacc.blob.core.windows.net/azclicont/Voting.sfpkg?sp=r&st=2024-08-05T15:34:35Z&se=2024-08-31T23:34:35Z&sv=2022-11-02&sr=b&sig=53LEBi3HZ3diygUSKC%2Bl%2BLWIEiBcroFH1zKSURyCYYU%3D',
            'v2': '2.0.0',
            'app_package_v2': 'https://azclistacc.blob.core.windows.net/azclicont/Voting.2.0.0.sfpkg?sp=r&st=2024-08-05T15:37:19Z&se=2024-08-31T23:37:19Z&sv=2022-11-02&sr=b&sig=wv9gAjXV8lyN%2Bu4OPT6xnCF%2FT8aJMAvxJeSJKi9lmJc%3D',
            'app_name': self.create_random_name('testApp', 11),
            'stateful_service_type': 'VotingDataType',
            'stateless_service_type': 'VotingWebType',
            'stateful_service_name': self.create_random_name("testSvc", 20),
