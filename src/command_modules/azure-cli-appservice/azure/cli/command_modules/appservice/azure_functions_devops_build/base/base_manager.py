...
class BaseManager(object):  # pylint: disable=too-many-instance-attributes,too-few-public-methods
    ...
    def __init__(self, creds, organization_name="", project_name="", repository_name="", pool_name=""):
        ...
        self._service_endpoint_client = self._connection.get_client('vsts.service_endpoint.v4_1.service_endpoint_client.ServiceEndpointClient')  # pylint: disable=line-too-long
    ...
    def _get_github_repository_by_name(self, project, name):
        ...
        repository_match = next((repository for repository in repositories.repositories
