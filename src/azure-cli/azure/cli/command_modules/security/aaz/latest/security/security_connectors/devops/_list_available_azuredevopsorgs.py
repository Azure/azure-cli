...
@register_command(
    "security security-connectors devops list-available-azuredevopsorgs",
    is_preview=True,
)
class ListAvailableAzuredevopsorgs(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AzureDevOpsOrgsListAvailable(ctx=self.ctx)()
    ...
    class AzureDevOpsOrgsListAvailable(AAZHttpOperation):
...
class _ListAvailableAzuredevopsorgsHelper:
    """Helper class for ListAvailableAzuredevopsorgs"""


__all__ = ["ListAvailableAzuredevopsorgs"]
