...
class Wait(AAZWaitCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.detail_level = AAZStrArg(
            options=["--detail-level"],
            help="Controls verbosity of the returned load balancer resource. When set to 'Reduced', read-only back-reference collections (e.g., rules referencing frontendIPConfigurations) are omitted from the response.",
    ...
    class LoadBalancersGet(AAZHttpOperation):
        ...
        def query_parameters(self):
            parameters = {
                ...
                **self.serialize_query_param(
                    "detailLevel", self.ctx.args.detail_level,
                ),
                **self.serialize_query_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_common_extended_location_read(_schema_on_200.extended_location)
            ...
            _WaitHelper._build_schema_common_backend_address_pool_read(backend_address_pools.Element)
            ...
            _WaitHelper._build_schema_common_frontend_ip_configuration_read(frontend_ip_configurations.Element)
            ...
            _WaitHelper._build_schema_common_inbound_nat_rule_read(inbound_nat_rules.Element)
            ...
            backend_address_pools = cls._schema_on_200.properties.load_balancing_rules.Element.properties.backend_address_pools
            backend_address_pools.Element = AAZObjectType()
            _WaitHelper._build_schema_common_sub_resource_read(backend_address_pools.Element)

            outbound_rules = cls._schema_on_200.properties.outbound_rules
            outbound_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.outbound_rules.Element
            _element.etag = AAZStrType(
                flags={"read_only": True},
            )
            _element.id = AAZStrType()
            ...
            properties = cls._schema_on_200.properties.outbound_rules.Element.properties
            ...
            frontend_ip_configurations = cls._schema_on_200.properties.outbound_rules.Element.properties.frontend_ip_configurations
            frontend_ip_configurations.Element = AAZObjectType()
            _WaitHelper._build_schema_common_sub_resource_read(frontend_ip_configurations.Element)
            ...
            load_balancing_rules.Element = AAZObjectType()
            _WaitHelper._build_schema_common_sub_resource_read(load_balancing_rules.Element)
