...
from .custom import \
    (create_update_subnet,
     ...
     set_load_balancer_property_entry, delete_load_balancer_property_entry,
     create_load_balancer_property_entry)
...
cli_command('network lb frontend-ip create', create_load_balancer_property_entry(subresource, create_lb_frontend_ip_configuration))
cli_command('network lb frontend-ip set', set_load_balancer_property_entry(subresource, set_lb_frontend_ip_configuration))
...
cli_command('network lb inbound-nat-rule create', create_load_balancer_property_entry(subresource, create_lb_inbound_nat_rule))
cli_command('network lb inbound-nat-rule set', set_load_balancer_property_entry(subresource, set_lb_inbound_nat_rule))
...
cli_command('network lb inbound-nat-pool create', create_load_balancer_property_entry(subresource, create_lb_inbound_nat_pool))
cli_command('network lb inbound-nat-pool set', set_load_balancer_property_entry(subresource, set_lb_inbound_nat_pool))
...
cli_command('network lb address-pool create', create_load_balancer_property_entry(subresource, create_lb_backend_address_pool))
...
cli_command('network lb rule create', create_load_balancer_property_entry(subresource, create_lb_rule))
cli_command('network lb rule set', set_load_balancer_property_entry(subresource, set_lb_rule))
...
subresource = 'probes'
cli_command('network lb probe create', create_load_balancer_property_entry(subresource, create_lb_probe))
cli_command('network lb probe set', set_load_balancer_property_entry(subresource, set_lb_probe))
