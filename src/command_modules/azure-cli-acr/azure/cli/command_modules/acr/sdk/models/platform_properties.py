...
class PlatformProperties(Model):
    ...
    :type os: str or ~containerregistrybuild.models.OS
    :param architecture: The OS architecture. Possible values include:
     'amd64', 'x86', 'arm'
    :type architecture: str or ~containerregistrybuild.models.Architecture
    :param variant: Variant of the CPU. Possible values include: 'v6', 'v7',
     'v8'
    :type variant: str or ~containerregistrybuild.models.Variant
    """
