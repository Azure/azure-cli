...
@register_command(
    "network first-party-service-tag update",
    is_preview=True,
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        yield self.FirstPartyServiceTagsCreateOrUpdate(ctx=self.ctx)()
    ...
    class FirstPartyServiceTagsCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
