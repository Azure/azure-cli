...
examples:
  - name: List all incidents for an alert rule. (autogenerated)
    ...
    crafted: true
  - name: List all incidents for an alert rule. (autogenerated)
    text: az monitor alert list-incidents --resource-group MyResourceGroup --rule-name MyRule --rule-name MyRule
    crafted: true
"""
...
examples:
  - name: List autoscale rules for a profile. (autogenerated)
    ...
    crafted: true
  - name: List autoscale rules for a profile. (autogenerated)
    text: az monitor autoscale rule list --autoscale-name MyAutoscale --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update autoscale settings. (autogenerated)
    ...
    crafted: true
  - name: Update autoscale settings. (autogenerated) (autogenerated)
...
examples:
  - name: Update diagnostic settings. (autogenerated)
    ...
    crafted: true
  - name: Update diagnostic settings. (autogenerated)
    text: az monitor diagnostic-settings update --name MyDiagnosticSetting --resource myScaleSet
    crafted: true
"""
