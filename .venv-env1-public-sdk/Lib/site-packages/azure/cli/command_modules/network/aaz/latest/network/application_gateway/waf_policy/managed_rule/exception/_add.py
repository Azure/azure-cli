...
@register_command(
    "network application-gateway waf-policy managed-rule exception add",
)
class Add(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.index = AAZIntArg(
            options=["--index"],
            help="Index of exception. If no index is provided, the default behaviour is `append`.",
        )
        ...
        _args_schema.value_match_operator = AAZStrArg(
            options=["--value-operator", "--value-match-operator"],
        ...
        cls._build_args_exclusion_managed_rule_set_update(rule_sets.Element)
        return cls._args_schema
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.managedRules.exceptions
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            _builder.set_prop("exceptionManagedRuleSets", AAZListType, ".rule_sets")
            ...
            _builder.set_prop("values", AAZListType, ".values")

            exception_managed_rule_sets = _builder.get(".exceptionManagedRuleSets")
            if exception_managed_rule_sets is not None:
                _AddHelper._build_schema_exclusion_managed_rule_set_update(exception_managed_rule_sets.set_elements(AAZObjectType, "."))
