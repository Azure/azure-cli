...
helps['ad sp create-for-rbac'] = """
            examples:
                ...
                - name: Create role assignments at the same time.
                  text: az ad sp create-for-rbac -n "http://my-app" --role contributor --scopes /subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/my_resource_group /subscriptions/11111111-2222-3333-4444-666666666666/resourceGroups/my-another-group
