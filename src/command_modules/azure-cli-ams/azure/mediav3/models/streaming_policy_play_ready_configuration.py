...
class StreamingPolicyPlayReadyConfiguration(Model):
    ...
    def __init__(self, custom_license_acquisition_url_template=None, play_ready_custom_attributes=None):
        super(StreamingPolicyPlayReadyConfiguration, self).__init__()
