...
class Assign(AAZCommand):
    ...
    :example: Assign an identity to the application gateway.
    ...
    class ApplicationGatewaysGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_application_gateway_read(cls._schema_on_200)
    ...
    class ApplicationGatewaysCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_application_gateway_read(cls._schema_on_200_201)
