...
class Configure(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.storage_account = AAZStrArg(
            ...
            help="Name or ID of the storage account in which to save the flow logs.",
            required=True,
        )
        ...
        _args_schema.target_resource_id = AAZStrArg(
            ...
            arg_group="Parameters",
            help="The ID of the resource to configure for flow log and traffic analytics (optional) .",
            required=True,
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkWatchersSetFlowLogConfiguration(ctx=self.ctx)()
    ...
    class NetworkWatchersSetFlowLogConfiguration(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("flowAnalyticsConfiguration", AAZObjectType, ".flow_analytics_configuration")
            _builder.set_prop("properties", AAZObjectType, ".", typ_kwargs={"flags": {"required": True, "client_flatten": True}})
            _builder.set_prop("targetResourceId", AAZStrType, ".target_resource_id", typ_kwargs={"flags": {"required": True}})

            flow_analytics_configuration = _builder.get(".flowAnalyticsConfiguration")
            ...
            network_watcher_flow_analytics_configuration = _builder.get(".flowAnalyticsConfiguration.networkWatcherFlowAnalyticsConfiguration")
        ...
        def _build_schema_on_200(cls):
            ...
            _ConfigureHelper._build_schema_flow_log_information_read(cls._schema_on_200)

            return cls._schema_on_200


class _ConfigureHelper:
    """Helper class for Configure"""
