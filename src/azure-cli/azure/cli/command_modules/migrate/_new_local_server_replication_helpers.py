...
def validate_server_parameters(cmd,
                               machine_id,
                               machine_index,
                               project_name,
                               resource_group_name,
...
def _process_target_fabrics(all_fabrics,
    ...
    for fabric in all_fabrics:
        ...
        if is_succeeded and is_correct_instance and name_matches:
            ...
            break
    return target_fabric, target_fabric_candidates, target_fabric_instance_type
...
def process_target_fabric(cmd,
    ...
    target_fabric, target_fabric_candidates, target_fabric_instance_type = _process_target_fabrics(
        all_fabrics,
        target_appliance_name,
        amh_solution)
...
def _handle_configuration_validation(cmd,
    ...
    return hyperv_generation, source_cpu_cores, is_source_dynamic_memory, source_memory_mb, protected_item_uri
...
def create_protected_item(cmd,
    ...
    hyperv_generation, source_cpu_cores, is_source_dynamic_memory, source_memory_mb, protected_item_uri = config_result
