...
from azure.cli.testsdk import (ScenarioTest, ResourceGroupPreparer, JMESPathCheck,
                               JMESPathCheckExists, JMESPathCheckNotExists, live_only, StorageAccountPreparer)
...
class ContainerAppJobsCRUDOperationsTest(ScenarioTest):
    ...
    def test_containerapp_manualjob_withidentity_crudoperations_e2e(self, resource_group):
        ...
        user_identity = self.cmd('identity create -g {} -n {}'.format(resource_group,
                                 user_identity_name)).get_output_in_json()
