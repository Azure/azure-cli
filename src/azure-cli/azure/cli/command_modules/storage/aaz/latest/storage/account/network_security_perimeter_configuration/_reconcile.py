...
@register_command(
    "storage account network-security-perimeter-configuration reconcile",
)
class Reconcile(AAZCommand):
    """Refreshes any information about the association.

    :example: Refreshes any information about the association
        az storage account network-security-perimeter-configuration reconcile --resource-group res4410 --account-name sto8607 --network-security-perimeter-configuration-name dbedb4e0-40e6-4145-81f3-f1314c150774.resourceAssociation1
    """
