...
-   "name": |-
    ...
    "text": |-
        az servicebus georecovery-alias authorization-rule keys list --resource-group myresourcegroup --namespace-name mynamespace --name myauthorule
"""
...
-   "name": |-
        Shows the list of Authorization Rule by Service Bus Namespace
    "text": |-
        az servicebus georecovery-alias authorization-rule list --resource-group myresourcegroup --namespace-name mynamespace --alias myaliasname
"""
...
-   "name": |-
    ...
    "text": |-
        az servicebus georecovery-alias delete --resource-group myresourcegroup --namespace-name secondarynamespace --alias myaliasname
"""
...
-   "name": |-
    ...
    "text": |-
        az servicebus georecovery-alias exists --resource-group myresourcegroup --namespace-name primarynamespace --alias myaliasname
"""
...
"examples":
-   "name": |-
        Invokes Geo-Disaster Recovery Configuration Alias failover and reconfigure the alias to point to the secondary namespace
    "text": |-
...
-   "name": |-
    ...
    "text": |-
        az servicebus georecovery-alias show  --resource-group myresourcegroup --namespace-name primarynamespace --alias myaliasname
-   "name": |-
        Get details of Alias (Geo DR Configuration)  of the Secondary Namespace
    "text": |-
        az servicebus georecovery-alias show  --resource-group myresourcegroup --namespace-name secondarynamespace --alias myaliasname
-   "name": |-
        Shows properties of Service Bus Geo-Disaster Recovery Configuration Alias for Primay/Secondary Namespace.
    "text": |-
        az servicebus georecovery-alias show --namespace-name primarynamespace --alias myaliasname --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create and Start Service Bus Migration of Standard to Premium namespace
    "text": |-
        az servicebus migration start --resource-group myresourcegroup --name standardnamespace --target-namespace ARMIDpremiumnamespace --post-migration-name mypostmigrationname
"""
...
"examples":
-   "name": |-
        Create Authorization Rule 'myauthorule' for the given Service Bus Namespace 'mynamepsace' in resourcegroup
    "text": |-
...
-   "name": |-
        List the keys and connection strings of Authorization Rule for Service Bus Namespace.
    "text": |-
        az servicebus namespace authorization-rule keys list --namespace-name mynamespace --name myauthorule --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Shows the list of Authorization Rule by Service Bus Namespace.
    "text": |-
        az servicebus namespace authorization-rule list --namespace-name mynamespace --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
"examples":
-   "name": |-
        Updates Authorization Rule 'myauthorule' for the given Service Bus Namespace 'mynamepsace' in resourcegroup
    "text": |-
...
-   "name": |-
        Create Authorization Rule for the given Service Bus Queue.
    "text": |-
        az servicebus queue authorization-rule create --namespace-name mynamespace --name myauthorule --rights Listen --queue-name myqueue --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List the keys and connection strings of Authorization Rule for the given Service Bus Queue.
    "text": |-
        az servicebus queue authorization-rule keys list --namespace-name mynamespace --name myauthorule --queue-name myqueue --resource-group myresourcegroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List the keys and connection strings of Authorization Rule for Service Bus Topic.
    "text": |-
        az servicebus topic authorization-rule keys list --query [0] --topic-name mytopic --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --output json
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az servicebus topic subscription list --resource-group myresourcegroup --namespace-name mynamespace
-   "name": |-
        List the Subscription by Service Bus Topic.
    "text": |-
...
-   "name": |-
    ...
    "text": |-
        az servicebus topic subscription rule list --resource-group myresourcegroup --namespace-name mynamespace --subscription-name mysubscription
-   "name": |-
        List the ServiceBus Rule by Subscription.
    "text": |-
