...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.servicebus/namespaces/{}/networkrulesets", "2026-07-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NamespacesListNetworkRuleSets(ctx=self.ctx)()
    ...
    class NamespacesListNetworkRuleSets(AAZHttpOperation):
