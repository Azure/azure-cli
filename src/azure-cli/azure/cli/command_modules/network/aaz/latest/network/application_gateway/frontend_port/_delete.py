...
@register_command(
    "network application-gateway frontend-port delete",
)
class Delete(AAZCommand):
    """Delete a frontend port.

    :example: Delete a frontend port.
    ...
    _aaz_info = {
        "version": "2023-11-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2023-11-01", "properties.frontendPorts[]"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the frontend port.",
            required=True,
        )
        return cls._args_schema
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.frontendPorts
