...
-   "name": |-
    ...
    "text": |-
        az sql db audit-policy show --output json --server <server> --name MyAzureSQLDatabase --query [0] --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Cancel an operation.
    "text": |-
        az sql db op cancel -g mygroup -s myserver -d mydb -n d2896db1-2ba8-4c84-bac1-387c430cce40
"""
...
-   "name": |-
    ...
    "text": |-
        az sql db tde show --server <server> --database <database> --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az sql db threat-policy show --output json --server <server> --name MyAzureSQLDatabase --query [0] --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Cancel an operation.
    "text": |-
        az sql elastic-pool op cancel -g mygroup -s myserver -ep myelasticpool -n d2896db1-2ba8-4c84-bac1-387c430cce40
"""
...
"examples":
-   "name": |-
        Restore a managed database using Point in time restore
    "text": |-
...
-   "name": |-
        Gets a server.
    "text": |-
        az sql server show --resource-group MyResourceGroup --name MyAzureSQLServer
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az sql server firewall-rule delete --server <server> --resource-group MyResourceGroup --name MyFirewallRule
    "crafted": |-
        True
"""
...
-   "name": |-
        Create a firewall rule.
    "text": |-
        az sql server firewall-rule create --server myserver --start-ip-address 1.2.3.4 --name myrule --end-ip-address 5.6.7.8 --resource-group mygroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Shows the details for a firewall rule.
    "text": |-
        az sql server firewall-rule show --server myserver --name myrule --resource-group mygroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Update a firewall rule
    "text": |-
        az sql server firewall-rule update -g mygroup -s myserver -n myrule --start-ip-address 9.8.7.6 --end-ip-address 5.4.3.2
-   "name": |-
        Update a firewall rule.
    "text": |-
        az sql server firewall-rule update --server myserver --start-ip-address 9.8.7.6 --name myrule --end-ip-address 5.4.3.2 --resource-group mygroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az sql server vnet-rule create --subnet subnetName --vnet-name vnetName
"""
