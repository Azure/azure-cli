...
def load_command_table(self, _):
    ...
    with self.command_group('network lb', network_lb_sdk) as g:
        from azure.cli.core.commands.progress import TimingProgressBar, SpinnerProgressBar
        g.show_command('show', 'get')
        g.custom_command('create', 'create_load_balancer', transform=DeploymentOutputLongRunningOperation(self.cli_ctx),
        ...
        g.command('delete', 'begin_delete', progress=SpinnerProgressBar(self.cli_ctx))
