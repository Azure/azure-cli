...
@register_command(
    "security va sql baseline list",
    is_preview=True,
)
class List(AAZCommand):
    """List the results for all rules in the Baseline.

    :example: List baseline for all rules on an Azure SQL database.
    ...
    :example: List baseline for all rules at the server level (system database 'master').
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SqlVulnerabilityAssessmentBaselineRulesList(ctx=self.ctx)()
    ...
    class SqlVulnerabilityAssessmentBaselineRulesList(AAZHttpOperation):
