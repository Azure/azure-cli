...
examples:
  ...
  - name: Create HTTP settings. (autogenerated)
    text: |
        az network application-gateway http-settings create --cookie-based-affinity Enabled --enable-probe true --gateway-name MyAppGateway --host-name MyHost --name MyHttpSettings --port 80 --probe MyNewProbe --protocol Http --resource-group MyResourceGroup --timeout 30
    crafted: true
"""
...
examples:
  - name: Delete a rewrite rule. (autogenerated)
    text: |
        az network application-gateway rewrite-rule delete --gateway-name MyGateway --name MyRewriteRule --resource-group MyResourceGroup --rule-set-name MyRuleSet --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    text: |
        az network application-gateway waf-policy custom-rule update --action Allow --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy. (autogenerated)
    text: |
        az network application-gateway waf-policy update --add communities='12076:5010' --name MyApplicationGatewayWAFPolicy --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
  - name: Update an application gateway WAF policy. (autogenerated)
    text: |
        az network application-gateway waf-policy update --name MyApplicationGatewayWAFPolicy --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  ...
  - name: Update an NS record set. (autogenerated)
    text: |
        az network dns record-set ns update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Update an SRV record set (autogenerated)
    text: |
        az network dns record-set srv update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Update a TXT record set. (autogenerated)
    text: |
        az network dns record-set txt update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    text: |
        az network express-route peering update --circuit-name MyCircuit --ip-version IPv4 --name MyPeering --peer-asn 10002 --primary-peer-subnet 2002:db00::/126 --resource-group MyResourceGroup --secondary-peer-subnet 2003:db00::/126 --vlan-id 103
    crafted: true
"""
...
examples:
  ...
  - name: List rules in a route filter. (autogenerated)
    text: |
        az network route-filter rule list --filter-name MyRouteFilter --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a route in a route table. (autogenerated)
    text: |
        az network route-table route update --name MyRoute --next-hop-ip-address 10.0.100.5 --resource-group MyResourceGroup --route-table-name MyRouteTable --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create a service endpoint policy. (autogenerated)
    text: |
        az network service-endpoint policy create --location westus2 --name MyServiceEndpointPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a service endpoint policy. (autogenerated)
    text: |
        az network service-endpoint policy delete --name myserviceendpointpolicy --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a traffic manager profile. (autogenerated)
    text: |
        az network traffic-manager profile update --name MyTmProfile --resource-group MyResourceGroup --routing-method Performance
    crafted: true
"""
...
examples:
  - name: List all endpoints form a connection monitor. (autogenerated)
    text: |
        az network watcher connection-monitor endpoint list --connection-monitor MyConnectionMonitor --location westus2 --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List all output from a connection monitor. (autogenerated)
    text: |
        az network watcher connection-monitor output list --connection-monitor MyConnectionMonitor --location westus2
    crafted: true
"""
