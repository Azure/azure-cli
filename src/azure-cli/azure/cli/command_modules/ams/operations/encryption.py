...
from azure.mgmt.media.models import (MediaService, AccountEncryption, KeyVaultProperties, ResourceIdentity,
...
def set_encryption(client, resource_group_name, account_name, key_type=None,
    ...
    try:
        account_info: MediaService = client.get(resource_group_name, account_name)\
        ...
        media_service: MediaService = MediaService(location=account_info.location,
                                                   storage_accounts=account_info.storage_accounts,
                                                   key_delivery=account_info.key_delivery,
                                                   identity=account_info.identity, encryption=encryption,
