...
class Show(AAZCommand):
    ...
    :example: Get the specified ANF snapshot
    ...
    _aaz_info = {
        "version": "2024-03-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/snapshots/{}", "2024-03-01"],
        ]
    }
