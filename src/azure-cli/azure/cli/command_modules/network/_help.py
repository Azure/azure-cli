...
examples:
  ...
  - name: Update an HTTP listener. (autogenerated)
    text: |
        az network application-gateway http-listener update --gateway-name MyAppGateway --host-names www.mynewhost.com --name MyHttpListener --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create HTTP settings. (autogenerated)
    text: |
        az network application-gateway http-settings create --cookie-based-affinity Enabled --gateway-name MyAppGateway --name MyHttpSettings --port 80 --probe MyNewProbe --protocol Http --resource-group MyResourceGroup --timeout 30
    crafted: true
"""
...
type: command
examples:
  - name: Delete a rewrite rule set. (autogenerated)
    text: |
        az network application-gateway rewrite-rule set delete --gateway-name mygateway --name myrewriteruleset --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete an application gateway WAF policy custom rule. (autogenerated)
    text: |
        az network application-gateway waf-policy custom-rule delete --name mywafpolicyrule --policy-name mypolicy --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Add managed rule set to the WAF policy managed rules (commonly used with --output). (autogenerated)
    text: |
...
examples:
  ...
  - name: Override rules under rule group EQUEST-921-PROTOCOL-ATTACK (autogenerated)
    text: |
        az network application-gateway waf-policy managed-rule rule-set update --group-name REQUEST-921-PROTOCOL-ATTACK --policy-name MyPolicy --resource-group MyResourceGroup --rules 921130 921160 --type Microsoft_BotManagerRuleSet --version 0.1
    crafted: true
"""
...
examples:
  ...
  - name: Delete an application security group. (autogenerated)
    text: |
        az network asg delete --name MyAsg --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Create a DDoS protection plan. (autogenerated)
    text: |
        az network ddos-protection create --name MyDdosPlan --resource-group MyResourceGroup --vnets MyVnet
    crafted: true
"""
...
examples:
  ...
  - name: Create an empty NS record set (autogenerated)
    text: |
        az network dns record-set ns create --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of an NS record set. (autogenerated)
    text: |
        az network dns record-set ns show --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create an empty SRV record set. (autogenerated)
    text: |
        az network dns record-set srv create --metadata owner=WebTeam --name MyRecordSet --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
  ...
  - name: Remove a TXT record from its record set.
    text: |
        az network dns record-set txt remove-record -g MyResourceGroup -z www.mysite.com \\
            -n MyRecordSet -v Owner=WebTeam
  - name: Remove a TXT record from its record set. (autogenerated)
    text: |
        az network dns record-set txt remove-record --keep-empty-record-set --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --value Owner=WebTeam --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create a new link authorization for an ExpressRoute circuit. (autogenerated)
    text: |
        az network express-route auth create --circuit-name MyCircuit --name MyAuthorization --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Delete a link authorization of an ExpressRoute circuit. (autogenerated)
    text: |
        az network express-route auth delete --circuit-name MyCircuit --name MyAuthorization --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update settings of an ExpressRoute circuit. (autogenerated)
    text: |
        az network express-route update --allow-global-reach true --name MyCircuit --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an outbound-rule. (autogenerated)
    text: |
        az network lb outbound-rule update --lb-name MyLb --name MyOutboundRule --outbound-ports 10000 --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a load balancing rule. (autogenerated)
    text: |
        az network lb rule update --backend-pool-name mybackendpool --lb-name MyLb --name MyLbRule --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a route in a route table. (autogenerated)
    text: |
        az network route-table route update --name MyRoute --next-hop-ip-address 10.0.100.5 --next-hop-type VirtualNetworkGateway --resource-group MyResourceGroup --route-table-name MyRouteTable
    crafted: true
"""
...
examples:
  - name: List all virtual routers under a subscription or a resource group. (autogenerated)
    text: |
        az network vrouter list --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Show a test group of a connection monitor. (autogenerated)
    text: |
        az network watcher connection-monitor test-group show --connection-monitor MyConnectionMonitor --location westus2 --name myconnectionmonitortestgroup
    crafted: true
"""
