...
class FileTaskStepUpdateParameters(TaskStepUpdateParameters):
    ...
    def __init__(self, context_path=None, context_access_token=None, task_file_path=None, values_file_path=None, values=None):
        super(FileTaskStepUpdateParameters, self).__init__(context_path=context_path, context_access_token=context_access_token)
