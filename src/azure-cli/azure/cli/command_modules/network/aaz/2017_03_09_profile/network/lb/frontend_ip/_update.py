...
class _UpdateHelper:
    ...
    def _build_schema_network_security_group_update(cls, _builder):
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].etag")
            _elements.set_prop("id", AAZStrType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].id")
            _elements.set_prop("name", AAZStrType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.networkInterfaces[].properties.ipConfigurations[].properties")
        if properties is not None:
            properties.set_prop("loadBalancerBackendAddressPools", AAZListType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].load_balancer_backend_address_pools")
            properties.set_prop("loadBalancerInboundNatRules", AAZListType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].load_balancer_inbound_nat_rules")
            properties.set_prop("primary", AAZBoolType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].primary")
            properties.set_prop("privateIPAddress", AAZStrType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].private_ip_address")
            properties.set_prop("privateIPAllocationMethod", AAZStrType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].private_ip_allocation_method")
            properties.set_prop("provisioningState", AAZStrType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].provisioning_state")
            cls._build_schema_public_ip_address_update(properties.set_prop("publicIPAddress", AAZObjectType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].public_ip_address"))
            cls._build_schema_subnet_update(properties.set_prop("subnet", AAZObjectType, "@NetworkSecurityGroup_update.network_interfaces.[].ip_configurations.[].subnet"))
