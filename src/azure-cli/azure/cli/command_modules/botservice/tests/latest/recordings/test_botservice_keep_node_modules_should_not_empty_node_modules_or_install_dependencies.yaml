...
- request:
    body: '{"location": "global", "sku": {"name": "F0"}, "kind": "azurebot", "properties":
      ...
      "d9cd79ec-c1d6-4b9f-b34d-67c6f2488ab5", "isCmekEnabled": false, "publicNetworkAccess":
  ...
  response:
    ...
    headers:
      ...
      - application/json; charset=utf-8
      date:
      - Fri, 24 Jun 2022 09:08:16 GMT
      etag:
      - '"ba00d958-0000-1800-0000-62b57efe0000"'
      expires:
      - '-1'
      pragma:
      - no-cache
