...
class Restart(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-11-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.compute/virtualmachinescalesets/{}/restart", "2024-11-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualMachineScaleSetsRestart(ctx=self.ctx)()
    ...
    class VirtualMachineScaleSetsRestart(AAZHttpOperation):
