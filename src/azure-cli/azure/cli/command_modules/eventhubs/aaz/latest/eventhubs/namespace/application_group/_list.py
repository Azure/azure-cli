...
@register_command(
    "eventhubs namespace application-group list",
)
class List(AAZCommand):
    """List a list of application groups for a Namespace.

    :example: ListApplicationGroups
        az eventhubs namespace application-group list --resource-group contosotest --namespace-name contoso-ua-test-eh-system-1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ApplicationGroupListByNamespace(ctx=self.ctx)()
    ...
    class ApplicationGroupListByNamespace(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element = cls._schema_on_200.value.Element.properties.policies.Element
            _element.name = AAZStrType(
                flags={"required": True},
            )
            _element.type = AAZStrType(
            ...
            disc_throttling_policy = cls._schema_on_200.value.Element.properties.policies.Element.discriminate_by("type", "ThrottlingPolicy")
