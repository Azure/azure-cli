...
class Wait(AAZWaitCommand):
    ...
    class SecurityRulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_application_security_group_read(destination_application_security_groups.Element)
            ...
            _WaitHelper._build_schema_application_security_group_read(source_application_security_groups.Element)
