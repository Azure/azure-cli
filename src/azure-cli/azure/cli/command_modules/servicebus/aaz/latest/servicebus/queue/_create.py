...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.max_size_in_megabytes = AAZIntArg(
            ...
            arg_group="Properties",
            help="The maximum capacity of the queue, denoted in megabytes, signifies the volume of memory assigned to the queu . The permissible values for this parameter are 1024, 2048, 3072, 4096, and 5120 megabytes. By default, the system assigns a capacity of 1024 megabytes. If the ‘enable-partition’ setting is set to true, the specified queue size will be amplified by a factor of 16.",
        )
