...
2.2.23
++++++
* vmss create `--single-placement-group`: Removed client-side validation. Does not fail if `--instance-count` is greater
  than 100 / zones are specified and `--single-placement-group` is set to true.
