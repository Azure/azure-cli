...
examples:
  ...
  - name: List the primary and secondary keys for a storage account (autogenerated)
    text: az storage account keys list --account-name MyStorageAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Add a network rule. (autogenerated)
    text: az storage account network-rule add --account-name mystorageaccount --ip-address 23.45.1.0/24 --resource-group myRg
    crafted: true
"""
...
examples:
  ...
  - name: Show storage account properties. (autogenerated)
    text: az storage account show --name MyStorageAccount
    crafted: true
"""
...
examples:
  ...
  - name: Get the connection string for a storage account. (autogenerated)
    ...
    crafted: true
  - name: Get the connection string for a storage account. (autogenerated)
    text: az storage account show-connection-string --name MyStorageAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete blobs from a blob container recursively. (autogenerated)
    text: az storage blob delete-batch --account-name MyStorageAccount --source MyContainer
    crafted: true
"""
...
examples:
  ...
  - name: List blobs in a given container. (autogenerated)
    text: az storage blob list --container-name MyContainer
    crafted: true
"""
...
examples:
  ...
  - name: Upload a file to a storage blob. (autogenerated)
    text: az storage blob upload --container-name MyContainer --file /path/to/file --name MyBlob
    crafted: true
"""
...
examples:
  ...
  - name: Upload files from a local directory to a blob container. (autogenerated)
    text: az storage blob upload-batch --account-name MyStorageAccount --destination MyContainer --source directory_path
    crafted: true
"""
...
examples:
  ...
  - name: Upload a file to a share that uses the SMB 3.0 protocol. (autogenerated)
    ...
    crafted: true
  - name: Upload a file to a share that uses the SMB 3.0 protocol. (autogenerated)
    text: az storage file upload --account-name MyStorageAccount --share-name MyShare --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Show logging settings for a storage account. (autogenerated)
    text: az storage logging show --account-name MyAccount --services bfqt
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the share. (autogenerated)
    ...
    crafted: true
  - name: Generates a shared access signature for the share (autogenerated)
    text: az storage share generate-sas --account-key 00000000 --account-name MyStorageAccount --expiry 2020-01-01 --name MyShare --permissions dlrw
    crafted: true
"""
