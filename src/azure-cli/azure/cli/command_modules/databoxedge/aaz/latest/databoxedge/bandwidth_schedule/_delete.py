...
class Delete(AAZCommand):
    ...
    :example: Delete the specified bandwidth schedule.
        az databoxedge bandwidth-schedule delete --device-name testedgedevice --name bandwidth-1 --resource-group GroupForEdgeAutomation
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BandwidthSchedulesDelete(ctx=self.ctx)()
