...
class Update(AAZCommand):
    ...
    :example: Update a frontend IP address.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the frontend IP configuration.",
            required=True,
        )
        ...
        _args_schema.subnet = AAZStrArg(
            options=["--subnet"],
            help="Name or ID of the subnet. If using Name, you need to provide `--vnet-name` as well.",
            nullable=True,
        )
