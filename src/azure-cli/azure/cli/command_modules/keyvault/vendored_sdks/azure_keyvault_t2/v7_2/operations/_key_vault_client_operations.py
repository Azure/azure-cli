...
class KeyVaultClientOperationsMixin(object):
    ...
    def get_certificates(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.CertificateItem]
        :raises:
    ...
    def get_certificate_issuers(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.CertificateIssuerItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def set_certificate_issuer(self, vault_base_url, issuer_name, provider, credentials=None, organization_details=None, attributes=None, cls=None, **kwargs):
        ...
        :type organization_details:
         ~azure.keyvault.v7_2.models.OrganizationDetails
    ...
    def create_certificate(self, vault_base_url, certificate_name, certificate_policy=None, certificate_attributes=None, tags=None, cls=None, **kwargs):
        ...
        :type certificate_policy:
         ~azure.keyvault.v7_2.models.CertificatePolicy
        :param certificate_attributes: The attributes of the certificate
         (optional).
        :type certificate_attributes:
         ~azure.keyvault.v7_2.models.CertificateAttributes
    ...
    def get_deleted_certificates(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.DeletedCertificateItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_key_versions(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.KeyItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def encrypt(self, vault_base_url, key_name, key_version, algorithm, value, iv=None, aad=None, tag=None, cls=None, **kwargs):
    ...
    def decrypt(self, vault_base_url, key_name, key_version, algorithm, value, iv=None, aad=None, tag=None, cls=None, **kwargs):
    ...
    def sign(self, vault_base_url, key_name, key_version, algorithm, value, cls=None, **kwargs):
        ...
        :param algorithm: The signing/verification algorithm identifier. For
         ...
         'ES384', 'ES512', 'ES256K'
        :type algorithm: str or
         ~azure.keyvault.v7_2.models.JsonWebKeySignatureAlgorithm
        :param value:
        :type value: bytes
        :param callable cls: A custom type or function that will be passed the
         direct response
    ...
    def wrap_key(self, vault_base_url, key_name, key_version, algorithm, value, iv=None, aad=None, tag=None, cls=None, **kwargs):
    ...
    def unwrap_key(self, vault_base_url, key_name, key_version, algorithm, value, iv=None, aad=None, tag=None, cls=None, **kwargs):
    ...
    def get_deleted_keys(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.DeletedKeyItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_secrets(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.SecretItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_secrets(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.DeletedSecretItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_storage_accounts(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.StorageAccountItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_storage_accounts(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.DeletedStorageAccountItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_storage_account(self, vault_base_url, storage_account_name, cls=None, **kwargs):
        ...
        :rtype: ~azure.keyvault.v7_2.models.DeletedStorageBundle
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def recover_deleted_storage_account(self, vault_base_url, storage_account_name, cls=None, **kwargs):
        ...
        :rtype: ~azure.keyvault.v7_2.models.StorageBundle
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def backup_storage_account(self, vault_base_url, storage_account_name, cls=None, **kwargs):
        ...
        :rtype: ~azure.keyvault.v7_2.models.BackupStorageResult
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def set_storage_account(self, vault_base_url, storage_account_name, resource_id, active_key_name, auto_regenerate_key, regeneration_period=None, storage_account_attributes=None, tags=None, cls=None, **kwargs):
        ...
        :type storage_account_attributes:
         ~azure.keyvault.v7_2.models.StorageAccountAttributes
        :param tags: Application specific metadata in the form of key-value
         pairs.
        :type tags: dict[str, str]
        :param callable cls: A custom type or function that will be passed the
    ...
    def get_sas_definitions(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.SasDefinitionItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_sas_definitions(
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.keyvault.v7_2.models.DeletedSasDefinitionItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_sas_definition(self, vault_base_url, storage_account_name, sas_definition_name, cls=None, **kwargs):
        ...
        :rtype: ~azure.keyvault.v7_2.models.DeletedSasDefinitionBundle
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def recover_deleted_sas_definition(self, vault_base_url, storage_account_name, sas_definition_name, cls=None, **kwargs):
        ...
        :rtype: ~azure.keyvault.v7_2.models.SasDefinitionBundle
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def set_sas_definition(self, vault_base_url, storage_account_name, sas_definition_name, template_uri, sas_type, validity_period, sas_definition_attributes=None, tags=None, cls=None, **kwargs):
        ...
        :type sas_type: str or ~azure.keyvault.v7_2.models.SasTokenType
        ...
        :type sas_definition_attributes:
         ~azure.keyvault.v7_2.models.SasDefinitionAttributes
        :param tags: Application specific metadata in the form of key-value
         pairs.
        :type tags: dict[str, str]
        :param callable cls: A custom type or function that will be passed the
    ...
    def begin_full_backup(
        ...
        if polling is True:
            polling_method = LROBasePolling(lro_delay, lro_options={'final-state-via': 'azure-async-operation'},
                                            **kwargs)
    ...
    def selective_key_restore_operation_method(self, vault_base_url, key_name, sas_token_parameters, folder, cls=None, **kwargs):
        ...
        :param folder: The Folder name of the blob where the previous
        ...
        error_map = kwargs.pop('error_map', None)
        restore_blob_details = None
        if sas_token_parameters is not None or folder is not None:
            restore_blob_details = models.SelectiveKeyRestoreOperationParameters(sas_token_parameters=sas_token_parameters, folder=folder)
