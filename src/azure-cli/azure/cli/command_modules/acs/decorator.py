...
class AKSContext:
    ...
    def get_nodepool_taints_value(self) -> Union[List[str], None]:
        ...
        if self.mc and self.mc.agent_pool_profiles:
            ...
            if agent_pool_profile:
                value_obtained_from_mc = agent_pool_profile.node_taints
...
class AKSCreateDecorator:
    ...
    def set_up_agent_pool_profiles(self, mc: ManagedCluster) -> ManagedCluster:
        ...
        agent_pool_profile = self.models.ManagedClusterAgentPoolProfile(
            ...
            node_taints=self.context.get_nodepool_taints_value(),
            count=node_count,
