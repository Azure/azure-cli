...
examples:
  ...
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account delete --name myresource-luis --resource-group cognitive-services-resource-group
    crafted: true
"""
...
examples:
  ...
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account update --name myresource --resource-group cognitive-services-resource-group --sku S0
    crafted: true
"""
