...
examples:
  ...
  - name: Regenerate the connection strings of Authorizationrule for the namespace. (autogenerated)
    text: |
        az eventhubs eventhub authorization-rule keys renew --eventhub-name myeventhub --key PrimaryKey --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Sets a Geo-Disaster Recovery Configuration Alias for the give Namespace (autogenerated)
    text: |
        az eventhubs georecovery-alias set --alias myaliasname --alternate-name MyAlternate --namespace-name primarynamespace --partner-namespace resourcearmid --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Updates the EventHubs Namespace (autogenerated)
    text: |
        az eventhubs namespace update --default-action Allow --name mynamespace --resource-group myresourcegroup
    crafted: true
"""
