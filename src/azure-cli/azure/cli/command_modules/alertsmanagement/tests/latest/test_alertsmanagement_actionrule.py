...
class AzureAlertsManagementActionRuleScenarioTest(ScenarioTest):
    ...
    def test_actionrule_suppression(self, resource_group):
        ...
        actionrule = self.cmd('alertsmanagement action-rule set --resource-group-name {} --name {} --scope "/subscriptions/dd91de05-d791-4ceb-b6dc-988682dc7d72/resourceGroups/alertslab","/subscriptions/dd91de05-d791-4ceb-b6dc-988682dc7d72/resourceGroups/Test-VMs" --severity-condition "Equals:Sev0,Sev1" --monitor-condition "NotEquals:Resolved" --description "Test description" --status "Enabled" --action-rule-type "Suppression" --recurrence-type "Weekly" --suppression-start-time "06/26/2018 06:00:00" --suppression-end-time "07/27/2018 06:00:00" --recurrence-values 1,4,6'.format(resource_group, action_rule_name)).get_output_in_json()
        ...
        self.check(status, actionrule['properties']['status'])
