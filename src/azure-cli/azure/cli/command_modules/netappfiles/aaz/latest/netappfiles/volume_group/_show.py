...
@register_command(
    "netappfiles volume-group show",
)
class Show(AAZCommand):
    """Get details of the specified volume group

    :example: Get an ANF volume group
    ...
    class VolumeGroupsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_placement_key_value_pairs_read(global_placement_rules.Element)
            ...
            _ShowHelper._build_schema_placement_key_value_pairs_read(placement_rules.Element)
