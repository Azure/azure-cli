...
examples:
  - name: Place the CLI in a waiting state until a condition of a apim api schema is met. (autogenerated)
    text: |
        az apim api wait --created --api-id MyApi --name MyApim --schema-id schemaId --resource-group MyResourceGroup
    crafted: true
"""
