...
examples:
  - name: remove an application owner. (autogenerated)
    text: |
        az ad app owner remove --id 00000000-0000-0000-0000-000000000000 --owner-object-id xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    crafted: true
"""
...
examples:
  - name: Get groups of which the user is a member (autogenerated)
    text: |
        az ad user get-member-groups --id 00000000-0000-0000-0000-000000000000
    crafted: true
"""
