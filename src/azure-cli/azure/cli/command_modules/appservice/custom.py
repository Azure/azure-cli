...
def create_webapp(cmd, resource_group_name, name, plan, runtime=None, startup_file=None,  # pylint: disable=too-many-statements,too-many-branches
    ...
    if is_linux:
        ...
        if runtime:
            ...
            if not match:
                raise ValidationError("Linux Runtime '{}' is not supported. Run 'az webapp list-runtimes --os-type linux' to cross check".format(runtime))
        ...
        if not match:
            raise ValidationError("Windows runtime '{}' is not supported. Run 'az webapp list-runtimes --os-type windows' to cross check".format(runtime))
        helper.get_site_config_setter(match, linux=is_linux)(cmd=cmd, stack=match, site_config=site_config)
