...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the request routing rule.",
            required=True,
        )
        _args_schema.priority = AAZIntArg(
            options=["--priority"],
            help="Priority of the request routing rule. Supported SKU tiers are Standard_v2, WAF_v2.",
            fmt=AAZIntArgFormat(
                maximum=20000,
                minimum=1,
            ),
        ...
        _args_schema.rule_type = AAZStrArg(
            options=["--rule-type"],
            help="Type of the request routing rule.",
            default="Basic",
            enum={"Basic": "Basic", "PathBasedRouting": "PathBasedRouting"},
        )

        # define Arg Group "Parameters.properties.requestRoutingRules[]"
        ...
        _args_schema.http_listener = AAZStrArg(
            ...
            arg_group="Properties",
            help="Name or ID of the HTTP listener. If only one exists, omit to use as default.",
        )
        ...
        _args_schema.rewrite_rule_set = AAZStrArg(
            ...
            arg_group="Properties",
            help="Name or ID of the rewrite rule set.",
        )
        _args_schema.url_path_map = AAZStrArg(
            options=["--url-path-map"],
            arg_group="Properties",
            help="Name or ID of the url path map.",
        )
        return cls._args_schema
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.requestRoutingRules
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("urlPathMap", AAZObjectType)
            ...
            http_listener = _builder.get(".properties.httpListener")
            if http_listener is not None:
                http_listener.set_prop("id", AAZStrType, ".http_listener")
            ...
            url_path_map = _builder.get(".properties.urlPathMap")
            if url_path_map is not None:
                url_path_map.set_prop("id", AAZStrType, ".url_path_map")

            return _instance_value


@register_command(
    "network application-gateway rule delete",
)
...
@register_command(
    "network application-gateway rule list",
)
class List(AAZCommand):
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.requestRoutingRules

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.requestRoutingRules = value
            return
...
@register_command(
    "network application-gateway rule show",
)
class Show(AAZCommand):
    """Get the details of a rule.

    :example: Get the details of a rule.
...
class Update(AAZCommand):
    ...
    :example: Update a rule use a new HTTP listener.
...
@register_command(
    "network application-gateway rule wait",
)
