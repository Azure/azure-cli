...
@register_command(
    "databoxedge device storage-account container delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ContainersDelete(ctx=self.ctx)()
    ...
    class ContainersDelete(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "containerName", self.ctx.args.container_name,
                    required=True,
                ),
                **self.serialize_url_param(
