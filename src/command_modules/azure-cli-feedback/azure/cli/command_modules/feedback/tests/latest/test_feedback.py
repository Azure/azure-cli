...
class TestCommandLogFile(ScenarioTest):
    ...
    def _helper_test_build_issue_info(self):
        ...
        issue_prefix, issue_body, _, original_issue_body = _build_issue_info_tup(log_file)
        items.append((log_file, issue_body, original_issue_body))
        ...
        for log_file, issue_body, original_issue_body in items:
