...
def create_vmss(cmd, vmss_name, resource_group_name, image=None,
    ...
    if orchestration_mode:
        ...
        vmss_resource = build_vmss_resource(
            ...
            patch_mode=patch_mode, enable_agent=enable_agent, v_cpus_available=v_cpus_available,
...
def update_vmss(cmd, resource_group_name, name, license_type=None, no_wait=False, instance_id=None,
                ...
                vm_sku=None, ephemeral_os_disk_placement=None, force_deletion=None,
                v_cpus_available=None, v_cpus_per_core=None,**kwargs):
    ...
    if v_cpus_available is not None:
        vmss.virtual_machine_profile.hardware_profile.vm_size_properties.v_cpus_available = v_cpus_available

    if v_cpus_per_core is not None:
        vmss.virtual_machine_profile.hardware_profile.vm_size_properties.v_cpus_per_core = v_cpus_per_core
