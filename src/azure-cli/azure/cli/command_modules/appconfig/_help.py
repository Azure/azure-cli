...
examples:
  ...
  - name: Create an App Configuration store linked to an Azure Front Door profile.
    text: az appconfig create -g MyResourceGroup -n MyAppConfiguration -l westus --sku Standard --azure-front-door-profile-resource-id /subscriptions/<SUBSCRIPTION_ID>/resourceGroups/<RESOURCEGROUP>/providers/Microsoft.Cdn/profiles/<PROFILE_NAME>
"""
...
examples:
  ...
  - name: Update an App Configuration store to link an Azure Front Door profile.
    text: az appconfig update -g MyResourceGroup -n MyAppConfiguration --azure-front-door-profile-resource-id /subscriptions/<SUBSCRIPTION_ID>/resourceGroups/<RESOURCEGROUP>/providers/Microsoft.Cdn/profiles/<PROFILE_NAME>
  - name: Update an App Configuration store to unlink an Azure Front Door profile.
    text: az appconfig update -g MyResourceGroup -n MyAppConfiguration --azure-front-door-profile-resource-id ""
"""
