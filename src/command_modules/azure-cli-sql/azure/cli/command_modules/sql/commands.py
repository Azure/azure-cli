...
def load_command_table(self, _):
    ...
    with self.command_group('sql db', capabilities_operations) as g:
        g.custom_command('list-editions', 'db_list_capabilities')

    with self.command_group('sql elastic-pool', capabilities_operations) as g:
    ...
    with self.command_group('sql', subscription_usages_operations) as g:
    ...
    with self.command_group('sql db', database_operations) as g:
    ...
    with self.command_group('sql db replica', database_operations) as g:
        g.custom_command('create', 'db_create_replica', no_wait_param='raw')

    with self.command_group('sql dw', database_operations) as g:
    ...
    with self.command_group('sql db replica', replication_links_operations) as g:
    ...
    with self.command_group('sql db audit-policy', database_blob_auditing_policies_operations) as g:
        g.command('show', 'get')
    ...
    with self.command_group('sql db threat-policy', database_threat_detection_policies_operations) as g:
        g.command('show', 'get')
    ...
    with self.command_group('sql elastic-pool', elastic_pools_ops) as g:
    ...
    with self.command_group('sql server', servers_operations) as g:
    ...
    with self.command_group('sql server firewall-rule', firewall_rules_operations) as g:
    ...
    with self.command_group('sql server ad-admin', aadadmin_operations) as g:
    ...
    with self.command_group('sql server key', server_keys_operations) as g:
    ...
    with self.command_group('sql server tde-key', encryption_protectors_operations) as g:
        g.command('show', 'get')
    ...
    with self.command_group('sql server vnet-rule', virtual_network_rules_operations) as g:
    ...
    with self.command_group('sql server conn-policy', server_connection_policies_operations) as c:
        c.command('show', 'get')
