...
class _CreateHelper:
    ...
    def _build_schema_network_interface_ip_configuration_create(cls, _builder):
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@NetworkInterfaceIPConfiguration_create.application_gateway_backend_address_pools.[].etag")
            ...
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})
            _elements.set_prop("type", AAZStrType, "@NetworkInterfaceIPConfiguration_create.application_gateway_backend_address_pools.[].type")
        ...
        if properties is not None:
            ...
            properties.set_prop("provisioningState", AAZStrType, "@NetworkInterfaceIPConfiguration_create.application_gateway_backend_address_pools.[].provisioning_state")
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@NetworkInterfaceIPConfiguration_create.virtual_network_taps.[].etag")
        ...
        if properties is not None:
            properties.set_prop("destinationLoadBalancerFrontEndIPConfiguration", AAZObjectType, "@NetworkInterfaceIPConfiguration_create.virtual_network_taps.[].destination_load_balancer_front_end_ip_configuration")
    ...
    def _build_schema_network_security_group_create(cls, _builder):
        ...
        if properties is not None:
            ...
            properties.set_prop("destinationAddressPrefix", AAZStrType, "@NetworkSecurityGroup_create.security_rules.[].destination_address_prefix")
            properties.set_prop("destinationAddressPrefixes", AAZListType, "@NetworkSecurityGroup_create.security_rules.[].destination_address_prefixes")
            properties.set_prop("destinationApplicationSecurityGroups", AAZListType, "@NetworkSecurityGroup_create.security_rules.[].destination_application_security_groups")
            properties.set_prop("destinationPortRange", AAZStrType, "@NetworkSecurityGroup_create.security_rules.[].destination_port_range")
            properties.set_prop("destinationPortRanges", AAZListType, "@NetworkSecurityGroup_create.security_rules.[].destination_port_ranges")
            ...
            properties.set_prop("sourceAddressPrefix", AAZStrType, "@NetworkSecurityGroup_create.security_rules.[].source_address_prefix")
            properties.set_prop("sourceAddressPrefixes", AAZListType, "@NetworkSecurityGroup_create.security_rules.[].source_address_prefixes")
            properties.set_prop("sourceApplicationSecurityGroups", AAZListType, "@NetworkSecurityGroup_create.security_rules.[].source_application_security_groups")
            properties.set_prop("sourcePortRange", AAZStrType, "@NetworkSecurityGroup_create.security_rules.[].source_port_range")
            properties.set_prop("sourcePortRanges", AAZListType, "@NetworkSecurityGroup_create.security_rules.[].source_port_ranges")
    ...
    def _build_schema_subnet_create(cls, _builder):
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@Subnet_create.delegations.[].etag")
        ...
        if properties is not None:
            properties.set_prop("actions", AAZListType, "@Subnet_create.delegations.[].actions")
        ...
        if _elements is not None:
            _elements.set_prop("id", AAZStrType, "@Subnet_create.resource_navigation_links.[].id")
            _elements.set_prop("name", AAZStrType, "@Subnet_create.resource_navigation_links.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.resourceNavigationLinks[].properties")
        if properties is not None:
            properties.set_prop("link", AAZStrType, "@Subnet_create.resource_navigation_links.[].link")
            properties.set_prop("linkedResourceType", AAZStrType, "@Subnet_create.resource_navigation_links.[].linked_resource_type")
        ...
        if _elements is not None:
            _elements.set_prop("id", AAZStrType, "@Subnet_create.service_association_links.[].id")
            _elements.set_prop("name", AAZStrType, "@Subnet_create.service_association_links.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.serviceAssociationLinks[].properties")
        if properties is not None:
            properties.set_prop("link", AAZStrType, "@Subnet_create.service_association_links.[].link")
            properties.set_prop("linkedResourceType", AAZStrType, "@Subnet_create.service_association_links.[].linked_resource_type")
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@Subnet_create.service_endpoint_policies.[].etag")
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@Subnet_create.service_endpoint_policies.[].service_endpoint_policy_definitions.[].etag")
        ...
        if _elements is not None:
            ...
            _elements.set_prop("provisioningState", AAZStrType, "@Subnet_create.service_endpoints.[].provisioning_state")
