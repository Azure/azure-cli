...
@register_command(
    "cosmosdb postgres check-name-availability",
)
class CheckNameAvailability(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.type = AAZStrArg(
            ...
            required=True,
            enum={"Microsoft.DBforPostgreSQL/serverGroupsv2": "Microsoft.DBforPostgreSQL/serverGroupsv2"},
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.ClustersCheckNameAvailability(ctx=self.ctx)()
    ...
    class ClustersCheckNameAvailability(AAZHttpOperation):
