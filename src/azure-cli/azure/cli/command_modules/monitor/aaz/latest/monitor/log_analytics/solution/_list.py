...
class List(AAZCommand):
    ...
    :example: List all log-analytics solutions in the current subscription
        az monitor log-analytics solution list

    :example: List all log-analytics solutions in a subscription
        az monitor log-analytics solution list --subscription MySubscription

    :example: List all log-analytics solutions in a resource group
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.SolutionsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.SolutionsListByResourceGroup(ctx=self.ctx)()
    ...
    class SolutionsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            contained_resources = cls._schema_on_200.value.Element.properties.contained_resources
            contained_resources.Element = AAZStrType()

            referenced_resources = cls._schema_on_200.value.Element.properties.referenced_resources
    ...
    class SolutionsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
