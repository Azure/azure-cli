...
@register_command(
    "cdn edge-action version create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.deployment_type = AAZStrArg(
            ...
            enum={"file": "file", "others": "others", "zip": "zip"},
        )
        _args_schema.is_default_version = AAZStrArg(
            options=["--is-default-version"],
            arg_group="Properties",
            help="The active state",
    ...
    class EdgeActionVersionsCreate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("deploymentType", AAZStrType, ".deployment_type", typ_kwargs={"flags": {"required": True}})
                properties.set_prop("isDefaultVersion", AAZStrType, ".is_default_version", typ_kwargs={"flags": {"required": True}})
