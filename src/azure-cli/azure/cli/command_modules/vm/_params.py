...
def load_arguments(self, _):
    ...
    with self.argument_context('sig create') as c:
        ...
        c.argument('soft_delete', arg_type=get_three_state_flag(), min_api='2021-03-01', help='Enables soft-deletion '
                   'for resources in this gallery, allowing them to be recovered within retention time.')
