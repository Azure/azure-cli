...
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ArtifactSourcesGet(ctx=self.ctx)()
    ...
    class ArtifactSourcesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.arm_template_folder_path = AAZStrType(
                serialized_name="armTemplateFolderPath",
            )
            properties.branch_ref = AAZStrType(
                serialized_name="branchRef",
            )
            ...
            properties.security_token = AAZStrType(
                serialized_name="securityToken",
            )
