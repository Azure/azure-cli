...
class VmCreateOperations(object):
    """VmCreateOperations operations.
    ...
    def create_or_update(
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'DeploymentVmCreate')
