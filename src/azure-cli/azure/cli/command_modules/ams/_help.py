...
examples:
  - name: Show the details of media reserved units for an Azure Media Services account. (autogenerated)
    text: az ams account mru show --name MyAzureMediaServicesAccount
    crafted: true
"""
...
examples:
  - name: Generate a new client secret for a service principal configured for an Azure Media Services account. (autogenerated)
    text: az ams account sp reset-credentials --account-name MyAccount
    crafted: true
"""
...
examples:
  - name: Update the details of an Azure Media Services account. (autogenerated)
    text: az ams account update --name MyAzureMediaServicesAccount --resource-group MyResourceGroup --subscription MySubscription --tags key=value
    crafted: true
"""
...
examples:
  - name: Delete an account filter. (autogenerated)
    text: az ams account-filter delete --account-name MyAccount --name MyAccountFilter
    crafted: true
"""
...
examples:
  - name: Update the details of an asset. (autogenerated)
    text: az ams asset update --account-name MyAccount --description newDescription --name MyAsset --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of an asset filter. (autogenerated)
    text: az ams asset-filter show --account-name MyAccount --asset-name MyAsset --name MyAssetFilter --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the details of a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint update --account-name MyAccount --disable-cdn --name MyStreamingEndpoint
    crafted: true
"""
