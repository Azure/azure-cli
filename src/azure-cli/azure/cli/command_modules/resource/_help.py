...
examples:
  ...
  - name: Delete an existing management group. (autogenerated)
    text: az account management-group delete --name GroupName
    crafted: true
"""
...
examples:
  ...
  - name: Add a subscription to a management group. (autogenerated)
    text: az account management-group subscription add --name GroupName --subscription Subscription
    crafted: true
"""
...
examples:
  ...
  - name: register a preview feature. (autogenerated)
    text: az feature register --name GalleryPreview --namespace Microsoft.Compute
    crafted: true
"""
...
examples:
  ...
  - name: Delete a resource group. (autogenerated)
    text: az group delete --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Validate whether a template is syntactically correct. (autogenerated)
    ...
    crafted: true
  - name: Validate whether a template is syntactically correct. (autogenerated)
    text: az group deployment validate --parameters @myparameters.json --resource-group MyResourceGroup --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  ...
  - name: Delete a resource group lock. (autogenerated)
    text: az group lock delete --name lockName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: List lock information in the resource-group. (autogenerated)
    text: az group lock list --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Show the details of a resource group lock (autogenerated)
    text: az group lock show --name lockname --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete a lock. (autogenerated)
    text: az lock delete --name lockName --resource-group group
    crafted: true
"""
...
examples:
  ...
  - name: Show the properties of a lock (autogenerated)
    ...
    crafted: true
  - name: Show the properties of a lock (autogenerated)
    text: az lock show --name lockname
    crafted: true
"""
...
examples:
  ...
  - name: Update a lock. (autogenerated)
    text: az lock update --lock-type CanNotDelete --name lockName --resource-group group
    crafted: true
"""
...
examples:
  ...
  - name: Tag a resource. (autogenerated)
    text: |
        az resource tag --name MyVm --resource-group MyResourceGroup --resource-type "Microsoft.Compute/virtualMachines" --tags vmlist=vm1
    crafted: true
"""
...
examples:
  - name: Update a resource. (autogenerated)
    ...
    crafted: true
  - name: Update a resource. (autogenerated)
    text: az resource update --ids /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/MyResourceGroup/providers/Microsoft.Network/virtualNetworks/MyVnet/subnets/MySubnet --set properties.connectionType=Proxy
    crafted: true
"""
...
examples:
  ...
  - name: invoke a custom request (autogenerated)
    text: |
        az rest --method head --uri "https://graph.microsoft.com/v1.0/users/johndoe@azuresdkteam.onmicrosoft.com"
    crafted: true
"""
