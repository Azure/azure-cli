...
@register_command(
    "netappfiles account identity assign",
)
class Assign(AAZCommand):
    ...
    class AccountsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_net_app_account_read(cls._schema_on_200)
    ...
    class AccountsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_net_app_account_read(cls._schema_on_200_201)
