...
class List(AAZCommand):
    ...
    :example: List private endpoints.
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.PrivateEndpointsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.PrivateEndpointsList(ctx=self.ctx)()
    ...
    class PrivateEndpointsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_common_private_endpoint_read(value.Element)

            return cls._schema_on_200

    class PrivateEndpointsList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
