...
examples:
  ...
  - name: Deletes Service Bus Geo-Disaster Recovery Configuration Alias request accepted (autogenerated)
    text: az servicebus georecovery-alias delete --alias myaliasname --namespace-name secondarynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Check if Geo Recovery Alias Name is available (autogenerated)
    text: az servicebus georecovery-alias exists --alias myaliasname --namespace-name primarynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Disable the Service Bus Migration of Standard to Premium namespace (autogenerated)
    text: az servicebus migration abort --name standardnamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Completes the Service Bus Migration of Standard to Premium namespace (autogenerated)
    text: az servicebus migration complete --name standardnamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows properties of properties of Service Bus Migration (autogenerated)
    text: az servicebus migration show --name standardnamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Create and Start Service Bus Migration of Standard to Premium namespace. (autogenerated)
    text: az servicebus migration start --name standardnamespace --post-migration-name mypostmigrationname --resource-group myresourcegroup --target-namespace ARMIDpremiumnamespace
    crafted: true
"""
...
examples:
  ...
  - name: Deletes the Authorization Rule of the Service Bus Namespace. (autogenerated)
    text: az servicebus namespace authorization-rule delete --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the keys and connection strings of Authorization Rule for Service Bus Namespace (autogenerated)
    text: az servicebus namespace authorization-rule keys list --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Regenerate keys of Authorization Rule for the Service Bus Namespace (autogenerated)
    ...
    crafted: true
  - name: Regenerate keys of Authorization Rule for the Service Bus Namespace. (autogenerated)
    text: az servicebus namespace authorization-rule keys renew --key PrimaryKey --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the list of Authorization Rule by Service Bus Namespace (autogenerated)
    text: az servicebus namespace authorization-rule list --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the details of Service Bus Namespace Authorization Rule (autogenerated)
    text: az servicebus namespace authorization-rule show --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Show properties of Network rule of the given Namespace. (autogenerated)
    text: az servicebus namespace network-rule list --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Shows the Service Bus Namespace details (autogenerated)
    text: az servicebus namespace show --name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the keys and connection strings of Authorization Rule for the given Service Bus Queue (autogenerated)
    text: az servicebus queue authorization-rule keys list --name myauthorule --namespace-name mynamespace --queue-name myqueue --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List of Authorization Rule by Service Bus Queue. (autogenerated)
    text: az servicebus queue authorization-rule list --namespace-name mynamespace --queue-name myqueue --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the Queue by Service Bus Namepsace (autogenerated)
    text: az servicebus queue list --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: shows the Service Bus Queue Details (autogenerated)
    text: az servicebus queue show --name myqueue --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the keys and connection strings of Authorization Rule for Service Bus Topic. (autogenerated)
    text: az servicebus topic authorization-rule keys list --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: shows list of Authorization Rule by Service Bus Topic (autogenerated)
    text: az servicebus topic authorization-rule list --namespace-name mynamespace --resource-group myresourcegroup --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: Shows the details of Authorization Rule for given Service Bus Topic (autogenerated)
    text: az servicebus topic authorization-rule show --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: List the Topic by Service Bus Namepsace (autogenerated)
    text: az servicebus topic list --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: List the Subscription by Service Bus Topic (autogenerated)
    text: az servicebus topic subscription list --namespace-name mynamespace --resource-group myresourcegroup --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: Deletes the ServiceBus Rule (autogenerated)
    text: az servicebus topic subscription rule delete --name myrule --namespace-name mynamespace --resource-group myresourcegroup --subscription-name mysubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: List the ServiceBus Rule by Subscription (autogenerated)
    text: az servicebus topic subscription rule list --namespace-name mynamespace --resource-group myresourcegroup --subscription-name mysubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: Shows ServiceBus Rule Details (autogenerated)
    text: az servicebus topic subscription rule show --name myrule --namespace-name mynamespace --resource-group myresourcegroup --subscription-name mysubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: Updates the ServiceBus Rule for Subscription (autogenerated)
    text: az servicebus topic subscription rule update --filter-sql-expression myproperty=myupdatedvalue --name myrule --namespace-name mynamespace --resource-group myresourcegroup --subscription-name mysubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: Shows Service Bus Subscription Details (autogenerated)
    text: az servicebus topic subscription show --name mysubscription --namespace-name mynamespace --resource-group myresourcegroup --topic-name mytopic
    crafted: true
"""
