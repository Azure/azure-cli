...
def process_vmss_create_namespace(cmd, namespace):
    ...
    if namespace.orchestration_mode is None:
        ...
        logger.warning(
            'Starting Ignite sprint 2023 (Nov), the "az vmss create" command will use the new default orchestration mode: Flexible. '
            'To learn more about Flexible Orchestration mode, please visit https://learn.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-orchestration-modes.')
