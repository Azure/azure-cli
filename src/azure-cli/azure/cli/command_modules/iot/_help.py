...
examples:
  ...
  - name: List all linked IoT hubs in an Azure IoT Hub device provisioning service. (autogenerated)
    text: az iot dps linked-hub list --dps-name MyDps --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Lists all certificates contained within an Azure IoT Hub (autogenerated)
    text: az iot hub certificate list --hub-name MyIotHub
    crafted: true
"""
...
examples:
  ...
  - name: Get information about the route in IoT Hub. (autogenerated)
    text: az iot hub route show --hub-name MyIotHub --route-name R1
    crafted: true
"""
