...
examples:
  ...
  - name: Check for the existence of a storage container. (autogenerated)
    text: |
        az storage container exists --account-name mystorageccount --auth-mode login --name mycontainer
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file (autogenerated)
    text: |
        az storage file generate-sas --account-name MyStorageAccount --expiry 2037-12-31T23:59:00Z --https-only --path path/file.txt --permissions rcdw --share-name MyShare --subscription mysubscription
    crafted: true
"""
...
examples:
    ...
    - name: Delete a file system in ADLS Gen2 account. (autogenerated)
      text: |
          az storage fs delete --account-name myadlsaccount --auth-mode login --name myfilesystem
      crafted: true
"""
...
examples:
    ...
    - name: Check for the existence of a file system in ADLS Gen2 account. (autogenerated)
      text: |
          az storage fs exists --account-name myadlsaccount --auth-mode login --name myfilesystem
      crafted: true
"""
...
examples:
    ...
    - name: List directories in ADLS Gen2 file system. (autogenerated)
      text: |
          az storage fs directory list --account-name myadlsaccount --auth-mode login --file-system myfilesystem
      crafted: true
"""
...
examples:
  ...
  - name: Return all user-defined metadata for the specified file system. (autogenerated)
    text: |
        az storage fs metadata show --account-name myadlsaccount --auth-mode login --name myfilesystem
    crafted: true
"""
