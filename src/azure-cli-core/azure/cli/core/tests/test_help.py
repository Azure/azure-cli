...
class TestHelpLoads(unittest.TestCase):
    ...
    def test_load_from_help_py(self, mocked_load, mocked_pkg_util):
        ...
        self.assertEqual(obj_param_dict["--arg1 -a"].short_summary, "A short summary.")
        self.assertEqual(obj_param_dict["--arg1 -a"].value_sources[0], "az foo bar")
        self.assertEqual(obj_param_dict["--arg1 -a"].value_sources[1], "az bar baz")

        self.assertEqual(command_help_obj.examples[0].name, "Alpha Example")
        self.assertEqual(command_help_obj.examples[0].text, "az test alpha --arg1 a --arg2 b --arg3 c")
