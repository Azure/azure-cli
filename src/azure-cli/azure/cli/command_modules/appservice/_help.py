...
helps['appservice domain create'] = """
    ...
    - name: Accept the legal terms for purchasing and creating MyCustomDomain.com, then purchase and create domain.
      text: az appservice domain create -g MyResourceGroup --hostname "MyCustomDomain.com" --contact-info=@'C:\path\to\contactinfo.json' --accept-hostname-purchase-terms
    - name: View the details of the domain that will be purchased and created, without actually running the operation
      text: az appservice domain create -g MyResourceGroup --hostname "MyCustomDomain.com" --contact-info=@'C:\paty\to\contactinfo.json' --dryrun
"""
