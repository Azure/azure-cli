...
def load_arguments(self, _):
    ...
    deployment_template_spec_type = CLIArgumentType(options_list=['--template-spec', '-t'], help='The resource id to the template-spec', is_preview=True, min_api='2019-06-01')
