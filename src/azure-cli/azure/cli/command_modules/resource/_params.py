...
def load_arguments(self, _):
    ...
    deployment_validation_level_help = 'The deployment validation level. May be set to "Provider" (the default), "Template", or "ProviderNoRbac". With a ' \
    ...
    deployment_validation_level_type = CLIArgumentType(options_list=['--validation-level'], required=False, arg_type=get_enum_type(ValidationLevel, None), help=deployment_validation_level_help)
    ...
    with self.argument_context('deployment sub create') as c:
        ...
        c.argument('what_if', arg_type=deployment_what_if_type)
        c.argument('proceed_if_no_change', arg_type=deployment_what_if_proceed_if_no_change_type)
        c.argument('validation_level', arg_type=deployment_validation_level_type, help=deployment_validation_level_help)
