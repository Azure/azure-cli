...
class Health(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ApplicationGatewaysBackendHealth(ctx=self.ctx)()
    ...
    class ApplicationGatewaysBackendHealth(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.backend_address_pools = AAZListType(
                serialized_name="backendAddressPools",
            )

            backend_address_pools = cls._schema_on_200.backend_address_pools
            backend_address_pools.Element = AAZObjectType()

            _element = cls._schema_on_200.backend_address_pools.Element
            _element.backend_address_pool = AAZObjectType(
                serialized_name="backendAddressPool",
            )
            _HealthHelper._build_schema_application_gateway_backend_address_pool_read(_element.backend_address_pool)
            _element.backend_http_settings_collection = AAZListType(
                serialized_name="backendHttpSettingsCollection",
            )

            backend_http_settings_collection = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection
            backend_http_settings_collection.Element = AAZObjectType()

            _element = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element
            _element.backend_http_settings = AAZObjectType(
                serialized_name="backendHttpSettings",
            )
            _element.servers = AAZListType()

            backend_http_settings = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.backend_http_settings
            ...
            properties = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.backend_http_settings.properties
            ...
            _HealthHelper._build_schema_sub_resource_read(properties.probe)
            ...
            authentication_certificates = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.backend_http_settings.properties.authentication_certificates
            authentication_certificates.Element = AAZObjectType()
            _HealthHelper._build_schema_sub_resource_read(authentication_certificates.Element)

            connection_draining = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.backend_http_settings.properties.connection_draining
            ...
            trusted_root_certificates = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.backend_http_settings.properties.trusted_root_certificates
            trusted_root_certificates.Element = AAZObjectType()
            _HealthHelper._build_schema_sub_resource_read(trusted_root_certificates.Element)

            servers = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.servers
            servers.Element = AAZObjectType()

            _element = cls._schema_on_200.backend_address_pools.Element.backend_http_settings_collection.Element.servers.Element
            ...
            _HealthHelper._build_schema_network_interface_ip_configuration_read(_element.ip_configuration)

            return cls._schema_on_200


class _HealthHelper:
    """Helper class for Health"""
