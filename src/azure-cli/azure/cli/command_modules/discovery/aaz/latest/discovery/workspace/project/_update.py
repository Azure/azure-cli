...
@register_command(
    "discovery workspace project update",
)
class Update(AAZCommand):
    """Update a Project

    :example: Update project tags
    ...
    _aaz_info = {
        "version": "2026-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.discovery/workspaces/{}/projects/{}", "2026-06-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.settings = AAZObjectArg(
            ...
            help="Settings for the project.",
            nullable=True,
        )

        settings = cls._args_schema.settings
        settings.behavior_preferences = AAZStrArg(
            options=["behavior-preferences"],
            help="Default preferences to guide AI behaviors in this project.",
            nullable=True,
            fmt=AAZStrArgFormat(
                max_length=5000,
            ),
    ...
    class ProjectsGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Discovery/workspaces/{workspaceName}/projects/{projectName}",
                **self.url_parameters
            )
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                properties.set_prop("settings", AAZObjectType, ".settings")

            settings = _builder.get(".properties.settings")
            if settings is not None:
                settings.set_prop("behaviorPreferences", AAZStrType, ".behavior_preferences")
...
class _UpdateHelper:
    ...
    def _build_schema_project_read(cls, _schema):
        ...
        properties.foundry_project_endpoint = AAZStrType(
            serialized_name="foundryProjectEndpoint",
            flags={"read_only": True},
        )
        ...
        properties.storage_container_ids = AAZListType(
            serialized_name="storageContainerIds",
        )

        settings = _schema_project_read.properties.settings
        settings.behavior_preferences = AAZStrType(
            serialized_name="behaviorPreferences",
        )

        storage_container_ids = _schema_project_read.properties.storage_container_ids
        storage_container_ids.Element = AAZStrType()
