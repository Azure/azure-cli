...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.servicebus/namespaces/{}/migrationconfigurations/{}", "2026-07-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.MigrationConfigsDelete(ctx=self.ctx)()
    ...
    class MigrationConfigsDelete(AAZHttpOperation):
