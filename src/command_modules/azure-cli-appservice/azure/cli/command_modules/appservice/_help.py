...
-   "name": |-
        enable identity for the functionapp.
    "text": |
...
-   "name": |-
    ...
    "text": |-
        az webapp remote-connection create --name MyWebapp --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Update a web app's connection strings.
    "text": |-
        az webapp config connection-string set --settings <settings> --connection-string-type ApiHub --name MyWebapp --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Get the details for available web app deployment profiles.
    "text": |-
        az webapp deployment list-publishing-profiles --output json --resource-group MyResourceGroup --query [0] --name MyWebapp
    "crafted": |-
        True
"""
...
-   "name": |-
        enable identity for the webapp.
    "text": |
...
-   "name": |-
        Create a web app in a sepcific region, by running the command from the folder where the code to deployed exists.
    "text": |
