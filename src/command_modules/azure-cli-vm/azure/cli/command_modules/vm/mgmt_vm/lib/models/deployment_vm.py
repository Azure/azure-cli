...
class DeploymentVm(Model):
    ...
    :ivar _artifacts_location: Container URI of of the template. Default
     value:
     "https://azuresdkci.blob.core.windows.net/templatehost/CreateVm_2017-1-5"
     .
    ...
    :type availability_set_type: str or :class:`availabilitySetType
     <Default.models.availabilitySetType>`
    ...
    :type network_interface_type: str or :class:`networkInterfaceType
     <Default.models.networkInterfaceType>`
    ...
    :type network_security_group_rule: str or
     :class:`networkSecurityGroupRule <Default.models.networkSecurityGroupRule>`
    ...
    :type network_security_group_type: str or
     :class:`networkSecurityGroupType <Default.models.networkSecurityGroupType>`
    ...
    :type storage_account_type: str or :class:`storageAccountType
     <Default.models.storageAccountType>`
