...
class Add(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the private link configuration.",
            required=True,
        )

        # define Arg Group "Parameters.properties.privateLinkConfigurations[]"
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                _AddHelper._build_schema_common_sub_resource_update(properties.set_prop("subnet", AAZObjectType, ".subnet"))
