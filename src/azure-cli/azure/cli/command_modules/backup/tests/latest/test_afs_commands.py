...
class BackupTests(ScenarioTest, unittest.TestCase):
    @live_only()
    @AllowLargeResponse()
    @ResourceGroupPreparer(name_prefix="AzureBackupRG_clitest_", location="eastus", random_name_length=32)
    @VaultPreparer()
    ...
    @AFSPolicyPreparer()
    @AFSItemPreparer()
    @StorageAccountPreparer(location="eastus", parameter_name="sa2")
