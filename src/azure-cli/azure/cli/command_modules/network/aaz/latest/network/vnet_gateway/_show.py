...
class Show(AAZCommand):
    ...
    class VirtualNetworkGatewaysGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_sub_resource_read(vng_client_connection_configurations.Element)
            ...
            _ShowHelper._build_schema_address_space_read(properties.vpn_client_address_pool)
            ...
            virtual_network_gateway_policy_groups.Element = AAZObjectType()
            _ShowHelper._build_schema_sub_resource_read(virtual_network_gateway_policy_groups.Element)
