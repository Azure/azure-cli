...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.UsersListByDataBoxEdgeDevice(ctx=self.ctx)()
    ...
    class UsersListByDataBoxEdgeDevice(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            encrypted_password = cls._schema_on_200.value.Element.properties.encrypted_password
            ...
            share_access_rights = cls._schema_on_200.value.Element.properties.share_access_rights
            share_access_rights.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.share_access_rights.Element
