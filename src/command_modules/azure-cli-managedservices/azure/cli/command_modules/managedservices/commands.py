...
def load_command_table(self, _):
    ...
    with self.command_group('managedservices assignments', msp_registration_assignments) as g:
        ...
        g.custom_command('list', 'cli_assignment_list', client_factory=cf_registration_assignments)
