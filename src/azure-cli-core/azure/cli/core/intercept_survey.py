...
# https://learn.microsoft.com/windows/console/console-virtual-terminal-sequences#extended-colors
...
# https://learn.microsoft.com/windows/console/console-virtual-terminal-sequences#text-modification
NEW_LINE = '\x1b[1L'
