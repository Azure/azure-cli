...
class List(AAZCommand):
    ...
    :example: List all linked storage accounts for a log analytics workspace.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LinkedStorageAccountsListByWorkspace(ctx=self.ctx)()
    ...
    class LinkedStorageAccountsListByWorkspace(AAZHttpOperation):
