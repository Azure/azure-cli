...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExportConfigurationsList(ctx=self.ctx)()
    ...
    class ExportConfigurationsList(AAZHttpOperation):
