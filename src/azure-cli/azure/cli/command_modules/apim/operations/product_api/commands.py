...
def load_command_table(commands_loader, _):
    ...
    with commands_loader.command_group('apim product api', sdk, custom_command_type=custom_type, is_preview=True) as g:
        ...
        g.custom_command('check', 'check_product_api_exists')
        g.custom_command('create', 'create_product_api', supports_no_wait=True)
        g.custom_command('delete', 'delete_product_api', supports_no_wait=True)
