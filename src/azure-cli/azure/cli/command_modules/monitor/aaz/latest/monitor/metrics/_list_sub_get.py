...
@register_command(
    "monitor metrics list-sub-get",
)
class ListSubGet(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.aggregation = AAZStrArg(
            options=["--aggregation"],
            help="The list of aggregation types (comma separated) to retrieve. *Examples: average, minimum, maximum*",
        )
        ...
        _args_schema.rollupby = AAZStrArg(
            options=["--rollupby"],
        ...
        _args_schema.top = AAZIntArg(
            options=["--top"],
            help="The maximum number of records to retrieve per resource ID in the request. Valid only if filter is specified. Defaults to 10.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.MetricsListAtSubscriptionScope(ctx=self.ctx)()
    ...
    class MetricsListAtSubscriptionScope(AAZHttpOperation):
        ...
        def query_parameters(self):
            parameters = {
                ...
                **self.serialize_query_param(
                    "AutoAdjustTimegrain", self.ctx.args.auto_adjust_timegrain,
                ),
                **self.serialize_query_param(
                    "ValidateDimensions", self.ctx.args.validate_dimensions,
                ),
                **self.serialize_query_param(
                ...
                **self.serialize_query_param(
                    "rollupby", self.ctx.args.rollupby,
                ),
                **self.serialize_query_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _ListSubGetHelper._build_schema_localizable_string_read(_element.name)
...
class _ListSubGetHelper:
    """Helper class for ListSubGet"""
