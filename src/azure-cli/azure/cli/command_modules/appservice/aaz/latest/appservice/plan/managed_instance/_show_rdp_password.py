...
class ShowRdpPassword(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AppServicePlansGetServerFarmRdpPassword(ctx=self.ctx)()
    ...
    class AppServicePlansGetServerFarmRdpPassword(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.rdp_password = AAZStrType(
                serialized_name="rdpPassword",
                flags={"secret": True},
            )
            _schema_on_200.rdp_password_expiry = AAZStrType(
                serialized_name="rdpPasswordExpiry",
            )

            return cls._schema_on_200


class _ShowRdpPasswordHelper:
    """Helper class for ShowRdpPassword"""


__all__ = ["ShowRdpPassword"]
