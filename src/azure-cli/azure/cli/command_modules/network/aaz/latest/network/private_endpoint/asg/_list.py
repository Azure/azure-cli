...
class List(AAZCommand):
    ...
    :example: List application security group within a private endpoint.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.applicationSecurityGroups

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.applicationSecurityGroups = value
            return
