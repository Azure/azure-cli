...
class DeletedKeyBundle(KeyBundle):
    ...
    def __init__(self, *, key=None, attributes=None, tags=None, release_policy=None, recovery_id: str=None, **kwargs) -> None:
...
class SasDefinitionBundle(Model):
    ...
    :vartype sas_type: str or ~azure.keyvault.v7_2.models.SasTokenType
    ...
    :vartype attributes: ~azure.keyvault.v7_2.models.SasDefinitionAttributes
...
class DeletedSasDefinitionListResult(Model):
    ...
    :ivar value: A response message containing a list of the deleted SAS
     ...
     definitions
    :vartype value: list[~azure.keyvault.v7_2.models.DeletedSasDefinitionItem]
...
class StorageAccountItem(Model):
    ...
    :vartype attributes: ~azure.keyvault.v7_2.models.StorageAccountAttributes
    :ivar tags: Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
...
class DeletedStorageListResult(Model):
    ...
    :ivar value: A response message containing a list of the deleted storage
     ...
     storage accounts
    :vartype value:
     list[~azure.keyvault.v7_2.models.DeletedStorageAccountItem]
...
class KeyCreateParameters(Model):
    ...
    def __init__(self, *, kty, key_size: int=None, public_exponent: int=None, key_ops=None, key_attributes=None, tags=None, curve=None, release_policy=None, **kwargs) -> None:
...
class KeyImportParameters(Model):
    ...
    def __init__(self, *, key, hsm: bool=None, key_attributes=None, tags=None, release_policy=None, **kwargs) -> None:
...
class OrganizationDetails(Model):
    ...
    :type admin_details:
     list[~azure.keyvault.v7_2.models.AdministratorDetails]
    """
...
class RoleAssignment(Model):
    ...
    :type properties:
     ~azure.keyvault.v7_2.models.RoleAssignmentPropertiesWithScope
    """
...
class SasDefinitionListResult(Model):
    ...
    :vartype value: list[~azure.keyvault.v7_2.models.SasDefinitionItem]
...
class StorageListResult(Model):
    ...
    :vartype value: list[~azure.keyvault.v7_2.models.StorageAccountItem]
...
class X509CertificateProperties(Model):
    ...
    :type subject_alternative_names:
     ~azure.keyvault.v7_2.models.SubjectAlternativeNames
