...
class ExportSpecification(AAZCommand):
    ...
    :example: Export API specification
        az apic api definition export-specification -g api-center-test -s contoso --api-name echo-api --version 2023-01-01 --name "openapi"
    """

    _aaz_info = {
        "version": "2023-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.apicenter/services/{}/workspaces/{}/apis/{}/versions/{}/definitions/{}/exportspecification", "2023-07-01-preview"],
        ]
    }
