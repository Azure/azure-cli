...
@register_command(
    "eventhubs georecovery-alias show",
)
class Show(AAZCommand):
    """Get Alias(Disaster Recovery configuration) for primary or secondary namespace

    :example: EHAliasGet
        az eventhubs georecovery-alias show --resource-group exampleResourceGroup --namespace-name sdk-Namespace-8859 --alias sdk-DisasterRecovery-3814
    """
