...
examples:
  ...
  - name: Create an empty CNAME record set. (autogenerated)
    text: az network dns record-set cname create --name MyRecordSet --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create a virtual network gateway. (autogenerated)
    ...
    crafted: true
  - name: Create a virtual network gateway. (autogenerated) (autogenerated)
    text: az network vnet-gateway create --gateway-type Vpn --location westus2 --name MyVnetGateway --no-wait --public-ip-addresses myVGPublicIPAddress --resource-group MyResourceGroup --sku Basic --vnet MyVnet --vpn-type PolicyBased
    crafted: true
"""
