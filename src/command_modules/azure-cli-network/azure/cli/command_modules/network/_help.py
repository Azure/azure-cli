...
-   name: Create an address pool.
    text: az network application-gateway address-pool create --name MyBackendAddressPool
        --servers {servers} --gateway-name MyGateway --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Delete an address pool.
    text: az network application-gateway address-pool delete -g MyResourceGroup --gateway-name
...
-   name: List address pools.
    text: az network application-gateway address-pool list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of an address pool.
    text: az network application-gateway address-pool show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyAddressPool
"""
...
-   name: Update an address pool, add server.
    text: az network application-gateway address-pool update -g MyResourceGroup --gateway-name
...
-   name: Delete an authorization certificate.
    text: az network application-gateway auth-cert delete -g MyResourceGroup --gateway-name
...
-   name: List authorization certificates.
    text: az network application-gateway auth-cert list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Show an authorization certificate.
    text: az network application-gateway auth-cert show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyAuthCert
"""
...
-   name: Update authorization certificates to use a new cert file.
    text: az network application-gateway auth-cert update -g MyResourceGroup --gateway-name
...
-   name: Delete a frontend IP address.
    text: az network application-gateway frontend-ip delete -g MyResourceGroup --gateway-name
...
-   name: List frontend IP addresses.
    text: az network application-gateway frontend-ip list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a frontend IP address.
    text: az network application-gateway frontend-ip show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyFrontendIp
"""
...
-   name: Update a frontend IP address to use a new IP address.
    text: az network application-gateway frontend-ip update -g MyResourceGroup --gateway-name
        MyAppGateway \\ -n MyFrontendIp --public-ip-address MyNewPublicIpAddress
"""
...
-   name: Delete a frontend port.
    text: az network application-gateway frontend-port delete -g MyResourceGroup --gateway-name
...
-   name: List frontend ports.
    text: az network application-gateway frontend-port list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a frontend port.
    text: az network application-gateway frontend-port show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyFrontendPort
"""
...
-   name: Create an HTTP listener.
    text: az network application-gateway http-listener create --resource-group MyResourceGroup
        --host-name MyHost --name MyHTTPListener --gateway-name MyGateway --frontend-port
        {frontend-port}
    crafted: 'True'
"""
...
-   name: Delete an HTTP listener.
    text: az network application-gateway http-listener delete -g MyResourceGroup --gateway-name
...
-   name: List HTTP listeners.
    text: az network application-gateway http-listener list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of an HTTP listener.
    text: az network application-gateway http-listener show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyHttpListener
"""
...
-   name: Delete HTTP settings.
    text: az network application-gateway http-settings delete -g MyResourceGroup --gateway-name
...
-   name: List HTTP settings.
    text: az network application-gateway http-settings list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a gateway's HTTP settings.
    text: az network application-gateway http-settings show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyHttpSettings
"""
...
examples:
-   name: Delete a probe.
    text: az network application-gateway probe delete -g MyResourceGroup --gateway-name
        MyAppGateway -n MyProbe
"""
...
examples:
-   name: List probes.
    text: az network application-gateway probe list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a probe.
    text: az network application-gateway probe show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyProbe
"""
...
-   name: List redirect configurations.
    text: az network application-gateway redirect-config list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a redirect configuration.
    text: az network application-gateway redirect-config show -g MyResourceGroup --gateway-name
...
-   name: Delete a trusted root certificate.
    text: az network application-gateway root-cert delete -g MyResourceGroup --gateway-name
...
-   name: List trusted root certificates.
    text: az network application-gateway root-cert list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a trusted root certificate.
    text: az network application-gateway root-cert show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyRootCert
"""
...
examples:
-   name: Delete a rule.
    text: az network application-gateway rule delete -g MyResourceGroup --gateway-name
        MyAppGateway -n MyRule
"""
...
examples:
-   name: List rules.
    text: az network application-gateway rule list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a rule.
    text: az network application-gateway rule show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyRule
"""
...
-   name: Show backend health of an application gateway.
    text: az network application-gateway show-backend-health -g MyResourceGroup -n
        MyAppGateway
"""
...
-   name: Delete an SSL certificate.
    text: az network application-gateway ssl-cert delete -g MyResourceGroup --gateway-name
...
-   name: List SSL certificates.
    text: az network application-gateway ssl-cert list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of an SSL certificate.
    text: az network application-gateway ssl-cert show -g MyResourceGroup --gateway-name
        MyAppGateway -n MySslCert
"""
...
long-summary: To view the predefined policies, use `az network application-gateway
    ssl-policy predefined list`.
parameters:
-   name: --cipher-suites
    populator-commands:
...
-   name: Get the details of a gateway's SSL policy settings.
    text: az network application-gateway ssl-policy show -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
long-summary: >
    The map must be created with at least one rule. This command requires the creation
    of the
...
-   name: Delete a URL path map.
    text: az network application-gateway url-path-map delete -g MyResourceGroup --gateway-name
...
-   name: List URL path maps.
    text: az network application-gateway url-path-map list -g MyResourceGroup --gateway-name
        MyAppGateway
"""
...
-   name: Get the details of a URL path map.
    text: az network application-gateway url-path-map show -g MyResourceGroup --gateway-name
        MyAppGateway -n MyUrlPathMap
"""
...
long-summary: >
    These commands are only applicable to application gateways with an SKU type of
    WAF. To learn
...
-   name: List available rules in the OWASP 3.0 rule set.
    text: az network application-gateway waf-config list-rule-sets --group '*' --type
        OWASP --version 3.0
...
long-summary: >
    This command is only applicable to application gateways with an SKU type of WAF.
    To learn
    more, visit https://docs.microsoft.com/en-us/azure/application-gateway/application-gateway-web-application-firewall-cli
parameters:
-   name: --rule-set-type
...
-   name: --disabled-rule-groups
    short-summary: Space-separated list of rule groups to disable. To disable individual
        rules, use `--disabled-rules`.
    populator-commands:
    -   az network application-gateway waf-config list-rule-sets
-   name: --disabled-rules
...
-   name: Get the firewall configuration of a web application.
    text: az network application-gateway waf-config show -g MyResourceGroup --gateway-name
        MyAppGateway
"""

helps["network application-gateway wait"] = """
type: command
short-summary: Place the CLI in a waiting state until a condition of the application
    gateway is met.
examples:
...
long-summary: >
    You can configure network security as a natural extension of an application's
    structure, ASG allows
    you to group virtual machines and define network security policies based on those
    groups. You can specify an
    application security group as the source and destination in a NSG security rule.
...
-   name: --vnets
    long-summary: >
        This parameter can only be used if all the VNets are within the same subscription
        as
        the DDoS protection plan. If this is not the case, set the protection plan
        on the VNet
...
-   name: Add a Vnet to a DDoS protection plan in the same subscription.
    text: az network ddos-protection update -g MyResourceGroup -n MyDdosPlan --vnets
        MyVnet
"""
...
-   name: Add an A record.
    text: |
        az network dns record-set a add-record -g MyResourceGroup -z www.mysite.com     -n MyRecordSet -a MyIpv4Address
-   name: Add an A record.
    text: az network dns record-set a add-record --zone-name MyZone --ipv4-address
        {ipv4-address} --record-set-name MyRecordSet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create an empty A record set.
    text: az network dns record-set a create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
-   name: Create an empty A record set.
    text: az network dns record-set a create --ttl {ttl} --zone-name www.mysite.com
        --name MyRecordSet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Delete an A record set and all associated records.
    text: az network dns record-set a delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
-   name: Delete an A record set and all associated records.
    text: az network dns record-set a delete --zone-name www.mysite.com --name MyRecordSet
        --yes  --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: List all A record sets in a zone.
    text: az network dns record-set a list --zone-name www.mysite.com --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Remove an A record from its record set.
    text: |
        az network dns record-set a remove-record -g MyResourceGroup -z www.mysite.com     -n MyRecordSet -a MyIpv4Address
-   name: Remove an A record from its record set.
    text: az network dns record-set a remove-record --zone-name MyZone --ipv4-address
        {ipv4-address} --record-set-name MyRecordSet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Get the details of an A record set.
    text: az network dns record-set a show --zone-name www.mysite.com --query [0]
        --name MyRecordSet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Update an A record set.
    text: az network dns record-set a update --zone-name MyZone --name MyRecordSet
        --set {set} --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create an empty AAAA record set.
    text: az network dns record-set aaaa create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Delete an AAAA record set and all associated records.
    text: az network dns record-set aaaa delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Get the details of an AAAA record set.
    text: az network dns record-set aaaa show -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Create an empty CAA record set.
    text: az network dns record-set caa create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Delete a CAA record set and all associated records.
    text: az network dns record-set caa delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Get the details of a CAA record set.
    text: az network dns record-set caa show -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Create an empty CNAME record set.
    text: az network dns record-set cname create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
-   name: Create an empty CNAME record set.
    text: az network dns record-set cname create --ttl {ttl} --zone-name www.mysite.com
        --resource-group MyResourceGroup --name MyRecordSet
    crafted: 'True'
"""
...
-   name: Delete a CNAME record set and its associated record.
    text: az network dns record-set cname delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
-   name: Delete a CNAME record set and its associated record.
    text: az network dns record-set cname delete --zone-name www.mysite.com --resource-group
        MyResourceGroup --name MyRecordSet
    crafted: 'True'
"""
...
-   name: Set the value of a CNAME record.
    text: |
        az network dns record-set cname set-record -g MyResourceGroup -z www.mysite.com     -n MyRecordSet -c www.contoso.com
-   name: Set the value of a CNAME record.
    text: az network dns record-set cname set-record --zone-name MyZone --cname {cname}
        --record-set-name MyRecordSet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Get the details of a CNAME record set.
    text: az network dns record-set cname show -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: List all "@" record sets within this zone.
    text: az network dns record-set list -g MyResourceGroup -z www.mysite.com --query
        "[?name=='@']"
-   name: List all record sets within a DNS zone.
    text: az network dns record-set list --zone-name www.mysite.com --output json
...
-   name: Create an empty MX record set.
    text: az network dns record-set mx create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Delete an MX record set and all associated records.
    text: az network dns record-set mx delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Get the details of an MX record set.
    text: az network dns record-set mx show -g MyResourceGroup -z www.mysite.com -n
        MyRecordSet
"""
...
-   name: Add an NS record.
    text: |
        az network dns record-set ns add-record -g MyResourceGroup -z www.mysite.com     -n MyRecordSet -d ns.mysite.com
-   name: Add an NS record.
    text: az network dns record-set ns add-record --output json --record-set-name
        MyRecordSet --nsdname {nsdname} --zone-name MyZone --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create an empty NS record set.
    text: az network dns record-set ns create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Delete an NS record set and all associated records.
    text: az network dns record-set ns delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: List all NS record sets in a zone.
    text: az network dns record-set ns list --zone-name www.mysite.com --query [0]
        --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Get the details of an NS record set.
    text: az network dns record-set ns show -g MyResourceGroup -z www.mysite.com -n
        MyRecordSet
"""
...
-   name: Create an empty PTR record set.
    text: az network dns record-set ptr create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Delete a PTR record set and all associated records.
    text: az network dns record-set ptr delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Get the details of a PTR record set.
    text: az network dns record-set ptr show -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Add an SRV record.
    text: |
        az network dns record-set srv add-record -g MyResourceGroup -z www.mysite.com     -n MyRecordSet -d another.site.com
-   name: Add an SRV record.
    text: az network dns record-set srv add-record --port {port} --zone-name MyZone
        --resource-group MyResourceGroup --target {target} --record-set-name MyRecordSet
...
-   name: Delete an SRV record set and all associated records.
    text: az network dns record-set srv delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Get the details of an SRV record set.
    text: az network dns record-set srv show -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Create an empty TXT record set.
    text: az network dns record-set txt create -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
-   name: Delete a TXT record set and all associated records.
    text: az network dns record-set txt delete -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
-   name: Delete a TXT record set and all associated records.
    text: az network dns record-set txt delete --zone-name www.mysite.com --name MyRecordSet
        --yes  --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Get the details of a TXT record set.
    text: az network dns record-set txt show -g MyResourceGroup -z www.mysite.com
        -n MyRecordSet
"""
...
parameters:
-   name: --if-none-match
    short-summary: Only create a DNS zone if one doesn't exist that matches the given
        name.
examples:
...
-   name: Create a DNS zone.
    text: az network dns zone create --name www.mysite.com --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Export a DNS zone as a DNS zone file.
    text: az network dns zone export --file-name MyFile --name www.mysite.com --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create a DNS zone using a DNS zone file.
    text: az network dns zone import --file-name /path/to/zone/file --name MyZone
        --resource-group MyResourceGroup
    crafted: 'True'
"""
...
type: command
short-summary: Update a DNS zone properties. Does not modify DNS records within the
    zone.
parameters:
-   name: --if-match
    short-summary: Update only if the resource with the same ETAG exists.
examples:
-   name: Update a DNS zone properties to change the user-defined value of a previously
        set tag.
    text: >
...
-   name: Create a new link authorization for an ExpressRoute circuit.
    text: >
        az network express-route auth create --circuit-name MyCircuit -g MyResourceGroup
        -n MyAuthorization
"""
...
-   name: Delete a link authorization of an ExpressRoute circuit.
    text: >
        az network express-route auth delete --circuit-name MyCircuit -g MyResourceGroup
        -n MyAuthorization
"""
...
-   name: Get the details of a link authorization of an ExpressRoute circuit.
    text: >
        az network express-route auth show -g MyResourceGroup --circuit-name MyCircuit
        -n MyAuthorization
"""
...
type: command
short-summary: Show the current Address Resolution Protocol (ARP) table of an ExpressRoute
    circuit.
examples:
-   name: Show the current Address Resolution Protocol (ARP) table of an ExpressRoute
        circuit.
    text: |
...
examples:
-   name: Create connection between two ExpressRoute circuits with AzurePrivatePeering
        settings.
    text: |
...
-   name: Delete private peering.
    text: >
        az network express-route peering delete -g MyResourceGroup --circuit-name
        MyCircuit -n AzurePrivatePeering
"""
...
-   name: Get private peering details of an ExpressRoute circuit.
    text: >
        az network express-route peering show -g MyResourceGroup --circuit-name MyCircuit
...
-   name: Change the SKU of an ExpressRoute circuit from Standard to Premium.
    text: >
        az network express-route update -n MyCircuit -g MyResourceGroup --sku-tier
        Premium
"""

helps["network express-route wait"] = """
type: command
short-summary: Place the CLI in a waiting state until a condition of the ExpressRoute
    is met.
examples:
-   name: Pause executing next line of CLI script until the ExpressRoute circuit is
...
-   name: Create an address pool.
    text: az network lb address-pool create --name MyAddressPool --lb-name MyLb --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create a basic internal load balancer on a specific virtual network and
        subnet.
    text: >
        az network lb create -g MyResourceGroup -n MyLb --sku Basic --vnet-name MyVnet
        --subnet MySubnet
-   name: Create a basic zone flavored internal load balancer, through provisioning
        a zonal public ip.
    text: >
        az network lb create -g MyResourceGroup -n MyLb --sku Basic --public-ip-zone
        2
-   name: >
        Create a standard zone flavored public-facing load balancer, through provisioning
        a zonal frontend ip configuration and Vnet.
    text: >
        az network lb create -g MyResourceGroup -n MyLb --sku Standard --frontend-ip-zone
        1 --vnet-name MyVnet --subnet MySubnet
"""
...
-   name: Create a frontend ip address for a public load balancer.
    text: az network lb frontend-ip create -g MyResourceGroup -n MyFrontendIp --lb-name
        MyLb --public-ip-name MyFrontendIp
-   name: Create a frontend ip address for an internal load balancer.
    text: |
        az network lb frontend-ip create -g MyResourceGroup -n MyFrontendIp --lb-name MyLb     --private-ip-address 10.10.10.100 --subnet-name MySubnet --subnet-vnet-name MyVnet
-   name: Create a frontend IP address.
    text: az network lb frontend-ip create --public-ip-address {public-ip-address}
        --name MyFrontendIp --lb-name MyLb --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Update the frontend IP address of a public load balancer.
    text: az network lb frontend-ip update -g MyResourceGroup --lb-name MyLb -n MyFrontendIp
        --public-ip-name MyNewPublicIp
...
-   name: Delete an inbound NAT address pool.
    text: az network lb inbound-nat-pool delete -g MyResourceGroup --lb-name MyLb
        -n MyNatPool
"""
...
-   name: List inbound NAT address pools.
    text: az network lb inbound-nat-pool list -g MyResourceGroup --lb-name MyLb -o
        table
"""
...
-   name: Get the details of an inbound NAT address pool.
    text: az network lb inbound-nat-pool show -g MyResourceGroup --lb-name MyLb -n
        MyNatPool
"""
...
-   name: Create a basic inbound NAT rule for a specific frontend IP and enable floating
        IP for NAT Rule.
    text: |
...
-   name: Delete an inbound NAT rule.
    text: az network lb inbound-nat-rule delete -g MyResourceGroup --lb-name MyLb
        -n MyNatRule
"""
...
-   name: List inbound NAT rules.
    text: az network lb inbound-nat-rule list -g MyResourceGroup --lb-name MyLb -o
        table
"""
...
-   name: Get the details of an inbound NAT rule.
    text: az network lb inbound-nat-rule show -g MyResourceGroup --lb-name MyLb -n
        MyNatRule
"""
...
examples:
-   name: Update an inbound NAT rule to disable floating IP and modify idle timeout
        duration.
    text: |
...
-   name: List load balancers.
    text: az network lb list --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create a probe.
    text: az network lb probe create --protocol Http --port {port} --name MyProbe
        --lb-name MyLb --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Delete a probe.
    text: az network lb probe delete --name MyProbe --lb-name MyLb --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Update a probe with a different port and interval.
    text: az network lb probe update -g MyResourceGroup --lb-name MyLb -n MyProbe
        --port 81 --interval 10
"""
...
examples:
-   name: >
        Create a load balancing rule that assigns a front-facing IP configuration
        and port to an address pool and port.
    text: |
        az network lb rule create -g MyResourceGroup --lb-name MyLb -n MyLbRule --protocol Tcp     --frontend-ip-name MyFrontEndIp --frontend-port 80     --backend-pool-name MyAddressPool --backend-port 80
-   name: >
        Create a load balancing rule that assigns a front-facing IP configuration
        and port to an address pool and port with the floating ip feature.
    text: |
        az network lb rule create -g MyResourceGroup --lb-name MyLb -n MyLbRule --protocol Tcp     --frontend-ip-name MyFrontEndIp --backend-pool-name MyAddressPool --backend-port 80     --floating-ip true
-   name: >
        Create an HA ports load balancing rule that assigns a frontend IP and port
        to use all available backend IPs in a pool on the same port.
    text: |
        az network lb rule create -g MyResourceGroup --lb-name MyLb -n MyHAPortsRule     --protocol All --frontend-port 0 --backend-port 0 --frontend-ip-name MyFrontendIp     --backend-pool-name MyAddressPool
-   name: Create a load balancing rule.
    text: az network lb rule create --probe-name MyProbe --backend-pool-name MyBackendPool
        --name MyLoadBalancingRule --resource-group MyResourceGroup --protocol All
        --backend-port {backend-port} --lb-name MyLb --frontend-port {frontend-port}
    crafted: 'True'
"""
...
-   name: Get the details of a load balancer.
    text: az network lb show --name MyLb --query [0] --resource-group MyResourceGroup
    crafted: 'True'
"""
...
long-summary: >
    This command can only be used to update the tags for a load balancer. Name and
...
type: command
short-summary: List the number of network resources in a region that are used against
...
long-summary: >
    In order to delete a Local Network Gateway, you must first delete ALL Connection
    objects in Azure
    that are connected to the Gateway. After deleting the Gateway, proceed to delete
    other resources now not in use.
...
examples:
-   name: Update a Local Network Gateway provisioned with a 10.0.0.0/24 address prefix
...
type: command
short-summary: Place the CLI in a waiting state until a condition of the local gateway
    is met.
examples:
...
examples:
-   name: Create a network interface for a specified subnet on a specified virtual
        network.
    text: >
        az network nic create -g MyResourceGroup --vnet-name MyVnet --subnet MySubnet
        -n MyNic
-   name: >
        Create a network interface for a specified subnet on a virtual network which
        allows
...
-   name: >
        Create a network interface for a specified subnet on a virtual network with
        network security group and application security groups.
    text: |
...
-   name: Create a network interface.
    text: az network nic create --subnet MySubnet --public-ip-address {public-ip-address}
        --location westus2 --name MyNic --resource-group MyResourceGroup --vnet-name
        MyVnet
    crafted: 'True'
"""
...
-   name: Delete a network interface.
    text: az network nic delete --resource-group MyResourceGroup --name MyNic
    crafted: 'True'
"""
...
-   name: Add an address pool to an IP configuration.
    text: |
        az network nic ip-config address-pool add -g MyResourceGroup --nic-name MyNic     -n MyIpConfig --address-poolMyAddressPool
-   name: Add an address pool to an IP configuration.
    text: az network nic ip-config address-pool add --ip-config-name MyIpConfig --nic-name
        MyNic --lb-name MyLb --address-pool {address-pool} --resource-group MyResourceGroup
    crafted: 'True'
"""
...
long-summary: >
    You must have the Microsoft.Network/AllowMultipleIpConfigurationsPerNic feature
    enabled for your subscription.
    Only one configuration may be designated as the primary IP configuration per NIC,
    using the `--make-primary` flag.
examples:
-   name: Create a primary IP configuration for a NIC.
    text: az network nic ip-config create -g MyResourceGroup -n MyIpConfig --nic-name
        MyNic --make-primary
-   name: Create an IP configuration.
    text: az network nic ip-config create --public-ip-address {public-ip-address}
        --nic-name MyNic --resource-group MyResourceGroup --name MyIpConfig
    crafted: 'True'
"""
...
-   name: Delete an IP configuration.
    text: az network nic ip-config delete -g MyResourceGroup -n MyIpConfig --nic-name
        MyNic
-   name: Delete an IP configuration.
    text: az network nic ip-config delete --nic-name MyNic --name MyIpConfig --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: List the IP configurations of a NIC.
    text: az network nic ip-config list --output json --nic-name MyNic --query [0]
        --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Show the details of an IP configuration of a NIC.
    text: az network nic ip-config show -g MyResourceGroup -n MyIpConfig --nic-name
        MyNic
-   name: Show the details of an IP configuration.
    text: az network nic ip-config show --nic-name MyNic --name MyIpConfig --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Update an IP configuration.
    text: az network nic ip-config update --public-ip-address {public-ip-address}
        --nic-name MyNic --name MyIPConfiguration --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: List all NICs by internal DNS suffix.
    text: >
        az network nic list --query "[?dnsSettings.internalDomainNameSuffix=--query
        "[?dnsSettings.internalDomainNameSuffix==`{dns_suffix}`]"
"""
...
-   name: Get the details of a network interface.
    text: az network nic show --query [0]
    crafted: 'True'
"""
...
-   name: Update a network interface to use a different network security group.
    text: az network nic update -g MyResourceGroup -n MyNic --network-security-group
        MyNewNsg
-   name: Update a network interface.
    text: az network nic update --network-security-group MyNewNsg --name MyNic --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
type: command
short-summary: Place the CLI in a waiting state until a condition of the network interface
    is met.
examples:
...
long-summary: >
    You can control network traffic to resources in a virtual network using a network
    security group.
    A network security group contains a list of security rules that allow or deny
    inbound or
    outbound network traffic based on source or destination IP addresses, Application
    Security
...
-   name: Create an NSG in a resource group within a region with tags.
    text: az network nsg create -g MyResourceGroup -n MyNsg --tags super_secure no_80
        no_22
-   name: Create a network security group.
    text: az network nsg create --resource-group MyResourceGroup --location westus2
        --name MyNsg
    crafted: 'True'
"""
...
-   name: Delete a network security group.
    text: az network nsg delete --resource-group MyResourceGroup --name MyNsg
    crafted: 'True'
"""
...
-   name: Create a basic "Allow" NSG rule with the highest priority.
    text: >
        ...
        --priority 100
-   name: Create a "Deny" rule over TCP for a specific IP address range with the lowest
        priority.
    text: |
        az network nsg rule create -g MyResourceGroup --nsg-name MyNsg -n MyNsgRule --priority 4096     --source-address-prefixes 208.130.28/24 --source-port-ranges 80     --destination-address-prefixes '*' --destination-port-ranges 80 8080 --access Deny     --protocol Tcp --description "Deny from specific IP address ranges on 80 and 8080."
...
-   name: Create a network security group rule.
    text: az network nsg rule create --access Allow --priority 100 --nsg-name MyNsg
        --destination-address-prefixes {destination-address-prefixes} --description
        {description} --name MyNsgRule --protocol * --resource-group MyResourceGroup
        --direction Inbound --destination-port-ranges {destination-port-ranges} --source-address-prefixes
...
-   name: Delete a network security group rule.
    text: az network nsg rule delete --nsg-name MyNsg --name MyNsgRule --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: List all rules in a network security group.
    text: az network nsg rule list --output json --nsg-name MyNsg --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Get the details of a network security group rule.
    text: az network nsg rule show --resource-group MyResourceGroup --nsg-name MyNsg
        --query [0] --name MyNsgRule
    crafted: 'True'
"""
...
-   name: Update an NSG rule with a new wildcard destination address prefix.
    text: az network nsg rule update -g MyResourceGroup --nsg-name MyNsg -n MyNsgRule
        --destination-address-prefix '*'
-   name: Update a network security group rule.
    text: az network nsg rule update --resource-group MyResourceGroup --access Allow
        --nsg-name MyNsg --source-address-prefixes {source-address-prefixes} --name
        MyNsgRule
    crafted: 'True'
"""
...
-   name: Get the default security rules of an NSG and format the output as a table.
    text: az network nsg show -g MyResourceGroup -n MyNsg --query "defaultSecurityRules[]"
        -o table
-   name: Get all default NSG rules with "Allow" access and format the output as a
        table.
    text: az network nsg show -g MyResourceGroup -n MyNsg --query "defaultSecurityRules[?access=='Allow']"
        -o table
-   name: Get information about a network security group.
    text: az network nsg show --resource-group MyResourceGroup --query [0] --name
        MyNsg
    crafted: 'True'
"""
...
long-summary: >
    This command can only be used to update the tags of an NSG. Name and resource
...
long-summary: >
    To create a network profile, see the create command for the relevant resource.
    Currently,
...
-   name: Create a static public IP resource for a DNS name label.
    text: az network public-ip create -g MyResourceGroup -n MyIp --dns-name MyLabel
        --allocation-method Static
-   name: Create a public IP resource in an availability zone in the current resource
        group region.
    text: az network public-ip create -g MyResourceGroup -n MyIp --zone 2
-   name: Create a public IP address.
    text: az network public-ip create --allocation-method Static --name MyIp --location
        westus2 --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: List public IP addresses.
    text: az network public-ip list --output json --query [0]
    crafted: 'True'
"""
...
-   name: Get the FQDN and IP address of a public IP resource.
    text: >
        ...
        address: ipAddress}"
-   name: Get the details of a public IP address.
    text: az network public-ip show --resource-group MyResourceGroup --name MyIp
    crafted: 'True'
"""
...
-   name: Update a public IP resource with a DNS name label and static allocation.
    text: az network public-ip update -g MyResourceGroup -n MyIp --dns-name MyLabel
        --allocation-method Static
-   name: Update a public IP address.
    text: az network public-ip update --dns-name MyLabel
    crafted: 'True'
"""
...
parameters:
-   name: --communities
    short-summary: Space-separated list of border gateway protocol (BGP) community
        values to filter on.
    populator-commands:
...
-   name: Delete a rule from a route filter.
    text: az network route-filter rule delete -g MyResourceGroup --filter-name MyRouteFilter
        -n MyRouteFilterRule
"""
...
-   name: Get the details of a rule in a route filter.
    text: az network route-filter rule show -g MyResourceGroup --filter-name MyRouteFilter
        -n MyRouteFilterRule
"""
...
long-summary: >
    This command can only be used to update the tags for a route filter. Name and
    resource group are immutable and cannot be updated.
examples:
-   name: Update the tags on a route filter.
    text: az network route-filter update -g MyResourceGroup -n MyRouteFilter --set
...
-   name: Create a route in a route table.
    text: az network route-table route create --next-hop-type Internet --address-prefix
        {address-prefix} --name MyRoute --route-table-name MyRouteTable --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Delete a route from a route table.
    text: az network route-table route delete -g MyResourceGroup ---route-table-name
        MyRouteTable -n MyRoute
"""
...
-   name: List routes in a route table.
    text: az network route-table route list -g MyResourceGroup ---route-table-name
        MyRouteTable
"""
...
-   name: Get the details of a route in a route table.
    text: az network route-table route show -g MyResourceGroup ---route-table-name
        MyRouteTable -n MyRoute -o table
"""
...
-   name: Update a route in a route table to change the next hop ip address.
    text: az network route-table route update -g MyResourceGroup ---route-table-name
        MyRouteTable \\ -n MyRoute --next-hop-ip-address 10.0.100.5
-   name: Update a route in a route table.
    text: az network route-table route update --next-hop-ip-address 10.0.100.5
    crafted: 'True'
"""
...
-   name: Update a route table to disable BGP route propogation.
    text: az network route-table update -g MyResourceGroup -n MyRouteTable --disable-bgp-route-propagation
        true
"""
...
examples:
-   name: Create an endpoint for a performance profile to point to an Azure Web App
        endpoint.
    text: |
...
-   name: Delete a traffic manager endpoint.
    text: az network traffic-manager endpoint delete -g MyResourceGroup \\ --profile-name
        MyTmProfile -n MyEndpoint --type azureEndpoints
"""
...
-   name: List traffic manager endpoints.
    text: az network traffic-manager endpoint list -g MyResourceGroup --profile-name
        MyTmProfile
"""
...
type: command
short-summary: Get the default geographic hierarchy used by the geographic traffic
    routing method.
examples:
-   name: Get the default geographic hierarchy used by the geographic traffic routing
        method.
...
-   name: Update a traffic manager endpoint to change its weight.
    text: az network traffic-manager endpoint update -g MyResourceGroup --profile-name
        MyTmProfile \\ -n MyEndpoint --weight 20 --type azureEndpoints
-   name: Update a traffic manager endpoint.
    text: az network traffic-manager endpoint update --profile-name MyTmProfile \\
        --name MyEndpoint --endpoint-status Disabled --type azureEndpoints --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
-   name: Update a traffic manager profile to change the TTL to 300.
    text: az network traffic-manager profile update -g MyResourceGroup -n MyTmProfile
        --ttl 300
"""
...
type: command
short-summary: Check if a private IP address is available for use within a virtual
    network.
examples:
-   name: Check whether 10.0.0.4 is available within MyVnet.
    text: az network vnet check-ip-address -g MyResourceGroup -n MyVnet --ip-address
        10.0.0.4
"""
...
long-summary: >
    You may also create a subnet at the same time by specifying a subnet name and
...
-   name: Create a virtual network.
    text: az network vnet create --address-prefixes {address-prefixes} --location
        westus2 --resource-group MyResourceGroup --subnet-name MySubnet --name MyVnet
        --subnet-prefixes {subnet-prefixes}
    crafted: 'True'
"""
...
-   name: Delete a virtual network.
    text: az network vnet delete --name myVNet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: List virtual networks in a subscription which specify a certain address
        prefix.
    text: az network vnet list --query "[?contains(addressSpace.addressPrefixes, '10.0.0.0/16')]"
-   name: List virtual networks.
    text: az network vnet list --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Create a peering connection between two virtual networks.
    text: |
        az network vnet peering create -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name MyVnet1     --remote-vnet-id MyVnet2Id --allow-vnet-access
-   name: Create a virtual network peering connection.
    text: az network vnet peering create --allow-vnet-access {allow-vnet-access} --resource-group
        MyResourceGroup --remote-vnet {remote-vnet} --vnet-name MyVnet --name MyVNetPeering
    crafted: 'True'
"""
...
-   name: Delete a virtual network peering connection.
    text: az network vnet peering delete -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name
        MyVnet1
-   name: Delete a peering.
    text: az network vnet peering delete --resource-group MyResourceGroup --vnet-name
        MyVnet1 --name MyVnet1ToMyVnet2
    crafted: 'True'
"""
...
-   name: List peerings.
    text: az network vnet peering list --vnet-name MyVnet1 --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Show all details of the specified virtual network peering.
    text: az network vnet peering show -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name
        MyVnet1
"""
...
-   name: Change forwarded traffic configuration of a virtual network peering.
    text: >
        az network vnet peering update -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name
        MyVnet1 --set allowForwardedTraffic=true
-   name: Change virtual network access of a virtual network peering.
    text: >
        az network vnet peering update -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name
        MyVnet1 --set allowVirtualNetworkAccess=true
-   name: Change gateway transit property configuration of a virtual network peering.
    text: >
        az network vnet peering update -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name
        MyVnet1 --set allowGatewayTransit=true
-   name: Use remote gateways in virtual network peering.
    text: >
        az network vnet peering update -g MyResourceGroup -n MyVnet1ToMyVnet2 --vnet-name
        MyVnet1 --set useRemoteGateways=true
"""
...
-   name: Get the details of a virtual network.
    text: az network vnet show --resource-group MyResourceGroup --output json --name
        MyVNet
    crafted: 'True'
"""
...
-   name: --service-endpoints
    short-summary: Space-separated list of services allowed private access to this
        subnet.
    populator-commands:
...
-   name: Create a subnet and associate an existing NSG and route table.
    text: az network vnet subnet create --resource-group MyResourceGroup --address-prefixes
        {address-prefixes} --vnet-name MyVnet --name MySubnet
    crafted: 'True'
"""
...
-   name: List the subnets in a virtual network.
    text: az network vnet subnet list --vnet-name MyVNet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Show details of a subnet.
    text: az network vnet subnet show --output json --name MySubnet --query [0] --vnet-name
        MyVNet --resource-group MyResourceGroup
    crafted: 'True'
"""
...
-   name: Associate a network security group to a subnet.
    text: az network vnet subnet update -g MyResourceGroup -n MySubnet --vnet-name
        MyVNet --network-security-group MyNsg
-   name: Update a subnet.
    text: az network vnet subnet update --network-security-group MyNsg --resource-group
        MyResourceGroup --vnet-name MyVNet --name MySubnet
    crafted: 'True'
"""
...
type: group
short-summary: Use an Azure Virtual Network Gateway to establish secure, cross-premises
    connectivity.
long-summary: >
...
-   name: >
        Create a basic virtual network gateway that provides point-to-site connectivity
        with a RADIUS secret that matches what is configured on a RADIUS server.
    text: |
        az network vnet-gateway create -g MyResourceGroup -n MyVnetGateway --public-ip-address MyGatewayIp \\
...
long-summary: >
    ...
    objects in Azure that are
     connected to the Gateway. After deleting the Gateway, proceed to delete other
    resources now not in use.
...
type: command
short-summary: List the routes of a virtual network gateway advertised to the specified
    peer.
examples:
-   name: List the routes of a virtual network gateway advertised to the specified
        peer.
    text: az network vnet-gateway list-advertised-routes -g MyResourceGroup -n MyVnetGateway
        --peer 23.10.10.9
"""
...
-   name: Retrieve the status of a BGP peer.
    text: az network vnet-gateway list-bgp-peer-status -g MyResourceGroup -n MyVnetGateway
        --peer 23.10.10.9
"""

helps["network vnet-gateway list-learned-routes"] = """
type: command
short-summary: This operation retrieves a list of routes the virtual network gateway
...
-   name: Reset a virtual network gateway with Active-Active feature enabled.
    text: az network vnet-gateway reset -g MyResourceGroup -n MyVnetGateway --gateway-vip
        MyGatewayIP
"""
...
long-summary: Prevent machines using this certificate from accessing Azure through
    this gateway.
"""
...
-   name: Delete a revoked certificate.
    text: az network vnet-gateway revoked-cert delete -g MyResourceGroup -n MyRootCertificate
...
examples:
-   name: Remove a certificate from the list of Root Certificates whose children are
        allowed to access this Gateway.
    text: az network vnet-gateway root-cert delete -g MyResourceGroup -n MyRootCertificate
        --gateway-name MyVnetGateway
"""
...
-   name: Get the details of a virtual network gateway.
    text: az network vnet-gateway show --resource-group MyResourceGroup --name MyVnetGateway
    crafted: 'True'
"""
...
-   name: Change the SKU of a virtual network gateway.
    text: az network vnet-gateway update -g MyResourceGroup -n MyVnetGateway --sku
        VpnGw2
"""

helps["network vnet-gateway vpn-client"] = """
type: group
short-summary: Download a VPN client configuration required to connect to Azure via
    point-to-site.
"""
...
long-summary: The command outputs a URL to a zip file for the generated VPN client
    configuration.
examples:
-   name: Create the VPN client configuration for RADIUS with EAP-MSCHAV2 authentication.
    text: az network vnet-gateway vpn-client generate -g MyResourceGroup -n MyVnetGateway
...
type: command
short-summary: Place the CLI in a waiting state until a condition of the virtual network
    gateway is met.
examples:
...
long-summary: The VPN Gateway and Local Network Gateway must be provisioned before
    creating the connection between them.
examples:
-   name: >
        Create a site-to-site connection between an Azure virtual network and an on-premises
...
long-summary: Set all IPsec policies of a VPN connection. If you want to set any IPsec
    policy, you must set them all.
examples:
...
-   name: Remove all previously specified IPsec policies from a connection.
    text: az network vpn-connection ipsec-policy clear -g MyResourceGroup --connection-name
        MyConnection
"""
...
-   name: List the IPsec policies set on a connection.
    text: az network vpn-connection ipsec-policy list -g MyResourceGroup --connection-name
        MyConnection
"""
...
-   name: Reset the shared key on a connection.
    text: az network vpn-connection shared-key reset -g MyResourceGroup --connection-name
        MyConnection --key-length 128
"""
...
-   name: View the shared key of a connection.
    text: az network vpn-connection shared-key show -g MyResourceGroup --connection-name
        MyConnection
"""
...
-   name: Change the shared key for the connection to "Abc123".
    text: az network vpn-connection shared-key update -g MyResourceGroup --connection-name
...
-   name: Get the details of a VPN connection.
    text: az network vpn-connection show --resource-group MyResourceGroup --name MyConnection
    crafted: 'True'
"""
...
-   name: Add BGP to an existing connection.
    text: az network vpn-connection update -g MyResourceGroup -n MyConnection --enable-bgp
        True
"""
...
long-summary: >
    Network Watcher assists with monitoring and diagnosing conditions at a network
    scenario level. To learn more visit https://docs.microsoft.com/en-us/azure/network-watcher/
"""
...
type: group
short-summary: Manage connection monitoring between an Azure Virtual Machine and any
    IP resource.
long-summary: >
    Connection monitor can be used to monitor network connectivity between an Azure
    virtual machine and an IP address.
     The IP address can be assigned to another Azure resource or a resource on the
    Internet or on-premises. To learn
...
type: command
short-summary: Query a snapshot of the most recent connection state of a connection
    monitor.
examples:
-   name: List a connection monitor for the given region.
...
-   name: Enable NSG flow logs.
    text: az network watcher flow-log configure -g MyResourceGroup --enabled true
        --nsg MyNsg --storage-account MyStorageAccount
-   name: Disable NSG flow logs.
    text: az network watcher flow-log configure -g MyResourceGroup --enabled false
        --nsg MyNsg
"""
...
-   name: Get the flow log configuration of a network security group.
    text: az network watcher flow-log show --nsg MyNsg --query [0] --resource-group
        MyResourceGroup
    crafted: 'True'
"""
...
long-summary: >
    These commands require that both Azure Network Watcher is enabled for the VMs
    region and that AzureNetworkWatcherExtension is enabled on the VM.
...
-   name: --storage-path
    short-summary: Fully qualified URI of an existing storage container in which to
...
-   name: --file-path
    short-summary: >
        Local path on the targeted VM at which to save the packet capture. For Linux
        VMs, the
        path must start with /var/captures.
-   name: --vm
    short-summary: Name or ID of the VM to target.
-   name: --filters
    short-summary: JSON encoded list of packet filters. Use `@{path}` to load from
        file.
examples:
-   name: Create a packet capture session on a VM.
    text: az network watcher packet-capture create -g MyResourceGroup -n MyPacketCaptureName
        --vm MyVm --storage-account MyStorageAccount
-   name: Create a packet capture session on a VM with optional filters for protocols,
        local IP address and remote IP address ranges and ports.
    text: |
...
examples:
-   name: Delete a packet capture session. This only deletes the session and not the
        capture file.
...
long-summary: >
    Requires that Network Watcher is enabled for the region in which the target is
    located.
examples:
...
-   name: Get the next hop from a VMs assigned IP address to a destination at 10.1.0.4.
    text: az network watcher show-next-hop -g MyResourceGroup --vm MyVm --source-ip
        10.0.0.4 --dest-ip 10.1.0.4
"""

helps["network watcher show-security-group-view"] = """
type: command
short-summary: Get detailed security information on a VM for the currently configured
...
type: command
short-summary: (PREVIEW) Test if a connection can be established between a Virtual
    Machine and a given endpoint.
long-summary: >
    To check connectivity between two VMs in different regions, use the VM ids instead
    of the VM names for the source and destination resource arguments.
...
examples:
-   name: Check connectivity between two virtual machines in the same resource group
        over port 80.
    text: az network watcher test-connectivity -g MyResourceGroup --source-resource
        MyVmName1 --dest-resource MyVmName2 --dest-port 80
-   name: Check connectivity between two virtual machines in the same subscription
        in two different resource groups over port 80.
    text: az network watcher test-connectivity --source-resource MyVmId1 --dest-resource
        MyVmId2 --dest-port 80
"""

helps["network watcher test-ip-flow"] = """
type: command
short-summary: Test IP flow to/from a VM given the currently configured network security
    group rules.
long-summary: >
    Requires that Network Watcher is enabled for the region in which the VM is located.
...
examples:
-   name: Run test-ip-flow verify to test logical connectivity from a VM to the specified
...
-   name: Show the results or status of a troubleshooting operation for a Vnet Gateway.
    text: az network watcher troubleshooting show -g MyResourceGroup --resource MyVnetGateway
...
-   name: --resource-type -t
    short-summary: The type of target resource to troubleshoot, if resource ID is
        not specified.
-   name: --storage-account
    short-summary: Name or ID of the storage account in which to store the troubleshooting
        results.
-   name: --storage-path
    short-summary: Fully qualified URI to the storage blob container in which to store
