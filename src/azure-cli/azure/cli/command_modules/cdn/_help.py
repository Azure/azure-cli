  ...
  - name: Delete a custom domain.
    text: >
        az cdn custom-domain delete -g group --endpoint-name endpoint --profile-name profile \\
            -n domain-name
  - name: Delete the custom domain of a CDN. (autogenerated)
    text: az cdn custom-domain delete --endpoint-name endpoint --name domain-name --profile-name profile --resource-group group
    crafted: true
"""
  ...
  - name: Get the details of a custom domain.
    text: >
        az cdn custom-domain show -g group --endpoint-name endpoint --profile-name profile \\
            -n domain-name
  - name: Show details for the custom domain of a CDN. (autogenerated)
    text: az cdn custom-domain show --endpoint-name endpoint --name domain-name --profile-name profile --resource-group group
    crafted: true
"""
...
examples:
  ...
  - name: List available endpoints for a CDN. (autogenerated)
    text: az cdn endpoint list --profile-name profile-name --resource-group group
    crafted: true
"""
...
examples:
  ...
  - name: Pre-load content for a CDN endpoint. (autogenerated)
    text: az cdn endpoint load --content-paths '/scripts/app.js' '/styles/main.css' --name endpoint --profile-name profile-name
    crafted: true
"""
...
examples:
  ...
  - name: Purge pre-loaded content for a CDN endpoint. (autogenerated)
    text: az cdn endpoint purge --content-paths '/scripts/app.js' '/styles/*' --name endpoint --profile-name profile-name --resource-group group
    crafted: true
"""
...
examples:
  ...
  - name: Delete a CDN profile. (autogenerated)
    text: az cdn profile delete --name profile --resource-group group
    crafted: true
"""
