...
from azure.cli.command_modules.network.aaz.latest.network.watcher.connection_monitor.test_configuration._list import List as _MonitorTestConfigurationList
