...
examples:
  - name: create a Kusto Database.
    text: |-
        az kusto database create --cluster-name myclustername -g myrgname --database-name mydbname  --soft-delete-period P365D --hot-cache-period P31D
"""
...
examples:
  - name: Get a Kusto database. (autogenerated)
    text: az kusto database show --cluster-name MyCluster --database-name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: create a Kusto Database.
    text: |-
        az kusto database update --cluster-name myclustername -g myrgname --database-name mydbname  --soft-delete-period P365D --hot-cache-period P30D
"""
