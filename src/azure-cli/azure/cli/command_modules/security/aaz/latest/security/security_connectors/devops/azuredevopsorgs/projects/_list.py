...
@register_command(
    "security security-connectors devops azuredevopsorgs projects list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AzureDevOpsProjectsList(ctx=self.ctx)()
    ...
    class AzureDevOpsProjectsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            actionable_remediation = cls._schema_on_200.value.Element.properties.actionable_remediation
            ...
            branch_configuration = cls._schema_on_200.value.Element.properties.actionable_remediation.branch_configuration
            ...
            branch_names = cls._schema_on_200.value.Element.properties.actionable_remediation.branch_configuration.branch_names
            branch_names.Element = AAZStrType()

            category_configurations = cls._schema_on_200.value.Element.properties.actionable_remediation.category_configurations
            category_configurations.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.actionable_remediation.category_configurations.Element
