...
@register_command_group(
    "network vpn-connection packet-capture",
)
...
class Stop(AAZCommand):
    ...
    :example: Stop packet capture on a VPN connection.
        az network vpn-connection packet-capture stop -g MyResourceGroup -n MyConnection --sas-url https://myStorageAct.blob.azure.com/artifacts?st=2019-04-10T22%3A12Z&se=2019-04-11T09%3A12Z&s p=rl&sv=2018-03-28&sr=c&sig=0000000000
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualNetworkGatewayConnectionsStopPacketCapture(ctx=self.ctx)()
        self.post_operations()
    ...
    class VirtualNetworkGatewayConnectionsStopPacketCapture(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
