...
class ListQuotaReport(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.quota_type = AAZStrArg(
            options=["--quota-type"],
            arg_group="Body",
            help="Type of quota. If provided, quotaTarget must also be specified. The quotaType and quotaTarget properties are optional, but when filtering by quota type, quotaType and quotaTarget must be supplied together. Service/API will return an error if only one is provided.",
    ...
    class VolumesListQuotaReport(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("quotaTarget", AAZStrType, ".quota_target")
            _builder.set_prop("quotaType", AAZStrType, ".quota_type")
            _builder.set_prop("usageThresholdPercentage", AAZIntType, ".usage_threshold_percentage")
