...
from .deployment_traffic_manager_profile import DeploymentTrafficManagerProfile
...
from .traffic_manager_profile_creation_client_enums import (
    monitorProtocol,
    routingMethod,
    status,
    DeploymentMode,
...
__all__ = [
    'DeploymentTrafficManagerProfile',
    'TemplateLink',
    'ParametersLink',
