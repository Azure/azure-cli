...
def load_arguments(self, _):
    ...
    with self.argument_context('network express-route peering connection config') as c:
        c.argument('address_prefix_type', help='The type of address_prefix_type.', arg_type=get_enum_type(['IPv6']))
