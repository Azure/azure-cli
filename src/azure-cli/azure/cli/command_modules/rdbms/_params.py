...
def load_arguments(self, _):    # pylint: disable=too-many-statements
    ...
    def _flexible_server_params(command_group):
        ...
        with self.argument_context('{} flexible-server create'.format(command_group)) as c:
            ...
            c.argument('vnet_resource_id', options_list=['--vnet'], help='Name or ID of a virtual network or name of a new one to create. If you want to use vnet from different resource group or subscription, please provide resource ID. The name must be between 2 to 64 characters. The name must begin with a letter or number, end with a letter, number or underscore, and may contain only letters, numbers, underscores, periods, or hyphens.')
