...
@register_command(
    "sql mi startstopschedule show",
)
class Show(AAZCommand):
    """Get the managed instance's Start/Stop schedule.

    :example: Get the managed instance's start stop schedule.
    ...
    class StartStopManagedInstanceSchedulesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            schedule_list = cls._schema_on_200.properties.schedule_list
            schedule_list.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.schedule_list.Element
