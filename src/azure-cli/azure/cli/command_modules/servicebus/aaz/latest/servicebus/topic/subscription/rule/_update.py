...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.requires_preprocessing = AAZBoolArg(
            options=["--requires-preprocessing"],
            arg_group="CorrelationFilter",
            help="Value that indicates whether the rule action requires preprocessing.",
            nullable=True,
        )
        ...
        _args_schema.filter_requires_preprocessing = AAZBoolArg(
            options=["--filter-requires-preprocessing"],
            arg_group="SqlFilter",
            help="Value that indicates whether the rule action requires preprocessing.",
            nullable=True,
        )
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if sql_filter is not None:
                ...
                sql_filter.set_prop("requiresPreprocessing", AAZBoolType, ".filter_requires_preprocessing")
...
class _UpdateHelper:
    ...
    def _build_schema_rule_read(cls, _schema):
        if cls._schema_rule_read is not None:
            ...
            _schema.location = cls._schema_rule_read.location
        ...
        action = _schema_rule_read.properties.action
        ...
        correlation_filter = _schema_rule_read.properties.correlation_filter
        ...
        correlation_filter.tags = AAZDictType()
        correlation_filter.to = AAZStrType()

        tags = _schema_rule_read.properties.correlation_filter.tags
        tags.Element = AAZStrType()

        sql_filter = _schema_rule_read.properties.sql_filter
