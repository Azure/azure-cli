...
examples:
  ...
  - name: Verifies if specific blob identified by image 'sha256:abc123' is available to pull from the repository.
    text: >
        az acr check-health -n MyRegistry -r MyRepository --image sha256:abc123
  - name: Verifies if specific blob identified by tag 'latest' is available to pull from the repository. 
    text: >
