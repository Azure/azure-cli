...
class VirtualMachineOperations(object):
    ...
    def apply_artifacts(
            self, resource_group_name, lab_name, name, apply_artifacts_request, custom_headers=None, raw=False, **operation_config):
        ...
        :type apply_artifacts_request: :class:`ApplyArtifactsRequest
         <azure.mgmt.devtestlabs.models.ApplyArtifactsRequest>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def detach_data_disk(
            self, resource_group_name, lab_name, name, detach_data_disk_properties, custom_headers=None, raw=False, **operation_config):
        ...
        :param name: The name of the virtual machine.
        :type name: str
        :param detach_data_disk_properties:
        :type detach_data_disk_properties: :class:`DetachDataDiskProperties
         <azure.mgmt.devtestlabs.models.DetachDataDiskProperties>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
