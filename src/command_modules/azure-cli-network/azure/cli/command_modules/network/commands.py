...
from azure.mgmt.trafficmanager.operations import (EndpointsOperations,
                                                  ProfilesOperations)
from azure.mgmt.dns.operations import (RecordSetsOperations,
                                       ZonesOperations)

from .custom import (list_network_resource_property,
                     get_network_resource_property_entry,
                     delete_network_resource_property_entry,
                     update_network_vpn_gateway,
                     update_vnet,
                     update_nsg_rule,
                     update_subnet,
                     set_lb_frontend_ip_configuration,
                     set_lb_inbound_nat_rule,
                     set_lb_inbound_nat_pool,
                     set_lb_rule,
                     set_lb_probe,
                     set_nic_ip_config,
                     set_nic)
...
cli_generic_update_command('network application-gateway update', ApplicationGatewaysOperations.get, ApplicationGatewaysOperations.create_or_update, cf_application_gateways)

cli_command(__name__, 'network application-gateway create', 'azure.cli.command_modules.network.mgmt_app_gateway.lib.operations.app_gateway_operations#AppGatewayOperations.create_or_update', cf_application_gateway_create, transform=DeploymentOutputLongRunningOperation('Starting network application-gateway create'))
...
for subresource, alias in property_map.items():
    cli_command(__name__, 'network application-gateway {} list'.format(alias), 'azure.cli.command_modules.network.custom#{}'.format(list_network_resource_property('application_gateways', subresource)))
    cli_command(__name__, 'network application-gateway {} show'.format(alias), 'azure.cli.command_modules.network.custom#{}'.format(get_network_resource_property_entry('application_gateways', subresource)))
    cli_command(__name__, 'network application-gateway {} delete'.format(alias), 'azure.cli.command_modules.network.custom#{}'.format(delete_network_resource_property_entry('application_gateways', subresource)))
...
cli_generic_update_command('network express-route peering update', ExpressRouteCircuitPeeringsOperations.get, ExpressRouteCircuitPeeringsOperations.create_or_update, cf_express_route_circuit_peerings, setter_arg_name='peering_parameters')
...
cli_generic_update_command('network express-route update', ExpressRouteCircuitsOperations.get, ExpressRouteCircuitsOperations.create_or_update, cf_express_route_circuits)
...
cli_generic_update_command('network lb update', LoadBalancersOperations.get, LoadBalancersOperations.create_or_update, cf_load_balancers)

cli_command(__name__, 'network lb create', 'azure.cli.command_modules.network.mgmt_lb.lib.operations.lb_operations#LbOperations.create_or_update', cf_load_balancer_create, transform=DeploymentOutputLongRunningOperation('Starting network lb create'))
...
for subresource, alias in property_map.items():
    cli_command(__name__, 'network lb {} list'.format(alias), 'azure.cli.command_modules.network.custom#{}'.format(list_network_resource_property('load_balancers', subresource)))
    cli_command(__name__, 'network lb {} show'.format(alias), 'azure.cli.command_modules.network.custom#{}'.format(get_network_resource_property_entry('load_balancers', subresource)))
    cli_command(__name__, 'network lb {} delete'.format(alias), 'azure.cli.command_modules.network.custom#{}'.format(delete_network_resource_property_entry('load_balancers', subresource)))
...
cli_generic_update_command('network lb frontend-ip update', LoadBalancersOperations.get, LoadBalancersOperations.create_or_update, cf_load_balancers, child_collection_prop_name='frontend_ip_configurations', custom_function=set_lb_frontend_ip_configuration)
cli_generic_update_command('network lb inbound-nat-rule update', LoadBalancersOperations.get, LoadBalancersOperations.create_or_update, cf_load_balancers, child_collection_prop_name='inbound_nat_rules', custom_function=set_lb_inbound_nat_rule)
cli_generic_update_command('network lb inbound-nat-pool update', LoadBalancersOperations.get, LoadBalancersOperations.create_or_update, cf_load_balancers, child_collection_prop_name='inbound_nat_pools', custom_function=set_lb_inbound_nat_pool)
cli_generic_update_command('network lb rule update', LoadBalancersOperations.get, LoadBalancersOperations.create_or_update, cf_load_balancers, child_collection_prop_name='load_balancing_rules', custom_function=set_lb_rule)
cli_generic_update_command('network lb probe update', LoadBalancersOperations.get, LoadBalancersOperations.create_or_update, cf_load_balancers, child_collection_prop_name='probes', custom_function=set_lb_probe)
...
cli_generic_update_command('network local-gateway update', LocalNetworkGatewaysOperations.get, LocalNetworkGatewaysOperations.create_or_update, cf_local_network_gateways)

cli_command(__name__, 'network local-gateway create', 'azure.cli.command_modules.network.mgmt_local_gateway.lib.operations.local_gateway_operations#LocalGatewayOperations.create_or_update', cf_local_gateway_create, transform=DeploymentOutputLongRunningOperation('Starting network local-gateway create'))

# NetworkInterfacesOperations
cli_command(__name__, 'network nic create', 'azure.cli.command_modules.network.mgmt_nic.lib.operations.nic_operations#NicOperations.create_or_update', cf_nic_create, transform=DeploymentOutputLongRunningOperation('Starting network nic create'))
...
cli_generic_update_command('network nic update', NetworkInterfacesOperations.get, NetworkInterfacesOperations.create_or_update, cf_network_interfaces, custom_function=set_nic)
...
cli_generic_update_command('network nic ip-config update', NetworkInterfacesOperations.get, NetworkInterfacesOperations.create_or_update, cf_network_interfaces, child_collection_prop_name='ip_configurations', child_arg_name='ip_config_name', custom_function=set_nic_ip_config)
cli_command(__name__, 'network nic ip-config list', 'azure.cli.command_modules.network.custom#{}'.format(list_network_resource_property(resource, subresource)))
cli_command(__name__, 'network nic ip-config show', 'azure.cli.command_modules.network.custom#{}'.format(get_network_resource_property_entry(resource, subresource)))
cli_command(__name__, 'network nic ip-config delete', 'azure.cli.command_modules.network.custom#{}'.format(delete_network_resource_property_entry(resource, subresource)))
...
cli_generic_update_command('network nsg update', NetworkSecurityGroupsOperations.get, NetworkSecurityGroupsOperations.create_or_update, cf_network_security_groups)

cli_command(__name__, 'network nsg create', 'azure.cli.command_modules.network.mgmt_nsg.lib.operations.nsg_operations#NsgOperations.create_or_update', cf_nsg_create, transform=DeploymentOutputLongRunningOperation('Starting network nsg create'))
...
cli_generic_update_command('network public-ip update', PublicIPAddressesOperations.get, PublicIPAddressesOperations.create_or_update, cf_public_ip_addresses)

cli_command(__name__, 'network public-ip create', 'azure.cli.command_modules.network.mgmt_public_ip.lib.operations.public_ip_operations#PublicIpOperations.create_or_update', cf_public_ip_create, transform=DeploymentOutputLongRunningOperation('Starting network public-ip create'))
...
cli_generic_update_command('network route-table update', RouteTablesOperations.get, RouteTablesOperations.create_or_update, cf_route_tables)

cli_command(__name__, 'network route-table create', 'azure.cli.command_modules.network.mgmt_route_table.lib.operations.route_table_operations#RouteTableOperations.create_or_update', cf_route_table_create, transform=DeploymentOutputLongRunningOperation('Starting network route-table create'))
...
cli_generic_update_command('network route-table route update', RoutesOperations.get, RoutesOperations.create_or_update, cf_routes)
...
cli_generic_update_command('network nsg rule update', SecurityRulesOperations.get, SecurityRulesOperations.create_or_update, cf_security_rules, setter_arg_name='security_rule_parameters', custom_function=update_nsg_rule)
...
cli_generic_update_command('network vnet subnet update', SubnetsOperations.get, SubnetsOperations.create_or_update, cf_subnets, setter_arg_name='subnet_parameters', custom_function=update_subnet)
...
cli_generic_update_command('network vpn-connection update', VirtualNetworkGatewayConnectionsOperations.get, VirtualNetworkGatewayConnectionsOperations.create_or_update, cf_virtual_network_gateway_connections)
...
cli_generic_update_command('network vpn-connection shared-key update', VirtualNetworkGatewayConnectionsOperations.get, VirtualNetworkGatewayConnectionsOperations.set_shared_key, cf_virtual_network_gateway_connections)

cli_command(__name__, 'network vpn-connection create', 'azure.cli.command_modules.network.mgmt_vpn_connection.lib.operations.vpn_connection_operations#VpnConnectionOperations.create_or_update', cf_vpn_connection_create, transform=DeploymentOutputLongRunningOperation('Starting network vpn-connection create'))
...
cli_generic_update_command('network vpn-gateway update', VirtualNetworkGatewaysOperations.get, VirtualNetworkGatewaysOperations.create_or_update, cf_virtual_network_gateways,
...
cli_generic_update_command('network vnet update', VirtualNetworksOperations.get, VirtualNetworksOperations.create_or_update, cf_virtual_networks,
                           custom_function=update_vnet)

cli_command(__name__, 'network vnet create', 'azure.cli.command_modules.network.mgmt_vnet.lib.operations.vnet_operations#VnetOperations.create_or_update', cf_vnet_create, transform=DeploymentOutputLongRunningOperation('Starting network vnet create'))
...
cli_generic_update_command('network vnet peering update', VirtualNetworkPeeringsOperations.get, VirtualNetworkPeeringsOperations.create_or_update, cf_virtual_network_peerings, setter_arg_name='virtual_network_peering_parameters')
...
cli_generic_update_command('network traffic-manager profile update', ProfilesOperations.get, ProfilesOperations.create_or_update, cf_traffic_manager_mgmt_profiles)

cli_command(__name__, 'network traffic-manager profile create', 'azure.cli.command_modules.network.mgmt_traffic_manager_profile.lib.operations.traffic_manager_profile_operations#TrafficManagerProfileOperations.create_or_update', cf_traffic_manager_profile_create, transform=DeploymentOutputLongRunningOperation('Starting network traffic-manager profile create'))
...
cli_generic_update_command('network traffic-manager endpoint update', EndpointsOperations.get, EndpointsOperations.create_or_update, cf_traffic_manager_mgmt_endpoints)
...
cli_generic_update_command('network dns zone update', ZonesOperations.get, ZonesOperations.create_or_update, cf_dns_mgmt_zones)
...
cli_command(__name__, 'network dns zone create', 'azure.cli.command_modules.network.mgmt_dns_zone.lib.operations.dns_zone_operations#DnsZoneOperations.create_or_update', cf_dns_mgmt_dns_zone_create, transform=DeploymentOutputLongRunningOperation('Starting network dns zone create'))
...
cli_generic_update_command('network dns record-set update', RecordSetsOperations.get, RecordSetsOperations.create_or_update, cf_dns_mgmt_record_sets)
