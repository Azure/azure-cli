...
examples:
  - name: Adds a certificate contact with the specified email to the Key Vault. (autogenerated)
    text: |
...
examples:
  - name: Create a role assignment for a specified assignee with a defined role and scope in a Managed HSM using its name. (autogenerated)
    text: |
        az keyvault role assignment create --assignee fb2f-ac10--a04f-8b0d786ea37d --hsm-name mock-mhsm-sd --role "Managed HSM Crypto User" --scope "/"
"""
