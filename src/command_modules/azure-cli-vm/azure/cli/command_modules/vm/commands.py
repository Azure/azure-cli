...
cli_command(__name__, 'vm encrypt enable', 'azure.cli.command_modules.vm.custom_disk_encryption#encrypt_disk')
cli_command(__name__, 'vm encrypt disable', 'azure.cli.command_modules.vm.custom_disk_encryption#disable_disk_encryption')
cli_command(__name__, 'vm encrypt show', 'azure.cli.command_modules.vm.custom_disk_encryption#show_disk_encryption')
