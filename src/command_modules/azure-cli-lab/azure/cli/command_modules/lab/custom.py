...
def claim_vm(cmd, client, lab_name=None, name=None, resource_group=None):
    ...
    return get_devtestlabs_lab_operation(cmd.cli_ctx, None).claim_any_vm(resource_group, lab_name)
