...
class Remove(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-01-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/networkinterfaces/{}", "2022-01-01", "properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[]"],
        ]
    }
