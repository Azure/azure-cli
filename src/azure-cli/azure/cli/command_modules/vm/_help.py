...
type: command
short-summary: List image definitions in a gallery shared directly to your subscription or tenant.
examples:
...
type: command
short-summary: update a share image definition.
examples:
...
type: command
short-summary: List image versions in a gallery shared directly to your subscription or tenant.
examples:
