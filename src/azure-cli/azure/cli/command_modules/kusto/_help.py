...
examples:
  ...
  - name: Create a Kusto cluster. (autogenerated)
    text: |
        az kusto cluster create --location "Central US" --name myclustername --resource-group myrgname --sku D13_v2
    crafted: true
  - name: Create a Kusto cluster (autogenerated)
    text: az kusto cluster create --name myclustername --resource-group myrgname --sku D13_v2
    crafted: true
"""
...
examples:
  ...
  - name: Update a Kusto cluster. (autogenerated)
    text: az kusto cluster update --capacity 4 --name myclustername --resource-group myrgname
    crafted: true
"""
