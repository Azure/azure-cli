...
class Add(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2025-07-01", "properties.privateLinkConfigurations[].properties.ipConfigurations[]"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_common_sub_resource_update(_args_schema.subnet)
        return cls._args_schema
