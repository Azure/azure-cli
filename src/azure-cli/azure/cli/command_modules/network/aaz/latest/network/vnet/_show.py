...
class Show(AAZCommand):
    ...
    class VirtualNetworksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_common_extended_location_read(_schema_on_200.extended_location)
            ...
            _ShowHelper._build_schema_common_address_space_read(properties.address_space)
            properties.bgp_communities = AAZObjectType(
                serialized_name="bgpCommunities",
            )
            _ShowHelper._build_schema_common_virtual_network_bgp_communities_read(properties.bgp_communities)
            properties.ddos_protection_plan = AAZObjectType(
                serialized_name="ddosProtectionPlan",
            )
            _ShowHelper._build_schema_common_sub_resource_read(properties.ddos_protection_plan)
            properties.default_public_nat_gateway = AAZObjectType(
                serialized_name="defaultPublicNatGateway",
                flags={"read_only": True},
            )
            _ShowHelper._build_schema_common_sub_resource_read(properties.default_public_nat_gateway)
            ...
            _ShowHelper._build_schema_common_virtual_network_encryption_read(properties.encryption)
            ...
            _ShowHelper._build_schema_common_address_space_read(properties.summarized_gateway_prefixes)
            ...
            _ShowHelper._build_schema_common_flow_log_read(flow_logs.Element)

            ip_allocations = cls._schema_on_200.properties.ip_allocations
            ip_allocations.Element = AAZObjectType()
            _ShowHelper._build_schema_common_sub_resource_read(ip_allocations.Element)

            subnets = cls._schema_on_200.properties.subnets
            subnets.Element = AAZObjectType()
            _ShowHelper._build_schema_common_subnet_read(subnets.Element)
            ...
            _ShowHelper._build_schema_common_address_space_read(properties.local_address_space)
            ...
            _ShowHelper._build_schema_common_address_space_read(properties.local_virtual_network_address_space)
            ...
            _ShowHelper._build_schema_common_address_space_read(properties.remote_address_space)
            properties.remote_bgp_communities = AAZObjectType(
                serialized_name="remoteBgpCommunities",
            )
            _ShowHelper._build_schema_common_virtual_network_bgp_communities_read(properties.remote_bgp_communities)
            ...
            _ShowHelper._build_schema_common_sub_resource_read(properties.remote_virtual_network)
            properties.remote_virtual_network_address_space = AAZObjectType(
                serialized_name="remoteVirtualNetworkAddressSpace",
            )
            _ShowHelper._build_schema_common_address_space_read(properties.remote_virtual_network_address_space)
            properties.remote_virtual_network_encryption = AAZObjectType(
                serialized_name="remoteVirtualNetworkEncryption",
                flags={"read_only": True},
            )
            _ShowHelper._build_schema_common_virtual_network_encryption_read(properties.remote_virtual_network_encryption)
            properties.resource_guid = AAZStrType(
                serialized_name="resourceGuid",
                flags={"read_only": True},
            )
