...
@register_command(
    "servicebus georecovery-alias list",
)
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.servicebus/namespaces/{}/disasterrecoveryconfigs", "2026-07-01-preview"],
        ]
    }
