...
type: command
short-summary: Unregister a registered container from a Recovery Serviced Vault.
examples:
  - name: Unregister a registered container from a Recovery Serviced Vault. (autogenerated)
...
type: command
short-summary: Create a backup policy.
examples:
  - name: Create a backup policy. (autogenerated)
...
type: command
short-summary: Start protecting a previously unprotected Azure FileShare as per the specified policy to a Recovery services vault.
examples:
  - name: Start protecting a previously unprotected Azure FileShare as per the specified policy to a Recovery services vault. (autogenerated)
...
type: command
short-summary: Restore a FileShare from the specified recovery point.
examples:
  - name: Restore a Azure FileShare from the specified recovery point. (autogenerated)
...
type: command
short-summary: Restore a file or directory of a FileShare from the specified recovery point.
examples:
  - name: Restore a file or directory of a FileShare from the specified recovery point. (autogenerated)
