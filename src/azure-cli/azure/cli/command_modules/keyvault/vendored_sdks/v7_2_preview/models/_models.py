...
class RestoreOperationParameters(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.sas_token_parameters = kwargs.get('sas_token_parameters', None)
        self.folder_to_restore = kwargs.get('folder_to_restore', None)
...
class SASTokenParameter(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.storage_resource_uri = kwargs.get('storage_resource_uri', None)
