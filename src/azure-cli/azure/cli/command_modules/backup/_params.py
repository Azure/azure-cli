...
allowed_workload_types = ['VM', 'AzureFileShare', 'SAPHANA', 'SAPHanaDatabase', 'MSSQL', 'SQLDataBase']
allowed_azure_workload_types = ['MSSQL', 'SQLDataBase', 'SAPHANA', 'SAPHanaDatabase', 'SAPASE']
...
allowed_protectable_item_type = ['SQLAG', 'SQLInstance', 'SQLDatabase', 'HANAInstance', 'SAPHanaSystem', 'SAPHanaDatabase']
