...
class PngImage(Image):
    ...
    :param range: Gets or sets the Duration till which to generate the
     ...
     (e.g: 100%)
    :type range: str
    :param layers: Gets the list of image layers.
    :type layers: list[~accounts.models.PngLayer]
    """
    ...
    def __init__(self, label=None, preserve_resolution_after_rotation=None, key_frame_interval=None, stretch_mode=None, sync_mode=None, start=None, step=None, range=None, layers=None):
        super(PngImage, self).__init__(label=label, preserve_resolution_after_rotation=preserve_resolution_after_rotation, key_frame_interval=key_frame_interval, stretch_mode=stretch_mode, sync_mode=sync_mode, start=start, step=step, range=range)
        self.layers = layers
