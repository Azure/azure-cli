...
@register_command(
    "security security-connectors devops azuredevopsorgs projects repos update",
    is_preview=True,
)
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AzureDevOpsReposUpdate(ctx=self.ctx)()
    ...
    class AzureDevOpsReposUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_azure_dev_ops_repository_read(cls._schema_on_200)
...
class _UpdateHelper:
    ...
    _schema_azure_dev_ops_repository_read = None

    @classmethod
    def _build_schema_azure_dev_ops_repository_read(cls, _schema):
        if cls._schema_azure_dev_ops_repository_read is not None:
            _schema.id = cls._schema_azure_dev_ops_repository_read.id
            _schema.name = cls._schema_azure_dev_ops_repository_read.name
            _schema.properties = cls._schema_azure_dev_ops_repository_read.properties
            _schema.system_data = cls._schema_azure_dev_ops_repository_read.system_data
            _schema.type = cls._schema_azure_dev_ops_repository_read.type
            return

        cls._schema_azure_dev_ops_repository_read = _schema_azure_dev_ops_repository_read = AAZObjectType()

        azure_dev_ops_repository_read = _schema_azure_dev_ops_repository_read
        azure_dev_ops_repository_read.id = AAZStrType(
            flags={"read_only": True},
        )
        azure_dev_ops_repository_read.name = AAZStrType(
            flags={"read_only": True},
        )
        azure_dev_ops_repository_read.properties = AAZObjectType()
        azure_dev_ops_repository_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        azure_dev_ops_repository_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_azure_dev_ops_repository_read.properties
        ...
        actionable_remediation = _schema_azure_dev_ops_repository_read.properties.actionable_remediation
        ...
        branch_configuration = _schema_azure_dev_ops_repository_read.properties.actionable_remediation.branch_configuration
        ...
        branch_names = _schema_azure_dev_ops_repository_read.properties.actionable_remediation.branch_configuration.branch_names
        branch_names.Element = AAZStrType()

        category_configurations = _schema_azure_dev_ops_repository_read.properties.actionable_remediation.category_configurations
        category_configurations.Element = AAZObjectType()

        _element = _schema_azure_dev_ops_repository_read.properties.actionable_remediation.category_configurations.Element
        _element.category = AAZStrType()
        _element.minimum_severity_level = AAZStrType(
            serialized_name="minimumSeverityLevel",
        )

        system_data = _schema_azure_dev_ops_repository_read.system_data
