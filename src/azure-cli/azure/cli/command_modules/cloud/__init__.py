...
class CloudCommandsLoader(AzCommandsLoader):
    ...
    def load_arguments(self, command):
        ...
        with self.argument_context('cloud') as c:
            ...
            c.argument('profile', help='Profile to use for this cloud. The azure stack profiles `2017-03-09-profile` `2018-03-01-hybrid` `2019-03-01-hybrid` and `2020-09-01-hybrid` have been deprecated and removed. To continue using Azure Stack please install the Azure CLI `2.66.*` (LTS) version.', choices=list(API_PROFILES))
