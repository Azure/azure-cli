...
@register_command(
    "network virtual-appliance connection create",
)
class Create(AAZCommand):
    """Create a connection to Network Virtual Appliance, if it doesn't exist else updates the existing NVA connection'
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_sub_resource_create(ids.Element)
    ...
    class NetworkVirtualApplianceConnectionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _schema_on_200_201.resource_name = AAZStrType(
            ...
            bgp_peer_address = cls._schema_on_200_201.properties.bgp_peer_address
