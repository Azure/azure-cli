...
class List(AAZCommand):
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.endpoints

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.endpoints = value
            return
    ...
    class ConnectionMonitorsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _ListHelper._build_schema_connection_monitor_result_read(cls._schema_on_200)
...
class Show(AAZCommand):
    ...
    :example: Show an endpoint from a connection monitor.
...
@register_command(
    "network watcher connection-monitor endpoint wait",
)
class Wait(AAZWaitCommand):
    ...
    class ConnectionMonitorsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _WaitHelper._build_schema_connection_monitor_result_read(cls._schema_on_200)
...
@link_helper(
    __package__,
    ("_build_schema_connection_monitor_endpoint_scope_item_read", "..__cmds"),
    ("_build_schema_connection_monitor_result_read", _Helper),
)
class _AddHelper:
