...
@register_command(
    "netappfiles snapshot policy volumes",
)
class Volumes(AAZCommand):
    """List volumes associated with snapshot policy

    Get the all ANF volumes associated with snapshot policy

    :example: Get ANF volumes associated with the specified snapshot policy
    ...
    _aaz_info = {
        "version": "2025-12-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/snapshotpolicies/{}/volumes", "2025-12-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SnapshotPoliciesListVolumes(ctx=self.ctx)()
    ...
    class SnapshotPoliciesListVolumes(AAZHttpOperation):
...
class _VolumesHelper:
    """Helper class for Volumes"""
