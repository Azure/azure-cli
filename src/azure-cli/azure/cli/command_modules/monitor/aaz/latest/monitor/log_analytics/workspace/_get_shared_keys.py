...
class GetSharedKeys(AAZCommand):
    """Get the shared keys for a workspace.

    :example: Get the shared keys for a workspace.
    ...
    class SharedKeysGetSharedKeys(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.primary_shared_key = AAZStrType(
                serialized_name="primarySharedKey",
            )
            _schema_on_200.secondary_shared_key = AAZStrType(
