...
def signalr_create(client, signalr_name, resource_group_name,
                   sku, unit_count=1, location=None, tags=None, service_mode='Default', enable_messaging_logs='False', allowed_origins=None, default_action="Allow"):
    sku = ResourceSku(name=sku, capacity=unit_count)
    service_mode_feature = SignalRFeature(flag="ServiceMode", value=service_mode)
    enable_messaging_logs_feature = SignalRFeature(flag="EnableMessagingLogs", value=enable_messaging_logs)
    ...
    parameter = SignalRResource(tags=tags,
                                ...
                                features=[service_mode_feature, enable_messaging_logs_feature],
                                cors=cors_setting,
                                location=location,
...
def signalr_update_custom(instance, sku=None, unit_count=1, tags=None, service_mode=None, allowed_origins=None, default_action=None, enable_messaging_logs=None):
    instance.features = []
