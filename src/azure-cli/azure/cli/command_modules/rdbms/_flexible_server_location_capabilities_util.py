...
def _postgres_parse_list_capability(result):
    ...
    auto_tuning = [feature for feature in supported_features if feature.name == "IndexTuning"]
    ...
    auto_tuning_supported = auto_tuning[0].status == "Enabled" if auto_tuning else False
