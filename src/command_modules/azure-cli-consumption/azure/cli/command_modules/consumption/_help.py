...
type: group
short-summary: Inspect the marketplace usage data of an Azure subscription within
    a billing period.
"""
...
type: command
short-summary: List reservation summaries for daily or monthly by order Id or reservation
    id.
examples:
-   name: List reservation summaries for daily or monthly by order Id or reservation
        id.
    text: az consumption reservation summary list --start-date 2018-01-01 in utc --end-date
        2018-02-01 in utc --query [0] --grain {grain} --reservation-order-id {reservation-order-id}
    crafted: 'True'
"""
...
type: command
short-summary: List the details of Azure resource consumption, either as an invoice
