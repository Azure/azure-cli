...
@register_command(
    "eventhubs eventhub fabric-shortcut delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a Microsoft Fabric shortcut.

    :example: Delete a Fabric shortcut
        az eventhubs eventhub fabric-shortcut delete --resource-group contoso-rg --namespace-name contoso-eventhub --event-hub-name orders --fabric-shortcut-name orders-shortcut
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FabricShortcutsDelete(ctx=self.ctx)()
    ...
    class FabricShortcutsDelete(AAZHttpOperation):
