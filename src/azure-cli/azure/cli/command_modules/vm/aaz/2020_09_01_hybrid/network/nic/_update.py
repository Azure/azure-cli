...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.tap_configurations = AAZListArg(
            options=["--tap-configurations"],
            arg_group="Properties",
            help="A list of TapConfigurations of the network interface.",
            nullable=True,
        )
        ...
        tap_configurations = cls._args_schema.tap_configurations
        tap_configurations.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_schema.tap_configurations.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
            nullable=True,
        ...
        _element.id = AAZResourceIdArg(
            ...
            nullable=True,
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/networkInterfaces/{}/tapConfigurations/{}",
            ),
        )
        _element.name = AAZStrArg(
            options=["name"],
        ...
        _element.virtual_network_tap = AAZObjectArg(
            options=["virtual-network-tap"],
            help="The reference of the Virtual Network Tap resource.",
            nullable=True,
        )
        cls._build_args_virtual_network_tap_update(_element.virtual_network_tap)
        return cls._args_schema
    ...
    _args_virtual_network_tap_update = None

    @classmethod
    def _build_args_virtual_network_tap_update(cls, _schema):
        if cls._args_virtual_network_tap_update is not None:
            _schema.destination_load_balancer_front_end_ip_configuration = cls._args_virtual_network_tap_update.destination_load_balancer_front_end_ip_configuration
            _schema.destination_network_interface_ip_configuration = cls._args_virtual_network_tap_update.destination_network_interface_ip_configuration
            _schema.destination_port = cls._args_virtual_network_tap_update.destination_port
            _schema.etag = cls._args_virtual_network_tap_update.etag
            _schema.id = cls._args_virtual_network_tap_update.id
            _schema.location = cls._args_virtual_network_tap_update.location
            _schema.tags = cls._args_virtual_network_tap_update.tags
            return

        cls._args_virtual_network_tap_update = AAZObjectArg(
            nullable=True,
        )

        virtual_network_tap_update = cls._args_virtual_network_tap_update
        virtual_network_tap_update.etag = AAZStrArg(
            options=["etag"],
            help="Gets a unique read-only string that changes whenever the resource is updated.",
            nullable=True,
        )
        virtual_network_tap_update.id = AAZResourceIdArg(
            options=["id"],
            help="Resource ID.",
            nullable=True,
            fmt=AAZResourceIdArgFormat(
        ...
        virtual_network_tap_update.location = AAZResourceLocationArg(
            options=["l", "location"],
            help="Resource location.",
            nullable=True,
            fmt=AAZResourceLocationArgFormat(
        ...
        virtual_network_tap_update.destination_load_balancer_front_end_ip_configuration = AAZObjectArg(
            options=["destination-load-balancer-front-end-ip-configuration"],
            help="The reference to the private IP address on the internal Load Balancer that will receive the tap",
            nullable=True,
        )
        virtual_network_tap_update.destination_network_interface_ip_configuration = AAZObjectArg(
            options=["destination-network-interface-ip-configuration"],
            help="The reference to the private IP Address of the collector nic that will receive the tap",
            nullable=True,
        )
        cls._build_args_network_interface_ip_configuration_update(virtual_network_tap_update.destination_network_interface_ip_configuration)
        virtual_network_tap_update.destination_port = AAZIntArg(
            options=["destination-port"],
            help="The VXLAN destination port that will receive the tapped traffic.",
            nullable=True,
        )
        virtual_network_tap_update.tags = AAZDictArg(
            options=["tags"],
            help="Resource tags.",
            nullable=True,
        )

        destination_load_balancer_front_end_ip_configuration = cls._args_virtual_network_tap_update.destination_load_balancer_front_end_ip_configuration
        destination_load_balancer_front_end_ip_configuration.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
            nullable=True,
        ...
        zones = cls._args_virtual_network_tap_update.destination_load_balancer_front_end_ip_configuration.zones
        zones.Element = AAZStrArg(
            nullable=True,
        )

        tags = cls._args_virtual_network_tap_update.tags
        tags.Element = AAZStrArg(
            nullable=True,
        )
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                properties.set_prop("tapConfigurations", AAZListType, ".tap_configurations")
            ...
            tap_configurations = _builder.get(".properties.tapConfigurations")
            if tap_configurations is not None:
                tap_configurations.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".properties.tapConfigurations[]")
            if _elements is not None:
                _elements.set_prop("etag", AAZStrType, ".etag")
                _elements.set_prop("id", AAZStrType, ".id")
                _elements.set_prop("name", AAZStrType, ".name")
            ...
            properties = _builder.get(".properties.tapConfigurations[].properties")
            if properties is not None:
                _UpdateHelper._build_schema_virtual_network_tap_update(properties.set_prop("virtualNetworkTap", AAZObjectType, ".virtual_network_tap"))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_virtual_network_tap_update(cls, _builder):
        if _builder is None:
            return
        _builder.set_prop("etag", AAZStrType, ".etag")
        _builder.set_prop("id", AAZStrType, ".id")
