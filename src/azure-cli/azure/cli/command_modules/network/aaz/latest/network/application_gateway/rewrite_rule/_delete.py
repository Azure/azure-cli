...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2025-07-01", "properties.rewriteRuleSets[].properties.rewriteRules[]"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.rewrite_rule_index = AAZIntArg(
            options=["--rewrite-rule-index"],
            required=True,
        )
        return cls._args_schema
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            filters = enumerate(result)
            filters = filter(
                lambda e: e[0] == self.ctx.args.rewrite_rule_index,
                filters
            )
            idx = next(filters)[0]
            return result[idx]
        ...
        def _set(self, value):
            ...
            self.ctx.args.rewrite_rule_index = idx
            result[idx] = value
            return
