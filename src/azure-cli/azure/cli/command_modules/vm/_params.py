...
def load_arguments(self, _):
    ...
    with self.argument_context('ppg show', min_api='2019-07-01') as c:
        c.argument('colocation', arg_type=get_three_state_flag(), help='Enable fetching the colocation status of all the resources in the proximity placement group. Default is false.')
