...
class RegistriesOperations(object):
    ...
    def check_name_availability(
            self, registry_name_check_request, custom_headers={}, raw=False, **operation_config):
        """
        Checks whether the container registry name is available.

        :param registry_name_check_request: The request to check whether the
         container registry name is available.
        :type registry_name_check_request: :class:`RegistryNameCheckRequest
         <containerregistrymanagementclient.models.RegistryNameCheckRequest>`
        ...
        :rtype: :class:`RegistryNameStatus
         <containerregistrymanagementclient.models.RegistryNameStatus>`
    ...
    def get_properties(
            self, resource_group_name, registry_name, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :rtype: :class:`Registry
         <containerregistrymanagementclient.models.Registry>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, registry_name, registry, custom_headers={}, raw=False, **operation_config):
        """
    ...
    def update(
            self, resource_group_name, registry_name, registry_update_parameters, custom_headers={}, raw=False, **operation_config):
        """
        ...
        :type registry_update_parameters: :class:`RegistryUpdateParameters
         <containerregistrymanagementclient.models.RegistryUpdateParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_by_resource_group(
        ...
        :rtype: :class:`RegistryPaged
         <containerregistrymanagementclient.models.RegistryPaged>`
        """
    ...
    def get_credentials(
        ...
        :rtype: :class:`RegistryCredentials
         <containerregistrymanagementclient.models.RegistryCredentials>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
