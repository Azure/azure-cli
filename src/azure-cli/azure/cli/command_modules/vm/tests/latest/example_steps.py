...
@try_manual
def step_disk_access_show_private_link_resource(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_disk_access_delete(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_gallery_application_create(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_gallery_application_show(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_gallery_application_list(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_gallery_application_version_list(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_gallery_application_delete(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_ssh_public_key_create(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_ssh_public_key_show(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_ssh_public_key_generate_key_pair(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_virtual_machine_reimage(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
...
@try_manual
def step_virtual_machine_scale(test, rg, rg_2, checks=None):
    if checks is None:
        checks = []
