...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr connected-acr') as c:
        ...
        c.argument('sync_schedule', options_list=['--sync-schedule', '-s'], type=int, help='Optional parameter to define the sync schedule. Uses cron expression to determine the schedule. If not specified, the instance is considered always online', required=False)
        ...
        c.argument('log_level', options_list=['--log-level'], type=int, help='Sets the log level for logging on the instance. Accepted log levels are Debug, Info, Warning, Error, and None. ', required=False, default="Info")
