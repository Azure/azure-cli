...
from azure.cli.command_modules.network.aaz.latest.network.dns.record_set._delete import Delete as _RecordSetDelete
from azure.cli.command_modules.network.aaz.latest.network.dns.record_set._create import Create as _RecordSetCreate
