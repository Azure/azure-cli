...
def load_command_table(self, _):
    ...
    with self.command_group('vm host group') as g:
        ...
        g.generic_update_command('update', getter_name='get_dedicated_host_group_instance_view', setter_name='update_dedicated_host_group', command_type=compute_custom)
