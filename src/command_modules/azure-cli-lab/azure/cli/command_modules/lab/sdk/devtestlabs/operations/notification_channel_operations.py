...
class NotificationChannelOperations(object):
    ...
    def notify(
            self, resource_group_name, lab_name, name, notify_parameters, custom_headers=None, raw=False, **operation_config):
        ...
        :param name: The name of the notificationChannel.
        :type name: str
        :param notify_parameters:
        :type notify_parameters: :class:`NotifyParameters
         <azure.mgmt.devtestlabs.models.NotifyParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
