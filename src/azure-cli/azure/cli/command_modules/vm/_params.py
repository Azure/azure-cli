...
def load_arguments(self, _):
    ...
    for scope in ['disk', 'snapshot']:
        with self.argument_context(scope) as c:
            ...
            c.argument('network_access_policy', min_api='2020-05-01', help='Policy for accessing the disk via network. Allowed values: AllowAll, AllowPrivate, DenyAll.', arg_type=get_enum_type(self.get_models('NetworkAccessPolicy')))
