...
class Show(AAZCommand):
    ...
    :example: Get the properties of the specified bandwidth schedule.
        az databoxedge bandwidth-schedule show --device-name testedgedevice --name bandwidth-1 --resource-group GroupForEdgeAutomation
    """
