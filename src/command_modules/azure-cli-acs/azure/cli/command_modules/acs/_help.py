...
examples:
  - name: Disable Kubernetes addons. (autogenerated)
    text: az aks disable-addons --addons  --name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Enable Kubernetes addons. (autogenerated)
    text: az aks enable-addons --addons  --name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Upgrade a managed Kubernetes cluster to a newer version. (autogenerated)
    text: az aks upgrade --kubernetes-version  --name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
