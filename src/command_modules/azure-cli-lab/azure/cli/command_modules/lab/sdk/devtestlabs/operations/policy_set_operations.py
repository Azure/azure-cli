...
class PolicySetOperations(object):
    ...
    def evaluate_policies(
            self, resource_group_name, lab_name, name, evaluate_policies_request, custom_headers=None, raw=False, **operation_config):
        ...
        :type name: str
        :param evaluate_policies_request:
        :type evaluate_policies_request: :class:`EvaluatePoliciesRequest
         <azure.mgmt.devtestlabs.models.EvaluatePoliciesRequest>`
