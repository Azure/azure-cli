...
class AzureConsumptionServiceScenarioTest(ScenarioTest):
    def _validate_usage(self, usage, includeMeterDetails=False):
        ...
        self.assertTrue(
            usage['pretaxCost'] and usage['usageQuantity'] and usage['billableQuantity'])
    ...
    def _validate_reservation_summaries(self, reservationsummaries):
        ...
        self.assertEqual(
            reservationsummaries['type'], 'Microsoft.Consumption/reservationsummaries')
    ...
    def _validate_reservation_details(self, reservationdetails):
        ...
        self.assertEqual(
            reservationdetails['type'], 'Microsoft.Consumption/reservationDetails')
    ...
    def test_list_usages_billing_period(self):
        ...
        usages_list = self.cmd(
            'consumption usage list -p {billing_period} -t 5').get_output_in_json()
    ...
    def test_list_usages_billing_period_expand(self):
        ...
        usages_list = self.cmd(
            'consumption usage list -p {billing_period} -a -m -t 5').get_output_in_json()
        self.assertTrue(usages_list)
        self.assertTrue(len(usages_list) <= 5)
    ...
    def test_list_usages_subscription(self):
        usages_list = self.cmd(
            'consumption usage list -t 5 -a').get_output_in_json()
        self.assertTrue(usages_list)
        self.assertTrue(len(usages_list) <= 5)
        self._validate_usage(usages_list[0], False)
    ...
    def test_list_usages_subscription_custom_date_range(self):
        ...
        usages_list = self.cmd(
            'consumption usage list -s {start_date} -e {end_date}').get_output_in_json()
        self.assertTrue(usages_list)
        ...
        self.assertTrue(all(usage_date_check(usage_date)
                            for usage_date in usages_list))

    def test_list_reservations_summaries_monthly(self):
        reservations_summaries_monthly_list = self.cmd(
            'consumption reservations summaries list -g ''monthly'' -roid ca69259e-bd4f-45c3-bf28-3f353f9cce9b').get_output_in_json()
        self.assertTrue(reservations_summaries_monthly_list)
        self._validate_reservation_summaries(
            reservations_summaries_monthly_list[0])

    def test_list_reservations_summaries_monthly_withreservationid(self):
        reservations_summaries_monthly_withreservationid_list = self.cmd(
            'consumption reservations summaries list -g ''monthly'' -roid ca69259e-bd4f-45c3-bf28-3f353f9cce9b -rid f37f4b70-52ba-4344-a8bd-28abfd21d640').get_output_in_json()
        self.assertTrue(reservations_summaries_monthly_withreservationid_list)
        self._validate_reservation_summaries(
            reservations_summaries_monthly_withreservationid_list[0])

    def test_list_reservations_summaries_daily(self):
        reservations_summaries_daily_list = self.cmd(
            'consumption reservations summaries list -g ''daily'' -roid ca69259e-bd4f-45c3-bf28-3f353f9cce9b -s ''2017-12-01'' -e ''2017-12-07''').get_output_in_json()
        self.assertTrue(reservations_summaries_daily_list)
        self._validate_reservation_summaries(
            reservations_summaries_daily_list[0])

    def test_list_reservations_summaries_daily_withreservationid(self):
        reservations_summaries_daily_withreservationid_list = self.cmd(
            'consumption reservations summaries list -g ''daily'' -roid ca69259e-bd4f-45c3-bf28-3f353f9cce9b -rid f37f4b70-52ba-4344-a8bd-28abfd21d640 -s ''2017-12-01'' -e ''2017-12-07''').get_output_in_json()
        self.assertTrue(reservations_summaries_daily_withreservationid_list)
        self._validate_reservation_summaries(
            reservations_summaries_daily_withreservationid_list[0])

    def test_list_reservations_details(self):
        reservations_details_list = self.cmd(
            'consumption reservations details list -roid ca69259e-bd4f-45c3-bf28-3f353f9cce9b -s ''2017-12-01'' -e ''2017-12-07''').get_output_in_json()
        self.assertTrue(reservations_details_list)
        self._validate_reservation_details(
            reservations_details_list[0])

    def test_list_reservations_details_withreservationid(self):
        reservations_details_list = self.cmd(
            'consumption reservations details list -roid ca69259e-bd4f-45c3-bf28-3f353f9cce9b -rid f37f4b70-52ba-4344-a8bd-28abfd21d640 -s ''2017-12-01'' -e ''2017-12-07''').get_output_in_json()
        self.assertTrue(reservations_details_list)
        self._validate_reservation_details(
            reservations_details_list[0])
