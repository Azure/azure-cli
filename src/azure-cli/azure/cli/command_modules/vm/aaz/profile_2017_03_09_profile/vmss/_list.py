...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2016-03-30",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.compute/virtualmachinescalesets", "2016-03-30"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.compute/virtualmachinescalesets", "2016-03-30"],
        ]
    }
    ...
    class VirtualMachineScaleSetsListAll(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.over_provision = AAZBoolType(
                serialized_name="overProvision",
            )
            ...
            subnet = cls._schema_on_200.value.Element.properties.virtual_machine_profile.network_profile.network_interface_configurations.Element.properties.ip_configurations.Element.properties.subnet
