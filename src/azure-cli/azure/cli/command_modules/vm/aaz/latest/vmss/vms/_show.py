...
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.expand = AAZStrArg(
            options=["--expand"],
            help="The expand expression to apply on the operation. 'InstanceView' will retrieve the instance view of the virtual machine. 'UserData' will retrieve the UserData of the virtual machine.",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VirtualMachineScaleSetVMsGet(ctx=self.ctx)()
    ...
    class VirtualMachineScaleSetVMsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.instance_id = AAZStrType(
            ...
            _ShowHelper._build_schema_interconnect_group_profile_read(network_profile.interconnect_group_profile)
            ...
            _ShowHelper._build_schema_public_ip_address_sku_read(public_ip_address_configuration.sku)
            ...
            network_profile_configuration = cls._schema_on_200.properties.network_profile_configuration
            network_profile_configuration.interconnect_group_profile = AAZObjectType(
                serialized_name="interconnectGroupProfile",
            )
            _ShowHelper._build_schema_interconnect_group_profile_read(network_profile_configuration.interconnect_group_profile)
            network_profile_configuration.network_interface_configurations = AAZListType(
                serialized_name="networkInterfaceConfigurations",
            )

            network_interface_configurations = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations
            network_interface_configurations.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element
            _element.name = AAZStrType(
                flags={"required": True},
            )
            _element.properties = AAZObjectType(
            ...
            properties = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties
            properties.auxiliary_mode = AAZStrType(
                serialized_name="auxiliaryMode",
            )
            properties.auxiliary_sku = AAZStrType(
            ...
            dns_settings = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.dns_settings
            dns_settings.dns_servers = AAZListType(
                serialized_name="dnsServers",
            )

            dns_servers = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.dns_settings.dns_servers
            dns_servers.Element = AAZStrType()

            ip_configurations = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations
            ip_configurations.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element
            _element.name = AAZStrType(
                flags={"required": True},
            )
            _element.properties = AAZObjectType(
            ...
            properties = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties
            properties.application_gateway_backend_address_pools = AAZListType(
                serialized_name="applicationGatewayBackendAddressPools",
            )
            properties.application_security_groups = AAZListType(
            ...
            application_gateway_backend_address_pools = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.application_gateway_backend_address_pools
            application_gateway_backend_address_pools.Element = AAZObjectType()
            _ShowHelper._build_schema_sub_resource_read(application_gateway_backend_address_pools.Element)

            application_security_groups = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.application_security_groups
            application_security_groups.Element = AAZObjectType()
            _ShowHelper._build_schema_sub_resource_read(application_security_groups.Element)

            load_balancer_backend_address_pools = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.load_balancer_backend_address_pools
            load_balancer_backend_address_pools.Element = AAZObjectType()
            _ShowHelper._build_schema_sub_resource_read(load_balancer_backend_address_pools.Element)

            load_balancer_inbound_nat_pools = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.load_balancer_inbound_nat_pools
            ...
            public_ip_address_configuration = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.public_ip_address_configuration
            public_ip_address_configuration.name = AAZStrType(
                flags={"required": True},
            )
            public_ip_address_configuration.properties = AAZObjectType(
            ...
            properties = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.public_ip_address_configuration.properties
            properties.delete_option = AAZStrType(
                serialized_name="deleteOption",
            )
            properties.dns_settings = AAZObjectType(
            ...
            dns_settings = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.public_ip_address_configuration.properties.dns_settings
            dns_settings.domain_name_label = AAZStrType(
                serialized_name="domainNameLabel",
                flags={"required": True},
            )
            ...
            ip_tags = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.public_ip_address_configuration.properties.ip_tags
            ip_tags.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.public_ip_address_configuration.properties.ip_tags.Element
            _element.first_party_service_tag_id = AAZStrType(
                serialized_name="firstPartyServiceTagId",
            )
            _element.ip_tag_type = AAZStrType(
            ...
            tags = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.properties.ip_configurations.Element.properties.public_ip_address_configuration.tags
            tags.Element = AAZStrType()

            tags = cls._schema_on_200.properties.network_profile_configuration.network_interface_configurations.Element.tags
            tags.Element = AAZStrType()
            ...
            protection_policy = cls._schema_on_200.properties.protection_policy
...
class _ShowHelper:
    ...
    _schema_interconnect_group_profile_read = None

    @classmethod
    def _build_schema_interconnect_group_profile_read(cls, _schema):
        if cls._schema_interconnect_group_profile_read is not None:
            _schema.interconnect_group = cls._schema_interconnect_group_profile_read.interconnect_group
            _schema.subgroups = cls._schema_interconnect_group_profile_read.subgroups
            return

        cls._schema_interconnect_group_profile_read = _schema_interconnect_group_profile_read = AAZObjectType()

        interconnect_group_profile_read = _schema_interconnect_group_profile_read
        interconnect_group_profile_read.interconnect_group = AAZObjectType(
            serialized_name="interconnectGroup",
        )
        cls._build_schema_sub_resource_read(interconnect_group_profile_read.interconnect_group)
        interconnect_group_profile_read.subgroups = AAZListType()

        subgroups = _schema_interconnect_group_profile_read.subgroups
