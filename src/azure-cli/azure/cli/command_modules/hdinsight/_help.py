...
type: command
short-summary: Updates credentials for an existing HDInsight cluster, including Entra ID users and HTTP password.
examples:
...
type: command
short-summary: Shows credential configuration of an existing HDInsight cluster, including HTTP username, password, and Entra ID user settings
"""
