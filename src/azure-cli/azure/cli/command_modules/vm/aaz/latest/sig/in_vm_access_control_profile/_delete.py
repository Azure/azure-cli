...
@register_command(
    "sig in-vm-access-control-profile delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a gallery in VM access control profile.

    :example: Delete a gallery in VM access control profile.
        az sig in-vm-access-control-profile delete --resource-group myResourceGroup --gallery-name myGalleryName --name myInVMAccessControlProfileName
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.GalleryInVMAccessControlProfilesDelete(ctx=self.ctx)()
    ...
    class GalleryInVMAccessControlProfilesDelete(AAZHttpOperation):
