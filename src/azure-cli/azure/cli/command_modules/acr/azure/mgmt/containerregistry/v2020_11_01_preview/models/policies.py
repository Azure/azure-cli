...
class Policies(Model):
    ...
    :type quarantine_policy: ~containerregistry.models.QuarantinePolicy
    :param trust_policy: The content trust policy for a container registry.
    :type trust_policy: ~containerregistry.models.TrustPolicy
    :param retention_policy: The retention policy for a container registry.
    :type retention_policy: ~containerregistry.models.RetentionPolicy
    """
