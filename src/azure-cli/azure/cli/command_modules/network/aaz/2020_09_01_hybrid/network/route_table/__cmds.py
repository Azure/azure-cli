...
class Update(AAZCommand):
    ...
    :example: Update a route table to disable BGP route propagation.
    ...
    class RouteTablesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _UpdateHelper._build_schema_route_table_read(cls._schema_on_200)
    ...
    class RouteTablesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            cls._schema_on_200_201 = AAZObjectType()
            _UpdateHelper._build_schema_route_table_read(cls._schema_on_200_201)
...
@link_helper(
    ...
    ("_build_schema_route_table_read", _Helper),
