...
examples:
  - name: Update a disk encryption set. (autogenerated)
    text: |
        az disk-encryption-set update --key-url MyKey --name MyDiskEncryptionSet --resource-group MyResourceGroup --source-vault MyVault
    crafted: true
"""
...
examples:
  - name: Create a proximity placement group. (autogenerated)
    text: |
        az ppg create --location westus2 --name MyProximityPlacementGroup --resource-group MyResourceGroup
    crafted: true
"""
