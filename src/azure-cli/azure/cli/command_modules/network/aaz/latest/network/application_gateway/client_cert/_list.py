...
@register_command(
    "network application-gateway client-cert list",
)
class List(AAZCommand):
    """List the existing trusted client certificates of the application gateway.

    :example: List the existing trusted client certificates of the application gateway.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.trustedClientCertificates

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.trustedClientCertificates = value
            return
