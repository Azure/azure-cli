...
@register_command(
    "network express-route-cross-connection peering route-tables-summary list-routes-table-summary",
)
class ListRoutesTableSummary(AAZCommand):
...
class _ListRoutesTableSummaryHelper:
    """Helper class for ListRoutesTableSummary"""


__all__ = ["ListRoutesTableSummary"]
