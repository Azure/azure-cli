...
class CmafFormat(MultiBitrateFormat):
    ...
    def __init__(self, filename_pattern=None, manifest_filename=None, output_files=None):
        super(CmafFormat, self).__init__(filename_pattern=filename_pattern, manifest_filename=manifest_filename, output_files=output_files)
        self.odatatype = '#Microsoft.Media.CmafFormat'
