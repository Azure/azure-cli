...
from .example_steps import step_network_interface_tap_configuration_list
from .example_steps import step_network_interface_tap_configuration_delete
from .. import (
    try_manual,
    raise_if,
    calc_coverage
...
def call_scenario(test):
    ...
    step_network_interface_tap_configuration_list(test, checks=[])
    step_network_interface_tap_configuration_delete(test, checks=[])
    cleanup_scenario(test)


# Test class for Scenario
@try_manual
class NetworkinterfacetapconfigurationsScenarioTest(ScenarioTest):
    def __init__(self, *args, **kwargs):
        super(NetworkinterfacetapconfigurationsScenarioTest, self).__init__(*args, **kwargs)
        self.kwargs.update({
    ...
    def test_networkinterfacetapconfigurations_Scenario(self, rg):
        call_scenario(self)
