...
from azure.mgmt.cdn.models import (AFDEndpoint, HealthProbeRequestType, EnabledState, Route, LinkToDefaultDomain,
                                   ...
                                   AFDEndpointUpdateParameters, SkuName, AfdPurgeParameters, Secret, AutoGeneratedDomainNameLabelScope,
                                   SecurityPolicy, ProfileUpdateParameters, AfdRouteCacheConfiguration, ActivatedResourceReference,
                                   ForwardingProtocol)
...
def create_afd_profile(client: ProfilesOperations, resource_group_name, profile_name,
    ...
    profile = Profile(location="global", sku=Sku(name=sku), tags=tags, origin_response_timeout_seconds=origin_response_timeout_seconds)
...
def update_afd_profile(client: ProfilesOperations, resource_group_name, profile_name, tags=None, origin_response_timeout_seconds=None):
    profile = client.get(resource_group_name, profile_name)
    ...
    return client.begin_update(resource_group_name, profile_name, ProfileUpdateParameters(tags=tags, origin_response_timeout_seconds=origin_response_timeout_seconds))
...
def create_afd_route(cmd,
    ...
    cache_configuration = AfdRouteCacheConfiguration(query_string_caching_behavior=query_string_caching_behavior,
...
def refresh_validation_token(cmd,
