...
class ListInstancePublicIps(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.vmss_name = AAZStrArg(
            options=["--vmss-name"],
            help="The name of the virtual machine scale set.",
            required=True,
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses(ctx=self.ctx)()
    ...
    class PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "virtualMachineScaleSetName", self.ctx.args.vmss_name,
                    required=True,
                ),
            }
            return parameters
        ...
        def _build_schema_on_200(cls):
            ...
            _ListInstancePublicIpsHelper._build_schema_public_ip_address_read(value.Element)

            return cls._schema_on_200


class _ListInstancePublicIpsHelper:
    """Helper class for ListInstancePublicIps"""
