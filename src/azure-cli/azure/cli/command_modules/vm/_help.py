...
examples:
  ...
  - name: Replicate to one more region (autogenerated)
    text: az sig image-version update --add publishingProfile.targetRegions name=westcentralus --gallery-image-definition MyImage --gallery-image-version 1.0.0 --gallery-name MyGallery --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a dedicated host. (autogenerated)
    text: az vm host create --host-group my-host-group --location eastasia --name my-host --platform-fault-domain 0 --resource-group my-resource-group --sku DSv3-Type1
    crafted: true
"""
...
examples:
  - name: Create a dedicated host group. (autogenerated)
    text: az vm host group create --location westus2 --name MyDedicatedHostGroup --platform-fault-domain-count 2 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update the 'autoReplaceOnFailure' field of a dedicated host. (autogenerated)
    text: az vm host update --host-group my-host-group --name my-host --resource-group my-resource-group --set autoReplaceOnFailure=True
    crafted: true
"""
...
examples:
  ...
  - name: List IP addresses associated with a VM (autogenerated)
...
examples:
  ...
  - name: disable encryption a VMSS (autogenerated)
...
examples:
  ...
  - name: Encrypt a VMSS with managed disks. (autogenerated)
    ...
    crafted: true
  - name: Encrypt a VMSS with managed disks. (autogenerated)
    text: az vmss encryption enable --disk-encryption-keyvault MyVault --name MyVmss --resource-group MyResourceGroup
    crafted: true
"""
