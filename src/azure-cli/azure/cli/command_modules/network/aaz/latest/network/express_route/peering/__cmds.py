...
@register_command(
    "network express-route peering wait",
)
...
@link_helper(
    __package__,
    ("_build_schema_express_route_circuit_peering_config_read", "..__cmds"),
...
__all__ = ["Create","Delete","GetStats","List","Show","Update","Wait","__CMDGroup"]
