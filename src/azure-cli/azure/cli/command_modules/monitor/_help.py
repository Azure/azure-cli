...
parameters:
  ...
  - name: --action-group -a
    short-summary: The names or the resource ids of the action groups to be added.
examples:
  - name: Remove action groups from this activity log alert. (autogenerated)
    text: |
        az monitor activity-log alert action-group remove --action-group /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/microsoft.insights/actionGroups/{ActionGroup} --name myactivitylogalerts --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Show details of an autoscale profile. (autogenerated)
    text: |
        az monitor autoscale profile show --autoscale-name myautoscale --name myautoscaleprofile --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete a linked service. (autogenerated)
    text: |
        az monitor log-analytics workspace linked-service delete --name cluster --resource-group MyResourceGroup --subscription mysubscription --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Delete a monitor private link scope resource. (autogenerated)
    text: |
        az monitor private-link-scope delete --name myazuremonitorprivatelinkscope --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: List all scoped resource of a private link scope resource. (autogenerated)
    text: |
        az monitor private-link-scope scoped-resource list --resource-group myresourcegroup --scope-name myscope
    crafted: true
"""
...
examples:
  - name: Delete a scoped resource of a private link scope resource. (autogenerated)
    text: |
        az monitor private-link-scope scoped-resource delete --name myassignedresource --resource-group myresourcegroup --scope-name myscope
    crafted: true
"""
