...
@register_command(
    "network virtual-appliance identity remove",
)
class Remove(AAZCommand):
    ...
    class NetworkVirtualAppliancesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _RemoveHelper._build_schema_network_virtual_appliance_read(cls._schema_on_200)
    ...
    class NetworkVirtualAppliancesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _RemoveHelper._build_schema_network_virtual_appliance_read(cls._schema_on_200_201)
