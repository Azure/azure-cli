...
examples:
  - name: Perform an on-demand backup of a backed up item. (autogenerated)
    text: |
        az backup protection backup-now --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --retain-until 01-02-2018 --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Stop protecting a backed up item. Can retain the backed up data forever or choose to delete it. (autogenerated)
    text: |
        az backup protection disable --container-name MyContainer --delete-backup-data false --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault --yes
    crafted: true
"""
...
examples:
  - name: Shows details of a particular recovery point. (autogenerated)
    text: |
        az backup recoverypoint show --container-name MyContainer --item-name MyItem --name MyRecoveryPoint --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Delete an existing Recovery services vault. (autogenerated)
    text: |
        az backup vault delete --force --name MyRecoveryServicesVault --resource-group MyResourceGroup
    crafted: true
"""
