...
examples:
  ...
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account delete --name myresource-luis --resource-group cognitive-services-resource-group --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    ...
    crafted: true
  - name: Manage Azure Cognitive Services accounts. (autogenerated) (autogenerated)
    text: az cognitiveservices account keys list --name myresource --resource-group cognitive-services-resource-group --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account keys regenerate --key-name key1 --name myresource --resource-group cognitive-services-resource-group
    crafted: true
"""
...
examples:
  ...
  - name: Create a rule to allow access for a subnet. (autogenerated)
    text: az cognitiveservices account network-rule add --name MyAccount --resource-group myRg --subnet mysubnet
    crafted: true
"""
...
examples:
  ...
  - name: Remove a network rule. (autogenerated)
    text: az cognitiveservices account network-rule remove --name MyAccount --resource-group MyResourceGroup
    crafted: true
  - name: Remove a network rule. (autogenerated)
    text: az cognitiveservices account network-rule remove --name MyAccount --resource-group MyResourceGroup --subnet mysubnet
    crafted: true
