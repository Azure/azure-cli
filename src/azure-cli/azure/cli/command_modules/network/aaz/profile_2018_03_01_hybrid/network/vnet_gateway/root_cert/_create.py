...
@register_command(
    "network vnet-gateway root-cert create",
)
class Create(AAZCommand):
    """Upload a root certificate.

    :example: Add a Root Certificate to the list of certs allowed to connect to this Gateway.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.root_cert_data = AAZStrArg(
            options=["--root-cert-data"],
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.vpnClientConfiguration.vpnClientRootCertificates
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                properties.set_prop("publicCertData", AAZStrType, ".root_cert_data", typ_kwargs={"flags": {"required": True}})
