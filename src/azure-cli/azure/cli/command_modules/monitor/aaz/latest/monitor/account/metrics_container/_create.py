...
@register_command(
    "monitor account metrics-container create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.metrics_container_name = AAZStrArg(
            options=["-n", "--name", "--metrics-container-name"],
            help="The name of the MetricsContainer",
            required=True,
            fmt=AAZStrArgFormat(
                pattern="^default$",
            ),
        ...
        _args_schema.version = AAZStrArg(
            ...
            help="The version of Metrics Query Service that this AMW will use for all metric queries.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.MetricsContainersCreateOrUpdate(ctx=self.ctx)()
    ...
    class MetricsContainersCreateOrUpdate(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "metricsContainerName", self.ctx.args.metrics_container_name,
                    required=True,
                ),
                **self.serialize_url_param(
