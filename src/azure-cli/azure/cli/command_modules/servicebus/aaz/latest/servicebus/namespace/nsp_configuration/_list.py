...
@register_command(
    "servicebus namespace nsp-configuration list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkSecurityPerimeterConfigurationList(ctx=self.ctx)()
    ...
    class NetworkSecurityPerimeterConfigurationList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            applicable_features = cls._schema_on_200.value.Element.properties.applicable_features
