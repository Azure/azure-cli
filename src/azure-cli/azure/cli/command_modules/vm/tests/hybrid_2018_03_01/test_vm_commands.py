...
class VMSSExtensionInstallTest(ScenarioTest):
    ...
    def test_vmss_extension(self):
        ...
        self.cmd('vmss create -n {vmss} -g {rg} --image UbuntuLTS --authentication-type password --admin-username admin123 --admin-password testPassword0 --instance-count 1 --orchestration-mode Uniform')
...
class DiagnosticsExtensionInstallTest(ScenarioTest):
    ...
    def test_diagnostics_extension_install(self, resource_group, storage_account):
        ...
        self.cmd('vmss create -g {rg} -n {vmss} --image UbuntuLTS --authentication-type password --admin-username user11 --admin-password TestTest12#$ --orchestration-mode Uniform')
...
class VMSSCreateLinuxSecretsScenarioTest(ScenarioTest):
    ...
    def test_vmss_create_linux_secrets(self, resource_group):
        ...
        self.cmd('vmss create -n {vmss} -g {rg} --image Debian --admin-username deploy --ssh-key-value \'{ssh_key}\' --secrets \'{secrets}\' --orchestration-mode Uniform')
