...
class DownloadUpdate(AAZCommand):
    """Downloads the updates on a Data Box Edge/Data Box Gateway device.

    :example: Download the updates on a Data Box Edge/Data Box Gateway device.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevicesDownloadUpdates(ctx=self.ctx)()
    ...
    class DevicesDownloadUpdates(AAZHttpOperation):
...
class _DownloadUpdateHelper:
    """Helper class for DownloadUpdate"""


__all__ = ["DownloadUpdate"]
