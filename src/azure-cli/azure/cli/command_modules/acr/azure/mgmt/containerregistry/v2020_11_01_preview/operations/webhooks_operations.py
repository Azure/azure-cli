...
class WebhooksOperations(object):
    ...
    def get(
        ...
        :rtype: ~containerregistry.models.Webhook or
    ...
    def create(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~containerregistry.models.Webhook]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~containerregistry.models.Webhook]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~containerregistry.models.WebhookPaged[~containerregistry.models.Webhook]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def ping(
        ...
        :rtype: ~containerregistry.models.EventInfo or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def get_callback_config(
        ...
        :rtype: ~containerregistry.models.CallbackConfig or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_events(
        ...
        :rtype:
         ~containerregistry.models.EventPaged[~containerregistry.models.Event]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
