...
class Update(AAZCommand):
    ...
    def _build_args_ip_configuration_update(cls, _schema):
        if cls._args_ip_configuration_update is not None:
            ...
            _schema.provisioning_state = cls._args_ip_configuration_update.provisioning_state
        ...
        ip_configuration_update.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
            help="Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.",
            nullable=True,
        )
    ...
    _args_route_table_update = None

    @classmethod
    def _build_args_route_table_update(cls, _schema):
        if cls._args_route_table_update is not None:
            _schema.etag = cls._args_route_table_update.etag
            _schema.id = cls._args_route_table_update.id
            _schema.location = cls._args_route_table_update.location
            _schema.provisioning_state = cls._args_route_table_update.provisioning_state
            _schema.routes = cls._args_route_table_update.routes
            _schema.subnets = cls._args_route_table_update.subnets
            _schema.tags = cls._args_route_table_update.tags
            return

        cls._args_route_table_update = AAZObjectArg(
            nullable=True,
        )

        route_table_update = cls._args_route_table_update
        route_table_update.etag = AAZStrArg(
            options=["etag"],
            help="Gets a unique read-only string that changes whenever the resource is updated.",
            nullable=True,
        )
        route_table_update.id = AAZResourceIdArg(
            options=["id"],
            help="Resource Identifier.",
            nullable=True,
            fmt=AAZResourceIdArgFormat(
        ...
        route_table_update.location = AAZResourceLocationArg(
            options=["l", "location"],
            help="Resource location.",
            nullable=True,
            fmt=AAZResourceLocationArgFormat(
        ...
        route_table_update.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
            help="The provisioning state of the resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.",
            nullable=True,
        )
        route_table_update.routes = AAZListArg(
            options=["routes"],
            help="Collection of routes contained within a route table.",
            nullable=True,
        )
        route_table_update.subnets = AAZListArg(
            options=["subnets"],
            help="A collection of references to subnets.",
            nullable=True,
        )
        route_table_update.tags = AAZDictArg(
            options=["tags"],
            help="Resource tags.",
            nullable=True,
        )

        routes = cls._args_route_table_update.routes
        routes.Element = AAZObjectArg(
            nullable=True,
        )

        _element = cls._args_route_table_update.routes.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
            nullable=True,
        ...
        subnets = cls._args_route_table_update.subnets
        subnets.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_subnet_update(subnets.Element)

        tags = cls._args_route_table_update.tags
        tags.Element = AAZStrArg(
            nullable=True,
        )
...
class _CreateHelper:
    ...
    def _build_schema_route_table_create(cls, _builder):
        ...
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@RouteTable_create.routes.[].etag")
            _elements.set_prop("id", AAZStrType, "@RouteTable_create.routes.[].id")
            _elements.set_prop("name", AAZStrType, "@RouteTable_create.routes.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.routes[].properties")
        if properties is not None:
            properties.set_prop("addressPrefix", AAZStrType, "@RouteTable_create.routes.[].address_prefix")
            properties.set_prop("nextHopIpAddress", AAZStrType, "@RouteTable_create.routes.[].next_hop_ip_address")
            properties.set_prop("nextHopType", AAZStrType, "@RouteTable_create.routes.[].next_hop_type", typ_kwargs={"flags": {"required": True}})
            properties.set_prop("provisioningState", AAZStrType, "@RouteTable_create.routes.[].provisioning_state")
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_route_table_update(cls, _builder):
        if _builder is None:
            return
        _builder.set_prop("etag", AAZStrType, ".etag")
        _builder.set_prop("id", AAZStrType, ".id")
        ...
        _elements = _builder.get(".properties.routes[]")
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@RouteTable_update.routes.[].etag")
            _elements.set_prop("id", AAZStrType, "@RouteTable_update.routes.[].id")
            _elements.set_prop("name", AAZStrType, "@RouteTable_update.routes.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.routes[].properties")
        if properties is not None:
            properties.set_prop("addressPrefix", AAZStrType, "@RouteTable_update.routes.[].address_prefix")
            properties.set_prop("nextHopIpAddress", AAZStrType, "@RouteTable_update.routes.[].next_hop_ip_address")
            properties.set_prop("nextHopType", AAZStrType, "@RouteTable_update.routes.[].next_hop_type", typ_kwargs={"flags": {"required": True}})
            properties.set_prop("provisioningState", AAZStrType, "@RouteTable_update.routes.[].provisioning_state")
    ...
    def _build_schema_subnet_update(cls, _builder):
        ...
        if properties is not None:
            ...
            properties.set_prop("provisioningState", AAZStrType, ".provisioning_state")
            cls._build_schema_route_table_update(properties.set_prop("routeTable", AAZObjectType, ".route_table"))
