...
2.40.0
++++++
* `aaz`: Support to use cli_ctx to initiate AAZCommand class (#23459)
* `aaz`: Fix AAZBearerTokenCredentialPolicy to support MSIAuthenticationWrapper crendital (#23471)
