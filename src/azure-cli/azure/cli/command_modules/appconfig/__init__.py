...
class AppconfigCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        configstore_custom = CliCommandType(operations_tmpl='azure.cli.command_modules.appconfig.custom#{}')
        super(AppconfigCommandsLoader, self).__init__(cli_ctx=cli_ctx, custom_command_type=configstore_custom)
