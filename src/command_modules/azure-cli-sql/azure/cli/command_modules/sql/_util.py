...
class ParametersContext(object):
    ...
    def expand(self, argument_name, model_type, patches=None):
        # TODO:
        ...
        #
        # Issue: https://github.com/Azure/azure-cli/issues/1644
        #        function _option_description doesn't return the correct argument name when the
