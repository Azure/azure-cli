...
examples:
  - name: Set the function app's configuration. (autogenerated)
    text: az functionapp config set --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Change deployment slots for a function app. (autogenerated)
    text: az functionapp deployment slot swap --name MyUniqueApp --resource-group MyResourceGroup --slot staging --subscription MySubscription --target-slot production
    crafted: true
"""
