...
examples:
  ...
  - name: Get a virtual network link to the specified Private DNS zone. (autogenerated)
    text: az network private-dns link vnet show --name MyLinkName --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
