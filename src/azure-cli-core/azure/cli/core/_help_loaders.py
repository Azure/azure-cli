...
class YamlLoaderMixin(object): # pylint:disable=too-few-public-methods
    ...
    @staticmethod
    def _load_yaml_content(file_names_list, file_content_dict):
        import os
        ...
        for file_name in file_names_list:
            ...
            results.append(_parse_yaml_from_string(content, file_name))
...
class HelpLoaderV1(BaseHelpLoader, YamlLoaderMixin):
    ...
    def load_entry_data(self, help_obj, parser):
        ...
        data_list = self._load_yaml_content(files_list, self._file_content_dict)
