...
register_cli_argument('account list', 'all_clouds', options_list=('--all-clouds',), help='List all subscriptions across all cloud environments', action='store_true')
register_cli_argument('account list', 'all', options_list=('--all',), help="List all subscriptions under current cloud, not just 'Enabled' ones", action='store_true')
