...
class ListNic(AAZCommand):
    """List associated load balancer network interfaces.

    :example: List associated load balancer network interfaces.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LoadBalancerNetworkInterfacesList(ctx=self.ctx)()
    ...
    class LoadBalancerNetworkInterfacesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListNicHelper._build_schema_network_interface_read(value.Element)

            return cls._schema_on_200


class _ListNicHelper:
    """Helper class for ListNic"""
