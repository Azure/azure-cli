...
--resource-group "myResourceGroup"
      - name: Create Gen1 Account
        text: |-
               az maps account create --kind "Gen1" --location "global" --disable-local-auth false --name "S0" --tags \
test="true" --account-name "myMapsAccount" --resource-group "myResourceGroup"
      - name: Create Gen2 Account
        text: |-
               az maps account create --kind "Gen2" --location "global" --disable-local-auth true --name "G2" --tags \
test="true" --account-name "myMapsAccount" --resource-group "myResourceGroup"
"""
