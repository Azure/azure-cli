...
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.search/searchservices/{}/listadminkeys", "2026-03-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AdminKeysGet(ctx=self.ctx)()
    ...
    class AdminKeysGet(AAZHttpOperation):
