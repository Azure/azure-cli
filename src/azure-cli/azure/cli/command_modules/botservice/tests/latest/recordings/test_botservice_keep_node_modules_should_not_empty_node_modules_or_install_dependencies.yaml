...
- request:
    body: '{"location": "global", "sku": {"name": "F0"}, "kind": "azurebot", "properties":
      ...
      "6213ea34-9f6b-44ff-8bb7-58b99941b60c", "isCmekEnabled": false, "publicNetworkAccess":
  ...
  response:
    ...
    headers:
      ...
      - application/json; charset=utf-8
      date:
      - Tue, 21 Jun 2022 08:26:32 GMT
      etag:
      - '"8b004634-0000-1800-0000-62b180b70000"'
      expires:
      - '-1'
      pragma:
      - no-cache
