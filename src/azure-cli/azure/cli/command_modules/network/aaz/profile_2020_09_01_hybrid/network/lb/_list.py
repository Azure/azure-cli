...
class List(AAZCommand):
    ...
    class LoadBalancersList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_backend_address_pool_read(backend_address_pools.Element)
            ...
            _ListHelper._build_schema_frontend_ip_configuration_read(frontend_ip_configurations.Element)
            ...
            _ListHelper._build_schema_inbound_nat_rule_read(inbound_nat_rules.Element)
            ...
            frontend_ip_configurations.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(frontend_ip_configurations.Element)
            ...
            load_balancing_rules.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(load_balancing_rules.Element)
