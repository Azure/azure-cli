...
def create_adla_account(cmd, client, resource_group_name, account_name, default_data_lake_store, location=None,
    ...
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.account.models import DataLakeAnalyticsAccount, DataLakeStoreAccountInfo
    adls_list = []
...
def update_adla_account(client, account_name, resource_group_name, tags=None, max_degree_of_parallelism=None,
    ...
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.account.models import DataLakeAnalyticsAccountUpdateParameters
...
def add_adla_firewall_rule(client, account_name, firewall_rule_name, start_ip_address, end_ip_address,
                           resource_group_name):
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.account.models import FirewallRule
...
def create_adla_compute_policy(client, account_name, compute_policy_name, object_id, object_type,
    ...
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.account.models import ComputePolicyCreateOrUpdateParameters
...
def create_adla_catalog_credential(client, account_name, database_name, credential_name, credential_user_name, uri,
    ...
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.catalog.models import DataLakeAnalyticsCatalogCredentialCreateParameters
...
def update_adla_catalog_credential(client, account_name, database_name, credential_name, credential_user_name, uri,
    ...
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.catalog.models import DataLakeAnalyticsCatalogCredentialUpdateParameters
    if not credential_user_password:
        try:
...
def submit_adla_job(client, account_name, job_name, script, runtime_version=None, compile_mode=None, compile_only=False,
    ...
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.job.models import (
...
def wait_adla_job(client, account_name, job_id, wait_interval_sec=5, max_wait_time_sec=-1):
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.job.models import JobState
