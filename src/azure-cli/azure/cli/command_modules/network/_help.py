...
examples:
  ...
  - name: (Public Preview) Create a route that forces all traffic to your web app to a Network Virtual Appliance, using a Service Tag.
    text: |
        az network route-table route create -g MyResourceGroup --route-table-name MyRouteTable -n MyRoute \\
            --next-hop-type VirtualAppliance --address-prefix AppService --next-hop-ip-address 10.0.100.4
"""
