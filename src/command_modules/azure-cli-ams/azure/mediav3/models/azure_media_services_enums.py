...
class ContentKeyPolicyPlayReadyUnknownOutputPassingOption(Enum):
...
class ContentKeyPolicyPlayReadyLicenseType(Enum):
...
class ContentKeyPolicyPlayReadyContentType(Enum):
...
class ContentKeyPolicyRestrictionTokenType(Enum):
...
class ContentKeyPolicyFairPlayRentalAndLeaseKeyType(Enum):
...
class TrackPropertyType(Enum):

    unknown = "Unknown"
    four_cc = "FourCC"


class TrackPropertyCompareOperation(Enum):

    unknown = "Unknown"
    equal = "Equal"


class StreamingLocatorContentKeyType(Enum):
...
class StreamingPolicyStreamingProtocol(Enum):
...
class LiveOutputResourceState(Enum):
...
class LiveEventInputProtocol(Enum):
...
class LiveEventResourceState(Enum):
...
class StreamOptionsFlag(Enum):

    default = "Default"
    low_latency = "LowLatency"


class StreamingEndpointResourceState(Enum):
