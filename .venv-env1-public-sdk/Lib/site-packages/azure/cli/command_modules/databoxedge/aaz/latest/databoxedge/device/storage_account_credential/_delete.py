...
@register_command(
    "databoxedge device storage-account-credential delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete the storage account credential.

    :example: Delete storage account credential
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StorageAccountCredentialsDelete(ctx=self.ctx)()
    ...
    class StorageAccountCredentialsDelete(AAZHttpOperation):
