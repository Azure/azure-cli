...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-04-15",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.cdn/profiles/{}/endpoints/{}/customdomains/{}", "2025-04-15"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.CustomDomainsDelete(ctx=self.ctx)()
