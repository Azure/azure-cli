...
# region - Eventhub Create
    ...
    for scope in ['eventhubs eventhub update', 'eventhubs eventhub create']:
        with self.argument_context(scope) as c:
            ...
            c.argument('partition_count', type=int, help='Number of partitions created for the Event Hub, allowed values are from 2 to 32 partitions. Default lower limit of 1 is supported with Kafka enabled namespaces. Default upper limit is 32 unless you have custom quota, in which case it would be upper limit of that quota.')
