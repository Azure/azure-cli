...
examples:
  ...
  - name: Update the details of this activity log alert (autogenerated)
    text: az monitor activity-log alert update --condition category=ServiceHealth and level=Error --name MyActivityLogAlerts --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update autoscale settings. (autogenerated)
    ...
    crafted: true
  - name: Update autoscale settings. (autogenerated)
    text: az monitor autoscale update --count 3 --name MyAutoscaleSettings --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a metric-based alert rule. (autogenerated)
    ...
    crafted: true
  - name: Update a metric-based alert rule. (autogenerated)
    text: az monitor metrics alert update --name MyAlertRule --resource-group MyResourceGroup
    crafted: true
"""
