...
def load_arguments(self, _):
    ...
    with self.argument_context('backup restore restore-disks') as c:
        ...
        c.argument('cvm_os_des_id', help='Disk Encryption Set Id to be used for OS disk encryption of Confidential VMs. This is applicable only for Confidential VMs with managed disks.')
