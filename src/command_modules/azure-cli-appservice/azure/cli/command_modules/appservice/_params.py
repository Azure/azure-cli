...
for scope in ['webapp', 'functionapp']:
    ...
    register_cli_argument(scope + ' deployment source', 'cd_app_type', arg_group='VSTS CD Provider', help='Web application framework you used to develop your app', default='AspNet', **enum_choice_list(['AspNet', 'AspNetCore', 'NodeJS', 'PHP', 'Python']))
