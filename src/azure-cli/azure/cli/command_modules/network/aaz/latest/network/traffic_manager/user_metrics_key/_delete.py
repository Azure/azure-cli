...
@register_command(
    "network traffic-manager user-metrics-key delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TrafficManagerUserMetricsKeysDelete(ctx=self.ctx)()
    ...
    class TrafficManagerUserMetricsKeysDelete(AAZHttpOperation):
