...
class Delete(AAZCommand):
    ...
    :example: Delete an ExpressRoute port. (autogenerated)
...
class Show(AAZCommand):
    ...
    :example: Get the details of an ExpressRoute port. (autogenerated)
...
__all__ = ["Create","Delete","GenerateLoa","List","Show","Update","Wait","__CMDGroup"]
