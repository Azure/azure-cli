    ...
    def pre_operations(self):
        ...
        if (not has_value(args.enable_private_link) and 'sharedPrivateLinkResource' not in existing) or \
            ...
            shared_private_link_resource = None
              ...
              has_value(args.private_link_sub_resource_type)) or args.enable_private_link.to_serialized_data() is True \
            or 'sharedPrivateLinkResource' in existing:
            ...
            shared_private_link_resource = {
                ...
                'private_link': {'id': args.private_link_resource if has_value(args.private_link_resource) \
