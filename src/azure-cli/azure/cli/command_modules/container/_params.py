...
def load_arguments(self, _):
    ...
    with self.argument_context('container create', arg_group='Confidential Container Group') as c:
        ...
        c.argument('allow_privilege_escalation', options_list=['--allow-escalation'], help="Allows whether a process can gain more privileges than its parent process.", action='store_true')
