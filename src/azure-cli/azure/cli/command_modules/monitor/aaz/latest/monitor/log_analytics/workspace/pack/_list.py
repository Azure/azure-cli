...
class List(AAZCommand):
    ...
    :example: List all the intelligence packs possible and whether they are enabled or disabled for a given workspace.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.IntelligencePacksList(ctx=self.ctx)()
    ...
    class IntelligencePacksList(AAZHttpOperation):
