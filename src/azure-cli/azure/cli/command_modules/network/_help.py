...
examples:
  ...
  - name: Update a redirect configuration. (autogenerated)
    text: |
        ...
        --name MyRedirectConfig \\
        --resource-group MyResourceGroup \\
        --target-listener MyNewBackendListener \\
        --type Permanent
    crafted: true
"""
...
examples:
  ...
  - name: Update a URL path map. (autogenerated)
    text: |
        ...
        --default-address-pool MyAddressPool \\
        --default-http-settings MyNewHttpSettings \\
        --gateway-name MyAppGateway \\
        --name MyUrlPathMap \\
        --resource-group MyResourceGroup
    crafted: true
...
examples:
  ...
  - name: Update a route in a route table. (autogenerated)
    text: |
        ...
        --name MyRoute \\
        --next-hop-ip-address 10.0.100.5 \\
...
examples:
  ...
  - name: Create a virtual network gateway. (autogenerated)
    text: |
        ...
        --name MyVnetGateway \\
        --no-wait \\
        --public-ip-addresses myVGPublicIPAddress \\
        --resource-group MyResourceGroup \\
        --sku Basic \\
        --vnet MyVnet \\
...
examples:
  ...
  - name: Create a VPN connection. (autogenerated)
    text: |
        ...
        --vnet-gateway2 /subscriptions/{subscriptionID}/resourceGroups/TestBGPRG1/providers/Microsoft.Network/virtualNetworkGateways/VNet1GW
    crafted: true
  - name: Create a VPN connection. (autogenerated)
    text: |
        az network vpn-connection create \\
