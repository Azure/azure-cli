...
examples:
  - name: Create a query key for a Search service.
    text: >
      az search service query-key create --resource-group MyResourceGroup --service-name MySearchService
"""
...
examples:
  - name: Regenerate the primary admin key for a Search service.
    text: >
      az search service admin-key regenerate --resource-group MyResourceGroup --service-name MySearchService --key-kind primary
  - name: Regenerate the secondary admin key for a Search service.
    text: >
      az search service admin-key regenerate --resource-group MyResourceGroup --service-name MySearchService --key-kind secondary
"""
...
examples:
  - name: Check if a Search service name is available.
    text: >
      az search service check-name-availability --name MySearchService
"""
...
examples:
  - name: Upgrade a Search service.
    text: >
      az search service upgrade --resource-group MyResourceGroup --service-name MySearchService
"""
...
examples:
  - name: Reconcile network security perimeter configuration for a Search service.
    text: >
      az search service network-security-perimeter-configuration reconcile --resource-group MyResourceGroup --service-name MySearchService
  - name: Reconcile network security perimeter configuration and specify a perimeter name.
    text: >
      az search service network-security-perimeter-configuration reconcile --resource-group MyResourceGroup --service-name MySearchService --perimeter-name MyPerimeter
  - name: Reconcile network security perimeter configuration and enable diagnostics.
    text: >
      az search service network-security-perimeter-configuration reconcile --resource-group MyResourceGroup --service-name MySearchService --enable-diagnostics true
"""
...
examples:
  - name: Create a shared private link resource for a Search service.
    text: >
      az search service shared-private-link-resource create --resource-group MyResourceGroup --service-name MySearchService --name MySharedPrivateLinkResource --group-id MyGroupId --resource-id /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/{provider}/{resourceType}/{resourceName}
  - name: Create a shared private link resource and specify a request message.
    text: >
      az search service shared-private-link-resource create --resource-group MyResourceGroup --service-name MySearchService --name MySharedPrivateLinkResource --group-id MyGroupId --resource-id /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/{provider}/{resourceType}/{resourceName} --request-message "Please approve this connection."
"""
...
examples:
  - name: Update the request message for a shared private link resource.
    text: >
      az search service shared-private-link-resource update --resource-group MyResourceGroup --service-name MySearchService --name MySharedPrivateLinkResource --request-message "Updated request message."
  - name: Approve a shared private link resource connection.
    text: >
      az search service shared-private-link-resource update --resource-group MyResourceGroup --service-name MySearchService --name MySharedPrivateLinkResource --status Approved
  - name: Reject a shared private link resource connection with a description.
    text: >
      az search service shared-private-link-resource update --resource-group MyResourceGroup --service-name MySearchService --name MySharedPrivateLinkResource --status Rejected --description "Connection not allowed."
"""
...
examples:
  - name: Approve a private endpoint connection.
    text: >
      az search service private-endpoint-connection update --resource-group MyResourceGroup --service-name MySearchService --name MyPrivateEndpointConnection --status Approved
  - name: Reject a private endpoint connection with a description.
    text: >
      az search service private-endpoint-connection update --resource-group MyResourceGroup --service-name MySearchService --name MyPrivateEndpointConnection --status Rejected --description "Connection not allowed."
  - name: Update the request message for a private endpoint connection.
    text: >
      az search service private-endpoint-connection update --resource-group MyResourceGroup --service-name MySearchService --name MyPrivateEndpointConnection --request-message "Updated request message."
"""