...
type: command
short-summary: Move a particular recovery point of a backed item from one tier to another tier.
examples:
  - name: Move a particular recovery point of a backed item. (autogenerated)
    text: az backup recoverypoint move --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault --rp-id RpId --source-tier SourceTier --destination-tier DestinationTier
    crafted: true
"""
