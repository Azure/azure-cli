...
-   "name": |-
    ...
    "text": |-
        az iot device send-d2c-message --device-id <device-id> --login <login> --da <da>
    "crafted": |-
        True
-   "name": |-
        Set edge modules on a single device.
    "text": |-
        az iot edge set-modules --content ../modules_content.json --device-id [Device ID] --hub-name [IoTHub Name]
    "crafted": |-
        True
-   "name": |-
        Create an IoT Edge deployment in the target IoT Hub.
    "text": |-
        az iot edge deployment create --content ../modules_content.json --target-condition "tags.building=9 and tags.environment='test'" --config-id <config-id> --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        List IoT Edge deployments in an IoT Hub.
    "text": |-
        az iot edge deployment list --login <login> --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        Send a cloud-to-device message.
    "text": |-
        az iot device c2d-message send --login <login> --properties <properties> --device-id <device-id> --da <da>
    "crafted": |-
        True
-   "name": |-
        Delete an IoT Edge deployment.
    "text": |-
        az iot edge deployment delete --hub-name MyHub --config-id <config-id>
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az iot dps enrollment list --dps-name MyDps --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
"examples":
-   "name": |-
        Delete linked IoT hub 'MyLinkedHub' in an Azure IoT Hub device provisioning service
    "text": |
...
-   "name": |-
    ...
    "text": |
        az iot dps linked-hub update --dps-name MyDps --resource-group MyResourceGroup --name MyLinkedHub.azure-devices.net --allocation-weight 10 --apply-allocation-policy True
"""
...
-   "name": |-
    ...
    "text": |-
        az iot hub monitor-events --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        Update device twin definition.
    "text": |-
        az iot hub device-twin update --login <login> --set tags='{"location":{"region":"US"}}' --device-id [Device ID] --hub-name [IoTHub Name] --resource-group MyResourceGroup
    "crafted": |-
        True
-   "name": |-
        Delete an IoT Hub device.
    "text": |-
        az iot hub device-identity delete --device-id <device-id> --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        Show a given IoT Hub device connection string.
    "text": |-
        az iot hub device-identity show-connection-string --device-id <device-id> --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        Create a device in an IoT Hub.
    "text": |-
        az iot hub device-identity create --device-id <device-id> --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        List devices in an IoT Hub.
    "text": |-
        az iot hub device-identity list --edge-enabled false --hub-name MyHub
    "crafted": |-
        True
-   "name": |-
        Update an IoT Hub device.
    "text": |-
        az iot hub device-identity update --device-id <device-id> --set capabilities.iotEdge=true --output json --login <login>
    "crafted": |-
        True
-   "name": |-
        Get a device twin definition.
    "text": |-
        az iot hub device-twin show --device-id <device-id> --hub-name MyHub
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |
        az iot hub routing-endpoint create --resource-group MyResourceGroup --hub-name MyIotHub --endpoint-name E2 --endpoint-type eventhub --endpoint-resource-group [Resource Group] --endpoint-subscription-id [SubscriptionId] --connection-string [Connection String]
-   "name": |-
        Add a new endpoint "S1" of type AzureStorageContainer to "MyIotHub" IoT Hub.
    "text": |
        az iot hub routing-endpoint create --resource-group MyResourceGroup --hub-name MyIotHub --endpoint-name S1 --endpoint-type azurestoragecontainer --endpoint-resource-group [Resource Group] --endpoint-subscription-id [SubscriptionId] --connection-string [Connection String] --container-name [Container Name]
"""
...
-   "name": |-
    ...
    "text": |
        az iot hub routing-endpoint show --resource-group MyResourceGroup --hub-name MyIotHub --endpoint-name [Endpoint Name]
"""
