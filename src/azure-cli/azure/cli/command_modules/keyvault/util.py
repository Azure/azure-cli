...
# This is a shred template for both CLI and PSH which is stored in template spec
# Below content is synced with version 0.1 of the template spec 'client_tool_kv_creation_template'
client_tool_kv_creation_template = {
    ...
    "parameters": {
        ...
        "apiVersion": {
            ...
            "metadata": {
                "description": "The API version used to call Keyvault Service."
            }
        }
    },
    "variables": {},
