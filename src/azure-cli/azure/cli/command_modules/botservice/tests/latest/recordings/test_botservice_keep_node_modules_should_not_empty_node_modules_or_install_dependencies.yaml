...
- request:
    ...
    headers:
      ...
      - -g -n
      User-Agent:
      - AZURECLI/2.37.0 azsdk-python-mgmt-botservice/2.0.0b2 Python/3.8.10 (Windows-10-10.0.19044-SP0)
    method: DELETE
...
- request:
    body: '{"location": "global", "sku": {"name": "F0"}, "kind": "azurebot", "properties":
      ...
      "9c775251-2187-406c-928e-b9cde13d647a", "isCmekEnabled": false, "publicNetworkAccess":
  ...
  response:
    ...
    headers:
      ...
      - application/json; charset=utf-8
      date:
      - Tue, 21 Jun 2022 05:32:06 GMT
      etag:
      - '"88003e40-0000-1800-0000-62b157d50000"'
      expires:
      - '-1'
      pragma:
      - no-cache
