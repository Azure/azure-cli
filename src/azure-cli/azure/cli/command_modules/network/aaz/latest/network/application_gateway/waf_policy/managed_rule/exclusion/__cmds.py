...
class Add(AAZCommand):
    ...
    :example: Add an OWASP CRS exclusion rule to the WAF policy managed rules.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.index = AAZIntArg(
            options=["--index"],
            help="Index of exclusion. If no index is provided, the default behavior is `append`.",
        )
        _args_schema.match_variable = AAZStrArg(
            options=["--match-variable"],
            help="Variable to be excluded.",
            required=True,
        ...
        _args_schema.selector = AAZStrArg(
            options=["--selector"],
            help="When match-variable is a collection, operator used to specify which elements in the collection this exclusion applies to.",
            required=True,
        )
        _args_schema.selector_match_operator = AAZStrArg(
            options=["--match-operator", "--selector-match-operator"],
            help="When match-variable is a collection, operate on the selector to specify which elements in the collection this exclusion applies to.",
            required=True,
        ...
        _element = cls._args_schema.rule_sets.Element
        ...
        rule_groups = cls._args_schema.rule_sets.Element.rule_groups
        rule_groups.Element = AAZObjectArg()

        _element = cls._args_schema.rule_sets.Element.rule_groups.Element
        ...
        rules = cls._args_schema.rule_sets.Element.rule_groups.Element.rules
        rules.Element = AAZObjectArg()

        _element = cls._args_schema.rule_sets.Element.rule_groups.Element.rules.Element
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.managedRules.exclusions
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            _builder.set_prop("exclusionManagedRuleSets", AAZListType, ".rule_sets")
            ...
            exclusion_managed_rule_sets = _builder.get(".exclusionManagedRuleSets")
            if exclusion_managed_rule_sets is not None:
                exclusion_managed_rule_sets.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".exclusionManagedRuleSets[]")
            ...
            rule_groups = _builder.get(".exclusionManagedRuleSets[].ruleGroups")
            if rule_groups is not None:
                rule_groups.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".exclusionManagedRuleSets[].ruleGroups[]")
            if _elements is not None:
            ...
            rules = _builder.get(".exclusionManagedRuleSets[].ruleGroups[].rules")
            if rules is not None:
                rules.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".exclusionManagedRuleSets[].ruleGroups[].rules[]")
            if _elements is not None:
