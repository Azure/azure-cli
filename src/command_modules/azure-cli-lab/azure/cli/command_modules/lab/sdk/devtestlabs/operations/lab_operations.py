...
class LabOperations(object):
    ...
    def list_by_subscription(
        ...
        :param expand: Specify the $expand query. Example:
         'properties($expand=storageDetails)'
        :type expand: str
    ...
    def export_lab_resource_usage(
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        export_lab_resource_usage_parameters = models.ExportLabResourceUsageParameters(blob_storage_absolute_sas_uri=blob_storage_absolute_sas_uri, usage_start_date=usage_start_date)

        # Construct URL
        url = '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{name}/exportLabResourceUsage'
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'name': self._serialize.url("name", name, 'str')
        ...
        # Construct body
        body_content = self._serialize.body(export_lab_resource_usage_parameters, 'ExportLabResourceUsageParameters')
