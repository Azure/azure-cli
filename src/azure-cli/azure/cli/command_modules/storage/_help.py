...
type: group
short-summary: Manage blob service properties for storage account.
"""
...
examples:
  ...
  - name: Disable the change feed for the storage account 'MyStorageAccount' in resource group 'MyResourceGroup'.
