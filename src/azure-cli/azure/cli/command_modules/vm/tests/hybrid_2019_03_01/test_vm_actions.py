...
class TestActions(unittest.TestCase):
    ...
    def test_figure_out_storage_source(self):
        ...
        src_blob_uri, src_disk, src_snapshot, src_restore_point, _ = _figure_out_storage_source(DummyCli(), 'tg1',
                                                                                                test_data)
    ...
    def test_update_sku_from_dict(self):
        ...
        for test_sku, expected in sku_tests.values():
            if isinstance(expected, dict):
                ...
                info_dict = {lun: dict(managedDisk={'storageAccountType': None}) for lun in dummy_expected if
                             lun != "os"}
