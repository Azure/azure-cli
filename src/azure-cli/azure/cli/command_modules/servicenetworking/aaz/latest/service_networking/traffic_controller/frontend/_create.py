...
@register_command(
    "service-networking traffic-controller frontend create",
    is_preview=True,
)
class Create(AAZCommand):
    """Create a Traffic Controller Frontend

    :example: Create a  Public frontend on Traffic Controller
        az service-networking traffic-controller frontend create -g testRG -n testFrontend --traffic-controller-name testTC --public-ip-address <publicIpId>
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.ip_address_version = AAZStrArg(
            options=["--ip-address-version"],
            arg_group="Properties",
            help="Frontend IP Address Version (Optional).",
            enum={"IPv4": "IPv4", "IPv6": "IPv6"},
        )
        _args_schema.mode = AAZStrArg(
            options=["--mode"],
            arg_group="Properties",
            help="Frontend Mode (Optional).",
            default="public",
            enum={"public": "public"},
        )
        _args_schema.public_ip_address = AAZStrArg(
            ...
            arg_group="Properties",
            help="Id of Public Address Resource",
        )
    ...
    class FrontendsInterfaceCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("ipAddressVersion", AAZStrType, ".ip_address_version")
            ...
            if public_ip_address is not None:
                public_ip_address.set_prop("id", AAZStrType, ".public_ip_address", typ_kwargs={"flags": {"required": True}})
        ...
        def _build_schema_on_200_201(cls):
            ...
            public_ip_address = cls._schema_on_200_201.properties.public_ip_address
