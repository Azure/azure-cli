...
class List(AAZCommand):
    ...
    :example: List link authorizations of an ExpressRoute circuit.
        az network express-route auth list -g MyResourceGroup --circuit-name MyCircuit

    :example: List link authorizations of an ExpressRoute circuit. (autogenerated)
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExpressRouteCircuitAuthorizationsList(ctx=self.ctx)()
    ...
    class ExpressRouteCircuitAuthorizationsList(AAZHttpOperation):
