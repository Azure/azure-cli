...
examples:
  ...
  - name: Create a MySQL database. (autogenerated)
    text: az mysql db create --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: List the databases for a server. (autogenerated)
    text: az mysql db list --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Create a server. (autogenerated)
    text: az mysql server create --admin-password password \ --admin-user username --location northeurope --name testsvr --resource-group testgroup --sku-name GP_Gen5_2 --version 5.7
    crafted: true
"""
...
examples:
  ...
  - name: Create a new firewall rule for a server. (autogenerated)
    text: az mysql server firewall-rule create --end-ip-address 107.46.14.221 --name allowip --resource-group testgroup --server-name testsvr --start-ip-address 107.46.14.221
    crafted: true
"""
...
examples:
  ...
  - name: Create a PostgreSQL database. (autogenerated)
    text: az postgres db create --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: List the databases for a server. (autogenerated)
    text: az postgres db list --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Create a server. (autogenerated)
    text: az postgres server create --admin-password password \ --admin-user username --location northeurope --name testsvr --resource-group testgroup --sku-name GP_Gen5_2 --storage-size 51200 --version 9.6
    crafted: true
"""
...
examples:
  ...
  - name: Create a new firewall rule for a server. (autogenerated)
    text: az postgres server firewall-rule create --end-ip-address 107.46.14.221 --name allowip --resource-group testgroup --server-name testsvr --start-ip-address 107.46.14.221
    crafted: true
"""
...
examples:
  ...
  - name: Download log files. (autogenerated)
    text: az postgres server-logs download --name f1.log f2.log --resource-group testgroup --server-name testsvr
    crafted: true
"""
