...
class ScopeMapsOperations(object):
    ...
    def get(
        ...
        :rtype: ~containerregistry.models.ScopeMap or
    ...
    def create(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~containerregistry.models.ScopeMap]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~containerregistry.models.ScopeMap]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :rtype:
         ~containerregistry.models.ScopeMapPaged[~containerregistry.models.ScopeMap]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
