...
examples:
  ...
  - name: List all AAAA record sets in a zone. (autogenerated)
    text: |
        az network private-dns record-set aaaa list --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Update an AAAA record set. (autogenerated)
    text: |
        az network private-dns record-set aaaa update --name MyRecordSet --resource-group MyResourceGroup --set useRemoteGateways=true --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Remove a CNAME record from its record set. (autogenerated)
    text: |
        az network private-dns record-set cname remove-record --cname www.contoso.com --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Add an MX record. (autogenerated)
    text: |
        az network private-dns record-set mx add-record --exchange mail.mysite.com --preference 10 --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create an empty MX record set. (autogenerated)
    text: |
        az network private-dns record-set mx create --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --ttl 300 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Place the CLI in a waiting state until a condition of the Private DNS zone is met. (autogenerated)
    text: |
        az network private-dns zone wait --exists --name www.mysite.com --resource-group MyResourceGroup --timeout 60
    crafted: true
"""
