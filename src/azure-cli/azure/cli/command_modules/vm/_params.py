...
def load_arguments(self, _):
    ...
    for scope in ['vm create', 'vmss create']:
        ...
        with self.argument_context(scope, arg_group='Authentication') as c:
            ...
            c.argument('generate_ssh_keys_type', arg_type=get_enum_type(['RSA', 'Ed25519']), help='Specify the type of SSH public and private key files to be generated if missing.')
