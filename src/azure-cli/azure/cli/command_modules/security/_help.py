...
examples:
  ...
  - name: Updates your automatic provisioning settings on the subscription. (autogenerated)
    ...
    crafted: true
  - name: Updates your automatic provisioning settings on the subscription. (autogenerated) (autogenerated)
    text: |
        az security auto-provisioning-setting update --auto-provision "off" --name "default" --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Creates a security contact. (autogenerated)
    text: |
        az security contact create --alert-notifications 'on' --alerts-admins 'on' --email 'john@contoso.com' --name "default1" --subscription MySubscription
    crafted: true
"""
