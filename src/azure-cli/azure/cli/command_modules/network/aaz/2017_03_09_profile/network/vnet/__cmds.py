...
class _UpdateHelper:
    ...
    def _build_schema_virtual_network_read(cls, _schema):
        ...
        address_space = _schema_virtual_network_read.properties.address_space
        address_space.address_prefixes = AAZListType(
            serialized_name="addressPrefixes",
        )

        address_prefixes = _schema_virtual_network_read.properties.address_space.address_prefixes
        address_prefixes.Element = AAZStrType()
