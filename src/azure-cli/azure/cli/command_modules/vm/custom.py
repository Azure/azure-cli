...
def show_proximity_placement_group(cmd, client, proximity_placement_group_name, resource_group_name, colocation=None):
    return client.get(resource_group_name, proximity_placement_group_name, colocation)
