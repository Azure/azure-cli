...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.ServiceEndpointPoliciesGet(ctx=self.ctx)()
        self.InstanceUpdateByJson(ctx=self.ctx)()
        self.InstanceUpdateByGeneric(ctx=self.ctx)()
        yield self.ServiceEndpointPoliciesCreateOrUpdate(ctx=self.ctx)()

    def _output(self, *args, **kwargs):
        result = self.deserialize_output(self.ctx.vars.instance, client_flatten=True)
        return result

    class ServiceEndpointPoliciesGet(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "serviceEndpointPolicyName", self.ctx.args.name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_service_endpoint_policy_read(cls._schema_on_200)

            return cls._schema_on_200

    class ServiceEndpointPoliciesCreateOrUpdate(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200_201(cls):
            ...
            _build_schema_service_endpoint_policy_read(cls._schema_on_200_201)
...
def _build_schema_service_endpoint_policy_read(_schema):
    global _schema_service_endpoint_policy_read
    if _schema_service_endpoint_policy_read is not None:
        _schema.etag = _schema_service_endpoint_policy_read.etag
        _schema.id = _schema_service_endpoint_policy_read.id
        _schema.kind = _schema_service_endpoint_policy_read.kind
        _schema.location = _schema_service_endpoint_policy_read.location
        _schema.name = _schema_service_endpoint_policy_read.name
        _schema.properties = _schema_service_endpoint_policy_read.properties
        _schema.tags = _schema_service_endpoint_policy_read.tags
        _schema.type = _schema_service_endpoint_policy_read.type
        return

    _schema_service_endpoint_policy_read = AAZObjectType()
...
def _build_schema_subnet_read(_schema):
    ...
    _build_schema_service_endpoint_policy_read(service_endpoint_policies.Element)
