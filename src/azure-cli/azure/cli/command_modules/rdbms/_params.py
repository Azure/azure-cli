...
def load_arguments(self, _):    # pylint: disable=too-many-statements
    ...
    for scope in ['mariadb server', 'mysql server', 'postgres server']:
        with self.argument_context(scope) as c:
            ...
            c.argument('public_network_access', arg_type=get_enum_type(['Enabled', 'Disabled']), options_list=['--public_network_access'], help='Set whether or not public network access is allowed for this server. Default is Enabled')
