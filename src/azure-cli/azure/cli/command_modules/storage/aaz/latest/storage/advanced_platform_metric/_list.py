...
@register_command(
    "storage advanced-platform-metric list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AdvancedPlatformMetricsList(ctx=self.ctx)()
    ...
    class AdvancedPlatformMetricsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            metrics_emitted = cls._schema_on_200.value.Element.properties.metrics_emitted
            metrics_emitted.Element = AAZStrType()

            rule_config = cls._schema_on_200.value.Element.properties.rule_config
            ...
            filter_values = cls._schema_on_200.value.Element.properties.rule_config.filter_values
