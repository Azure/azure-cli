...
class Create(AAZCommand):
    ...
    :example: Create an address pool with two endpoints.
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            backend_addresses = _builder.get(".properties.backendAddresses")
            if backend_addresses is not None:
                backend_addresses.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".properties.backendAddresses[]")
