...
class MapsScenarioTests(ScenarioTest):
    ...
    def test_create_maps_account(self, resource_group):
        ...
        account = self.cmd('az maps account create -n {name} -g {rg} --sku {sku} --force',
                           checks=[
        ...
        account_duplicated = self.cmd(
            'az maps account create -n {name} -g {rg} --sku {sku} --force').get_output_in_json()
        ...
        self.cmd('az maps account create -n {name1} -g {rg1} --sku {sku} --force')
        self.cmd('az maps account create -n {name2} -g {rg} --sku {sku} --force')
