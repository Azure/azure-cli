...
for scope in ['webapp', 'functionapp']:
    ...
    register_cli_argument(scope + ' deployment source', 'python_framework', arg_group='VSTS CD Provider', help='Framework used for Python application.', **enum_choice_list(['Bottle', 'Django', 'Flask']))
    register_cli_argument(scope + ' deployment source', 'python_version', arg_group='VSTS CD Provider', help='Python version used for application.', **enum_choice_list(['Python 2.7.12 x64', 'Python 2.7.12 x86', 'Python 2.7.13 x64', 'Python 2.7.13 x86', 'Python 3.5.3 x64', 'Python 3.5.3 x86', 'Python 3.6.0 x64', 'Python 3.6.0 x86', 'Python 3.6.2 x64', 'Python 3.6.1 x86']))
