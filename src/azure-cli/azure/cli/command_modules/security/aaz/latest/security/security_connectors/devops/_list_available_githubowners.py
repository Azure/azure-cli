...
@register_command(
    "security security-connectors devops list-available-githubowners",
    is_preview=True,
)
class ListAvailableGithubowners(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GitHubOwnersListAvailable(ctx=self.ctx)()
    ...
    class GitHubOwnersListAvailable(AAZHttpOperation):
...
class _ListAvailableGithubownersHelper:
    """Helper class for ListAvailableGithubowners"""


__all__ = ["ListAvailableGithubowners"]
