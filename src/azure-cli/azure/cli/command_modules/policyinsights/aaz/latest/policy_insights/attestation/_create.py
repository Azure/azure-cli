...
class Create(AAZCommand):
    """Create an attestation at resource scope.

    :example: Create a minimal attestation
        az policy attestation create --attestation-name 'Test-Attestation' -a '142412412412414'
    """
