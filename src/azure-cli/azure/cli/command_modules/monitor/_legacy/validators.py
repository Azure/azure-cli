...
def validate_autoscale_timegrain(namespace):
    ...
    from azure.cli.command_modules.monitor._legacy.actions import get_period_type
    from azure.cli.command_modules.monitor._legacy.util import get_autoscale_statistic_map
...
def validate_metrics_alert_dimension(namespace):
    from azure.cli.command_modules.monitor._legacy.grammar.metric_alert.MetricAlertConditionValidator import dim_op_conversion
...
def validate_metrics_alert_condition(namespace):
    from azure.cli.command_modules.monitor._legacy.grammar.metric_alert.MetricAlertConditionValidator import op_conversion, \
