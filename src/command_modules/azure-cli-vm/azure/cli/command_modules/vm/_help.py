...
examples:
  ...
  - name: Disable the boot diagnostics on a VM
    text: az vm boot-diagnostics disable --ids $(az vm list --resource-group MyResourceGroup "[].id" tsv) --name MyVirtualMachine --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Enable diagnostics on a VMSS. (autogenerated)
    text: "az vmss diagnostics set --protected-settings {protected-settings} --resource-group MyResourceGroup --settings '{\"commandToExecute\": \"echo testing\"}' --vmss-name MyVmss"
    crafted: true
"""
