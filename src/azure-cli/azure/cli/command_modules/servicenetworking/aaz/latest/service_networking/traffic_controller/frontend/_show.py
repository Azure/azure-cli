...
@register_command(
    "service-networking traffic-controller frontend show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a Traffic Controller Frontend

    :example: Get the details of an Frontend
        az service-networking traffic-controller frontend show -g testRG -n testFrontend --traffic-controller-name testTC
    """
