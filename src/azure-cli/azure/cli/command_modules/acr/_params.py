...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr create') as c:
        ...
        c.argument('writable_cache_repos', arg_type=get_enum_type(WritableCacheRepos), is_preview=True, help="'Enable or disable writing to repositories backed by cache rules. If not specified, this is set to Disabled by default'")
