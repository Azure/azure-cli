...
* Fixed case sensitive issue for AKS dashboard addon (#15123)
...
* vm boot-diagnostics enable: --storage becomes optional; New command: vm boot-diagnostics get-boot-log-uris (#15145)
