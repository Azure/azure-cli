...
from azure.cli.command_modules.acs._consts import (
    ...
    CONST_OS_SKU_AZURELINUX, CONST_OS_SKU_MARINER, CONST_OS_SKU_UBUNTU,
...
node_os_skus_create = [CONST_OS_SKU_AZURELINUX, CONST_OS_SKU_UBUNTU, CONST_OS_SKU_MARINER]
node_os_skus = node_os_skus_create + [CONST_OS_SKU_WINDOWS2019, CONST_OS_SKU_WINDOWS2022]
node_os_skus_update = [CONST_OS_SKU_AZURELINUX, CONST_OS_SKU_MARINER]
