...
class Replication(Resource):
    ...
    :param zone_redundancy: Zone redundancy level configured for this
     replication. Possible values include: 'Enabled', 'Disabled'. Default
     value: "Disabled" .
    :type zone_redundancy: str or ~containerregistry.models.ZoneRedundancy
    """
