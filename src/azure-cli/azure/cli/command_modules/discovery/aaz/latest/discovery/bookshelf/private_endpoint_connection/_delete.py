...
@register_command(
    "discovery bookshelf private-endpoint-connection delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.BookshelfPrivateEndpointConnectionsDelete(ctx=self.ctx)()
    ...
    class BookshelfPrivateEndpointConnectionsDelete(AAZHttpOperation):
