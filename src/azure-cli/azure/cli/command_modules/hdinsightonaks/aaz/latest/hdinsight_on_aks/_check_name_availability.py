...
@register_command(
    "hdinsight-on-aks check-name-availability",
)
class CheckNameAvailability(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-05-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.hdinsight/locations/{}/checknameavailability", "2024-05-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "NameAvailabilityParameters"

        _args_schema = cls._args_schema
        _args_schema.name = AAZStrArg(
            options=["--name"],
            arg_group="NameAvailabilityParameters",
            help="Name for checking availability.",
        )
        _args_schema.type = AAZStrArg(
            options=["--type"],
            arg_group="NameAvailabilityParameters",
            help="The resource type in Microsoft.HDInsight/clusterPools/clusters.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.LocationsCheckNameAvailability(ctx=self.ctx)()
    ...
    class LocationsCheckNameAvailability(AAZHttpOperation):
