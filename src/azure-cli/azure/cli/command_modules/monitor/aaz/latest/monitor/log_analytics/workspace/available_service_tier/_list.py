...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AvailableServiceTiersListByWorkspace(ctx=self.ctx)()
    ...
    class AvailableServiceTiersListByWorkspace(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.capacity_reservation_level = AAZIntType(
                serialized_name="capacityReservationLevel",
                flags={"read_only": True},
            )
            _element.default_retention = AAZIntType(
            ...
            _element.last_sku_update = AAZStrType(
                serialized_name="lastSkuUpdate",
                flags={"read_only": True},
            )
            _element.maximum_retention = AAZIntType(
                serialized_name="maximumRetention",
                flags={"read_only": True},
            )
            _element.minimum_retention = AAZIntType(
                serialized_name="minimumRetention",
                flags={"read_only": True},
            )
            _element.service_tier = AAZStrType(
