...
examples:
  - name: Check for the existence of a blob in a container. (autogenerated)
    text: az storage blob exists --account-key 00000000 --account-name MyAccount --container-name MyContainer --blob-name MyBlob
    crafted: true
"""
...
examples:
  - name: Set the block or page tiers on the blob. (autogenerated)
    text: az storage blob set-tier --account-key 00000000 --account-name MyAccount --container-name MyContainer --blob-name MyBlob --tier P10
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a blob (autogenerated)
    text: az storage blob show --account-name MyAccount --container-name MyContainer --blob-name MyBlob
    crafted: true
"""
...
examples:
  - name: Create the url to access a blob (autogenerated)
    text: az storage blob url --connection-string $connectionString --container-name container1 --blob-name blob1
    crafted: true
  - name: Create the url to access a blob (autogenerated)
    text: az storage blob url --account-name storageacct --container-name container1 --blob-name blob1
    crafted: true
"""
