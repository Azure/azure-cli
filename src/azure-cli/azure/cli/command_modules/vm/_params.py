...
def load_arguments(self, _):
    ...
    for scope in ['vmss create', 'vmss update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('enable_resilient_vm_creation', arg_type=get_three_state_flag(), min_api='2023-09-01', help='Automatically recover customers from OS Provisioning Timeout and VM Start Timeout errors experienced during a VM Create operation by deleting and recreating the affected VM.')
            c.argument('enable_resilient_vm_deletion', arg_type=get_three_state_flag(), min_api='2023-09-01', help='Retry VM Delete requests asynchronously in the event of a failed delete operation.')
