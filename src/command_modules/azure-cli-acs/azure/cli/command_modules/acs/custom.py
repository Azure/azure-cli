...
def dcos_install_cli(cmd, client=None, install_location=None, client_version='1.8'):
    """
...
def k8s_install_cli(cmd, client=None, client_version='latest', install_location=None):
