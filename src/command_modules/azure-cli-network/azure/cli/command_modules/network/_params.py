...
register_cli_argument('network dns record soa', 'email', options_list=('--email', '-e'), help='Email address.')
register_cli_argument('network dns record soa', 'expire_time', options_list=('--expire-time', '-x'), help='Expire time (seconds).')
register_cli_argument('network dns record soa', 'minimum_ttl', options_list=('--minimum-ttl', '-m'), help='Minimum TTL (time-to-live, seconds).')
register_cli_argument('network dns record soa', 'refresh_time', options_list=('--refresh-time', '-f'), help='Refresh value (seconds).')
register_cli_argument('network dns record soa', 'retry_time', options_list=('--retry-time', '-r'), help='Retry time (seconds).')
register_cli_argument('network dns record soa', 'serial_number', options_list=('--serial-number', '-s'))
...
register_cli_argument('network dns record txt', 'value', options_list=('--value', '-v'), help='Space separated list of text values.')
