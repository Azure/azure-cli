...
-   "name": |-
    ...
    "text": |-
        az mariadb db create -g testgroup -s testsvr -n testdb --admin-user myadmin --admin-password {server_admin_password} --sku-name GP_Gen4_2 --version 5.7
-   "name": |-
        Create database 'testdb' in server 'testsvr' with a given character set and collation rules.
    "text": |-
        az mariadb db create -g testgroup -s testsvr -n testdb --charset {valid_charset} --collation {valid_collation} --admin-user myadmin --admin-password {server_admin_password} --sku-name GP_Gen4_2 --version 5.7
"""
...
"examples":
-   "name": |-
        Create a MariaDB server with only required paramaters in North Europe.
    "text": |-
        az mariadb server create -l northeurope -g testgroup -n testsvr -u username -p password
-   "name": |-
        Create a MariaDB server with a Standard performance tier and 2 vcore in North Europe.
    "text": |-
        az mariadb server create -l northeurope -g testgroup -n testsvr -u username -p password \ --sku-name GP_Gen4_2
-   "name": |-
        Create a MariaDB server with all paramaters set.
    "text": |-
        az mariadb server create -l northeurope -g testgroup -n testsvr -u username -p password \ --sku-name B_Gen4_2 --ssl-enforcement Disabled \ --storage-size 51200 --tags "key=value" --version {server-version}
"""
...
"examples":
-   "name": |-
        Create a firewall rule allowing all connections from all IP addresses.
    "text": |-
        az mariadb server firewall-rule create -g testgroup -s testsvr -n allowall --start-ip-address 0.0.0.0 --end-ip-address 255.255.255.255
"""
...
-   "name": |-
    ...
    "text": |-
        az mariadb server firewall-rule update -g testgroup -s testsvr -n allowall --start-ip-address 0.0.0.1
-   "name": |-
        Update a firewall rule's start and end IP address.
    "text": |-
        az mariadb server firewall-rule update -g testgroup -s testsvr -n allowall --start-ip-address 0.0.0.1 --end-ip-address 255.255.255.254
"""
...
"examples":
-   "name": |-
        Georestore 'testsvr' as 'testsvrnew' where 'testsvrnew' is in same resource group as 'testsvr'.
    "text": |-
        az mariadb server georestore -g testgroup -n testsvrnew --source-server testsvr -l westus2
-   "name": |-
        Georestore 'testsvr2' to 'testsvrnew', where 'testsvrnew' is in the different resource group as the original server.
    "text": |
...
-   "name": |-
        Create database 'testdb' in the server 'testsvr' with the default parameters.
    "text": |-
        az mysql db create -g testgroup -s testsvr -n testdb --admin-user myadmin --admin-password {server_admin_password} --sku-name GP_Gen4_2 --version 5.7
-   "name": |-
        Create database 'testdb' in server 'testsvr' with a given character set and collation rules.
    "text": |-
        az mysql db create -g testgroup -s testsvr -n testdb --charset {valid_charset} --collation {valid_collation} --admin-user myadmin --admin-password {server_admin_password} --sku-name GP_Gen4_2 --version 5.7
"""
...
"examples":
-   "name": |-
        Create a MySQL server with only required paramaters in North Europe.
    "text": |-
        az mysql server create -l northeurope -g testgroup -n testsvr -u username -p password
-   "name": |-
        Create a MySQL server with a Standard performance tier and 2 vcore in North Europe.
    "text": |-
        az mysql server create -l northeurope -g testgroup -n testsvr -u username -p password \ --sku-name GP_Gen4_2
-   "name": |-
        Create a MySQL server with all paramaters set.
    "text": |-
        az mysql server create -l northeurope -g testgroup -n testsvr -u username -p password \ --sku-name B_Gen4_2 --ssl-enforcement Disabled \ --storage-size 51200 --tags "key=value" --version {server-version}
-   "name": |-
        Create a server.
    "text": |-
...
-   "name": |-
        Create a firewall rule allowing all connections from all IP addresses.
    "text": |-
        az mysql server firewall-rule create -g testgroup -s testsvr -n allowall --start-ip-address 0.0.0.0 --end-ip-address 255.255.255.255
-   "name": |-
        Create a new firewall rule for a server.
    "text": |-
        az mysql server firewall-rule create --start-ip-address 0.0.0.0 --server-name testsvr --end-ip-address 255.255.255.255 --name allowall --resource-group testgroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Update a firewall rule's start IP address.
    "text": |-
        az mysql server firewall-rule update -g testgroup -s testsvr -n allowall --start-ip-address 0.0.0.1
-   "name": |-
        Update a firewall rule's start and end IP address.
    "text": |-
        az mysql server firewall-rule update -g testgroup -s testsvr -n allowall --start-ip-address 0.0.0.1 --end-ip-address 255.255.255.254
"""
...
"examples":
-   "name": |-
        Create replica for server testsvr.
    "text": |-
        az mysql server replica create -n testreplsvr -g testgroup -s testsvr
-   "name": |-
        Create replica testreplsvr for server testsvr2, where 'testreplsvr' is in a different resource group.
    "text": |
...
"examples":
-   "name": |-
        Stop server testsvr as replica and make it an individual server.
    "text": |-
        az mysql server replica stop -g testgroup -n testsvr
"""
...
-   "name": |-
        Create a virtual network rule to allows access to a MySQL server.
    "text": |-
        az mysql server vnet-rule create --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/vnetName/subnets/subnetName --server-name testsvr --name vnetRuleName --resource-group testgroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create database 'testdb' in the server 'testsvr' with the default parameters.
    "text": |-
        az postgres db create -g testgroup -s testsvr -n testdb --admin-user myadmin --admin-password {server_admin_password} --sku-name GP_Gen4_2 --version 5.7
-   "name": |-
        Create database 'testdb' in server 'testsvr' with a given character set and collation rules.
    "text": |-
        az postgres db create -g testgroup -s testsvr -n testdb --charset {valid_charset} --collation {valid_collation} --admin-user myadmin --admin-password {server_admin_password} --sku-name GP_Gen4_2 --version 5.7
"""
...
-   "name": |-
        Create a PostgreSQL server with a Standard performance tier and 2 vcore in North Europe.
    "text": |-
...
-   "name": |-
    ...
    "text": |-
        az postgres server create -l northeurope -g testgroup -n testsvr -u username -p password \ --sku-name B_Gen4_2 --ssl-enforcement Disabled \ --storage-size 51200 --tags "key=value" --version {server-version}
-   "name": |-
        Create a server.
    "text": |-
...
-   "name": |-
        Create a new firewall rule for a server.
    "text": |-
        az postgres server firewall-rule create --start-ip-address 0.0.0.0 --server-name testsvr --end-ip-address 255.255.255.255 --name allowall --resource-group testgroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete a firewall rule.
    "text": |-
        az postgres server firewall-rule delete --server-name MyServer --yes  --name MyFirewallRule --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List all firewall rules for a server.
    "text": |-
        az postgres server firewall-rule list --server-name MyServer --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az postgres server vnet-rule list --server-name MyServer --resource-group MyResourceGroup
    "crafted": |-
        True
-   "name": |-
        Deletes the virtual network rule with the given name.
    "text": |-
        az postgres server vnet-rule delete --resource-group MyResourceGroup --server-name MyServer --name MyVnetRule
    "crafted": |-
        True
"""
...
-   "name": |-
        Create a virtual network rule to allows access to a PostgreSQL server.
    "text": |-
        az postgres server vnet-rule create --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/vnetName/subnets/subnetName --ignore-missing-endpoint <ignore-missing-endpoint> --resource-group testgroup --server-name testsvr --name vnetRuleName
    "crafted": |-
        True
"""
