...
register_cli_argument('acs', 'api_version', options_list=('--api-version',), default='2017-01-31', required=False, help='Use API version of ACS to perform az acs operations')
