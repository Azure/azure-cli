...
@register_command(
    "netappfiles subvolume delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete subvolume

    :example: Delete a subvolume of the ANF volume
    ...
    _aaz_info = {
        "version": "2025-12-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/subvolumes/{}", "2025-12-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SubvolumesDelete(ctx=self.ctx)()
    ...
    class SubvolumesDelete(AAZHttpOperation):
