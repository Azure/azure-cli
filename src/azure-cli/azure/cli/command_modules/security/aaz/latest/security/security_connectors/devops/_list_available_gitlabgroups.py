...
@register_command(
    "security security-connectors devops list-available-gitlabgroups",
    is_preview=True,
)
class ListAvailableGitlabgroups(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GitLabGroupsListAvailable(ctx=self.ctx)()
    ...
    class GitLabGroupsListAvailable(AAZHttpOperation):
...
class _ListAvailableGitlabgroupsHelper:
    """Helper class for ListAvailableGitlabgroups"""


__all__ = ["ListAvailableGitlabgroups"]
