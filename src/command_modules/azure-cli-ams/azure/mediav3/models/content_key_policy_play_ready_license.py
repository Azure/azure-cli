...
class ContentKeyPolicyPlayReadyLicense(Model):
    ...
    :param allow_test_devices: A flag indicating whether test devices can use
     the license.
    ...
    :type play_right: ~encoding.models.ContentKeyPolicyPlayReadyPlayRight
    :param license_type: The license type. Possible values include: 'Unknown',
     'NonPersistent', 'Persistent'
    :type license_type: str or
     ~encoding.models.ContentKeyPolicyPlayReadyLicenseType
    :param content_key_location: The content key location.
    :type content_key_location:
     ~encoding.models.ContentKeyPolicyPlayReadyContentKeyLocation
    :param content_type: The PlayReady content type. Possible values include:
     'Unknown', 'Unspecified', 'UltraVioletDownload', 'UltraVioletStreaming'
    :type content_type: str or
     ~encoding.models.ContentKeyPolicyPlayReadyContentType
    """
    ...
    def __init__(self, allow_test_devices, license_type, content_key_location, content_type, begin_date=None, expiration_date=None, relative_begin_date=None, relative_expiration_date=None, grace_period=None, play_right=None):
        super(ContentKeyPolicyPlayReadyLicense, self).__init__()
