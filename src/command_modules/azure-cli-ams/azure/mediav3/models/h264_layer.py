...
class H264Layer(VideoLayer):
    ...
    def __init__(self, width=None, height=None, label=None, bitrate=None, max_bitrate=None, b_frames=None, frame_rate=None, slices=None, adaptive_bframe=None, profile=None, level=None, buffer_window=None, reference_frames=None, entropy_mode=None):
        super(H264Layer, self).__init__(width=width, height=height, label=label, bitrate=bitrate, max_bitrate=max_bitrate, b_frames=b_frames, frame_rate=frame_rate, slices=slices, adaptive_bframe=adaptive_bframe)
