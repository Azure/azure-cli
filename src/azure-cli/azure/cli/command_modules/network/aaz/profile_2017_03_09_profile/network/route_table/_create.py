...
class Create(AAZCommand):
    ...
    def _build_args_ip_configuration_create(cls, _schema):
        if cls._args_ip_configuration_create is not None:
            ...
            _schema.provisioning_state = cls._args_ip_configuration_create.provisioning_state
        ...
        ip_configuration_create.provisioning_state = AAZStrArg(
    ...
    _args_route_table_create = None

    @classmethod
    def _build_args_route_table_create(cls, _schema):
        if cls._args_route_table_create is not None:
            _schema.etag = cls._args_route_table_create.etag
            _schema.id = cls._args_route_table_create.id
            _schema.location = cls._args_route_table_create.location
            _schema.provisioning_state = cls._args_route_table_create.provisioning_state
            _schema.routes = cls._args_route_table_create.routes
            _schema.subnets = cls._args_route_table_create.subnets
            _schema.tags = cls._args_route_table_create.tags
            return

        cls._args_route_table_create = AAZObjectArg()

        route_table_create = cls._args_route_table_create
        route_table_create.etag = AAZStrArg(
            options=["etag"],
            help="Gets a unique read-only string that changes whenever the resource is updated.",
        )
        route_table_create.id = AAZResourceIdArg(
            options=["id"],
            help="Resource Identifier.",
            fmt=AAZResourceIdArgFormat(
        ...
        route_table_create.location = AAZResourceLocationArg(
            options=["l", "location"],
            help="Resource location.",
            fmt=AAZResourceLocationArgFormat(
                resource_group_arg="resource_group",
        ...
        route_table_create.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
            help="The provisioning state of the resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.",
        )
        route_table_create.routes = AAZListArg(
            options=["routes"],
            help="Collection of routes contained within a route table.",
        )
        route_table_create.subnets = AAZListArg(
            options=["subnets"],
            help="A collection of references to subnets.",
        )
        route_table_create.tags = AAZDictArg(
            options=["tags"],
            help="Resource tags.",
        )

        routes = cls._args_route_table_create.routes
        routes.Element = AAZObjectArg()

        _element = cls._args_route_table_create.routes.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        ...
        subnets = cls._args_route_table_create.subnets
        subnets.Element = AAZObjectArg()
        cls._build_args_subnet_create(subnets.Element)

        tags = cls._args_route_table_create.tags
        tags.Element = AAZStrArg()
    ...
    def _build_args_subnet_create(cls, _schema):
        if cls._args_subnet_create is not None:
            ...
            _schema.provisioning_state = cls._args_subnet_create.provisioning_state
        ...
        subnet_create.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
        ...
        cls._build_args_route_table_create(subnet_create.route_table)
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_route_table_create(cls, _builder):
        if _builder is None:
            return
        _builder.set_prop("etag", AAZStrType, ".etag")
        _builder.set_prop("id", AAZStrType, ".id")
        ...
        routes = _builder.get(".properties.routes")
        if routes is not None:
            routes.set_elements(AAZObjectType, ".")

        _elements = _builder.get(".properties.routes[]")
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, ".etag")
            _elements.set_prop("id", AAZStrType, ".id")
            _elements.set_prop("name", AAZStrType, ".name")
        ...
        properties = _builder.get(".properties.routes[].properties")
        if properties is not None:
    ...
    def _build_schema_subnet_create(cls, _builder):
        ...
        if properties is not None:
            ...
            cls._build_schema_network_security_group_create(properties.set_prop("networkSecurityGroup", AAZObjectType, ".network_security_group"))
            properties.set_prop("provisioningState", AAZStrType, ".provisioning_state")
            cls._build_schema_route_table_create(properties.set_prop("routeTable", AAZObjectType, ".route_table"))
