...
examples:
  ...
  - name: Delete a virtual network link to the specified Private DNS zone. (autogenerated)
    text: az network private-dns link vnet delete --name MyLinkName --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: List the virtual network links to the specified Private DNS zone. (autogenerated)
    text: az network private-dns link vnet list --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Update a virtual network link's properties. Does not modify virtual network within the link. (autogenerated)
    text: az network private-dns link vnet update --name MyLinkName --registration-enabled true --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Add an A record. (autogenerated)
    text: az network private-dns record-set a add-record --ipv4-address MyIpv4Address --record-set-name MyRecordSet --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: List all A record sets in a zone. (autogenerated)
    text: az network private-dns record-set a list --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
  ...
  - name: List all "@" record sets within this zone.
    text: |
        az network private-dns record-set list -g MyResourceGroup -z www.mysite.com \\
            --query "[?name=='@']"
  - name: List all record sets within a Private DNS zone. (autogenerated)
    text: az network private-dns record-set list --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Delete a Private DNS zone. (autogenerated)
    text: az network private-dns zone delete --name www.mysite.com --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Get a Private DNS zone. (autogenerated)
    text: az network private-dns zone show --name www.mysite.com --resource-group MyResourceGroup
    crafted: true
"""
