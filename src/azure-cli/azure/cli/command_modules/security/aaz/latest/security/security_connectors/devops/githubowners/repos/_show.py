...
@register_command(
    "security security-connectors devops githubowners repos show",
    is_preview=True,
)
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GitHubReposGet(ctx=self.ctx)()
    ...
    class GitHubReposGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.parent_owner_name = AAZStrType(
                serialized_name="parentOwnerName",
            )
            ...
            properties.repo_full_name = AAZStrType(
                serialized_name="repoFullName",
                flags={"read_only": True},
            )
            ...
            properties.repo_name = AAZStrType(
                serialized_name="repoName",
                flags={"read_only": True},
            )
