...
register_cli_argument('subscriptiondefinition create', 'offer_type', options_list=('--offer_type', '-o'), required=True, help='The subscription\'s offer type.', completer=get_offer_type_completion_list)
