...
examples:
  - name: Validate whether a template is syntactically correct. (autogenerated)
    text: az deployment validate --location westus2 --parameters @myparameters.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  ...
  - name: List lock information in the resource-level. (autogenerated)
    text: az resource lock list --resource-group MyResourceGroup --resource-name myvnet --resource-type Microsoft.Network/virtualNetworks --subscription MySubscription
    crafted: true
"""
