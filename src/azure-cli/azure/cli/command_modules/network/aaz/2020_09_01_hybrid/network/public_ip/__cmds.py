...
class Create(AAZCommand):
    ...
    :example: Create a basic public IP resource.
        az network public-ip create -g MyResourceGroup -n MyIp

    :example: Create a static public IP resource for a DNS name label.
        az network public-ip create -g MyResourceGroup -n MyIp --dns-name MyLabel --allocation-method Static

    :example: Create a public IP resource in an availability zone in the current resource group region.
...
class List(AAZCommand):
    ...
    :example: List all public IPs in a subscription.
        az network public-ip list

    :example: List all public IPs in a resource group.
        az network public-ip list -g MyResourceGroup

    :example: List all public IPs of a domain name label.
...
@link_helper(
    __package__,
    ("_build_schema_application_security_group_read", _Helper),
    ("_build_schema_ip_configuration_read", _Helper),
    ("_build_schema_interface_endpoint_read", _Helper),
    ("_build_schema_network_interface_ip_configuration_read", _Helper),
    ("_build_schema_network_interface_tap_configuration_read", _Helper),
    ("_build_schema_network_interface_read", _Helper),
    ("_build_schema_network_security_group_read", _Helper),
    ("_build_schema_public_ip_address_read", _Helper),
    ("_build_schema_security_rule_read", _Helper),
    ("_build_schema_sub_resource_read", _Helper),
    ("_build_schema_subnet_read", _Helper),
    ("_build_schema_virtual_network_tap_read", _Helper),
)
class _CreateHelper:
