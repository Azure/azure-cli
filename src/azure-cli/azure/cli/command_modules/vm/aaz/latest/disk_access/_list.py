...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.DiskAccessesList(ctx=self.ctx)()
        if condition_1:
            self.DiskAccessesListByResourceGroup(ctx=self.ctx)()
    ...
    class DiskAccessesList(AAZHttpOperation):
    ...
    class DiskAccessesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
