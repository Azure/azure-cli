...
class Delete(AAZCommand):
    ...
    :example: Delete an ExpressRoute circuit connection. (autogenerated)
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpressRouteCircuitConnectionsDelete(ctx=self.ctx)()
        self.post_operations()
    ...
    class ExpressRouteCircuitConnectionsDelete(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
