...
class Assign(AAZCommand):
    ...
    :example: Assign AAD authentication to a virtual network gateway
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.audience = AAZStrArg(
            options=["--audience"],
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            return result.properties.vpnClientConfiguration

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.vpnClientConfiguration = value
            return
    ...
    class VirtualNetworkGatewaysGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_virtual_network_gateway_read(cls._schema_on_200)
    ...
    class VirtualNetworkGatewaysCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_virtual_network_gateway_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            _builder.set_prop("aadAudience", AAZStrType, ".audience")
            _builder.set_prop("aadIssuer", AAZStrType, ".issuer")
            _builder.set_prop("aadTenant", AAZStrType, ".tenant")
