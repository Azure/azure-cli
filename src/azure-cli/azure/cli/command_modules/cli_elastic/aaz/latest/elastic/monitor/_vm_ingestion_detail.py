...
class VmIngestionDetail(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VMIngestionDetails(ctx=self.ctx)()
    ...
    class VMIngestionDetails(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.cloud_id = AAZStrType(
...
class _VmIngestionDetailHelper:
    """Helper class for VmIngestionDetail"""


__all__ = ["VmIngestionDetail"]
