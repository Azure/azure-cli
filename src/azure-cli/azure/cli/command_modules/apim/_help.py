...
type: command
short-summary: Place the CLI in a waiting state until a condition of a Product is met.
examples:
  - name: Place the CLI in a waiting state until a condition of a Product is met.
    text: |
        az apim product wait --created -g MyResourceGroup -n MyApim --product-id MyProductId
    crafted: true
"""
...
helps['apim named-value wait'] = """
type: command
short-summary: Place the CLI in a waiting state until a condition of an apim Named Value is met.
examples:
  - name: Place the CLI in a waiting state until a condition of a apim is met.
    text: |
        az apim named-value wait --created -g MyResourceGroup -n MyApim --id MyNamedValueId
    crafted: true
"""
...
examples:
  - name: Create a revision for the specfic API.
    text: |-
        az apim api revision create -g MyResourceGroup -n MyApim --api-id MyApiId -r revisionId -d RevisionDescription
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a apim api schema is met.
    text: |
        az apim api schema wait --created -g MyResourceGroup -n MyApim -a MyApi -s MySchemaId
    crafted: true
"""
...
type: command
short-summary: Creates or updates the subscription of specified user to the specified product.
"""
...
type: command
short-summary: Deletes the specified subscription.
"""

helps['apim subscription update'] = """
type: command
short-summary: Updates the specified subscription.
"""

helps['apim subscription keys list'] = """
type: command
short-summary: Lists the subscription keys.
"""

helps['apim subscription show'] = """
type: command
short-summary: Gets the details of a subscription.
"""

helps['apim subscription keys regenerate'] = """
type: command
short-summary: Regenerates the subscription keys.
"""

helps['apim subscription regenerate-key'] = """
type: command
short-summary: Regenerates the primary or secondary subscription key
"""

helps['apim wait'] = """
type: command
short-summary: Waits for a command to complete for an API Management instance.
"""
