...
def load_arguments(self, _):
    ...
    with self.argument_context('container create') as c:
        ...
        c.argument('secure_environment_variables', nargs='+', type=_secure_environment_variables_type, help='A list of secure environment variable for the container. Space-separated values in \'key=value\' format. PowerShell and Windows Command Prompt users should use --file when values contain special characters.')
