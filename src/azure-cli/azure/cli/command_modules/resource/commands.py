...
def load_command_table(self, _):
    ...
    with self.command_group('stack mg', resource_deploymentstacks_sdk, resource_type=ResourceType.MGMT_RESOURCE_DEPLOYMENTSTACKS) as g:
        ...
        g.custom_command(
            'validate', 'validate_deployment_stack_at_management_group', supports_no_wait=True, validator=validate_deployment_stack_files)
    ...
    with self.command_group('stack sub', resource_deploymentstacks_sdk, resource_type=ResourceType.MGMT_RESOURCE_DEPLOYMENTSTACKS) as g:
        ...
        g.custom_command(
            'validate', 'validate_deployment_stack_at_subscription', supports_no_wait=True, validator=validate_deployment_stack_files)
    ...
    with self.command_group('stack group', resource_deploymentstacks_sdk, resource_type=ResourceType.MGMT_RESOURCE_DEPLOYMENTSTACKS) as g:
        ...
        g.custom_command(
            'validate', 'validate_deployment_stack_at_resource_group', supports_no_wait=True, validator=validate_deployment_stack_files)
