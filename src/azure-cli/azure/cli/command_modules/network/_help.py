...
examples:
  - name: List application gateway WAF policy custom rules. (autogenerated)
    text: az network application-gateway waf-policy custom-rule list --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List application gateway WAF policy custom rule match conditions. (autogenerated)
    text: az network application-gateway waf-policy custom-rule match-condition list --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update an application gateway WAF policy. (autogenerated)
    text: |
        ...
        --name MyApplicationGatewayWAFPolicy \\
        --remove tags.no_80 \\
        --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update an inbound NAT rule. (autogenerated)
    text: |
        ...
        --name MyNatRule \\
        --resource-group MyResourceGroup \\
        --set tags.CostCenter=MyBusinessGroup
    crafted: true
"""
