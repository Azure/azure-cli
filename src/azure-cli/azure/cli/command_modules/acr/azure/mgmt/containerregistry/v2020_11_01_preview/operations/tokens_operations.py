...
class TokensOperations(object):
    ...
    def get(
        ...
        :rtype: ~containerregistry.models.Token or
    ...
    def create(
        ...
        :type token_create_parameters: ~containerregistry.models.Token
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~containerregistry.models.Token]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~containerregistry.models.Token]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :type token_update_parameters:
         ~containerregistry.models.TokenUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def list(
        ...
        :rtype:
         ~containerregistry.models.TokenPaged[~containerregistry.models.Token]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
