...
class Run(ProxyResource):
    ...
    :param git_commit_trigger: The git commit trigger that caused the run.
    ...
    def __init__(self, run_id=None, status=None, last_updated_time=None, run_type=None, create_time=None, start_time=None, finish_time=None, output_images=None, task=None, image_update_trigger=None, git_commit_trigger=None, is_archive_enabled=False, platform=None, agent_configuration=None, provisioning_state=None):
