...
@register_command(
    "network express-route-cross-connection peering update",
)
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_express_route_circuit_peering_config_update(_args_schema.microsoft_peering_config)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                _UpdateHelper._build_schema_express_route_circuit_peering_config_update(properties.set_prop("microsoftPeeringConfig", AAZObjectType, ".microsoft_peering_config"))
...
class _UpdateHelper:
    ...
    def _build_schema_express_route_cross_connection_peering_read(cls, _schema):
        ...
        ipv6_peering_config = _schema_express_route_cross_connection_peering_read.properties.ipv6_peering_config
        ...
        route_filter = _schema_express_route_cross_connection_peering_read.properties.ipv6_peering_config.route_filter
