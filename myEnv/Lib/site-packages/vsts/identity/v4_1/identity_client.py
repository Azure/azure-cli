...
class IdentityClient(VssClient):
    ...
    def create_or_bind_with_claims(self, source_identity):
        ...
        [Preview API]
        :param :class:`<Identity> <identity.v4_1.models.Identity>` source_identity:
        :rtype: :class:`<Identity> <identity.v4_1.models.Identity>`
        """
    ...
    def get_descriptor_by_id(self, id, is_master_id=None):
        ...
        :rtype: :class:`<str> <identity.v4_1.models.str>`
        """
        route_values = {}
        if id is not None:
    ...
    def create_groups(self, container):
        """CreateGroups.
        :param :class:`<object> <identity.v4_1.models.object>` container:
        :rtype: [Identity]
        """
    ...
    def get_identity_changes(self, identity_sequence_id, group_sequence_id, scope_id=None):
        ...
        :param str scope_id:
        :rtype: :class:`<ChangedIdentities> <identity.v4_1.models.ChangedIdentities>`
        """
        query_parameters = {}
    ...
    def update_identities(self, identities):
        """UpdateIdentities.
        :param :class:`<VssJsonCollectionWrapper> <identity.v4_1.models.VssJsonCollectionWrapper>` identities:
    ...
    def update_identity(self, identity, identity_id):
        """UpdateIdentity.
        :param :class:`<Identity> <identity.v4_1.models.Identity>` identity:
        :param str identity_id:
        """
        route_values = {}
        if identity_id is not None:
    ...
    def create_identity(self, framework_identity_info):
        """CreateIdentity.
        :param :class:`<FrameworkIdentityInfo> <identity.v4_1.models.FrameworkIdentityInfo>` framework_identity_info:
        :rtype: :class:`<Identity> <identity.v4_1.models.Identity>`
        """
    ...
    def read_identity_batch(self, batch_info):
        """ReadIdentityBatch.
        [Preview API]
        :param :class:`<IdentityBatchInfo> <identity.v4_1.models.IdentityBatchInfo>` batch_info:
        :rtype: [Identity]
        """
    ...
    def get_identity_snapshot(self, scope_id):
        ...
        [Preview API]
        :param str scope_id:
        :rtype: :class:`<IdentitySnapshot> <identity.v4_1.models.IdentitySnapshot>`
        """
        route_values = {}
        if scope_id is not None:
    ...
    def get_self(self):
        ...
        :rtype: :class:`<IdentitySelf> <identity.v4_1.models.IdentitySelf>`
        """
        response = self._send(http_method='GET',
    ...
    def create_scope(self, info, scope_id):
        """CreateScope.
        [Preview API]
        :param :class:`<CreateScopeInfo> <identity.v4_1.models.CreateScopeInfo>` info:
        :param str scope_id:
        :rtype: :class:`<IdentityScope> <identity.v4_1.models.IdentityScope>`
        """
        route_values = {}
        if scope_id is not None:
            route_values['scopeId'] = self._serialize.url('scope_id', scope_id, 'str')
    ...
    def rename_scope(self, rename_scope, scope_id):
        """RenameScope.
        [Preview API]
        :param :class:`<IdentityScope> <identity.v4_1.models.IdentityScope>` rename_scope:
        :param str scope_id:
        """
        route_values = {}
        if scope_id is not None:
    ...
    def get_signed_in_token(self):
        """GetSignedInToken.
        [Preview API]
        :rtype: :class:`<AccessTokenResult> <identity.v4_1.models.AccessTokenResult>`
        """
        response = self._send(http_method='GET',
    ...
    def get_tenant(self, tenant_id):
        ...
        [Preview API]
        :param str tenant_id:
        :rtype: :class:`<TenantInfo> <identity.v4_1.models.TenantInfo>`
        """
        route_values = {}
