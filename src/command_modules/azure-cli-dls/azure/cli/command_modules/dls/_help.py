...
examples:
  - name: Creates a Data Lake Store account. (autogenerated)
    text: |-
        az dls account create --account "{Data Lake Store Account Name}" --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Remove the access control list for a file or folder. (autogenerated)
    text: az dls fs access remove-all --account mydatalakestoragegen1 --default-acl --path /mynewfolder
    crafted: true
"""
...
examples:
  - name: Append content to a file in a Data Lake Store account. (autogenerated)
    text: az dls fs append --account mydatalakestoragegen1 --content {content} --path /mynewfolder
    crafted: true
"""
...
examples:
  - name: Join files in a Data Lake Store account into one file. (autogenerated)
    text: |-
        az dls fs join --account mydatalakestoragegen1 --destination-path "/mynewfolder/vehicle1_09142014.csv" --source-paths {source-paths}
    crafted: true
"""
