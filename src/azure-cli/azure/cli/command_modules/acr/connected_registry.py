...
def acr_connected_registry_delete(cmd,
    ...
    try:
        ...
        if cleanup:
            ...
            acr_token_delete(cmd, token_client, registry_name, sync_token_name, yes, resource_group_name).result()
            acr_scope_map_delete(cmd, scope_map_client, registry_name, sync_scope_map_name, yes, resource_group_name).result()
