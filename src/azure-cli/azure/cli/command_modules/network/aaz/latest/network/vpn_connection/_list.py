...
class List(AAZCommand):
    ...
    class VirtualNetworkGatewayConnectionsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            certificate_authentication = cls._schema_on_200.value.Element.properties.certificate_authentication
            ...
            inbound_auth_certificate_chain = cls._schema_on_200.value.Element.properties.certificate_authentication.inbound_auth_certificate_chain
            inbound_auth_certificate_chain.Element = AAZStrType()

            egress_nat_rules = cls._schema_on_200.value.Element.properties.egress_nat_rules
            egress_nat_rules.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(egress_nat_rules.Element)
            ...
            ingress_nat_rules = cls._schema_on_200.value.Element.properties.ingress_nat_rules
            ingress_nat_rules.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(ingress_nat_rules.Element)
            ...
            tunnel_properties = cls._schema_on_200.value.Element.properties.tunnel_properties
            tunnel_properties.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.tunnel_properties.Element
