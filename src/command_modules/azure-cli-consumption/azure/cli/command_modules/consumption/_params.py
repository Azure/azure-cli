...
def load_arguments(self, _):
    ...
    with self.argument_context('consumption reservations summaries list') as rs:
        rs.argument('reservationorderid', options_list=['--reservationorderid', '-roid'],help='Reservation order id')
        rs.argument('reservationid', options_list=['--reservationid', '-rid'], help='Reservation id')
    ...
    with self.argument_context('consumption reservations details list') as rd:
        rd.argument('reservationorderid', options_list=['--reservationorderid', '-roid'],help='Reservation order id')
        rd.argument('reservationid', options_list=['--reservationid', '-rid'], help='Reservation id')
