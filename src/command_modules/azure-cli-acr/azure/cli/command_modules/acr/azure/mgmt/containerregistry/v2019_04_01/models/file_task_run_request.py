...
class FileTaskRunRequest(RunRequest):
    ...
    :type type: str
    :param task_file_path: The template/definition file path relative to the
     source.
    ...
    def __init__(self, task_file_path, platform, is_archive_enabled=False, values_file_path=None, values=None, timeout=3600, agent_configuration=None, source_location=None, credentials=None):
        super(FileTaskRunRequest, self).__init__(is_archive_enabled=is_archive_enabled)
