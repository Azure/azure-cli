...
examples:
  - name: Delete an event hub consumer group. (autogenerated)
    text: |
        az iot hub consumer-group delete --hub-name MyHub --name MyEventHubConsumerGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Cancel a job in an IoT hub. (autogenerated)
    text: |
        az iot hub job cancel --hub-name MyHub --job-id JobId
    crafted: true
"""
...
examples:
  - name: List the jobs in an IoT hub. (autogenerated)
    text: |
        az iot hub job list --hub-name MyHub
    crafted: true
"""
...
examples:
  - name: Get the details of a job in an IoT hub. (autogenerated)
    text: |
        az iot hub job show --hub-name MyHub --job-id JobId
    crafted: true
"""
