...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/subvolumes", "2025-06-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SubvolumesListByVolume(ctx=self.ctx)()
    ...
    class SubvolumesListByVolume(AAZHttpOperation):
