...
def load_arguments(self, _):
    ...
    with self.argument_context('appconfig kv export') as c:
        ...
        c.argument('snapshot', help="Export all keys in a given snapshot of the App Configuration store. If no snapshot is specified, the keys currently in the store are exported based on the specified key and label filters.", is_preview=True)
