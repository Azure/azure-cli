...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr helm install-cli') as c:
        ...
        c.argument('install_location', help='File path at which to install Helm CLI (Existing one at the same path will be overwritten)', default=_get_helm_default_install_location())
