...
from .v7_3_preview.version import VERSION as v7_3_PREVIEW_VERSION
...
class KeyVaultClient(MultiApiClientMixin):
    ...
    Implementation depends on the API version:
         ...
         * 2016-10-01: :class:`v2016_10_01.KeyVaultClient<.v2016_10_01.KeyVaultClient>`
    ...
    def models(self):
        """Module depends on the API version:
            * 2016-10-01: :mod:`v2016_10_01.models<.v2016_10_01.models>`
            * 7.0: :mod:`v7_0.models<.v7_0.models>`
         """
        ...
        if api_version == v7_0_VERSION:
            ...
            from .v7_3_preview import models as implModels
    ...
    def _create_client_impl(self, api_version):
        ...
        if api_version == v7_0_VERSION:
            ...
            from .v7_3_preview import KeyVaultClient as ImplClient
        elif api_version == v2016_10_01_VERSION:
