...
examples:
  ...
  - name: List the Tasks within a Project. Some tasks may have a status of Unknown, which indicates that an error occurred while querying the status of that task. (autogenerated)
    text: az dms project task list --project-name myproject --resource-group myresourcegroup --service-name mydms
    crafted: true
"""
