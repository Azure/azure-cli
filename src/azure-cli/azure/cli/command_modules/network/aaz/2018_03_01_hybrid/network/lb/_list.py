...
class List(AAZCommand):
    ...
    class LoadBalancersList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            inbound_nat_pools = cls._schema_on_200.value.Element.properties.frontend_ip_configurations.Element.properties.inbound_nat_pools
            inbound_nat_pools.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(inbound_nat_pools.Element)

            inbound_nat_rules = cls._schema_on_200.value.Element.properties.frontend_ip_configurations.Element.properties.inbound_nat_rules
            inbound_nat_rules.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(inbound_nat_rules.Element)

            load_balancing_rules = cls._schema_on_200.value.Element.properties.frontend_ip_configurations.Element.properties.load_balancing_rules
            load_balancing_rules.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(load_balancing_rules.Element)

            outbound_nat_rules = cls._schema_on_200.value.Element.properties.frontend_ip_configurations.Element.properties.outbound_nat_rules
            outbound_nat_rules.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(outbound_nat_rules.Element)

            zones = cls._schema_on_200.value.Element.properties.frontend_ip_configurations.Element.zones
            ...
            outbound_nat_rules = cls._schema_on_200.value.Element.properties.outbound_nat_rules
            outbound_nat_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.outbound_nat_rules.Element
            _element.etag = AAZStrType()
            _element.id = AAZStrType()
            _element.name = AAZStrType()
            _element.properties = AAZObjectType(
            ...
            properties = cls._schema_on_200.value.Element.properties.outbound_nat_rules.Element.properties
            ...
            frontend_ip_configurations = cls._schema_on_200.value.Element.properties.outbound_nat_rules.Element.properties.frontend_ip_configurations
            frontend_ip_configurations.Element = AAZObjectType()
