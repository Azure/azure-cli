...
class UsageMetricOperations(object):
    """UsageMetricOperations operations.
    ...
    def list(
        ...
        :param api_version: The resource provider api version.
        :type api_version: str
        :param filter: The odata filter string to use in the query
        :type filter: str
        ...
        :rtype: :class:`UsageMetricPaged <insights.models.UsageMetricPaged>`
        """
