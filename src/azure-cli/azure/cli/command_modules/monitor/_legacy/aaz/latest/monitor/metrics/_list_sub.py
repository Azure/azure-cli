...
class ListSub(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.filter = AAZStrArg(
            options=["--filter"],
            arg_group="Body",
            help="The **$filter** is used to reduce the set of metric data returned.<br>Example:<br>Metric contains metadata A, B and C.<br>- Return all time series of C where A = a1 and B = b1 or b2<br>**$filter=A eq ΓÇÿa1ΓÇÖ and B eq ΓÇÿb1ΓÇÖ or B eq ΓÇÿb2ΓÇÖ and C eq ΓÇÿ*ΓÇÖ**<br>- Invalid variant:<br>**$filter=A eq ΓÇÿa1ΓÇÖ and B eq ΓÇÿb1ΓÇÖ and C eq ΓÇÿ*ΓÇÖ or B = ΓÇÿb2ΓÇÖ**<br>This is invalid because the logical or operator cannot separate two different metadata names.<br>- Return all time series where A = a1, B = b1 and C = c1:<br>**$filter=A eq ΓÇÿa1ΓÇÖ and B eq ΓÇÿb1ΓÇÖ and C eq ΓÇÿc1ΓÇÖ**<br>- Return all time series where A = a1<br>**$filter=A eq ΓÇÿa1ΓÇÖ and B eq ΓÇÿ*ΓÇÖ and C eq ΓÇÿ*ΓÇÖ**.",
        )
