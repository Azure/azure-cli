...
class Create(AAZCommand):
    ...
    :example: Create a redirect configuration to a http-listener called MyBackendListener.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the redirect configuration.",
            required=True,
        )
        _args_schema.include_path = AAZBoolArg(
            options=["--include-path"],
            help="Whether to include path in the redirected url.",
        )
        _args_schema.include_query_string = AAZBoolArg(
            options=["--include-query-string"],
            help="Whether to include query string in the redirected url.",
        )
        ...
        _args_schema.target_listener = AAZStrArg(
            options=["--target-listener"],
            help="Name or ID of the HTTP listener to redirect the request to.",
        )
        _args_schema.target_url = AAZStrArg(
            options=["--target-url"],
            help="URL to redirect the request to.",
        )

        # define Arg Group "Parameters.properties.redirectConfigurations[]"
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.redirectConfigurations
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("redirectType", AAZStrType, ".type")
                properties.set_prop("targetListener", AAZObjectType)
                properties.set_prop("targetUrl", AAZStrType, ".target_url")

            target_listener = _builder.get(".properties.targetListener")
            if target_listener is not None:
                target_listener.set_prop("id", AAZStrType, ".target_listener")
