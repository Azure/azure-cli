...
class WebappQuickCreateTest(ScenarioTest):
    ...
    def test_linux_webapp_quick_create(self, resource_group, resource_group_location):
        ...
        self.cmd('webapp create -g {} -n {} --plan {} -i derekbekoe/commute-frontend:0.3 --settings COMMUTE_API=https://api_app_name.azurewebsites.net'.format(resource_group, webapp_name, plan))
        import time
