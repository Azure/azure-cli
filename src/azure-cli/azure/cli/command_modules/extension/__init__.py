...
class ExtensionCommandsLoader(AzCommandsLoader):
    ...
    def load_arguments(self, command):
        ...
        with self.argument_context('extension') as c:
            ...
            c.argument('allow_preview', options_list=['--allow-preview'], default=False, arg_type=get_three_state_flag(), help="Include preview packages for extension installation, if exists")
