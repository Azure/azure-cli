...
@register_command(
    "netappfiles volume finalize-relocation",
)
class FinalizeRelocation(AAZCommand):
    """Finalizes the relocation of the volume and cleans up the old volume.

    :example: Finalizes the relocation of the volume and cleans up the old volume
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/finalizerelocation", "2025-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesFinalizeRelocation(ctx=self.ctx)()
    ...
    class VolumesFinalizeRelocation(AAZHttpOperation):
...
class _FinalizeRelocationHelper:
    """Helper class for FinalizeRelocation"""


__all__ = ["FinalizeRelocation"]
