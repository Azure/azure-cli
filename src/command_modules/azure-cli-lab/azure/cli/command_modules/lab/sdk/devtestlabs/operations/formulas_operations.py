...
class FormulasOperations(object):
    ...
    def list(
        ...
        :rtype: :class:`FormulaPaged <devtestlabs.models.FormulaPaged>`
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`Formula <devtestlabs.models.Formula>`
    ...
    def create_or_update(
        ...
        :type formula: :class:`Formula <devtestlabs.models.Formula>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
         :class:`AzureOperationPoller<msrestazure.azure_operation.AzureOperationPoller>`
         instance that returns :class:`Formula <devtestlabs.models.Formula>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
