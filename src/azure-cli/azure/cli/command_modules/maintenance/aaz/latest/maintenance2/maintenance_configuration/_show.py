...
@register_command(
    "maintenance2 maintenance-configuration show",
)
class Show(AAZCommand):
    ...
    class MaintenanceConfigurationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_task_properties_read(post_tasks.Element)

            pre_tasks = cls._schema_on_200.properties.install_patches.tasks.pre_tasks
            pre_tasks.Element = AAZObjectType()
            _ShowHelper._build_schema_task_properties_read(pre_tasks.Element)
