...
def _get_load_balancer_outbound_ips(cmd, load_balancer_outbound_ips, models):
...
def _get_load_balancer_outbound_ip_prefixes(cmd, load_balancer_outbound_ip_prefixes, models):
