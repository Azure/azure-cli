...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr import') as c:
        ...
        c.argument('source_registry_username', options_list=['--source-username', '-su'], help='The username of source container registry')
        c.argument('source_registry_password', options_list=['--source-password', '-sp'], help='The password of source container registry')
