...
type: command
short-summary: List details for all service providers available for creating OAuth
    connection settings.
examples:
...
-   name: Create a new bot.
    text: az bot create --version v3 --insights-location East US --location westus2
        --name MyResourceBot --kind function --resource-group MyResourceGroup
    crafted: 'True'
"""
...
type: command
short-summary: Add scripts to your local source code directory to be able to publish
    back using `az bot publish`.
"""
...
-   name: Publish to a bot's associated app service.
    text: az bot publish --resource-group MyResourceGroup --name botName
    crafted: 'True'
"""
...
long-summary: Get information about an existing bot. To get the information needed
    to connect to the bot, use the --msbot flag with the command.
examples:
-   name: Get the information needed to connect to an existing bot on Azure
    text: |-
        az bot show -n botName -g MyResourceGroup --msbot
-   name: Get an existing bot.
    text: az bot show --name MyResourceBot --resource-group MyResourceGroup
    crafted: 'True'
"""
