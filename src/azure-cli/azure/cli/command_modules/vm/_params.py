...
def load_arguments(self, _):
    ...
    with self.argument_context('vm availability-set create') as c:
        ...
        c.argument('enable_all_instance_down', options_list=['--all-instance-down', '--enable-all-instance-down'], arg_type=get_three_state_flag(), min_api='2025-04-01', help='Specify if Scheduled Events should be auto-approved when all instances are down. Its default value is true.')
        c.argument('scheduled_events_api_version', options_list=['--se-api-version', '--scheduled-events-api-version'], min_api='2025-04-01', help='Specify the api-version to determine which Scheduled Events configuration schema version will be delivered.')
    # endregion
