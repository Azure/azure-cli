...
from azure.cli.command_modules.network.aaz.latest.network.watcher.connection_monitor.test_configuration._remove import Remove as _MonitorTestConfigurationRemove
