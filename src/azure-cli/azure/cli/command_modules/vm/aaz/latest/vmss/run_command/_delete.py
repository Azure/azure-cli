...
class Delete(AAZCommand):
    ...
    :example: Delete a VMSS run command.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualMachineScaleSetVMRunCommandsDelete(ctx=self.ctx)()
    ...
    class VirtualMachineScaleSetVMRunCommandsDelete(AAZHttpOperation):
