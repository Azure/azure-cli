...
class StreamingLocatorsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~encoding.models.StreamingLocatorPaged[~encoding.models.StreamingLocator]
    ...
    def get(
        ...
        :rtype: ~encoding.models.StreamingLocator or
    ...
    def create(
        ...
        :type parameters: ~encoding.models.StreamingLocator
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_content_keys(
        ...
        :rtype: ~encoding.models.ListContentKeysResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`ApiErrorException<encoding.models.ApiErrorException>`
        """
        # Construct URL
    ...
    def list_paths(
        ...
        :rtype: ~encoding.models.ListPathsResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`ApiErrorException<encoding.models.ApiErrorException>`
        """
        # Construct URL
