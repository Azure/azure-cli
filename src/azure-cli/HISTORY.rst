...
* `az bicep build`: Fix #22621: `--stdout` does not work (#22685)
...
* `az sig`: Add new command `show-community` to support listing image versions in community gallery (#21480)
* `az sig image-definition`: Add new command `show-community` to support getting an image in a gallery community (#21480)
* `az sig image-definition`: Add new command `list-community` to support listing VM Image definitions in a gallery community (#21480)
* `az sig image-version`: Add new command ` show-community` to support getting an image version in a gallery community (#21480)
* `az sig image-version `: Add new command `list-community` to support listing VM image versions in a gallery community (#21480)
* `az sig share`: Add new command `enable-community` to support sharing gallery to community (#21480)
* `az sig gallery-application version`: Add new parameters `--package-file-name` to specify the downloaded package file on the VM (#22857)
* `az sig gallery-application version`: Add new parameters `--config-file-name` to specify the downloaded config file on the VM (#22857)
* `az disk create`: `--gallery-image-reference` adds support for creating disk from shared gallery image version or community gallery image version (#22756)
* `az disk create`: `--source` add support for creating a disk from disk restore point (#22898)
...
* `az vm/vmss create`: `--security-type` supports new value `ConfidentialVM` for Confidential VM (#22650)
