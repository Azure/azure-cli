...
examples:
  - name: Show the details of an Azure Media Services account. (autogenerated)
    text: az ams account show --name MyAzureMediaServicesAccount
    crafted: true
"""
...
examples:
  - name: Delete an asset. (autogenerated)
    text: az ams asset delete --account-name MyAccount --name MyAsset
    crafted: true
"""
...
examples:
  ...
  - name: List all the assets of an Azure Media Services account. (autogenerated)
    text: az ams asset list --account-name amsAccount --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Update the details of an asset. (autogenerated)
    text: az ams asset update --account-name MyAccount --name MyAsset --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: List all the jobs of a transform within an Azure Media Services account. (autogenerated)
    text: az ams job list --account-name amsAccount --resource-group resourceGroup --transform-name transformName
    crafted: true
"""
...
examples:
  ...
  - name: List all the live events of an Azure Media Services account. (autogenerated)
    text: az ams live-event list --account-name amsAccount --resource-group resourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update the details of a live event. (autogenerated)
    text: az ams live-event update --account-name amsAccount --ips 1.2.3.4/22 5.6.7.8/30 --name liveEventName --resource-group resourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint show --account-name MyAccount --name MyStreamingEndpoint
    crafted: true
"""
