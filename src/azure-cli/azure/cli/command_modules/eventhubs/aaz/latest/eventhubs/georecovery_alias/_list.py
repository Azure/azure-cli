...
@register_command(
    "eventhubs georecovery-alias list",
)
class List(AAZCommand):
    """List all Alias(Disaster Recovery configurations)

    :example: EHAliasList
        az eventhubs georecovery-alias list --resource-group exampleResourceGroup --namespace-name sdk-Namespace-8859
    """

    _aaz_info = {
        "version": "2026-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.eventhub/namespaces/{}/disasterrecoveryconfigs", "2026-07-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DisasterRecoveryConfigsList(ctx=self.ctx)()
    ...
    class DisasterRecoveryConfigsList(AAZHttpOperation):
