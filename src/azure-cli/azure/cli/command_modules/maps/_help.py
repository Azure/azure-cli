...
me}/providers/Microsoft.Storage/accounts/{storageName}'.
    ...
    examples:
      - name: Create Account with Managed Identities
        text: |-
               az maps account create --type "SystemAssigned, UserAssigned" --user-assigned-identities \
"{\\"/subscriptions/21a9967a-e8a9-4656-a70b-96ff1c4d05a0/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIden\
tity/userAssignedIdentities/identityName\\":{}}" --kind "Gen2" --location "eastus" --disable-local-auth false \
...
--resource-group "myResourceGroup"
      - name: Create Gen1 Account
        text: |-
               az maps account create --kind "Gen1" --location "global" --disable-local-auth false --sku "S0" --tags \
test="true" --account-name "myMapsAccount" --resource-group "myResourceGroup"
      - name: Create Gen2 Account
        text: |-
               az maps account create --kind "Gen2" --location "global" --disable-local-auth true --sku "G2" --tags \
test="true" --account-name "myMapsAccount" --resource-group "myResourceGroup"
"""
...
helps['maps account delete'] = """
    ...
    examples:
      - name: DeleteAccount
        text: |-
               az maps account delete --account-name "myMapsAccount" --resource-group "myResourceGroup"
"""
...
examples:
  - name: List the keys to use with the Maps APIs (autogenerated)
    text: az maps account keys list --account-name MyMapsAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Show the details of a maps account. (autogenerated)
    text: az maps account show --account-name MyMapsAccount --resource-group MyResourceGroup
    crafted: true
"""
...
me}/providers/Microsoft.Storage/accounts/{storageName}'.
    ...
    examples:
      - name: Update Account Managed Identities
        text: |-
               az maps account update --type "SystemAssigned, UserAssigned" --user-assigned-identities \
"{\\"/subscriptions/21a9967a-e8a9-4656-a70b-96ff1c4d05a0/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIden\
...
t" --name "G2" --account-name "myMapsAccount" --resource-group "myResourceGroup"
...
"myResourceGroup"
      - name: Update to Gen1 Account
        text: |-
               az maps account update --kind "Gen1" --sku "S1" --account-name "myMapsAccount" --resource-group \
"myResourceGroup"
      - name: Update to Gen2 Account
        text: |-
               az maps account update --kind "Gen2" --sku "G2" --account-name "myMapsAccount" --resource-group \
"myResourceGroup"
"""
...
Maps REST APIs. Only one key is needed at a time; two are given to provide seamless key regeneration."
    examples:
      - name: Keys List
        text: |-
               az maps account keys list --account-name "myMapsAccount" --resource-group "myResourceGroup"
"""
...
working immediately."
    examples:
      - name: Keys Renew
        text: |-
               az maps account keys renew --account-name "myMapsAccount" --key "primary" --resource-group \
"myResourceGroup"
"""
