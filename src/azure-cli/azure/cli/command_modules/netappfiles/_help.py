...
examples:
  ...
  - name: List the mount targets of an Azure NetApp Files (ANF) volume (autogenerated)
    text: az netappfiles list-mount-targets --account-name myaccname --pool-name mypoolname --resource-group mygroup --volume-name myvolname
    crafted: true
"""
...
examples:
  ...
  - name: Get the specified ANF pool (autogenerated)
    text: az netappfiles pool show --account-name myaccname --pool-name mypoolname --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a new Azure NetApp Files (ANF) snapshot. (autogenerated)
    text: az netappfiles snapshot create --account-name myaccname --location eastus --pool-name mypoolname --resource-group mygroup --snapshot-name mysnapname --volume-name myvolname
    crafted: true
"""
...
examples:
  ...
  - name: Add a new rule to the export policy for a volume. (autogenerated)
    text: |
        az netappfiles volume export-policy add --account-name myaccname --allowed-clients "1.2.3.0/24" --cifs true --nfsv3 true --nfsv4 true --pool-name mypoolname --resource-group mygroup --rule-index 2 --unix-read-only true --unix-read-write true --volume-name myvolname
    crafted: true
"""
