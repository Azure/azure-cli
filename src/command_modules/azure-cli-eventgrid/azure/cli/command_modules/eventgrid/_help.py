...
-   "name": |-
        Create a new event subscription for an Event Grid topic or for an Azure resource.
    "text": |-
        az eventgrid event-subscription create --max-delivery-attempts <max-delivery-attempts> --event-delivery-schema cloudeventv01schema --endpoint https://contoso.azurewebsites.net/api/f1?code=code --name es2
    "crafted": |-
        True
"""
...
-   "name": |-
        Get the details of an event subscription.
    "text": |-
        az eventgrid event-subscription show --name es1 --include-full-endpoint-url false --topic-name topic1 --resource-group rg1
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az eventgrid topic show --ids /subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/kalstest/providers/Microsoft.EventGrid/topics/topic1
"""
...
-   "name": |-
    ...
    "text": |-
        az eventgrid topic update -g rg1 --name topic1 --tags Dept=IT
"""
