...
examples:
  - name: Update a task for an Azure Container Registry. (autogenerated)
    text: az acr task update --base-image-trigger-enabled true --commit-trigger-enabled true --context https://github.com/Azure-Samples/acr-build-helloworld-node.git --file Dockerfile --git-access-token 000000000000000000000000000000000 --image MyImage --name MyTask --platform Windows --registry MyRegistry
    crafted: true
"""
...
examples:
  - name: Generate or replace one or both passwords of a token for an Azure Container Registry (autogenerated)
    text: az acr token credential generate --name MyToken --password1 --registry MyRegistry --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List recent events for a webhook. (autogenerated)
    text: az acr webhook list-events --name MyWebhook --registry MyRegistry --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Update a route in IoT Hub. (autogenerated)
    text: az iot hub route update --condition true --endpoint-name myendpoint --hub-name MyIotHub --resource-group MyResourceGroup --route-name R1 --source-type invalid
    crafted: true
  - name: Update a route in IoT Hub. (autogenerated)
...
examples:
  - name: Delete a Kusto cluster. (autogenerated)
    text: az kusto cluster delete --name mycluster --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: Create a workspace instance. (autogenerated)
    text: az monitor log-analytics workspace create --location westus2 --resource-group MyResourceGroup --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy. (autogenerated)
    ...
    crafted: true
  - name: Update an application gateway WAF policy. (autogenerated)
    text: az network application-gateway waf-policy update --name MyApplicationGatewayWAFPolicy --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  - name: Update a TXT record set. (autogenerated)
    text: az network dns record-set txt update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: List all endpoints form a connection monitor. (autogenerated)
    text: az network watcher connection-monitor endpoint list --connection-monitor MyConnectionMonitor --location westus2 --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Cancel a deployment at resource group. (autogenerated)
    text: az deployment group cancel --name deployment01 --resource-group testrg --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List the replicas of a database and their replication status. (autogenerated)
    text: az sql db replica list-links --name MyAzureSQLDatabase --resource-group MyResourceGroup --server myserver --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Copy multiple files or blobs to a file share. (autogenerated)
    text: az storage file copy start-batch --account-key 00000000 --account-name destaccount --destination-share destshare --pattern *.py --source-account-name srcaccount --source-share srcshare
    crafted: true
"""
...
examples:
  - name: Delete a file system in ADLS Gen2 account. (autogenerated)
    text: az storage fs delete --account-name myadlsaccount --auth-mode login --name myfilesystem --yes
    crafted: true
"""
...
examples:
  - name: List directories in ADLS Gen2 file system (autogenerated)
    text: az storage fs directory list --account-key 0000-0000 --account-name myadlsaccount --file-system myfilesystem --path dir --recursive true
    crafted: true
"""
...
examples:
  - name: Show metrics settings for a storage account. (autogenerated)
    text: az storage metrics show --account-key 00000000 --account-name MyAccount --subscription mysubscription
    crafted: true
"""
