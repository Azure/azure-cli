...
for scope in ['vm create', 'vmss create']:
    ...
    register_cli_argument(scope, 'validate', options_list=('--validate', '-v'), help='Generate and validate the ARM template without creating any resources.', action='store_true')
