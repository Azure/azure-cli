...
def load_arguments(self, _):
    ...
    with self.argument_context('alertsmanagement alert list') as c:
        ...
        c.argument('select', options_list=['--select'], required=False, help='Project the required fields out of essentials. Expected input is comma-separated. ')
    ...
    with self.argument_context('alertsmanagement alert list-summary') as c:
        c.argument('groupby', options_list=['--group-by'], required=True, help='Supported values – severity, alertState, monitorCondition, monitorService, signalType, alertRule')
    ...
    with self.argument_context('alertsmanagement action-rule list') as c:
        ...
        c.argument('severity', severity_arg_type, required=False)
        c.argument('monitor_service', monitor_service_arg_type, required=False)
        c.argument('impacted_scope', options_list=['--impacted-scope'], required=False, help='Gets all actions rules in a subscription filter by impacted scope')
    ...
    with self.argument_context('alertsmanagement action-rule set') as c:
        ...
        c.argument('action_rule', options_list=['--action-rule'], required=True, help='Action rule json defining scope and conditions')
