...
class Delete(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.sql/servers/{}", "2023-05-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ServersDelete(ctx=self.ctx)()
    ...
    class ServersDelete(AAZHttpOperation):
