...
class TestVMCreateDefaultVnet(unittest.TestCase):
    ...
    @mock.patch('azure.cli.command_modules.vm.aaz.2018_03_01_hybrid.network.vnet.List', _mock_network_client_with_existing_vnet)
    ...
    @mock.patch('azure.cli.command_modules.vm.aaz.2018_03_01_hybrid.network.vnet.List', _mock_network_client_with_existing_vnet_location)
...
class TestVMSSCreateDefaultVnet(unittest.TestCase):
    ...
    @mock.patch('azure.cli.command_modules.vm.aaz.2018_03_01_hybrid.network.vnet.List', _mock_network_client_with_existing_subnet)
