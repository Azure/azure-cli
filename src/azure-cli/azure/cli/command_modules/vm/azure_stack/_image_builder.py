...
from azure.cli.command_modules.vm.azure_stack._client_factory import _compute_client_factory
from azure.cli.command_modules.vm.azure_stack._validators import _get_resource_id
