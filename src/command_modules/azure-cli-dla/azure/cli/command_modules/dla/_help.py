...
examples:
  - name: Update a Data Lake Analytics account
    text: |-
...
examples:
  - name: Submit a job to a Data Lake Analytics account. (autogenerated)
    text: |-
        az dla job submit --account "{Data Lake Analytics account name}" --job-name MyJob --script "{Script to submit}"
    crafted: true
"""
...
examples:
  - name: Wait for a Data Lake Analytics job to finish. (autogenerated)
    text: |-
        az dla job wait --account "{Data Lake Analytics account name}" --job-id {job-id}
    crafted: true
"""
