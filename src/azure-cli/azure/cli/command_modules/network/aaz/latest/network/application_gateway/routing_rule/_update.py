...
@register_command(
    "network application-gateway routing-rule update",
)
class Update(AAZCommand):
    """Update a rule.

    :example: Update a rule use a new listener.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.address_pool = AAZStrArg(
            ...
            help="Name or ID of the backend address pool.",
            nullable=True,
        )
        _args_schema.settings = AAZStrArg(
            options=["--settings"],
            arg_group="Properties",
            help="Name or ID of the settings.",
            nullable=True,
        )
        _args_schema.listener = AAZStrArg(
            options=["--listener"],
            arg_group="Properties",
            help="Name or ID of the listener.",
            nullable=True,
        )
        return cls._args_schema
