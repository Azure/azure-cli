...
@register_command(
    "netappfiles volume export-policy add",
)
class Add(AAZCommand):
    """Add a new rule to the export policy for a volume.

    :example: Add an export policy rule for the ANF volume
    ...
    class VolumesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AddHelper._build_schema_volume_read(cls._schema_on_200)
    ...
    class VolumesCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AddHelper._build_schema_volume_read(cls._schema_on_200_201)
