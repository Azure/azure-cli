...
class ResourceGroupScenarioTest(ScenarioTest):
    ...
    def test_rest_arm(self):
        ...
        # https://learn.microsoft.com/rest/api/resources/resourcegroups/createorupdate
        ...
        # Resource Groups - Get
        # https://learn.microsoft.com/rest/api/resources/resourcegroups/get
        ...
        # https://learn.microsoft.com/rest/api/resources/resourcegroups/delete
    ...
    def test_rest_storage(self, resource_group):
        ...
        # https://learn.microsoft.com/rest/api/storagerp/storageaccounts/create
        ...
        while state != 'Succeeded':
            ...
            # https://learn.microsoft.com/rest/api/storagerp/storageaccounts/getproperties
        ...
        # Create an account SAS token https://learn.microsoft.com/rest/api/storageservices/create-account-sas
        # https://learn.microsoft.com/rest/api/storagerp/storageaccounts/listaccountsas
        ...
        # https://learn.microsoft.com/rest/api/storagerp/storageaccounts/delete
    ...
    def test_rest_microsoft_graph(self):
        ...
        # Create application
        # https://learn.microsoft.com/graph/api/application-post-applications?view=graph-rest-1.0&tabs=http
        ...
        # Get application
        # https://learn.microsoft.com/graph/api/application-get?view=graph-rest-1.0&tabs=http
        ...
        # https://learn.microsoft.com/graph/api/application-addpassword?view=graph-rest-1.0&tabs=http
        ...
        # https://learn.microsoft.com/graph/api/serviceprincipal-post-serviceprincipals?view=graph-rest-1.0&tabs=http
        ...
        # https://learn.microsoft.com/graph/api/serviceprincipal-get?view=graph-rest-1.0&tabs=http
        ...
        # https://learn.microsoft.com/graph/api/serviceprincipal-update?view=graph-rest-1.0&tabs=http
        ...
        # https://learn.microsoft.com/graph/api/serviceprincipal-addpassword?view=graph-rest-1.0&tabs=http
        ...
        # https://learn.microsoft.com/graph/api/serviceprincipal-delete?view=graph-rest-1.0&tabs=http
        ...
        # Delete application
        # https://learn.microsoft.com/graph/api/application-delete?view=graph-rest-1.0&tabs=http
