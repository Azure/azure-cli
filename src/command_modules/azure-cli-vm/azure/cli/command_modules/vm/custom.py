...
def create_vm(cmd, vm_name, resource_group_name, image=None, size='Standard_DS1_v2', location=None, tags=None,
    ...
    vm_resource = build_vm_resource(
        ...
        license_type=license_type, zone=zone, disk_info=disk_info, boot_diagnostics_storage_uri=boot_diagnostics_storage,  # pylint: disable=line-too-long
        ultra_ssd_enabled=ultra_ssd_enabled, computer_name=computer_name)
