...
class Show(AAZCommand):
    ...
    class ClustersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_compute_resource_definition_read(flink_profile.history_server)
            flink_profile.job_manager = AAZObjectType(
                serialized_name="jobManager",
                flags={"required": True},
            )
            _ShowHelper._build_schema_compute_resource_definition_read(flink_profile.job_manager)
            ...
            _ShowHelper._build_schema_compute_resource_definition_read(flink_profile.task_manager)
            ...
            _ShowHelper._build_schema_trino_debug_config_read(coordinator.debug)
            ...
            _ShowHelper._build_schema_trino_debug_config_read(worker.debug)
