...
class DiskEncryptionSetTest(ScenarioTest):
    ...
    #
    #     vault_id = self.cmd(
    #         'keyvault create -g {rg} -n {vault} --enable-purge-protection true --enable-soft-delete true').get_output_in_json()[
    #         'id']
    #     kid = self.cmd('keyvault key create -n {key} --vault {vault} --protection software').get_output_in_json()['key']['kid']
    #     self.kwargs.update({
    #         'vault_id': vault_id,
