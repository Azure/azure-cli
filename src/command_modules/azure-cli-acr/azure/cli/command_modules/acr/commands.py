...
def load_command_table(self, _):  # pylint: disable=too-many-statements
    ...
    acr_health_check_util = CliCommandType(
        operations_tmpl='azure.cli.command_modules.acr.health_check#{}'
    )
    ...
    with self.command_group('acr', acr_health_check_util) as g:
        g.command('health-check', 'acr_health_check')