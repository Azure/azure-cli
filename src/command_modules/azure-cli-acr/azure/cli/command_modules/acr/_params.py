...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr task') as c:
        ...
        c.argument('secret_arg', help="Secret build argument in 'name[=value]' format. Multiple --secret-arg can be fed.", action='append", action='append', validator=validate_secret_arg)
        c.argument('set_value', options_list=['--set'], help="Task value in 'name[=value]' format. Multiple --set can be fed.", action='append", action='append', validator=validate_set)
        c.argument('set_secret', help="Secret task value in 'name[=value]' format. Multiple --set-secret can be fed.", action='append", action='append', validator=validate_set_secret)
