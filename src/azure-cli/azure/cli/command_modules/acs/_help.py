...
examples:
  - name: Add a node pool to the managed Kubernetes cluster. (autogenerated)
    text: |
        az aks nodepool add --cluster-name MyCluster --kubernetes-version 1.13.9 --name MyNodePool --node-count 7 --os-type Windows --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete the agent pool in the managed Kubernetes cluster. (autogenerated)
    text: |
        az aks nodepool delete --cluster-name MyCluster --name MyNodePool --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List node pools in the managed Kubernetes cluster. (autogenerated)
    text: |
        az aks nodepool list --cluster-name MyCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Scale the node pool in a managed Kubernetes cluster. (autogenerated)
    text: |
        az aks nodepool scale --cluster-name MyCluster --name MyNodePool --node-count 7 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Upgrade the node pool in a managed Kubernetes cluster. (autogenerated)
    text: |
        az aks nodepool upgrade --cluster-name MyCluster --kubernetes-version 1.13.9 --name MyNodePool --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Remove the ACI Connector from a managed Kubernetes cluster. (autogenerated)
    text: |
        az aks remove-connector --connector-name MyConnector --location westus2 --name MyManagedCluster --os-type Windows --resource-group MyResourceGroup
    crafted: true
"""
...
helps['aks rotate-certs'] = """
    ...
    examples:
      - name: Rotate certificates and keys on a managed Kubernetes cluster (autogenerated)
        text: |
            az aks rotate-certs --name MyManagedCluster --resource-group MyResourceGroup
        crafted: true
"""
