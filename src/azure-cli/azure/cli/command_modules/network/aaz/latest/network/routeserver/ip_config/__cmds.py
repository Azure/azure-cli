...
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualHubIpConfigurationCreateOrUpdate(ctx=self.ctx)()
    ...
    class VirtualHubIpConfigurationCreateOrUpdate(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "ipConfigName", self.ctx.args.name,
                    required=True,
                ),
                **self.serialize_url_param(
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualHubIpConfigurationDelete(ctx=self.ctx)()
        self.post_operations()
    ...
    class VirtualHubIpConfigurationDelete(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VirtualHubIpConfigurationList(ctx=self.ctx)()
        self.post_operations()
    ...
    class VirtualHubIpConfigurationList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_public_ip_address_read(properties.public_ip_address)
            properties.subnet = AAZObjectType()
            _ListHelper._build_schema_subnet_read(properties.subnet)
...
__all__ = ["Create","Delete","List","__CMDGroup"]
