...
class Update(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RestorePointCollectionsUpdate(ctx=self.ctx)()
    ...
    class RestorePointCollectionsUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_api_entity_reference_read(properties.source_restore_point)
            ...
            _UpdateHelper._build_schema_api_entity_reference_read(exclude_disks.Element)
            ...
            _UpdateHelper._build_schema_instance_view_status_read(replication_status.status)
            ...
            _UpdateHelper._build_schema_instance_view_status_read(statuses.Element)
            ...
            _UpdateHelper._build_schema_sub_resource_read(_element.source_vault)
            ...
            _UpdateHelper._build_schema_host_endpoint_settings_read(proxy_agent_settings.wire_server)
            ...
            _UpdateHelper._build_schema_managed_disk_parameters_read(_element.managed_disk)
            _element.name = AAZStrType(
                flags={"read_only": True},
            )
            ...
            _UpdateHelper._build_schema_disk_restore_point_attributes_read(os_disk.disk_restore_point)
            ...
            _UpdateHelper._build_schema_managed_disk_parameters_read(os_disk.managed_disk)
            ...
            _UpdateHelper._build_schema_sub_resource_read(disk_encryption_key.source_vault)
            ...
            _UpdateHelper._build_schema_sub_resource_read(key_encryption_key.source_vault)
