...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.SecurityPartnerProvidersListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.SecurityPartnerProvidersList(ctx=self.ctx)()
    ...
    class SecurityPartnerProvidersListByResourceGroup(AAZHttpOperation):
    ...
    class SecurityPartnerProvidersList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
