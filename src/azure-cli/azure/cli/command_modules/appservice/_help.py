...
examples:
  ...
  - name: Swap a staging slot into production for the MyUniqueApp function app. (autogenerated)
    text: az functionapp deployment slot swap --name MyUniqueApp --resource-group MyResourceGroup --slot staging --target-slot production
    crafted: true
"""
...
examples:
  - name: Get the details of a web app's settings. (autogenerated)
    ...
    crafted: true
  - name: Get the details of a web app's settings. (autogenerated) (autogenerated)
