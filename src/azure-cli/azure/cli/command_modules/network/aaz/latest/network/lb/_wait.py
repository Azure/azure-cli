...
class Wait(AAZWaitCommand):
    ...
    class LoadBalancersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_frontend_ip_configuration_read(frontend_ip_configurations.Element)
            ...
            backend_address_pools.Element = AAZObjectType()
            _WaitHelper._build_schema_sub_resource_read(backend_address_pools.Element)
