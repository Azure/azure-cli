...
register_cli_argument('appservice web config update', 'linux_fx_version', help="The docker image used for your linux-based webapp, e.g., \"RUBY|2.3\", \"NODE|6.6\", \"PHP|5.6\"")
