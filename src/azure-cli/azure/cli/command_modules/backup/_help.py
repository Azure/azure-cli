...
examples:
  ...
  - name: Update the policy associated with this item. (autogenerated)
    text: az backup item set-policy --container-name MyContainer --name MyBackedUpItem --policy-name MyPolicy --vault-name MyVault
    crafted: true
"""
...
examples:
  ...
  - name: Before you can delete a Backup protection policy, the policy must not have any associated Backup items. To  associate another policy with a Backup item, use the backup item set-policy command. (autogenerated) (autogenerated)
    text: az backup policy delete --name MyBackupPolicy --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Stop protecting a backed up item. Can retain the backed up data forever or choose to delete it. (autogenerated)
    ...
    crafted: true
  - name: Stop protecting a backed up Azure VM. (autogenerated) (autogenerated)
...
examples:
  - name: Sets backup related properties of the Recovery Services vault. (autogenerated)
    ...
    crafted: true
  - name: Sets backup related properties of the Recovery Services vault. (autogenerated) (autogenerated)
