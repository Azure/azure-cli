...
class Delete(AAZCommand):
    ...
    :example: Delete a packet capture session. This only deletes the session and not the capture file.
        az network watcher packet-capture delete -n packetCaptureName -l westcentralus

    :example: Delete a packet capture session.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PacketCapturesDelete(ctx=self.ctx)()
    ...
    class PacketCapturesDelete(AAZHttpOperation):
