...
for scope in ['vm create', 'vmss create']:
    ...
    register_cli_argument(scope, 'data_caching', options_list=['--data-caching'], arg_group='Storage', help='Storage caching type for the VM data disk(s).', **enum_choice_list(CachingTypes))
