...
register_cli_argument('network lb', 'frontend_port', help='Port number [0-65535]')
register_cli_argument('network lb', 'frontend_port_range_start', help='Port number [0-65535]')
register_cli_argument('network lb', 'frontend_port_range_end', help='Port number [0-65535]')
register_cli_argument('network lb', 'backend_port', help='Port number [0-65535]')
