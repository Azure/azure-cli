...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_sub_resource_update(_element.backend_http_settings)
        _element.firewall_policy = AAZObjectArg(
            options=["firewall-policy"],
            help="Reference to the FirewallPolicy resource.",
        )
        cls._build_args_sub_resource_update(_element.firewall_policy)
        ...
        cls._build_args_sub_resource_update(_element.load_distribution_policy)
        ...
        cls._build_args_sub_resource_update(_element.redirect_configuration)
        _element.rewrite_rule_set = AAZObjectArg(
            options=["rewrite-rule-set"],
            help="Rewrite rule set resource of URL path map path rule.",
        )
        cls._build_args_sub_resource_update(_element.rewrite_rule_set)
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                _CreateHelper._build_schema_sub_resource_update(properties.set_prop("backendHttpSettings", AAZObjectType, ".backend_http_settings"))
                _CreateHelper._build_schema_sub_resource_update(properties.set_prop("firewallPolicy", AAZObjectType, ".firewall_policy"))
                _CreateHelper._build_schema_sub_resource_update(properties.set_prop("loadDistributionPolicy", AAZObjectType, ".load_distribution_policy"))
                properties.set_prop("paths", AAZListType, ".paths")
                _CreateHelper._build_schema_sub_resource_update(properties.set_prop("redirectConfiguration", AAZObjectType, ".redirect_configuration"))
                _CreateHelper._build_schema_sub_resource_update(properties.set_prop("rewriteRuleSet", AAZObjectType, ".rewrite_rule_set"))
