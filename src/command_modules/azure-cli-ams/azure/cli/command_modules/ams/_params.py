...
def load_arguments(self, _):  # pylint: disable=too-many-locals, too-many-statements
    ...
    with self.argument_context('ams asset-filter') as c:
        ...
        c.argument('bitrate', help='The first quality bitrate.', deprecate_info=c.deprecate(target='bitrate', redirect='firstQuality', hide=True))
        c.argument('firstQuality', help='The first quality (lowest) bitrate to include in the manifest.')
