...
from azure.cli.command_modules.vm.generated.action import *  # noqa: F403, pylint: disable=unused-wildcard-import,wildcard-import
try:
...
def load_images_from_aliases_doc(cli_ctx, publisher=None, offer=None, sku=None, architecture=None):
    ...
    from azure.cli.command_modules.vm.azure_stack._alias import alias_json
    try:
