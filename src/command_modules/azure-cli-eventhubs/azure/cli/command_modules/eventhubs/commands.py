...
# Namespace Region
    ...
    with self.command_group('eventhubs namespace', eh_namespace_util, min_api='2017-04-01', client_factory=namespaces_mgmt_client_factory) as g:
    ...
    with self.command_group('eventhubs namespace authorization-rule', eh_namespace_util, min_api='2017-04-01', client_factory=namespaces_mgmt_client_factory) as g:
...
# EventHub Region
    with self.command_group('eventhubs eventhub', eh_event_hub_util, min_api='2017-04-01', client_factory=event_hub_mgmt_client_factory) as g:
    ...
    with self.command_group('eventhubs eventhub authorization-rule', eh_event_hub_util, min_api='2017-04-01', client_factory=event_hub_mgmt_client_factory) as g:
        g.command('create', 'create_or_update_authorization_rule')
        g.show_command('show', 'get_authorization_rule')
        g.command('list', 'list_authorization_rules')
        g.command('keys list', 'list_keys')
...
# ConsumerGroup Region
    with self.command_group('eventhubs eventhub consumer-group', eh_consumer_groups_util, min_api='2017-04-01', client_factory=consumer_groups_mgmt_client_factory) as g:
...
# DisasterRecoveryConfigs Region
    with self.command_group('eventhubs georecovery-alias', eh_geodr_util, min_api='2017-04-01', client_factory=disaster_recovery_mgmt_client_factory) as g:
    ...
    with self.command_group('eventhubs georecovery-alias authorization-rule', eh_geodr_util, min_api='2017-04-01', client_factory=disaster_recovery_mgmt_client_factory) as g:
        g.command('list', 'list_authorization_rules')
        g.show_command('show', 'get_authorization_rule')
        g.command('keys list', 'list_keys')

# NetwrokRuleSet Region
    with self.command_group('eventhubs namespace network-rule', eh_namespace_util, min_api='2017-04-01', client_factory=namespaces_mgmt_client_factory) as g:
