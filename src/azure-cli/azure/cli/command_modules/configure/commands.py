...
from azure.cli.command_modules.configure._validators import validate_local_context
...
def load_command_table(self, _):
    ...
    with self.command_group('local-context', configure_custom, is_experimental=True) as g:
        ...
        g.command('list', 'list_local_context', validator=validate_local_context)
        g.command('show', 'show_local_context', validator=validate_local_context)
        g.command('delete', 'delete_local_context', validator=validate_local_context)
        g.command('clear', 'clear_local_context', validator=validate_local_context)
