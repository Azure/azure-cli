...
def load_arguments_eh(self, _):
    ...
    (KeyType, AccessRights, SkuName, KeySource) = self.get_models('KeyType', 'AccessRights', 'SkuName', 'KeySource', 'ManagedServiceIdentityType', resource_type=ResourceType.MGMT_EVENTHUB)
