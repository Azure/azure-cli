...
aladdin_helps['acr task timer add'] = """
type: command
short-summary: Add a timer trigger to a task.
examples:
  - name: Add a timer trigger to a task. (autogenerated)
    text: |
        az acr task timer add --name taskname --registry registryname --schedule "30 9 * * 1-5" --subscription mysubscription --timer-name t2
    crafted: true
"""

aladdin_helps['acr task timer remove'] = """
type: command
short-summary: Remove a timer trigger from a task.
examples:
  - name: Remove a timer trigger from a task. (autogenerated)
    text: az acr task timer remove --name taskname --registry registryname --subscription mysubscription --timer-name t2
    crafted: true
"""
...
examples:
  - name: Generate a new client secret for a service principal configured for an Azure Media Services account (autogenerated)
    text: az ams account sp reset-credentials --account-name myaccount --name myappappuri --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Show an existing content key policy. (autogenerated)
    text: az ams content-key-policy show --account-name myaccount --name mycontentkeypolicy --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['appconfig credential regenerate'] = """
type: command
short-summary: Regenerate an access key for an App Configuration.
examples:
  - name: Regenerate an access key for an App Configuration. (autogenerated)
    text: az appconfig credential regenerate --id 0-l0-s0:8ldbreMVH+d7EjaSUg3H --name MyAppConfiguration --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""

aladdin_helps['appconfig feature lock'] = """
type: command
short-summary: Lock a feature flag to prohibit write operations.
examples:
  - name: Lock a feature flag to prohibit write operations. (autogenerated)
    text: az appconfig feature lock --feature color --label test --name MyAppConfiguration --only-show-errors --yes
    crafted: true
"""
...
examples:
  - name: Delete app service environment. (autogenerated)
    text: az appservice ase delete --name MyAseName --no-wait --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete a specific triggered webjob hosted on a web app. (autogenerated)
    text: az webapp webjob triggered remove --name MyWebApp --resource-group MyResourceGroup --subscription mysubscription --webjob-name MyWebjob
    crafted: true
"""
...
examples:
  - name: Show details of a container registered to a Recovery services vault. (autogenerated)
    text: az backup container show --backup-management-type AzureIaasVM --name MyContainer --resource-group MyResourceGroup --subscription mysubscription --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: List the start and end points of the unbroken log chain(s) of the given backup item. (autogenerated)
    text: az backup recoverypoint show-log-chain --backup-management-type AzureIaasVM --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --start-date 01-01-2019 --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Update properties for a Batch account. (autogenerated)
    text: az batch account set --name MyBatchAccount --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Stop a CDN endpoint. (autogenerated)
    text: az cdn endpoint stop --name endpoint --profile-name profile-name --resource-group group --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['cognitiveservices account keys regenerate'] = """
type: command
short-summary: Manage Azure Cognitive Services accounts.
long-summary: This article lists the Azure CLI commands for Azure Cognitive Services account and subscription management only. Refer to the documentation at https://docs.microsoft.com/azure/cognitive-services/ for individual services to learn how to use the APIs and supported SDKs.
examples:
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account keys regenerate --key-name key1 --name myresource --resource-group cognitive-services-resource-group --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update the throughput of the Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb cassandra keyspace throughput update --account-name myaccount --name mykeyspace --resource-group myresourcegroup --subscription mysubscription --throughput "500"
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph delete --account-name myaccount --database-name mydatabase --name mygraph --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List the Gremlin graphs under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph list --account-name myaccount --database-name mydatabase --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete the SQL database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb sql database delete --account-name myaccount --name mydatabase --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: Delete the SQL user defined function under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql user-defined-function delete --account-name myaccount --container-name mycontainer --database-name mydatabase --name myuserdefinedfunction --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: Creates a Data Lake Store account. (autogenerated)
    text: az dls account create --account mydatalakestoragegen1 --location westus2 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Stop an instance of the Data Migration Service (autogenerated)
    text: az dms stop --name myservice --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['eventhubs eventhub consumer-group delete'] = """
type: command
...
aladdin_helps['eventhubs georecovery-alias fail-over'] = """
type: command
short-summary: Invokes Geo-Disaster Recovery Configuration Alias to point to the secondary namespace
examples:
  - name: Invokes Geo-Disaster Recovery Configuration Alias to point to the secondary namespace. (autogenerated)
    text: az eventhubs georecovery-alias fail-over --alias myaliasname --namespace-name secondarynamespace --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['eventhubs georecovery-alias show'] = """
type: command
...
examples:
  - name: shows properties of Geo-Disaster Recovery Configuration Alias for Primay or Secondary Namespace. (autogenerated)
    text: az eventhubs georecovery-alias show --alias myaliasname --namespace-name primarynamespace --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Updates the EventHubs Namespace. (autogenerated)
    text: az eventhubs namespace update --enable-auto-inflate true --maximum-throughput-units 20 --name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['iot dps certificate verify'] = """
type: command
...
examples:
  - name: Verify an Azure IoT Hub Device Provisioning Service certificate. (autogenerated)
    text: az iot dps certificate verify --certificate-name MyCertificate --dps-name MyDps --etag AAAAAAAAAAA= --path /certificates/Verification.pem --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['managedservices assignment create'] = """
type: command
...
examples:
  - name: Creates a new registration assignment. (autogenerated)
    text: |
        az managedservices assignment create --definition "/subscriptions/00000000-0000-0000-0000-00000000000000000/providers/Microsoft.ManagedServices/registrationDefinitions/00000000-0000-0000-0000-00000000000000000" --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update the details of this activity log alert (autogenerated)
    ...
    crafted: true
  - name: Update the details of this activity log alert. (autogenerated)
    text: az monitor activity-log alert update --name MyActivityLogAlerts --resource-group MyResourceGroup --tags key[=value]
    crafted: true
"""
...
examples:
  - name: Get a list of management groups connected to a workspace. (autogenerated)
    text: az monitor log-analytics workspace list-management-groups --resource-group MyResourceGroup --subscription mysubscription --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update a rewrite rule. (autogenerated)
    text: az network application-gateway rewrite-rule update --gateway-name MyGateway --name MyRewriteRule --remove tags.no_80 --resource-group MyResourceGroup --rule-set-name MyRuleSet --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update a URL path map. (autogenerated)
    text: az network application-gateway url-path-map update --default-address-pool MyAddressPool --default-http-settings MyNewHttpSettings --gateway-name MyAppGateway --name MyUrlPathMap --remove tags.no_80 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List application gateway WAF policy custom rules. (autogenerated)
    text: az network application-gateway waf-policy custom-rule list --policy-name MyPolicy --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    ...
    crafted: true
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule update --action Allow --name MyWAFPolicyRule --policy-name MyPolicy --priority 500 --resource-group MyResourceGroup --rule-type MatchRule
    crafted: true
"""
...
examples:
  - name: Create an empty PTR record set. (autogenerated)
    text: az network dns record-set ptr create --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Delete a PTR record set and all associated records. (autogenerated)
    text: az network dns record-set ptr delete --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --yes --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update properties of an SOA record. (autogenerated)
    text: az network dns record-set soa update --email myhostmaster.mysite.com --only-show-errors --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Delete an ExpressRoute circuit. (autogenerated)
    text: az network express-route delete --name MyCircuit --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create an ExpressRoute gateway connection. (autogenerated)
    text: az network express-route gateway connection create --gateway-name MyGateway --name MyExpressRouteConnection --peering /subscriptions/MySub/resourceGroups/MyResourceGroup/providers/Microsoft.Network/expressRouteCircuits/MyCircuit/peerings/AzurePrivatePeering --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create peering settings for an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering create --circuit-name MyCircuit --peer-asn 10002 --peering-type AzurePublicPeering --primary-peer-subnet 101.0.0.0/30 --resource-group MyResourceGroup --secondary-peer-subnet 102.0.0.0/30 --shared-key Abc123 --vlan-id 103
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the network interface is met. (autogenerated)
    text: az network nic wait --deleted --name MyNic --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show a private endpoint dns zone group. (autogenerated)
    text: az network private-endpoint dns-zone-group show --endpoint-name MyEndpoint --name MyPrivateDnsZoneGroup --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete a service endpoint policy definition (autogenerated)
    text: az network service-endpoint policy-definition delete --name myserviceendpointpolicydefinition --policy-name mypolicy --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: List service endpoint policy definitions. (autogenerated)
    text: az network service-endpoint policy-definition list --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of a service endpoint policy definition. (autogenerated)
    text: az network service-endpoint policy-definition show --name myserviceendpointpolicydefinition --policy-name mypolicy --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Reset a VPN connection shared key. (autogenerated)
    text: az network vpn-connection shared-key reset --connection-name MyConnection --key-length 128 --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show an endpoint from a connection monitor. (autogenerated)
    text: az network watcher connection-monitor endpoint show --connection-monitor MyConnectionMonitor --location westus2 --name myconnectionmonitorendpoint --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show a test group of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-group show --connection-monitor MyConnectionMonitor --location westus2 --name myconnectionmonitortestgroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete the specified flow log resource. (autogenerated)
    text: az network watcher flow-log delete --location westus2 --name MyFlowLogger
    crafted: true
"""
...
examples:
  - name: Delete a resource policy remediation. (autogenerated)
    text: az policy remediation delete --name myremediation --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Lists deployments for a resource policy remediation. (autogenerated)
    text: az policy remediation deployment list --management-group myMg --name myremediation
    crafted: true
"""
...
examples:
  - name: List deployment operations at subscription scope. (autogenerated)
    text: az deployment operation sub list --name mydeployment
    crafted: true
"""
...
examples:
  - name: Deletes the Authorization Rule of the Service Bus Namespace. (autogenerated)
    text: az servicebus namespace authorization-rule delete --name myauthorule --namespace-name mynamespace --only-show-errors --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Updates a Service Bus Namespace (autogenerated)
    ...
    crafted: true
  - name: Updates a Service Bus Namespace. (autogenerated)
    text: az servicebus namespace update --capacity 1 --name mynamespace --resource-group myresourcegroup
    crafted: true
"""

aladdin_helps['servicebus queue authorization-rule delete'] = """
type: command
short-summary: Delete the Authorization Rule of Service Bus Queue
examples:
  - name: Delete the Authorization Rule of Service Bus Queue. (autogenerated)
    text: az servicebus queue authorization-rule delete --name myauthorule --namespace-name mynamespace --only-show-errors --queue-name myqueue --resource-group myresourcegroup
    crafted: true
"""

aladdin_helps['servicebus queue authorization-rule keys renew'] = """
type: command
short-summary: Regenerate keys of Authorization Rule for Service Bus Queue
examples:
  - name: Regenerate keys of Authorization Rule for Service Bus Queue. (autogenerated)
    text: az servicebus queue authorization-rule keys renew --key PrimaryKey --name myauthorule --namespace-name mynamespace --queue-name myqueue --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Updates existing Service Bus Queue. (autogenerated)
    text: az servicebus queue update --enable-batched-operations true --enable-duplicate-detection true --name myqueue --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Deletes the Authorization Rule of the given Service Bus Topic. (autogenerated)
    text: az servicebus topic authorization-rule delete --name myauthorule --namespace-name mynamespace --only-show-errors --resource-group myresourcegroup --topic-name mytopic
    crafted: true
"""
...
aladdin_helps['signalr update'] = """
type: command
short-summary: Update an existing SignalR Service.
examples:
  - name: Update an existing SignalR Service. (autogenerated)
    text: az signalr update --name MySignalR --resource-group MyResourceGroup --subscription mysubscription --unit-count 50
    crafted: true
"""
...
examples:
  - name: Update an elastic pool. (autogenerated)
    text: az sql elastic-pool update --capacity 100 --name mypool --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  - name: Create a managed instance. (autogenerated)
    text: az sql mi create --admin-password mypassword --admin-user myusername --location mylocation --name myinstance --resource-group mygroup --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/{VNETName}/subnets/{SubnetName} --vnet-name myvnet
    crafted: true
"""
...
examples:
  ...
  - name: Update a managed instance. (autogenerated)
    ...
    crafted: true
  - name: Update a managed instance. (autogenerated)
    text: az sql mi update --name myinstance --resource-group mygroup --set tags.tagName=tagValue
    crafted: true
"""
...
examples:
  - name: Create an encryption scope within storage account. (autogenerated)
    text: az storage account encryption-scope create --account-name mystorageaccount --key-source Microsoft.Storage --name myencryption --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Copies an incremental copy of a blob asynchronously. (autogenerated)
    ...
    crafted: true
  - name: Copies an incremental copy of a blob asynchronously. (autogenerated)
    text: az storage blob incremental-copy start --connection-string myconnectionstring --destination-blob MyDestinationBlob --destination-container MyDestinationContainer --source-uri https://storage.blob.core.windows.net/photos
    crafted: true
"""
...
examples:
  - name: Show the storage blob delete-policy. (autogenerated)
    ...
    crafted: true
  - name: Show the storage blob delete-policy. (autogenerated)
    text: az storage blob service-properties delete-policy show --account-name mystorageccount --auth-mode login
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file. (autogenerated)
    text: az storage file generate-sas --account-key 00000000 --account-name MyStorageAccount --expiry 2037-12-31T23:59:00Z --https-only --path path/file.txt --permissions rcdw --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Delete a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory delete --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir --yes
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    text: az disk wait --deleted --name MyManagedDisk --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: update a share image defintiion. (autogenerated)
    text: az sig image-definition update --gallery-image-definition MyImage --gallery-name MyGallery --resource-group MyResourceGroup --set publishingProfile.excludeFromLatest=true
    crafted: true
"""
...
examples:
  - name: update a share image gallery. (autogenerated)
    text: az sig update --gallery-name mygallery --resource-group myresourcegroup --set publishingProfile.excludeFromLatest=true
    crafted: true
"""
...
examples:
  - name: Gets specific run command for a subscription in a location. (autogenerated)
    text: az vmss run-command show --command-id RunShellScript --location westus2 --subscription mysubscription
    crafted: true
"""
