...
from azure.cli.commands.arm import is_valid_resource_id, register_id_parameter
...
# Application-Gateway
register_cli_argument('network application-gateway', 'application_gateway_name', name_arg_type, completer=get_resource_name_completion_list('Microsoft.Network/applicationGateways'), id_part='resource_name')
for name in ('delete',
             'show',
             'start',
             'stop'):
    register_id_parameter('network application-gateway ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network express-route circuit-auth ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network express-route circuit-peering ' + name,)
...
for name in ('delete',
             ...
             'list-routes',
             'show'):
    register_id_parameter('network express-route circuit ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network local-gateway ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network nic ' + name)
...
for name in ('show',):
    register_id_parameter('network nic scale-set ' + name, child_name='network_interface_name')
for name in ('list', 'list-vm-nics'):
    register_id_parameter('network nic scale-set ' + name)
...
for name in ('delete',
             'rule list',
             'show'):
    register_id_parameter('network nsg ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network nsg rule ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network public-ip ' + name)

# Route Operation
register_cli_argument('network route-operation', 'route_name', name_arg_type, id_part='child_name')
for name in ('delete',
             'show'):
    register_id_parameter('network route-operation ' + name, name='route_table_name')
...
for name in ('delete',
             'show'):
    register_id_parameter('network route-table ' + name)
...
for name in ('delete',
             'show',
             'subnet list'):
    register_id_parameter('network vnet ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network vnet subnet ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network lb ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network vpn-gateway ' + name)
...
for name in ('delete',
             'show'):
    register_id_parameter('network vpn-connection ' + name)
...
for name in ('show',):
    register_id_parameter('network vpn-connection shared-key ' + name)
