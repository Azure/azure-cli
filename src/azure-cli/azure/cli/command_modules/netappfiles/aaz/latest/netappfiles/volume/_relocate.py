...
@register_command(
    "netappfiles volume relocate",
)
class Relocate(AAZCommand):
    """Relocates volume to a new stamp

    :example: Relocates volume to a new stamp
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.creation_token = AAZStrArg(
            ...
            arg_group="Body",
            help="New creation token for the volume that controls the mount point name",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesRelocate(ctx=self.ctx)()
    ...
    class VolumesRelocate(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("creationToken", AAZStrType, ".creation_token")
...
class _RelocateHelper:
    """Helper class for Relocate"""
