...
class ListRouteTablesSummary(AAZCommand):
    ...
    _aaz_info = {
        "version": "2022-01-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/expressroutecrossconnections/{}/peerings/{}/routetablessummary/{}", "2022-01-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpressRouteCrossConnectionsListRoutesTableSummary(ctx=self.ctx)()
    ...
    class ExpressRouteCrossConnectionsListRoutesTableSummary(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.state_or_prefixes_received = AAZStrType(
...
__all__ = ["ListRouteTablesSummary"]
