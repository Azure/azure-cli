...
|az billing billing-property|BillingProperty|[commands](#CommandsInBillingProperty)|
...
### <a name="CommandsInBillingProperty">Commands in `az billing billing-property` group</a>
|CLI Command|Operation Swagger name|Parameters|Examples|
|---------|------------|--------|-----------|
|[az billing billing-property show](#BillingPropertyGet)|Get|[Parameters](#ParametersBillingPropertyGet)|[Example](#ExamplesBillingPropertyGet)|
|[az billing billing-property update](#BillingPropertyUpdate)|Update|[Parameters](#ParametersBillingPropertyUpdate)|[Example](#ExamplesBillingPropertyUpdate)|
...
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--billing-account-name**|string|The ID that uniquely identifies a billing account.|billing_account_name|billingAccountName|
|**--expand**|string|May be used to expand the soldTo, invoice sections and billing profiles.|expand|$expand|
...
```
az billing balance show --billing-account-name "{billingAccountName}" --billing-profile-name "{billingProfileName}"
```
##### <a name="ParametersAvailableBalancesGet">Parameters</a> 
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
|**--billing-account-name**|string|The ID that uniquely identifies a billing account.|billing_account_name|billingAccountName|
|**--billing-profile-name**|string|The ID that uniquely identifies a billing profile.|billing_profile_name|billingProfileName|

### group `az billing billing-property`
#### <a name="BillingPropertyGet">Command `az billing billing-property show`</a>
...
|Option|Type|Description|Path (SDK)|Swagger name|
|------|----|-----------|----------|------------|
#### <a name="BillingPropertyUpdate">Command `az billing billing-property update`</a>
...
```
az billing customer list --billing-account-name "{billingAccountName}" --billing-profile-name "{billingProfileName}"
```
...
```
az billing customer list --billing-account-name "{billingAccountName}"
```
...
##### <a name="ExamplesCustomersGet">Example</a>
```
az billing customer show --expand "enabledAzurePlans,resellers" --billing-account-name "{billingAccountName}" --name \
"{customerName}"
```
...
```
az billing policy update --billing-account-name "{billingAccountName}" --billing-profile-name "{billingProfileName}" \
...
```
az billing product list --billing-account-name "{billingAccountName}" --billing-profile-name "{billingProfileName}" \
...
```
az billing product list --billing-account-name "{billingAccountName}" --customer-name "{customerName}"
```
...
```
az billing product list --billing-account-name "{billingAccountName}"
```
...
```
az billing product update --billing-account-name "{billingAccountName}" --auto-renew "Off" --name "{productName}"
```
...
```
az billing product validate-move --billing-account-name "{billingAccountName}" --destination-invoice-section-id \
"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections\
/{newInvoiceSectionName}" --name "{productName}"
```
##### <a name="ExamplesProductsValidateMove">Example</a>
...
```
az billing profile create --billing-account-name "{billingAccountName}" --name "{billingProfileName}" --bill-to \
...
```
az billing subscription list --billing-account-name "{billingAccountName}" --customer-name "{customerName}"
```
...
```
az billing subscription list --billing-account-name "{billingAccountName}"
```
...
```
az billing subscription move --billing-account-name "{billingAccountName}" --destination-invoice-section-id \
"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections\
...
```
az billing subscription validate-move --billing-account-name "{billingAccountName}" --destination-invoice-section-id \
"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections\
/{newInvoiceSectionName}"
```
##### <a name="ExamplesBillingSubscriptionsValidateMove">Example</a>
...
```
az billing transaction list --billing-account-name "{billingAccountName}" --invoice-name "{invoiceName}"
```
