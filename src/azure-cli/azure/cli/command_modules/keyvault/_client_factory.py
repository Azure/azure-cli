...
def keyvault_private_data_plane_factory_v7_2_preview(cli_ctx, _):
    from .vendored_sdks import KeyVaultAuthentication, KeyVaultClient
    from azure.cli.core.profiles import ResourceType, get_api_version
    from azure.cli.core.util import should_disable_connection_verify
...
def keyvault_private_data_plane_factory_v7_0(cli_ctx, _):
    from .vendored_sdks import KeyVaultAuthentication, KeyVaultClient
    from azure.cli.core.util import should_disable_connection_verify

    version = '7.0'  # For Secure Key Release feature
