...
def load_command_table(self, _):
    ...
    if not is_azure_stack_profile(self):
        ...
        with self.command_group('keyvault security-domain', private_data_entity.command_type) as g:
            ...
            g.keyvault_custom('encrypt-blob', 'security_domain_encrypt_blob', supports_no_wait=True)
            g.keyvault_custom('upload-blob', 'security_domain_upload_blob', supports_no_wait=True)
