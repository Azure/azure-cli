...
examples:
  ...
  - name: Delete the specified ANF snapshot. (autogenerated)
    text: az netappfiles snapshot delete --account-name myaccname --pool-name mypoolname --resource-group mygroup --snapshot-name mysnapname --volume-name myvolname
    crafted: true
"""
...
examples:
  ...
  - name: Get the specified ANF snapshot. (autogenerated)
    text: az netappfiles snapshot show --account-name myaccname --pool-name mypoolname --resource-group mygroup --snapshot-name mysnapname --volume-name myvolname
    crafted: true
"""
