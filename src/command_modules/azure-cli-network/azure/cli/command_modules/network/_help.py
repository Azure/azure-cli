...
-   "name": |-
        Create an address pool.
    "text": |-
        az network application-gateway address-pool create --name MyBackendAddressPool --servers <servers> --gateway-name MyGateway --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
"examples":
-   "name": |-
        Update an address pool, add server.
    "text": |-
...
-   "name": |-
    ...
    "text": |-
        az network application-gateway auth-cert update -g MyResourceGroup --gateway-name MyAppGateway \ -n MyAuthCert --cert-file /path/to/new/cert/file
"""
...
"examples":
-   "name": |-
        Update a frontend IP address to use a new IP address.
    "text": |-
        az network application-gateway frontend-ip update -g MyResourceGroup --gateway-name MyAppGateway \ -n MyFrontendIp --public-ip-address MyNewPublicIpAddress
"""
...
-   "name": |-
        Create an HTTP listener.
    "text": |-
        az network application-gateway http-listener create --resource-group MyResourceGroup --host-name MyHost --name MyHTTPListener --gateway-name MyGateway --frontend-port <frontend-port>
    "crafted": |-
        True
"""
...
"examples":
-   "name": |-
        Update an application gateway to use additional servers.
    "text": |
...
-   "name": |-
        List available rules in table foramt.
    "text": |-
...
-   "name": |-
        Add an A record.
    "text": |-
        az network dns record-set a add-record --zone-name MyZone --ipv4-address <ipv4-address> --record-set-name MyRecordSet --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create an empty A record set.
    "text": |-
        az network dns record-set a create --ttl <ttl> --zone-name www.mysite.com --name MyRecordSet --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete an A record set and all associated records.
    "text": |-
        az network dns record-set a delete --zone-name www.mysite.com --name MyRecordSet --yes  --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List all A record sets in a zone.
    "text": |-
        az network dns record-set a list --zone-name www.mysite.com --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Remove an A record from its record set.
    "text": |-
        az network dns record-set a remove-record --zone-name MyZone --ipv4-address <ipv4-address> --record-set-name MyRecordSet --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Get the details of an A record set.
    "text": |-
        az network dns record-set a show --zone-name www.mysite.com --query [0] --name MyRecordSet --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Update an A record set.
    "text": |-
        az network dns record-set a update --zone-name MyZone --name MyRecordSet --set <set> --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create an empty CNAME record set.
    "text": |-
        az network dns record-set cname create --ttl <ttl> --zone-name www.mysite.com --resource-group MyResourceGroup --name MyRecordSet
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete a CNAME record set and its associated record.
    "text": |-
        az network dns record-set cname delete --zone-name www.mysite.com --resource-group MyResourceGroup --name MyRecordSet
    "crafted": |-
        True
"""
...
-   "name": |-
        Set the value of a CNAME record.
    "text": |-
        az network dns record-set cname set-record --zone-name MyZone --cname <cname> --record-set-name MyRecordSet --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List all record sets within a DNS zone.
    "text": |-
        az network dns record-set list --zone-name www.mysite.com --output json --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Add an NS record.
    "text": |-
        az network dns record-set ns add-record --output json --record-set-name MyRecordSet --nsdname <nsdname> --zone-name MyZone --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List all NS record sets in a zone.
    "text": |-
        az network dns record-set ns list --zone-name www.mysite.com --query [0] --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Add an SRV record.
    "text": |-
        az network dns record-set srv add-record --port <port> --zone-name MyZone --resource-group MyResourceGroup --target <target> --record-set-name MyRecordSet --priority <priority> --weight <weight>
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete a TXT record set and all associated records.
    "text": |-
        az network dns record-set txt delete --zone-name www.mysite.com --name MyRecordSet --yes  --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
"examples":
-   "name": |-
        Export a DNS zone as a DNS zone file in tsv format.
    "text": |
...
-   "name": |-
        Create an address pool.
    "text": |-
        az network lb address-pool create --name MyAddressPool --lb-name MyLb --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List address pools.
    "text": |-
        az network lb address-pool list --lb-name MyLb --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az network lb frontend-ip create -g MyResourceGroup -n MyFrontendIp --lb-name MyLb --public-ip-name MyFrontendIp
-   "name": |-
...
-   "name": |-
        Create a frontend IP address.
    "text": |-
        az network lb frontend-ip create --public-ip-address <public-ip-address> --name MyFrontendIp --lb-name MyLb --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az network lb frontend-ip update -g MyResourceGroup --lb-name MyLb -n MyFrontendIp --public-ip-name MyNewPublicIp
-   "name": |-
...
-   "name": |-
        Add an address pool to an IP configuration.
    "text": |-
        az network nic ip-config address-pool add --ip-config-name MyIpConfig --nic-name MyNic --lb-name MyLb --address-pool <address-pool> --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create an IP configuration.
    "text": |-
        az network nic ip-config create --public-ip-address <public-ip-address> --nic-name MyNic --resource-group MyResourceGroup --name MyIpConfig
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete an IP configuration.
    "text": |-
        az network nic ip-config delete --nic-name MyNic --name MyIpConfig --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List the IP configurations of a NIC.
    "text": |-
        az network nic ip-config list --output json --nic-name MyNic --query [0] --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Show the details of an IP configuration.
    "text": |-
        az network nic ip-config show --nic-name MyNic --name MyIpConfig --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Update an IP configuration.
    "text": |-
        az network nic ip-config update --public-ip-address <public-ip-address> --nic-name MyNic --name MyIPConfiguration --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create a public IP address.
    "text": |-
        az network public-ip create --allocation-method Static --name MyIp --location westus2 --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Delete a public IP address.
    "text": |-
        az network public-ip delete --name MyIp --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List public IP addresses.
    "text": |-
        az network public-ip list --output json --query [0]
    "crafted": |-
        True
"""
...
-   "name": |-
        Get the details of a public IP address.
    "text": |-
        az network public-ip show --resource-group MyResourceGroup --name MyIp
    "crafted": |-
        True
"""
...
-   "name": |-
        Update a public IP address.
    "text": |-
        az network public-ip update --dns-name MyLabel
    "crafted": |-
        True
"""
...
-   "name": |-
        Create a route in a route table.
    "text": |-
        az network route-table route create --next-hop-type Internet --address-prefix <address-prefix> --name MyRoute --route-table-name MyRouteTable --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Update a route in a route table.
    "text": |-
        az network route-table route update --next-hop-ip-address 10.0.100.5
    "crafted": |-
        True
"""
...
-   "name": |-
        Update a traffic manager endpoint.
    "text": |-
        az network traffic-manager endpoint update --profile-name MyTmProfile \ --name MyEndpoint --endpoint-status Disabled --type azureEndpoints --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Get the flow log configuration of a network security group.
    "text": |-
        az network watcher flow-log show --nsg MyNsg --query [0] --resource-group MyResourceGroup
    "crafted": |-
        True
"""
