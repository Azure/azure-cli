...
-   "name": |-
    ...
    "text": |-
        az disk show --resource-group MyResourceGroup --output json --name MyManagedDisk
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az identity create --output json --resource-group MyResourceGroup --query [0] --name MyIdentityResource
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az image copy --target-resource-group <target-resource-group> --target-location <target-location> --source-object-name MySourceObject --source-resource-group <source-resource-group> --cleanup <cleanup>
    "crafted": |-
        True
-   "name": |-
        Gets an image.
    "text": |-
        az image show --output json --resource-group MyResourceGroup --name MyImage
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az sig image-definition show --gallery-name MyGallery --gallery-image-definition <gallery-image-definition> --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Create a gallery image definition.
    "text": |-
        az sig image-definition create --os-type linux --sku GreatSku --gallery-image-definition MyImage --resource-group MyResourceGroup --offer GreatOffer --gallery-name MyGallery --publisher GreatPublisher
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az sig image-version show --gallery-name MyGallery --gallery-image-definition <gallery-image-definition> --resource-group MyResourceGroup
    "crafted": |-
        True
-   "name": |-
        List gallery Image Versions in a gallery Image Definition.
    "text": |-
        az sig image-version list --output json --gallery-name MyGallery --query [0] --gallery-image-definition <gallery-image-definition> --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Grant read access to a snapshot.
    "text": |-
        az snapshot grant-access --output json --name MySnapshot --query [0] --duration-in-seconds <duration-in-seconds> --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Revoke read access to a snapshot.
    "text": |-
        az snapshot revoke-access --output json --resource-group MyResourceGroup --name MySnapshot
    "crafted": |-
        True
"""
...
-   "name": |-
        Create an Azure Availability Set.
    "text": |-
        az vm availability-set create --name MyAvSet --location westus2 --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List availability sets.
    "text": |-
        az vm availability-set list --output json --query [0] --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Get information for an availability set.
    "text": |-
        az vm availability-set show --output json --name MyAvSet --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Enable the boot diagnostics on a VM.
    "text": |-
        az vm boot-diagnostics enable --storage https://mystor.blob.core.windows.net/ --resource-group MyResourceGroup --name MyVirtualMachine
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": "az keyvault certificate create --vault-name vaultname -n cert1 \\\n \
        \ -p \"$(az keyvault certificate get-default-policy)\"\n\nsecrets=$(az keyvault\
        \ secret list-versions --vault-name vaultname \\\n  -n cert1 --query \"[?attributes.enabled].id\"\
        \ -o tsv)\n\nvm_secrets=$(az vm secret format -s \"$secrets\") \n\naz vm create\
        \ -g group-name -n vm-name --admin-username deploy  \\\n  --image debian --secrets\
        \ \"$vm_secrets\"\n"
-   "name": |-
...
-   "name": |-
        Get instance information about a VM.
    "text": |-
        az vm get-instance-view --output json --name MyVm --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Opens a VM to inbound traffic on specified ports.
    "text": |-
        az vm open-port --port '*' --name MyVm --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Execute a specific run command on a vm.
    "text": |-
        az vm run-command invoke --scripts "sudo apt-get update && sudo apt-get install -y nginx" --name MyVm --command-id RunShellScript --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        Attach an unmanaged persistent disk to a VM.
    "text": |-
        az vm unmanaged-disk attach --size-gb <size-gb> --new  --name MyDataDiskName(optionalWhenCreateNewDisk) --vm-name MyVm --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        List unmanaged disks with IDs containing the string "data_disk".
    "text": |
...
-   "name": |-
        List unmanaged disks of a VM.
    "text": |-
        az vm unmanaged-disk list --output json --resource-group MyResourceGroup --name MyVirtualMachine
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": "az keyvault certificate create --vault-name vaultname -n cert1 \\\n \
        ...
        \ secret list-versions --vault-name vaultname \\\n  -n cert1 --query \"[?attributes.enabled].id\"\
        \ -o tsv)\n\nvm_secrets=$(az vm secret format -s \"$secrets\") \n\naz vmss\
        \ create -g group-name -n vm-name --admin-username deploy  \\\n  --image debian\
        \ --secrets \"$vm_secrets\"\n"
-   "name": |-
...
-   "name": |-
        Delete VMs within a VMSS.
    "text": |-
        az vmss delete-instances --no-wait  --resource-group MyResourceGroup --instance-ids <instance-ids> --name MyScaleSet
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az vmss identity assign -g MyResourceGroup -n MyVmss --role Owner --scope /subscriptions/db5eb68e-73e2-4fa8-b18a-0123456789999/resourceGroups/MyResourceGroup
-   "name": |-
        Enable managed service identity on a VMSS.
    "text": |-
...
-   "name": |-
    ...
    "text": |-
        az vmss nic list --output json --query [0] --vmss-name MyVmss --resource-group MyResourceGroup
    "crafted": |-
        True
"""
