...
cli_command(__name__, 'ad app show', 'azure.cli.command_modules.role.custom#show_application', factory, exception_handler=empty_on_404)
...
cli_command(__name__, 'ad sp show', 'azure.cli.command_modules.role.custom#show_service_principal', factory, exception_handler=empty_on_404)
#RBAC related
...
cli_command(__name__, 'ad user show', 'azure.graphrbac.operations.users_operations#UsersOperations.get', factory, exception_handler=empty_on_404)
...
cli_command(__name__, 'ad group show', 'azure.graphrbac.operations.groups_operations#GroupsOperations.get', factory, exception_handler=empty_on_404)
