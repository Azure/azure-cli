...
examples:
  ...
  - name: add an API permission (autogenerated)
    text: az ad app permission add --api 00000000-0000-0000-0000-000000000000 --api-permissions 00000000-0000-0000-0000-000000000000=Scope --id 00000000-0000-0000-0000-000000000000
    crafted: true
"""
...
examples:
  ...
  - name: Grant the app an API Delegated permissions (autogenerated)
    text: az ad app permission grant --api a0322f79-57df-498f-9d9f-12678 --id 00000000-0000-0000-0000-0000000
    crafted: true
"""
...
examples:
  ...
  - name: List API permissions the application has requested (autogenerated)
    text: az ad app permission list --id 00000000-0000-0000-0000-0000000
    crafted: true
"""
...
examples:
  ...
  - name: List Oauth2 permission grants (autogenerated)
    text: az ad app permission list-grants --id 00000000-0000-0000-0000-0000000000006
    crafted: true
"""
