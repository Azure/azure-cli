...
class Create(AAZCommand):
    ...
    @classmethod
    def _build_args_backend_address_pool_create(cls, _schema):
        if cls._args_backend_address_pool_create is not None:
            _schema.etag = cls._args_backend_address_pool_create.etag
            _schema.id = cls._args_backend_address_pool_create.id
            _schema.name = cls._args_backend_address_pool_create.name
            _schema.provisioning_state = cls._args_backend_address_pool_create.provisioning_state
            return

        cls._args_backend_address_pool_create = AAZObjectArg()

        backend_address_pool_create = cls._args_backend_address_pool_create
        backend_address_pool_create.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        backend_address_pool_create.id = AAZStrArg(
            options=["id"],
            help="Resource Identifier.",
        )
        backend_address_pool_create.name = AAZStrArg(
            options=["name"],
            help="Gets name of the resource that is unique within a resource group. This name can be used to access the resource.",
        )
        backend_address_pool_create.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
    ...
    _args_inbound_nat_rule_create = None

    @classmethod
    def _build_args_inbound_nat_rule_create(cls, _schema):
        if cls._args_inbound_nat_rule_create is not None:
            _schema.backend_port = cls._args_inbound_nat_rule_create.backend_port
            _schema.enable_floating_ip = cls._args_inbound_nat_rule_create.enable_floating_ip
            _schema.etag = cls._args_inbound_nat_rule_create.etag
            _schema.frontend_ip_configuration = cls._args_inbound_nat_rule_create.frontend_ip_configuration
            _schema.frontend_port = cls._args_inbound_nat_rule_create.frontend_port
            _schema.id = cls._args_inbound_nat_rule_create.id
            _schema.idle_timeout_in_minutes = cls._args_inbound_nat_rule_create.idle_timeout_in_minutes
            _schema.name = cls._args_inbound_nat_rule_create.name
            _schema.protocol = cls._args_inbound_nat_rule_create.protocol
            _schema.provisioning_state = cls._args_inbound_nat_rule_create.provisioning_state
            return

        cls._args_inbound_nat_rule_create = AAZObjectArg()

        inbound_nat_rule_create = cls._args_inbound_nat_rule_create
        inbound_nat_rule_create.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        inbound_nat_rule_create.id = AAZStrArg(
            options=["id"],
            help="Resource Identifier.",
        )
        inbound_nat_rule_create.name = AAZStrArg(
            options=["name"],
            help="Gets name of the resource that is unique within a resource group. This name can be used to access the resource.",
        )
        inbound_nat_rule_create.backend_port = AAZIntArg(
            options=["backend-port"],
            help="The port used for the internal endpoint. Acceptable values range from 1 to 65535.",
        )
        inbound_nat_rule_create.enable_floating_ip = AAZBoolArg(
            options=["enable-floating-ip"],
            help="Configures a virtual machine's endpoint for the floating IP capability required to configure a SQL AlwaysOn Availability Group. This setting is required when using the SQL AlwaysOn Availability Groups in SQL server. This setting can't be changed after you create the endpoint.",
        )
        inbound_nat_rule_create.frontend_ip_configuration = AAZObjectArg(
            options=["frontend-ip-configuration"],
            help="A reference to frontend IP addresses.",
        )
        cls._build_args_sub_resource_create(inbound_nat_rule_create.frontend_ip_configuration)
        inbound_nat_rule_create.frontend_port = AAZIntArg(
            options=["frontend-port"],
            help="The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.",
        )
        inbound_nat_rule_create.idle_timeout_in_minutes = AAZIntArg(
            options=["idle-timeout-in-minutes"],
            help="The timeout for the TCP idle connection. The value can be set between 4 and 30 minutes. The default value is 4 minutes. This element is only used when the protocol is set to TCP.",
        )
        inbound_nat_rule_create.protocol = AAZStrArg(
            options=["protocol"],
            help="The transport protocol for the endpoint. Possible values are: 'Udp' or 'Tcp'",
            enum={"Tcp": "Tcp", "Udp": "Udp"},
        )
        inbound_nat_rule_create.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
    ...
    def _build_args_network_security_group_create(cls, _schema):
        ...
        _element = cls._args_network_security_group_create.network_interfaces.Element.ip_configurations.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        ...
        load_balancer_backend_address_pools = cls._args_network_security_group_create.network_interfaces.Element.ip_configurations.Element.load_balancer_backend_address_pools
        load_balancer_backend_address_pools.Element = AAZObjectArg()
        cls._build_args_backend_address_pool_create(load_balancer_backend_address_pools.Element)

        load_balancer_inbound_nat_rules = cls._args_network_security_group_create.network_interfaces.Element.ip_configurations.Element.load_balancer_inbound_nat_rules
        load_balancer_inbound_nat_rules.Element = AAZObjectArg()
        cls._build_args_inbound_nat_rule_create(load_balancer_inbound_nat_rules.Element)
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_backend_address_pool_create(cls, _builder):
        if _builder is None:
            return
    ...
    @classmethod
    def _build_schema_inbound_nat_rule_create(cls, _builder):
        if _builder is None:
            return
        _builder.set_prop("etag", AAZStrType, ".etag")
        _builder.set_prop("id", AAZStrType, ".id")
    ...
    def _build_schema_network_security_group_create(cls, _builder):
        ...
        if load_balancer_backend_address_pools is not None:
            cls._build_schema_backend_address_pool_create(load_balancer_backend_address_pools.set_elements(AAZObjectType, "."))
        ...
        if load_balancer_inbound_nat_rules is not None:
            cls._build_schema_inbound_nat_rule_create(load_balancer_inbound_nat_rules.set_elements(AAZObjectType, "."))
