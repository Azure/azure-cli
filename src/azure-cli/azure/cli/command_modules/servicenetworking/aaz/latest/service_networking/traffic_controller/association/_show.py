...
@register_command(
    "service-networking traffic-controller association show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a Traffic Controller Association

    :example: Get the details of an Association
        az service-networking traffic-controller association show -g testRG -n testAssociation --traffic-controller-name testTC
    """
