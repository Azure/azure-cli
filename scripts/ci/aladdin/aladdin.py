...
examples:
  - name: Approve a private endpoint connection request for a container registry. (autogenerated)
    text: az acr private-endpoint-connection approve --name myprivateendpointconnection --registry-name myregistry
    crafted: true
"""
...
examples:
  - name: Update a token (replace associated scope map) for an Azure Container Registry. (autogenerated)
    text: az acr token update --name MyToken --registry MyRegistry --scope-map MyNewScopeMap --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List streaming locators which are associated with this asset. (autogenerated)
    text: az ams asset list-streaming-locators --account-name myaccount --name myasset
    crafted: true
"""
...
examples:
  - name: Create an asset filter. (autogenerated)
    text: az ams asset-filter create --account-name amsAccount --asset-name assetName --end-timestamp 200000 --force-end-timestamp true --name filterName --resource-group resourceGroup --start-timestamp 100000 --timescale 1000
    crafted: true
"""
...
examples:
  - name: Start a streaming endpoint. (autogenerated)
    text: az ams streaming-endpoint start --account-name myaccount --name mystreamingendpoint --no-wait --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Create a function app. (autogenerated)
    ...
    crafted: true
  - name: Create a function app. (autogenerated)
    text: az functionapp create --consumption-plan-location westus --functions-version 2 --name MyUniqueAppName --resource-group MyResourceGroup --runtime dotnet --storage-account MyStorageAccount
    crafted: true
"""
...
examples:
  - name: Restore a web app snapshot. (autogenerated)
    text: az webapp config snapshot restore --name MySite --resource-group MyResourceGroup --slot staging --source-name SourceApp --source-resource-group OriginalResourceGroup --time 2018-12-11T23:34:16.8388367
    crafted: true
"""
...
examples:
  - name: Construct the recovery configuration of an Azure workload backed up item. (autogenerated)
    text: az backup recoveryconfig show --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --restore-mode AlternateWorkloadRestore --rp-name myrp --target-container-name mytargetcontainer --target-item-name mytargetitem --target-server-name mytargetserver --target-server-type SQLAG --vault-name MyVault --workload-type MSSQL
    crafted: true
"""
...
examples:
  - name: Close access to the recovery point. (autogenerated)
    text: az backup restore files unmount-rp --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --rp-name MyRp --subscription mysubscription --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: List workspaces. (autogenerated)
    text: az batchai workspace list --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb gremlin database delete --account-name myaccount --name mydatabase --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: Delete the Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph delete --account-name myaccount --database-name mydatabase --name mygraph --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: Deletes a firewall rule in a Data Lake Store account. (autogenerated)
    text: az dls account firewall delete --account mydatalakestoragegen1 --firewall-rule-name myfirewallrule
    crafted: true
"""
...
examples:
  - name: Delete a file or folder in a Data Lake Store account. (autogenerated)
    text: az dls fs delete --account dpreptestfiles --path / --recurse
    crafted: true
"""
...
examples:
  - name: Regenerate a shared access key of a topic (autogenerated)
    text: az eventgrid topic key regenerate --key-name mykey --name mytopic --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Regenerate the connection strings of Authorizationrule for the namespace. (autogenerated)
    text: az eventhubs namespace authorization-rule keys renew --key PrimaryKey --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete an IoT Central application. (autogenerated)
    text: az iot central app delete --name my-first-iot-app --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""

aladdin_helps['iot dps access-policy show'] = """
type: command
...
examples:
  - name: Show details of a shared access policies in an Azure IoT Hub device provisioning service (autogenerated)
    text: az iot dps access-policy show --access-policy-name MyPolicy --dps-name MyDps --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete a message enrichment in your IoT hub (by key). (autogenerated)
    text: az iot hub message-enrichment delete --key test --name new-policy --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Remove a Key Vault managed Azure Storage Account and all associated SAS definitions (autogenerated)
    text: az keyvault storage remove --name MyStorageAccount --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Remove action groups from this activity log alert. (autogenerated)
    text: az monitor activity-log alert action-group remove --action-group /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/microsoft.insights/actionGroups/{ActionGroup} --name myactivitylogalerts --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete a linked service. (autogenerated)
    text: az monitor log-analytics workspace linked-service delete --name cluster --resource-group MyResourceGroup --subscription mysubscription --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update a workspace instance. (autogenerated)
    text: az monitor log-analytics workspace update --resource-group myresourcegroup --retention-time 30 --workspace-name myworkspace
    crafted: true
"""
...
examples:
  - name: List all scoped resource of a private link scope resource. (autogenerated)
    text: az monitor private-link-scope scoped-resource list --resource-group myresourcegroup --scope-name myscope
    crafted: true
"""
...
examples:
  - name: Create HTTP settings. (autogenerated)
    ...
    crafted: true
  - name: Create HTTP settings. (autogenerated)
    text: az network application-gateway http-settings create --cookie-based-affinity Enabled --gateway-name MyAppGateway --name MyHttpSettings --port 80 --probe MyNewProbe --protocol Http --resource-group MyResourceGroup --timeout 30
    crafted: true
"""
...
examples:
  - name: Update HTTP settings. (autogenerated)
    ...
    crafted: true
  - name: Update HTTP settings. (autogenerated)
    text: az network application-gateway http-settings update --gateway-name MyAppGateway --host-name-from-backend-pool true --name MyHttpSettings --port 80 --probe MyNewProbe --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule create --action Allow --name mywafpolicyrule --policy-name mypolicy --priority 500 --resource-group myresourcegroup --rule-type MatchRule
    crafted: true
"""
...
examples:
  - name: Delete an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule delete --name mywafpolicyrule --policy-name mypolicy --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Override rules under rule group EQUEST-921-PROTOCOL-ATTACK (autogenerated)
    text: az network application-gateway waf-policy managed-rule rule-set update --group-name REQUEST-921-PROTOCOL-ATTACK --policy-name MyPolicy --resource-group MyResourceGroup --rules 921130 921160 --type Microsoft_BotManagerRuleSet --version 0.1
    crafted: true
"""
...
aladdin_helps['network dns record-set ns show'] = """
type: command
short-summary: Get the details of an NS record set.
examples:
  - name: Get the details of an NS record set. (autogenerated)
    text: az network dns record-set ns show --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty SRV record set. (autogenerated)
    text: az network dns record-set srv create --metadata owner=WebTeam --name MyRecordSet --resource-group MyResourceGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update settings of an ExpressRoute circuit. (autogenerated)
    text: az network express-route update --allow-global-reach true --name MyCircuit --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update an inbound NAT address pool. (autogenerated)
    ...
    crafted: true
  - name: Update an inbound NAT address pool. (autogenerated)
    text: az network lb inbound-nat-pool update --backend-port 8080 --floating-ip true --frontend-port-range-end 89 --frontend-port-range-start 80 --lb-name MyLb --name MyNatPool --protocol Udp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a route in a route table. (autogenerated)
    ...
    crafted: true
  - name: Update a route in a route table. (autogenerated)
    text: az network route-table route update --name MyRoute --next-hop-ip-address 10.0.100.5 --next-hop-type VirtualNetworkGateway --resource-group MyResourceGroup --route-table-name MyRouteTable
    crafted: true
"""
...
aladdin_helps['network vrouter list'] = """
type: command
...
examples:
  - name: List all virtual routers under a subscription or a resource group. (autogenerated)
    text: az network vrouter list --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Update a virtual router. (autogenerated)
    text: az network vrouter update --name myvirtualrouter --resource-group myresourcegroup --tags super_secure no_80 no_22
    crafted: true
"""
...
examples:
  - name: Update an AAAA record set. (autogenerated)
    text: az network private-dns record-set aaaa update --name MyRecordSet --resource-group MyResourceGroup --set useRemoteGateways=true --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['network private-dns record-set cname remove-record'] = """
type: command
...
examples:
  - name: Remove a CNAME record from its record set. (autogenerated)
    text: az network private-dns record-set cname remove-record --cname www.contoso.com --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network private-dns record-set mx add-record'] = """
type: command
short-summary: Add an MX record.
examples:
  - name: Add an MX record. (autogenerated)
    text: az network private-dns record-set mx add-record --exchange mail.mysite.com --preference 10 --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty MX record set. (autogenerated)
    text: az network private-dns record-set mx create --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --ttl 300 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the Private DNS zone is met. (autogenerated)
    text: az network private-dns zone wait --exists --name www.mysite.com --resource-group MyResourceGroup --timeout 60
    crafted: true
"""
...
examples:
  - name: Create a MariaDB database. (autogenerated)
    text: az mariadb db create --name testdb --resource-group testgroup --server-name testsvr --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a database. (autogenerated)
    text: az mariadb db show --name testdb --resource-group testgroup --server-name testsvr --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at management group. (autogenerated)
    text: az deployment mg validate --location WestUS --management-group-id testmg --name mydeployment --parameters MyValue=This MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: List deployment operations at management group. (autogenerated)
    text: az deployment operation mg list --management-group-id testrg --name mydeployment
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a deployment condition is met. (autogenerated)
    text: az deployment sub wait --created --name MyDeployment
    crafted: true
"""
...
examples:
  - name: Update a resource-level lock. (autogenerated)
    text: az resource lock update --ids /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Web/sites/{WebApp} --lock-type CanNotDelete
    crafted: true
"""
...
examples:
  - name: Update a resource. (autogenerated)
    ...
    crafted: true
  - name: Update a resource. (autogenerated)
    text: az resource update --name myresource --resource-group myresourcegroup --resource-type subnets --set tags.key=value
    crafted: true
"""
...
examples:
  - name: Shows a security alert. (autogenerated)
    text: |
        az security alert show --location "centralus" --name "alertName" --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['servicebus georecovery-alias authorization-rule keys list'] = """
type: command
short-summary: List the keys and connection strings of Authorization Rule for the Service Bus Namespace
examples:
  - name: List the keys and connection strings of Authorization Rule for the Service Bus Namespace (autogenerated)
    text: az servicebus georecovery-alias authorization-rule keys list --alias myaliasname --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""

aladdin_helps['servicebus georecovery-alias break-pair'] = """
type: command
...
examples:
  - name: Disables Service Bus Geo-Disaster Recovery Configuration Alias and stops replicating changes from primary to secondary namespaces. (autogenerated)
    text: az servicebus georecovery-alias break-pair --alias myaliasname --namespace-name primarynamespace --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create the data policy rules associated with the specified storage account. (autogenerated)
    text: az storage account management-policy create --account-name myaccount --policy @policy.json --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Upload a file to a storage blob. (autogenerated)
    text: az storage blob upload --account-key 0000-0000 --account-name mystorageaccount --container-name MyContainer --file /path/to/file --name MyBlob
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file (autogenerated)
    text: az storage file generate-sas --account-name MyStorageAccount --expiry 2037-12-31T23:59:00Z --https-only --path path/file.txt --permissions rcdw --share-name MyShare --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete a file system in ADLS Gen2 account. (autogenerated)
    text: az storage fs delete --account-name myadlsaccount --auth-mode login --name myfilesystem
    crafted: true
"""
...
examples:
  - name: Check for the existence of a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory exists --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir
    crafted: true
"""
...
examples:
  - name: Move a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory move --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir --new-directory newfs/dir
    crafted: true
"""
...
examples:
  - name: Show properties of a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory show --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir
    crafted: true
"""
...
examples:
  - name: Show properties of file in ADLS Gen2 file system. (autogenerated)
    text: az storage fs file show --account-name myadlsaccount --auth-mode login --file-system fsname --path dir/a.txt
    crafted: true
"""
...
aladdin_helps['storage fs metadata show'] = """
type: command
...
examples:
  - name: Return all user-defined metadata for the specified file system. (autogenerated)
    text: az storage fs metadata show --account-name myadlsaccount --auth-mode login --name myfilesystem
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a managed disk is met (autogenerated)
    text: az disk wait --exists --name MyManagedDisk --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update --exclude-from-latest. If it is set to true, people deploying VMs with version omitted will not use this version. (autogenerated)
    text: az sig image-version update --gallery-image-definition MyImage --gallery-image-version 1.0.0 --gallery-name MyGallery --resource-group MyResourceGroup --set publishingProfile.excludeFromLatest=true
    crafted: true
"""
...
examples:
  - name: Update a dedicated host. (autogenerated)
    text: az vm host update --host-group my-host-group --name my-host --remove tags.tagName --resource-group my-resource-group
    crafted: true
"""
...
examples:
  - name: List the metric definitions for a VM. (autogenerated)
    text: az vm monitor metrics list-definitions --name MyIDVirtualMachine --resource-group MyResourceGroup
    crafted: true
"""
