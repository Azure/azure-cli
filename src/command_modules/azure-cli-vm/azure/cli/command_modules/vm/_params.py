...
register_cli_argument('vmss create', 'enable_autoscale', arg_group='Autoscale', action='store_true', help='Create with CPU-based autoscale settings. Assumed if one or more scaling arguments are supplied.')
register_cli_argument('vmss create', 'scale_out_cpu', arg_group='Autoscale', help='CPU percentage at which which to scale out.')
register_cli_argument('vmss create', 'scale_out_increment', arg_group='Autoscale', help='Number of VM instances to add when scaling out.')
register_cli_argument('vmss create', 'scale_out_max', arg_group='Autoscale', help='Maximum number of VMs to provision.')
register_cli_argument('vmss create', 'scale_in_cpu', arg_group='Autoscale', help='CPU percentage at which to scale in.')
register_cli_argument('vmss create', 'scale_in_increment', arg_group='Autoscale', help='Number of VM instances to remove when scaling in.')
register_cli_argument('vmss create', 'scale_in_min', arg_group='Autoscale', help='Minimum number of VMs to keep provisioned.')
