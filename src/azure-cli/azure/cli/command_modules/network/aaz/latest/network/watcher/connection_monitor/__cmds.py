...
@register_command(
    "network watcher connection-monitor stop",
)
class Stop(AAZCommand):
    """Stop the specified connection monitor.

    :example: Stop the specified connection monitor.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ConnectionMonitorsStop(ctx=self.ctx)()
        self.post_operations()
    ...
    class ConnectionMonitorsStop(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
@register_command(
    "network watcher connection-monitor wait",
)
class Wait(AAZWaitCommand):
    ...
    class ConnectionMonitorsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            exclude = cls._schema_on_200.properties.endpoints.Element.scope.exclude
            exclude.Element = AAZObjectType()
            _WaitHelper._build_schema_connection_monitor_endpoint_scope_item_read(exclude.Element)

            include = cls._schema_on_200.properties.endpoints.Element.scope.include
            include.Element = AAZObjectType()
            _WaitHelper._build_schema_connection_monitor_endpoint_scope_item_read(include.Element)
...
@link_helper(
    __package__,
    ("_build_schema_connection_monitor_endpoint_scope_item_read", _Helper),
)
class _CreateHelper:
...
__all__ = ["Create","Delete","List","Query","Show","Start","Stop","Update","Wait","__CMDGroup"]
