...
helps['ams account update'] = """
    ...
    examples:
      - name: Update the details of an Azure Media Services account. (autogenerated)
        text: |
            az ams account update --name MyAzureMediaServicesAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account show'] = """
    ...
    examples:
      - name: Show the details of an Azure Media Services account. (autogenerated)
        text: |
            az ams account show --name MyAzureMediaServicesAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account delete'] = """
    ...
    examples:
      - name: Delete an Azure Media Services account. (autogenerated)
        text: |
            az ams account delete --name MyAzureMediaServicesAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account check-name'] = """
    ...
    examples:
      - name: Checks whether the Media Service resource name is available. (autogenerated)
        text: |
            az ams account check-name --location westus2 --name MyAzureMediaServicesAccount
        crafted: true
"""
...
helps['ams account storage add'] = """
    ...
    examples:
      - name: Attach a secondary storage to an Azure Media Services account. (autogenerated)
        text: |
            az ams account storage add --account-name MyAccount --name MyResourceIDSecondaryStorageAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account storage remove'] = """
    ...
    examples:
      - name: Detach a secondary storage from an Azure Media Services account. (autogenerated)
        text: |
            az ams account storage remove --account-name MyAccount --name MyResourceIDSecondaryStorageAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account sp reset-credentials'] = """
    ...
    examples:
      - name: Generate a new client secret for a service principal configured for an Azure Media Services account. (autogenerated)
        text: |
            az ams account sp reset-credentials --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams transform list'] = """
    ...
    examples:
      - name: List all the transforms of an Azure Media Services account. (autogenerated)
        text: |
            az ams transform list --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams transform show'] = """
    ...
    examples:
      - name: Show the details of a transform. (autogenerated)
        text: |
            az ams transform show --account-name MyAccount --name MyTransform --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams transform create'] = """
    ...
    examples:
        ...
        - name: Create a transform. (autogenerated)
          text: |
              az ams transform create --account-name myAmsAccount --description newDescription --name transformName --preset "C:MyPresetsCustomPreset.json" --resource-group myResourceGroup
          crafted: true
    """
...
helps['ams transform delete'] = """
    ...
    examples:
      - name: Delete a transform. (autogenerated)
        text: |
            az ams transform delete --account-name MyAccount --name MyTransform --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams asset show'] = """
    ...
    examples:
      - name: Show the details of an asset. (autogenerated)
        text: |
            az ams asset show --account-name MyAccount --name MyAsset --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams asset list-streaming-locators'] = """
    ...
    examples:
      - name: List streaming locators which are associated with this asset. (autogenerated)
        text: |
            az ams asset list-streaming-locators --account-name MyAccount --name MyAsset --resource-group MyResourceGroup --subscription MySubscription
        crafted: true
"""
...
helps['ams asset create'] = """
    ...
    examples:
      - name: Create an asset. (autogenerated)
        text: |
            az ams asset create --account-name MyAccount --name MyAsset --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams asset update'] = """
    ...
    examples:
      - name: Update the details of an asset. (autogenerated)
        text: |
            az ams asset update --account-name MyAccount --name MyAsset --resource-group MyResourceGroup --set outputs[0].relativePriority=High
        crafted: true
"""
...
helps['ams asset delete'] = """
    ...
    examples:
      - name: Delete an asset. (autogenerated)
        text: |
            az ams asset delete --account-name MyAccount --name MyAsset --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams asset get-sas-urls'] = """
    ...
    examples:
      - name: Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content. The signatures are derived from the storage account keys. (autogenerated)
        text: |
            az ams asset get-sas-urls --account-name MyAccount --expiry 2019-02-01T12:20:00Z --name MyAsset --permissions Read
        crafted: true
      - name: Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content. The signatures are derived from the storage account keys. (autogenerated)
        text: |
            az ams asset get-sas-urls --account-name MyAccount --name MyAsset --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams asset-filter list'] = """
    ...
    examples:
      - name: List all the asset filters of an Azure Media Services account. (autogenerated)
        text: |
            az ams asset-filter list --account-name MyAccount --asset-name MyAsset --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams content-key-policy show'] = """
    ...
    examples:
      - name: Show an existing content key policy. (autogenerated)
        text: |
            az ams content-key-policy show --account-name MyAccount --name MyContentKeyPolicy --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams content-key-policy delete'] = """
    ...
    examples:
      - name: Delete a content key policy. (autogenerated)
        text: |
            az ams content-key-policy delete --account-name MyAccount --name MyContentKeyPolicy --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams content-key-policy list'] = """
    ...
    examples:
      - name: List all the content key policies within an Azure Media Services account. (autogenerated)
        text: |
            az ams content-key-policy list --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams job update'] = """
    ...
    examples:
      - name: Update an existing job. (autogenerated)
        text: |
            az ams job update --account-name MyAccount --description newDescription --name MyJob --resource-group MyResourceGroup --transform-name MyTransform
        crafted: true
      - name: Update an existing job. (autogenerated)
        text: |
            az ams job update --account-name MyAccount --name MyJob --resource-group MyResourceGroup --set outputs[0].relativePriority=High --transform-name MyTransform
        crafted: true
"""
...
helps['ams job show'] = """
    ...
    examples:
      - name: Show the details of a job. (autogenerated)
        text: |
            az ams job show --account-name MyAccount --name MyJob --resource-group MyResourceGroup --transform-name MyTransform
        crafted: true
"""
...
helps['ams job delete'] = """
    ...
    examples:
      - name: Delete a job. (autogenerated)
        text: |
            az ams job delete --account-name MyAccount --name MyJob --resource-group MyResourceGroup --transform-name MyTransform
        crafted: true
"""
...
helps['ams job cancel'] = """
    ...
    examples:
      - name: Cancel a job. (autogenerated)
        text: |
            az ams job cancel --account-name MyAccount --name MyJob --resource-group MyResourceGroup --transform-name MyTransform
        crafted: true
"""
...
helps['ams streaming-locator create'] = """
    ...
    examples:
      - name: Create a streaming locator. (autogenerated)
        text: |
            az ams streaming-locator create --account-name MyAccount --asset-name MyAsset --name MyStreamingLocator --resource-group MyResourceGroup --streaming-policy-name MyStreamingPolicy
        crafted: true
"""
...
helps['ams streaming-locator list'] = """
    ...
    examples:
      - name: List all the streaming locators within an Azure Media Services account. (autogenerated)
        text: |
            az ams streaming-locator list --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-locator show'] = """
    ...
    examples:
      - name: Show the details of a streaming locator. (autogenerated)
        text: |
            az ams streaming-locator show --account-name MyAccount --name MyStreamingLocator --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-locator get-paths'] = """
    ...
    examples:
      - name: List paths supported by a streaming locator. (autogenerated)
        text: |
            az ams streaming-locator get-paths --account-name MyAccount --name MyStreamingLocator --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-locator list-content-keys'] = """
    ...
    examples:
      - name: List content keys used by a streaming locator. (autogenerated)
        text: |
            az ams streaming-locator list-content-keys --account-name MyAccount --name MyStreamingLocator --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-policy list'] = """
    ...
    examples:
      - name: List all the streaming policies within an Azure Media Services account. (autogenerated)
        text: |
            az ams streaming-policy list --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-policy show'] = """
    ...
    examples:
      - name: Show the details of a streaming policy. (autogenerated)
        text: |
            az ams streaming-policy show --account-name MyAccount --name MyStreamingPolicy --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-endpoint start'] = """
    ...
    examples:
      - name: Start a streaming endpoint. (autogenerated)
        text: |
            az ams streaming-endpoint start --account-name MyAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-endpoint stop'] = """
    ...
    examples:
      - name: Stop a streaming endpoint. (autogenerated)
        text: |
            az ams streaming-endpoint stop --account-name MyAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-endpoint list'] = """
    ...
    examples:
      - name: List all the streaming endpoints within an Azure Media Services account. (autogenerated)
        text: |
            az ams streaming-endpoint list --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-endpoint show'] = """
    ...
    examples:
      - name: Show the details of a streaming endpoint. (autogenerated)
        text: |
            az ams streaming-endpoint show --account-name MyAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-endpoint delete'] = """
    ...
    examples:
      - name: Delete a streaming endpoint. (autogenerated)
        text: |
            az ams streaming-endpoint delete --account-name MyAccount --name MyStreamingEndpoint --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams streaming-endpoint update'] = """
    ...
    examples:
      - name: Update the details of a streaming endpoint. (autogenerated)
        text: |
            az ams streaming-endpoint update --account-name MyAccount --disable-cdn --name MyStreamingEndpoint --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams live-event create'] = """
    ...
    examples:
      - name: Create a live event. (autogenerated)
        text: |
            az ams live-event create --account-name MyAccount --ips 1.2.3.4/22 5.6.7.8/30 --name MyLiveEvent --resource-group MyResourceGroup --streaming-protocol FragmentedMP4
        crafted: true
"""
...
helps['ams live-event start'] = """
    ...
    examples:
      - name: Start a live event. (autogenerated)
        text: |
            az ams live-event start --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams live-event show'] = """
    ...
    examples:
      - name: Show the details of a live event. (autogenerated)
        text: |
            az ams live-event show --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams live-event delete'] = """
    ...
    examples:
      - name: Delete a live event. (autogenerated)
        text: |
            az ams live-event delete --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
        crafted: true
"""
...
helps['ams live-event stop'] = """
    ...
    examples:
      - name: Stop a live event. (autogenerated)
        text: |
            az ams live-event stop --account-name MyAccount --name MyLiveEvent --remove-outputs-on-stop --resource-group MyResourceGroup --subscription MySubscription
        crafted: true
"""
...
helps['ams live-event reset'] = """
    ...
    examples:
      - name: Reset a live event. (autogenerated)
        text: |
            az ams live-event reset --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
        crafted: true
"""
...
helps['ams live-output show'] = """
    ...
    examples:
      - name: Show the details of a live output. (autogenerated)
        text: |
            az ams live-output show --account-name MyAccount --live-event-name MyLiveEvent --name MyLiveOutput --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams live-output list'] = """
    ...
    examples:
      - name: List all the live outputs in a live event. (autogenerated)
        text: |
            az ams live-output list --account-name MyAccount --live-event-name MyLiveEvent --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams live-output delete'] = """
    ...
    examples:
      - name: Delete a live output. (autogenerated)
        text: |
            az ams live-output delete --account-name MyAccount --live-event-name MyLiveEvent --name MyLiveOutput --resource-group MyResourceGroup --subscription MySubscription
        crafted: true
"""
...
helps['ams account-filter show'] = """
    ...
    examples:
      - name: Show the details of an account filter. (autogenerated)
        text: |
            az ams account-filter show --account-name MyAccount --name MyAccountFilter --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account-filter list'] = """
    ...
    examples:
      - name: List all the account filters of an Azure Media Services account. (autogenerated)
        text: |
            az ams account-filter list --account-name MyAccount --resource-group MyResourceGroup
        crafted: true
"""
...
helps['ams account mru show'] = """
    ...
    examples:
      - name: Show the details of media reserved units for an Azure Media Services account. (autogenerated)
        text: |
            az ams account mru show --name MyAzureMediaServicesAccount --resource-group MyResourceGroup
        crafted: true
"""
