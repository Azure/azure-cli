...
class List(AAZCommand):
    ...
    :example: List all test groups of a connection monitor.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.testGroups

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.testGroups = value
            return
...
@register_command(
    "network watcher connection-monitor test-group wait",
)
...
__all__ = ["Add","List","Show","Wait","__CMDGroup"]
