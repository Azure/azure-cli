...
class Delete(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.certificate_name = AAZStrArg(
            ...
            help="Name of of the certificate to delete.",
            required=True,
    ...
    def _execute_operations(self):
        yield self.ServerTrustCertificatesDelete(ctx=self.ctx)()

    class ServerTrustCertificatesDelete(AAZHttpOperation):
