...
class List(AAZCommand):
    ...
    :example: SshPublicKey_ListBySubscription_MaximumSet_Gen
        az sshkey list
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.SshPublicKeysListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.SshPublicKeysListByResourceGroup(ctx=self.ctx)()
    ...
    class SshPublicKeysListBySubscription(AAZHttpOperation):
    ...
    class SshPublicKeysListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
