...
def load_command_table(self, _):
    ...
    action_group_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2019_06_01.operations#ActionGroupsOperations.{}',
    ...
    activity_log_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2015_04_01.operations#EventCategoriesOperations.{}',
        client_factory=cf_event_categories,
        exception_handler=monitor_exception_handler)

    activity_log_alerts_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2017_04_01.operations#ActivityLogAlertsOperations.{}',
    ...
    alert_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2016_03_01.operations#AlertRulesOperations.{}',
        client_factory=cf_alert_rules,
        exception_handler=monitor_exception_handler)

    alert_rule_incidents_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2016_03_01.operations#AlertRuleIncidentsOperations.{}',
        client_factory=cf_alert_rule_incidents,
        exception_handler=monitor_exception_handler)

    autoscale_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2015_04_01.operations#AutoscaleSettingsOperations.{}',
    ...
    diagnostics_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2017_05_01_preview.operations#DiagnosticSettingsOperations.{}',
        client_factory=cf_diagnostics,
        exception_handler=monitor_exception_handler)

    diagnostics_categories_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2017_05_01_preview.operations#DiagnosticSettingsCategoryOperations.{}',
        client_factory=cf_diagnostics,
        exception_handler=monitor_exception_handler)
    ...
    log_profiles_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2016_03_01.operations#LogProfilesOperations.{}',
    ...
    metric_alert_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2018_03_01.operations#MetricAlertsOperations.{}',
        client_factory=cf_metric_alerts,
        exception_handler=monitor_exception_handler)

    metric_definitions_sdk = CliCommandType(
        operations_tmpl='azure.mgmt.monitor.v2018_01_01.operations#MetricDefinitionsOperations.{}',
