...
examples:
-   name: List registered clouds.
    text: az cloud list --output json
    crafted: 'True'
"""
...
long-summary: When registering a cloud, specify only the resource manager endpoint
    for the autodetection of other endpoints.
"""
...
examples:
-   name: Get the details of a registered cloud.
    text: az cloud show --output json --query [0]
    crafted: 'True'
"""
