...
examples:
  - name: Configure deployment slot auto swap. (autogenerated)
    text: |
        az functionapp deployment slot auto-swap --disable --name MyFunctionApp --resource-group MyResourceGroup --slot staging
    crafted: true
"""
...
examples:
  ...
  - name: Create an App Service Plan for an Azure Function. (autogenerated)
    text: |
        az functionapp plan create --is-linux true --location westus2 --name MyPlan --number-of-workers 1 --resource-group MyResourceGroup --sku B1
    crafted: true
"""
...
examples:
  - name: Delete an App Service Plan. (autogenerated)
    text: |
        az functionapp plan delete --name MyAppServicePlan --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Bind a hostname to a web app. (autogenerated)
    text: |
        az webapp config hostname add --hostname $fqdn --resource-group MyResourceGroup --webapp-name MyWebapp
    crafted: true
"""
...
helps['appservice ase show'] = """
    ...
    - name: Show details of an app service environment. (autogenerated)
      text: |
          az appservice ase show --name MyAseName --resource-group MyResourceGroup
      crafted: true
"""
