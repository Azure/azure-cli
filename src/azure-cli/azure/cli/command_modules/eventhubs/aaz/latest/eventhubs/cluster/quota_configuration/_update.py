...
@register_command(
    "eventhubs cluster quota-configuration update",
)
class Update(AAZCommand):
    ...
    :example: ClustersQuotasConfigurationPatch
        az eventhubs cluster quota-configuration update --resource-group ArunMonocle --cluster-name testCluster --settings "{eventhub-per-namespace-quota:20,namespaces-per-cluster-quota:200}"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.settings = AAZDictArg(
            ...
            help="All possible Cluster settings - a collection of key/value paired settings which apply to quotas and configurations imposed on the cluster.",
        )
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ConfigurationPatch(ctx=self.ctx)()
    ...
    class ConfigurationPatch(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _schema_on_200_201.settings = AAZDictType()

            settings = cls._schema_on_200_201.settings
