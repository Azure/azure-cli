...
class AKSAgentPoolContextTestCase(unittest.TestCase):
    ...
    def test__init__(self):
        ...
        with self.assertRaises(CLIInternalError):
            AKSAgentPoolContext(self.cmd, AKSAgentPoolParamDict({}), self.models, decorator_mode=1)

    def test_attach_agentpool(self):
        ctx_1 = AKSAgentPoolContext(self.cmd, AKSAgentPoolParamDict({}), self.models, decorator_mode=DecoratorMode.CREATE)
    ...
    def test_validate_counts_in_autoscaler(self):
        ctx = AKSAgentPoolContext(self.cmd, AKSAgentPoolParamDict({}), self.models, decorator_mode=DecoratorMode.CREATE)
        # default
