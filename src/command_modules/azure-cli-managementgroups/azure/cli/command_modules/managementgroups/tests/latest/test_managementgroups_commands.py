...
class AzureManagementGroupsScenarioTest(ScenarioTest):
    def test_list_managementgroups(self):
        managementgroups_list = self.cmd(
            'managementgroups group list').get_output_in_json()
    ...
    def test_get_managementgroup(self):
        managementgroup_get = self.cmd(
            'managementgroups group get --group-name testGroup123').get_output_in_json()
    ...
    def test_get_managementgroup_with_expand(self):
        managementgroup_get = self.cmd(
            'managementgroups group get --group-name testGroup123 --expand').get_output_in_json()
        self.assertIsNotNone(managementgroup_get)
        self.assertIsNotNone(managementgroup_get["details"])
        self.assertIsNotNone(
            managementgroup_get["details"]["parent"]["displayName"])
    ...
    def test_get_managementgroup_with_expand_and_recurse(self):
        managementgroup_get = self.cmd(
            'managementgroups group get --group-name testGroup123 --expand --recurse').get_output_in_json()
        self.assertIsNotNone(managementgroup_get)
        self.assertIsNotNone(managementgroup_get["details"])
        self.assertIsNotNone(
            managementgroup_get["details"]["parent"]["displayName"])
    ...
    def test_new_managementgroup(self):
        ...
        managementgroup_create = self.cmd(
            'managementgroups group new --group-name ' +
    ...
    def test_update_managementgroup_with_displayname(self):
        ...
        managementgroup_update = self.cmd(
            'managementgroups group update --group-name ' +
            name +
            ' --display-name ' +
            displayName).get_output_in_json()
