...
examples:
  ...
  - name: Shows the ServiceBus Rule details. (autogenerated)
...
examples:
  ...
  - name: Updates the Service Bus Topic (autogenerated)
    ...
    crafted: true
  - name: Updates the Service Bus Topic (autogenerated) (autogenerated)
    text: az servicebus topic update --auto-delete-on-idle PT3M --name mytopic --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
  - name: Updates the Service Bus Topic (autogenerated)
    text: az servicebus topic update --name mytopic --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
