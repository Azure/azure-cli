...
class List(AAZCommand):
    ...
    class VirtualNetworksList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            address_space = cls._schema_on_200.value.Element.properties.address_space
            address_space.address_prefixes = AAZListType(
                serialized_name="addressPrefixes",
            )

            address_prefixes = cls._schema_on_200.value.Element.properties.address_space.address_prefixes
