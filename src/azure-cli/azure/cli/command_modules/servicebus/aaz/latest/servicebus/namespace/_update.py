...
class _UpdateHelper:
    ...
    def _build_schema_sb_namespace_read(cls, _schema):
        ...
        sb_namespace_read.identity = AAZIdentityObjectType()
        ...
        platform_capabilities = _schema_sb_namespace_read.properties.platform_capabilities
        platform_capabilities.confidential_compute = AAZObjectType(
            serialized_name="confidentialCompute",
        )

        confidential_compute = _schema_sb_namespace_read.properties.platform_capabilities.confidential_compute
