...
class DiskOperations(object):
    ...
    def attach_disk(
            self, resource_group_name, lab_name, user_name, name, attach_disk_properties, custom_headers=None, raw=False, **operation_config):
        ...
        :param name: The name of the disk.
        :type name: str
        :param attach_disk_properties:
        :type attach_disk_properties: :class:`AttachDiskProperties
         <azure.mgmt.devtestlabs.models.AttachDiskProperties>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def detach_disk(
            self, resource_group_name, lab_name, user_name, name, detach_disk_properties, custom_headers=None, raw=False, **operation_config):
        ...
        :param name: The name of the disk.
        :type name: str
        :param detach_disk_properties:
        :type detach_disk_properties: :class:`DetachDiskProperties
         <azure.mgmt.devtestlabs.models.DetachDiskProperties>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
