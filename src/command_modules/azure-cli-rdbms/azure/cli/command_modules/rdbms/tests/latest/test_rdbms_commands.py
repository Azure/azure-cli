    ...
    def _test_replica_mgmt(self, resource_group, database_engine):
        ...
        result = self.cmd('{} server create -g {} --name {} -l brazilsouth '
                          ...
                          checks=[
                              ...
                              JMESPathCheck('primaryServerId', '')]).get_output_in_json()
        ...
        self.cmd('{} server replica create -g {} -n {} '
                 ...
                 checks=[
                     ...
                     JMESPathCheck('primaryServerId', result['id']),
        ...
        # test replica stop
        self.cmd('{} server replica stop -g {} -n {}'
        ...
        # test show server with replication info, primary becomes normal server
        self.cmd('{} server show -g {} --name {}'
                 .format(database_engine, resource_group, server),
                 checks=[
                     JMESPathCheck('replicationRole', 'None'),
        ...
        sleep(300)
        # test show server with replication info, replica was auto stopped after primary deleted
        self.cmd('{} server show -g {} --name {}'
