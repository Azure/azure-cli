...
class List(AAZCommand):
    ...
    class VirtualNetworksList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            ip_allocations.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(ip_allocations.Element)
            ...
            remote_bgp_communities = cls._schema_on_200.value.Element.properties.virtual_network_peerings.Element.properties.remote_bgp_communities
            remote_bgp_communities.regional_community = AAZStrType(
                serialized_name="regionalCommunity",
                flags={"read_only": True},
            )
            ...
            remote_virtual_network_encryption = cls._schema_on_200.value.Element.properties.virtual_network_peerings.Element.properties.remote_virtual_network_encryption
            remote_virtual_network_encryption.enabled = AAZBoolType(
                flags={"required": True},
            )
            remote_virtual_network_encryption.enforcement = AAZStrType()
...
class Wait(AAZWaitCommand):
    ...
    class VirtualNetworksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            ip_allocations = cls._schema_on_200.properties.ip_allocations
            ip_allocations.Element = AAZObjectType()
            _WaitHelper._build_schema_sub_resource_read(ip_allocations.Element)
...
@link_helper(
    ...
    ("_build_schema_extended_location_read", _Helper),
    ("_build_schema_frontend_ip_configuration_read", _Helper),
    ...
    ("_build_schema_private_endpoint_read", _Helper),
    ("_build_schema_private_link_service_connection_state_read", _Helper),
    ("_build_schema_private_link_service_connection_read", _Helper),
...
class _UpdateHelper:
    ...
    def _build_schema_virtual_network_read(cls, _schema):
        if cls._schema_virtual_network_read is not None:
            ...
            _schema.extended_location = cls._schema_virtual_network_read.extended_location
        ...
        virtual_network_read.extended_location = AAZObjectType(
            serialized_name="extendedLocation",
        )
        cls._build_schema_extended_location_read(virtual_network_read.extended_location)
        ...
        bgp_communities = _schema_virtual_network_read.properties.bgp_communities
        bgp_communities.regional_community = AAZStrType(
            serialized_name="regionalCommunity",
            flags={"read_only": True},
        )
        ...
        encryption = _schema_virtual_network_read.properties.encryption
        encryption.enabled = AAZBoolType(
            flags={"required": True},
        )
        encryption.enforcement = AAZStrType()

        ip_allocations = _schema_virtual_network_read.properties.ip_allocations
        ip_allocations.Element = AAZObjectType()
        cls._build_schema_sub_resource_read(ip_allocations.Element)
        ...
        remote_bgp_communities = _schema_virtual_network_read.properties.virtual_network_peerings.Element.properties.remote_bgp_communities
        remote_bgp_communities.regional_community = AAZStrType(
            serialized_name="regionalCommunity",
            flags={"read_only": True},
        )
        ...
        remote_virtual_network_encryption = _schema_virtual_network_read.properties.virtual_network_peerings.Element.properties.remote_virtual_network_encryption
        remote_virtual_network_encryption.enabled = AAZBoolType(
            flags={"required": True},
        )
        remote_virtual_network_encryption.enforcement = AAZStrType()
...
__all__ = ["CheckIpAddress","Create","Delete","List","ListEndpointServices","Show","Update","Wait","__CMDGroup"]
