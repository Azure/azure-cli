...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr artifact-streaming') as c:
        c.argument('repository', required=True, help="The name of the repository.")
        c.argument('image', arg_type=image_by_tag_or_digest_type, required=True)
        c.argument('enable_streaming', required=True, help="Indicates whether artifact streaming is enabled for a repository.", arg_type=get_three_state_flag())
        c.argument('operation_id', options_list=['--id'], required=True, help="The ID returned when creating a streaming artifact.")
