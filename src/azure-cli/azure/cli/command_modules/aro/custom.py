...
def aro_create(cmd,  # pylint: disable=too-many-locals
    ...
    assign_contributor_to_vnet(cmd.cli_ctx, vnet, client_sp.object_id, 'client', tags)
    assign_contributor_to_vnet(cmd.cli_ctx, vnet, rp_client_sp.object_id, 'rp_client', tags)
