...
class GetCircuitLinkFailoverSingleTestDetail(AAZCommand):
    ...
    :example: ExpressRouteCircuitLinkFailoverSingleTestDetails
        az network express-route get-circuit-link-failover-single-test-detail --resource-group rg1 --name erckt --failover-test-id fe458ae8-d2ae-4520-a104-44bc233bde7e --link-type Primary --maintenance-category BgpDisconnect
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpressRouteCircuitsGetCircuitLinkFailoverSingleTestDetails(ctx=self.ctx)()
    ...
    class ExpressRouteCircuitsGetCircuitLinkFailoverSingleTestDetails(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _GetCircuitLinkFailoverSingleTestDetailHelper._build_schema_express_route_link_failover_route_list_read(_element.non_redundant_routes)
            _element.redundant_routes = AAZObjectType(
                serialized_name="redundantRoutes",
                flags={"read_only": True},
            )
            _GetCircuitLinkFailoverSingleTestDetailHelper._build_schema_express_route_link_failover_route_list_read(_element.redundant_routes)
...
class _GetCircuitLinkFailoverSingleTestDetailHelper:
    """Helper class for GetCircuitLinkFailoverSingleTestDetail"""
...
__all__ = ["GetCircuitLinkFailoverSingleTestDetail"]