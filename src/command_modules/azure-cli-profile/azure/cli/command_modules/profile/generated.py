...
cli_command(command_table, 'account list', list_subscriptions, '[Subscription]')
cli_command(command_table, 'account set', set_active_subscription, 'Result')
cli_command(command_table, 'account clear', account_clear, 'Result')
