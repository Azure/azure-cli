...
# region - Eventhub Create
    ...
    for scope in ['eventhubs eventhub create']:
        with self.argument_context(scope) as c:
            ...
            c.argument('mi_system_assigned', arg_group='Capture-Identity', arg_type=get_three_state_flag(),
                       help='Enable System Assigned Identity')
            c.argument('mi_user_assigned', arg_group='Capture-Identity', nargs='+', help='List of User Assigned Identity ids.')
