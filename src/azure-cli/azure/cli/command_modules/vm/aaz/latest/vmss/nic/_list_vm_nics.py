...
class ListVmNics(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkInterfacesListVirtualMachineScaleSetVMNetworkInterfaces(ctx=self.ctx)()
    ...
    class NetworkInterfacesListVirtualMachineScaleSetVMNetworkInterfaces(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListVmNicsHelper._build_schema_network_interface_read(value.Element)

            return cls._schema_on_200


class _ListVmNicsHelper:
    """Helper class for ListVmNics"""
