...
@register_command(
    "network application-gateway address-pool delete",
)
class Delete(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2025-07-01", "properties.backendAddressPools[]"],
        ]
    }
