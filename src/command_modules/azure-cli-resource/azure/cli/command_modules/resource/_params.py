...
register_cli_argument('resource invoke-action', 'parameters', help='Parameter arguments for the action that will be passed along in the post request body')
register_cli_argument('resource invoke-action', 'post_url', help='The url that will be sent in the POST request (must include api-version query parameter)')
