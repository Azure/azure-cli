...
class KeyVaultClientOperationsMixin:
    ...
    def get_certificates(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.CertificateItem]
        :raises:
    ...
    async def create_key(self, vault_base_url, key_name, kty, key_size=None, public_exponent=None, key_ops=None, key_attributes=None, tags=None, curve=None, release_policy=None, *, cls=None, **kwargs):
    ...
    async def import_key(self, vault_base_url, key_name, key, hsm=None, key_attributes=None, tags=None, release_policy=None, *, cls=None, **kwargs):
    ...
    async def update_key(self, vault_base_url, key_name, key_version, key_ops=None, key_attributes=None, tags=None, release_policy=None, *, cls=None, **kwargs):
    ...
    def get_key_versions(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.KeyItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    async def export_key(self, vault_base_url, key_name, key_version, environment, *, cls=None, **kwargs):
        """Exports a key.
    ...
    def get_deleted_keys(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.DeletedKeyItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_secrets(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.SecretItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_secrets(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.DeletedSecretItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_storage_accounts(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.StorageAccountItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_storage_accounts(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.DeletedStorageAccountItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_sas_definitions(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.SasDefinitionItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    def get_deleted_sas_definitions(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.keyvault.v7_2.models.DeletedSasDefinitionItem]
        :raises:
         :class:`KeyVaultErrorException<azure.keyvault.v7_2.models.KeyVaultErrorException>`
        """
        error_map = kwargs.pop('error_map', None)
    ...
    async def full_backup(self, vault_base_url, storage_resource_uri, token, *, cls=None, **kwargs):
    ...
    async def full_backup_status(self, vault_base_url, job_id, *, cls=None, **kwargs):
    ...
    async def full_restore_operation_method(self, vault_base_url, sas_token_parameters, folder_to_restore, *, cls=None, **kwargs):
    ...
    async def full_restore_status(self, vault_base_url, job_id, *, cls=None, **kwargs):
    ...
    async def selective_key_restore_operation_method(self, vault_base_url, key_name, sas_token_parameters, folder, *, cls=None, **kwargs):
