...
def create_identity(client, resource_group_name, resource_name, location, tags=None, resource_restriction=None):
    parameters = {}
...
def update_identity(instance, tags=None, resource_restriction=None):
    parameters = {}
    if tags is not None:
        parameters['tags'] = tags
    if resource_restriction is not None:
