...
@register_command(
    "network express-route-circuit stop-circuit-link-failover-test",
)
class StopCircuitLinkFailoverTest(AAZCommand):
    ...
    :example: ExpressRouteCircuitStopLinkFailoverSimulation
        az network express-route-circuit stop-circuit-link-failover-test --resource-group rg1 --express-route-circuit-name erckt --circuit-test-category BgpDisconnect --link-type Primary --was-simulation-successful True --is-verified True
    """
