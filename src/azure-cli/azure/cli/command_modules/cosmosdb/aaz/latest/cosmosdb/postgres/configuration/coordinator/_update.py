...
class Update(AAZCommand):
    ...
    :example: Update single configuration of coordinator
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.configuration_name = AAZStrArg(
            ...
            help="The name of the cluster configuration.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ConfigurationsUpdateOnCoordinator(ctx=self.ctx)()
    ...
    class ConfigurationsUpdateOnCoordinator(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            properties.default_value = AAZStrType(
