...
class Delete(AAZCommand):
    ...
    :example: Delete a link authorization of an ExpressRoute circuit.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpressRouteCircuitAuthorizationsDelete(ctx=self.ctx)()
    ...
    class ExpressRouteCircuitAuthorizationsDelete(AAZHttpOperation):
