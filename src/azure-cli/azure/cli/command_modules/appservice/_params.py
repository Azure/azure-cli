...
subscription than the app service environment, please use the resource ID for --app-service-environment parameter. ",
    ...
    with self.argument_context('webapp create') as c:
        ...
        c.argument('auto_generated_domain_name_label_scope', help="Specifies the scope of uniqueness for the default hostname during resource creation. ", choices=['TenantReuse', 'SubscriptionReuse', 'ResourceGroupReuse', 'NoReuse'])
        c.ignore('language')
