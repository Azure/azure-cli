...
def load_arguments_sb(self, _):
    ...
    from azure.cli.command_modules.relay._validators import validate_partner_namespace

    from knack.arguments import CLIArgumentType
    from azure.mgmt.relay.models.relay_management_client_enums import SkuTier, AccessRights, KeyType 
