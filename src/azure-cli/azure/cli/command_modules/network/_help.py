...
examples:
  ...
  - name: Update HTTP settings. (autogenerated)
    text: az network application-gateway http-settings update --enable-probe true --gateway-name MyAppGateway --name MyHttpSettings --probe MyNewProbe --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a redirect configuration. (autogenerated)
    text: az network application-gateway redirect-config update --gateway-name MyAppGateway --include-path true --include-query-string true --name MyRedirectConfig --resource-group MyResourceGroup --target-listener MyNewBackendListener --type Permanent
    crafted: true
"""
...
examples:
  - name: List rewrite rule sets. (autogenerated)
    text: az network application-gateway rewrite-rule set list --gateway-name MyGateway --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a rule. (autogenerated)
    text: az network application-gateway rule update --address-pool MyAddressPool --gateway-name MyAppGateway --http-listener MyNewBackendListener --http-settings MyHttpSettings --name MyRule --no-wait --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an application gateway. (autogenerated)
    text: az network application-gateway update --name MyApplicationGateway --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  - name: List application gateway WAF policies. (autogenerated)
    text: az network application-gateway waf-policy list --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy rule delete --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List application gateway WAF policy custom rules. (autogenerated)
    text: az network application-gateway waf-policy rule list --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List application gateway WAF policy custom rule match conditions. (autogenerated)
    text: az network application-gateway waf-policy rule match-condition list --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Get the details of an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy rule show --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy rule update --name MyWAFPolicyRule --policy-name MyPolicy --priority 500 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an ExpressRoute circuit connection. (autogenerated)
    text: az network express-route peering connection delete --circuit-name MyCircuit --name MyPeeringConnection --peering-name MyPeering --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Remove an inbound NAT rule of an IP configuration. (autogenerated)
    text: az network nic ip-config inbound-nat-rule remove --inbound-nat-rule MyNatRule --ip-config-name MyIpConfig --lb-name MyLb --nic-name MyNic --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a public IP prefix resource. (autogenerated)
    text: az network public-ip prefix delete --name MyPublicIPPrefix --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of a public IP prefix resource. (autogenerated)
    text: az network public-ip prefix show --name MyPublicIPPrefix --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a route in a route table. (autogenerated)
    text: az network route-table route update --address-prefix 10.0.0.0/16 --name MyRoute --next-hop-ip-address 10.0.100.5 --next-hop-type VirtualNetworkGateway --resource-group MyResourceGroup --route-table-name MyRouteTable
    crafted: true
"""
...
examples:
  ...
  - name: Update a traffic manager endpoint. (autogenerated)
    ...
    crafted: true
  - name: Update a traffic manager endpoint. (autogenerated)
    text: az network traffic-manager endpoint update --endpoint-status Enabled --name MyEndpoint --profile-name MyTmProfile --resource-group MyResourceGroup --type azureEndpoints
    crafted: true
"""
...
examples:
  ...
  - name: Update a VPN connection shared key. (autogenerated)
    text: az network vpn-connection shared-key update --connection-name MyConnection --resource-group MyResourceGroup --subscription MySubscription --value Abc123
    crafted: true
"""
