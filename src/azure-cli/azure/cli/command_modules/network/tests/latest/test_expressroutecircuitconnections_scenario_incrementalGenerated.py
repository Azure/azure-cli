...
@try_manual
class ExpressroutecircuitconnectionsScenarioTest(ScenarioTest):
    def __init__(self, *args, **kwargs):
        super(ExpressroutecircuitconnectionsScenarioTest, self).__init__(*args, **kwargs)
        self.kwargs.update({
    ...
    def test_expressroutecircuitconnections_Scenario(self, rg):
        call_scenario(self)
