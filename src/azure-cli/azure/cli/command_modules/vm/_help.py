...
examples:
  ...
  - name: Update custom VM images. (autogenerated)
    text: az image update --name ImageName --resource-group ResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Convert an Azure Availability Set to contain VMs with managed disks. (autogenerated)
    text: az vm availability-set convert --name MyAvSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Disable the boot diagnostics on a VM. (autogenerated)
    text: az vm boot-diagnostics disable --ids @-
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a VM. (autogenerated)
    text: az vm show --name MyVm --resource-group MyResourceGroup --show-details
    crafted: true
"""
