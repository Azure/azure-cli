...
"example":
-   "name": |-
        Set full permissions for a user, read-execute permissions for a group, and execute permissions for all.
    "text": |-
        az fs access set-permission --path /path/to/file.txt --permission 751
"""
...
-   "name": |-
        Get file or folder information in a Data Lake Store account.
    "text": |-
        az dls fs show --account <account> --path <path> --output json
"""
...
-   "name": |-
        Set the permissions for a file or folder in a Data Lake Store account.
    "text": |-
        az dls fs access set-permission --account <account> --path <path> --permission <permission>
-   "name": |-
        Update the access control list for a file or folder.
    "text": |-
        az dls fs access set-entry --account <account> --path <path> --acl-spec [default:]user|group|other:[entity id or UPN]:r|-w|-x|-
"""
