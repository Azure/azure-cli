...
@register_command(
    "network virtual-network-appliance show",
)
class Show(AAZCommand):
    """Get information about the specified virtual network appliance.

    :example: Get virtual network appliance
        az network virtual-network-appliance show --resource-group rg1 --virtual-network-appliance-name test-vna
    """
    ...
    class VirtualNetworkAppliancesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_common_subnet_read(properties.subnet)
