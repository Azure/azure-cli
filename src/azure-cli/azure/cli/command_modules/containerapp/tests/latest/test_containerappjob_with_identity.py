...
from azure.cli.testsdk import (ScenarioTest, ResourceGroupPreparer, JMESPathCheck, JMESPathCheckExists,
                               JMESPathCheckNotExists, live_only, StorageAccountPreparer, LogAnalyticsWorkspacePreparer)
...
class ContainerAppJobsCRUDOperationsTest(ScenarioTest):
    ...
    def test_containerapp_manualjob_withidentity_crudoperations_e2e(self, resource_group, laworkspace_customer_id, laworkspace_shared_key):
        import requests
