...
subscription than the app service environment, please use the resource ID for --app-service-environment parameter. ",
    ...
    with self.argument_context('functionapp config container') as c:
        ...
        c.argument('dapr_app_id', options_list=['--dapr-app-id'], help="The Dapr application identifier.")
        c.argument('dapr_app_port', type=int, options_list=['--dapr-app-port'], help="The port Dapr uses to communicate to the application.")
