...
class LiveEvent(TrackedResource):
    ...
    :type input: ~encoding.models.LiveEventInput
    :param preview: The Live Event preview.
    :type preview: ~encoding.models.LiveEventPreview
    :param encoding: The Live Event encoding.
    :type encoding: ~encoding.models.LiveEventEncoding
    ...
    :vartype resource_state: str or ~encoding.models.LiveEventResourceState
    :param cross_site_access_policies: The Live Event access policies.
    :type cross_site_access_policies: ~encoding.models.CrossSiteAccessPolicies
    :param vanity_url: The Live Event vanity URL flag.
    :type vanity_url: bool
    :param stream_options: The stream options.
    :type stream_options: list[str or ~encoding.models.StreamOptionsFlag]
    ...
    def __init__(self, tags=None, location=None, description=None, input=None, preview=None, encoding=None, cross_site_access_policies=None, vanity_url=None, stream_options=None):
        super(LiveEvent, self).__init__(tags=tags, location=location)
