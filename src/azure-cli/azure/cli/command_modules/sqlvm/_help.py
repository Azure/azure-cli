...
examples:
  ...
  - name: Creates an availability group listener. (autogenerated)
    text: az sql vm group ag-listener create --ag-name agname --group-name sqlvmgroup --ip-address 10.0.0.11 --load-balancer '/subscriptions/{yoursubscription}/resourceGroups/{yourrg}/providers/Microsoft.Network/loadBalancers/{lbname}' --name aglistenertest --probe-port 59999 --resource-group myresourcegroup --sqlvms sqlvm1 sqlvm2 --subnet '/subscriptions/{yoursubscription}/resourceGroups/{yourrg}/providers/Microsoft.Network/virtualNetworks/{vnname}/subnets/{subnetname}'
    crafted: true
"""
