...
def load_arguments(self, _):
    ...
    with self.argument_context('vm create') as c:
        ...
        c.argument('platform_fault_domain', min_api='2020-06-01',
                   help='Specify the scale set logical fault domain into which the virtual machine will be created. By default, the virtual machine will by automatically assigned to a fault domain that best maintains balance across available fault domains. This is applicable only if the virtualMachineScaleSet property of this virtual machine is set. The virtual machine scale set that is referenced, must have platform fault domain count. This property cannot be updated once the virtual machine is created. Fault domain assignment can be viewed in the virtual machine instance view')
        c.argument('linux_patch_mode', arg_type=get_enum_type(self.get_models('LinuxVMGuestPatchMode')), min_api='2020-12-01',
                  help='Specify the mode of VM Guest Patching to IaaS Linux virtual machine. Possible values are: ImageDefault - The virtual machine\'s default patching configuration is used. AutomaticByPlatform - The virtual machine will be automatically updated by the platform. --enable-agent must be set.')
