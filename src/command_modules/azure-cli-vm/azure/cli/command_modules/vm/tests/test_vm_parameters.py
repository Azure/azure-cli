...
class Test_ArgumentParser(unittest.TestCase):
    ...
    def test_parse_vm_show(self):
        ...
        args = mock_echo_args('vm show',
                              '/subscriptions/00000000-0000-0000-0000-0123456789abc/resourceGroups/thisisaresourcegroup/providers/Microsoft.Compute/virtualMachines/thisisavmname') # pylint: disable=line-too-long
        self.assertDictEqual({
            'api_version': '2016-03-30',
            'expand': None,
