...
class Show(AAZCommand):
    ...
    class VirtualNetworksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_sub_resource_read(properties.default_public_nat_gateway)
            ...
            flow_logs = cls._schema_on_200.properties.flow_logs
            flow_logs.Element = AAZObjectType()
            _ShowHelper._build_schema_flow_log_read(flow_logs.Element)
            ...
            _ShowHelper._build_schema_address_space_read(properties.local_address_space)
            ...
            _ShowHelper._build_schema_address_space_read(properties.local_virtual_network_address_space)
            ...
            local_subnet_names = cls._schema_on_200.properties.virtual_network_peerings.Element.properties.local_subnet_names
            ...
            remote_subnet_names = cls._schema_on_200.properties.virtual_network_peerings.Element.properties.remote_subnet_names
...
class _ShowHelper:
    ...
    def _build_schema_network_security_group_read(cls, _schema):
        ...
        flow_logs.Element = AAZObjectType()
        cls._build_schema_flow_log_read(flow_logs.Element)
