...
class DeleteByRg(AAZCommand):
    """Delete an existing attestation at resource group scope.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AttestationsDeleteAtResourceGroup(ctx=self.ctx)()
    ...
    class AttestationsDeleteAtResourceGroup(AAZHttpOperation):
...
class _DeleteByRgHelper:
    """Helper class for DeleteByRg"""
