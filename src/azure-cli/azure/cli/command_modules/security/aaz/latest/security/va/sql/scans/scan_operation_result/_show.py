...
class Show(AAZCommand):
    ...
    :example: Poll a scan operation result by its operation id on an Azure SQL database.
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/{resourceid}/providers/microsoft.security/sqlvulnerabilityassessments/default/scans/scanoperationresults/{}", "2026-04-01-preview"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.operation_id = AAZStrArg(
            ...
            help="The operation id of the scan operation returned by 'security va sql scans initiate-scan'.",
            required=True,
        )
        ...
        _args_schema.database_name = AAZStrArg(
            ...
            help="The name of the database the scan was initiated against. Required when the original scan was initiated at the server-level scope.",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        self.SqlVulnerabilityAssessmentSettingsOperationGroupGetScanOperationResult(ctx=self.ctx)()
    ...
    class SqlVulnerabilityAssessmentSettingsOperationGroupGetScanOperationResult(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/{resourceId}/providers/Microsoft.Security/sqlVulnerabilityAssessments/default/scans/scanOperationResults/{operationId}",
                **self.url_parameters
            )
