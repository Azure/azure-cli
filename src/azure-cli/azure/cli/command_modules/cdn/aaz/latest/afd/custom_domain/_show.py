...
class Show(AAZCommand):
    ...
    class AFDCustomDomainsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_resource_reference_read(properties.azure_dns_zone)
            ...
            _ShowHelper._build_schema_resource_reference_read(properties.pre_validated_custom_domain_resource_id)
