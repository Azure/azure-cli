...
@register_command(
    "network virtual-appliance connection delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a NVA connection.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.NetworkVirtualApplianceConnectionsDelete(ctx=self.ctx)()
    ...
    class NetworkVirtualApplianceConnectionsDelete(AAZHttpOperation):
