...
class ACSOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, deployment_name, dns_name_prefix, name, ssh_key_value, content_version=None, admin_username="azureuser", agent_count="1", agent_vm_size="Standard_D2", location=None, master_count="1", orchestrator_type="dcos", custom_headers={}, raw=False, **operation_config):
        """
