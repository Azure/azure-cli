...
class PublicIPOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, deployment_name, name, content_version=None, allocation_method="Dynamic", dns_name=None, location=None, public_ip_address_type="noDns", custom_headers={}, raw=False, **operation_config):
        """
