...
def storage_file_upload_batch(cmd, client, destination, source, destination_path=None, pattern=None, dryrun=False,
    ...
    from azure.cli.command_modules.storage.track2_util import make_file_url
    ...
    def _upload_action(src, dst):
        ...
        _make_directory_in_files_share_v2(client, dir_name)
...
def _make_directory_in_files_share_v2(share_client, directory_path, existing_dirs=None):
    """
    Create directories recursively.
