...
class RGPreparer(AbstractPreparer, SingleValueReplacer):
    def __init__(self, name_prefix='AzureBackupRG_clitest.rg',
    ...
    def create_resource(self, name, **kwargs):
        cmd = 'az group create --location {} --name {} --tags ManagerAlias=ramat Owner=zubairabid'.format(self.location, name)
