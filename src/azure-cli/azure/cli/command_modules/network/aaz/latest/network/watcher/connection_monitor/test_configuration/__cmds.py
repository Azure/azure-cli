...
@register_command_group(
    "network watcher connection-monitor test-configuration",
    is_preview=True,
)
...
class List(AAZCommand):
    ...
    :example: List all test configurations of a connection monitor.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.testConfigurations

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.testConfigurations = value
            return
...
@register_command(
    "network watcher connection-monitor test-configuration wait",
)
