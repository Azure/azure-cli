...
examples:
  ...
  - name: Deletes an artifact source. (autogenerated)
    text: az deploymentmanager artifact-source delete --artifact-source-name contosoServiceArtifactSource --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of an artifact source. (autogenerated)
    text: az deploymentmanager artifact-source show --artifact-source-name contosoServiceArtifactSource --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: Updates an artifact source. (autogenerated)
    text: az deploymentmanager artifact-source update --artifact-source-name contosoServiceArtifactSource --resource-group rg1 --sas-uri https://dummy.blob.azure.com/updated_sample_sas_uri
    crafted: true
"""
...
examples:
  ...
  - name: Gets the rollout. (autogenerated)
    text: az deploymentmanager rollout show --resource-group rg1 --rollout-name contosoServiceRollout
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a service. (autogenerated)
    text: az deploymentmanager service show --resource-group rg1 --service-name contosoService1 --service-topology-name contosoServiceTopology
    crafted: true
"""
...
examples:
  ...
  - name: Updates the service. (autogenerated)
    text: |
        az deploymentmanager service update --resource-group rg1 --service-name contosoService1 --service-topology-name contosoServiceTopology --target-location "West US"
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a service topology. (autogenerated)
    text: az deploymentmanager service-topology show --resource-group rg1 --service-topology-name contosoServiceTopology
    crafted: true
"""
...
examples:
  ...
  - name: Updates the service topology. (autogenerated)
    text: az deploymentmanager service-topology update --artifact-source /subscriptions/mySub/resourcegroups/rg1/providers/Microsoft.DeploymentManager/artifactSources/contosoWebAppArtifactSource --resource-group rg1 --service-topology-name contosoServiceTopology
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a service unit. (autogenerated)
    text: az deploymentmanager service-unit show --resource-group rg1 --service-name contosoService1 --service-topology-name contosoServiceTopology --service-unit-name ContosoService1Storage
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of the step. (autogenerated)
    text: az deploymentmanager step show --resource-group rg1 --step-name contosoServiceWaitStep
    crafted: true
"""
...
examples:
  ...
  - name: Updates the step. (autogenerated)
    text: az deploymentmanager step update --duration PT20M --resource-group rg1 --step-name contosoServiceWaitStep
    crafted: true
"""
