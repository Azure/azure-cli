...
helps['network virtualhub-router'] = """
type: group
...
examples:
  - name: Update a virtual hub router. (autogenerated)
    text: |
        az network virtualhub-router update --name myvirtualrouter --resource-group myresourcegroup --tags super_secure no_80 no_22
    crafted: true
"""

helps['network virtualhub-router show'] = """
type: command
short-summary: Show a virtual hub router.
"""

helps['network virtualhub-router list'] = """
type: command
short-summary: List all virtual hub routers under a subscription or a resource group.
"""

helps['network virtualhub-router delete'] = """
type: command
short-summary: Delete a virtual hub router under a resource group.
"""

helps['network virtualhub-router peering'] = """
type: group
short-summary: Manage the virtual hub router peering.
"""

helps['network virtualhub-router peering create'] = """
type: command
short-summary: Create a virtual hub router peering.
"""

helps['network virtualhub-router peering update'] = """
type: command
short-summary: Update a virtual hub router peering.
"""

helps['network virtualhub-router peering list'] = """
type: command
short-summary: List all virtual hub router peerings under a resource group.
"""

helps['network virtualhub-router peering show'] = """
type: command
short-summary: Show a virtual hub router peering
"""

helps['network virtualhub-router peering delete'] = """
type: command
short-summary: Delete a virtual hub router peering.
"""

helps['network virtualhub-router peering list-learned-routes'] = """
type: command
short-summary: List all routes the virtual hub bgp connection has learned.
"""

helps['network virtualhub-router peering list-advertised-routes'] = """
type: command
