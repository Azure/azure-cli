...
examples:
  ...
  - name: Remove allowed origins (autogenerated)
    text: az functionapp cors remove --allowed-origins * --name MyFunctionApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Change deployment slots for a function app. (autogenerated)
    text: az functionapp deployment slot swap --name MyUniqueApp --resource-group MyResourceGroup --slot staging
    crafted: true
"""
...
examples:
  ...
  - name: Update the authentication settings for the webapp. (autogenerated)
    text: az webapp auth update --action AllowAnonymous --enabled true --name myUniqueApp --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Remove allowed origins (autogenerated)
    text: az webapp cors remove --allowed-origins * --name MyWebApp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Configure deployment slot auto swap. (autogenerated)
    text: az webapp deployment slot auto-swap --name MyWebapp --resource-group MyResourceGroup --slot staging --subscription MySubscription
    crafted: true
"""
