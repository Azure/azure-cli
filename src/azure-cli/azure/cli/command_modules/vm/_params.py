...
def load_arguments(self, _):
    ...
    for scope in ['vmss create', 'vmss update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('priority_count', type=int, min_api='2022-08-01', help='The base number of regular priority VMs that will be created in this scale set as it scales out. Must be greater than 0.')
            c.argument('priority_percentage', type=int, min_api='2022-08-01', help='The percentage of VM instances, after the base regular priority count has been reached, that are expected to use regular priority. Must be between 0 and 100.')
