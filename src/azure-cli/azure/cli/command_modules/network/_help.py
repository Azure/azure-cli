...
examples:
  ...
  - name: Update an authorization certificate. (autogenerated)
    text: az network application-gateway auth-cert update --cert-file /path/to/new/cert/file --gateway-name MyAppGateway --name MyAuthCert --no-wait --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a frontend IP address (autogenerated)
    text: az network application-gateway frontend-ip show --gateway-name MyAppGateway --name MyFrontendIp --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy rule create --action Allow --name MyWAFPolicyRule --policy-name MyPolicy --priority 10 --resource-group MyResourceGroup --rule-type MatchRule
    crafted: true
"""
...
examples:
  - name: Update an outbound-rule. (autogenerated)
    text: az network lb outbound-rule update --address-pool MyAddressPool --lb-name MyLb --name MyOutboundRule --resource-group MyResourceGroup
    crafted: true
"""
