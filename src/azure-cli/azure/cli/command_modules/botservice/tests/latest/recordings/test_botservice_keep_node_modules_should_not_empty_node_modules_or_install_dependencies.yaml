...
- request:
    body: '{"location": "global", "sku": {"name": "F0"}, "kind": "azurebot", "properties":
      ...
      "03c593a4-60a2-4830-a2c9-2ac4d452a206", "isCmekEnabled": false, "publicNetworkAccess":
  ...
  response:
    ...
    headers:
      ...
      - application/json; charset=utf-8
      date:
      - Mon, 20 Jun 2022 09:57:51 GMT
      etag:
      - '"d50126d8-0000-0800-0000-62b0449d0000"'
      expires:
      - '-1'
      pragma:
      - no-cache
