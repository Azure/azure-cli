...
@register_command(
    "monitor private-link-scope private-endpoint-connection delete",
    is_preview=True,
...
class Delete(AAZCommand):
    ...
    :example: Delete a private endpoint connection of a private link scope resource.
        az monitor private-link-scope private-endpoint-connection delete -n MyName -g MyResourceGroup --scope-name MyScope
    """
