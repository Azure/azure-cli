...
def load_arguments(self, _):
    ...
    with self.argument_context('upgrade') as c:
        ...
        c.argument('allow_preview', options_list=['--allow-preview', '--preview', '--allow-preview-extension'], action="store_true",
                   help="Install packages that may be in preview, if exists")
