...
# Mariner 2.0's python3 is 3.9, the rpm path is /usr/src/mariner/RPMS/x86_64/azure-cli-2.63.0-1.cm2.x86_64.rpm
# Azure Linux 3's python3 is 3.12, the rpm path is /usr/src/azl/RPMS/x86_64/azure-cli-2.63.0-1.azl3.x86_64.rpm
