...
helps['servicebus namespace network-rule-set ip-rule list'] = """
type: command
short-summary: Show properties of ip-rule in Network-rule of the given Namespace.
examples:
  - name: Show list of ip-rule present in Network of the given Namespace
    text: az servicebus namespace network-rule-set ip-rule list --resource-group myresourcegroup --namespace-name mynamespace
"""

helps['servicebus namespace network-rule-set virtual-network-rule list'] = """
type: command
short-summary: Show properties of ip-rule in Network-rule of the given Namespace.
examples:
  - name: Show list of subnet present in Network of the given Namespace
    text: az servicebus namespace network-rule-set virtual-network-rule list --resource-group myresourcegroup --namespace-name mynamespace
"""
...
type: command
short-summary: Remove ip-rule of network for a namespace
examples:
