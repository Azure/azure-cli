...
class PrivateEndpointConnectionsOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.keyvault.v2018_02_14.models.PrivateEndpointConnection or
    ...
    def put(
        ...
        :type properties:
         ~azure.mgmt.keyvault.v2018_02_14.models.PrivateEndpointConnection
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def delete(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.keyvault.v2018_02_14.models.PrivateEndpointConnection]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.keyvault.v2018_02_14.models.PrivateEndpointConnection]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
