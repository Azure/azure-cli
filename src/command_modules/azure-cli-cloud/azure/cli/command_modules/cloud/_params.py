...
register_cli_argument('cloud show', 'cloud_name', help='Name of the registered cloud. If not specified, we use the current active cloud.')
register_cli_argument('cloud update', 'cloud_name', help='Name of the registered cloud. If not specified, we use the current active cloud.')
...
register_cli_argument('cloud unregister', 'cloud_name', completer=get_custom_cloud_name_completion_list)
