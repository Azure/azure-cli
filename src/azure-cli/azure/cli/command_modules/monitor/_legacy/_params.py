...
from azure.cli.command_modules.monitor._legacy.actions import (
...
from azure.cli.command_modules.monitor._legacy.validators import (
...
from azure.cli.command_modules.monitor._legacy.actions import get_date_midnight_type
...
def load_arguments(self, _):
    ...
    # monitor metrics alert update args are defined by MetricsAlertUpdate._build_arguments_schema
