...
def register_providers():
    ...
    _register_one_provider('Microsoft.DBforPostgreSQL/serverGroupsv2', '2022-11-08', True)
    ...
    _register_one_provider('Microsoft.VideoIndexer/accounts', '2024-06-01-preview', True)
