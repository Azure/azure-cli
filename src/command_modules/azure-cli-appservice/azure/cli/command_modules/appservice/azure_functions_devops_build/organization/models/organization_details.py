...
class OrganizationDetails(Model):  # pylint: disable=super-init-not-called,too-many-instance-attributes
    _attribute_map = {
    ...
    def __init__(self, accountId=None, accountHostType=None,  # pylint: disable=super-init-not-called
                 accountName=None, subscriptionId=None, subscriptionStatus=None,
                 resourceGroupName=None, geoLocation=None, locale=None,
                 regionDisplayName=None, serviceUrls=None, accountTenantId=None,
                 isAccountOwner=None, resourceName=None, subscriptionName=None,
                 isEligibleForPurchase=None, isPrepaidFundSubscription=None,
                 isPricingAvailable=None, subscriptionOfferCode=None,
                 offerType=None, subscriptionTenantId=None,
                 subscriptionObjectId=None, failedPurchaseReason=None):
