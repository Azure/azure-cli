...
type: group
short-summary: Manage custom IP prefix
"""
...
examples:
  - name: Create a custom IP prefix resource. (autogenerated)
    text: |
...
examples:
  - name: Delete a custom IP prefix resource. (autogenerated)
    text: |
...
examples:
  - name: Get the details of a custom IP prefix resource. (autogenerated)
    text: |
...
examples:
  - name: Update a custom IP prefix resource. (autogenerated)
    text: |
