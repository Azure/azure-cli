...
examples:
  ...
  - name: Place the CLI in a waiting state until a condition of a managed disk is met (autogenerated)
    text: |
        az disk wait --exists --name MyManagedDisk --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a disk encryption set. (autogenerated)
    text: |
        az disk-encryption-set create --key-url MyKey --location westus2 --name MyDiskEncryptionSet --resource-group MyResourceGroup --source-vault MyVault
    crafted: true
"""
...
examples:
  ...
  - name: create a gallery image definition. (autogenerated)
    text: |
        az sig image-definition create --gallery-image-definition MyImage --gallery-name MyGallery --offer GreatOffer --os-state Generalized --os-type Windows --publisher GreatPublisher --resource-group MyResourceGroup --sku GreatSku
    crafted: true
"""
...
examples:
  ...
  - name: Update a dedicated host. (autogenerated)
    text: |
        az vm host update --host-group my-host-group --name my-host --remove tags.tagName --resource-group my-resource-group
    crafted: true
"""
