...
def load_arguments(self, _):
    with self.argument_context('account subscriptiondefinition show') as c:
        c.argument('subscription_definition_name', options_list=['--name', '-n'])
    ...
    for scope in ['account subscriptiondefinition create']:
        with self.argument_context(scope) as c:
            c.argument('name', options_list=['--name', '-n'], help='Name of the test subscription definition.')
