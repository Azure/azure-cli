...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        ip_allocations = cls._args_schema.ip_allocations
        ip_allocations.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_sub_resource_update(ip_allocations.Element)

        nat_gateway = cls._args_schema.nat_gateway
        nat_gateway.id = AAZStrArg(
            options=["id"],
            help="Resource ID.",
            nullable=True,
        )
...
class _UpdateHelper:
    ...
    def _build_schema_private_link_service_connection_read(cls, _schema):
        ...
        private_link_service_connection_state = _schema_private_link_service_connection_read.properties.private_link_service_connection_state
    ...
    def _build_schema_virtual_network_tap_read(cls, _schema):
        ...
        destination_load_balancer_front_end_ip_configuration.type = AAZStrType(
            flags={"read_only": True},
        )
