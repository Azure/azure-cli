...
@register_command(
    "netappfiles volume replication suspend",
)
class Suspend(AAZCommand):
    ...
    :example: Suspend the replication process
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/breakreplication", "2025-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.force_break_replication = AAZBoolArg(
            options=["-f", "--force", "--force-break-replication"],
            arg_group="Body",
            help="If replication is in status transferring and you want to force break the replication, set to true",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesBreakReplication(ctx=self.ctx)()
    ...
    class VolumesBreakReplication(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("forceBreakReplication", AAZBoolType, ".force_break_replication")
