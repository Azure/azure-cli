...
class Show(AAZCommand):
    ...
    :example: Get the details of an ExpressRoute port location. (autogenerated)
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.location = AAZStrArg(
            options=["-l", "--location"],
            help="Name of the requested ExpressRoutePort peering location.",
            required=True,
            id_part="name",
        )
        return cls._args_schema
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExpressRoutePortsLocationsGet(ctx=self.ctx)()
        self.post_operations()
    ...
    class ExpressRoutePortsLocationsGet(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200(cls):
            ...
            available_bandwidths = cls._schema_on_200.properties.available_bandwidths
            available_bandwidths.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.available_bandwidths.Element
            _element.offer_name = AAZStrType(
                serialized_name="offerName",
                flags={"read_only": True},
            )
