...
@register_command(
    "cosmosdb postgres cluster list-by-resource-group",
    is_preview=True,
)
class ListByResourceGroup(AAZCommand):
    ...
    class ClustersListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByResourceGroupHelper._build_schema_system_data_read(_element.system_data)
...
class _ListByResourceGroupHelper:
    """Helper class for ListByResourceGroup"""
