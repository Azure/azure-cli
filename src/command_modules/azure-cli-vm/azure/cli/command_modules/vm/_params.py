...
register_cli_argument('vmss create', 'backend_port', help='Backend port to open with NAT rules when creating a new load balancer. Defaults to 22 on Linux and 3389 on Windows.', type=int, arg_group='Network Balancer')
