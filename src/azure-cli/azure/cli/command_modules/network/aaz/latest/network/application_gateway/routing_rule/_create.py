...
@register_command(
    "network application-gateway routing-rule create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.priority = AAZIntArg(
            options=["--priority"],
            help="Priority of the routing rule. Supported SKU tiers are Standard_v2, WAF_v2.",
            fmt=AAZIntArgFormat(
                maximum=20000,
                minimum=1,
            ),
        ...
        # define Arg Group "Parameters.properties.routingRules[]"
        ...
        _args_schema.address_pool = AAZStrArg(
            ...
            help="Name or ID of the backend address pool. If only one exists, omit to use as default.",
        )
        _args_schema.settings = AAZStrArg(
            options=["--settings"],
            arg_group="Properties",
            help="Name or ID of the settings. If only one exists, omit to use as default.",
        )
        _args_schema.listener = AAZStrArg(
            options=["--listener"],
            arg_group="Properties",
            help="Name or ID of the listener. If only one exists, omit to use as default.",
        )
        return cls._args_schema
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("backendSettings", AAZObjectType)
                properties.set_prop("listener", AAZObjectType)
            ...
            backend_settings = _builder.get(".properties.backendSettings")
            if backend_settings is not None:
                backend_settings.set_prop("id", AAZStrType, ".settings")

            listener = _builder.get(".properties.listener")
            if listener is not None:
                listener.set_prop("id", AAZStrType, ".listener")
