...
examples:
  ...
  - name: Validate whether a template is valid at management group. (autogenerated)
    text: |
        az deployment mg validate --location WestUS --management-group-id testmg --name mydeployment --parameters MyValue=This MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: List deployment operations at management group. (autogenerated)
    text: |
        az deployment operation mg list --management-group-id testrg --name mydeployment
    crafted: true
"""
...
examples:
  ...
  - name: Validate whether a template is valid at tenant scope. (autogenerated)
    text: |
        az deployment tenant validate --location WestUS --name mydeployment --parameters MyValue=This MyArray=@array.json --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Validate whether a template is syntactically correct. (autogenerated)
    text: |
        az group deployment validate --parameters "{ "location": { "value": "westus" } }"      --resource-group MyResourceGroup --template-file storage.json
    crafted: true
"""
...
examples:
  - name: Delete a managed application (autogenerated)
    text: |
        az managedapp delete --name MyManagedApplication --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a resource-level lock. (autogenerated)
    text: |
        az resource lock update --ids /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Web/sites/{WebApp} --lock-type CanNotDelete
    crafted: true
"""
