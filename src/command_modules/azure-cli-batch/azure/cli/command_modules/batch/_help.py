...
examples:
  - name: Create a Batch account with the specified parameters. (autogenerated)
    text: az batch account create --location westus2 --name MyBatchAccount --resource-group MyResourceGroup --storage-account mystorageaccount
    crafted: true
"""
...
examples:
  - name: Add a Batch job schedule to an account. (autogenerated)
    text: |
        az batch job-schedule create --account-endpoint https://accountname.location.batch.azure.com --account-name MyAccount --id mypool --job-manager-task-command-line "/bin/sh -c MyCommand" --job-manager-task-id MyJobManagerTaskId --pool-id mypool --recurrence-interval PT24H
    crafted: true
"""
...
examples:
  - name: Create a Batch pool in an account. When creating a pool, choose arguments from either Cloud Services Configuration or Virtual Machine Configuration. (autogenerated)
    text: az batch pool create --json-file myrendertask_multi.json
    crafted: true
"""
...
examples:
  - name: Update the properties of a Batch pool. Updating a property in a subgroup will reset the unspecified properties of that group. (autogenerated)
    text: az batch pool set --account-endpoint https://accountname.location.batch.azure.com --account-name MyAccount --application-package-references app01#1.0 --pool-id mypool
    crafted: true
"""
...
examples:
  - name: Download the content of a Batch task file. (autogenerated)
    text: az batch task file download --account-endpoint https://accountname.location.batch.azure.com --account-name MyAccount --destination ./stdout.txt --file-path stdout.txt --job-id myjob --task-id mytask1
    crafted: true
"""
