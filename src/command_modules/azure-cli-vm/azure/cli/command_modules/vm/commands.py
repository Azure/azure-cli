...
def load_command_table(self, _):
    ...
    with self.command_group('disk', compute_disk_sdk, operation_group='disks', min_api='2017-03-30') as g:
        ...
        g.generic_show_command('show', 'get', table_transformer=transform_disk_show_table_output)
    ...
    with self.command_group('vm', compute_vm_sdk) as g:
        ...
        g.generic_show_command('show', 'show_vm', table_transformer=transform_vm, custom_command=True)
    ...
    with self.command_group('vm encryption', custom_command_type=compute_disk_encryption_custom) as g:
        ...
        g.generic_show_command('show', 'show_vm_encryption_status', custom_command=True)

    with self.command_group('vm extension', compute_vm_extension_sdk) as g:
        g.command('delete', 'delete', supports_no_wait=True)
        g.generic_show_command('show', 'get', table_transformer=transform_extension_show_table_output)
    ...
    with self.command_group('vm image', compute_vm_image_sdk) as g:
        ...
        g.generic_show_command('show', 'show_vm_image', custom_command=True)
    ...
    with self.command_group('vm nic', compute_vm_sdk) as g:
        ...
        g.generic_show_command('show', 'show_vm_nic', custom_command=True)
    ...
    with self.command_group('vmss', compute_vmss_sdk, operation_group='virtual_machine_scale_sets') as g:
        ...
        g.generic_show_command('show', 'show_vmss', table_transformer=get_vmss_table_output_transformer(self, False), custom_command=True)
    ...
    with self.command_group('vmss encryption', custom_command_type=compute_disk_encryption_custom, min_api='2017-03-30') as g:
        ...
        g.generic_show_command('show', 'show_vmss_encryption_status', custom_command=True)
    ...
    with self.command_group('vmss extension', compute_vmss_sdk) as g:
        ...
        g.generic_show_command('show', 'get_vmss_extension', custom_command=True)
    ...
    with self.command_group('vmss nic', network_nic_sdk) as g:
        ...
        g.generic_show_command('show', 'get_virtual_machine_scale_set_network_interface')
