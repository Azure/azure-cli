...
subscription than the app service environment, please use the resource ID for --app-service-environment parameter. ",
        ...
        c.argument('async_scaling_enabled', arg_type=get_three_state_flag(), help='Enable async scaling for the app service plan. Set to "true" to create an async operation if there are insufficient workers to scale synchronously. The SKU must be Dedicated.')
