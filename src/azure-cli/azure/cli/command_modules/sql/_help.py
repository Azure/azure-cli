...
examples:
  ...
  - name: Create a copy of a database. (autogenerated)
    text: az sql db copy --dest-name newDb --name originalDb --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  - name: Create a new database by restoring from a backup. (autogenerated)
    ...
    crafted: true
  - name: Create a new database by restoring from a backup. (autogenerated) (autogenerated)
    text: |
...
examples:
  ...
  - name: Create a managed instance. (autogenerated)
    text: az sql mi create --admin-password mypassword --admin-user myusername --capacity 8 --collation Latin1_General_100_CS_AS_SC --edition GeneralPurpose --family Gen4 --license-type LicenseIncluded --location mylocation --name myinstance --public-data-endpoint-enabled true --resource-group mygroup --storage 32GB --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/{VNETName}/subnets/{SubnetName}
    crafted: true
"""
...
examples:
  ...
  - name: Update a managed instance. (autogenerated)
    ...
    crafted: true
  - name: Update a managed instance. (autogenerated)
    text: az sql mi update --capacity vcorecapacity --name myinstance --resource-group mygroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a managed database. (autogenerated)
    text: az sql midb create --managed-instance myinstance --name mymanageddb --resource-group mygroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a server. (autogenerated)
    ...
    crafted: true
  - name: Update a server. (autogenerated) (autogenerated)
    text: az sql server update --admin-password myadminpassword --name MyAzureSQLServer --resource-group MyResourceGroup
    crafted: true
"""
