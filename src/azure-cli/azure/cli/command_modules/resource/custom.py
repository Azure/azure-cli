...
from azure.cli.command_modules.resource._client_factory import (
    ...
    _resource_links_client_factory, _authorization_management_client, _resource_managedapps_client_factory, _resource_privatelinks_client_factory)
...
from . import custom_deployments
...
class _ResourceUtils:  # pylint: disable=too-many-instance-attributes
    ...
    def invoke_action(self, action, request_body):
        ...
        if self.resource_id:
            ...
            url = client.format_url(
                ...
                subscriptionId=serialize.url(
                    "self._config.subscription_id", self.rcf.resources._config.subscription_id, 'str'),  # pylint: disable=protected-access
                action=serialize.url("action", action, 'str'))
        ...
        pipeline_response = client._pipeline.run(request, stream=False)  # pylint: disable=protected-access
...
# region deployments
def deploy_arm_template_at_subscription_scope(cmd, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, confirm_with_what_if=None, what_if_result_format=None, what_if_exclude_change_types=None, template_spec=None, query_string=None, what_if=None, proceed_if_no_change=None):
    return custom_deployments.deploy_arm_template_at_subscription_scope(cmd, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, confirm_with_what_if=confirm_with_what_if, what_if_result_format=what_if_result_format, what_if_exclude_change_types=what_if_exclude_change_types, template_spec=template_spec, query_string=query_string, what_if=what_if, proceed_if_no_change=proceed_if_no_change)


def validate_arm_template_at_subscription_scope(cmd, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, template_spec=None, query_string=None):
    return custom_deployments.validate_arm_template_at_subscription_scope(cmd, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, template_spec=template_spec, query_string=query_string)


def deploy_arm_template_at_resource_group(cmd, resource_group_name=None, template_file=None, template_uri=None, parameters=None, deployment_name=None, mode=None, rollback_on_error=None, no_wait=False, handle_extended_json_format=None, aux_subscriptions=None, aux_tenants=None, no_prompt=False, confirm_with_what_if=None, what_if_result_format=None, what_if_exclude_change_types=None, template_spec=None, query_string=None, what_if=None, proceed_if_no_change=None):
    return custom_deployments.deploy_arm_template_at_resource_group(cmd, resource_group_name=resource_group_name, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, mode=mode, rollback_on_error=rollback_on_error, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, aux_subscriptions=aux_subscriptions, aux_tenants=aux_tenants, no_prompt=no_prompt, confirm_with_what_if=confirm_with_what_if, what_if_result_format=what_if_result_format, what_if_exclude_change_types=what_if_exclude_change_types, template_spec=template_spec, query_string=query_string, what_if=what_if, proceed_if_no_change=proceed_if_no_change)


def validate_arm_template_at_resource_group(cmd, resource_group_name=None, template_file=None, template_uri=None, parameters=None, deployment_name=None, mode=None, rollback_on_error=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, template_spec=None, query_string=None):
    return custom_deployments.validate_arm_template_at_resource_group(cmd, resource_group_name=resource_group_name, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, mode=mode, rollback_on_error=rollback_on_error, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, template_spec=template_spec, query_string=query_string)


def deploy_arm_template_at_management_group(cmd, management_group_id=None, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, confirm_with_what_if=None, what_if_result_format=None, what_if_exclude_change_types=None, template_spec=None, query_string=None, what_if=None, proceed_if_no_change=None, mode=None):
    return custom_deployments.deploy_arm_template_at_management_group(cmd, management_group_id=management_group_id, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, confirm_with_what_if=confirm_with_what_if, what_if_result_format=what_if_result_format, what_if_exclude_change_types=what_if_exclude_change_types, template_spec=template_spec, query_string=query_string, what_if=what_if, proceed_if_no_change=proceed_if_no_change, mode=mode)


def validate_arm_template_at_management_group(cmd, management_group_id=None, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, template_spec=None, query_string=None):
    return custom_deployments.validate_arm_template_at_management_group(cmd, management_group_id=management_group_id, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, template_spec=template_spec, query_string=query_string)


def deploy_arm_template_at_tenant_scope(cmd, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, confirm_with_what_if=None, what_if_result_format=None, what_if_exclude_change_types=None, template_spec=None, query_string=None, what_if=None, proceed_if_no_change=None):
    return custom_deployments.deploy_arm_template_at_tenant_scope(cmd, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, confirm_with_what_if=confirm_with_what_if, what_if_result_format=what_if_result_format, what_if_exclude_change_types=what_if_exclude_change_types, template_spec=template_spec, query_string=query_string, what_if=what_if, proceed_if_no_change=proceed_if_no_change)


def validate_arm_template_at_tenant_scope(cmd, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, no_wait=False, handle_extended_json_format=None, no_prompt=False, template_spec=None, query_string=None):
    return custom_deployments.validate_arm_template_at_tenant_scope(cmd, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt, template_spec=template_spec, query_string=query_string)


def what_if_deploy_arm_template_at_resource_group(cmd, resource_group_name, template_file=None, template_uri=None, parameters=None, deployment_name=None, mode=None, aux_tenants=None, result_format=None, no_pretty_print=None, no_prompt=False, exclude_change_types=None, template_spec=None, query_string=None):
    return custom_deployments.what_if_deploy_arm_template_at_resource_group(cmd, resource_group_name, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, mode=mode, aux_tenants=aux_tenants, result_format=result_format, no_pretty_print=no_pretty_print, no_prompt=no_prompt, exclude_change_types=exclude_change_types, template_spec=template_spec, query_string=query_string)


def what_if_deploy_arm_template_at_subscription_scope(cmd, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, result_format=None, no_pretty_print=None, no_prompt=False, exclude_change_types=None, template_spec=None, query_string=None):
    return custom_deployments.what_if_deploy_arm_template_at_subscription_scope(cmd, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, result_format=result_format, no_pretty_print=no_pretty_print, no_prompt=no_prompt, exclude_change_types=exclude_change_types, template_spec=template_spec, query_string=query_string)


def what_if_deploy_arm_template_at_management_group(cmd, management_group_id=None, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, result_format=None, no_pretty_print=None, no_prompt=False, exclude_change_types=None, template_spec=None, query_string=None):
    return custom_deployments.what_if_deploy_arm_template_at_management_group(cmd, management_group_id=management_group_id, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, result_format=result_format, no_pretty_print=no_pretty_print, no_prompt=no_prompt, exclude_change_types=exclude_change_types, template_spec=template_spec, query_string=query_string)


def what_if_deploy_arm_template_at_tenant_scope(cmd, template_file=None, template_uri=None, parameters=None, deployment_name=None, deployment_location=None, result_format=None, no_pretty_print=None, no_prompt=False, exclude_change_types=None, template_spec=None, query_string=None):
    return custom_deployments.what_if_deploy_arm_template_at_tenant_scope(cmd, template_file=template_file, template_uri=template_uri, parameters=parameters, deployment_name=deployment_name, deployment_location=deployment_location, result_format=result_format, no_pretty_print=no_pretty_print, no_prompt=no_prompt, exclude_change_types=exclude_change_types, template_spec=template_spec, query_string=query_string)


def list_deployments_at_subscription_scope(cmd, filter_string=None):
    return custom_deployments.list_deployments_at_subscription_scope(cmd, filter_string=filter_string)


def list_deployments_at_resource_group(cmd, resource_group_name, filter_string=None):
    return custom_deployments.list_deployments_at_resource_group(cmd, resource_group_name, filter_string=filter_string)


def list_deployments_at_management_group(cmd, management_group_id, filter_string=None):
    return custom_deployments.list_deployments_at_management_group(cmd, management_group_id, filter_string=filter_string)


def list_deployments_at_tenant_scope(cmd, filter_string=None):
    return custom_deployments.list_deployments_at_tenant_scope(cmd, filter_string=filter_string)


def get_deployment_at_subscription_scope(cmd, deployment_name):
    return custom_deployments.get_deployment_at_subscription_scope(cmd, deployment_name)


def get_deployment_at_resource_group(cmd, resource_group_name, deployment_name):
    return custom_deployments.get_deployment_at_resource_group(cmd, resource_group_name, deployment_name)


def get_deployment_at_management_group(cmd, management_group_id, deployment_name):
    return custom_deployments.get_deployment_at_management_group(cmd, management_group_id, deployment_name)


def get_deployment_at_tenant_scope(cmd, deployment_name):
    return custom_deployments.get_deployment_at_tenant_scope(cmd, deployment_name)


def delete_deployment_at_subscription_scope(cmd, deployment_name):
    return custom_deployments.delete_deployment_at_subscription_scope(cmd, deployment_name)


def delete_deployment_at_resource_group(cmd, resource_group_name, deployment_name):
    return custom_deployments.delete_deployment_at_resource_group(cmd, resource_group_name, deployment_name)


def delete_deployment_at_management_group(cmd, management_group_id, deployment_name):
    return custom_deployments.delete_deployment_at_management_group(cmd, management_group_id, deployment_name)


def delete_deployment_at_tenant_scope(cmd, deployment_name):
    return custom_deployments.delete_deployment_at_tenant_scope(cmd, deployment_name)


def cancel_deployment_at_subscription_scope(cmd, deployment_name):
    return custom_deployments.cancel_deployment_at_subscription_scope(cmd, deployment_name)


def cancel_deployment_at_resource_group(cmd, resource_group_name, deployment_name):
    return custom_deployments.cancel_deployment_at_resource_group(cmd, resource_group_name, deployment_name)


def cancel_deployment_at_management_group(cmd, management_group_id, deployment_name):
    return custom_deployments.cancel_deployment_at_management_group(cmd, management_group_id, deployment_name)


def cancel_deployment_at_tenant_scope(cmd, deployment_name):
    return custom_deployments.cancel_deployment_at_tenant_scope(cmd, deployment_name)


def deploy_arm_template(cmd, resource_group_name, template_file=None, template_uri=None, deployment_name=None, parameters=None, mode=None, rollback_on_error=None, no_wait=False, handle_extended_json_format=None, aux_subscriptions=None, aux_tenants=None, no_prompt=False):
    return custom_deployments.deploy_arm_template(cmd, resource_group_name, template_file=template_file, template_uri=template_uri, deployment_name=deployment_name, parameters=parameters, mode=mode, rollback_on_error=rollback_on_error, no_wait=no_wait, handle_extended_json_format=handle_extended_json_format, aux_subscriptions=aux_subscriptions, aux_tenants=aux_tenants, no_prompt=no_prompt)


def validate_arm_template(cmd, resource_group_name, template_file=None, template_uri=None, parameters=None, mode=None, rollback_on_error=None, handle_extended_json_format=None, no_prompt=False):
    return custom_deployments.validate_arm_template(cmd, resource_group_name, template_file=template_file, template_uri=template_uri, parameters=parameters, mode=mode, rollback_on_error=rollback_on_error, handle_extended_json_format=handle_extended_json_format, no_prompt=no_prompt)


def export_template_at_subscription_scope(cmd, deployment_name):
    return custom_deployments.export_template_at_subscription_scope(cmd, deployment_name)


def export_template_at_resource_group(cmd, resource_group_name, deployment_name):
    return custom_deployments.export_template_at_resource_group(cmd, resource_group_name, deployment_name)


def export_template_at_management_group(cmd, management_group_id, deployment_name):
    return custom_deployments.export_template_at_management_group(cmd, management_group_id, deployment_name)


def export_template_at_tenant_scope(cmd, deployment_name):
    return custom_deployments.export_template_at_tenant_scope(cmd, deployment_name)


def export_deployment_as_template(cmd, resource_group_name, deployment_name):
    return custom_deployments.export_deployment_as_template(cmd, resource_group_name, deployment_name)


def get_deployment_operations(client, resource_group_name, deployment_name, operation_ids):
    """Gets a deployment operation."""
    return custom_deployments.get_deployment_operations(client, resource_group_name, deployment_name, operation_ids)


def get_deployment_operations_at_subscription_scope(client, deployment_name, operation_ids):
    return custom_deployments.get_deployment_operations_at_subscription_scope(client, deployment_name, operation_ids)


def get_deployment_operations_at_resource_group(client, resource_group_name, deployment_name, operation_ids):
    return custom_deployments.get_deployment_operations_at_resource_group(client, resource_group_name, deployment_name, operation_ids)


def get_deployment_operations_at_management_group(client, management_group_id, deployment_name, operation_ids):
    return custom_deployments.get_deployment_operations_at_management_group(client, management_group_id, deployment_name, operation_ids)


def get_deployment_operations_at_tenant_scope(client, deployment_name, operation_ids):
    return custom_deployments.get_deployment_operations_at_tenant_scope(client, deployment_name, operation_ids)


def list_deployment_scripts(cmd, resource_group_name=None):
    return custom_deployments.list_deployment_scripts(cmd, resource_group_name=resource_group_name)


def get_deployment_script(cmd, resource_group_name, name):
    return custom_deployments.get_deployment_script(cmd, resource_group_name, name)


def get_deployment_script_logs(cmd, resource_group_name, name):
    return custom_deployments.get_deployment_script_logs(cmd, resource_group_name, name)


def delete_deployment_script(cmd, resource_group_name, name):
    return custom_deployments.delete_deployment_script(cmd, resource_group_name, name)


def get_template_spec(cmd, resource_group_name=None, name=None, version=None, template_spec=None):
    return custom_deployments.get_template_spec(cmd, resource_group_name=resource_group_name, name=name, version=version, template_spec=template_spec)


def create_template_spec(cmd, resource_group_name, name, template_file=None, location=None, display_name=None, description=None, version=None, version_description=None, tags=None, no_prompt=False, ui_form_definition_file=None):
    return custom_deployments.create_template_spec(cmd, resource_group_name, name, template_file=template_file, location=location, display_name=display_name, description=description, version=version, version_description=version_description, tags=tags, no_prompt=no_prompt, ui_form_definition_file=ui_form_definition_file)


def update_template_spec(cmd, resource_group_name=None, name=None, template_spec=None, template_file=None, display_name=None, description=None, version=None, version_description=None, tags=None, ui_form_definition_file=None):
    return custom_deployments.update_template_spec(cmd, resource_group_name=resource_group_name, name=name, template_spec=template_spec, template_file=template_file, display_name=display_name, description=description, version=version, version_description=version_description, tags=tags, ui_form_definition_file=ui_form_definition_file)


def export_template_spec(cmd, output_folder, resource_group_name=None, name=None, version=None, template_spec=None):
    return custom_deployments.export_template_spec(cmd, output_folder, resource_group_name=resource_group_name, name=name, version=version, template_spec=template_spec)


def delete_template_spec(cmd, resource_group_name=None, name=None, version=None, template_spec=None):
    return custom_deployments.delete_template_spec(cmd, resource_group_name=resource_group_name, name=name, version=version, template_spec=template_spec)


def list_template_specs(cmd, resource_group_name=None, name=None):
    return custom_deployments.list_template_specs(cmd, resource_group_name=resource_group_name, name=name)


def create_deployment_stack_at_subscription(cmd, name, location, deny_settings_mode, action_on_unmanage, deployment_resource_group=None, template_file=None, template_spec=None, template_uri=None, query_string=None, parameters=None, description=None, deny_settings_excluded_principals=None, deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, bypass_stack_out_of_sync_error=False, tags=None, yes=False, no_wait=False):
    return custom_deployments.create_deployment_stack_at_subscription(cmd, name, location, deny_settings_mode, action_on_unmanage, deployment_resource_group=deployment_resource_group, template_file=template_file, template_spec=template_spec, template_uri=template_uri, query_string=query_string, parameters=parameters, description=description, deny_settings_excluded_principals=deny_settings_excluded_principals, deny_settings_excluded_actions=deny_settings_excluded_actions, deny_settings_apply_to_child_scopes=deny_settings_apply_to_child_scopes, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, tags=tags, yes=yes, no_wait=no_wait)


def show_deployment_stack_at_subscription(cmd, name=None, id=None):  # pylint: disable=redefined-builtin
    return custom_deployments.show_deployment_stack_at_subscription(cmd, name=name, id=id)


def list_deployment_stack_at_subscription(cmd):
    return custom_deployments.list_deployment_stack_at_subscription(cmd)


def delete_deployment_stack_at_subscription(cmd, action_on_unmanage, name=None, id=None, bypass_stack_out_of_sync_error=False, yes=False):  # pylint: disable=redefined-builtin
    return custom_deployments.delete_deployment_stack_at_subscription(cmd, action_on_unmanage, name=name, id=id, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, yes=yes)


def export_template_deployment_stack_at_subscription(cmd, name=None, id=None):  # pylint: disable=redefined-builtin
    return custom_deployments.export_template_deployment_stack_at_subscription(cmd, name=name, id=id)


def create_deployment_stack_at_resource_group(cmd, name, resource_group, deny_settings_mode, action_on_unmanage, template_file=None, template_spec=None, template_uri=None, query_string=None, parameters=None, description=None, deny_settings_excluded_principals=None, deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, bypass_stack_out_of_sync_error=False, yes=False, tags=None, no_wait=False):
    return custom_deployments.create_deployment_stack_at_resource_group(cmd, name, resource_group, deny_settings_mode, action_on_unmanage, template_file=template_file, template_spec=template_spec, template_uri=template_uri, query_string=query_string, parameters=parameters, description=description, deny_settings_excluded_principals=deny_settings_excluded_principals, deny_settings_excluded_actions=deny_settings_excluded_actions, deny_settings_apply_to_child_scopes=deny_settings_apply_to_child_scopes, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, yes=yes, tags=tags, no_wait=no_wait)


def show_deployment_stack_at_resource_group(cmd, name=None, resource_group=None, id=None):  # pylint: disable=redefined-builtin
    return custom_deployments.show_deployment_stack_at_resource_group(cmd, name=name, resource_group=resource_group, id=id)


def list_deployment_stack_at_resource_group(cmd, resource_group):
    return custom_deployments.list_deployment_stack_at_resource_group(cmd, resource_group)


def delete_deployment_stack_at_resource_group(cmd, action_on_unmanage, name=None, resource_group=None, id=None, bypass_stack_out_of_sync_error=False, yes=False):  # pylint: disable=redefined-builtin
    return custom_deployments.delete_deployment_stack_at_resource_group(cmd, action_on_unmanage, name=name, resource_group=resource_group, id=id, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, yes=yes)
...
def export_template_deployment_stack_at_resource_group(cmd, name=None, resource_group=None, id=None):  # pylint: disable=redefined-builtin
    return custom_deployments.export_template_deployment_stack_at_resource_group(cmd, name=name, resource_group=resource_group, id=id)


def validate_deployment_stack_at_resource_group(cmd, name, resource_group, deny_settings_mode, action_on_unmanage, template_file=None, template_spec=None, template_uri=None, query_string=None, parameters=None, description=None, deny_settings_excluded_principals=None, deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, bypass_stack_out_of_sync_error=False, tags=None):
    return custom_deployments.validate_deployment_stack_at_resource_group(cmd, name, resource_group, deny_settings_mode, action_on_unmanage, template_file=template_file, template_spec=template_spec, template_uri=template_uri, query_string=query_string, parameters=parameters, description=description, deny_settings_excluded_principals=deny_settings_excluded_principals, deny_settings_excluded_actions=deny_settings_excluded_actions, deny_settings_apply_to_child_scopes=deny_settings_apply_to_child_scopes, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, tags=tags)


def validate_deployment_stack_at_subscription(cmd, name, location, deny_settings_mode, action_on_unmanage, deployment_resource_group=None, template_file=None, template_spec=None, template_uri=None, query_string=None, parameters=None, description=None, deny_settings_excluded_principals=None, deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, bypass_stack_out_of_sync_error=False, tags=None):
    return custom_deployments.validate_deployment_stack_at_subscription(cmd, name, location, deny_settings_mode, action_on_unmanage, deployment_resource_group=deployment_resource_group, template_file=template_file, template_spec=template_spec, template_uri=template_uri, query_string=query_string, parameters=parameters, description=description, deny_settings_excluded_principals=deny_settings_excluded_principals, deny_settings_excluded_actions=deny_settings_excluded_actions, deny_settings_apply_to_child_scopes=deny_settings_apply_to_child_scopes, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, tags=tags)


def validate_deployment_stack_at_management_group(cmd, management_group_id, name, location, deny_settings_mode, action_on_unmanage, deployment_subscription=None, template_file=None, template_spec=None, template_uri=None, query_string=None, parameters=None, description=None, deny_settings_excluded_principals=None, deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, bypass_stack_out_of_sync_error=False, tags=None):
    return custom_deployments.validate_deployment_stack_at_management_group(cmd, management_group_id, name, location, deny_settings_mode, action_on_unmanage, deployment_subscription=deployment_subscription, template_file=template_file, template_spec=template_spec, template_uri=template_uri, query_string=query_string, parameters=parameters, description=description, deny_settings_excluded_principals=deny_settings_excluded_principals, deny_settings_excluded_actions=deny_settings_excluded_actions, deny_settings_apply_to_child_scopes=deny_settings_apply_to_child_scopes, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, tags=tags)


def create_deployment_stack_at_management_group(cmd, management_group_id, name, location, deny_settings_mode, action_on_unmanage, deployment_subscription=None, template_file=None, template_spec=None, template_uri=None, query_string=None, parameters=None, description=None, deny_settings_excluded_principals=None, deny_settings_excluded_actions=None, deny_settings_apply_to_child_scopes=False, bypass_stack_out_of_sync_error=False, yes=False, tags=None, no_wait=False):
    return custom_deployments.create_deployment_stack_at_management_group(cmd, management_group_id, name, location, deny_settings_mode, action_on_unmanage, deployment_subscription=deployment_subscription, template_file=template_file, template_spec=template_spec, template_uri=template_uri, query_string=query_string, parameters=parameters, description=description, deny_settings_excluded_principals=deny_settings_excluded_principals, deny_settings_excluded_actions=deny_settings_excluded_actions, deny_settings_apply_to_child_scopes=deny_settings_apply_to_child_scopes, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, yes=yes, tags=tags, no_wait=no_wait)


def show_deployment_stack_at_management_group(cmd, management_group_id, name=None, id=None):  # pylint: disable=redefined-builtin
    return custom_deployments.show_deployment_stack_at_management_group(cmd, management_group_id, name=name, id=id)


def list_deployment_stack_at_management_group(cmd, management_group_id):
    return custom_deployments.list_deployment_stack_at_management_group(cmd, management_group_id)


def delete_deployment_stack_at_management_group(cmd, management_group_id, action_on_unmanage, name=None, id=None, bypass_stack_out_of_sync_error=False, yes=False):  # pylint: disable=redefined-builtin
    return custom_deployments.delete_deployment_stack_at_management_group(cmd, management_group_id, action_on_unmanage, name=name, id=id, bypass_stack_out_of_sync_error=bypass_stack_out_of_sync_error, yes=yes)
...
def export_template_deployment_stack_at_management_group(cmd, management_group_id, name=None, id=None):  # pylint: disable=redefined-builtin
    return custom_deployments.export_template_deployment_stack_at_management_group(cmd, management_group_id, name=name, id=id)


def list_deployment_operations_at_subscription_scope(cmd, deployment_name):
    return custom_deployments.list_deployment_operations_at_subscription_scope(cmd, deployment_name)


def list_deployment_operations_at_resource_group(cmd, resource_group_name, deployment_name):
    return custom_deployments.list_deployment_operations_at_resource_group(cmd, resource_group_name, deployment_name)


def list_deployment_operations_at_management_group(cmd, management_group_id, deployment_name):
    return custom_deployments.list_deployment_operations_at_management_group(cmd, management_group_id, deployment_name)


def list_deployment_operations_at_tenant_scope(cmd, deployment_name):
    return custom_deployments.list_deployment_operations_at_tenant_scope(cmd, deployment_name)


def get_deployment_operation_at_subscription_scope(cmd, deployment_name, op_id):
    return custom_deployments.get_deployment_operation_at_subscription_scope(cmd, deployment_name, op_id)


def get_deployment_operation_at_resource_group(cmd, resource_group_name, deployment_name, op_id):
    return custom_deployments.get_deployment_operation_at_resource_group(cmd, resource_group_name, deployment_name, op_id)


def get_deployment_operation_at_management_group(cmd, management_group_id, deployment_name, op_id):
    return custom_deployments.get_deployment_operation_at_management_group(cmd, management_group_id, deployment_name, op_id)


def get_deployment_operation_at_tenant_scope(cmd, deployment_name, op_id):
    return custom_deployments.get_deployment_operation_at_tenant_scope(cmd, deployment_name, op_id)


def install_bicep_cli(cmd, version=None, target_platform=None):
    return custom_deployments.install_bicep_cli(cmd, version=version, target_platform=target_platform)


def uninstall_bicep_cli(cmd):
    return custom_deployments.uninstall_bicep_cli(cmd)


def upgrade_bicep_cli(cmd, target_platform=None):
    return custom_deployments.upgrade_bicep_cli(cmd, target_platform=target_platform)


def build_bicep_file(cmd, file, stdout=None, outdir=None, outfile=None, no_restore=None):
    return custom_deployments.build_bicep_file(cmd, file, stdout=stdout, outdir=outdir, outfile=outfile, no_restore=no_restore)


def build_bicepparam_file(cmd, file, stdout=None, outdir=None, outfile=None, no_restore=None):
    return custom_deployments.build_bicepparam_file(cmd, file, stdout=stdout, outdir=outdir, outfile=outfile, no_restore=no_restore)
...
def format_bicep_file(cmd, file, stdout=None, outdir=None, outfile=None, newline=None, newline_kind=None, indent_kind=None, indent_size=None, insert_final_newline=None):
    return custom_deployments.format_bicep_file(cmd, file, stdout=stdout, outdir=outdir, outfile=outfile, newline=newline, newline_kind=newline_kind, indent_kind=indent_kind, indent_size=indent_size, insert_final_newline=insert_final_newline)


def publish_bicep_file(cmd, file, target, documentationUri=None, documentation_uri=None, with_source=None, force=None):
    return custom_deployments.publish_bicep_file(cmd, file, target, documentationUri=documentationUri, documentation_uri=documentation_uri, with_source=with_source, force=force)


def restore_bicep_file(cmd, file, force=None):
    return custom_deployments.restore_bicep_file(cmd, file, force=force)


def decompile_bicep_file(cmd, file, force=None):
    return custom_deployments.decompile_bicep_file(cmd, file, force=force)


def decompileparams_bicep_file(cmd, file, bicep_file=None, outdir=None, outfile=None, stdout=None):
    return custom_deployments.decompileparams_bicep_file(cmd, file, bicep_file=bicep_file, outdir=outdir, outfile=outfile, stdout=stdout)


def show_bicep_cli_version(cmd):
    return custom_deployments.show_bicep_cli_version(cmd)


def list_bicep_cli_versions(cmd):
    return custom_deployments.list_bicep_cli_versions(cmd)
...
def generate_params_file(cmd, file, no_restore=None, outdir=None, outfile=None, stdout=None, output_format=None, include_params=None):
    return custom_deployments.generate_params_file(cmd, file, no_restore=no_restore, outdir=outdir, outfile=outfile, stdout=stdout, output_format=output_format, include_params=include_params)


def lint_bicep_file(cmd, file, no_restore=None, diagnostics_format=None):
    return custom_deployments.lint_bicep_file(cmd, file, no_restore=no_restore, diagnostics_format=diagnostics_format)
# endregion
