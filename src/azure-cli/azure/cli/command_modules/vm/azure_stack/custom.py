...
from azure.cli.command_modules.vm.generated.custom import *  # noqa: F403, pylint: disable=unused-wildcard-import,wildcard-import
try:
...
def create_managed_disk(cmd, resource_group_name, disk_name, location=None,  # pylint: disable=too-many-locals, too-many-branches, too-many-statements, line-too-long
    ...
    if gallery_image_reference is not None:
        ...
        if is_shared_gallery_image_id(gallery_image_reference):
            ...
            from azure.cli.command_modules.vm.azure_stack._vm_utils import parse_community_gallery_image_id
        ...
        if vnet_type == 'new':
            ...
            if vnet_name:
                ...
                if vnet_exists:
                    ...
                    from azure.cli.command_modules.vm.azure_stack._validators import get_network_client
