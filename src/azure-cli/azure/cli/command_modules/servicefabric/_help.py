...
examples:
  ...
  - name: Add a secondary cluster certificate to the cluster. (autogenerated)
    ...
    crafted: true
  - name: Add a secondary cluster certificate to the cluster. (autogenerated)
    text: az sf cluster certificate add --cluster-name cluster1 --resource-group group-name --secret-identifier 'https://{KeyVault}.vault.azure.net/secrets/{Secret}'
    crafted: true
"""
...
examples:
  ...
  - name: Remove a certificate from a cluster. (autogenerated)
    text: az sf cluster certificate remove --cluster-name cluster1 --resource-group group-name --thumbprint '5F3660C715EBBDA31DB1FFDCF508302348DE8E7A'
    crafted: true
"""
...
examples:
  ...
  - name: Update the settings of a cluster. (autogenerated)
    text: az sf cluster setting set --cluster-name cluster1 --parameter 'MaxFileOperationTimeout' --resource-group group-name --section 'NamingService' --value 5000
    crafted: true
"""
