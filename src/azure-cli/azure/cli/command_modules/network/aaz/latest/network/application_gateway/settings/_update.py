...
@register_command(
    "network application-gateway settings update",
)
class Update(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2025-07-01", "properties.backendSettingsCollection[]"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the backend settings.",
            required=True,
        )
        ...
        _args_schema.backend_pool_host_name = AAZBoolArg(
            options=["--backend-pool-host-name"],
            help="Whether to use host name of the backend server as the host header.",
            nullable=True,
        )
        ...
        _args_schema.probe = AAZStrArg(
            options=["--probe"],
            help="Name or ID of the probe to associate with the settings.",
            nullable=True,
        )
        ...
        # define Arg Group "Parameters.properties.backendSettingsCollection[]"
        ...
        cls._build_args_common_sub_resource_update(trusted_root_certificates.Element)
        return cls._args_schema
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.backendSettingsCollection
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if trusted_root_certificates is not None:
                _UpdateHelper._build_schema_common_sub_resource_update(trusted_root_certificates.set_elements(AAZObjectType, "."))
