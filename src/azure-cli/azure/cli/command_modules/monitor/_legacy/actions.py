...
from azure.cli.command_modules.monitor._legacy.util import get_autoscale_scale_direction_map
...
class MetricAlertConditionAction(argparse._AppendAction):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        from azure.cli.command_modules.monitor._legacy.grammar.metric_alert import (
...
class AutoscaleConditionAction(argparse.Action):  # pylint: disable=protected-access
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        from azure.cli.command_modules.monitor._legacy.grammar.autoscale import (
