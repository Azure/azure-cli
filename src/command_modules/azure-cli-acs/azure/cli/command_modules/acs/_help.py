...
-   "name": |-
    ...
    "short-summary": |-
        Service principal used for authentication to Azure APIs.
    "long-summary": |-
        If not specified, a new service principal with the contributor role is created and cached at $HOME/.azure/acsServicePrincipal.json to be used by subsequent `az acs` commands.
-   "name": |-
        --client-secret
    "type": |-
        string
