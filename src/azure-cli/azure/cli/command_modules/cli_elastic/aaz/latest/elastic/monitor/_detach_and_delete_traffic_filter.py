...
class DetachAndDeleteTrafficFilter(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DetachAndDeleteTrafficFilterDelete(ctx=self.ctx)()
...
class _DetachAndDeleteTrafficFilterHelper:
    """Helper class for DetachAndDeleteTrafficFilter"""


__all__ = ["DetachAndDeleteTrafficFilter"]
