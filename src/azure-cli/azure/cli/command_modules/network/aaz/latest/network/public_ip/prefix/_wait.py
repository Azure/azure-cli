...
class Wait(AAZWaitCommand):
    ...
    class PublicIpPrefixesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_common_sub_resource_read(properties.custom_ip_prefix)
            ...
            _WaitHelper._build_schema_common_sub_resource_read(properties.load_balancer_frontend_ip_configuration)
