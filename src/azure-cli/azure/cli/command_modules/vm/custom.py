...
def create_image_version(cmd, resource_group_name, gallery_name, gallery_image_name, gallery_image_version,
                         ...
                         target_region_encryption=None, os_vhd=None, os_vhd_storage_account=None):
    ...
    if cmd.supported_api_version(min_api='2019-07-01', operation_group='gallery_image_versions'):
        if managed_image is None and os_snapshot is None and os_vhd is None:
        ...
        if cmd.supported_api_version(min_api='2020-09-30', operation_group='gallery_image_versions'):
            if os_vhd and os_vhd_storage_account is None or os_vhd is None and os_vhd_storage_account:
                raise ValidationError('--vhd and --vhd-storage-account should be used together.')
            if os_vhd and os_vhd_storage_account:
                ...
                os_disk_image = GalleryOSDiskImage(source=GalleryArtifactVersionSource(id=os_vhd_storage_account, uri=os_vhd))
