...
def load_arguments(self, _):
    ...
    with self.argument_context('signalr create') as c:
        ...
        c.argument('allowed_origins', options_list=['--allowed-origins', '-a'], nargs='*', help='space separated origins that should be allowed to make cross-origin calls (for example: http://example.com:12345). To allow all, use "*" or remove all arguments')
