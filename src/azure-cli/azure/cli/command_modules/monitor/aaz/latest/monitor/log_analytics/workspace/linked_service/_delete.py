...
@register_command(
    "monitor log-analytics workspace linked-service delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a linked service.

    :example: Delete a linked service.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.LinkedServicesDelete(ctx=self.ctx)()
    ...
    class LinkedServicesDelete(AAZHttpOperation):
