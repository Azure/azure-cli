...
register_argument_deprecate('sql mi link create', '--primary-availability-group-name', '--partner-availability-group-name')
register_argument_deprecate('sql mi link create', '--secondary-availability-group-name', '--instance-availability-group-name')
