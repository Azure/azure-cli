...
cli_generic_wait_command(__name__, 'acs wait', 'azure.mgmt.compute.operations.container_services_operations#ContainerServicesOperations.get', _acs_client_factory)
