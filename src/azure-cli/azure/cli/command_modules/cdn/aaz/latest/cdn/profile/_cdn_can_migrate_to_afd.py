...
@register_command(
    "cdn profile cdn-can-migrate-to-afd",
)
class CdnCanMigrateToAfd(AAZCommand):
...
class _CdnCanMigrateToAfdHelper:
    """Helper class for CdnCanMigrateToAfd"""


__all__ = ["CdnCanMigrateToAfd"]
