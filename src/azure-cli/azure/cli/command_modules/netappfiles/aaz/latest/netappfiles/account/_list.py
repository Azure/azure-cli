...
class List(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.netapp/netappaccounts", "2026-07-01"],
    ...
    class AccountsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            bind_password_akv_config = cls._schema_on_200.value.Element.properties.ldap_configuration.bind_password_akv_config
            ...
            dns_servers = cls._schema_on_200.value.Element.properties.ldap_configuration.dns_servers
