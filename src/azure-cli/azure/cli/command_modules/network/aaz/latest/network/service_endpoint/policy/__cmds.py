...
class Delete(AAZCommand):
    ...
    :example: Delete a service endpoint policy.
        az network service-endpoint policy delete -g MyResourceGroup -n MyPolicy
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ServiceEndpointPoliciesDelete(ctx=self.ctx)()
        self.post_operations()
    ...
    class ServiceEndpointPoliciesDelete(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
class Show(AAZCommand):
    ...
    :example: Get the details of a service endpoint policy.
    ...
    class ServiceEndpointPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _ShowHelper._build_schema_service_endpoint_policy_read(cls._schema_on_200)
...
@register_command(
    "network service-endpoint policy wait",
)
class Wait(AAZWaitCommand):
    ...
    class ServiceEndpointPoliciesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _WaitHelper._build_schema_service_endpoint_policy_read(cls._schema_on_200)
...
@link_helper(
    ...
    ("_build_schema_service_endpoint_policy_read", _Helper),
