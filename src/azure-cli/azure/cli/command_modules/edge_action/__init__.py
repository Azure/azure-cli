...
from azure.cli.command_modules.edge_action._help import helps  # pylint: disable=unused-import
...
class EdgeActionCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        from azure.cli.command_modules.edge_action.commands import load_command_table
    ...
    def load_arguments(self, command):
        from azure.cli.command_modules.edge_action._params import load_arguments
