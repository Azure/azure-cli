...
-   "name": |-
    ...
    "text": |-
        az relay hyco update --resource-group myresourcegroup --namespace-name mynamespace --name myhyco --support-ordering True
"""
...
-   "name": |-
    ...
    "text": |-
        az relay wcfrelay create --resource-group myresourcegroup --namespace-name mynamespace --name myrelay
"""
...
-   "name": |-
    ...
    "text": |-
        az relay wcfrelay update --resource-group myresourcegroup --namespace-name mynamespace --name myrelay --auto-delete-on-idle PT3M
"""
