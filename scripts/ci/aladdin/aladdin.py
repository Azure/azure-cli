...
aladdin_helps['functionapp cors credentials'] = """
type: command
...
aladdin_helps['logicapp config appsettings delete'] = """
type: command
...
aladdin_helps['logicapp config appsettings list'] = """
type: command
...
aladdin_helps['network dns record-set ds create'] = """
type: command
...
aladdin_helps['network dns record-set ds update'] = """
type: command
...
aladdin_helps['network dns record-set tlsa create'] = """
type: command
...
aladdin_helps['network dns record-set tlsa update'] = """
type: command
...
long-summary: It supports the generic update (using property path) to update resources. If the update operation fails, please try run 'az resource patch' instead.
examples:
...
aladdin_helps['sql db show-deleted'] = """
type: command
...
aladdin_helps['sql db tde key revalidate'] = """
type: command
...
aladdin_helps['sql db tde key revert'] = """
type: command
