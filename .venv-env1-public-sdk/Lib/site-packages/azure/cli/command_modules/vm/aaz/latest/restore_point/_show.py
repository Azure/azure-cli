...
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.expand = AAZStrArg(
            options=["--expand"],
            help="The expand expression to apply on the operation. 'InstanceView' retrieves information about the run-time state of a restore point.",
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.RestorePointsGet(ctx=self.ctx)()
    ...
    class RestorePointsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            exclude_disks = cls._schema_on_200.properties.exclude_disks
            ...
            disk_restore_points = cls._schema_on_200.properties.instance_view.disk_restore_points
            disk_restore_points.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.instance_view.disk_restore_points.Element
            ...
            source_metadata = cls._schema_on_200.properties.source_metadata
            ...
            diagnostics_profile = cls._schema_on_200.properties.source_metadata.diagnostics_profile
            diagnostics_profile.boot_diagnostics = AAZObjectType(
                serialized_name="bootDiagnostics",
            )

            boot_diagnostics = cls._schema_on_200.properties.source_metadata.diagnostics_profile.boot_diagnostics
            boot_diagnostics.enabled = AAZBoolType()
            boot_diagnostics.storage_uri = AAZStrType(
                serialized_name="storageUri",
            )

            hardware_profile = cls._schema_on_200.properties.source_metadata.hardware_profile
            ...
            vm_size_properties = cls._schema_on_200.properties.source_metadata.hardware_profile.vm_size_properties
            ...
            os_profile = cls._schema_on_200.properties.source_metadata.os_profile
            ...
            linux_configuration = cls._schema_on_200.properties.source_metadata.os_profile.linux_configuration
            ...
            patch_settings = cls._schema_on_200.properties.source_metadata.os_profile.linux_configuration.patch_settings
            ...
            automatic_by_platform_settings = cls._schema_on_200.properties.source_metadata.os_profile.linux_configuration.patch_settings.automatic_by_platform_settings
            ...
            ssh = cls._schema_on_200.properties.source_metadata.os_profile.linux_configuration.ssh
            ssh.public_keys = AAZListType(
                serialized_name="publicKeys",
            )

            public_keys = cls._schema_on_200.properties.source_metadata.os_profile.linux_configuration.ssh.public_keys
            public_keys.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.source_metadata.os_profile.linux_configuration.ssh.public_keys.Element
            _element.key_data = AAZStrType(
                serialized_name="keyData",
            )
            _element.path = AAZStrType()

            secrets = cls._schema_on_200.properties.source_metadata.os_profile.secrets
            secrets.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.source_metadata.os_profile.secrets.Element
            ...
            vault_certificates = cls._schema_on_200.properties.source_metadata.os_profile.secrets.Element.vault_certificates
            vault_certificates.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.source_metadata.os_profile.secrets.Element.vault_certificates.Element
            ...
            windows_configuration = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration
            ...
            additional_unattend_content = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.additional_unattend_content
            additional_unattend_content.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.additional_unattend_content.Element
            ...
            patch_settings = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.patch_settings
            patch_settings.assessment_mode = AAZStrType(
                serialized_name="assessmentMode",
            )
            patch_settings.automatic_by_platform_settings = AAZObjectType(
            ...
            automatic_by_platform_settings = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.patch_settings.automatic_by_platform_settings
            automatic_by_platform_settings.bypass_platform_safety_checks_on_user_schedule = AAZBoolType(
                serialized_name="bypassPlatformSafetyChecksOnUserSchedule",
            )
            automatic_by_platform_settings.reboot_setting = AAZStrType(
            ...
            win_rm = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.win_rm
            win_rm.listeners = AAZListType()

            listeners = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.win_rm.listeners
            listeners.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.source_metadata.os_profile.windows_configuration.win_rm.listeners.Element
            _element.certificate_url = AAZStrType(
                serialized_name="certificateUrl",
            )
            _element.protocol = AAZStrType()

            security_profile = cls._schema_on_200.properties.source_metadata.security_profile
            ...
            encryption_identity = cls._schema_on_200.properties.source_metadata.security_profile.encryption_identity
            ...
            uefi_settings = cls._schema_on_200.properties.source_metadata.security_profile.uefi_settings
            ...
            storage_profile = cls._schema_on_200.properties.source_metadata.storage_profile
            ...
            data_disks = cls._schema_on_200.properties.source_metadata.storage_profile.data_disks
            data_disks.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.source_metadata.storage_profile.data_disks.Element
            ...
            os_disk = cls._schema_on_200.properties.source_metadata.storage_profile.os_disk
            ...
            encryption_settings = cls._schema_on_200.properties.source_metadata.storage_profile.os_disk.encryption_settings
            ...
            disk_encryption_key = cls._schema_on_200.properties.source_metadata.storage_profile.os_disk.encryption_settings.disk_encryption_key
            ...
            key_encryption_key = cls._schema_on_200.properties.source_metadata.storage_profile.os_disk.encryption_settings.key_encryption_key
