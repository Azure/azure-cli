...
@register_command(
    "security security-connector devops azuredevopsorg project create",
    is_preview=True,
)
class Create(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AzureDevOpsProjectsCreateOrUpdate(ctx=self.ctx)()
    ...
    class AzureDevOpsProjectsCreateOrUpdate(AAZHttpOperation):
