...
def load_arguments(self, _):
    ...
    with self.argument_context('bicep generate-params') as c:
        ...
        c.argument('output_format', arg_type=CLIArgumentType(options_list=['--output-format'], help="Set output format. Valid values are ( json | bicepparam )."))
        c.argument('include_params', arg_type=CLIArgumentType(options_list=['--include-params'], help="Set include params. Valid values are ( all | required-only )."))
