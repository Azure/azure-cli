...
class AlertRuleIncidentOperations(object):
    """AlertRuleIncidentOperations operations.
    ...
    def get(
            self, resource_group_name, rule_name, incident_name, api_version="2016-03-01", custom_headers=None, raw=False, **operation_config):
        """
        ...
        :rtype: :class:`Incident <insights.models.Incident>`
