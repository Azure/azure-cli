...
@register_command(
    "network application-gateway settings create",
)
...
@register_command(
    "network application-gateway settings list",
)
class List(AAZCommand):
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.backendSettingsCollection

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.backendSettingsCollection = value
            return
...
@register_command(
    "network application-gateway settings show",
)
