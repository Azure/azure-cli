...
@register_command(
    "search service private-link-resource list",
)
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.search/searchservices/{}/privatelinkresources", "2026-03-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PrivateLinkResourcesListSupported(ctx=self.ctx)()
    ...
    class PrivateLinkResourcesListSupported(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            properties.shareable_private_link_resource_types = AAZListType(
                serialized_name="shareablePrivateLinkResourceTypes",
                flags={"read_only": True},
            )
            ...
            shareable_private_link_resource_types = cls._schema_on_200.value.Element.properties.shareable_private_link_resource_types
            shareable_private_link_resource_types.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.shareable_private_link_resource_types.Element
            _element.name = AAZStrType(
                flags={"read_only": True},
            )
            _element.properties = AAZObjectType(
            ...
            properties = cls._schema_on_200.value.Element.properties.shareable_private_link_resource_types.Element.properties
