...
def load_arguments(self, _):
    ...
    with self.argument_context('webapp create') as c:
        ...
        c.argument('docker_registry_server_url', options_list=['--docker-registry-server-url'], help='the container registry server url')
        c.argument('docker_registry_server_user', options_list=['--docker-registry-server-user'], help='the container registry server username')
        c.argument('docker_registry_server_password', options_list=['--docker-registry-server-password'], help='the container registry server password')
