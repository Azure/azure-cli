...
@register_command(
    "network application-gateway http-listener show",
)
class Show(AAZCommand):
    """Get the details of an HTTP listener.

    :example: Get the details of an HTTP listener.
...
class Update(AAZCommand):
    ...
    :example: Update an HTTP listener to use a different hostname.
...
@link_helper(
    __package__,
    ("_build_schema_application_gateway_custom_error_update", _Helper),
