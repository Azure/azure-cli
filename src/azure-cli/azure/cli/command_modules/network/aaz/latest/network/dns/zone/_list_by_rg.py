...
class ListByRg(AAZCommand):
    ...
    class ZonesListByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListByRgHelper._build_schema_sub_resource_read(registration_virtual_networks.Element)
            ...
            _ListByRgHelper._build_schema_sub_resource_read(resolution_virtual_networks.Element)
