...
examples:
  ...
  - name: Update the details of this activity log alert. (autogenerated)
    text: |
        az monitor activity-log alert update --condition category=ServiceHealth and level=Error --enabled true --name MyActivityLogAlerts --resource-group MyResourceGroup
    crafted: true
  - name: Update the details of this activity log alert. (autogenerated)
    text: |
        az monitor activity-log alert update --name MyActivityLogAlerts --resource-group MyResourceGroup --set retentionPolicy.days=365
    crafted: true
"""
...
examples:
  ...
  - name: Create a workspace instance. (autogenerated)
    text: |
        az monitor log-analytics workspace create --location westus2 --resource-group MyResourceGroup --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update a workspace instance. (autogenerated)
    text: |
        az monitor log-analytics workspace update --resource-group myresourcegroup --workspace-name myworkspace
    crafted: true
"""
...
examples:
  ...
  - name: Create some linked storage accounts for log analytics workspace. (autogenerated)
    text: |
        az monitor log-analytics workspace linked-storage create --resource-group MyResourceGroup --storage-accounts SA1 SA2 --subscription mysubscription --type CustomLogs --workspace-name MyWorkspace
    crafted: true
"""
