...
@register_command(
    "network express-route-circuit get-circuit-link-failover-single-test-detail",
)
class GetCircuitLinkFailoverSingleTestDetail(AAZCommand):
    ...
    :example: ExpressRouteCircuitLinkFailoverSingleTestDetails
        az network express-route-circuit get-circuit-link-failover-single-test-detail --resource-group rg1 --express-route-circuit-name erckt --failover-test-id fe458ae8-d2ae-4520-a104-44bc233bde7e --link-type Primary --circuit-maintenance-category BgpDisconnect
    """
