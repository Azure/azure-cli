...
from azure.cli.core.aaz import AAZStrType, AAZListType, AAZObjectType, AAZDictType, AAZBoolType, AAZIntType
...
from ..aaz.latest.vm.image import List as _VMImageList
