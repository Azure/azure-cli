...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.entra_jwt_validation_config = AAZObjectArg(
            options=["--entra-jwt-validation-config"],
            arg_group="Properties",
            help="Entra JWT validation configuration resource of the application gateway.",
        )
        cls._build_args_common_sub_resource_update(_args_schema.entra_jwt_validation_config)
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("entraJWTValidationConfig", AAZObjectType, ".entra_jwt_validation_config"))
