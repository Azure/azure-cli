...
skuavailabilitypath = 'azure.mgmt.cognitiveservices.operations.check_sku_availability_operations#CheckSkuAvailabilityOperations.'
...
cli_command(__name__, 'cognitiveservices checkskuavailability', skuavailabilitypath + 'list', cognitiveservices_client_factory)
