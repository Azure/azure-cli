...
class List(AAZCommand):
    ...
    :example: Get all the bandwidth schedules for a Data Box Edge/Data Box Gateway device.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BandwidthSchedulesListByDataBoxEdgeDevice(ctx=self.ctx)()
    ...
    class BandwidthSchedulesListByDataBoxEdgeDevice(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            days = cls._schema_on_200.value.Element.properties.days
