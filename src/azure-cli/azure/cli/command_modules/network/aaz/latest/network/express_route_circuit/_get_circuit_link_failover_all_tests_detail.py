...
@register_command(
    "network express-route-circuit get-circuit-link-failover-all-tests-detail",
)
class GetCircuitLinkFailoverAllTestsDetail(AAZCommand):
    ...
    :example: ExpressRouteCircuitLinkFailoverAllTestsDetails
        az network express-route-circuit get-circuit-link-failover-all-tests-detail --resource-group rg1 --express-route-circuit-name erckt --failover-test-type LinkFailover --fetch-latest True
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.express_route_circuit_name = AAZStrArg(
            options=["--express-route-circuit-name"],
