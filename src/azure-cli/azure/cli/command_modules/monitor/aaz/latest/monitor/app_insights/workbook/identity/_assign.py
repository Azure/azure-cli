...
@register_command(
    "monitor app-insights workbook identity assign",
)
class Assign(AAZCommand):
    ...
    class WorkbooksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _AssignHelper._build_schema_workbook_read(cls._schema_on_200)
    ...
    class WorkbooksCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _AssignHelper._build_schema_workbook_read(cls._schema_on_200_201)
