...
In autogenerated reference content, short summaries show in reference tables. For an example, see the tables in [Reference Index A-Z](https://learn.microsoft.com/cli/azure/reference-index?view=azure-cli-latest) and [az account](https://learn.microsoft.com/cli/azure/account).
...
For an example of a long summary, see [az acr helm repo add](https://learn.microsoft.com/cli/azure/acr/helm/repo?view=azure-cli-latest#az-acr-helm-repo-add). The Python source code for `az acr helm repo add` is found in [/acr/_help.py](https://github.com/azure/azure-cli/blob/dev/src/azure-cli/azure/cli/command_modules/acr/_help.py):
