...
class List(AAZCommand):
    ...
    :example: VirtualMachineImage_List_MaximumSet_Gen
        az vm image list --location aaaaaaaaaaaaaaa --publisher aaaaaa --offer aaaaaaaaaaaaaaaa --sku aaaaaaaaaaaaaaaaaaaaaaa --expand aaaaaaaaaaaaaaaaaaaaaaaa --top 18 --orderby aa
    """
