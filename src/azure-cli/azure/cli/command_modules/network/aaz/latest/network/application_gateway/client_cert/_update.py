...
@register_command(
    "network application-gateway client-cert update",
)
class Update(AAZCommand):
    """Update trusted client certificate of the application gateway.

    :example: Update trusted client certificate of the application gateway.
        az network application-gateway client-cert update --gateway-name MyAppGateway -g MyResourceGroup --name MyCert --data FilePath
    """
