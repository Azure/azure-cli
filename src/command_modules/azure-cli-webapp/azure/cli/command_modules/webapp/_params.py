...
register_cli_argument('app-service-plan', 'resource_group', arg_type=resource_group_name_type)
register_cli_argument('app-service-plan', 'location', arg_type=location_type)
register_cli_argument('app-service-plan', 'name', arg_type=existing_plan_name)
register_cli_argument('app-service-plan create', 'name', options_list=('--name', '-n'), help="Name of the new app service plan")
register_cli_argument('app-service-plan', 'tier', type=str.upper, choices=['FREE', 'SHARED', 'B1', 'B2', 'B3', 'S1', 'S2', 'S3', 'P1', 'P2', 'P3'], default='B1',
...
register_cli_argument('app-service-plan', 'number_of_workers', help='Number of workers to be allocated.', type=int, default=1)
register_cli_argument('app-service-plan', 'admin_site_name', help='The name of the admin web app.')
...
register_cli_argument('webapp log set', 'application_logging', choices=two_states_switch, type=two_states_switch_type, help='configure application logging to file system')
register_cli_argument('webapp log set', 'detailed_error_messages', choices=two_states_switch, type=two_states_switch_type, help='configure detailed error messages')
register_cli_argument('webapp log set', 'failed_request_tracing', choices=two_states_switch, type=two_states_switch_type, help='configure failed request tracing')
...
register_cli_argument('webapp config update', 'remote_debugging_enabled', choices=two_states_switch, type=two_states_switch_type, help='enable or disable remote debugging')
register_cli_argument('webapp config update', 'web_sockets_enabled', choices=two_states_switch, type=two_states_switch_type, help='enable or disable web sockets')
register_cli_argument('webapp config update', 'always_on', choices=two_states_switch, type=two_states_switch_type, help='ensure webapp gets loaded all the time, rather unloaded after been idle. Recommended when you have continuous web jobs running')
register_cli_argument('webapp config update', 'auto_heal_enabled', choices=two_states_switch, type=two_states_switch_type, help='enable or disable auto heal')
register_cli_argument('webapp config update', 'use32_bit_worker_process', options_list=('--use-32bit-worker-process',), choices=two_states_switch, type=two_states_switch_type, help='use 32 bits worker process or not')
