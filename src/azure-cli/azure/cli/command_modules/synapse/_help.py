...
examples:
  - name: Set a SQL pool's transparent data encryption configuration. (autogenerated)
    text: |-
        ...
        --status Enabled --trans-data-en-name current'
"""
...
examples:
  - name: Get a SQL pool's transparent data encryption configuration. (autogenerated)
    text: |-
        az synapse sql pool tde show --name sqlpool --workspace-name testsynapseworkspace --resource-group \\
        --trans-data-en-name tdename
"""
...
examples:
  - name: Get a SQL pool's threat detection policy.
    text: |-
        ...
        --resource-group rg --sec-alert-policy-name threatpolicy
"""
