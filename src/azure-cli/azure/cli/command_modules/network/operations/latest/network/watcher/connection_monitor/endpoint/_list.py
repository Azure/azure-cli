...
from azure.cli.command_modules.network.aaz.latest.network.watcher.connection_monitor.endpoint._list import List as _WatcherConnectionMonitorEndpointList
