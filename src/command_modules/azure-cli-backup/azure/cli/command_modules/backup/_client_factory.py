...
def _common_client_factory(cli_ctx):
...
def _backup_client_factory(cli_ctx):
...
def virtual_machines_cf(cli_ctx):
    return _compute_client_factory(cli_ctx).virtual_machines


def resources_cf(cli_ctx):
