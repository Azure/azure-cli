...
class Show(AAZCommand):
    ...
    :example: ConsumerGroupGet
        az eventhubs eventhub consumer-group show --resource-group ArunMonocle --namespace-name sdk-Namespace-2661 --eventhub-name sdk-EventHub-6681 --consumer-group-name sdk-ConsumerGroup-5563
    """
