...
class AzCLIError(CLIError):
    ...
    def __init__(self, error_msg, command=None, recommendation=None):
        ...
        if error_enabled():
            if command is not None:
                self.error_help = error_assistance(command=command, message=None)
            else:
                self.error_help = error_assistance(command=None, message=error_msg)
        else:
    ...
    def print_error(self):
        ...
        # print error help generated by Azure OpenAI
        if self.error_help is not None:
            print_error_assistance(self.error_help)
