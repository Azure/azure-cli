...
helps['resource show'] = """
    ...
    long-summary: For example /subscriptions/0000/resourceGroups/my_resource_group/providers/Microsoft.Provider/resA/myA/resB/myB/resC/myC.
    examples:
        - name: Show a virtual machine.
          text: >
            az vm show -g my_resource_group -n myvm --resource-type "Microsoft.Compute/virtualMachines"
        - name: Show a web app using a resource identifier.
          text: >
            az resource show --id /subscriptions/0b1f6471-1bf0-4dda-aec3-111111111111/resourceGroups/my_resource_group/providers/Microsoft.Web/sites/myWebapp
        - name: Show a subnet.
          text: >
            az resource show -g my_resource_group -n mysubnet --namespace microsoft.network --parent virtualnetworks/myvnet --resource-type subnets
        - name: Show a subnet using a resource identifier.
          text: >
            az resource show --id /subscriptions/0b1f6471-1bf0-4dda-aec3-111111111111/resourceGroups/my_resource_group/providers/Microsoft.Network/virtualNetworks/myvnet/subnets/mysubnet
        - name: Show an application gateway path rule.
          text: >
            az resource show -g my_resource_group --namespace Microsoft.Network --parent applicationGateways/ag1/urlPathMaps/map1 --resource-type pathRules -n rule1  
"""
...
helps['resource delete'] = """
    ...
    examples:
        - name: Delete a virtual machine.
          text: >
            az vm delete -g my_resource_group -n myvm --resource-type "Microsoft.Compute/virtualMachines"
        - name: Delete a web app using a resource identifier.
          text: >
            az resource delete --id /subscriptions/0b1f6471-1bf0-4dda-aec3-111111111111/resourceGroups/my_resource_group/providers/Microsoft.Web/sites/myWebapp
        - name: Delete a subnet using a resource identifier.
          text: >
            az resource delete --id /subscriptions/0b1f6471-1bf0-4dda-aec3-111111111111/resourceGroups/my_resource_group/providers/Microsoft.Network/virtualNetworks/myvnet/subnets/mysubnet
"""
...
helps['resource tag'] = """
    ...
    examples:
        - name: Tag a virtual machine.
          text: >
            az resource tag --tags vmlist=vm1 -g my_resource_group -n myvm --resource-type "Microsoft.Compute/virtualMachines"
        - name: Tag a web app using a resource identifier.
          text: >
            az resource tag --tags vmlist=vm1 --id /subscriptions/0b1f6471-1bf0-4dda-aec3-111111111111/resourceGroups/my_resource_group/providers/Microsoft.Web/sites/myWebapp
"""
...
helps['group exists'] = """
    ...
    examples:
        - name: Check group existence.
          text: >
            az group exists -n my_resource_group
"""
...
helps['group create'] = """
    ...
    examples:
        - name: Create a resource group in West US.
          text: >
            az group create -l westus -n my_resource_group
"""
...
helps['group delete'] = """
    ...
    examples:
        - name: Delete a resource group.
          text: >
            az group delete -n my_resource_group
"""
...
helps['group deployment create'] = """
    ...
    examples:
        - name: Create a deployment from a remote template file.
          text: >
            az group deployment create -g my_resource_group --template-uri https://myresource/azuredeploy.json --parameters @myparameters.json
        - name: Create a deployment from a local template file and use parameter values in a string. 
          text: >
            az group deployment create -g my_resource_group --template-file azuredeploy.json --parameters "{\\"location\\": {\\"value\\": \\"westus\\"}}"
"""
