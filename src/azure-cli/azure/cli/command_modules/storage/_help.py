...
examples:
  - name: Create a storage account 'mystorageaccount123' in resource group 'MyResourceGroup' in the West US region with locally redundant storage.
    text: az storage account create -n mystorageaccount123 -g MyResourceGroup -l westus --sku Standard_LRS
    unsupported-profiles: 2017-03-09-profile
  - name: Create a storage account 'mystorageaccount123' in resource group 'MyResourceGroup' in the West US region with locally redundant storage.
    text: az storage account create -n mystorageaccount123 -g MyResourceGroup -l westus --account-type Standard_LRS
...
examples:
  ...
  - name: Delete a storage account using an account name and resource group.
    text: az storage account delete -n mystorageaccount123 -g MyResourceGroup
"""
...
examples:
  - name: Generate a sas token for the account that is valid for queue and table services on Linux.
    text: |
        ...
        az storage account generate-sas --permissions cdlruwap --account-name mystorageaccount123 --services qt --resource-types sco --expiry $end -otsv
  ...
  - name: Generates a shared access signature for the account (autogenerated)
    text: az storage account generate-sas --account-key 00000000 --account-name mystorageaccount123 --expiry 2020-01-01 --https-only --permissions acuw --resource-types co --services bfqt
    crafted: true
"""
...
examples:
  - name: List the primary and secondary keys for a storage account.
    text: az storage account keys list -g MyResourceGroup -n mystorageaccount123
"""
...
examples:
  - name: Create a rule to allow a specific address-range.
    text: az storage account network-rule add -g myRg --account-name mystorageaccount123 --ip-address 23.45.1.0/24
  - name: Create a rule to allow access for a subnet.
    text: az storage account network-rule add -g myRg --account-name mystorageaccount123 --vnet myvnet --subnet mysubnet
"""
...
examples:
  - name: List network rules. (autogenerated)
    text: az storage account network-rule list --account-name mystorageaccount123 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Remove a network rule. (autogenerated)
    text: az storage account network-rule remove --account-name mystorageaccount123 --resource-group MyResourceGroup --subnet mysubnet
    crafted: true
  - name: Remove a network rule. (autogenerated)
    text: az storage account network-rule remove --account-name mystorageaccount123 --ip-address 23.45.1.0/24 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Show properties for a storage account using an account name and resource group.
    text: az storage account show -g MyResourceGroup -n mystorageaccount123
"""
...
examples:
  - name: Get a connection string for a storage account.
    text: az storage account show-connection-string -g MyResourceGroup -n mystorageaccount123
  - name: Get the connection string for a storage account. (autogenerated)
    text: az storage account show-connection-string --name mystorageaccount123 --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update the properties of a storage account. (autogenerated)
    text: az storage account update --default-action Allow --name mystorageaccount123 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Copies a blob asynchronously. Use `az storage blob show` to check the status of the blobs. (autogenerated)
    text: az storage blob copy start --account-key 00000000 --account-name mystorageaccount123 --destination-blob MyDestinationBlob --destination-container MyDestinationContainer --source-uri https://storage.blob.core.windows.net/photos
    crafted: true
"""
...
examples:
  - name: Copy multiple blobs or files to a blob container. Use `az storage blob show` to check the status of the blobs. (autogenerated)
    text: az storage blob copy start-batch --account-key 00000000 --account-name mystorageaccount123 --destination-container MyDestinationContainer --source-account-key MySourceKey --source-account-name MySourceAccount --source-container MySourceContainer
    crafted: true
"""
...
examples:
  - name: Delete all blobs ending with ".py" in a container that have not been modified for 10 days.
    text: |
        ...
        az storage blob delete-batch -s MyContainer --account-name mystorageaccount123 --pattern *.py --if-unmodified-since $date
"""
...
examples:
  - name: Download all blobs that end with .py
    text: az storage blob download-batch -d . --pattern *.py -s MyContainer --account-name mystorageaccount123
"""
...
examples:
  - name: Check for the existence of a blob in a container. (autogenerated)
    text: az storage blob exists --account-key 00000000 --account-name mystorageaccount123 --container-name MyContainer --name MyBlob
    crafted: true
"""
...
examples:
  - name: Generate a sas token for a blob with read-only permissions.
    text: |
        ...
        az storage blob generate-sas --account-name mystorageaccount123 -c MyContainer -n MyBlob --permissions r --expiry $end --https-only
  - name: Generates a shared access signature for the blob. (autogenerated)
    text: az storage blob generate-sas --account-key 00000000 --account-name mystorageaccount123 --container-name MyContainer --expiry 2018-01-01T00:00:00Z --name MyBlob --permissions r
    crafted: true
"""
...
examples:
  - name: Show the storage blob delete-policy. (autogenerated)
    text: az storage blob service-properties delete-policy show --account-name mystorageaccount123
    crafted: true
"""
...
examples:
  - name: Update the storage blob delete-policy. (autogenerated)
    text: az storage blob service-properties delete-policy update --account-name mystorageaccount123 --days-retained 7 --enable true
    crafted: true
"""
...
examples:
  - name: Update storage blob service properties. (autogenerated)
    text: az storage blob service-properties update --404-document error.html --account-name mystorageaccount123 --index-document index.html --static-website true
    crafted: true
"""
...
examples:
  - name: Set the block or page tiers on the blob. (autogenerated)
    text: az storage blob set-tier --account-key 00000000 --account-name mystorageaccount123 --container-name MyContainer --name MyBlob --tier P10
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a blob (autogenerated)
    text: az storage blob show --account-name mystorageaccount123 --container-name MyContainer --name MyBlob
    crafted: true
"""
...
examples:
  - name: Sync a single blob to a container.
    text: az storage blob sync -c MyContainer --account-name mystorageaccount123 -s "path/to/file" -d NewBlob
  - name: Sync a directory to a container.
    text: az storage blob sync -c MyContainer --account-name mystorageaccount123 -s "path/to/directory"
"""
...
examples:
  - name: Upload all files that end with .py unless blob exists and has been modified since given date.
    text: az storage blob upload-batch -d MyContainer --account-name mystorageaccount123 -s directory_path --pattern *.py --if-unmodified-since 2018-08-27T20:51Z
"""
...
examples:
  - name: Marks the specified container for deletion. (autogenerated)
    text: az storage container delete --account-key 00000000 --account-name mystorageaccount123 --name MyContainer
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage container. (autogenerated)
    text: az storage container exists --account-name mystorageaccount123 --name MyContainer
    crafted: true
"""
...
examples:
  - name: Generate a sas token for blob container and use it to upload a blob.
    text: |
        ...
        sas=`az storage container generate-sas -n MyContainer --account-name mystorageaccount123 --https-only --permissions dlrw --expiry $end -otsv`
        az storage blob upload -n MyBlob -c MyContainer --account-name mystorageaccount123 -f file.txt --sas-token $sas
  - name: Generates a shared access signature for the container (autogenerated)
    text: az storage container generate-sas --account-key 00000000 --account-name mystorageaccount123 --expiry 2020-01-01 --name MyContainer --permissions dlrw
    crafted: true
"""
...
examples:
  - name: Get the legal hold properties of a container. (autogenerated)
    text: az storage container legal-hold show --account-name mystorageaccount123 --container-name MyContainer
    crafted: true
"""
...
examples:
  - name: Remove all CORS rules from a storage account. (autogenerated)
    text: az storage cors clear --account-name mystorageaccount123 --services bfqt
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage directory. (autogenerated)
    text: az storage directory exists --account-key 00000000 --account-name mystorageaccount123 --name MyDirectory --share-name myshare
    crafted: true
"""
...
examples:
  - name: Delete files from an Azure Storage File Share. (autogenerated)
    text: az storage file delete-batch --account-key 00000000 --account-name mystorageaccount123 --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Download files from an Azure Storage File Share to a local directory in a batch operation. (autogenerated)
    text: az storage file download-batch --account-name mystorageaccount123 --destination . --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file. (autogenerated)
    text: az storage file exists --account-key 00000000 --account-name mystorageaccount123 --path path/file.txt --share-name myshare
    crafted: true
"""
...
examples:
  - name: Generate a sas token for a file.
    text: |
        ...
        az storage file generate-sas -p path/file.txt -s myshare --account-name mystorageaccount123 --permissions rcdw --https-only --expiry $end
"""
...
examples:
  ...
  - name: Upload a file to a share that uses the SMB 3.0 protocol. (autogenerated)
    text: az storage file upload --account-key 00000000 --account-name mystorageaccount123 --path path/file.txt --share-name myshare --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Upload files from a local directory to an Azure Storage File Share in a batch operation. (autogenerated)
    text: az storage file upload-batch --account-key 00000000 --account-name mystorageaccount123 --destination . --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Create the url to access a file. (autogenerated)
    text: az storage file url --account-name mystorageaccount123 --path path/file.txt --share-name myshare
    crafted: true
"""
...
examples:
  - name: Show metrics settings for a storage account. (autogenerated)
    text: az storage metrics show --account-key 00000000 --account-name mystorageaccount123
    crafted: true
"""
...
examples:
  - name: Update metrics settings for a storage account. (autogenerated)
    text: az storage metrics update --account-name mystorageaccount123 --api true --hour true --minute true --retention 10 --services bfqt
    crafted: true
"""
...
examples:
  - name: Creates a new share under the specified account.
    text: az storage share create --name myfileshare --account-name mystorageaccount123
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file share. (autogenerated)
    text: az storage share exists --account-key 00000000 --account-name mystorageaccount123 --name myfileshare
    crafted: true
"""
...
examples:
  - name: Generate a sas token for a fileshare and use it to upload a file.
    text: |
        ...
        sas=`az storage share generate-sas -n myshare --account-name mystorageaccount123 --https-only --permissions dlrw --expiry $end -otsv`
        az storage file upload -s myshare --account-name mystorageaccount123 --source file.txt  --sas-token $sas
"""
...
examples:
  - name: Create a URI to access a file share. (autogenerated)
    text: az storage share url --account-key 00000000 --account-name mystorageaccount123 --name myfileshare
    crafted: true
"""
