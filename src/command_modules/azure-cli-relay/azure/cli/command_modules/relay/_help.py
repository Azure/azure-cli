...
helps["relay"] = """
type: group
short-summary: Manage Azure Relay Service namespaces, WCF relays, hybrid connections,
    and rules
"""
...
-   name: Create Authorization Rule for given Relay Service Hybrid Connection
    text: az relay hyco authorization-rule create --resource-group myresourcegroup
        --namespace-name mynamespace --hybrid-connection-name myhyco --name myauthorule
        --rights Send Listen
"""
...
-   name: Deletes the Authorization Rule of Relay Service Hybrid Connection.
    text: az relay hyco authorization-rule delete --resource-group myresourcegroup
        --namespace-name mynamespace --hybrid-connection-name myhyco --name myauthorule
"""
...
type: command
short-summary: List the keys and connection strings of Authorization Rule for Relay
    Service Hybrid Connection.
examples:
-   name: List the keys and connection strings of Authorization Rule for Relay Service
        Hybrid Connection.
    text: az relay hyco authorization-rule keys list --resource-group myresourcegroup
        --namespace-name mynamespace --hybrid-connection-name myhyco --name myauthorule
"""
...
-   name: Regenerate key of Relay Service Hybrid Connection.
    text: az relay hyco authorization-rule keys renew --resource-group myresourcegroup
        --namespace-name mynamespace --hybrid-connection-name myhyco --name myauthorule
        --key PrimaryKey
"""
...
-   name: shows list of Authorization Rule by Relay Service Hybrid Connection
    text: az relay hyco authorization-rule list --resource-group myresourcegroup --namespace-name
        mynamespace --hybrid-connection-name myhyco
"""

helps["relay hyco authorization-rule show"] = """
type: command
short-summary: Shows the details of Authorization Rule for given Relay Service Hybrid
    Connection
examples:
-   name: Shows the details of Authorization Rule for given Relay Service Hybrid Connection
    text: az relay hyco authorization-rule show --resource-group myresourcegroup --namespace-name
...
examples:
-   name: Create Authorization Rule for given Relay Service Hybrid Connection
    text: az relay hyco authorization-rule update --resource-group myresourcegroup
        --namespace-name mynamespace --hybrid-connection-name myhyco --name myauthorule
        --rights Send
"""
...
-   name: Create a new Relay Service Hybrid Connection
    text: az relay hyco create --resource-group myresourcegroup --namespace-name mynamespace
        --name myhyco
"""
...
-   name: Deletes the Relay Service Hybrid Connection
    text: az relay hyco delete --resource-group myresourcegroup --namespace-name mynamespace
        --name myhyco
"""
...
-   name: Shows the Hybrid Connection details.
    text: az relay hyco show --resource-group myresourcegroup --namespace-name mynamespace
        --name myhyco
"""
...
-   name: Updates existing Relay Service Hybrid Connection.
    text: az relay hyco update --resource-group myresourcegroup --namespace-name mynamespace
        --name myhyco --support-ordering True
"""
...
examples:
-   name: Create Authorization Rule 'myrule' for the given Relay Service Namespace
        'mynamespace' in resourcegroup
    text: az relay namespace authorization-rule create --resource-group myresourcegroup
...
-   name: Deletes the Authorization Rule of the Relay Service Namespace.
    text: az relay namespace authorization-rule delete --resource-group myresourcegroup
...
-   name: List the keys and connection strings of Authorization Rule for Relay Service
        Namespace
    text: az relay namespace authorization-rule keys list --resource-group myresourcegroup
        --namespace-name mynamespace --name myauthorule
"""
...
-   name: Regenerate keys of Authorization Rule for the Relay Service Namespace.
    text: az relay namespace authorization-rule keys renew --resource-group myresourcegroup
...
-   name: Shows the list of Authorization Rule by Relay Service Namespace
    text: az relay namespace authorization-rule list --resource-group myresourcegroup
...
-   name: Shows the details of Relay Service Namespace Authorization Rule
    text: az relay namespace authorization-rule show --resource-group myresourcegroup
        --namespace-name mynamespace --name myauthorule
"""
...
examples:
-   name: Updates Authorization Rule 'myrule' for the given Relay Service Namespace
        'mynamespace' in resourcegroup
    text: az relay namespace authorization-rule update --resource-group myresourcegroup
...
-   name: Create a Relay Service Namespace.
    text: az relay namespace create --resource-group myresourcegroup --name mynamespace
        --location westus --tags tag1=value1 tag2=value2
"""
...
-   name: Updates a Relay Service Namespace.
    text: az relay namespace update --resource-group myresourcegroup --name mynamespace
        --tags tag=value
"""
...
-   name: Create Authorization Rule for WCF Relay
    text: az relay wcfrelay authorization-rule create --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay --name myauthorule --rights
        Listen
"""
...
-   name: Delete the Authorization Rule of Relay Service WCF Relay
    text: az relay wcfrelay authorization-rule delete --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay --name myauthorule
"""
...
type: command
short-summary: List the keys and connection strings of Authorization Rule for the
    given Relay Service WCF Relay
examples:
-   name: List the keys and connection strings of Authorization Rule for the given
        Relay Service WCF Relay
    text: az relay wcfrelay authorization-rule keys list --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay --name myauthorule
"""
...
-   name: Regenerate keys of Authorization Rule for Relay Service WCF Relay
    text: az relay wcfrelay authorization-rule keys renew --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay --name myauthorule --key
        PrimaryKey
"""
...
-   name: List of Authorization Rule by WCF Relay
    text: az relay wcfrelay authorization-rule list --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay
"""

helps["relay wcfrelay authorization-rule show"] = """
type: command
short-summary: show properties of Authorization Rule for the given Relay Service WCF
    Relay.
examples:
-   name: show properties of Authorization Rule
    text: az relay wcfrelay authorization-rule show --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay --name myauthorule
"""
...
-   name: Update Authorization Rule for WCF Relay
    text: az relay wcfrelay authorization-rule update --resource-group myresourcegroup
        --namespace-name mynamespace --relay-name myrelay --name myauthorule --rights
        Send
"""
...
-   name: Create Relay Service WCF Relay.
    text: az relay wcfrelay create --resource-group myresourcegroup --namespace-name
        mynamespace --name myrelay
"""
...
-   name: Deletes the wcfrelay
    text: az relay wcfrelay delete --resource-group myresourcegroup --namespace-name
        mynamespace --name myrelay
"""
...
-   name: Get the WCF Relays by Relay Service Namespace.
    text: az relay wcfrelay list --resource-group myresourcegroup --namespace-name
        mynamespace
"""
...
-   name: Shows the Relay Service WCF Relay Details
    text: az relay wcfrelay show --resource-group myresourcegroup --namespace-name
        mynamespace --name myrelay
"""
...
-   name: Updates Relay Service WCF Relay.
    text: az relay wcfrelay update --resource-group myresourcegroup --namespace-name
        mynamespace --name myrelay --auto-delete-on-idle PT3M
"""
