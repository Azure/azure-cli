...
**Analysis**: Not all configured properties updated for a cmd are considered as breaking changes. The properties listed in CMD_PROPERTY_UPDATE_BREAK_LIST below are thought to influence or interrupt current workflow and be breaking changes.
