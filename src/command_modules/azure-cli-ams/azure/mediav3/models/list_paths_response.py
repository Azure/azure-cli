...
class ListPathsResponse(Model):
    ...
    :param streaming_paths: Streaming Paths supported by current Streaming
     Locator
    :type streaming_paths: list[~encoding.models.StreamingPath]
    ...
    def __init__(self, streaming_paths=None, download_paths=None):
        super(ListPathsResponse, self).__init__()
