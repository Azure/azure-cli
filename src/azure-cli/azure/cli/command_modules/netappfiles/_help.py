...
examples:
  ...
  - name: Create a new Azure NetApp Files (ANF) snapshot. (autogenerated)
    text: |
        az netappfiles snapshot create --account-name myaccname --location eastus --pool-name mypoolname --resource-group mygroup --snapshot-name mysnapname --subscription MySubscription --volume-name myvolname
    crafted: true
"""
