...
class Start(AAZCommand):
    ...
    :example: Start packet capture on a VPN connection.
        az network vpn-connection packet-capture start -g MyResourceGroup -n MyConnection
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualNetworkGatewayConnectionsStartPacketCapture(ctx=self.ctx)()
