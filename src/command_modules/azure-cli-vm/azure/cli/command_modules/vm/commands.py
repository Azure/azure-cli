...
from azure.cli.command_modules.vm._validators import (
    ...
    process_remove_identity_namespace, process_vm_secret_format, process_vm_vmss_stop, process_vmss_update_namespace)
...
def load_command_table(self, _):
    ...
    with self.command_group('vmss', compute_vmss_sdk, operation_group='virtual_machine_scale_sets') as g:
        ...
        g.generic_update_command('update', getter_name='get_vmss', setter_name='update_vmss', supports_no_wait=True, command_type=compute_custom, validator=process_vmss_update_namespace)
