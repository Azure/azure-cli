...
class Update(AAZCommand):
    ...
    class ConnectorGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_connector_resource_read(cls._schema_on_200)
    ...
    class ConnectorCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_connector_resource_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_connector_resource_read = None

    @classmethod
    def _build_schema_connector_resource_read(cls, _schema):
        if cls._schema_connector_resource_read is not None:
            _schema.id = cls._schema_connector_resource_read.id
            _schema.name = cls._schema_connector_resource_read.name
            _schema.properties = cls._schema_connector_resource_read.properties
            _schema.system_data = cls._schema_connector_resource_read.system_data
            _schema.type = cls._schema_connector_resource_read.type
            return

        cls._schema_connector_resource_read = _schema_connector_resource_read = AAZObjectType()

        connector_resource_read = _schema_connector_resource_read
        connector_resource_read.id = AAZStrType(
            flags={"read_only": True},
        )
        connector_resource_read.name = AAZStrType(
            flags={"read_only": True},
        )
        connector_resource_read.properties = AAZObjectType(
            flags={"required": True, "client_flatten": True},
        )
        connector_resource_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        connector_resource_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_connector_resource_read.properties
        ...
        connector_basic_info = _schema_connector_resource_read.properties.connector_basic_info
        ...
        connector_service_type_info = _schema_connector_resource_read.properties.connector_service_type_info
        connector_service_type_info.connector_service_type = AAZStrType(
            serialized_name="connectorServiceType",
            flags={"required": True},
        )

        disc_azure_blob_storage_sink_connector = _schema_connector_resource_read.properties.connector_service_type_info.discriminate_by("connector_service_type", "AzureBlobStorageSinkConnector")
        ...
        disc_azure_blob_storage_source_connector = _schema_connector_resource_read.properties.connector_service_type_info.discriminate_by("connector_service_type", "AzureBlobStorageSourceConnector")
        ...
        disc_azure_cosmos_db_sink_connector = _schema_connector_resource_read.properties.connector_service_type_info.discriminate_by("connector_service_type", "AzureCosmosDBSinkConnector")
        ...
        disc_azure_cosmos_db_source_connector = _schema_connector_resource_read.properties.connector_service_type_info.discriminate_by("connector_service_type", "AzureCosmosDBSourceConnector")
        ...
        disc_azure_synapse_analytics_sink_connector = _schema_connector_resource_read.properties.connector_service_type_info.discriminate_by("connector_service_type", "AzureSynapseAnalyticsSinkConnector")
        ...
        partner_connector_info = _schema_connector_resource_read.properties.partner_connector_info
        partner_connector_info.partner_connector_type = AAZStrType(
            serialized_name="partnerConnectorType",
            flags={"required": True},
        )

        disc_kafka_azure_blob_storage_sink = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureBlobStorageSink")
        ...
        topics = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureBlobStorageSink").topics
        topics.Element = AAZStrType()

        disc_kafka_azure_blob_storage_source = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureBlobStorageSource")
        ...
        disc_kafka_azure_cosmos_db_sink = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureCosmosDBSink")
        ...
        topics = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureCosmosDBSink").topics
        topics.Element = AAZStrType()

        disc_kafka_azure_cosmos_db_source = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureCosmosDBSource")
        ...
        disc_kafka_azure_synapse_analytics_sink = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureSynapseAnalyticsSink")
        ...
        topics = _schema_connector_resource_read.properties.partner_connector_info.discriminate_by("partner_connector_type", "KafkaAzureSynapseAnalyticsSink").topics
        topics.Element = AAZStrType()

        system_data = _schema_connector_resource_read.system_data
