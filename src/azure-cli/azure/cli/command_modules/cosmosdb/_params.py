...
def load_arguments(self, _):
    ...
    with self.argument_context('cosmosdb collection') as c:
        ...
        c.argument('vector_embedding_policy', options_list=['--vector-embedding-policy'], type=shell_safe_json_parse, completer=FilesCompleter(), help='Vector Encryption Policy, you can enter it as a string or as a file, e.g., --vector-embeddings @policy-file.json or ' + SQL_VECTOR_EMBEDDING_POLICY_EXAMPLE)
