...
@register_command(
    "afd custom-domain regenerate-validation-token",
)
class RegenerateValidationToken(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AFDCustomDomainsRefreshValidationToken(ctx=self.ctx)()
    ...
    class AFDCustomDomainsRefreshValidationToken(AAZHttpOperation):
...
class _RegenerateValidationTokenHelper:
    """Helper class for RegenerateValidationToken"""


__all__ = ["RegenerateValidationToken"]
