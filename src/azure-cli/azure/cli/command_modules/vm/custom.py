...
def restart_vm(cmd, resource_group_name, vm_name, no_wait=False, force=False):
    from .aaz.latest.vm import Redeploy as VmRedeploy, Restart as VmRestart
    command_args = {
        'resource_group': resource_group_name,
        'vm_name': vm_name,
        'no_wait': no_wait,
    ...
    if force:
        return VmRedeploy(cli_ctx=cmd.cli_ctx)(command_args=command_args)
    return VmRestart(cli_ctx=cmd.cli_ctx)(command_args=command_args)
