...
class AKSManagedClusterContext(BaseAKSContext):
    ...
    def _get_network_plugin(self, enable_validation: bool = False) -> Union[str, None]:
        ...
        if enable_validation:
            (
                ...
                dns_service_ip,
                network_policy,
            ) = self._get_pod_cidr_and_service_cidr_and_dns_service_ip_and_network_policy(
                enable_validation=False
            )
    ...
    def _get_pod_cidr_and_service_cidr_and_dns_service_ip_and_network_policy(
        self, enable_validation: bool = False
    ) -> Tuple[
        Union[str, None],
        Union[str, None],
    ...
    def get_pod_cidr_and_service_cidr_and_dns_service_ip_and_and_network_policy(
        ...
        string type or None.
        """
        return self._get_pod_cidr_and_service_cidr_and_dns_service_ip_and_network_policy(
