...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_common_ipam_pool_prefix_allocation_update(ipam_pool_prefix_allocations.Element)
        ...
        cls._build_args_common_address_space_update(_args_schema.summarized_gateway_prefixes)
        return cls._args_schema

    _args_common_address_space_update = None

    @classmethod
    def _build_args_common_address_space_update(cls, _schema):
        if cls._args_common_address_space_update is not None:
            _schema.address_prefixes = cls._args_common_address_space_update.address_prefixes
            _schema.ipam_pool_prefix_allocations = cls._args_common_address_space_update.ipam_pool_prefix_allocations
            return

        cls._args_common_address_space_update = AAZObjectArg(
            nullable=True,
        )

        common_address_space_update = cls._args_common_address_space_update
        common_address_space_update.address_prefixes = AAZListArg(
            options=["address-prefixes"],
            help="A list of address blocks reserved for this virtual network in CIDR notation.",
            nullable=True,
        )
        common_address_space_update.ipam_pool_prefix_allocations = AAZListArg(
            options=["ipam-pool-prefix-allocations"],
            help="A list of IPAM Pools allocating IP address prefixes.",
            nullable=True,
        )

        address_prefixes = cls._args_common_address_space_update.address_prefixes
        address_prefixes.Element = AAZStrArg(
            nullable=True,
        )

        ipam_pool_prefix_allocations = cls._args_common_address_space_update.ipam_pool_prefix_allocations
        ipam_pool_prefix_allocations.Element = AAZObjectArg(
            nullable=True,
        )
        cls._build_args_common_ipam_pool_prefix_allocation_update(ipam_pool_prefix_allocations.Element)
    ...
    _args_common_ipam_pool_prefix_allocation_update = None

    @classmethod
    def _build_args_common_ipam_pool_prefix_allocation_update(cls, _schema):
        if cls._args_common_ipam_pool_prefix_allocation_update is not None:
            _schema.id = cls._args_common_ipam_pool_prefix_allocation_update.id
            _schema.number_of_ip_addresses = cls._args_common_ipam_pool_prefix_allocation_update.number_of_ip_addresses
            return

        cls._args_common_ipam_pool_prefix_allocation_update = AAZObjectArg(
            nullable=True,
        )

        common_ipam_pool_prefix_allocation_update = cls._args_common_ipam_pool_prefix_allocation_update
        common_ipam_pool_prefix_allocation_update.number_of_ip_addresses = AAZStrArg(
            options=["number-of-ip-addresses"],
            help="Number of IP addresses to allocate.",
            nullable=True,
        )
        common_ipam_pool_prefix_allocation_update.id = AAZResourceIdArg(
            options=["id"],
    ...
    class VirtualNetworksGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_common_virtual_network_read(cls._schema_on_200)
    ...
    class VirtualNetworksCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_common_virtual_network_read(cls._schema_on_200_201)
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                _UpdateHelper._build_schema_common_address_space_update(properties.set_prop("summarizedGatewayPrefixes", AAZObjectType, ".summarized_gateway_prefixes"))
            ...
            if ipam_pool_prefix_allocations is not None:
                _UpdateHelper._build_schema_common_ipam_pool_prefix_allocation_update(ipam_pool_prefix_allocations.set_elements(AAZObjectType, "."))
...
class _UpdateHelper:
    ...
    @classmethod
    def _build_schema_common_address_space_update(cls, _builder):
        if _builder is None:
            return
        ...
        if ipam_pool_prefix_allocations is not None:
            cls._build_schema_common_ipam_pool_prefix_allocation_update(ipam_pool_prefix_allocations.set_elements(AAZObjectType, "."))
    ...
    @classmethod
    def _build_schema_common_ipam_pool_prefix_allocation_update(cls, _builder):
        if _builder is None:
            return
    ...
    _schema_common_virtual_network_read = None

    @classmethod
    def _build_schema_common_virtual_network_read(cls, _schema):
        if cls._schema_common_virtual_network_read is not None:
            _schema.etag = cls._schema_common_virtual_network_read.etag
            _schema.extended_location = cls._schema_common_virtual_network_read.extended_location
            _schema.id = cls._schema_common_virtual_network_read.id
            _schema.location = cls._schema_common_virtual_network_read.location
            _schema.name = cls._schema_common_virtual_network_read.name
            _schema.properties = cls._schema_common_virtual_network_read.properties
            _schema.tags = cls._schema_common_virtual_network_read.tags
            _schema.type = cls._schema_common_virtual_network_read.type
            return

        cls._schema_common_virtual_network_read = _schema_common_virtual_network_read = AAZObjectType()

        common_virtual_network_read = _schema_common_virtual_network_read
        common_virtual_network_read.etag = AAZStrType(
            flags={"read_only": True},
        )
        common_virtual_network_read.extended_location = AAZObjectType(
            serialized_name="extendedLocation",
        )
        cls._build_schema_common_extended_location_read(common_virtual_network_read.extended_location)
        common_virtual_network_read.id = AAZStrType()
        common_virtual_network_read.location = AAZStrType()
        common_virtual_network_read.name = AAZStrType(
            flags={"read_only": True},
        )
        common_virtual_network_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        common_virtual_network_read.tags = AAZDictType()
        common_virtual_network_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_common_virtual_network_read.properties
        properties.address_space = AAZObjectType(
            serialized_name="addressSpace",
        )
        cls._build_schema_common_address_space_read(properties.address_space)
        properties.bgp_communities = AAZObjectType(
            serialized_name="bgpCommunities",
        )
        cls._build_schema_common_virtual_network_bgp_communities_read(properties.bgp_communities)
        properties.ddos_protection_plan = AAZObjectType(
            serialized_name="ddosProtectionPlan",
        )
        cls._build_schema_common_sub_resource_read(properties.ddos_protection_plan)
        properties.default_public_nat_gateway = AAZObjectType(
            serialized_name="defaultPublicNatGateway",
            flags={"read_only": True},
        )
        cls._build_schema_common_sub_resource_read(properties.default_public_nat_gateway)
        ...
        cls._build_schema_common_virtual_network_encryption_read(properties.encryption)
        properties.flow_logs = AAZListType(
            serialized_name="flowLogs",
            flags={"read_only": True},
        )
        ...
        cls._build_schema_common_address_space_read(properties.summarized_gateway_prefixes)
        properties.virtual_network_peerings = AAZListType(
            serialized_name="virtualNetworkPeerings",
        )

        dhcp_options = _schema_common_virtual_network_read.properties.dhcp_options
        dhcp_options.dns_servers = AAZListType(
            serialized_name="dnsServers",
        )

        dns_servers = _schema_common_virtual_network_read.properties.dhcp_options.dns_servers
        dns_servers.Element = AAZStrType()

        flow_logs = _schema_common_virtual_network_read.properties.flow_logs
        flow_logs.Element = AAZObjectType()
        cls._build_schema_common_flow_log_read(flow_logs.Element)

        ip_allocations = _schema_common_virtual_network_read.properties.ip_allocations
        ip_allocations.Element = AAZObjectType()
        cls._build_schema_common_sub_resource_read(ip_allocations.Element)

        subnets = _schema_common_virtual_network_read.properties.subnets
        subnets.Element = AAZObjectType()
        cls._build_schema_common_subnet_read(subnets.Element)

        virtual_network_peerings = _schema_common_virtual_network_read.properties.virtual_network_peerings
        virtual_network_peerings.Element = AAZObjectType()

        _element = _schema_common_virtual_network_read.properties.virtual_network_peerings.Element
        _element.etag = AAZStrType(
            flags={"read_only": True},
        )
        _element.id = AAZStrType()
        ...
        properties = _schema_common_virtual_network_read.properties.virtual_network_peerings.Element.properties
        ...
        cls._build_schema_common_address_space_read(properties.local_address_space)
        ...
        cls._build_schema_common_address_space_read(properties.local_virtual_network_address_space)
        ...
        cls._build_schema_common_address_space_read(properties.remote_address_space)
        properties.remote_bgp_communities = AAZObjectType(
            serialized_name="remoteBgpCommunities",
        )
        cls._build_schema_common_virtual_network_bgp_communities_read(properties.remote_bgp_communities)
        ...
        cls._build_schema_common_sub_resource_read(properties.remote_virtual_network)
        properties.remote_virtual_network_address_space = AAZObjectType(
            serialized_name="remoteVirtualNetworkAddressSpace",
        )
        cls._build_schema_common_address_space_read(properties.remote_virtual_network_address_space)
        properties.remote_virtual_network_encryption = AAZObjectType(
            serialized_name="remoteVirtualNetworkEncryption",
            flags={"read_only": True},
        )
        cls._build_schema_common_virtual_network_encryption_read(properties.remote_virtual_network_encryption)
        properties.resource_guid = AAZStrType(
            serialized_name="resourceGuid",
            flags={"read_only": True},
        )
        ...
        local_subnet_names = _schema_common_virtual_network_read.properties.virtual_network_peerings.Element.properties.local_subnet_names
        local_subnet_names.Element = AAZStrType()

        remote_subnet_names = _schema_common_virtual_network_read.properties.virtual_network_peerings.Element.properties.remote_subnet_names
        remote_subnet_names.Element = AAZStrType()

        tags = _schema_common_virtual_network_read.tags
        tags.Element = AAZStrType()
