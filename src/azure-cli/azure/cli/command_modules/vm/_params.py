...
def load_arguments(self, _):
    ...
    with self.argument_context('disk') as c:
        ...
        c.argument('upload_size_byte', type=int, min_api='2019-03-01', help='The size (in bytes) of the contents of the upload including the VHD footer. Min value: 20972032. Max value: 35183298347520')
    # endregion
    ...
    with self.argument_context('snapshot', resource_type=ResourceType.MGMT_COMPUTE, operation_group='snapshots') as c:
        ...
        c.argument('incremental', help='Whether a snapshot is incremental. Incremental snapshots on the same disk occupy less space than full snapshots and can be diffed', arg_type=get_three_state_flag())
    # endregion
