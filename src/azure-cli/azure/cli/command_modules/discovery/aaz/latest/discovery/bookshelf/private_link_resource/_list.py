...
@register_command(
    "discovery bookshelf private-link-resource list",
)
class List(AAZCommand):
    """List all private link resources for the bookshelf.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BookshelfPrivateLinkResourcesListByBookshelf(ctx=self.ctx)()
    ...
    class BookshelfPrivateLinkResourcesListByBookshelf(AAZHttpOperation):
