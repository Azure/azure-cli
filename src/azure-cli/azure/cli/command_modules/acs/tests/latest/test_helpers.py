...
class GetUserAssignedIdentityTestCase(unittest.TestCase):
    ...
    def test_get_user_assigned_identity(self):
        ...
        cloud_error_2 = HttpResponseError(Mock(status_code="xxx"), "mock user assigned identity was not found")
        ...
        cloud_error_3 = HttpResponseError(Mock(status_code="xxx"), "test_error_msg")
