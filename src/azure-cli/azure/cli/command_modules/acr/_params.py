...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr check-health') as c:
        ...
        c.argument('vnet', options_list=['--vnet'],
                   help="Virtual network ID to verify the DNS routing of private endpoints. Can be a name if in the same resource group of the registry. You must run the command inside the virtual network",
                   required=False)
