...
@register_command(
    "network application-gateway redirect-config delete",
)
class Delete(AAZCommand):
    """Delete a redirect configuration.

    :example: Delete a redirect configuration.
...
class Show(AAZCommand):
    ...
    :example: Get the details of a redirect configuration.
...
class Update(AAZCommand):
    ...
    :example: Update a redirect configuration to a different http-listener.
