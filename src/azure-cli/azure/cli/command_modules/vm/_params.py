...
def load_arguments(self, _):
    ...
    with self.argument_context('vm open-port') as c:
        ...
        c.argument('port', help="The port or port range (ex: 80-100) to open inbound traffic to. Use '*' to allow traffic to all ports. Use Comma separated values for multiple port or port ranges.")
