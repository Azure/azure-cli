...
@link_helper(
    __package__,
    ("_build_schema_sub_resource_create", _Helper),
    ("_build_schema_application_gateway_backend_address_pool_read", _Helper),
    ("_build_schema_application_gateway_custom_error_read", _Helper),
    ("_build_schema_application_gateway_header_configuration_read", _Helper),
    ("_build_schema_application_gateway_ip_configuration_read", _Helper),
    ("_build_schema_application_gateway_ssl_policy_read", _Helper),
...
__all__ = ["Create","Delete","Health","HealthOnDemand","List","Show","Start","Stop","Update","Wait","__CMDGroup"]
