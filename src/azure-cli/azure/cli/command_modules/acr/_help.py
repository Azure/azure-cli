...
long-summary: Docker must be installed on your machine. Once done, use 'docker logout `<registry url>`xcbnx' to log out. (If you only need an access token and do not want to install Docker, specify '--expose-token')
examples:
