...
class Show(AAZCommand):
    ...
    :example: Get a specific order by name.
    ...
    class OrdersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_order_status_read(properties.current_status)
            ...
            _ShowHelper._build_schema_tracking_info_read(delivery_tracking_info.Element)

            order_history = cls._schema_on_200.properties.order_history
            order_history.Element = AAZObjectType()
            _ShowHelper._build_schema_order_status_read(order_history.Element)

            return_tracking_info = cls._schema_on_200.properties.return_tracking_info
            return_tracking_info.Element = AAZObjectType()
            _ShowHelper._build_schema_tracking_info_read(return_tracking_info.Element)
