...
examples:
  ...
  - name: Restart a server. (autogenerated)
    text: az mariadb server restart --name testsvr --resource-group testgroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a virtual network rule to allows access to a MariaDB server. (autogenerated)
    text: az mariadb server vnet-rule create --name vnetRuleName --resource-group testgroup --server-name testsvr --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/vnetName/subnets/subnetName
    crafted: true
"""
...
examples:
  ...
  - name: Delete a server. (autogenerated)
    text: az mysql server delete --name testsvr --resource-group testgroup --yes
    crafted: true
"""
...
examples:
  ...
  - name: Create a read replica for a server. (autogenerated)
    text: |
        az mysql server replica create --name testreplsvr --resource-group testgroup --source-server "/subscriptions/${SubID}/resourceGroups/${ResourceGroup}/providers/Microsoft.DBforMySQL/servers/testsvr2"
    crafted: true
"""
...
examples:
  - name: Delete a firewall rule. (autogenerated)
    ...
    crafted: true
  - name: Delete a firewall rule. (autogenerated) (autogenerated)
    text: az postgres server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer
    crafted: true
"""
