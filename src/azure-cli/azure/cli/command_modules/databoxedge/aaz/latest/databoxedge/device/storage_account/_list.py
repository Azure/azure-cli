...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.StorageAccountsListByDataBoxEdgeDevice(ctx=self.ctx)()
    ...
    class StorageAccountsListByDataBoxEdgeDevice(AAZHttpOperation):
