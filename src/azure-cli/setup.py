...
DEPENDENCIES = [
    ...
    'azure-cli-ams==0.4.5',
    'azure-cli-appservice==0.2.19',
    'azure-cli-backup==1.2.4',
    'azure-cli-batch==4.0.1',
    'azure-cli-batchai==0.4.8',
    'azure-cli-billing==0.2.1',
    'azure-cli-botservice==0.2.0',
    'azure-cli-cdn==0.2.3',
