...
from azure.mgmt.containerinstance.models import (
    ContainerGroupRestartPolicy, OperatingSystemTypes, ContainerNetworkProtocol, AutoGeneratedDomainNameLabelScope)
...
def load_arguments(self, _):
    ...
    with self.argument_context('container create') as c:
        ...
        c.argument('auto_generated_domain_name_label_scope', arg_type=get_enum_type(AutoGeneratedDomainNameLabelScope), help='The autogenerate name label policy chosen by user')
