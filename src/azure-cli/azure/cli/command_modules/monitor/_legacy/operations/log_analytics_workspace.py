...
from azure.cli.command_modules.monitor._legacy.aaz.latest.monitor.log_analytics.workspace.data_export import \
    Create as _WorkspaceDataExportCreate, \
    Update as _WorkspaceDataExportUpdate
from azure.cli.command_modules.monitor._legacy.aaz.latest.monitor.log_analytics.workspace.table import \
    Create as _WorkspaceTableCreate, \
    Update as _WorkspaceTableUpdate
from azure.cli.command_modules.monitor._legacy.aaz.latest.monitor.log_analytics.workspace.table.search_job \
...
def recover_log_analytics_workspace(cmd, workspace_name, resource_group_name=None, no_wait=False):
    from azure.cli.command_modules.monitor._legacy.aaz.latest.monitor.log_analytics.workspace import Create, \
...
def create_log_analytics_workspace_saved_search(cmd, workspace_name, resource_group_name, saved_search_id,
                                                ...
                                                tags=None):
    from azure.cli.command_modules.monitor._legacy.aaz.latest.monitor.log_analytics.workspace.saved_search import Create
...
def update_log_analytics_workspace_saved_search(cmd, workspace_name, resource_group_name, saved_search_id,
                                                ...
                                                function_alias=None, function_parameters=None,
                                                tags=None):
    from azure.cli.command_modules.monitor._legacy.aaz.latest.monitor.log_analytics.workspace.saved_search import Update
    command_args = {
        "resource_group": resource_group_name,
        "saved_search_name": saved_search_id,
        "workspace_name": workspace_name,
