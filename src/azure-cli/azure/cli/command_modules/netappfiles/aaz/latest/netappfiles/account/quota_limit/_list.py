...
@register_command(
    "netappfiles account quota-limit list",
)
class List(AAZCommand):
    """List a list of quota limits for all quotas that are under account. Currently PoolsPerAccount is the only one.

    :example: QuotaLimits
        az netappfiles account quota-limit list --resource-group myRG --account-name myAccount
    """

    _aaz_info = {
        "version": "2025-12-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/quotalimits", "2025-12-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetAppResourceQuotaLimitsAccountList(ctx=self.ctx)()
    ...
    class NetAppResourceQuotaLimitsAccountList(AAZHttpOperation):
