...
examples:
  - name: Grant a resource read access to a managed disk
...
examples:
  - name: View an instance of a VMSS
    text: az vmss get-instance-view --instance-id instanceId --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Upgrade VMs within a VMSS. (autogenerated)
    text: az vmss update-instances --instance-ids --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
