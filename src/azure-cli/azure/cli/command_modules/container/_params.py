...
def load_arguments(self, _):
    ...
    with self.argument_context('container create') as c:
        ...
        c.argument('environment_variables', nargs='+', options_list=['--environment-variables', '-e'], type=_environment_variables_type, help='A list of environment variable for the container. Space-separated values in \'key=value\' format. In PowerShell, use azps when values include special characters like " or ^.')
        c.argument('secure_environment_variables', nargs='+', type=_secure_environment_variables_type, help='A list of secure environment variable for the container. Space-separated values in \'key=value\' format. In PowerShell, use azps when values include special characters like " or ^.')
