...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('sf managed-cluster network-security-rule add', validator=validate_add_network_security_rule) as c:
        ...
        c.argument('source_port_ranges', options_list=['--source_port_ranges, --spr'],  action='append', help='string of space separated source port ranges')
        c.argument('destination_port_ranges', options_list=['--destination_port_ranges, --dpr'],  action='append', help='string of space separated destination port ranges')
        c.argument('source_address_prefixes', options_list=['--source_address_prefixes, --sap'],  action='append', help='string of space separated source address prefixes')
        c.argument('destination_address_prefixes', options_list=['destination_address_prefixes, --dap'],  action='append', help='string of space separated destination address prefixes')
