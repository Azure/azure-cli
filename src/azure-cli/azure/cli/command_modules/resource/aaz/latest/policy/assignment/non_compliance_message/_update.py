...
class Update(AAZCommand):
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            _builder.set_prop("message", AAZStrType, ".message", typ_kwargs={"flags": {"required": True}})
            _builder.set_prop("policyDefinitionReferenceId", AAZStrType, ".policy_definition_reference_id")
