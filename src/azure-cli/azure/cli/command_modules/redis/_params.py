...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('redis') as c:
        ...
        c.argument('disable_access_key_authentication', options_list=['--disable-access-keys'], help='Authentication to Redis through access keys is disabled when set as true. Default value is false.')
