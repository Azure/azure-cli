...
def validate_resource_group_name(cmd, ns):
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.account import DataLakeAnalyticsAccountManagementClient  # pylint: disable=line-too-long
