...
AZURE_PUBLIC_CLOUD = Cloud(
    ...
    endpoints=CloudEndpoints(
        ...
        active_directory_resource_id='https://graph.microsoft.com/',
...
AZURE_CHINA_CLOUD = Cloud(
    ...
    endpoints=CloudEndpoints(
        ...
        active_directory_resource_id='https://microsoftgraph.chinacloudapi.cn/',
...
AZURE_US_GOV_CLOUD = Cloud(
    ...
    endpoints=CloudEndpoints(
        ...
        active_directory_resource_id='https://graph.microsoft.us/',
        active_directory_graph_resource_id='https://graph.windows.net/',
...
AZURE_GERMAN_CLOUD = Cloud(
    ...
    endpoints=CloudEndpoints(
        ...
        active_directory_resource_id='https://graph.microsoft.de/',
