...
def load_arguments(self, _):
    ...
    with self.argument_context('appconfig create') as c:
        ...
        c.argument('azure_front_door_profile', help='Resource ID of an Azure Front Door profile to link to this App Configuration store.')
    ...
    with self.argument_context('appconfig update') as c:
        ...
        c.argument('enable_arm_private_network_access', arg_type=enable_arm_private_network_access_arg_type)
        c.argument('kv_revision_retention_period', arg_type=kv_revision_retention_period_arg_type)
        c.argument('azure_front_door_profile', help='Resource ID of an Azure Front Door profile to link to this App Configuration store. Pass "" to unlink a Front Door profile.')
