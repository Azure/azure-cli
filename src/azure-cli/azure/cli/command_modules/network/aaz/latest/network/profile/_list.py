...
class List(AAZCommand):
    ...
    class NetworkProfilesList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_container_network_interface_configuration_read(container_network_interface_configurations.Element)
            ...
            _build_schema_container_network_interface_configuration_read(properties.container_network_interface_configuration)
...
def _build_schema_container_network_interface_configuration_read(_schema):
    global _schema_container_network_interface_configuration_read
    if _schema_container_network_interface_configuration_read is not None:
        _schema.etag = _schema_container_network_interface_configuration_read.etag
        _schema.id = _schema_container_network_interface_configuration_read.id
        _schema.name = _schema_container_network_interface_configuration_read.name
        _schema.properties = _schema_container_network_interface_configuration_read.properties
        _schema.type = _schema_container_network_interface_configuration_read.type
        return

    _schema_container_network_interface_configuration_read = AAZObjectType(
        flags={"read_only": True}
    )
    ...
    _build_schema_sub_resource_read(container_network_interfaces.Element)

    ip_configurations = _schema_container_network_interface_configuration_read.properties.ip_configurations
    ip_configurations.Element = AAZObjectType(
        flags={"read_only": True},
    )
    _build_schema_ip_configuration_profile_read(ip_configurations.Element)
...
def _build_schema_ip_configuration_profile_read(_schema):
    global _schema_ip_configuration_profile_read
    if _schema_ip_configuration_profile_read is not None:
        _schema.etag = _schema_ip_configuration_profile_read.etag
        _schema.id = _schema_ip_configuration_profile_read.id
        _schema.name = _schema_ip_configuration_profile_read.name
        _schema.properties = _schema_ip_configuration_profile_read.properties
        _schema.type = _schema_ip_configuration_profile_read.type
        return

    _schema_ip_configuration_profile_read = AAZObjectType(
        flags={"read_only": True}
    )
...
def _build_schema_subnet_read(_schema):
    ...
    _build_schema_ip_configuration_profile_read(ip_configuration_profiles.Element)
