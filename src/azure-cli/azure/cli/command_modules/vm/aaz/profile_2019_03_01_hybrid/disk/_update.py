...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_source_vault_update(disk_encryption_key.source_vault)
        ...
        cls._build_args_source_vault_update(key_encryption_key.source_vault)
        return cls._args_schema
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if disk_encryption_key is not None:
                ...
                _UpdateHelper._build_schema_source_vault_update(disk_encryption_key.set_prop("sourceVault", AAZObjectType, ".source_vault", typ_kwargs={"flags": {"required": True}}))
            ...
            if key_encryption_key is not None:
                ...
                _UpdateHelper._build_schema_source_vault_update(key_encryption_key.set_prop("sourceVault", AAZObjectType, ".source_vault", typ_kwargs={"flags": {"required": True}}))
