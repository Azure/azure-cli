...
examples:
  ...
  - name: Create a read replica for a server. (autogenerated)
    text: |
        az postgres server replica create --location westus2 --name testreplsvr --no-wait --resource-group testgroup --source-server "/subscriptions/${SubID}/resourceGroups/${ResourceGroup}/providers/Microsoft.DBforPostgreSQL/servers/testsvr2"
    crafted: true
"""
