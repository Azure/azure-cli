...
@register_command(
    "eventhubs georecovery-alias authorization-rule list",
)
class List(AAZCommand):
    """List a list of authorization rules for a Namespace.

    :example: ListAuthorizationRules
        az eventhubs georecovery-alias authorization-rule list --resource-group exampleResourceGroup --namespace-name sdk-Namespace-9080 --alias sdk-DisasterRecovery-4047
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DisasterRecoveryConfigsListAuthorizationRules(ctx=self.ctx)()
    ...
    class DisasterRecoveryConfigsListAuthorizationRules(AAZHttpOperation):
