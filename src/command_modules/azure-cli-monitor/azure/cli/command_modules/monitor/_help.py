...
-   "name": |-
        Create a default activity log alert.
    "text": |-
        az monitor activity-log alert create --condition <condition> --resource-group {ResourceGroup} --action-group <action-group> --name {AlertName}
    "crafted": |-
        True
"""
...
-   "name": |-
        List activity log alerts under a resource group or the current subscription.
    "text": |-
        az monitor activity-log alert list --query [0]
    "crafted": |-
        True
"""
...
-   "name": |-
        List and query activity log events.
    "text": |-
        az monitor activity-log list --query [0] --start-time <start-time> --resource-group {ResourceGroup}
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az monitor diagnostic-settings show --resource <resource> --name MyDiagnosticSetting
    "crafted": |-
        True
"""
...
-   "name": |-
        Create diagnostic settings for the specified resource.
    "text": |-
        az monitor diagnostic-settings create --event-hub <event-hub> --resource <resource> --logs  --event-hub-rule <event-hub-rule> --name MyDiagnosticSettings
    "crafted": |-
        True
"""
...
-   "name": |-
    ...
    "text": |-
        az monitor log-profiles list --query [0]
    "crafted": |-
        True
"""
