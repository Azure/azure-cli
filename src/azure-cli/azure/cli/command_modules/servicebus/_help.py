...
examples:
  ...
  - name: Regenerate keys of Authorization Rule for the Service Bus Namespace (autogenerated)
    ...
    crafted: true
  - name: Set Primary Key of a namespace to self generated SAS token.
    text: az servicebus namespace authorization-rule keys renew --key PrimaryKey --key-value {SAStoken} --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
