...
DEPENDENCIES = [
    'azure-cli-acr==2.2.4',
    'azure-cli-acs==2.3.21',
    'azure-cli-advisor==2.0.0',
    'azure-cli-ams==0.4.4',
    'azure-cli-appservice==0.2.17',
    'azure-cli-backup==1.2.3',
    ...
    'azure-cli-monitor==0.2.12',
    'azure-cli-network==2.3.6',
