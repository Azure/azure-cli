...
from azure.cli.core.commands.parameters import \
    (ignore_type, tags_type, file_type, get_resource_name_completion_list, enum_choice_list, model_choice_list)
...
AccountPermissions = get_sdk_attr('azure.cli.storagesdk.models#AccountPermissions')
DeleteSnapshot = get_sdk_attr('azure.cli.storagesdk.blob#DeleteSnapshot')
BlockBlobService = get_sdk_attr('azure.cli.storagesdk.blob#BlockBlobService')
PageBlobService = get_sdk_attr('azure.cli.storagesdk.blob#PageBlobService')
AppendBlobService = get_sdk_attr('azure.cli.storagesdk.blob#AppendBlobService')
...
SharePermissions = get_sdk_attr('azure.cli.storagesdk.file.models#SharePermissions')
...
QueuePermissions = get_sdk_attr('azure.cli.storagesdk.queue.models#QueuePermissions')
