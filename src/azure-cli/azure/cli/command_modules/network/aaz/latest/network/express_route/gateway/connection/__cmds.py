...
@register_command_group(
    "network express-route gateway connection",
)
...
class Delete(AAZCommand):
    ...
    :example: Delete an ExpressRoute gateway connection. (autogenerated)
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.ExpressRouteConnectionsDelete(ctx=self.ctx)()
        self.post_operations()
    ...
    class ExpressRouteConnectionsDelete(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
class List(AAZCommand):
    ...
    :example: List ExpressRoute gateway connections. (autogenerated)
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ExpressRouteConnectionsList(ctx=self.ctx)()
        self.post_operations()
    ...
    class ExpressRouteConnectionsList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200(cls):
            ...
            express_route_circuit_peering = cls._schema_on_200.value.Element.properties.express_route_circuit_peering
            express_route_circuit_peering.id = AAZStrType()

            routing_configuration = cls._schema_on_200.value.Element.properties.routing_configuration
            routing_configuration.associated_route_table = AAZObjectType(
                serialized_name="associatedRouteTable",
            )
            ...
            propagated_route_tables = cls._schema_on_200.value.Element.properties.routing_configuration.propagated_route_tables
            propagated_route_tables.ids = AAZListType()
            propagated_route_tables.labels = AAZListType()

            ids = cls._schema_on_200.value.Element.properties.routing_configuration.propagated_route_tables.ids
            ids.Element = AAZObjectType()
            _ListHelper._build_schema_sub_resource_read(ids.Element)

            labels = cls._schema_on_200.value.Element.properties.routing_configuration.propagated_route_tables.labels
            labels.Element = AAZStrType()

            vnet_routes = cls._schema_on_200.value.Element.properties.routing_configuration.vnet_routes
            vnet_routes.bgp_connections = AAZListType(
                serialized_name="bgpConnections",
                flags={"read_only": True},
            )
            ...
            static_routes = cls._schema_on_200.value.Element.properties.routing_configuration.vnet_routes.static_routes
            static_routes.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.routing_configuration.vnet_routes.static_routes.Element
            _element.address_prefixes = AAZListType(
                serialized_name="addressPrefixes",
            )
            _element.name = AAZStrType()
...
class Show(AAZCommand):
    ...
    :example: Get the details of an ExpressRoute gateway connection. (autogenerated)
...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.internet_security = AAZBoolArg(
            options=["--internet-security"],
            help="Enable internet security. A virtual hub can have the ability to propagate a learned default route to this ExpressRoute connection. This ref https://review.docs.microsoft.com/en-us/azure/virtual-wan/effective-routes-virtual-hub?branch=pr-en-us-91866#aboutdefaultroute might be helpful.",
            nullable=True,
        )
        _args_schema.routing_weight = AAZIntArg(
            options=["--routing-weight"],
