...
- request:
    body: '{"location": "global", "sku": {"name": "F0"}, "kind": "azurebot", "properties":
      ...
      "f1b15361-7fee-41e7-b7bd-94d2b490759f", "isCmekEnabled": false, "publicNetworkAccess":
  ...
  response:
    ...
    headers:
      ...
      etag:
      - '"a800750b-0000-1800-0000-62b558270000"'
      expires:
      - '-1'
      pragma:
      - no-cache
