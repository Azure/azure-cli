...
def cf_shared_galleries(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).shared_galleries
...
def cf_shared_gallery_image(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).shared_gallery_images


def cf_shared_gallery_image_version(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).shared_gallery_image_versions
...
def cf_capacity_reservation_groups(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).capacity_reservation_groups


def cf_capacity_reservations(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).capacity_reservations


def cf_restore_point(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).restore_points


def cf_restore_point_collection(cli_ctx, *_):
    return _compute_client_factory(cli_ctx).restore_point_collections
