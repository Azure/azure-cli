...
@register_command(
    "monitor log-analytics workspace linked-service list",
)
class List(AAZCommand):
    """Get all the linked services in a workspace.

    :example: Get all the linked services in a workspace.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.LinkedServicesListByWorkspace(ctx=self.ctx)()
    ...
    class LinkedServicesListByWorkspace(AAZHttpOperation):
