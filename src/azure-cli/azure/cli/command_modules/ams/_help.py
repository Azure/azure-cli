    ...
    examples:
      - name: Attach a secondary storage to an Azure Media Services account. (autogenerated)
        text: |
            ...
            --name MyResourceIDSecondaryStorageAccount \\
    ...
    examples:
        ...
        - name: Create a transform. (autogenerated)
          text: |
              ...
              --account-name myAmsAccount \\
              --description newDescription \\
              --name transformName \\
              --preset "C:\\MyPresets\\CustomPreset.json" \\
              --resource-group myResourceGroup
          crafted: true
    """
    ...
    examples:
      - name: Update the details of an asset. (autogenerated)
        text: |
            ...
            --name MyAsset \\
            --resource-group MyResourceGroup \\
            --set outputs[0].relativePriority=High
        crafted: true
"""
    ...
    examples:
      - name: Create a streaming locator. (autogenerated)
        text: |
            ...
            --resource-group MyResourceGroup \\
            --streaming-policy-name MyStreamingPolicy
        crafted: true
"""
    ...
    examples:
      - name: Create a live event. (autogenerated)
        text: |
            ...
            --account-name MyAccount \\
            --ips 1.2.3.4/22 5.6.7.8/30 \\
            --name MyLiveEvent \\
            --resource-group MyResourceGroup \\
            --streaming-protocol FragmentedMP4
        crafted: true
"""
