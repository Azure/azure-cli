...
class ContentKeyPoliciesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~encoding.models.ContentKeyPolicyPaged[~encoding.models.ContentKeyPolicy]
    ...
    def get(
        ...
        :rtype: ~encoding.models.ContentKeyPolicy or
    ...
    def get_policy_properties_with_secrets(
        ...
        :rtype: ~encoding.models.ContentKeyPolicyProperties or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`ApiErrorException<encoding.models.ApiErrorException>`
        """
        # Construct URL
