...
class DeleteBySubscription(AAZCommand):
    """Delete an existing attestation at subscription scope.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AttestationsDeleteAtSubscription(ctx=self.ctx)()
    ...
    class AttestationsDeleteAtSubscription(AAZHttpOperation):
...
class _DeleteBySubscriptionHelper:
    """Helper class for DeleteBySubscription"""


__all__ = ["DeleteBySubscription"]
