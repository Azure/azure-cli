...
class ClaimAnyVm(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.LabsClaimAnyVm(ctx=self.ctx)()
    ...
    class LabsClaimAnyVm(AAZHttpOperation):
...
class _ClaimAnyVmHelper:
    """Helper class for ClaimAnyVm"""
