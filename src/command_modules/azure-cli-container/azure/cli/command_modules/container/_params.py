...
def load_arguments(self, _):
    ...
    with self.argument_context('container create', arg_group='Git Repo Volume') as c:
        c.argument('gitrepo_repository', help='The URL of a git repository to be mounted as a volume')
        c.argument('gitrepo_directory', validator=validate_gitrepo_directory, help="The target directory path in the git repository. Must not contain '..'.")
