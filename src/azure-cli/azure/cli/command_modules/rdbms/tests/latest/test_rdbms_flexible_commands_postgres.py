...
class PostgresFlexibleServerMgmtScenarioTest(FlexibleServerMgmtScenarioTest):
    ...
    @pytest.mark.dependency(name="test_postgres_flexible_server_mgmt_prepare")
    ...
    @AllowLargeResponse()
    @pytest.mark.dependency(name="test_postgres_flexible_server_create", depends=["test_postgres_flexible_server_mgmt_prepare"])
    ...
    @AllowLargeResponse()
    @pytest.mark.dependency(name="test_postgres_flexible_server_create_non_default_tiers", depends=["test_postgres_flexible_server_create"])
    ...
    @AllowLargeResponse()
    @pytest.mark.dependency(name="test_postgres_flexible_server_create_different_version", depends=["test_postgres_flexible_server_create_non_default_tiers"])
    ...
    @AllowLargeResponse()
    @pytest.mark.dependency(name="test_postgres_flexible_server_update_password", depends=["test_postgres_flexible_server_create_different_version"])
