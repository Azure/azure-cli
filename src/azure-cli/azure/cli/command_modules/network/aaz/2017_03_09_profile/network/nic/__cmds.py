...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        subnets = cls._args_schema.ip_configurations.Element.subnet.route_table.subnets
        ...
        cls._build_args_network_interface_create(network_interfaces.Element)
    ...
    _args_network_interface_create = None

    @classmethod
    def _build_args_network_interface_create(cls, _schema):
        if cls._args_network_interface_create is not None:
            _schema.dns_settings = cls._args_network_interface_create.dns_settings
            _schema.enable_ip_forwarding = cls._args_network_interface_create.enable_ip_forwarding
            _schema.etag = cls._args_network_interface_create.etag
            _schema.id = cls._args_network_interface_create.id
            _schema.ip_configurations = cls._args_network_interface_create.ip_configurations
            _schema.location = cls._args_network_interface_create.location
            _schema.mac_address = cls._args_network_interface_create.mac_address
            _schema.network_security_group = cls._args_network_interface_create.network_security_group
            _schema.primary = cls._args_network_interface_create.primary
            _schema.provisioning_state = cls._args_network_interface_create.provisioning_state
            _schema.resource_guid = cls._args_network_interface_create.resource_guid
            _schema.tags = cls._args_network_interface_create.tags
            _schema.virtual_machine = cls._args_network_interface_create.virtual_machine
            return

        cls._args_network_interface_create = AAZObjectArg()

        network_interface_create = cls._args_network_interface_create
        network_interface_create.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        network_interface_create.id = AAZResourceIdArg(
            options=["id"],
        ...
        network_interface_create.location = AAZResourceLocationArg(
            options=["l", "location"],
            help="Resource location.",
            fmt=AAZResourceLocationArgFormat(
                resource_group_arg="resource_group",
        ...
        network_interface_create.dns_settings = AAZObjectArg(
            options=["dns-settings"],
            help="The DNS settings in network interface.",
        )
        network_interface_create.enable_ip_forwarding = AAZBoolArg(
            options=["enable-ip-forwarding"],
            help="Indicates whether IP forwarding is enabled on this network interface.",
        )
        network_interface_create.ip_configurations = AAZListArg(
            options=["ip-configurations"],
            help="A list of IPConfigurations of the network interface.",
        )
        network_interface_create.mac_address = AAZStrArg(
            options=["mac-address"],
            help="The MAC address of the network interface.",
        )
        network_interface_create.network_security_group = AAZObjectArg(
            options=["network-security-group"],
            help="The reference of the NetworkSecurityGroup resource.",
        )
        cls._build_args_network_security_group_create(network_interface_create.network_security_group)
        network_interface_create.primary = AAZBoolArg(
            options=["primary"],
            help="Gets whether this is a primary network interface on a virtual machine.",
        )
        network_interface_create.provisioning_state = AAZStrArg(
            options=["provisioning-state"],
            help="The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.",
        )
        ...
        network_interface_create.virtual_machine = AAZObjectArg(
            options=["virtual-machine"],
            help="The reference of a virtual machine.",
        )
        cls._build_args_sub_resource_create(network_interface_create.virtual_machine)
        network_interface_create.tags = AAZDictArg(
            options=["tags"],
            help="Resource tags.",
        )

        dns_settings = cls._args_network_interface_create.dns_settings
        ...
        applied_dns_servers = cls._args_network_interface_create.dns_settings.applied_dns_servers
        applied_dns_servers.Element = AAZStrArg()

        dns_servers = cls._args_network_interface_create.dns_settings.dns_servers
        dns_servers.Element = AAZStrArg()

        ip_configurations = cls._args_network_interface_create.ip_configurations
        ip_configurations.Element = AAZObjectArg()

        _element = cls._args_network_interface_create.ip_configurations.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        ...
        load_balancer_backend_address_pools = cls._args_network_interface_create.ip_configurations.Element.load_balancer_backend_address_pools
        load_balancer_backend_address_pools.Element = AAZObjectArg()

        _element = cls._args_network_interface_create.ip_configurations.Element.load_balancer_backend_address_pools.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        ...
        load_balancer_inbound_nat_rules = cls._args_network_interface_create.ip_configurations.Element.load_balancer_inbound_nat_rules
        load_balancer_inbound_nat_rules.Element = AAZObjectArg()

        _element = cls._args_network_interface_create.ip_configurations.Element.load_balancer_inbound_nat_rules.Element
        _element.etag = AAZStrArg(
            options=["etag"],
            help="A unique read-only string that changes whenever the resource is updated.",
        )
        ...
        dns_settings = cls._args_network_interface_create.ip_configurations.Element.public_ip_address.dns_settings
        dns_settings.domain_name_label = AAZStrArg(
            options=["domain-name-label"],
        ...
        tags = cls._args_network_interface_create.ip_configurations.Element.public_ip_address.tags
        tags.Element = AAZStrArg()

        tags = cls._args_network_interface_create.tags
        tags.Element = AAZStrArg()
    ...
    class NetworkInterfacesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if subnets is not None:
                _CreateHelper._build_schema_subnet_create(subnets.set_elements(AAZObjectType, "."))
            ...
            if network_interfaces is not None:
                _CreateHelper._build_schema_network_interface_create(network_interfaces.set_elements(AAZObjectType, "."))
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_network_interface_create(cls, _builder):
        if _builder is None:
            return
        ...
        _elements = _builder.get(".properties.ipConfigurations[]")
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@NetworkInterface_create.ip_configurations.[].etag")
            _elements.set_prop("id", AAZStrType, "@NetworkInterface_create.ip_configurations.[].id")
            _elements.set_prop("name", AAZStrType, "@NetworkInterface_create.ip_configurations.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.ipConfigurations[].properties")
        if properties is not None:
            properties.set_prop("loadBalancerBackendAddressPools", AAZListType, "@NetworkInterface_create.ip_configurations.[].load_balancer_backend_address_pools")
            properties.set_prop("loadBalancerInboundNatRules", AAZListType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules")
            properties.set_prop("primary", AAZBoolType, "@NetworkInterface_create.ip_configurations.[].primary")
            properties.set_prop("privateIPAddress", AAZStrType, "@NetworkInterface_create.ip_configurations.[].private_ip_address")
            properties.set_prop("privateIPAllocationMethod", AAZStrType, "@NetworkInterface_create.ip_configurations.[].private_ip_allocation_method")
            properties.set_prop("provisioningState", AAZStrType, "@NetworkInterface_create.ip_configurations.[].provisioning_state")
            properties.set_prop("publicIPAddress", AAZObjectType, "@NetworkInterface_create.ip_configurations.[].public_ip_address")
            cls._build_schema_subnet_create(properties.set_prop("subnet", AAZObjectType, "@NetworkInterface_create.ip_configurations.[].subnet"))
        ...
        _elements = _builder.get(".properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[]")
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_backend_address_pools.[].etag")
            _elements.set_prop("id", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_backend_address_pools.[].id")
            _elements.set_prop("name", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_backend_address_pools.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[].properties")
        if properties is not None:
            properties.set_prop("provisioningState", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_backend_address_pools.[].provisioning_state")
        ...
        _elements = _builder.get(".properties.ipConfigurations[].properties.loadBalancerInboundNatRules[]")
        if _elements is not None:
            _elements.set_prop("etag", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].etag")
            _elements.set_prop("id", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].id")
            _elements.set_prop("name", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].name")
            _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

        properties = _builder.get(".properties.ipConfigurations[].properties.loadBalancerInboundNatRules[].properties")
        if properties is not None:
            properties.set_prop("backendPort", AAZIntType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].backend_port")
            properties.set_prop("enableFloatingIP", AAZBoolType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].enable_floating_ip")
            cls._build_schema_sub_resource_create(properties.set_prop("frontendIPConfiguration", AAZObjectType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].frontend_ip_configuration"))
            properties.set_prop("frontendPort", AAZIntType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].frontend_port")
            properties.set_prop("idleTimeoutInMinutes", AAZIntType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].idle_timeout_in_minutes")
            properties.set_prop("protocol", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].protocol")
            properties.set_prop("provisioningState", AAZStrType, "@NetworkInterface_create.ip_configurations.[].load_balancer_inbound_nat_rules.[].provisioning_state")
    ...
    def _build_schema_network_security_group_create(cls, _builder):
        ...
        if network_interfaces is not None:
            cls._build_schema_network_interface_create(network_interfaces.set_elements(AAZObjectType, "."))
