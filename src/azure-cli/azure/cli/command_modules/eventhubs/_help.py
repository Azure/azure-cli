...
examples:
  ...
  - name: Sets a Geo-Disaster Recovery Configuration Alias for the give Namespace (autogenerated)
    ...
    crafted: true
  - name: Sets Geo-Disaster Recovery Configuration Alias for the give Namespace (autogenerated)
...
examples:
  ...
  - name: Creates Authorizationrule for the given Namespace (autogenerated)
    text: az eventhubs namespace authorization-rule create --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --rights Manage
    crafted: true
"""
...
examples:
  ...
  - name: Add a network rule for a namespace. (autogenerated)
    ...
    crafted: true
  - name: Add a network rule for a namespace. (autogenerated)
    text: az eventhubs namespace network-rule add --action Allow --ip-address 10.6.0.0/24 --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Remove network rule for a namespace (autogenerated)
    text: az eventhubs namespace network-rule remove --ip-address 10.6.0.0/24 --namespace-name mynamespace --resource-group myresourcegroup
    crafted: true
"""
