...
**Analysis**: Not all newly configured properties for a cmd are considered as breaking changes. The properties listed in CMD_PROPERTY_ADD_BREAK_LIST below are thought to influence or interrupt current workflow and be breaking changes. 
