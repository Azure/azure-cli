...
@register_command(
    "cosmosdb postgres configuration show",
)
class Show(AAZCommand):
    ...
    class ConfigurationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            server_role_group_configurations = cls._schema_on_200.properties.server_role_group_configurations
            server_role_group_configurations.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.server_role_group_configurations.Element
