...
examples:
  ...
  - name: Create an encryption scope within storage account. (autogenerated)
    text: |
        az storage account encryption-scope create --account-name mystorageaccount --key-source Microsoft.Storage --key-uri "https://vaultname.vault.azure.net/keys/keyname/0000000000000000000000000000000000000" --name myencryption --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Updates the data policy rules associated with the specified storage account. (autogenerated)
    text: |
        az storage account management-policy update --account-name myaccount --force-string --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  ...
  - name: Mark a blob or snapshot for deletion. (autogenerated)
    text: |
        az storage blob delete --account-key 00000000 --account-name mystorageaccount --container-name mycontainer --name MyBlob
    crafted: true
"""
...
examples:
  ...
  - name: Upload a file to a storage blob. (autogenerated)
    text: |
        az storage blob upload --account-key 0000-0000 --account-name mystorageaccount --container-name MyContainer --file /path/to/file --name MyBlob
    crafted: true
"""
...
examples:
  ...
  - name: Copy multiple files or blobs to a file share. (autogenerated)
    text: |
        az storage file copy start-batch --account-key 00000000 --account-name destaccount --destination-share destshare --pattern *.py --source-account-name srcaccount --source-share srcshare
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the file. (autogenerated)
    text: |
        az storage file generate-sas --account-key 00000000 --account-name MyStorageAccount --expiry 2037-12-31T23:59:00Z --path path/file.txt --permissions rcdw --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Create the url to access a file. (autogenerated)
    text: |
        az storage file url --account-key 00000000 --account-name MyAccount --path path/file.txt --share-name MyShare
    crafted: true
"""
...
examples:
    ...
    - name: Delete a file system in ADLS Gen2 account. (autogenerated)
      text: |
          az storage fs delete --account-name myadlsaccount --auth-mode login --name myfilesystem --yes
      crafted: true
"""
...
examples:
    ...
    - name: List file systems in ADLS Gen2 account. (autogenerated)
      text: |
          az storage fs list --account-name myadlsaccount --auth-mode login
      crafted: true
"""
...
examples:
    ...
    - name: Create a directory in ADLS Gen2 file system. (autogenerated)
      text: |
          az storage fs directory create --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir
      crafted: true
"""
...
examples:
    ...
    - name: Delete a directory in ADLS Gen2 file system. (autogenerated)
      text: |
          az storage fs directory delete --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir
      crafted: true
"""
...
examples:
    ...
    - name: List directories in ADLS Gen2 file system (autogenerated)
      text: |
          az storage fs directory list --account-key 0000-0000 --account-name myadlsaccount --file-system myfilesystem --path dir --recursive true
      crafted: true
"""
...
examples:
  ...
  - name: Upload a file to a file path in ADLS Gen2 file system. (autogenerated)
    text: |
        az storage fs file upload --account-name myadlsaccount --auth-mode login --file-system fsname --path dir/a.txt --source a.txt
    crafted: true
"""
...
examples:
  - name: Show metrics settings for a storage account. (autogenerated)
    text: |
        az storage metrics show --account-key 00000000 --account-name MyAccount --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Generates a shared access signature for the share (autogenerated)
    text: |
        az storage share generate-sas --account-key 00000000 --account-name MyStorageAccount --expiry 2019-02-01T12:20Z --https-only --name MyShare --permissions dlrw
    crafted: true
"""
