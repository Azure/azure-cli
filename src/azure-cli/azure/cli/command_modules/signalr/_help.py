...
examples:
  ...
  - name: Add a list of allowed origins to a SignalR Service (autogenerated)
    text: |
        az signalr cors add --allowed-origins "http://example1.com" "https://example2.com" --name MySignalR --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Remove allowed origins from a SignalR Service (autogenerated)
    text: |
        az signalr cors remove --allowed-origins "http://example1.com" "https://example2.com" --name MySignalR --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Restart a SignalR Service instance. (autogenerated)
    text: az signalr restart --name MySignalR --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update an existing SignalR Service. (autogenerated)
    text: |
        az signalr update --allowed-origins "http://example1.com" "https://example2.com" --name MySignalR --resource-group MyResourceGroup
    crafted: true
  - name: Update an existing SignalR Service. (autogenerated)
    text: az signalr update --name MySignalR --resource-group MyResourceGroup --service-mode Default
    crafted: true
"""
