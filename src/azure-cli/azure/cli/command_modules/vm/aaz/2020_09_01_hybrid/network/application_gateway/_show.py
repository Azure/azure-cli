...
class Show(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.application_gateway_name = AAZStrArg(
            options=["-n", "--name", "--application-gateway-name"],
            help="The name of the application gateway.",
            required=True,
            id_part="name",
        )
        ...
        def url_parameters(self):
            parameters = {
                **self.serialize_url_param(
                    "applicationGatewayName", self.ctx.args.application_gateway_name,
                    required=True,
                ),
                **self.serialize_url_param(
