...
class AutoscaleProfile(Model):
    ...
    :type capacity: :class:`ScaleCapacity
     <azure.insights.models.ScaleCapacity>`
    :param rules: the collection of rules that provide the triggers and
     ...
     specified.
    :type rules: list of :class:`ScaleRule <azure.insights.models.ScaleRule>`
    :param fixed_date: the specific date-time for the profile. This element
     is not used if the Recurrence element is used.
    :type fixed_date: :class:`TimeWindow <azure.insights.models.TimeWindow>`
    ...
    :type recurrence: :class:`Recurrence <azure.insights.models.Recurrence>`
    """ 
