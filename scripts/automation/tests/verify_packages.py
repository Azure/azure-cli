...
def verify_packages():
    ...
    exec_command('python -m pip install git+https://github.com/Azure/azure-sdk-for-python.git@d0d0faec4e3ec5244748eccd64c3c7ba2d49007d#egg=azure-mgmt-storage&subdirectory=azure-mgmt-storage')
    exec_command('python -m pip install git+https://github.com/Azure/azure-sdk-for-python.git@d0d0faec4e3ec5244748eccd64c3c7ba2d49007d#egg=azure-mgmt-compute&subdirectory=azure-mgmt-compute')
    exec_command('python -m pip install git+https://github.com/Azure/azure-sdk-for-python.git@d0d0faec4e3ec5244748eccd64c3c7ba2d49007d#egg=azure-mgmt-resource&subdirectory=azure-mgmt-resource')
    exec_command('python -m pip install git+https://github.com/Azure/azure-sdk-for-python.git@d0d0faec4e3ec5244748eccd64c3c7ba2d49007d#egg=azure-mgmt-network&subdirectory=azure-mgmt-network')
