...
@register_command(
    "eventhubs namespace private-link-resource show",
)
class Show(AAZCommand):
    """List lists of resources that supports Privatelinks.

    :example: NameSpacePrivateLinkResourcesGet
        az eventhubs namespace private-link-resource show --resource-group ArunMonocle --namespace-name sdk-Namespace-2924
    """

    _aaz_info = {
        "version": "2026-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.eventhub/namespaces/{}/privatelinkresources", "2026-07-01-preview"],
        ]
    }
