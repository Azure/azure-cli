...
from azure.cli.command_modules.monitor._legacy._help import helps  # pylint: disable=unused-import
...
class MonitorArgumentContext(AzArgumentContext):
    ...
    def resource_parameter(self, dest, arg_group=None, required=True, skip_validator=False, alias='resource',
        ...
        from azure.cli.command_modules.monitor._legacy.validators import get_target_resource_validator
...
class MonitorCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        from azure.cli.command_modules.monitor._legacy.commands import load_command_table
