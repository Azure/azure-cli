...
@register_command(
    "security security-connectors devops gitlabgroups list-subgroups",
    is_preview=True,
)
class ListSubgroups(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.GitLabSubgroupsList(ctx=self.ctx)()
    ...
    class GitLabSubgroupsList(AAZHttpOperation):
...
class _ListSubgroupsHelper:
    """Helper class for ListSubgroups"""


__all__ = ["ListSubgroups"]
