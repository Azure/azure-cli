...
class NatGatewayScenarioTests(ScenarioTest):
    ...
    def test_natgateway(self, resource_group, resource_group_location):
        ...
        self.cmd('az network public-ip create -g {rg} -n {ip_addr} --location {location} --zone 2 --sku Standard ')

        # create public ip prefix
        self.cmd('az network public-ip prefix create --length 28 --location {location} --name {ip_prefix} --resource-group {rg} --zone 2')
