...
examples:
  - name: Create a data warehouse. (autogenerated)
    text: |
        az sql dw create --collation Latin1_General_100_CS_AS_SC --name MyDataWarehouse --resource-group MyResourceGroup --server myserver --service-objective S0
    crafted: true
"""
...
examples:
  - name: Set the primary of the instance failover group by failing over all databases from the current primary managed instance. (autogenerated)
    text: |
        az sql instance-failover-group set-primary --location westus2 --name MyInstanceFailoverGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Deletes an existing managed instance Active Directory Administrator. (autogenerated)
    text: |
        az sql mi ad-admin delete --managed-instance myinstance --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Returns a list of managed instance Active Directory Administrators. (autogenerated)
    text: |
        az sql mi ad-admin list --managed-instance myinstance --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a server. (autogenerated)
    text: |
        az sql server update --assign_identity --name MyAzureSQLServer --resource-group MyResourceGroup
    crafted: true
"""
