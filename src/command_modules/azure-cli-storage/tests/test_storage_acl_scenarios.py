...
class StorageAccessControlListTets(StorageScenarioMixin, ScenarioTest):
    ...
    def _verify_access_control_list(self, account_info, service_type, container_name):
        ...
        self.storage_cmd('storage {} policy create {} -n test1 --permission l', account_info,
                         service_type, container_id_parameter)
        self.storage_cmd('storage {} policy create {} -n test2 --start 2016-01-01T00:00Z',
                         account_info, service_type, container_id_parameter)
        self.storage_cmd('storage {} policy create {} -n test3 --expiry 2018-01-01T00:00Z',
                         account_info, service_type, container_id_parameter)
        self.storage_cmd('storage {} policy create {} -n test4 --permission rwdl '
                         '--start 2016-01-01T00:00Z --expiry 2016-05-01T00:00Z', account_info,
                         service_type, container_id_parameter)
        ...
        self.storage_cmd('storage {} policy show {} -n test1', account_info, service_type,
            ...
            .assert_with_checks(JMESPathCheck('permission', 'l'))
        ...
        self.storage_cmd('storage {} policy update {} -n test1 --permission r', account_info,
                         service_type, container_id_parameter)
        self.storage_cmd('storage {} policy show {} -n test1', account_info, service_type,
                         container_id_parameter) \
            .assert_with_checks(JMESPathCheck('permission', 'r'))
        self.storage_cmd('storage {} policy delete {} -n test1', account_info, service_type,
                         container_id_parameter)
