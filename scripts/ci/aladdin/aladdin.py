...
aladdin_helps['acr scope-map show'] = """
type: command
short-summary: Show details and attributes of a scope map for an Azure Container Registry.
examples:
  - name: Show details and attributes of a scope map for an Azure Container Registry. (autogenerated)
    text: az acr scope-map show --name MyScopeMap --registry MyRegistry --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Scale the node pool in a managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool scale --cluster-name MyCluster --name MyNodePool --no-wait --node-count 7 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an App Service Plan. (autogenerated)
    text: az functionapp plan delete --name MyAppServicePlan --resource-group MyResourceGroup --yes
    crafted: true
"""
...
examples:
  - name: Run a specific triggered webjob hosted on a web app (autogenerated)
    text: az webapp webjob triggered run --name MyWebApp --resource-group MyResourceGroup --slot staging --subscription MySubscription --webjob-name MyWebjob
    crafted: true
"""
...
examples:
  - name: Update an inbound NAT address pool. (autogenerated)
    ...
    crafted: true
  - name: Update an inbound NAT address pool. (autogenerated)
    text: az network lb inbound-nat-pool update --enable-tcp-reset true --lb-name MyLb --name MyNatPool --protocol Udp --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a packet capture session. (autogenerated)
    text: az network watcher packet-capture delete --location westcentralus --name packetCaptureName --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a read replica for a server. (autogenerated)
    text: |
        az mysql server replica create --location westus2 --name testreplsvr --resource-group testgroup --source-server "/subscriptions/${SubID}/resourceGroups/${ResourceGroup}/providers/Microsoft.DBforMySQL/servers/testsvr2" --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a managed instance. (autogenerated)
    ...
    crafted: true
  - name: Update a managed instance. (autogenerated)
    text: az sql mi update --capacity vcorecapacity --name myinstance --no-wait --resource-group mygroup --set tags.tagName=tagValue
    crafted: true
"""
...
aladdin_helps['ppg update'] = """
type: command
short-summary: Update a proximity placement group
examples:
  - name: Update a proximity placement group. (autogenerated)
    text: az ppg update --name MyProximityPlacementGroup --resource-group MyResourceGroup
    crafted: true
"""
