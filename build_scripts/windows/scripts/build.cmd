...
if "%TARGET%"=="msi" (
    ...
    copy %REPO_ROOT%\build_scripts\windows\scripts\azps.ps1 %BUILDING_DIR%\wbin\az.ps1
    ...
    copy %REPO_ROOT%\build_scripts\windows\scripts\azps.ps1 %BUILDING_DIR%\bin\az.ps1
)
if %errorlevel% neq 0 goto ERROR
