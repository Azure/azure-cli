...
@register_command(
    "eventhubs georecovery-alias authorization-rule show",
)
class Show(AAZCommand):
    ...
    _aaz_info = {
        "version": "2026-01-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.eventhub/namespaces/{}/disasterrecoveryconfigs/{}/authorizationrules/{}", "2026-01-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DisasterRecoveryConfigsGetAuthorizationRule(ctx=self.ctx)()
    ...
    class DisasterRecoveryConfigsGetAuthorizationRule(AAZHttpOperation):
