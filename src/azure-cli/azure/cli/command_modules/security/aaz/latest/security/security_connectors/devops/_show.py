...
@register_command(
    "security security-connectors devops show",
    is_preview=True,
)
class Show(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.DevOpsConfigurationsGet(ctx=self.ctx)()
    ...
    class DevOpsConfigurationsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            authorization = cls._schema_on_200.properties.authorization
            authorization.code = AAZStrType(
                flags={"secret": True},
            )

            top_level_inventory_list = cls._schema_on_200.properties.top_level_inventory_list
