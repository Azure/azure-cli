...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.DiskEncryptionSetsList(ctx=self.ctx)()
        if condition_1:
            self.DiskEncryptionSetsListByResourceGroup(ctx=self.ctx)()
    ...
    class DiskEncryptionSetsList(AAZHttpOperation):
    ...
    class DiskEncryptionSetsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
