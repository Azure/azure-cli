...
# VM Container (ACS)
cli_command(__name__, 'vm container create', 'azure.cli.command_modules.vm.mgmt_acs.lib.operations.acs_operations#AcsOperations.create_or_update', cf_acs_create,
...
######
cli_command(__name__, 'vm container show', 'azure.mgmt.compute.operations.container_service_operations#ContainerServiceOperations.get', cf_acs)
cli_command(__name__, 'vm container list', 'azure.mgmt.compute.operations.container_service_operations#ContainerServiceOperations.list', cf_acs)
cli_command(__name__, 'vm container delete', 'azure.mgmt.compute.operations.container_service_operations#ContainerServiceOperations.delete', cf_acs)
