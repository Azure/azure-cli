...
_LBOutboundRule = _import_aaz_by_profile("network.lb.outbound_rule")


class LBOutboundRuleCreate(_LBOutboundRule.Create):
...
class LBOutboundRuleUpdate(_LBOutboundRule.Update):
