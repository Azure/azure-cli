...
def _deploy_arm_template_core(cli_ctx, resource_group_name,
                              ...
                              no_wait=False, aux_tenants=None):
    ...
    smc = get_mgmt_service_client(cli_ctx, ResourceType.MGMT_RESOURCE_RESOURCES, aux_tenants=aux_tenants)
    if validate_only:
...
def deploy_arm_template(cmd, resource_group_name,
                        ...
                        handle_extended_json_format=False, aux_tenants=None):
