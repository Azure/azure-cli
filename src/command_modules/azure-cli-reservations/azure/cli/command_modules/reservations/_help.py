...
-   name: Get all reservations.
    text: az reservations reservation list --query [0] --reservation-order-id {reservation-order-id}
    crafted: 'True'
"""
...
-   name: --quantity-1 -1
    type: int
    short-summary: Quantity of the first reservation that will be created from split
        operation
-   name: --quantity-2 -2
    type: int
    short-summary: Quantity of the second reservation that will be created from split
        operation
"""
...
-   name: --applied-scopes -s
    type: string
    short-summary: Subscription that the benefit will be applied. Do not specify if
