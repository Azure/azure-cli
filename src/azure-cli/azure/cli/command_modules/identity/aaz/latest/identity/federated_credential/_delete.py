...
class Delete(AAZCommand):
    ...
    :example: Delete a federated identity credential under a specific user assigned identity.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FederatedIdentityCredentialsDelete(ctx=self.ctx)()
    ...
    class FederatedIdentityCredentialsDelete(AAZHttpOperation):
