...
examples:
  ...
  - name: Delete a storage account. (autogenerated)
    text: az storage account delete --name MyStorageAccount
    crafted: true
"""
...
examples:
  ...
  - name: Regenerates one of the access keys for the specified storage account. (autogenerated)
    text: az storage account keys renew --account-name MyAccount --key primary --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Download blobs from a blob container recursively. (autogenerated)
    text: az storage blob download-batch --destination . --pattern *.py --source MyContainer
    crafted: true
"""
...
examples:
  ...
  - name: Copies an incremental copy of a blob asynchronously. (autogenerated)
    ...
    crafted: true
  - name: Copies an incremental copy of a blob asynchronously. (autogenerated) (autogenerated)
    text: az storage blob incremental-copy start --account-key 00000000 --account-name MyAccount --destination-blob MyDestinationBlob --destination-container MyDestinationContainer --source-account-key MySourceKey --source-account-name MySourceAccount --source-blob MyBlob --source-container MySourceContainer --source-snapshot MySnapshot
    crafted: true
"""
...
examples:
  - name: Marks the specified container for deletion. (autogenerated)
    ...
    crafted: true
  - name: Marks the specified container for deletion. (autogenerated)
    text: az storage container delete --name MyContainer
    crafted: true
"""
...
examples:
  ...
  - name: Generate a SAS token for a storage container (autogenerated)
    text: az storage container generate-sas --connection-string $connectionString --expiry 2020-01-01 --https-only --name MyContainer --permissions dlrw
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage directory. (autogenerated)
    ...
    crafted: true
  - name: Check for the existence of a storage directory. (autogenerated) (autogenerated)
    text: az storage directory exists --account-key 00000000 --account-name MyAccount --name MyDirectory --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Show metrics settings for a storage account. (autogenerated)
    ...
    crafted: true
  - name: Show metrics settings for a storage account. (autogenerated)
    text: az storage metrics show --account-name MyAccount
    crafted: true
"""
