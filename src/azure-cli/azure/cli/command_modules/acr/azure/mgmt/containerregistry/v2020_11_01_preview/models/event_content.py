...
class EventContent(Model):
    ...
    :type target: ~containerregistry.models.Target
    :param request: The request that generated the event.
    :type request: ~containerregistry.models.Request
    ...
    :type actor: ~containerregistry.models.Actor
    ...
    :type source: ~containerregistry.models.Source
    """
