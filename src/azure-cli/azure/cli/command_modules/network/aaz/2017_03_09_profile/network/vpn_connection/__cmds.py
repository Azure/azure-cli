...
@link_helper(
    ...
    ("_build_schema_bgp_settings_read", _Helper),
...
class _UpdateHelper:
    ...
    def _build_schema_virtual_network_gateway_update(cls, _builder):
        ...
        if properties is not None:
            properties.set_prop("privateIPAddress", AAZStrType, "@VirtualNetworkGateway_update.ip_configurations.[].private_ip_address")
            ...
            properties.set_prop("provisioningState", AAZStrType, "@VirtualNetworkGateway_update.ip_configurations.[].provisioning_state")
        ...
        if properties is not None:
            properties.set_prop("provisioningState", AAZStrType, "@VirtualNetworkGateway_update.vpn_client_configuration.vpn_client_revoked_certificates.[].provisioning_state")
        ...
        if properties is not None:
            properties.set_prop("provisioningState", AAZStrType, "@VirtualNetworkGateway_update.vpn_client_configuration.vpn_client_root_certificates.[].provisioning_state")
            properties.set_prop("publicCertData", AAZStrType, "@VirtualNetworkGateway_update.vpn_client_configuration.vpn_client_root_certificates.[].public_cert_data")
...
__all__ = ["Delete","List","Show","Update","Wait","__CMDGroup"]
