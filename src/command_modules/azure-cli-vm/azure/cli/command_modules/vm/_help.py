...
helps['vmss update'] = """
type: command
short-summary: Update a VMSS or VM within a VMSS.
examples:
  ...
  - name: Update a VM instance's protection policies.
    text: az vmss update --name MyScaleSet --resource-group MyResourceGroup --instance-id 4 \
            --protection-policy protect_from_scale_in=False protect_from_scale_set_actions=True
            
  - name: Update a VM instance's tags.
    text: az vmss update --name MyScaleSet --resource-group MyResourceGroup --instance-id 4 \
            --protection-policy protect_from_scale_in=False protect_from_scale_set_actions=True
"""
