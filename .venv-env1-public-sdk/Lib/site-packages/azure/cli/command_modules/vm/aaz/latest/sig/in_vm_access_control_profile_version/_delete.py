...
@register_command(
    "sig in-vm-access-control-profile-version delete",
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a gallery in VM access control profile version.

    :example: Delete a gallery in VM access control profile version.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.GalleryInVMAccessControlProfileVersionsDelete(ctx=self.ctx)()
    ...
    class GalleryInVMAccessControlProfileVersionsDelete(AAZHttpOperation):
