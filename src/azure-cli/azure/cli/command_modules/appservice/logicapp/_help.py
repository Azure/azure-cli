...
examples:
  - name: Create a basic logic app.
    text: >
        az logicapp create -g {myRG} --subscription {mySubscription} -p MyPlan -n {myAppName} -s {myStorageAccount}
"""
...
examples:
  - name: Delete a logic app.
    text: az logicapp delete --name {myAppName} --resource-group {myRG} --subscription {mySubscription}
"""
...
examples:
  - name: Get the details of a logic app.
    text: az logicapp show --name {myAppName} --resource-group {myRG} --subscription {mySubscription}
"""
...
examples:
  - name: Restart a logic app.
    text: az logicapp restart --name {myAppName} --resource-group {myRG}
    crafted: true
"""
...
examples:
  - name: Start a logic app
    text: az logicapp start --name {myAppName} --resource-group {myRG}
    crafted: true
"""
...
examples:
  - name: Stop a logic app.
    text: az logicapp stop --name {myAppName} --resource-group {myRG}
    crafted: true
"""
...
examples:
  - name: Delete a logic app's settings. (autogenerated)
    text: az logicapp config appsettings delete --name {myAppName} --resource-group {myRG} --subscription {mySubscription} --setting-names {setting-names}
    crafted: true
"""
...
examples:
  - name: Show settings for a logic app. (autogenerated)
    text: az logicapp config appsettings list --name {myAppName} --resource-group {myRG} --subscription {mySubscription}
    crafted: true
"""
...
examples:
  - name: Update a logic app's settings.
    text: |
        az logicapp config appsettings set --name {myAppName} --resource-group {myRG} --subscription {mySubscription} --settings "AzureWebJobsStorage=$storageConnectionString"
"""
...
examples:
  - name: Update a logic app. (autogenerated)
    text: az logicapp update --name {myAppName} --resource-group {myRG}
    crafted: true
"""
