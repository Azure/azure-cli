...
def _resource_managedapps_client_factory(cli_ctx, **_):
    ...
    return get_mgmt_service_client(cli_ctx, ManagedApplicationClient)
...
def cf_resource_managedapplications(cli_ctx, _):
    return _resource_managedapps_client_factory(cli_ctx).appliances


def cf_resource_managedappdefinitions(cli_ctx, _):
    return _resource_managedapps_client_factory(cli_ctx).appliance_definitions
