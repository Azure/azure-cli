...
class Delete(AAZCommand):
    ...
    :example: ApplicationGroupDelete
        az eventhubs namespace application-group delete --resource-group contosotest --namespace-name contoso-ua-test-eh-system-1 --application-group-name appGroup1
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ApplicationGroupDelete(ctx=self.ctx)()
    ...
    class ApplicationGroupDelete(AAZHttpOperation):
