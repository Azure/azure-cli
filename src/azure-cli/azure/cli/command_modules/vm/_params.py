...
def load_arguments(self, _):
    ...
    with self.argument_context('vmss create', operation_group='virtual_machine_scale_sets') as c:
        ...
        c.argument('skuprofile_vmsizes', nargs='+', options_list=['--skuprofile-vmsizes'], min_api='2024-07-01', help='A list of VM sizes in the scale set. Only works with Flexible orchestration_mode. See https://azure.microsoft.com/pricing/details/virtual-machines/ for size info.')
        c.argument('skuprofile_allostrat', options_list=['--skuprofile-allocation-strategy', '--sku-allocat-strat'], arg_type=get_enum_type(['LowestPrice', 'CapacityOptimized']), min_api='2024-07-01', help='Allocation strategy for skuprofile_vmsizes: LowestPrice or CapacityOptimized.')
