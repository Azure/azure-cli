...
class Create(AAZCommand):
    ...
    :example: Create a frontend IP address.
    ...
    :example: Create a frontend IP address with subnet.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.public_ip_address = AAZStrArg(
...
@register_command(
    "network application-gateway frontend-ip delete",
)
...
@register_command(
    "network application-gateway frontend-ip list",
)
...
@register_command(
    "network application-gateway frontend-ip show",
)
...
@register_command(
    "network application-gateway frontend-ip wait",
)
