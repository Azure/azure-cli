...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_sub_resource_create(subnet.service_gateway)
    ...
    class VirtualNetworkAppliancesCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                _CreateHelper._build_schema_sub_resource_create(properties.set_prop("serviceGateway", AAZObjectType, ".service_gateway"))
        ...
        def _build_schema_on_200_201(cls):
            ...
            _CreateHelper._build_schema_subnet_read(properties.subnet)
