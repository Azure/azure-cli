...
from .custom import _get_rg_location, _validate_ssh_key, _get_default_dns_prefix, _set_vm_set_type, set_load_balancer_sku, get_subscription_id
...
class AKSCreateContext:
    ...
    def __init__(self, cmd, raw_parameters):
        self.cmd = cmd
    ...
    def get_resource_group_name(self, enable_validation=False, force_update=False, **kwargs):
    ...
    def get_name(self, enable_validation=False, force_update=False, **kwargs):
        # Note: This parameter will not be decorated into the `mc` object.
        # read the original value passed by the command
    ...
    def get_ssh_key_value(self, enable_validation=False, force_update=False, **kwargs):
        # read the original value passed by the command
    ...
    def get_dns_name_prefix(self, enable_validation=False, force_update=False, **kwargs):
    ...
    def get_location(self, enable_validation=False, force_update=False, **kwargs):
    ...
    def get_kubernetes_version(self, enable_validation=False, force_update=False, **kwargs):
        # Note: This parameter will not be decorated into the `mc` object.
        # read the original value passed by the command
    ...
    def get_no_ssh_key(self, enable_validation=False, force_update=False, **kwargs):
        # read the original value passed by the command
    ...
    def get_vm_set_type(self, enable_validation=False, force_update=False, **kwargs):
        ...
        if self.mc and self.mc.agent_pool_profiles:
            agent_pool_profile = safe_list_get(self.mc.agent_pool_profiles, 0, None)
    ...
    def get_load_balancer_sku(self, enable_validation=False, force_update=False, **kwargs):
    ...
    def get_api_server_authorized_ip_ranges(self, enable_validation=False, force_update=False, **kwargs):
        ...
        if mc_property is not None:
            ...
            api_server_authorized_ip_ranges = intermediate
        else:
    ...
    def get_fqdn_subdomain(self, enable_validation=False, force_update=False, **kwargs):
        # read the original value passed by the command
