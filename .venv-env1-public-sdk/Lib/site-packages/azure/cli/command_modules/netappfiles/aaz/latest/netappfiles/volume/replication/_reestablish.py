...
@register_command(
    "netappfiles volume replication reestablish",
)
class Reestablish(AAZCommand):
    """Re-establish a previously deleted replication between 2 volumes that have a common ad-hoc or policy-based snapshots

    :example: Re-establish a previously deleted replication between 2 volumes that have a common ad-hoc or policy-based snapshots
    ...
    _aaz_info = {
        "version": "2025-12-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/reestablishreplication", "2025-12-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.source_volume_id = AAZStrArg(
            options=["--source-volume-id"],
            arg_group="Body",
            help="Resource id of the source volume for the replication",
        )
        return cls._args_schema

    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesReestablishReplication(ctx=self.ctx)()
    ...
    class VolumesReestablishReplication(AAZHttpOperation):
