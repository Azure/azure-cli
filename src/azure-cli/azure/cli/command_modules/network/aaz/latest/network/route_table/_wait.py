...
class Wait(AAZWaitCommand):
    ...
    class RouteTablesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_common_route_table_read(cls._schema_on_200)
...
class _WaitHelper:
    ...
    _schema_common_route_table_read = None

    @classmethod
    def _build_schema_common_route_table_read(cls, _schema):
        if cls._schema_common_route_table_read is not None:
            _schema.etag = cls._schema_common_route_table_read.etag
            _schema.id = cls._schema_common_route_table_read.id
            _schema.location = cls._schema_common_route_table_read.location
            _schema.name = cls._schema_common_route_table_read.name
            _schema.properties = cls._schema_common_route_table_read.properties
            _schema.tags = cls._schema_common_route_table_read.tags
            _schema.type = cls._schema_common_route_table_read.type
            return

        cls._schema_common_route_table_read = _schema_common_route_table_read = AAZObjectType()

        common_route_table_read = _schema_common_route_table_read
        common_route_table_read.etag = AAZStrType(
            flags={"read_only": True},
        )
        common_route_table_read.id = AAZStrType()
        common_route_table_read.location = AAZStrType()
        common_route_table_read.name = AAZStrType(
            flags={"read_only": True},
        )
        common_route_table_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        common_route_table_read.tags = AAZDictType()
        common_route_table_read.type = AAZStrType(
            flags={"read_only": True},
        )

        properties = _schema_common_route_table_read.properties
        ...
        routes = _schema_common_route_table_read.properties.routes
        routes.Element = AAZObjectType()

        _element = _schema_common_route_table_read.properties.routes.Element
        _element.etag = AAZStrType(
            flags={"read_only": True},
        )
        _element.id = AAZStrType()
        ...
        properties = _schema_common_route_table_read.properties.routes.Element.properties
        ...
        next_hop = _schema_common_route_table_read.properties.routes.Element.properties.next_hop
        next_hop.next_hop_ip_addresses = AAZListType(
            serialized_name="nextHopIpAddresses",
            flags={"required": True},
        )

        next_hop_ip_addresses = _schema_common_route_table_read.properties.routes.Element.properties.next_hop.next_hop_ip_addresses
        next_hop_ip_addresses.Element = AAZStrType()

        subnets = _schema_common_route_table_read.properties.subnets
        subnets.Element = AAZObjectType()
        cls._build_schema_common_subnet_read(subnets.Element)

        tags = _schema_common_route_table_read.tags
        tags.Element = AAZStrType()
    ...
    def _build_schema_common_subnet_read(cls, _schema):
        ...
        cls._build_schema_common_route_table_read(properties.route_table)
