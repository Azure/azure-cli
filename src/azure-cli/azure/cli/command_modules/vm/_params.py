...
def load_arguments(self, _):
    ...
    for scope in ['vm create', 'vm update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('security_type', arg_type=get_enum_type(["TrustedLaunch", "Standard", "ConfidentialVM"], default=None), help='Specify the security type of the virtual machine.')
    ...
    for scope in ['vmss create', 'vmss update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('security_type', arg_type=get_enum_type(["TrustedLaunch", "Standard", "ConfidentialVM"], default=None), help='Specify the security type of the virtual machine scale set.')
