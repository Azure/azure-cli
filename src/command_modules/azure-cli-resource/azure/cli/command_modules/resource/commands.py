...
from azure.cli.command_modules.resource._validators import (
    process_deployment_create_namespace,
    process_deployment_group_create_namespace)
...
def load_command_table(self, _):
    ...
    with self.command_group('group deployment', resource_deployment_sdk) as g:
        g.custom_command('create', 'deploy_arm_template', supports_no_wait=True, validator=process_deployment_group_create_namespace, exception_handler=handle_template_based_exception)
