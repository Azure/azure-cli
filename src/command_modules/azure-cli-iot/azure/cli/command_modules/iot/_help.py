...
examples:
  - name: Cancel a job in an IoT hub. (autogenerated)
    text: az iot hub job cancel --hub-name MyHub --job-id {job-id}
    crafted: true
"""
...
examples:
  ...
  - name: Update a route in IoT Hub. (autogenerated)
    text: az iot hub route update --condition true --enabled true --endpoint E2 --hub-name MyIotHub --name R1 --type invalid
    crafted: true
"""
