...
def load_arguments(self, _):
    ...
    with self.argument_context('backup vault create') as c:
        ...
        c.argument('cost_management_granularity', options_list=['--cost-granularity-level'], arg_type=get_enum_type(allowed_granularitylevel_options), help='Use this parameter to configure cost management settings for the vault. By default, the property is "VaultLevel" for the vault.')
