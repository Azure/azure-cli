...
@register_command(
    "monitor private-link-scope private-endpoint-connection show",
    is_preview=True,
)
class Show(AAZCommand):
    """Show a private endpoint connection of a private link scope resource.

    :example: Show a private endpoint connection of a private link scope resource.
        az monitor private-link-scope private-endpoint-connection show -n MyName -g MyResourceGroup --scope-name MyScope
    """
