...
class Show(AAZCommand):
    ...
    class ApisGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            contacts = cls._schema_on_200.properties.contacts
            contacts.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.contacts.Element
            _element.email = AAZStrType()
            _element.name = AAZStrType()
            _element.url = AAZStrType()

            external_documentation = cls._schema_on_200.properties.external_documentation
            external_documentation.Element = AAZObjectType()

            _element = cls._schema_on_200.properties.external_documentation.Element
            ...
            license = cls._schema_on_200.properties.license
            license.identifier = AAZStrType()
            license.name = AAZStrType()
            license.url = AAZStrType()

            terms_of_service = cls._schema_on_200.properties.terms_of_service
