...
class GlobalScheduleOperations(object):
    """GlobalScheduleOperations operations.
    ...
    def list_by_subscription(
            self, expand=None, filter=None, top=None, order_by=None, custom_headers=None, raw=False, **operation_config):
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = '/subscriptions/{subscriptionId}/providers/Microsoft.DevTestLab/schedules'
    ...
    def list_by_resource_group(
            self, resource_group_name, expand=None, filter=None, top=None, order_by=None, custom_headers=None, raw=False, **operation_config):
