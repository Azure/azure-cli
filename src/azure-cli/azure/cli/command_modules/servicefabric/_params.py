...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('sf managed-cluster network-security-rule add', validator=validate_add_network_security_rule) as c:
        ...
        c.argument('destination_port_ranges', nargs='+', help='A single or space separated list of destination port ranges')
        c.argument('source_address_prefixes', nargs='+', help='A single or space separated list of source address prefixes')
        c.argument('destination_address_prefixes', nargs='+', help='A single or space separated list of destination address prefixes')
