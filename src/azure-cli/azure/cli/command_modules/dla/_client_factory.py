...
def cf_dla_catalog(cli_ctx, _):
    from azure.cli.core.commands.client_factory import get_mgmt_service_client
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.catalog import DataLakeAnalyticsCatalogManagementClient  # pylint: disable=line-too-long
...
def cf_dla_job(cli_ctx, _):
    from azure.cli.core.commands.client_factory import get_mgmt_service_client
    from azure.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics.job import DataLakeAnalyticsJobManagementClient  # pylint: disable=line-too-long
    return get_mgmt_service_client(
        cli_ctx,
