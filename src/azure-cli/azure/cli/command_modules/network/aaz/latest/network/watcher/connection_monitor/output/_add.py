...
#         "version": "2022-01-01",
#         "resources": [
#            # ["mgmt-plane",  "/subscriptions/9cece3e3-0f7d-47ca-af0e-9772773f90b7/resourcegroups/networkwatcherrg/providers/microsoft.network/networkwatchers/NetworkWatcher_eastus2/connectionMonitors/AppGwTopoTest2", "2022-01-01", "properties.outputs[]"],
#             ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/networkwatchers/{}/connectionmonitors/{}", "2022-01-01", "properties.outputs[]"],
#          ]
#         # "resources": [
#         #     #/resourceGroups/networkwatcherrg/providers/Microsoft.Network/networkWatchers/NetworkWatcher_eastus2/connectionMonitors/{connectionMonitorName}"
#         #      ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/networkwatchers/{}/connectionmonitors/{}/outputs/{}", "2022-01-01"],
#         #     ["mgmt-plane", "/subscriptions/9cece3e3-0f7d-47ca-af0e-9772773f90b7/resourcegroups/networkwatcherrg/providers/microsoft.network/networkwatchers/NetworkWatcher_eastus2/connectionMonitors/AppGwTopoTest2"]
#         # ]
#     }
...
#         self.InstanceCreateByJson(ctx=self.ctx)()
#         self.post_instance_create(self.ctx.selectors.subresource.required())
#         yield self.CreateConnectionMonitorOutput(ctx=self.ctx)()
#         self.post_operations()
...
#             return
    ...
    # class CreateConnectionMonitorOutput(AAZHttpOperation):
    #     CLIENT_TYPE = "MgmtClient"
    ...
    #         return parameters
        ...
        # @property
        # def content(self):
        #     # Here you can serialize the content needed for creating a connection monitor output destination
        #     # Example:
        #     _content_value, _builder = self.new_content_builder(
        #         self.ctx.args.,
        #         value=self.ctx.vars.instance,
        #     )
            # _content_value = {
            #     "type": self.ctx.args.output_type,
            #     "workspaceSettings": {
            #         "workspaceResourceId": self.ctx.args.workspace_id
            #     }
            #}
           # return self.serialize_content(_content_value)
    ...
    #         # For example, update the context with the returned data
    #         self.ctx.set_var(
    #             "instance",
    #             data,
    #             schema_builder=self._build_schema_on_200_201
    ...
    #         # Define the schema for deserializing the response if needed
    #         # Example:
    #         cls._schema_on_200_201 = AAZObjectType()
    #         #_AddHelper._build_schema_connection_monitor_result_read(cls._schema_on_200_201)
    #         cls._schema_on_200_201.set_prop("workspace_id", AAZStrType)
    #         # Define other properties as needed
    #         return cls._schema_on_200_201
    #         #schema.set_prop("id", AAZStrType)
    #         #schema.set_prop("type", AAZStrType)
    #         # Define other properties as needed
    #         #return schema
...
#     def _execute_operations(self):
#         self.pre_operations()
#         self.CreateConnectionMonitorOutput(ctx=self.ctx)()
#         self.pre_instance_create()
#         self.InstanceCreateByJson(ctx=self.ctx)()
#         self.post_instance_create(self.ctx.selectors.subresource.required())
#         self.post_operations()
...
#         def _get(self):
#             result = self.ctx.vars.instance
#             result = result.get("properties", {}).get("outputs", [])
#             result = result.properties.outputs
#             filters = enumerate(result)
#             filters = filter(
#                 lambda e: e[0] == self.ctx.args.output_index,
...
#         def url(self):
#             return self.client.format_url(
#                 "/subscriptions/9cece3e3-0f7d-47ca-af0e-9772773f90b7/resourceGroups/networkwatcherrg/providers/Microsoft.Network/networkWatchers/NetworkWatcher_eastus2/connectionMonitors/{connectionMonitorName}",
#                 **self.url_parameters
#             )
