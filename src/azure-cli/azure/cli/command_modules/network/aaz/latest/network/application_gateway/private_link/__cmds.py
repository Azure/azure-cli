...
@register_command(
    "network application-gateway private-link list",
    is_preview=True,
)
class List(AAZCommand):
    """List all the private links.

    :example: List all the private links.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.privateLinkConfigurations

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.privateLinkConfigurations = value
            return
...
@register_command(
    "network application-gateway private-link remove",
    is_preview=True,
