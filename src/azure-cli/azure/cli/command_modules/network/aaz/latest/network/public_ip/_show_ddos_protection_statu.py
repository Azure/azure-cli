...
class ShowDdosProtectionStatu(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.PublicIPAddressesDdosProtectionStatus(ctx=self.ctx)()
    ...
    class PublicIPAddressesDdosProtectionStatus(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _schema_on_200.ddos_protection_plan_id = AAZStrType(
                serialized_name="ddosProtectionPlanId",
            )
            _schema_on_200.is_workload_protected = AAZStrType(
                serialized_name="isWorkloadProtected",
            )
            _schema_on_200.public_ip_address = AAZStrType(
                serialized_name="publicIpAddress",
            )
            _schema_on_200.public_ip_address_id = AAZStrType(
