...
examples:
  ...
  - name: Get the details of a replicated region. (autogenerated)
    text: az acr replication show --name MyReplication --registry MyRegistry
    crafted: true
"""
...
examples:
  ...
  - name: Updates a replication. (autogenerated)
    ...
    crafted: true
  - name: Updates a replication. (autogenerated)
    text: az acr replication update --name MyReplication --registry MyRegistry
    crafted: true
"""
...
examples:
  ...
  - name: List all the custom registry credentials for task. (autogenerated)
    text: az acr task credential list --name taskname --registry registryname
    crafted: true
"""
...
examples:
  ...
  - name: Update the registry login credential for a task. (autogenerated)
    text: az acr task credential update --login-server myregistry.docker.io --name taskname --password 'mysecret' --registry registryname --username 'myusername2'
    crafted: true
"""
...
examples:
  ...
  - name: Display the managed service identities for task. (autogenerated)
    text: az acr task identity show --name MyTask --registry MyRegistry
    crafted: true
"""
