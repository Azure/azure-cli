...
@register_command(
    "cdn edge-action execution-filter list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EdgeActionExecutionFiltersListByEdgeAction(ctx=self.ctx)()
    ...
    class EdgeActionExecutionFiltersListByEdgeAction(AAZHttpOperation):
