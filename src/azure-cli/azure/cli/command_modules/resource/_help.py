...
examples:
  ...
  - name: Remove an existing subscription from a management group. (autogenerated)
    text: az account management-group subscription remove --name GroupName --subscription Subscription
    crafted: true
"""
...
examples:
  ...
  - name: Deletes a deployment from the deployment history. (autogenerated)
    text: az deployment delete --name MyDeployment
    crafted: true
"""
...
examples:
  ...
  - name: Gets a deployment. (autogenerated)
    text: az deployment show --name MyDeployment
    crafted: true
"""
...
examples:
  - name: Show a policy assignment's managed identity. (autogenerated)
    text: az policy assignment identity show --name MyPolicyAssignment --scope '/providers/Microsoft.Management/managementGroups/MyManagementGroup'
    crafted: true
"""
...
examples:
  - name: Delete a policy set definition. (autogenerated)
    ...
    crafted: true
  - name: Delete a policy set definition. (autogenerated) (autogenerated)
    text: az policy set-definition delete --name MyPolicySetDefinition
    crafted: true
"""
...
examples:
  ...
  - name: Delete a resource level lock (autogenerated)
    text: az resource lock delete --name lockName --resource-group MyResourceGroup --resource-name /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/{VMName} --resource-type Microsoft.Network/virtualNetworks
    crafted: true
"""
