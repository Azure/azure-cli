...
examples:
  ...
  - name: Create a simple Ubuntu Linux VM with a public IP address, DNS entry, two data disks (10GiB and 20GiB), and then generate ssh key pairs.
    text: |
...
parameters:
  ...
  - name: --ssh-key-values
    short-summary: Space-separated list of SSH public keys or public key file paths.
examples:
  - name: Create a Windows VM scale set with 5 instances, a load balancer, a public IP address, and a 2GiB data disk.
    text: >
