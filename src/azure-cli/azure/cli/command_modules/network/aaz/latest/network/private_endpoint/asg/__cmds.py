...
class Add(AAZCommand):
    ...
    :example: Add a private endpoint application security group.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "Parameters.properties.applicationSecurityGroups[]"
        return cls._args_schema
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.applicationSecurityGroups
            filters = enumerate(result)
            filters = filter(
                lambda e: e[1].id == self.ctx.args.asg_id,
                filters
            )
            idx = next(filters)[0]
            return result[idx]
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            _builder.set_prop("id", AAZStrType, ".asg_id")
...
class Remove(AAZCommand):
    ...
    :example: Remove a private endpoint application security group.
