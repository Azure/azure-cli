            ...
            for add_action in args.add_actions:
                ...
                try:
                    ...
                    raise InvalidArgumentValueError(
                        "Value of --add-action is invalid. Please refer to --help to get insight of correct format.")
                ...
                action["odatatype"] = ("Microsoft.WindowsAzure.Management.Monitoring.Alerts.Models."
                                       "Microsoft.AppInsights.Nexus.DataContracts.Resources."
                                       "ScheduledQueryRules.Action")
        ...
        if has_value(args.add_conditions):
            for cond in self.add_conditions:
                if "dynamic" in cond:
                    ...
                    item["ignore_data_before"] = Serializer.serialize_iso(dt) \
                        if (dt := item.pop("ignore_data_before", None)) else None
