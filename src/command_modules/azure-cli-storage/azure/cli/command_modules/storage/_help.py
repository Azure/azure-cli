...
examples:
  - name: Remove a network rule. (autogenerated)
    text: |
        az storage account network-rule remove --account-name MyAccount --ip-address "16.17.18.0/24" --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Copies a blob asynchronously. Use `az storage blob show` to check the status of the blobs. (autogenerated)
    text: az storage blob copy start --account-key 00000000 --account-name MyAccount --destination-blob MyDestinationBlob --destination-container MyDestinationContainer --source-uri $URI
    crafted: true
"""
...
examples:
  - name: Copy multiple blobs or files to a blob container. Use `az storage blob show` to check the status of the blobs. (autogenerated)
    text: az storage blob copy start-batch --account-key 00000000 --account-name MyAccount --destination-container MyDestinationContainer --source-container MySourceContainer
    crafted: true
"""
...
examples:
  - name: Check for the existence of a blob in a container. (autogenerated)
    text: az storage blob exists --container-name MyContainer --name MyBlob
    crafted: true
"""
...
examples:
  - name: Update storage blob service properties. (autogenerated)
    text: az storage blob service-properties update --404-document {404-document} --account-name MyAccount --index-document {index-document} --static-website true
    crafted: true
"""
...
examples:
  - name: Create the url to access a blob. (autogenerated)
    text: az storage blob url --container-name container1 --name blob1
    crafted: true
"""
...
examples:
  - name: Marks the specified container for deletion. (autogenerated)
    text: az storage container delete --account-name MyAccount --name MyContainer
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage container. (autogenerated)
    text: az storage container exists --name MyContainer
    crafted: true
"""
...
examples:
  - name: Add a CORS rule to a storage account. (autogenerated)
    text: az storage cors add --account-name MyAccount --allowed-headers {allowed-headers} --exposed-headers {exposed-headers} --methods DELETE --origins {origins} --services bfqt
    crafted: true
"""
...
examples:
  - name: Check for the existence of a storage directory. (autogenerated)
    text: az storage directory exists --account-key $STORAGEKEY --account-name MyAccount --name MyDirectory --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Insert an entity into a table. (autogenerated)
    text: az storage entity insert --entity {entity} --table-name MyTable
    crafted: true
"""
...
parameters:
  ...
  - name: --source-sas
    ...
    short-summary: The shared access signature for the source storage account.
examples:
  - name: Copy multiple files or blobs to a file share. (autogenerated)
    text: |
        az storage file copy start-batch --account-key $STORAGEKEY --account-name MyAccount --destination-share "myshare" --pattern *.py --source-account-key MySourceKey --source-account-name MySourceAccount --source-share share1
    crafted: true
"""
...
examples:
  - name: Delete files from an Azure Storage File Share. (autogenerated)
    text: az storage file delete-batch --account-key $STORAGEKEY --account-name MyAccount --pattern *.py --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file. (autogenerated)
    text: az storage file exists --account-key $STORAGEKEY --account-name MyAccount --path path/file.txt --share-name MyShare
    crafted: true
"""
...
examples:
  ...
  - name: Upload a file to a share that uses the SMB 3.0 protocol. (autogenerated)
    text: az storage file upload --account-key $STORAGEKEY --account-name MyStorageAccount --path cifar --share-name MyShare --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Upload files from a local directory to an Azure Storage File Share in a batch operation. (autogenerated)
    text: az storage file upload-batch --account-key $STORAGEKEY --account-name MyAccount --destination . --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Show logging settings for a storage account. (autogenerated)
    text: az storage logging show --account-name MyAccount
    crafted: true
"""
...
examples:
  - name: Update logging settings for a storage account. (autogenerated)
    text: az storage logging update --connection-string $current_env_conn_string --log {log} --retention 2 --services bfqt
    crafted: true
"""
...
examples:
  - name: Update metrics settings for a storage account. (autogenerated)
    text: az storage metrics update --account-name MyAccount --api true --hour true --minute true --retention 2 --services bfqt
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file share. (autogenerated)
    text: az storage share exists --account-key $STORAGEKEY --account-name MyAccount --connection-string $current_env_conn_string --name MyFileShare
    crafted: true
"""
...
examples:
  - name: Create a URI to access a file share. (autogenerated)
    text: az storage share url --account-key $STORAGEKEY --account-name MyAccount --name MyFileShare
    crafted: true
"""
