...
class Show(AAZCommand):
    ...
    class VirtualMachinesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_schedule_read(properties.lab_vms_shutdown)
            properties.lab_vms_startup = AAZObjectType(
                serialized_name="labVmsStartup",
            )
            _ShowHelper._build_schema_schedule_read(properties.lab_vms_startup)
            ...
            _ShowHelper._build_schema_day_details_read(properties.daily_recurrence)
            properties.hourly_recurrence = AAZObjectType(
                serialized_name="hourlyRecurrence",
            )
            _ShowHelper._build_schema_hour_details_read(properties.hourly_recurrence)
            properties.notification_settings = AAZObjectType(
                serialized_name="notificationSettings",
            )
            _ShowHelper._build_schema_notification_settings_read(properties.notification_settings)
            ...
            _ShowHelper._build_schema_week_details_read(properties.weekly_recurrence)
