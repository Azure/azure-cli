...
def load_arguments(self, _):
    ...
    for scope in ['disk create', 'snapshot create']:
        with self.argument_context(scope) as c:
            ...
            c.argument('secure_vm_disk_encryption_set', options_list=['--securevm-disk-encryption-set'], help='Name or ID of disk encryption set created with ConfidentialVmEncryptedWithCustomerKey encryption type.')
    # endregion
