...
def load_command_table(self, _):
    ...
    data_entity = get_client(self.cli_ctx, ResourceType.DATA_PRIVATE_KEYVAULT)
    ...
    if not is_azure_stack_profile(self):
        ...
        private_data_entity = get_client(self.cli_ctx, ResourceType.DATA_PRIVATE_KEYVAULT, Clients.private_7_2)
