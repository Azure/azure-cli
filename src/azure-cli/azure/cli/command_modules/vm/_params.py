...
def load_arguments(self, _):
    ...
    architecture_type = CLIArgumentType(arg_type=get_enum_type(self.get_models('Architecture', operation_group='disks')), min_api='2021-07-01', help='CPU architecture. Possible values include: x64, Arm64.')
