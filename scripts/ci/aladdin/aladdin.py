...
examples:
  - name: Get the properties of a specified agent pool for an Azure Container Registry. (autogenerated)
    text: az acr agentpool show --name MyAgentName --only-show-errors --registry MyRegistry --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Assign a managed identity to a container registry. (autogenerated)
    text: |
        az acr identity assign --identities "/subscriptions/{SUBSCRIPTON ID}/resourcegroups/{RESOURCE GROUP}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUserAssignedIdentitiy" --name mycontainerregistry
    crafted: true
"""
...
examples:
  - name: Remove a managed identity from a container registry. (autogenerated)
    text: |
        az acr identity remove --identities "/subscriptions/{SUBSCRIPTON ID}/resourcegroups/{RESOURCE GROUP}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myUserAssignedIdentitiy" --name mycontainerregistry
    crafted: true
"""
...
examples:
  - name: Approve a private endpoint connection request for a container registry. (autogenerated)
    text: az acr private-endpoint-connection approve --name myprivateendpointconnection --registry-name myregistry --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Updates a replication. (autogenerated)
    ...
    crafted: true
  - name: Updates a replication. (autogenerated)
    text: az acr replication update --name MyReplication --region-endpoint-enabled true --registry MyRegistry --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['ams account-filter create'] = """
type: command
short-summary: Create an account filter.
examples:
  - name: Create an account filter. (autogenerated)
    text: az ams account-filter create --account-name amsAccount --first-quality 720 --name filterName --resource-group resourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List all the account filters of an Azure Media Services account. (autogenerated)
    text: az ams account-filter list --account-name myaccount --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show the details of an asset. (autogenerated)
    text: az ams asset show --account-name myaccount --name myasset --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show an existing content key policy. (autogenerated)
    text: az ams content-key-policy show --account-name myaccount --name mycontentkeypolicy --resource-group myresourcegroup --with-secrets
    crafted: true
"""
...
examples:
  - name: Create a streaming locator. (autogenerated)
    text: az ams streaming-locator create --account-name myaccount --asset-name myasset --content-key-policy-name mycontentkeypolicy --name mystreaminglocator --resource-group myresourcegroup --streaming-policy-name mystreamingpolicy
    crafted: true
"""
...
aladdin_helps['ams transform update'] = """
type: command
short-summary: Update the details of a transform.
examples:
  - name: Update the details of a transform. (autogenerated)
    text: az ams transform update --account-name myAmsAccount --description newDescription --name transformName --resource-group myResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete an API Management API. (autogenerated)
    text: az apim api delete --api-id MyApi --resource-group myresourcegroup --service-name myservice
    crafted: true
"""
...
examples:
  - name: Show details of an API Management API. (autogenerated)
    text: az apim api show --api-id MyApi --resource-group myresourcegroup --service-name myservice
    crafted: true
"""
...
examples:
  - name: Restore key-values. (autogenerated)
    text: |
        az appconfig kv restore --connection-string Endpoint=https://contoso.azconfig.io;Id=xxx;Secret=xxx --datetime "2019-05-01T11:24:12Z" --key color --label v1.* --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['staticwebapp environment functions'] = """
type: command
short-summary: Show information about functions.
examples:
  - name: Show information about functions. (autogenerated)
    text: az staticwebapp environment functions --name MyStaticAppName --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete given hostname of the static app. (autogenerated)
    text: az staticwebapp hostname delete --hostname HostnameToDelete --name MyStaticAppName --resource-group myresourcegroup
    crafted: true
"""

aladdin_helps['staticwebapp hostname set'] = """
type: command
short-summary: Set given sub-domain hostname to the static app. Please configure a CNAME record with your DNS provider.
examples:
  - name: Set given sub-domain hostname to the static app. (autogenerated)
    text: az staticwebapp hostname set --hostname www.example.com --name MyStaticAppName --resource-group myresourcegroup
    crafted: true
"""

aladdin_helps['staticwebapp users list'] = """
type: command
short-summary: Lists users and assigned roles, limited to users who accepted their invites.
examples:
  - name: Lists users and assigned roles, limited to users who accepted their invites. (autogenerated)
    text: az staticwebapp users list --name MyStaticAppName --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Get the details of a source control deployment configuration. (autogenerated)
    text: az webapp deployment source show --name MyWebApp --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Stop protecting a backed up item. (autogenerated)
    text: az backup protection disable --backup-management-type AzureIaasVM --container-name MyContainer --delete-backup-data true --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: List the start and end points of the unbroken log chain(s) of the given backup item. (autogenerated)
    text: az backup recoverypoint show-log-chain --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault --workload-type VM
    crafted: true
"""
...
examples:
  - name: Delete an existing Recovery services vault. (autogenerated)
    text: az backup vault delete --name MyRecoveryServicesVault --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a new v4 SDK bot. (autogenerated)
    text: |
        az bot create --appid myAppId --endpoint "https://bing.com/api/messages" --kind registration --name myresourcebot --password password --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete an existing bot. (autogenerated)
    text: az bot delete --name myresourcebot --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create the DirectLine Channel on a bot with only v3 protocol enabled. (autogenerated)
    text: az bot directline create --name botName --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details of the Facebook Channel on a bot. (autogenerated)
    text: az bot facebook show --name myresourcebot --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Get details of the Microsoft Teams Channel on a bot. (autogenerated)
    text: az bot msteams show --name myresourcebot --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Publish to a bot's associated app service. (autogenerated)
    text: |
        az bot publish --code-dir "." --name botName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details of the Webchat Channel on a bot. (autogenerated)
    text: az bot webchat show --name myresourcebot --only-show-errors --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['cdn waf policy managed-rule-set add'] = """
type: command
short-summary: Add a managed rule set to a CDN WAF policy.
examples:
  - name: Add a managed rule set to a CDN WAF policy. (autogenerated)
    text: az cdn waf policy managed-rule-set add --only-show-errors --policy-name policy --resource-group group --rule-set-type DefaultRuleSet --rule-set-version 1.0
    crafted: true
"""
...
examples:
  - name: Manage Azure Cognitive Services accounts. (autogenerated)
    text: az cognitiveservices account create --kind Face --location WestEurope --name myresource --resource-group myResourceGroup --sku S0 --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['cosmosdb cassandra table throughput migrate'] = """
type: command
short-summary: Migrate the throughput of the Cassandra table between autoscale and manually provisioned.
examples:
  - name: Migrate the throughput of the Cassandra table between autoscale and manually provisioned. (autogenerated)
    text: az cosmosdb cassandra table throughput migrate --account-name myaccount --keyspace-name mykeyspace --name mytable --resource-group myresourcegroup --throughput-type autoscale
    crafted: true
"""
...
examples:
  - name: Update an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    ...
    crafted: true
  - name: Update an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table update --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --ttl 1000
    crafted: true
"""
...
examples:
  - name: Show the details of a Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb gremlin database show --account-name myaccount --name mydatabase --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update the throughput of the Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: |
        az cosmosdb gremlin graph throughput update --account-name myaccount --database-name mydatabase --name mygraph --resource-group myresourcegroup --throughput "700"
    crafted: true
"""
...
examples:
  - name: List the SQL stored procedures under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql stored-procedure list --account-name myaccount --container-name mycontainer --database-name mydatabase --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create an SQL trigger under an Azure Cosmos DB SQL container. (autogenerated)
    text: az cosmosdb sql trigger create --account-name MyAccount --body TriggerBody --container-name MyContainer --database-name MyDatabase --name MyTrigger --resource-group MyResourceGroup --type Pre
    crafted: true
"""
...
examples:
  - name: Create an Table under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb table create --account-name myaccount --name mytable --resource-group myresourcegroup --throughput "500"
    crafted: true
"""
...
aladdin_helps['databoxedge device show'] = """
type: command
short-summary: "Get the properties of the Data Box Edge/Data Box Gateway device."
examples:
  - name: Get the properties of the Data Box Edge/Data Box Gateway device. (autogenerated)
    text: |
        az databoxedge device show --device-name "testedgedevice" --resource-group "GroupForEdgeAutomation" --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Lists firewall rules in a Data Lake Store account. (autogenerated)
    ...
    crafted: true
  - name: Lists firewall rules in a Data Lake Store account. (autogenerated)
    text: az dls account firewall list --account mydatalakestoragegen1 --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Cancel a task if it's currently queued or running. (autogenerated)
    text: az dms project task cancel --name mytask --project-name myproject --resource-group myresourcegroup --service-name myservice
    crafted: true
"""
...
aladdin_helps['eventhubs georecovery-alias authorization-rule keys list'] = """
type: command
short-summary: Shows the keys and connection strings of Authorizationrule for the EventHubs Namespace
examples:
  - name: Shows the keys and connection strings of Authorizationrule for the EventHubs Namespace. (autogenerated)
    text: az eventhubs georecovery-alias authorization-rule keys list --alias myaliasname --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Request that a backup of the specified key be downloaded to the client. (autogenerated)
    text: az keyvault key backup --file mykey.der --name mykey --vault-name myvault
    crafted: true
"""
...
examples:
  - name: List the deleted keys in the specified Vault or HSM. (autogenerated)
    text: |
        az keyvault key list-deleted --id "/subscriptions/00000000-0000-0000-0000-00000000000000000/resourceGroups/myrg/providers/Microsoft.KeyVault/vaults/mykv/privateEndpointConnections/mykv.00000000-0000-0000-0000-00000000000000000"
    crafted: true
"""
...
examples:
  - name: Restore a backed up key to a Vault or HSM. (autogenerated)
    text: az keyvault key restore --file mykey.der --vault-name myvault
    crafted: true
"""
...
examples:
  - name: Delete a saved search for a given workspace. (autogenerated)
    text: az monitor log-analytics workspace saved-search delete --name mysavedsearchandituniqueingivenworkspace --resource-group myresourcegroup --workspace-name myworkspace
    crafted: true
"""
...
examples:
  - name: Delete a scoped resource of a private link scope resource. (autogenerated)
    text: az monitor private-link-scope scoped-resource delete --name myassignedresource --resource-group myresourcegroup --scope-name myscope
    crafted: true
"""
...
examples:
  - name: Update an HTTP listener. (autogenerated)
    text: az network application-gateway http-listener update --gateway-name MyAppGateway --host-names www.mynewhost.com --name MyHttpListener --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Add a new Private Link with a default IP Configuration and associate it with an existing Frontend IP. (autogenerated)
    text: az network application-gateway private-link add --frontend-ip MyAppGatewayPublicIp --gateway-name mygateway --name myprivatelink --resource-group myresourcegroup --subnet MySubnet --subnet-prefix 10.0.0.0/24
    crafted: true
"""
...
examples:
  - name: List all the Private Link. (autogenerated)
    text: az network application-gateway private-link list --gateway-name mygateway --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Show a Private Link. (autogenerated)
    text: az network application-gateway private-link show --gateway-name mygateway --name myprivatelink --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete a rewrite rule set. (autogenerated)
    text: az network application-gateway rewrite-rule set delete --gateway-name mygateway --name myrewriteruleset --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Add ssl profiles of the application gateway. (autogenerated)
    text: az network application-gateway ssl-profile add --cipher-suites TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 TLS_RSA_WITH_AES_128_GCM_SHA256 --gateway-name MyAppGateway --min-protocol-version TLSv1_2 --name MySslProfile --policy-type Custom --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an application gateway. (autogenerated)
    ...
    crafted: true
  - name: Update an application gateway. (autogenerated)
    text: az network application-gateway update --name MyApplicationGateway --resource-group MyResourceGroup --sku Standard_Small
    crafted: true
"""
...
aladdin_helps['network application-gateway waf-policy wait'] = """
type: command
short-summary: Place the CLI in a waiting state until a condition of the application gateway WAF policy is met.
examples:
  - name: Place the CLI in a waiting state until a condition of the application gateway WAF policy is met. (autogenerated)
    text: az network application-gateway waf-policy wait --name myapplicationgatewaywafpolicy --resource-group myresourcegroup --updated
    crafted: true
"""
...
aladdin_helps['network cross-region-lb create'] = """
type: command
short-summary: Create a cross-region load balancer.
examples:
  - name: Create a cross-region load balancer. (autogenerated)
    text: az network cross-region-lb create --backend-pool-name mybackendpool --frontend-ip-name myfrontendip --name MyLb --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['network ddos-protection show'] = """
type: command
short-summary: Show details of a DDoS protection plan.
examples:
  - name: Show details of a DDoS protection plan. (autogenerated)
    text: az network ddos-protection show --name MyDdosPlan --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete an NS record set and all associated records. (autogenerated)
    text: |
        az network dns record-set ns delete --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Delete a PTR record set and all associated records. (autogenerated)
    text: |
        az network dns record-set ptr delete --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    ...
    crafted: true
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering update --advertised-public-prefixes 2002:db00::/126 --circuit-name MyCircuit --ip-version IPv4 --name MyPeering --primary-peer-subnet 2002:db00::/126 --resource-group MyResourceGroup --secondary-peer-subnet 2003:db00::/126
    crafted: true
"""
...
examples:
  ...
  - name: Update a load balancing rule. (autogenerated)
    ...
    crafted: true
  - name: Update a load balancing rule. (autogenerated)
    text: az network lb rule update --backend-pool-name mybackendpool --lb-name MyLb --name MyLbRule --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a private link service endpoint connection. (autogenerated)
    text: |
        az network private-link-service connection update --connection-status Approved --description "Allow Internet to Web ASG on ports 80,8080." --name MyEndpointName.00000000-0000-0000-0000-00000000000000000 --resource-group MyResourceGroup --service-name MyPLSName
    crafted: true
"""
...
aladdin_helps['network routeserver peering show'] = """
type: command
short-summary: Show a virtual hub router peering
examples:
  - name: Show a virtual hub router peering. (autogenerated)
    text: az network routeserver peering show --name myvirtualhubrouterpeering --resource-group myresourcegroup --vrouter-name myvrouter
    crafted: true
"""
...
examples:
  - name: Delete a service endpoint policy. (autogenerated)
    text: az network service-endpoint policy delete --name myserviceendpointpolicy --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['network virtual-appliance delete'] = """
type: command
short-summary: Delete an Azure network virtual appliance.
examples:
  - name: Delete an Azure network virtual appliance. (autogenerated)
    text: az network virtual-appliance delete --name mynetworkvirtualappliance --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Create a flow log on a network security group. (autogenerated)
    text: az network watcher flow-log create --enabled true --location westus --name MyFlowLog --nsg MyNetworkSecurityGroupID --resource-group MyResourceGroup --storage-account account
    crafted: true
"""
...
examples:
  - name: Show a resource policy remediation. (autogenerated)
    text: |
        az policy remediation show --name myremediation --resource "/subscriptions/00000000-0000-0000-0000-00000000000000000/resourceGroups/myRg/providers/Microsoft.Compute/virtualMachines/myVm"
    crafted: true
"""
...
examples:
  - name: Delete a CNAME record set and its associated record. (autogenerated)
    text: |
        az network private-dns record-set cname delete --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['network private-dns record-set ptr add-record'] = """
type: command
short-summary: Add a PTR record.
examples:
  - name: Add a PTR record. (autogenerated)
    text: az network private-dns record-set ptr add-record --ptrdname another.site.com --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network private-dns record-set ptr delete'] = """
type: command
short-summary: Delete a PTR record set and all associated records.
examples:
  - name: Delete a PTR record set and all associated records. (autogenerated)
    text: az network private-dns record-set ptr delete --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""

aladdin_helps['network private-dns record-set ptr list'] = """
type: command
short-summary: List all PTR record sets in a zone.
examples:
  - name: List all PTR record sets in a zone. (autogenerated)
    text: az network private-dns record-set ptr list --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Set a subscription to be the current active subscription. (autogenerated)
    text: az account set --subscription 00000000-0000-0000-0000-00000000000000000
    crafted: true
"""
...
examples:
  - name: Delete a server. (autogenerated)
    text: az mariadb server delete --name testsvr --resource-group testgroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a firewall rule. (autogenerated)
    text: az mariadb server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update the parameter of a flexible server. (autogenerated)
    text: az mysql flexible-server parameter set --name parameterName --resource-group myresourcegroup --server-name myserver --subscription MySubscription --value parameterValue
    crafted: true
"""
...
aladdin_helps['mysql server ad-admin show'] = """
type: command
short-summary: Get Active Directory Administrator information for a MySQL server.
examples:
  - name: Get Active Directory Administrator information for a MySQL server. (autogenerated)
    text: az mysql server ad-admin show --resource-group testgroup --server-name testsvr --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update the parameter of a flexible server. (autogenerated)
    text: az postgres flexible-server parameter set --name parameterName --resource-group myresourcegroup --server-name myserver --value parameterValue
    crafted: true
"""
...
aladdin_helps['postgres server private-endpoint-connection show'] = """
type: command
short-summary: Show details of a private endpoint connection associated with a PostgreSQL server.
examples:
  - name: Show details of a private endpoint connection associated with a PostgreSQL server. (autogenerated)
    text: az postgres server private-endpoint-connection show --name myprivateendpointconnectionassociatedserver --resource-group myresourcegroup --server-name myserver
    crafted: true
"""
...
aladdin_helps['relay hyco authorization-rule delete'] = """
type: command
short-summary: Deletes the Authorization Rule of the given Relay Service Hybrid Connection.
examples:
  - name: Deletes the Authorization Rule of the given Relay Service Hybrid Connection. (autogenerated)
    text: az relay hyco authorization-rule delete --hybrid-connection-name myhyco --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['relay wcfrelay authorization-rule show'] = """
type: command
short-summary: show properties of Authorization Rule for the given Relay Service WCF Relay.
examples:
  - name: show properties of Authorization Rule for the given Relay Service WCF Relay. (autogenerated)
    text: az relay wcfrelay authorization-rule show --name myauthorule --namespace-name mynamespace --relay-name myrelay --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""

aladdin_helps['relay wcfrelay show'] = """
type: command
short-summary: shows the Relay Service WCF Relay Details
examples:
  - name: shows the Relay Service WCF Relay Details. (autogenerated)
    text: az relay wcfrelay show --name myrelay --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Export the template used for a deployment. (autogenerated)
    text: az deployment export --name MyDeployment --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: List deployment operations at resource group. (autogenerated)
    text: az deployment operation group list --name MyDeployment --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a managed application. (autogenerated)
    ...
    crafted: true
  - name: Delete a managed application. (autogenerated)
    text: az managedapp delete --name MyManagedApplication --only-show-errors --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['policy assignment identity assign'] = """
type: command
short-summary: Add a system assigned identity to a policy assignment.
examples:
  - name: Add a system assigned identity to a policy assignment. (autogenerated)
    text: az policy assignment identity assign --identity-scope /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/MyResourceGroup --name MyPolicyAssignment --role Contributor --scope '/providers/Microsoft.Management/managementGroups/MyManagementGroup'
    crafted: true
"""
...
aladdin_helps['servicebus topic subscription rule show'] = """
type: command
short-summary: Shows ServiceBus Rule Details
examples:
  - name: Shows ServiceBus Rule Details. (autogenerated)
    text: az servicebus topic subscription rule show --name myrule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription --subscription-name mysubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  - name: Updates the Service Bus Topic. (autogenerated)
    ...
    crafted: true
  - name: Updates the Service Bus Topic. (autogenerated)
    text: az servicebus topic update --auto-delete-on-idle PT3M --name mytopic --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['sql db classification list'] = """
type: command
short-summary: Get the sensitivity classifications of a given database.
examples:
  - name: Get the sensitivity classifications of a given database. (autogenerated)
    text: az sql db classification list --name mydb --resource-group mygroup --server myserver --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a data warehouse. (autogenerated)
    ...
    crafted: true
  - name: Update a data warehouse. (autogenerated)
    text: az sql dw update --max-size 250GB --name MyDataWarehouse --resource-group MyResourceGroup --server myserver
    crafted: true
"""
...
examples:
  - name: Deletes an existing managed instance Active Directory Administrator. (autogenerated)
    text: az sql mi ad-admin delete --managed-instance myManagedInstance --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Returns a list of managed instance Active Directory Administrators. (autogenerated)
    text: az sql mi ad-admin list --managed-instance myManagedInstance --resource-group myresourcegroup
    crafted: true
"""

aladdin_helps['sql mi failover'] = """
type: command
short-summary: Failover a managed instance.
examples:
  - name: Failover a managed instance. (autogenerated)
    text: az sql mi failover --name myinstance --replica-type ReadableSecondary --resource-group mygroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Copy an incremental copy of a blob asynchronously. (autogenerated)
    ...
    crafted: true
  - name: Copies an incremental copy of a blob asynchronously. (autogenerated)
    text: az storage blob incremental-copy start --account-name MyAccount --destination-blob MyDestinationBlob --destination-container MyDestinationContainer --source-uri https://storage.blob.core.windows.net/photos
    crafted: true
"""
...
aladdin_helps['storage container legal-hold set'] = """
type: command
short-summary: Set legal hold tags.
examples:
  - name: Set legal hold tags. (autogenerated)
    text: az storage container legal-hold set --account-name mystorageccount --container-name mycontainer --subscription mysubscription --tags tag1 tag2
    crafted: true
"""
...
examples:
  - name: Create a new file in ADLS Gen2 file system. (autogenerated)
    text: az storage fs file create --account-name myadlsaccount --connection-string myconnectionstring --file-system fsname --path dir/a.txt
    crafted: true
"""
...
examples:
  - name: Delete a file in ADLS Gen2 file system. (autogenerated)
    text: az storage fs file delete --account-name myadlsaccount --auth-mode login --file-system fsname --path dir/a.txt
    crafted: true
"""
...
examples:
  - name: Return all user-defined metadata for the specified file. (autogenerated)
    text: az storage fs file metadata show --account-name myadlsaccount --auth-mode login --file-system fsname --path dir/a.txt
    crafted: true
"""
...
aladdin_helps['storage logging off'] = """
type: command
...
examples:
  - name: Turn off logging for a storage account. (autogenerated)
    text: az storage logging off --account-key 00000000 --account-name MyAccount
    crafted: true
"""
...
aladdin_helps['synapse sql pool tde show'] = """
type: command
...
examples:
  - name: Get a SQL pool's transparent data encryption configuration. (autogenerated)
    text: az synapse sql pool tde show --ids 00000000-0000-0000-0000-0000000000000-00000000-0000-0000-0000-0000000000000
    crafted: true
"""

aladdin_helps['synapse sql pool update'] = """
type: command
short-summary: Update a SQL pool.
examples:
  - name: Update a SQL pool. (autogenerated)
    text: |
        az synapse sql pool update --name sqlpool --performance-level "DW1000c" --resource-group rg --workspace-name testsynapseworkspace
    crafted: true
"""

aladdin_helps['synapse sql pool wait'] = """
type: command
short-summary: Place the CLI in a waiting state until a condition of a SQL pool is met.
examples:
  - name: Place the CLI in a waiting state until a condition of a SQL pool is met. (autogenerated)
    text: az synapse sql pool wait --created --resource-group myresourcegroup --sql-pool-name mysqlpool --workspace-name myworkspace
    crafted: true
"""

aladdin_helps['synapse workspace update'] = """
type: command
short-summary: Update a Synapse workspace.
examples:
  - name: Update a Synapse workspace. (autogenerated)
    text: az synapse workspace update --name fromcli4 --resource-group rg --sql-admin-login-password Password123!
    crafted: true
"""
...
examples:
  - name: update a share image defintiion. (autogenerated)
    text: az sig image-definition update --gallery-image-definition MyImage --gallery-name MyGallery --resource-group MyResourceGroup --set publishingProfile.excludeFromLatest=true --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete an SSH public key. (autogenerated)
    text: az sshkey delete --resource-group myresourcegroup --ssh-public-key-name mysshpublickey
    crafted: true
"""
...
aladdin_helps['vm simulate-eviction'] = """
type: command
short-summary: Simulate the eviction of a Spot VM.
examples:
  - name: Simulate the eviction of a Spot VM. (autogenerated)
    text: az vm simulate-eviction --name MyVm --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['vmss extension upgrade'] = """
type: command
short-summary: Upgrade all extensions for all VMSS instances to the latest version.
examples:
  - name: Upgrade all extensions for all VMSS instances to the latest version. (autogenerated)
    text: az vmss extension upgrade --ids @-
    crafted: true
"""
...
examples:
  - name: Change ServiceState property for a given service within a VMSS. (autogenerated)
    text: az vmss set-orchestration-service-state --action Resume --name MyScaleSet --resource-group MyResourceGroup --service-name AutomaticRepairs --subscription MySubscription
    crafted: true
"""
