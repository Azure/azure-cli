...
class ShowHealth(AAZCommand):
    ...
    :example: Get the VPN client connection health detail per P2S client connection of the virtual network gateway.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualNetworkGatewaysGetVpnclientConnectionHealth(ctx=self.ctx)()
    ...
    class VirtualNetworkGatewaysGetVpnclientConnectionHealth(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.egress_packets_transferred = AAZIntType(
            ...
            _element.ingress_packets_transferred = AAZIntType(
                serialized_name="ingressPacketsTransferred",
                flags={"read_only": True},
            )
            _element.max_bandwidth = AAZIntType(
                serialized_name="maxBandwidth",
                flags={"read_only": True},
            )
            _element.max_packets_per_second = AAZIntType(
            ...
            _element.vpn_connection_duration = AAZIntType(
                serialized_name="vpnConnectionDuration",
                flags={"read_only": True},
            )
            _element.vpn_connection_id = AAZStrType(
                serialized_name="vpnConnectionId",
                flags={"read_only": True},
            )
            _element.vpn_connection_time = AAZStrType(
                serialized_name="vpnConnectionTime",
                flags={"read_only": True},
            )
            _element.vpn_user_name = AAZStrType(
...
class _ShowHealthHelper:
    """Helper class for ShowHealth"""
