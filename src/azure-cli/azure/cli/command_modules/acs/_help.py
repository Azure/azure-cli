...
examples:
  - name: Get the versions available for creating a managed Kubernetes cluster
    ...
    crafted: true
  - name: Get the versions available for creating a managed Kubernetes cluster (autogenerated)
    text: az aks get-versions --location westus2
    crafted: true
"""
...
examples:
  ...
  - name: Remove Azure Dev Spaces from a managed Kubernetes cluster. (autogenerated)
    text: az aks remove-dev-spaces --name my-aks --resource-group my-aks-group
    crafted: true
"""
...
examples:
  - name: Show the details for a managed Kubernetes cluster
    ...
    crafted: true
  - name: Show the details for a managed Kubernetes cluster (autogenerated)
    text: az aks show --name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update credentials for a managed Kubernetes cluster, like service principal. (autogenerated)
    text: az aks update-credentials --client-secret MyNewServicePrincipalSecret --name MyManagedCluster --reset-service-principal --resource-group MyResourceGroup --service-principal MyNewServicePrincipalID
    crafted: true
"""
