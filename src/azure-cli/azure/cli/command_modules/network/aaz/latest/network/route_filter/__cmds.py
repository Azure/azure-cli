...
class Update(AAZCommand):
    ...
    :example: Update the tags on a route filter.
    ...
    class RouteFiltersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _UpdateHelper._build_schema_route_filter_read(cls._schema_on_200)
    ...
    class RouteFiltersCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            cls._schema_on_200_201 = AAZObjectType()
            _UpdateHelper._build_schema_route_filter_read(cls._schema_on_200_201)
...
class Wait(AAZWaitCommand):
    ...
    class RouteFiltersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _WaitHelper._build_schema_express_route_circuit_peering_read(ipv6_peerings.Element)

            peerings = cls._schema_on_200.properties.peerings
            peerings.Element = AAZObjectType(
                flags={"read_only": True},
            )
            _WaitHelper._build_schema_express_route_circuit_peering_read(peerings.Element)
...
@link_helper(
    ...
    ("_build_schema_express_route_circuit_peering_read", _Helper),
...
class _UpdateHelper:
    ...
    def _build_schema_route_filter_read(cls, _schema):
        ...
        ipv6_peerings = _schema_route_filter_read.properties.ipv6_peerings
        ipv6_peerings.Element = AAZObjectType(
            flags={"read_only": True},
        )
        cls._build_schema_express_route_circuit_peering_read(ipv6_peerings.Element)

        peerings = _schema_route_filter_read.properties.peerings
        peerings.Element = AAZObjectType(
            flags={"read_only": True},
        )
        cls._build_schema_express_route_circuit_peering_read(peerings.Element)
