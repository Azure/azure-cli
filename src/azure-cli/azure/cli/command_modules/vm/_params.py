...
def load_arguments(self, _):
    ...
    for scope in ['disk', 'snapshot']:
        with self.argument_context(scope) as c:
            ...
            c.argument('public_network_access', arg_type=get_enum_type(['Disabled', 'Enabled']), min_api='2021-04-01', is_preview=True, help='Policy for controlling export on the disk')
            c.argument('accelerated_network', arg_type=get_three_state_flag(), min_api='2021-04-01', is_preview=True, help='True if the image from which the OS disk is created supports accelerated networking')
