...
def load_arguments(self, _):
    ...
    with self.argument_context('batchai cluster create', arg_group='Nodes') as c:
        ...
        c.argument('vm_priority', arg_type=get_enum_type(['dedicated', 'lowpriority']), default=None, options_list=['--vm-priority'], help="VM priority. If lowpriority selected the node can get preempted while the job is running.")
