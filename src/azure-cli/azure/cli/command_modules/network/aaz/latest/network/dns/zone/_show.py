...
class Show(AAZCommand):
    ...
    class ZonesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            name_servers = cls._schema_on_200.properties.name_servers
            name_servers.Element = AAZStrType()

            registration_virtual_networks = cls._schema_on_200.properties.registration_virtual_networks
            registration_virtual_networks.Element = AAZObjectType()
            _ShowHelper._build_schema_sub_resource_read(registration_virtual_networks.Element)

            resolution_virtual_networks = cls._schema_on_200.properties.resolution_virtual_networks
            resolution_virtual_networks.Element = AAZObjectType()
            _ShowHelper._build_schema_sub_resource_read(resolution_virtual_networks.Element)
