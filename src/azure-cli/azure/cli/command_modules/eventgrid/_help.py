...
examples:
  ...
  - name: Get the details of a domain. (autogenerated)
    text: az eventgrid domain show --name domain1 --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: Delete a domain topic under a domain. (autogenerated)
    text: az eventgrid domain topic delete --domain-name domain1 --name domaintopic1 --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a domain topic. (autogenerated)
    text: az eventgrid domain topic show --domain-name domain1 --name topic1 --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: Delete a topic. (autogenerated)
    ...
    crafted: true
  - name: Delete a topic. (autogenerated)
    text: az eventgrid topic delete --name topic1 --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: Get the details of a topic (autogenerated)
    text: az eventgrid topic show --name topic1 --resource-group rg1
    crafted: true
"""
...
examples:
  ...
  - name: List the event types supported by a topic type. (autogenerated)
    text: az eventgrid topic-type list-event-types --name Microsoft.Storage.StorageAccounts
    crafted: true
"""
