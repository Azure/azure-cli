...
register_cli_argument('keyvault key', 'id', help='The URI identifier of a key vault key')
register_cli_argument('keyvault secret', 'id', help='The URI identifier of a key vault secret')
register_cli_argument('keyvault certificate', 'id', help='The URI identifier of a key vault certificate')
