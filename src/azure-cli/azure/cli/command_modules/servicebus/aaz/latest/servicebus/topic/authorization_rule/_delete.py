...
@register_command(
    "servicebus topic authorization-rule delete",
)
class Delete(AAZCommand):
    """Delete a topic authorization rule.

    :example: Deletes the Authorization Rule of Service Bus Topic.
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TopicsDeleteAuthorizationRule(ctx=self.ctx)()
    ...
    class TopicsDeleteAuthorizationRule(AAZHttpOperation):
