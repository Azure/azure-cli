...
DEPENDENCIES = [
    ...
    'azure-cli-container==0.3.13',
    'azure-cli-core==2.0.57',
    'azure-cli-cosmosdb==0.2.7',
    'azure-cli-dla==0.2.3',
    'azure-cli-dls==0.1.7',
    'azure-cli-dms==0.1.2',
