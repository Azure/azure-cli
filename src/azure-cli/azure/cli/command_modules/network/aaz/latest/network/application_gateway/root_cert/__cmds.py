...
class Create(AAZCommand):
    ...
    :example: Upload a trusted root certificate.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.name = AAZStrArg(
            options=["-n", "--name"],
            help="Name of the trusted root certificate.",
            required=True,
        )
        _args_schema.keyvault_secret = AAZStrArg(
            options=["--keyvault-secret"],
            help="ID of keyvault secret.",
        )

        # define Arg Group "Parameters.properties.trustedRootCertificates[]"
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.trustedRootCertificates
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("keyVaultSecretId", AAZStrType, ".keyvault_secret")

            return _instance_value


@register_command(
    "network application-gateway root-cert delete",
)
...
@register_command(
    "network application-gateway root-cert list",
)
class List(AAZCommand):
    """List trusted root certificates.

    :example: List trusted root certificates.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.trustedRootCertificates

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.trustedRootCertificates = value
            return
...
@register_command(
    "network application-gateway root-cert show",
)
class Show(AAZCommand):
    """Get the details of a trusted root certificate.

    :example: Get the details of a trusted root certificate.
...
class Update(AAZCommand):
    ...
    :example: Update a trusted root certificate.
...
@register_command(
    "network application-gateway root-cert wait",
)
