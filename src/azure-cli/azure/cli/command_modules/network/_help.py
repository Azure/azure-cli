...
examples:
  - name: SSH to virtual machine using Azure Bastion (autogenerated)
    text: |
        az network bastion ssh --name MyBastionHost --resource-group MyResourceGroup --vm-id vmResourceId --auth-type AAD/password/ssh-key-file
    crafted: true
"""
...
examples:
  - name: RDP to virtual machine using Azure Bastion (autogenerated)
    text: |
        az network bastion rdp --name MyBastionHost --resource-group MyResourceGroup --vm-id vmResourceId
    crafted: true
"""
...
examples:
  - name: Show a Azure bastion host machine (autogenerated)
    text: |
        az network bastion tunnel --name MyBastionHost --resource-group MyResourceGroup --vm-id vmResourceId --resource-port 111 --port 222
    crafted: true
"""
