...
class VmssCreateOperations(object):
    """VmssCreateOperations operations.
    ...
    def create_or_update(
        ...
        :type location: str
        :param nat_backend_port: Backend NAT port to map.
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'DeploymentVmssCreate')
