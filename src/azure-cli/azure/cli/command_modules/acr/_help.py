...
examples:
  ...
  - name: Update content-trust policy for an Azure Container Registry. (autogenerated)
    text: az acr config content-trust update --name taskname --status enabled
    crafted: true
"""
...
examples:
  ...
  - name: Delete a replicated region from an Azure Container Registry. (autogenerated)
    text: az acr replication delete --name MyReplication --registry MyRegistry
    crafted: true
"""
...
examples:
  ...
  - name: Update the schedule of a timer trigger for a task. (autogenerated)
    text: |
        az acr task timer update --name taskname --registry registryname --schedule "0 12 * * *" --timer-name t2
    crafted: true
"""
...
examples:
  ...
  - name: Patch the run properties of an Azure Container Registry Task. (autogenerated)
    text: az acr task update-run --no-archive true --registry MyRegistry --run-id runId
    crafted: true
"""
...
examples:
  ...
  - name: List recent events for a webhook (autogenerated)
    text: az acr webhook list-events --name MyWebhook --registry MyRegistry
    crafted: true
"""
