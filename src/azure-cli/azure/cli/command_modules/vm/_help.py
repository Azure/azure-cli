...
examples:
  - name: Get a proximity placement group (autogenerated)
    text: az ppg show --name MyProximityPlacementGroup --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
