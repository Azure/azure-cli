...
examples:
  ...
  - name: Update a virtual network gateway. (autogenerated)
    ...
    crafted: true
  - name: Update AAD (Azure Active Directory) authentication of a virtual network gateway
    text: |-
        az network vnet-gateway update -g MyResourceGroup -n MyVnetGateway \\
        --aad-tenant MyAADTenantURI \\
        --aad-audience MyAADAudienceID \\
        --aad-issuer MyAADIssuer
"""
