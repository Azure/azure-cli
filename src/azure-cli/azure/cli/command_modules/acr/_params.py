...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr connected-registry create') as c:
        ...
        c.argument('notifications_list', options_list=['--notifications-list'], nargs='+', help='List of artifact pattern for which notifications need to be generated. Use the format "--notifications-list [PATTERN1 PATTERN2 ...]".')
    ...
    with self.argument_context('acr connected-registry update') as c:
        ...
        c.argument('add_notifications_list', options_list=['--add-notifications-list'], nargs='*',
                   help='List of artifact pattern to be added to notifications list. Use the format "--add-notifications-list [PATTERN1 PATTERN2 ...]".')
        c.argument('remove_notifications_list', options_list=['--remove-notifications-list'], nargs='*',
                   help='List of artifact pattern to be removed from notifications list. Use the format "--remove-notifications-list [PATTERN1 PATTERN2 ...]".')
