...
class Remove(AAZCommand):
    ...
    _aaz_info = {
        "version": "2018-11-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/networkinterfaces/{}", "2018-11-01", "properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[]"],
        ]
    }
