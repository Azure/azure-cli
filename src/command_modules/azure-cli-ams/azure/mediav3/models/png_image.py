...
class PngImage(Image):
    ...
    def __init__(self, label=None, key_frame_interval=None, stretch_mode=None, start=None, step=None, range=None, layers=None):
        super(PngImage, self).__init__(label=label, key_frame_interval=key_frame_interval, stretch_mode=stretch_mode, start=start, step=step, range=range)
        self.layers = layers
