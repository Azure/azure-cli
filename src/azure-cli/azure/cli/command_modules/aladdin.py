...
examples:
  - name: Remove the ACI Connector from a managed Kubernetes cluster. (autogenerated)
    text: az aks remove-connector --connector-name MyConnector --location westus2 --name MyManagedCluster --os-type Windows --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['ams account storage add'] = """
type: command
short-summary: Attach a secondary storage to an Azure Media Services account.
examples:
  - name: Attach a secondary storage to an Azure Media Services account. (autogenerated)
    text: az ams account storage add --account-name MyAccount --name MyResourceIDSecondaryStorageAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update the details of an Azure Media Services account. (autogenerated)
    text: az ams account update --name MyAzureMediaServicesAccount --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['ams account-filter show'] = """
type: command
short-summary: Show the details of an account filter.
examples:
  - name: Show the details of an account filter. (autogenerated)
    text: az ams account-filter show --account-name MyAccount --name MyAccountFilter --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content. The signatures are derived from the storage account keys. (autogenerated)
    text: az ams asset get-sas-urls --account-name MyAccount --expiry 2019-02-01T12:20:00Z --name MyAsset --permissions Read
    crafted: true
  - name: Lists storage container URLs with shared access signatures (SAS) for uploading and downloading Asset content. The signatures are derived from the storage account keys. (autogenerated)
    text: az ams asset get-sas-urls --account-name MyAccount --name MyAsset --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List streaming locators which are associated with this asset. (autogenerated)
    text: az ams asset list-streaming-locators --account-name MyAccount --name MyAsset --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update the details of an asset. (autogenerated)
    text: az ams asset update --account-name MyAccount --name MyAsset --resource-group MyResourceGroup --set outputs[0].relativePriority=High
    crafted: true
"""

aladdin_helps['ams asset-filter list'] = """
type: command
short-summary: List all the asset filters of an Azure Media Services account.
examples:
  - name: List all the asset filters of an Azure Media Services account. (autogenerated)
    text: az ams asset-filter list --account-name MyAccount --asset-name MyAsset --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['ams job cancel'] = """
type: command
short-summary: Cancel a job.
examples:
  - name: Cancel a job. (autogenerated)
    text: az ams job cancel --account-name MyAccount --name MyJob --resource-group MyResourceGroup --transform-name MyTransform
    crafted: true
"""
...
aladdin_helps['ams job update'] = """
type: command
short-summary: Update an existing job.
examples:
  - name: Update an existing job. (autogenerated)
    text: az ams job update --account-name MyAccount --description newDescription --name MyJob --resource-group MyResourceGroup --transform-name MyTransform
    crafted: true
  - name: Update an existing job. (autogenerated)
    text: az ams job update --account-name MyAccount --name MyJob --resource-group MyResourceGroup --set outputs[0].relativePriority=High --transform-name MyTransform
    crafted: true
"""

aladdin_helps['ams live-event create'] = """
type: command
short-summary: Create a live event.
examples:
  - name: Create a live event. (autogenerated)
    text: az ams live-event create --account-name MyAccount --ips 1.2.3.4/22 5.6.7.8/30 --name MyLiveEvent --resource-group MyResourceGroup --streaming-protocol FragmentedMP4
    crafted: true
"""
...
examples:
  - name: Delete a live event. (autogenerated)
    text: az ams live-event delete --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""

aladdin_helps['ams live-event reset'] = """
type: command
short-summary: Reset a live event.
examples:
  - name: Reset a live event. (autogenerated)
    text: az ams live-event reset --account-name MyAccount --name MyLiveEvent --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Stop a live event. (autogenerated)
    text: az ams live-event stop --account-name MyAccount --name MyLiveEvent --remove-outputs-on-stop --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a live output. (autogenerated)
    text: az ams live-output delete --account-name MyAccount --live-event-name MyLiveEvent --name MyLiveOutput --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['ams live-output show'] = """
type: command
short-summary: Show the details of a live output.
examples:
  - name: Show the details of a live output. (autogenerated)
    text: az ams live-output show --account-name MyAccount --live-event-name MyLiveEvent --name MyLiveOutput --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a transform. (autogenerated)
    text: az ams transform delete --account-name MyAccount --name MyTransform --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['appconfig feature show'] = """
type: command
short-summary: Show all attributes of a feature flag.
examples:
  - name: Show all attributes of a feature flag. (autogenerated)
    text: az appconfig feature show --feature color --fields key --name MyAppConfiguration
    crafted: true
"""

aladdin_helps['appservice ase show'] = """
type: command
short-summary: Show details of an app service environment.
examples:
  - name: Show details of an app service environment. (autogenerated)
    text: az appservice ase show --name MyAseName --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Configure deployment slot auto swap. (autogenerated)
    text: az functionapp deployment slot auto-swap --disable --name MyFunctionApp --resource-group MyResourceGroup --slot staging
    crafted: true
"""
...
examples:
  - name: Delete an existing Recovery services vault. (autogenerated)
    text: az backup vault delete --force --name MyRecoveryServicesVault --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['batch account create'] = """
type: command
...
examples:
  - name: Create a Batch account with the specified parameters. (autogenerated)
    text: az batch account create --location westus2 --name MyBatchAccount --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get details of the Facebook Channel on a bot (commonly used with --output). (autogenerated)
    text: az bot facebook show --name MyResourceBot --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['bot msteams delete'] = """
type: command
short-summary: Delete the Microsoft Teams Channel on a bot
examples:
  - name: Delete the Microsoft Teams Channel on a bot (autogenerated)
    text: az bot msteams delete --name MyResourceBot --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['bot skype create'] = """
type: command
short-summary: Create the Skype Channel on a bot.
examples:
  - name: Create the Skype Channel on a bot. (autogenerated)
    text: az bot skype create --add-disabled true --enable-media-cards true --enable-messaging true --name botName --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""

aladdin_helps['bot skype show'] = """
type: command
short-summary: Get details of the Skype Channel on a bot
examples:
  - name: Get details of the Skype Channel on a bot (autogenerated)
    text: az bot skype show --name MyResourceBot --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a CDN profile. (autogenerated)
    text: az cdn profile update --name MyCDNProfileWhichIsUniqueWithinResourceGroup --resource-group MyResourceGroup --tags key=value
    crafted: true
"""
...
examples:
  ...
  - name: Remove a network rule. (autogenerated)
    text: az cognitiveservices account network-rule remove --name MyAccount --resource-group MyResourceGroup --subnet mysubnet --vnet-name MyVnet
    crafted: true
"""
...
examples:
  - name: Create an Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: |
        az cosmosdb cassandra keyspace create --account-name MyAccount --name MyKeyspace --resource-group MyResourceGroup --throughput "500"
    crafted: true
"""
...
examples:
  - name: Show the details of a Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb cassandra keyspace show --account-name MyAccount --name MyKeyspace --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Cassandra keyspace under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb cassandra keyspace throughput show --account-name MyAccount --name MyKeyspace --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an Azure Cosmos DB Cassandra table.
    ...
    crafted: true
  - name: Create an Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table create --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --schema @indexes-file.json --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete the Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: az cosmosdb cassandra table delete --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update the throughput of the Cassandra table under an Azure Cosmos DB Cassandra keyspace. (autogenerated)
    text: |
        az cosmosdb cassandra table throughput update --account-name MyAccount --keyspace-name MyKeyspace --name MyTable --resource-group MyResourceGroup --subscription MySubscription --throughput "500"
    crafted: true
"""
...
aladdin_helps['cosmosdb gremlin database delete'] = """
type: command
short-summary: Delete the Gremlin database under an Azure Cosmos DB account.
examples:
  - name: Delete the Gremlin database under an Azure Cosmos DB account. (autogenerated)
    text: az cosmosdb gremlin database delete --account-name MyAccount --name MyDatabase --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List the read-only access keys for a Azure Cosmos DB database account. (autogenerated)
    text: az cosmosdb list-read-only-keys --name MyCosmosDBDatabaseAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Get the throughput of the MongoDB collection under an Azure Cosmos DB MongoDB database. (autogenerated)
    text: az cosmosdb mongodb collection throughput show --account-name MyAccount --database-name MyDatabase --name MyCollection --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete the SQL container under an Azure Cosmos DB SQL database. (autogenerated)
    text: az cosmosdb sql container delete --account-name MyAccount --database-name MyDatabase --name MyContainer --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a Data Lake Store account. (autogenerated)
    text: az dls account delete --account mydatalakestoragegen1 --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['eventgrid domain update'] = """
type: command
short-summary: Update a domain.
examples:
  - name: Update a domain. (autogenerated)
    text: az eventgrid domain update --ids /subscriptions/{SubID}/resourceGroups/{RG}/providers/Microsoft.EventGrid/domains/domain1
    crafted: true
"""
...
aladdin_helps['eventhubs eventhub authorization-rule keys renew'] = """
type: command
short-summary: Regenerate the connection strings of Authorizationrule for the namespace.
examples:
  - name: Regenerate the connection strings of Authorizationrule for the namespace. (autogenerated)
    text: az eventhubs eventhub authorization-rule keys renew --eventhub-name myeventhub --key PrimaryKey --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Sets a Geo-Disaster Recovery Configuration Alias for the give Namespace (autogenerated)
    ...
    crafted: true
  - name: Sets a Geo-Disaster Recovery Configuration Alias for the give Namespace (autogenerated)
    text: az eventhubs georecovery-alias set --alias myaliasname --alternate-name MyAlternate --namespace-name primarynamespace --partner-namespace resourcearmid --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete an event hub consumer group. (autogenerated)
    text: az iot hub consumer-group delete --hub-name MyHub --name MyEventHubConsumerGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Start a Kusto cluster (autogenerated)
    text: az kusto cluster start --name MyCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Export artifacts from a formula. (autogenerated)
    text: az lab formula export-artifacts --lab-name MyLab --name MyFormula --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show the details of a maps account. (autogenerated)
    text: az maps account show --name MyMapsAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update autoscale settings. (autogenerated)
    ...
    crafted: true
  - name: Update autoscale settings. (autogenerated)
    text: az monitor autoscale update --name MyAutoscaleSettings --resource-group MyResourceGroup --set retentionPolicy.days=365 --set retentionPolicy.days=365 --set retentionPolicy.days=365 --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a workspace instance. (autogenerated)
    text: az monitor log-analytics workspace delete --resource-group MyResourceGroup --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Create a frontend IP address. (autogenerated)
    text: az network application-gateway frontend-ip create --gateway-name MyAppGateway --name MyFrontendIp --private-ip-address 10.10.10.50 --resource-group MyResourceGroup --subnet MySubnet --vnet-name MyVnet
    crafted: true
"""
...
examples:
  - name: Update a frontend IP address. (autogenerated)
    text: az network application-gateway frontend-ip update --gateway-name MyAppGateway --name MyFrontendIp --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  - name: Create HTTP settings. (autogenerated)
    text: az network application-gateway http-settings create --gateway-name MyAppGateway --host-name MyHost --name MyHttpSettings --port 80 --probe MyNewProbe --protocol Http --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List rewrite rule conditions. (autogenerated)
    text: az network application-gateway rewrite-rule condition list --gateway-name MyGateway --resource-group MyResourceGroup --rule-name MyRule --rule-set-name MyRuleSet
    crafted: true
"""
...
examples:
  - name: Get the details of a rewrite rule. (autogenerated)
    text: az network application-gateway rewrite-rule show --gateway-name MyGateway --name MyRewriteRule --resource-group MyResourceGroup --rule-set-name MyRuleSet
    crafted: true
"""
...
examples:
  - name: Get the details of an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule show --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['network application-gateway waf-policy managed-rule rule-set remove'] = """
type: command
short-summary: >
...
examples:
  - name: Remove a managed rule set by rule set group name if rule_group_name is specified. Otherwise, remove all rule set.
    text: az network application-gateway waf-policy managed-rule rule-set remove --policy-name MyPolicy --resource-group MyResourceGroup --type Permanent --version IPv4
    crafted: true
"""
...
examples:
  - name: List properties of a web application firewall global configuration. (autogenerated)
    text: az network application-gateway waf-policy policy-setting list --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an empty CAA record set. (autogenerated)
    text: az network dns record-set caa create --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Delete a CAA record set and all associated records. (autogenerated)
    text: az network dns record-set caa delete --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create an empty NS record set. (autogenerated)
    text: az network dns record-set ns create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Get the details of a TXT record set. (autogenerated)
    text: az network dns record-set txt show --name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: List ExpressRoute links. (autogenerated)
    text: az network express-route port link list --port-name MyPort --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of an ExpressRoute link. (autogenerated)
    text: az network express-route port link show --name MyLinkExpressRoutePort --port-name MyPort --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of an ExpressRoute port. (autogenerated)
    text: az network express-route port show --name MyExpressRoutePort --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update an inbound NAT rule. (autogenerated)
    ...
    crafted: true
  - name: Update an inbound NAT rule. (autogenerated)
    text: az network lb inbound-nat-rule update --lb-name MyLb --name MyNatRule --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup
    crafted: true
"""
...
examples:
  - name: Update an outbound-rule. (autogenerated)
    ...
    crafted: true
  - name: Update an outbound-rule. (autogenerated)
    text: az network lb outbound-rule update --frontend-ip-configs myfrontendoutbound --lb-name MyLb --name MyOutboundRule --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a private endpoint. (autogenerated)
    text: az network private-endpoint delete --name MyPrivateEndpoint --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of a private endpoint (autogenerated)
    text: az network private-endpoint show --name MyPrivateEndpoint --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a private link service endpoint connection. (autogenerated)
    text: az network private-link-service connection delete --name MyPrivateEndpointConnection --resource-group MyResourceGroup --service-name MyService
    crafted: true
"""
...
examples:
  - name: Get the details of a private link service. (autogenerated)
    text: az network private-link-service show --name MyPrivateLinkService --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a public IP prefix resource. (autogenerated)
    text: az network public-ip prefix update --name MyPublicIPPrefix --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  - name: Create a service endpoint policy. (autogenerated)
    text: az network service-endpoint policy create --name MyServiceEndpointPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a service endpoint policy definition. (autogenerated)
    text: az network service-endpoint policy-definition update --add communities='12076:5010' --name MyServiceEndpointPolicyDefinition --policy-name MyPolicy --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Delete a traffic manager profile. (autogenerated)
    text: az network traffic-manager profile delete --name MyTmProfile --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Create a virtual network. (autogenerated)
    text: az network vnet create --address-prefixes 10.0.0.0/16 --name MyVirtualNetwork --resource-group MyResourceGroup --subnet-name MyAseSubnet --subnet-prefixes 10.0.0.0/24
    crafted: true
"""
...
examples:
  - name: Update a virtual network. (autogenerated)
    text: az network vnet update --address-prefixes 40.1.0.0/24 --name MyVNet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a revoked certificate. (autogenerated)
    text: az network vnet-gateway revoked-cert delete --gateway-name MyVnetGateway --name MyRootCertificate --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update a virtual network gateway. (autogenerated)
    text: az network vnet-gateway update --address-prefixes 40.1.0.0/24 --client-protocol IkeV2 --name MyVnetGateway --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of the virtual network gateway is met. (autogenerated)
    text: az network vnet-gateway wait --name MyVnetGateway --resource-group MyResourceGroup --updated
    crafted: true
"""
...
examples:
  - name: List connection monitors for the given region. (autogenerated)
    text: az network watcher connection-monitor list --location westus --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Show a resource policy remediation. (autogenerated)
    text: az policy remediation show --management-group myMg --name MyRemediation
    crafted: true
"""
...
examples:
  - name: Create a virtual network link to the specified Private DNS zone. (autogenerated)
    text: az network private-dns link vnet create --name MyLinkName --registration-enabled true --resource-group MyResourceGroup --subscription MySubscription --tags CostCenter=Marketing --virtual-network MyVirtualNetworkId --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update a virtual network link's properties. Does not modify virtual network within the link. (autogenerated)
    text: az network private-dns link vnet update --name MyLinkName --registration-enabled true --resource-group MyResourceGroup --tags CostCenter=Marketing --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create a read replica for a server. (autogenerated)
    text: |
        az mysql server replica create --name testreplsvr --resource-group testgroup --source-server "/subscriptions/${SubID}/resourceGroups/${ResourceGroup}/providers/Microsoft.DBforMySQL/servers/testsvr2" --subscription MySubscription
    crafted: true
"""

aladdin_helps['mysql server replica stop'] = """
type: command
short-summary: Stop replication to a read replica and make it a read/write server.
examples:
  - name: Stop replication to a read replica and make it a read/write server. (autogenerated)
    text: az mysql server replica stop --name testreplsvr --resource-group testgroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['postgres server vnet-rule update'] = """
type: command
short-summary: Update a virtual network rule.
examples:
  - name: Update a virtual network rule. (autogenerated)
    text: az postgres server vnet-rule update --name MyVnetRule --resource-group MyResourceGroup --server-name MyServer --subnet subnetName
    crafted: true
"""
...
aladdin_helps['relay wcfrelay list'] = """
type: command
short-summary: List the WCF Relay by Relay Service Namepsace
examples:
  - name: List the WCF Relay by Relay Service Namepsace (autogenerated)
    text: az relay wcfrelay list --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""



aladdin_helps['deployment export'] = """
type: command
...
aladdin_helps['deployment validate'] = """
type: command
...
examples:
  - name: Place the CLI in a waiting state until a deployment condition is met. (autogenerated)
    text: az deployment wait --deleted --name MyDeployment --subscription MySubscription
    crafted: true
"""

aladdin_helps['feature list'] = """
type: command
...
examples:
  - name: Show a policy assignment's managed identity. (autogenerated)
    text: az policy assignment identity show --name MyPolicyAssignment
    crafted: true
"""
...
examples:
  - name: Delete a policy set definition. (autogenerated)
    text: az policy set-definition delete --management-group myMg --name MyPolicySetDefinition
    crafted: true
"""
...
aladdin_helps['policy set-definition update'] = """
type: command
...
examples:
  ...
  - name: Place the CLI in a waiting state until a condition of a resources is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a resources is met. (autogenerated)
    text: az resource wait --exists --name MyResource --resource-group MyResourceGroup --resource-type subnets
    crafted: true
"""
...
aladdin_helps['servicebus namespace authorization-rule delete'] = """
type: command
short-summary: Deletes the Authorization Rule of the Service Bus Namespace.
examples:
  - name: Deletes the Authorization Rule of the Service Bus Namespace. (autogenerated)
    text: az servicebus namespace authorization-rule delete --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['servicebus topic authorization-rule delete'] = """
type: command
short-summary: Deletes the Authorization Rule of the given Service Bus Topic.
examples:
  - name: Deletes the Authorization Rule of the given Service Bus Topic. (autogenerated)
    text: az servicebus topic authorization-rule delete --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription --topic-name mytopic
    crafted: true
"""

aladdin_helps['servicebus topic authorization-rule show'] = """
type: command
short-summary: Shows the details of Authorization Rule for given Service Bus Topic
examples:
  - name: Shows the details of Authorization Rule for given Service Bus Topic (autogenerated)
    text: az servicebus topic authorization-rule show --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  - name: Create a data warehouse. (autogenerated)
    text: az sql dw create --collation Latin1_General_100_CS_AS_SC --name MyDataWarehouse --resource-group MyResourceGroup --server myserver --service-objective S0
    crafted: true
"""
...
aladdin_helps['sql instance-failover-group set-primary'] = """
type: command
...
examples:
  - name: Set the primary of the instance failover group by failing over all databases from the current primary managed instance. (autogenerated)
    text: az sql instance-failover-group set-primary --location westus2 --name MyInstanceFailoverGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a managed instance. (autogenerated)
    text: az sql mi create --admin-password mypassword --admin-user myusername --assign-identity --capacity 8 --edition GeneralPurpose --family Gen4 --license-type LicenseIncluded --location mylocation --name myinstance --resource-group mygroup --storage 32GB --subnet /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/{VNETName}/subnets/{SubnetName} --vnet-name MyVnet
    crafted: true
"""
...
aladdin_helps['sql server ad-admin update'] = """
type: command
...
examples:
  - name: Get the legal hold properties of a container. (autogenerated)
    text: az storage container legal-hold show --account-name MyAccount --container-name MyContainer --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List all CORS rules for a storage account. (autogenerated)
    text: az storage cors list --account-name MyAccount
    crafted: true
"""
...
examples:
  - name: List directories in a share. (autogenerated)
    text: az storage directory list --account-name MyAccount --share-name MyShare
    crafted: true
"""
...
examples:
  - name: Insert an entity into a table. (autogenerated)
    text: az storage entity insert --connection-string $connectionString --entity PartitionKey=AAA RowKey=BBB Content=ASDF2 --if-exists fail --table-name MyTable
    crafted: true
"""
...
examples:
  - name: Delete files from an Azure Storage File Share. (autogenerated)
    ...
    crafted: true
  - name: Delete files from an Azure Storage File Share. (autogenerated)
    text: az storage file delete-batch --account-key 00000000 --account-name MyAccount --pattern *.py --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Download files from an Azure Storage File Share to a local directory in a batch operation. (autogenerated)
    ...
    crafted: true
  - name: Download files from an Azure Storage File Share to a local directory in a batch operation. (autogenerated)
    text: az storage file download-batch --destination . --pattern *.py --source /path/to/file
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file. (autogenerated)
    ...
    crafted: true
  - name: Check for the existence of a file. (autogenerated)
    text: az storage file exists --connection-string $connectionString --path path/file.txt --share-name MyShare
    crafted: true
"""
...
type: command
examples:
  - name: Generates a shared access signature for the file. (autogenerated)
    text: az storage file generate-sas --account-name MyStorageAccount --expiry 2037-12-31T23:59:00Z --path path/file.txt --permissions rcdw --share-name MyShare --start 2019-01-01T12:20Z
    crafted: true
"""
...
examples:
  - name: Show logging settings for a storage account. (autogenerated)
    text: az storage logging show --account-name MyAccount --services qt
    crafted: true
"""
...
examples:
  - name: Creates a new share under the specified account. (autogenerated)
    text: az storage share create --account-name MyAccount --name MyFileShare
    crafted: true
"""
...
examples:
  - name: Check for the existence of a file share. (autogenerated)
    ...
    crafted: true
  - name: Check for the existence of a file share (autogenerated)
    text: az storage share exists --connection-string $connectionString --name MyFileShare
    crafted: true
"""
...
examples:
  - name: Create a URI to access a file share. (autogenerated)
    ...
    crafted: true
  - name: Create a URI to access a file share. (autogenerated)
    text: az storage share url --connection-string $connectionString --name MyFileShare
    crafted: true
"""
...
examples:
  - name: Revoke a resource's read access to a managed disk. (autogenerated)
    ...
    crafted: true
  - name: Revoke a resource's read access to a managed disk. (autogenerated)
    text: az disk revoke-access --name MyManagedDisk --resource-group MyResourceGroup
    crafted: true
"""
...
aladdin_helps['image template show'] = """
type: command
short-summary: Show an image builder template.
examples:
  - name: Show an image builder template (autogenerated)
    text: az image template show --name mytemplate --resource-group my-group
    crafted: true
"""
...
examples:
  - name: Get a proximity placement group (commonly used with --output). (autogenerated)
    text: az ppg show --name MyProximityPlacementGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a snapshot. (autogenerated)
    text: az snapshot update --name MySnapshot --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a snapshot is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a snapshot is met. (autogenerated)
    text: az snapshot wait --created --name MySnapshot --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['vm boot-diagnostics disable'] = """
type: command
...
examples:
  ...
  - name: Place the CLI in a waiting state until a condition of a virtual machine extension is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a virtual machine extension is met. (autogenerated)
    text: az vm extension wait --ids @- --name MyExtension --subscription MySubscription --updated --vm-name MyVm
    crafted: true
"""
...
examples:
  - name: Create a dedicated host group. (autogenerated)
    text: az vm host group create --name MyDedicatedHostGroup --platform-fault-domain-count 2 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Get the details of a dedicated host group (autogenerated)
    text: az vm host group show --name MyDedicatedHostGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List dedicated hosts. (autogenerated)
    text: az vm host list --host-group my-host-group --resource-group my-rg
    crafted: true
"""
...
examples:
  - name: Get the details of a dedicated host (autogenerated)
    text: az vm host show --host-group my-host-group --name MyDedicatedHost --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Cancel Azure Marketplace image terms. (autogenerated)
    text: az vm image terms cancel --subscription MySubscription --urn publisher:offer:sku:version
    crafted: true
"""
...
examples:
  - name: Deallocate VMs within a VMSS. (autogenerated)
    text: az vmss deallocate --instance-ids 1 --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Enable managed service identity on a VMSS. (autogenerated)
    text: az vmss identity assign --identities readerId writerId --name MyVmss --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Restart VMs within a VMSS. (autogenerated)
    text: az vmss restart --instance-ids 1 --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Start VMs within a VMSS. (autogenerated)
    text: az vmss start --instance-ids 1 --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Power off (stop) VMs within a VMSS. (autogenerated)
    text: az vmss stop --instance-ids 1 --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""

aladdin_helps['vmss update'] = """
type: command
