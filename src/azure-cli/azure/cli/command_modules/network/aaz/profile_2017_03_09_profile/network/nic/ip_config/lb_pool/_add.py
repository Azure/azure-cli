...
class Add(AAZCommand):
    ...
    _aaz_info = {
        "version": "2015-06-15",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/networkinterfaces/{}", "2015-06-15", "properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[]"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "Parameters.properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[]"
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            _builder.set_prop("id", AAZStrType, ".pool_id")
