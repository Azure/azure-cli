...
@register_command(
    "network private-link-service list-auto-approved",
)
class ListAutoApproved(AAZCommand):
    ...
    :example: List all of the private link service that can be linked to a Private Endpoint with auto approved
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.PrivateLinkServicesListAutoApprovedPrivateLinkServicesByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.PrivateLinkServicesListAutoApprovedPrivateLinkServices(ctx=self.ctx)()
    ...
    class PrivateLinkServicesListAutoApprovedPrivateLinkServicesByResourceGroup(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _element.private_link_service = AAZStrType(
                serialized_name="privateLinkService",
            )

            return cls._schema_on_200

    class PrivateLinkServicesListAutoApprovedPrivateLinkServices(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
class _ListAutoApprovedHelper:
    """Helper class for ListAutoApproved"""


__all__ = ["ListAutoApproved"]
