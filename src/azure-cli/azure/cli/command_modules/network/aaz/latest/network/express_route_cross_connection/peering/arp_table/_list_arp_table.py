...
@register_command(
    "network express-route-cross-connection peering arp-table list-arp-table",
)
class ListArpTable(AAZCommand):
...
class _ListArpTableHelper:
    """Helper class for ListArpTable"""


__all__ = ["ListArpTable"]
