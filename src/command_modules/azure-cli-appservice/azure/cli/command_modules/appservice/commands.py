...
cli_command(__name__, 'functionapp config hostname delete', 'azure.cli.command_modules.appservice.custom#delete_hostname')
cli_command(__name__, 'functionapp config hostname get-external-ip', 'azure.cli.command_modules.appservice.custom#get_external_ip')
cli_command(__name__, 'functionapp config ssl upload', 'azure.cli.command_modules.appservice.custom#upload_ssl_cert', exception_handler=ex_handler_factory())
cli_command(__name__, 'functionapp config ssl list', 'azure.cli.command_modules.appservice.custom#list_ssl_certs')
cli_command(__name__, 'functionapp config ssl bind', 'azure.cli.command_modules.appservice.custom#bind_ssl_cert', exception_handler=ex_handler_factory())
cli_command(__name__, 'functionapp config ssl unbind', 'azure.cli.command_modules.appservice.custom#unbind_ssl_cert')
cli_command(__name__, 'functionapp config ssl delete', 'azure.cli.command_modules.appservice.custom#delete_ssl_cert')
cli_command(__name__, 'functionapp deployment source config-local-git', 'azure.cli.command_modules.appservice.custom#enable_local_git')
cli_command(__name__, 'functionapp deployment source config', 'azure.cli.command_modules.appservice.custom#config_source_control', exception_handler=ex_handler_factory())
cli_command(__name__, 'functionapp deployment source sync', 'azure.cli.command_modules.appservice.custom#sync_site_repo')
cli_command(__name__, 'functionapp deployment source show', 'azure.cli.command_modules.appservice.custom#show_source_control', exception_handler=empty_on_404)
cli_command(__name__, 'functionapp deployment source delete', 'azure.cli.command_modules.appservice.custom#delete_source_control')
cli_command(__name__, 'functionapp deployment source update-token', 'azure.cli.command_modules.appservice.custom#update_git_token', exception_handler=ex_handler_factory())
cli_command(__name__, 'functionapp deployment user set', 'azure.cli.command_modules.appservice.custom#set_deployment_user')
