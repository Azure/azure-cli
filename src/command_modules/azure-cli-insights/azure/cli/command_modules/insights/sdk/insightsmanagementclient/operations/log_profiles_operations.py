...
class LogProfilesOperations(object):
    ...
    def get(
        ...
        :rtype: :class:`LogProfileResource
         <azure.insights.models.LogProfileResource>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :type parameters: :class:`LogProfileCreateOrUpdateParameters
         <azure.insights.models.LogProfileCreateOrUpdateParameters>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'LogProfileCreateOrUpdateParameters')
    ...
    def list(
        ...
        :rtype: :class:`LogProfileResourcePaged
         <azure.insights.models.LogProfileResourcePaged>`
        """
