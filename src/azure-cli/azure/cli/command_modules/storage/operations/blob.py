...
def set_blob_service_properties(client, parameters, delete_retention=None, delete_retention_period=None,
    ...
    if 'static_website' in parameters:
    ...
    client.set_service_properties(timeout=timeout, **kwargs)
    return client.get_service_properties(timeout=timeout)
