...
type: group
short-summary: Manage a static web app's managed service identity
"""

helps['staticwebapp identity assign'] = """
type: command
short-summary: assign managed service identity to the static web app
examples:
  - name: assign local identity and assign a reader role to the current resource group.
    text: >
...
type: command
short-summary: Disable static web app's managed service identity
examples:
...
type: command
short-summary: display static web app's managed service identity
examples:
  - name: display static web app's managed service identity (autogenerated)
