...
class ListEnvironment(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AccessListEnvironments(ctx=self.ctx)()
    ...
    class AccessListEnvironments(AAZHttpOperation):
...
class _ListEnvironmentHelper:
    """Helper class for ListEnvironment"""


__all__ = ["ListEnvironment"]
