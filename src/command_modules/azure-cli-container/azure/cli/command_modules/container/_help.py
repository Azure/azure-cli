...
-   "name": |-
    ...
    "text": |-
        az container restart --name MyContainerGroup --resource-group MyResourceGroup
    "crafted": |-
        True
-   "name": |-
...
-   "name": |-
    ...
    "text": |-
        az container create -g MyResourceGroup --name myapp --image myimage:latest --assign-identity  /subscriptions/mySubscrpitionId/resourcegroups/myRG/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myID
-   "name": |-
        Create a container group with both system and user assigned identity.
    "text": |-
        az container create -g MyResourceGroup --name myapp --image myimage:latest --assign-identity [system] /subscriptions/mySubscrpitionId/resourcegroups/myRG/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myID
    "min_profile": |-
        latest
-   "name": |-
        Create a container group.
