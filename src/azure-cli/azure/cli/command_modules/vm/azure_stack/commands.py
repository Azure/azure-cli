...
from azure.cli.command_modules.vm.azure_stack._client_factory import (cf_vm, cf_avail_set, cf_ni,
...
def load_command_table(self, _):
    ...
    custom_tmpl = 'azure.cli.command_modules.vm.azure_stack.custom#{}'

    compute_custom = CliCommandType(operations_tmpl=custom_tmpl)

    compute_disk_encryption_custom = CliCommandType(
        operations_tmpl='azure.cli.command_modules.vm.azure_stack.disk_encryption#{}',
        operation_group='virtual_machines'
    )

    image_builder_custom = CliCommandType(
        operations_tmpl='azure.cli.command_modules.vm.azure_stack._image_builder#{}',
