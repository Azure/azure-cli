...
class Create(AAZCommand):
    ...
    _aaz_info = {
        "version": "2024-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}", "2024-09-01"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.encryption_type = AAZStrArg(
            ...
            arg_group="Properties",
            help="Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.",
            default="Single",
            nullable=True,
            enum={"Double": "Double", "Single": "Single"},
        )
