...
def load_arguments(self, _):
    ...
    with self.argument_context('containerapp env', arg_group='Dapr') as c:
        ...
        c.argument('connection_string', options_list=['--dapr-connection-string', '-d'], help='Application Insights connection string used by Dapr to export Service to Service communication telemetry.')
