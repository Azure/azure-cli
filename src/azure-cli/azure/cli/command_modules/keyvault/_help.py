...
examples:
  ...
  - name: Download the public portion of a Key Vault certificate. (autogenerated)
    text: az keyvault certificate download --file cert.crt --name cert-name --vault-name vault
    crafted: true
"""
...
examples:
  ...
  - name: Import a certificate into KeyVault. (autogenerated)
    text: az keyvault certificate import --file cert_file --name cert_name --vault-name vaultname
    crafted: true
"""
...
examples:
  - name: Delete a key vault. (autogenerated)
    ...
    crafted: true
  - name: Delete a key vault. (autogenerated)
    text: az keyvault delete --name MyKeyVault
    crafted: true
"""
