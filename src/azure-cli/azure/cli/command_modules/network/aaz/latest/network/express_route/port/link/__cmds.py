...
class Show(AAZCommand):
    ...
    :example: Get the details of an ExpressRoute link.
...
@register_command(
    "network express-route port link wait",
)
...
@link_helper(
    __package__,
    ("_build_schema_express_route_port_read", _Helper),
)
class _ListHelper:
...
__all__ = ["List","Show","Update","Wait","__CMDGroup"]
