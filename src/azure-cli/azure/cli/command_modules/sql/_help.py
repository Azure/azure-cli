...
examples:
  - name: Get the details for a database. (autogenerated)
    text: az sql db show --name MyAzureSQLDatabase --resource-group MyResourceGroup --server myserver --keys "https://xxxxxx.vault.azure.net/keys/xxxxxx/6638b3667e384aefa31364f94d230361" --keys-to-remove "https://xxxxx.vault.azure.net/keys/xxxxx/648a7ffbade6466ebf2abc1e33d9513f"
    crafted: true
"""
