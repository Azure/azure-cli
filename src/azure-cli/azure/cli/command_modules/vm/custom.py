...
def create_managed_disk(cmd, resource_group_name, disk_name, location=None,  # pylint: disable=too-many-locals, too-many-branches, too-many-statements
    ...
    if security_type or secure_vm_disk_encryption_set:
        disk.security_profile = {'securityType': security_type, 'secure_vm_disk_encryption_set_id': secure_vm_disk_encryption_set}
