...
DEPENDENCIES = [
    ...
    'azure-mgmt-cognitiveservices==15.0.0b6',  # 15.0.0b6 version supports adapter-deployment operations which is in PrPr, pls don't remove it without consulting our team
    ...
    'azure-mgmt-recoveryservicesbackup~=11.0.0',
