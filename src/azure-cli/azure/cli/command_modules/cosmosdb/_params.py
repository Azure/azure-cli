...
def load_arguments(self, _):
    ...
    from azure.mgmt.cosmosdb.models import KeyKind, DefaultConsistencyLevel, DatabaseAccountKind, TriggerType, TriggerOperation, ServerVersion, NetworkAclBypass, AnalyticalStorageSchemaType
    ...
    for scope in ['cosmosdb create', 'cosmosdb update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('analytical_storage_schema_type', arg_type=get_enum_type(AnalyticalStorageSchemaType), help="Schema type for analytical storage.", arg_group='Analytical Storage Configuration')
