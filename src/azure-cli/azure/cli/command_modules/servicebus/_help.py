...
examples:
  ...
  - name: shows properties of Service Bus Geo-Disaster Recovery Configuration Alias for Primay/Secondary Namespace (autogenerated)
    text: |
        az servicebus georecovery-alias show --alias myaliasname --namespace-name primarynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Deletes the Authorization Rule of the Service Bus Namespace. (autogenerated)
    text: |
        az servicebus namespace authorization-rule delete --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Deletes the Authorization Rule of the given Service Bus Topic. (autogenerated)
    text: |
        az servicebus topic authorization-rule delete --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription --topic-name mytopic
    crafted: true
"""
...
examples:
  ...
  - name: Shows the details of Authorization Rule for given Service Bus Topic (autogenerated)
    text: |
        az servicebus topic authorization-rule show --name myauthorule --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription --topic-name mytopic
    crafted: true
"""
