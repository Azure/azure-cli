...
examples:
  ...
  - name: Create a frontend IP address. (autogenerated)
    text: az network application-gateway frontend-ip create --gateway-name MyAppGateway --name MyFrontendIp --private-ip-address 10.10.10.50 --resource-group MyResourceGroup --subnet MySubnet
    crafted: true
"""
...
examples:
  - name: Create a rewrite rule set. (autogenerated)
    text: az network application-gateway rewrite-rule set create --gateway-name MyGateway --name MyRewriteRuleSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy. (autogenerated)
    text: az network application-gateway waf-policy create --name MyApplicationGatewayWAFPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy rule create --action Allow --name MyWAFPolicyRule --policy-name MyPolicy --priority 500 --resource-group MyResourceGroup --rule-type MatchRule
    crafted: true
"""
...
examples:
  ...
  - name: Create an application security group. (autogenerated)
    text: az network asg create --location westus2 --name MyAsg --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create an empty CNAME record set. (autogenerated)
    text: az network dns record-set cname create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create an empty MX record set. (autogenerated)
    text: az network dns record-set mx create --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  ...
  - name: Create a route filter. (autogenerated)
    text: az network route-filter create --location westus2 --name MyRouteFilter --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Create a VPN connection. (autogenerated)
    ...
    crafted: true
  - name: Create a VPN connection. (autogenerated)
    text: az network vpn-connection create --local-gateway2 MyLocalGateway --location westus2 --name MyConnection --resource-group MyResourceGroup --shared-key Abc123 --vnet-gateway1 MyVnetGateway
    crafted: true
"""
...
examples:
  ...
  - name: Create a connection monitor. (autogenerated)
    text: az network watcher connection-monitor create --dest-port 80 --dest-resource MyVmName2 --name MyConnectionMonitorName --resource-group MyResourceGroup --source-resource MyVM
    crafted: true
"""
