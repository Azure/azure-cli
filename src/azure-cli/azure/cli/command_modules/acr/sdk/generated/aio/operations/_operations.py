...
class CacheRulesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    async def get(self, resource_group_name: str, registry_name: str, cache_rule_name: str, **kwargs: Any) -> JSON:
...
class CredentialSetsOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, credential_set_name: str, **kwargs: Any) -> JSON:
...
class ExportPipelinesOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, export_pipeline_name: str, **kwargs: Any) -> JSON:
...
class RegistriesOperations:
    ...
    @distributed_trace_async
    async def check_name_availability(self, registry_name_check_request: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Checks whether the container registry name is available for use. The name must contain only
        alphanumeric characters, be globally unique, and between 5 and 50 characters in length.
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def list_usages(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def list_credentials(self, resource_group_name: str, registry_name: str, **kwargs: Any) -> JSON:
...
class ImportPipelinesOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, import_pipeline_name: str, **kwargs: Any) -> JSON:
...
class PipelineRunsOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, pipeline_run_name: str, **kwargs: Any) -> JSON:
...
class ReplicationsOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, replication_name: str, **kwargs: Any) -> JSON:
...
class ScopeMapsOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, scope_map_name: str, **kwargs: Any) -> JSON:
...
class TokensOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, token_name: str, **kwargs: Any) -> JSON:
...
class WebhooksOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, registry_name: str, webhook_name: str, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def ping(self, resource_group_name: str, registry_name: str, webhook_name: str, **kwargs: Any) -> JSON:
