...
@register_command(
    "network vnet-gateway vpn-client ipsec-policy show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get the VPN client connection ipsec policy per P2S client connection of the virtual network gateway.

    :example: Get the VPN client connection ipsec policy per P2S client connection of the virtual network gateway.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualNetworkGatewaysGetVpnclientIpsecParameters(ctx=self.ctx)()
    ...
    class VirtualNetworkGatewaysGetVpnclientIpsecParameters(AAZHttpOperation):
