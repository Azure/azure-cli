...
examples:
  ...
  - name: Shows an auto provisioning setting. (autogenerated)
    text: |
...
examples:
  ...
  - name: Deletes a security contact. (autogenerated)
    text: |
        az security contact delete --name "default1" --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Shows the Azure Security Center Pricing tier for the subscription. (autogenerated)
    text: az security pricing show --name default
    crafted: true
"""
...
examples:
  ...
  - name: Shows a security setting. (autogenerated)
    text: |
        az security setting show --name "MCAS"
    crafted: true
"""
...
examples:
  ...
  - name: Shows the workspace settings in your subscription - these settings let you control which workspace will hold your security data (autogenerated)
    text: az security workspace-setting show --name default
    crafted: true
"""
