...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_application_security_group_create(asgs.Element)
        ...
        _element = cls._args_schema.manual_private_link_service_connections.Element
        ...
        _element.private_link_service_id = AAZStrArg(
            options=["private-link-service-id"],
        )
        _element.request_message = AAZStrArg(
            options=["request-message"],
        )

        group_ids = cls._args_schema.manual_private_link_service_connections.Element.group_ids
        group_ids.Element = AAZStrArg()

        private_link_service_connection_state = cls._args_schema.manual_private_link_service_connections.Element.private_link_service_connection_state
    ...
    class PrivateEndpointsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if manual_private_link_service_connections is not None:
                manual_private_link_service_connections.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".properties.manualPrivateLinkServiceConnections[]")
            if _elements is not None:
                _elements.set_prop("id", AAZStrType, ".id")
                _elements.set_prop("name", AAZStrType, ".name")
                _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

            properties = _builder.get(".properties.manualPrivateLinkServiceConnections[].properties")
            if properties is not None:
            ...
            group_ids = _builder.get(".properties.manualPrivateLinkServiceConnections[].properties.groupIds")
            if group_ids is not None:
                group_ids.set_elements(AAZStrType, ".")

            private_link_service_connection_state = _builder.get(".properties.manualPrivateLinkServiceConnections[].properties.privateLinkServiceConnectionState")
