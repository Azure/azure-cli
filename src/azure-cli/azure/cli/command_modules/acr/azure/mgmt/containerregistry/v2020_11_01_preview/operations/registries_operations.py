...
class RegistriesOperations(object):
    ...
    def import_image(
        ...
        :type parameters: ~containerregistry.models.ImportImageParameters
    ...
    def create(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~containerregistry.models.Registry]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_private_link_resources(
        ...
        :rtype:
         ~containerregistry.models.PrivateLinkResourcePaged[~containerregistry.models.PrivateLinkResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def generate_credentials(
        ...
        :type generate_credentials_parameters:
         ~containerregistry.models.GenerateCredentialsParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~containerregistry.models.GenerateCredentialsResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~containerregistry.models.GenerateCredentialsResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
