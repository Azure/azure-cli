...
@register_command(
    "network application-gateway client-cert add",
)
class Add(AAZCommand):
    """Add trusted client certificate of the application gateway.

    :example: Add trusted client certificate of the application gateway.
        az network application-gateway client-cert add --gateway-name MyAppGateway -g MyResourceGroup --name MyCert --data FilePath
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "Parameters.properties.trustedClientCertificates[]"

        # define Arg Group "Properties"

        _args_schema = cls._args_schema
        _args_schema.cert_data = AAZStrArg(
            options=["--cert-data"],
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                properties.set_prop("data", AAZStrType, ".cert_data")
