...
TARGET_RESOURCES_DEPRECATED = [RESOURCE.Mysql, RESOURCE.Postgres, RESOURCE.NeonPostgres]

# The target resources to be blocked (deprecated and no longer functional)
TARGET_RESOURCES_BLOCKED = [RESOURCE.NeonPostgres]
