...
@register_command(
    "search service shared-private-link-resource list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SharedPrivateLinkResourcesListByService(ctx=self.ctx)()
    ...
    class SharedPrivateLinkResourcesListByService(AAZHttpOperation):
