...
class AKSContextTestCase(unittest.TestCase):
    ...
    def test_get_nodepool_taints(self):
        # default
        ctx_1 = AKSContext(
            self.cmd,
        ...
        self.assertEqual(ctx_1.get_nodepool_taints(), None)
        agent_pool_profile = self.models.ManagedClusterAgentPoolProfile(
            name="test_nodepool_name",
        ...
        ctx_1.attach_mc(mc)
        self.assertEqual(
            ctx_1.get_nodepool_taints(), ["taint1=value1:NoSchedule", "taint2=value2:NoSchedule"]
        )
