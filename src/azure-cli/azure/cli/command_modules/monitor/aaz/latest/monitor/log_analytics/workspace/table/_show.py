...
class Show(AAZCommand):
    ...
    class TablesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ShowHelper._build_schema_restored_logs_read(properties.restored_logs)
            ...
            _ShowHelper._build_schema_search_results_read(properties.search_results)
            ...
            _ShowHelper._build_schema_restored_logs_read(schema.restored_logs)
            schema.search_results = AAZObjectType(
                serialized_name="searchResults",
            )
            _ShowHelper._build_schema_search_results_read(schema.search_results)
            ...
            _ShowHelper._build_schema_column_read(columns.Element)
            ...
            _ShowHelper._build_schema_column_read(standard_columns.Element)
