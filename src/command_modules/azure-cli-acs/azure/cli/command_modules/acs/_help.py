...
helps['aks install-connector'] = """
    ...
    examples:
        ...
        - name: Install the ACI-Connector for Windows to an AKS Cluster.
          text: az aks install-connector --name MyManagedCluster --resource-group MyResourceGroup --connector_name MyConnector --os-type Windows
        ...
        - name: Install the ACI-Connector from a specific custom chart.
          text: az aks install-connector --name MyManagedCluster --resource-group MyResourceGroup --connector_name MyConnector --chart_url <CustomURL>
"""
helps['aks remove-connector'] = """
    ...
    examples:
        - name: Undeploy the ACI-Connector on an AKS cluster.
          text: az aks remove-connector --name MyManagedCluster --resource-group MyResourceGroup --connector_name MyConnector
        - name: Undeploy the ACI-Connector on an AKS cluster using the graceful mode
          text: az aks remove-connector --name MyManagedCluster --resource-group MyResourceGroup --connector_name MyConnector --graceful
"""
