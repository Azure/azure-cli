...
@register_command(
    "network asg address-prefix-set wait",
    is_preview=True,
)
class Wait(AAZWaitCommand):
    """Place the CLI in a waiting state until an address prefix set condition is met."""
    ...
    def _output(self, *args, **kwargs):
        return self.deserialize_output(self.ctx.vars.instance, client_flatten=False)
