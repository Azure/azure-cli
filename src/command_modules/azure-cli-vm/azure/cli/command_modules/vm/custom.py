...
def create_vm(cmd, vm_name, resource_group_name, image=None, size='Standard_DS1_v2', location=None, tags=None,
    ...
    if nic_type == 'new':
        ...
        if nsg_type == 'new':
            ...
            master_template.add_resource(build_nsg_resource(cmd, nsg, location, tags, nsg_rule_type, bool(application_security_groups)))  # pylint: disable=line-too-long
    ...
    if load_balancer_type == 'new':
        ...
        if load_balancer_sku and load_balancer_sku.lower() == 'standard' and nsg is None:
            ...
            master_template.add_resource(build_nsg_resource(
                None, nsg_name, location, tags, 'rdp' if os_type.lower() == 'windows' else 'ssh', bool(application_security_groups)))  # pylint: disable=line-too-long
