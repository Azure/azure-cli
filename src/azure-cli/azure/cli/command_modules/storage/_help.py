...
examples:
  ...
  - name: Upload a file to a storage blob. (autogenerated)
    text: |
        az storage blob upload --account-name MyAccount --container-name MyContainer --file /path/to/file --name MyBlob
    crafted: true
"""
...
examples:
  - name: List all CORS rules for a storage account. (autogenerated)
    text: |
        az storage cors list --account-key 00000000 --account-name MyAccount
    crafted: true
"""
