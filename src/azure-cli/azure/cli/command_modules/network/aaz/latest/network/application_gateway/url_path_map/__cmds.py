...
@register_command(
    "network application-gateway url-path-map delete",
)
class Delete(AAZCommand):
    """Delete a URL path map.

    :example: Delete a URL path map.
...
@register_command(
    "network application-gateway url-path-map list",
)
class List(AAZCommand):
    """List URL path maps.

    :example: List URL path maps.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.urlPathMaps

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.urlPathMaps = value
            return
...
class Update(AAZCommand):
    ...
    :example: Update a URL path map to use new default HTTP settings.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.default_address_pool = AAZStrArg(
            options=["--default-address-pool"],
            help="Name or ID of the default backend address pool.",
            nullable=True,
        )
        _args_schema.default_http_settings = AAZStrArg(
            options=["--default-http-settings"],
            help="Name or ID of the default HTTP settings.",
            nullable=True,
        )
        _args_schema.default_redirect_config = AAZStrArg(
            options=["--default-redirect-config"],
...
@register_command(
    "network application-gateway url-path-map wait",
)
