...
def load_command_table(self, _):
    ...
    with self.command_group('cosmosdb', cosmosdb_sdk, client_factory=cf_db_accounts) as g:
        ...
        g.command('list-keys', 'list_keys',
                  deprecate_info=g.deprecate(redirect='cosmosdb keys list', hide=True))
        g.command('list-read-only-keys', 'list_read_only_keys', deprecate_info=g.deprecate(
            redirect='cosmosdb keys list --type read-only-keys', hide=True))
        g.command('list-connection-strings', 'list_connection_strings', table_transformer=list_connection_strings_output,
                  deprecate_info=g.deprecate(redirect='cosmosdb keys list --type connection-strings', hide=True))
        g.custom_command('regenerate-key', 'cli_cosmosdb_regenerate_key',
                         deprecate_info=g.deprecate(redirect='cosmosdb keys regenerate', hide=True))
    ...
    with self.command_group('cosmosdb private-link-resource',
        ...
        g.show_command('list', 'list_by_database_account',
    ...
    with self.command_group('cosmosdb sql stored-procedure', cosmosdb_sql_sdk, client_factory=cf_sql_resources) as g:
        g.custom_command(
            'create', 'cli_cosmosdb_sql_stored_procedure_create_update')
        g.custom_command(
            'update', 'cli_cosmosdb_sql_stored_procedure_create_update')
        g.command('list', 'list_sql_stored_procedures')
        g.show_command('show', 'get_sql_stored_procedure')
        g.command('delete', 'begin_delete_sql_stored_procedure',
                  confirmation=True)
    ...
    with self.command_group('cosmosdb sql user-defined-function', cosmosdb_sql_sdk, client_factory=cf_sql_resources) as g:
        ...
        g.command('delete', 'begin_delete_sql_user_defined_function',
                  confirmation=True)
    ...
    with self.command_group('cosmosdb mongodb collection', cosmosdb_mongo_sdk, client_factory=cf_mongo_db_resources) as g:
        ...
        g.command('delete', 'begin_delete_mongo_db_collection',
                  confirmation=True)
    ...
    with self.command_group('cosmosdb cassandra keyspace', cosmosdb_cassandra_sdk, client_factory=cf_cassandra_resources) as g:
        ...
        g.command('delete', 'begin_delete_cassandra_keyspace',
                  confirmation=True)
    ...
    with self.command_group('cosmosdb sql database throughput', cosmosdb_sql_sdk, client_factory=cf_sql_resources) as g:
        ...
        g.custom_command(
            'migrate', 'cli_cosmosdb_sql_database_throughput_migrate')
        g.custom_command(
            'update', 'cli_cosmosdb_sql_database_throughput_update')
    ...
    with self.command_group('cosmosdb sql container throughput', cosmosdb_sql_sdk, client_factory=cf_sql_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_sql_container_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_sql_container_throughput_migrate')
    ...
    with self.command_group('cosmosdb mongodb database throughput', cosmosdb_mongo_sdk, client_factory=cf_mongo_db_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_mongodb_database_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_mongodb_database_throughput_migrate')
    ...
    with self.command_group('cosmosdb mongodb collection throughput', cosmosdb_mongo_sdk, client_factory=cf_mongo_db_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_mongodb_collection_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_mongodb_collection_throughput_migrate')
    ...
    with self.command_group('cosmosdb cassandra keyspace throughput', cosmosdb_cassandra_sdk, client_factory=cf_cassandra_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_cassandra_keyspace_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_cassandra_keyspace_throughput_migrate')
    ...
    with self.command_group('cosmosdb cassandra table throughput', cosmosdb_cassandra_sdk, client_factory=cf_cassandra_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_cassandra_table_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_cassandra_table_throughput_migrate')
    ...
    with self.command_group('cosmosdb gremlin database throughput', cosmosdb_gremlin_sdk, client_factory=cf_gremlin_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_gremlin_database_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_gremlin_database_throughput_migrate')
    ...
    with self.command_group('cosmosdb gremlin graph throughput', cosmosdb_gremlin_sdk, client_factory=cf_gremlin_resources) as g:
        ...
        g.custom_command(
            'update', 'cli_cosmosdb_gremlin_graph_throughput_update')
        g.custom_command(
            'migrate', 'cli_cosmosdb_gremlin_graph_throughput_migrate')
    ...
    with self.command_group('cosmosdb keys', cosmosdb_sdk, client_factory=cf_db_accounts) as g:
        g.custom_command('list', 'cli_cosmosdb_keys',
    ...
    with self.command_group('cosmosdb database', deprecate_info=self.deprecate(redirect=DATABASE_DEPRECATION_INFO, hide=True)) as g:
        ...
        g.cosmosdb_custom('create', 'cli_cosmosdb_database_create',
                          table_transformer=database_output)
        g.cosmosdb_custom(
            'delete', 'cli_cosmosdb_database_delete', confirmation=True)
    ...
    with self.command_group('cosmosdb collection', deprecate_info=self.deprecate(redirect=COLLECTION_DEPRECATON_INFO, hide=True)) as g:
        ...
        g.cosmosdb_custom('create', 'cli_cosmosdb_collection_create',
                          table_transformer=collection_output)
        g.cosmosdb_custom(
            'delete', 'cli_cosmosdb_collection_delete', confirmation=True)
    ...
    with self.command_group('cosmosdb sql role definition', cosmosdb_sql_sdk, client_factory=cf_sql_resources) as g:
        g.custom_command(
            'create', 'cli_cosmosdb_sql_role_definition_create', supports_no_wait=True)
        g.custom_command(
            'update', 'cli_cosmosdb_sql_role_definition_update', supports_no_wait=True)
        ...
        g.command('delete', 'begin_delete_sql_role_definition',
    ...
    with self.command_group('cosmosdb sql role assignment', cosmosdb_sql_sdk, client_factory=cf_sql_resources) as g:
        g.custom_command(
            'create', 'cli_cosmosdb_sql_role_assignment_create', supports_no_wait=True)
        g.custom_command(
            'update', 'cli_cosmosdb_sql_role_assignment_update', supports_no_wait=True)
        ...
        g.command('delete', 'begin_delete_sql_role_assignment',
                  confirmation=True, supports_no_wait=True)
