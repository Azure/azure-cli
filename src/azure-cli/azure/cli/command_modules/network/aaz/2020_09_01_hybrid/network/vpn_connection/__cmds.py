...
class List(AAZCommand):
    ...
    class VirtualNetworkGatewayConnectionsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_ipsec_policy_read(ipsec_policies.Element)
...
@link_helper(
    ...
    ("_build_schema_ipsec_policy_read", _Helper),
...
__all__ = ["Delete","List","ListConnection","Show","ShowDeviceConfigScript","Update","Wait","__CMDGroup"]
