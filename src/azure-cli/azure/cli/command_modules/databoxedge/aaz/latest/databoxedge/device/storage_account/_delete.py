...
@register_command(
    "databoxedge device storage-account delete",
...
class Delete(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.StorageAccountsDelete(ctx=self.ctx)()
    ...
    class StorageAccountsDelete(AAZHttpOperation):
