...
examples:
  ...
  - name: Delete a domain topic under a domain. (autogenerated)
    text: az eventgrid domain topic delete --domain-name domain1 --name domaintopic1 --resource-group rg1 --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Show the details of a domain topic. (autogenerated)
...
examples:
  ...
  - name: Update a domain (autogenerated)
    text: az eventgrid domain update --name domain1 --resource-group rg1 --tags Dept=IT
    crafted: true
"""
