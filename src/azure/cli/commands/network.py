...
from ..commands._auto_command import (build_operation, LongRunningOperation,
                                      GLOBALPARAMALIASES, AutoCommandDefinition)
...
build_operation("network expressroutecircuit",
                ...
                [
                    ...
                    AutoCommandDefinition(ExpressRouteCircuitsOperations.list_routes_table, '[ExpressRouteCircuitRoutesTable]'),
...
build_operation("network nic",
                ...
                [
                    ...
                    AutoCommandDefinition(NetworkInterfacesOperations.list_virtual_machine_scale_set_vm_network_interfaces, '[NetworkInterface]'),
                    AutoCommandDefinition(NetworkInterfacesOperations.list_virtual_machine_scale_set_network_interfaces, '[NetworkInterface]'),
                    AutoCommandDefinition(NetworkInterfacesOperations.get_virtual_machine_scale_set_network_interface, 'NetworkInterface'),
