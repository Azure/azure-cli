...
examples:
  - name: Creates a tag in the subscription. (autogenerated)
    text: >
        az tag create --name MyTag
  - name: Deletes a tag from the subscription. (autogenerated)
    text: >
        az tag delete --name MyTag
  - name: Creates a tag value. (autogenerated)
    text: >
        az tag add-value --name MyTag --value {value}       
"""
