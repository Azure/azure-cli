...
examples:
  ...
  - name: Create a storage account 'mystorageaccount' in resource group 'MyResourceGroup' with account-scoped encryption key enabled for Table Service.
    text: az storage account create -n mystorageaccount -g MyResourceGroup -t Account 
"""
