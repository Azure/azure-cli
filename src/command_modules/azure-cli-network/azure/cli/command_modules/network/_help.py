...
examples:
  ...
  - name: Delete a trusted root certificate. (autogenerated)
    text: az network application-gateway root-cert delete --gateway-name MyAppGateway --name MyRootCert --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update an inbound NAT address pool. (autogenerated)
    text: az network lb inbound-nat-pool update --backend-port 8080 --frontend-port-range-end 89 --frontend-port-range-start 80 --lb-name MyLb --name MyNatPool --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Update a load balancing rule. (autogenerated)
    ...
    crafted: true
  - name: Update a load balancing rule. (autogenerated)
    text: az network lb rule update --floating-ip true --lb-name MyLb --name MyLbRule --resource-group MyResourceGroup
    crafted: true
"""
