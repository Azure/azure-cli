...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.FirstPartyServiceTagsListAll(ctx=self.ctx)()
        if condition_1:
            self.FirstPartyServiceTagsList(ctx=self.ctx)()
    ...
    class FirstPartyServiceTagsListAll(AAZHttpOperation):
    ...
    class FirstPartyServiceTagsList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
