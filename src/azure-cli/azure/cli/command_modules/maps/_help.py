...
examples:
  ...
  - name: Create a maps account. (autogenerated)
    text: |
        az maps account create --accept-tos --name MyMapsAccount --resource-group MyResourceGroup --sku S0
    crafted: true
"""
...
examples:
  - name: Show the details of a maps account. (autogenerated)
    text: |
        az maps account show --name MyMapsAccount --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
