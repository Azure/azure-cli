...
class ContentKeyPolicyPlayReadyPlayRight(Model):
    ...
    :type explicit_analog_television_output_restriction:
     ~encoding.models.ContentKeyPolicyPlayReadyExplicitAnalogTelevisionRestriction
    :param digital_video_only_content_restriction: Enables the Image
     Constraint For Analog Component Video Restriction in the license.
    :type digital_video_only_content_restriction: bool
    :param image_constraint_for_analog_component_video_restriction: Enables
    ...
    :param image_constraint_for_analog_computer_monitor_restriction: Enables
     the Image Constraint For Analog Component Video Restriction in the
     license.
    :type image_constraint_for_analog_computer_monitor_restriction: bool
    :param allow_passing_video_content_to_unknown_output: Configures Unknown
     output handling settings of the license. Possible values include:
     'Unknown', 'NotAllowed', 'Allowed', 'AllowedWithVideoConstriction'
    :type allow_passing_video_content_to_unknown_output: str or
     ~encoding.models.ContentKeyPolicyPlayReadyUnknownOutputPassingOption
    ...
    def __init__(self, digital_video_only_content_restriction, image_constraint_for_analog_component_video_restriction, image_constraint_for_analog_computer_monitor_restriction, allow_passing_video_content_to_unknown_output, first_play_expiration=None, scms_restriction=None, agc_and_color_stripe_restriction=None, explicit_analog_television_output_restriction=None, uncompressed_digital_video_opl=None, compressed_digital_video_opl=None, analog_video_opl=None, compressed_digital_audio_opl=None, uncompressed_digital_audio_opl=None):
        super(ContentKeyPolicyPlayReadyPlayRight, self).__init__()
