...
class SigImageVersionShow(_SigImageVersionShow):
    def _output(self, *args, **kwargs):
        ...
        publishing_profile = new_result.get("publishing_profile", {})
        ...
        target_extended_locations = publishing_profile.get("target_extended_locations", [])
        for target_extended_location in target_extended_locations:
            ...
            if "extendedLocationReplicaCount" in target_extended_location:
                target_extended_location["extended_location_replica_count"] = target_extended_location["extendedLocationReplicaCount"]
        ...
        target_regions = publishing_profile.get("target_regions", [])
        for target_region in target_regions:
            ...
            additional_replica_sets = target_region.get("additional_replica_sets", [])
        ...
        replication_status = new_result.get("replication_status", {})
        ...
        safety_profile = new_result.get("safety_profile", {})
        ...
        security_profile = new_result.get("security_profile", {})
        ...
        uefi_settings = security_profile.get("uefi_settings", {})
        ...
        storage_profile = new_result.get("storage_profile", {})
        ...
        data_disk_images = storage_profile.get("data_disk_images", [])
        ...
        os_disk_image = storage_profile.get("os_disk_image", {})
        ...
        source = storage_profile.get("source", {})
        ...
        validations_profile = new_result.get("validations_profile", {})
        ...
        executed_validations = validations_profile.get("executed_validations", {})
