...
class Remove(AAZCommand):
    ...
    _aaz_info = {
        "version": "2017-10-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/networkinterfaces/{}", "2017-10-01", "properties.ipConfigurations[].properties.loadBalancerBackendAddressPools[]"],
        ]
    }
