...
## prerequisite
1. Ensure `NEXT_BREAKING_CHANGE_RELEASE` and `NEXT_BREAKING_CHANGE_DATE` in [breaking_change.py] (C:\Code\azure-cli\src\azure-cli-core\azure\cli\core\breaking_change.py) are correct before proceeding with the phase1.
