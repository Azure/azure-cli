...
class InstallUpdate(AAZCommand):
    """Installs the updates on the Data Box Edge/Data Box Gateway device.

    :example: Install the updates on the Data Box Edge/Data Box Gateway device.
        az databoxedge device install-update --device-name testedgedevice --resource-group GroupForEdgeAutomation
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.DevicesInstallUpdates(ctx=self.ctx)()
    ...
    class DevicesInstallUpdates(AAZHttpOperation):
...
class _InstallUpdateHelper:
    """Helper class for InstallUpdate"""


__all__ = ["InstallUpdate"]
