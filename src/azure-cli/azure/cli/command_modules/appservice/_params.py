...
def load_arguments(self, _):
    ...
    with self.argument_context('webapp create') as c:
        ...
        c.argument('docker_registry_server_password', options_list=['--docker-registry-server-password'], help='The container registry server password. Required for private registries.')
