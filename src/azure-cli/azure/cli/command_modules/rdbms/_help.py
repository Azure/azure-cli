...
examples:
  - name: Delete a firewall rule. (autogenerated)
    text: |
        az mysql server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer
    crafted: true
"""
...
examples:
  - name: Get the details of a firewall rule. (autogenerated)
    text: |
        az mysql server firewall-rule show --name MyFirewallRule --resource-group MyResourceGroup --server-name MyServer
    crafted: true
"""
...
examples:
  ...
  - name: Stop replication to a read replica and make it a read/write server. (autogenerated)
    text: |
        az mysql server replica stop --name testreplsvr --resource-group testgroup --subscription MySubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a server. (autogenerated)
    text: |
        az mysql server update --name testsvrnew --resource-group testgroup --ssl-enforcement Enabled
    crafted: true
"""
...
examples:
  ...
  - name: Update a server. (autogenerated)
    text: |
        az postgres server update --name testsvrnew --resource-group testgroup --ssl-enforcement Enabled
    crafted: true
"""
...
examples:
  - name: Update a virtual network rule. (autogenerated)
    text: |
        az postgres server vnet-rule update --name MyVnetRule --resource-group MyResourceGroup --server-name MyServer --subnet subnetName
    crafted: true
"""
