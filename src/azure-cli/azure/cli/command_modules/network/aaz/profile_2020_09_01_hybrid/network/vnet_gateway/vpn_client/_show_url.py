...
class ShowUrl(AAZCommand):
    """Retrieve a pre-generated VPN client configuration.

    :example: Get the pre-generated point-to-site VPN client of the virtual network gateway.
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VirtualNetworkGatewaysGetVpnProfilePackageUrl(ctx=self.ctx)()
...
class _ShowUrlHelper:
    """Helper class for ShowUrl"""
