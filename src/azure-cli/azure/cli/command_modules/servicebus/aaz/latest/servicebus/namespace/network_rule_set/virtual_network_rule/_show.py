...
@register_command(
    "servicebus namespace network-rule-set virtual-network-rule show",
)
class Show(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.servicebus/namespaces/{}/networkrulesets/default", "2022-10-01-preview", "properties.virtualNetworkRules[]"],
        ]
    }
