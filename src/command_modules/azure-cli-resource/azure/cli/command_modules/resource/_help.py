...
examples:
  - name: List preview features. (autogenerated)
...
examples:
  - name: Validate whether a template is syntactically correct. (autogenerated)
    text: "az group deployment validate --parameters '{ \\\\ \"location\": { \\\\ \"value\": \"westus\" \\\\ } \\\\ }' --resource-group MyResourceGroup --template-file storage.json"
    crafted: true
"""
...
examples:
  - name: Update a resource group. (autogenerated)
    text: az group update --resource-group MyResourceGroup --set tags.CostCenter='{"Dept":"IT","Environment":"Test"}'
    crafted: true
"""
...
examples:
  - name: Update a policy set definition. (autogenerated)
    text: "az policy set-definition update --definitions '[ \\\\ { \\\\ \"policyDefinitionId\": \"/subscriptions/mySubId/providers/Microsoft.Authorization/policyDefinitions/storagePolicy\" \\\\ } \\\\ ]' --name MyPolicySetDefinition"
    crafted: true
"""
...
examples:
  ...
  - name: Invoke an action on the resource. (autogenerated)
    text: az resource invoke-action --action capture --name MyResource --resource-group MyResourceGroup --resource-type Microsoft.Network/virtualNetworks
    crafted: true
"""
