...
@register_command(
    "netappfiles account quota-limit show",
)
class Show(AAZCommand):
    """Get the default, current and usages account quota limit

    :example: QuotaLimits
        az netappfiles account quota-limit show --resource-group myRG --account-name myAccount --quota-limit-name poolsPerAccount
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetAppResourceQuotaLimitsAccountGet(ctx=self.ctx)()
    ...
    class NetAppResourceQuotaLimitsAccountGet(AAZHttpOperation):
