...
examples:
  ...
  - name: Cancel a deployment at subscription scope. (autogenerated)
    text: |
        az deployment sub cancel --name deployment01 --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Cancel a deployment at resource group. (autogenerated)
    text: |
        az deployment group cancel --name deployment01 --resource-group testrg --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Validate whether a template is valid at tenant scope. (autogenerated)
    text: |
        az deployment tenant validate --location WestUS --name mydeployment --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Export the template used for a deployment. (autogenerated)
    text: |
        az group deployment export --name MyDeployment --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
