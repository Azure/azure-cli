...
class Add(AAZCommand):
    ...
    :example: Add specified IPsec policies to a gateway instead of relying on defaults.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.dh_group = AAZStrArg(
            ...
            help="The DH Group used in initial SA.",
            required=True,
        ...
        _args_schema.pfs_group = AAZStrArg(
            options=["--pfs-group"],
            arg_group="IKE Phase 2",
            help="The Pfs Group used for new child SA.",
            required=True,
...
class List(AAZCommand):
    ...
    :example: List the IPsec policies set on a gateway.
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            result = self.ctx.vars.instance
            return result.properties.vpnClientConfiguration.vpnClientIpsecPolicies

        def _set(self, value):
            result = self.ctx.vars.instance
            result.properties.vpnClientConfiguration.vpnClientIpsecPolicies = value
            return
    ...
    class VirtualNetworkGatewaysGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _ListHelper._build_schema_virtual_network_gateway_read(cls._schema_on_200)
...
@link_helper(
    ...
    ("_build_schema_virtual_network_gateway_read", _Helper),
)
class _AddHelper:
