...
class _UpdateHelper:
    ...
    def _build_schema_network_interface_ip_configuration_update(cls, _builder):
        ...
        if properties is not None:
            ...
            cls._build_schema_sub_resource_update(properties.set_prop("outboundNatRule", AAZObjectType, ".outbound_nat_rule"))
            properties.set_prop("provisioningState", AAZStrType, ".provisioning_state")
        ...
        if properties is not None:
            cls._build_schema_network_interface_ip_configuration_update(properties.set_prop("backendIPConfiguration", AAZObjectType, ".backend_ip_configuration"))
