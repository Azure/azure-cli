...
from azure.cli.core.commands.parameters import enum_choice_list, location_type, name_type, resource_group_name_type
...
register_cli_argument('container', 'name', name_type)
...
register_cli_argument('container create', 'image_registry_login_server', help='The container image registry login server')
register_cli_argument('container create', 'image_registry_username', help='The username to log in container image registry server')
register_cli_argument('container create', 'image_registry_password', help='The password to log in container image registry server')
