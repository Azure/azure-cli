...
class Health(AAZCommand):
    ...
    class ApplicationGatewaysBackendHealth(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_application_gateway_backend_address_pool_read(_element.backend_address_pool)
            ...
            _build_schema_network_interface_ip_configuration_read(_element.ip_configuration)
