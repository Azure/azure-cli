...
examples:
  ...
  - name: Delete a domain. (autogenerated)
    text: |
        az eventgrid domain delete --ids /subscriptions/{SubID}/resourceGroups/{RG}/providers/Microsoft.EventGrid/domains/domain1
    crafted: true
"""
...
examples:
  ...
  - name: Update a domain. (autogenerated)
    text: |
        az eventgrid domain update --ids /subscriptions/{SubID}/resourceGroups/{RG}/providers/Microsoft.EventGrid/domains/domain1
    crafted: true
"""
...
examples:
  ...
  - name: Delete a topic. (autogenerated)
    text: |
        az eventgrid topic delete --ids /subscriptions/{SubID}/resourceGroups/{RG}/providers/Microsoft.EventGrid/topics/topic1
    crafted: true
"""
