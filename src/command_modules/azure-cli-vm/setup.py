...
setup(
    ...
    packages=[
        ...
        'azure.cli.command_modules.vm.mgmt_vmss_create',
        'azure.cli.command_modules.vm.mgmt_vmss_create.lib',
        'azure.cli.command_modules.vm.mgmt_vmss_create.lib.models',
        'azure.cli.command_modules.vm.mgmt_vmss_create.lib.operations',
