...
@register_command(
    "search service private-endpoint-connection list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.PrivateEndpointConnectionsListByService(ctx=self.ctx)()
    ...
    class PrivateEndpointConnectionsListByService(AAZHttpOperation):
