...
class ExportMetadataSchema(AAZCommand):
    ...
    :example: Export effective metadata schema
        az apic service export-metadata-schema -g contoso-resources -s contoso
    """

    _aaz_info = {
        "version": "2023-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.apicenter/services/{}/exportmetadataschema", "2023-07-01-preview"],
        ]
    }
