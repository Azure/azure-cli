...
examples:
  - name: Disable Kubernetes addons. (autogenerated)
    text: az aks disable-addons --addons http_application_routing --name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Enable Kubernetes addons. (autogenerated)
    text: az aks enable-addons --addons monitoring --name MyManagedCluster --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Scale the node pool in a managed Kubernetes cluster. (autogenerated)
    text: az aks scale --name MyManagedCluster --node-count 1 --resource-group MyResourceGroup
    crafted: true
"""
