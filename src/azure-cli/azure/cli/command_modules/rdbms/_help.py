...
examples:
  ...
  - name: List the databases for a server. (autogenerated)
    text: az mariadb db list --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Show the details of a database. (autogenerated)
    text: az mariadb db show --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Update a firewall rule. (autogenerated)
    text: az mariadb server firewall-rule update --end-ip-address 107.46.14.218 --name allowiprange --resource-group testgroup --server-name testsvr --start-ip-address 107.46.14.1
    crafted: true
"""
...
examples:
  ...
  - name: Delete a database. (autogenerated)
    text: az mysql db delete --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Show the details of a database. (autogenerated)
    text: az mysql db show --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Update a firewall rule. (autogenerated)
    text: az mysql server firewall-rule update --end-ip-address 107.46.14.218 --name allowiprange --resource-group testgroup --server-name testsvr --start-ip-address 107.46.14.1
    crafted: true
"""
...
examples:
  ...
  - name: List all read replicas for a given server. (autogenerated)
    text: az mysql server replica list --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Stop replication to a read replica and make it a read/write server. (autogenerated)
    text: az mysql server replica stop --name testreplsvr --resource-group testgroup
    crafted: true
"""
...
examples:
  ...
  - name: Download log files. (autogenerated)
    text: az mysql server-logs download --name f1.log f2.log --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Delete a database. (autogenerated)
    text: az postgres db delete --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Show the details of a database. (autogenerated)
    text: az postgres db show --name testdb --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Update a firewall rule. (autogenerated)
    text: az postgres server firewall-rule update --end-ip-address 107.46.14.218 --name allowiprange --resource-group testgroup --server-name testsvr --start-ip-address 107.46.14.1
    crafted: true
"""
...
examples:
  ...
  - name: List all read replicas for a given server. (autogenerated)
    text: az postgres server replica list --resource-group testgroup --server-name testsvr
    crafted: true
"""
...
examples:
  ...
  - name: Stop replication to a read replica and make it a read/write server. (autogenerated)
    text: az postgres server replica stop --name testreplsvr --resource-group testgroup
    crafted: true
"""
