...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.hsm = AAZObjectArg(
            options=["--hsm"],
            arg_group="Properties",
            help="Managed HSM properties of the Application Gateway resource.",
        )

        hsm = cls._args_schema.hsm
        hsm.key_id = AAZStrArg(
            options=["key-id"],
            help="Key identifier of a key stored in Managed HSM.",
        )
        hsm.public_cert_data = AAZStrArg(
            options=["public-cert-data"],
            help="Base-64 encoded value of a base-64 public certificate.",
        )
        return cls._args_schema
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("hsm", AAZObjectType, ".hsm")
            ...
            if hsm is not None:
                hsm.set_prop("keyId", AAZStrType, ".key_id")
                hsm.set_prop("publicCertData", AAZStrType, ".public_cert_data")
...
class _CreateHelper:
    ...
    def _build_schema_application_gateway_read(cls, _schema):
        ...
        cls._build_schema_common_managed_service_identity_read(application_gateway_read.identity)
        ...
        cls._build_schema_common_sub_resource_read(properties.firewall_policy)
        ...
        cls._build_schema_common_application_gateway_backend_address_pool_read(backend_address_pools.Element)
        ...
        authentication_certificates.Element = AAZObjectType()
        cls._build_schema_common_sub_resource_read(authentication_certificates.Element)
        ...
        cls._build_schema_common_sub_resource_read(trusted_root_certificates.Element)
        ...
        cls._build_schema_common_sub_resource_read(properties.public_ip_address)
        ...
        cls._build_schema_common_application_gateway_ip_configuration_read(gateway_ip_configurations.Element)
        ...
        cls._build_schema_common_sub_resource_read(properties.frontend_port)
        properties.host_name = AAZStrType(
            serialized_name="hostName",
        )
        ...
        cls._build_schema_common_sub_resource_read(properties.ssl_certificate)
        properties.ssl_profile = AAZObjectType(
            serialized_name="sslProfile",
        )
        cls._build_schema_common_sub_resource_read(properties.ssl_profile)
        ...
        cls._build_schema_common_sub_resource_read(properties.target_listener)
        ...
        cls._build_schema_common_sub_resource_read(path_rules.Element)
        ...
        cls._build_schema_common_sub_resource_read(request_routing_rules.Element)
        ...
        cls._build_schema_common_sub_resource_read(url_path_maps.Element)
        ...
        cls._build_schema_common_sub_resource_read(properties.backend_http_settings)
        properties.entra_jwt_validation_config = AAZObjectType(
            serialized_name="entraJWTValidationConfig",
        )
        cls._build_schema_common_sub_resource_read(properties.entra_jwt_validation_config)
        properties.http_listener = AAZObjectType(
            serialized_name="httpListener",
        )
        cls._build_schema_common_sub_resource_read(properties.http_listener)
        properties.load_distribution_policy = AAZObjectType(
            serialized_name="loadDistributionPolicy",
        )
        cls._build_schema_common_sub_resource_read(properties.load_distribution_policy)
        ...
        cls._build_schema_common_sub_resource_read(properties.redirect_configuration)
        ...
        cls._build_schema_common_sub_resource_read(properties.url_path_map)
        ...
        cls._build_schema_common_sub_resource_read(properties.backend_settings)
        properties.listener = AAZObjectType()
        cls._build_schema_common_sub_resource_read(properties.listener)
        properties.priority = AAZIntType(
            flags={"required": True},
        )
        properties.provisioning_state = AAZStrType(
        ...
        cls._build_schema_common_sub_resource_read(properties.default_backend_address_pool)
        ...
        cls._build_schema_common_sub_resource_read(properties.default_load_distribution_policy)
        ...
        cls._build_schema_common_sub_resource_read(properties.default_rewrite_rule_set)
        properties.path_rules = AAZListType(
            serialized_name="pathRules",
        )
        properties.provisioning_state = AAZStrType(
