...
@register_command(
    "eventhubs namespace network-rule-set update",
)
class Update(AAZCommand):
    """Update NetworkRuleSet for a Namespace.

    :example: NameSpaceNetworkRuleSetCreate
        az eventhubs namespace network-rule-set update --resource-group ResourceGroup --namespace-name sdk-Namespace-6019
    """
