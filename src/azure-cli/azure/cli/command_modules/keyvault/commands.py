...
def load_command_table(self, _):
    ...
    if not is_azure_stack_profile(self):
        with self.command_group('keyvault key', data_key_entity.command_type) as g:
            ...
            g.keyvault_command('rotation-policy show', 'get_key_rotation_policy', is_preview=True)
            g.keyvault_custom('rotation-policy update', 'update_key_rotation_policy', is_preview=True)
