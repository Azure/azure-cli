...
@register_command(
    "network application-gateway frontend-port show",
)
class Show(AAZCommand):
    """Get the details of a frontend port.

    :example: Get the details of a frontend port.
...
@register_command(
    "network application-gateway frontend-port update",
)
class Update(AAZCommand):
    """Update a frontend port.

    :example: Update a frontend port to use a different port.
...
@register_command(
    "network application-gateway frontend-port wait",
)
