...
class Create(AAZCommand):
    ...
    :example: Create a private endpoint with ip-configs.
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.asgs = AAZListArg(
            ...
            help={"short-summary": "The private endpoint application security groups.", "long-summary": "Usage: --asg id=MyApplicationSecurityGroupId\nMultiple application security groups can be specified by using more than one `--asg` argument."},
        )
        ...
        _args_schema = cls._args_schema
        _args_schema.manual_private_link_service_connections = AAZListArg(
        ...
        _args_schema.ip_configs = AAZListArg(
            ...
            help={"short-summary": "The private endpoint ip configurations.", "long-summary": "Usage: --ip-config name=MyIPConfig group-id=MyGroup member-name=MyMember private-ip-address=MyPrivateIPAddress\nMultiple ip configurations can be specified by using more than one `--ip-config` argument."},
        )
    ...
    class PrivateEndpointsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_prop("customNetworkInterfaceName", AAZStrType, ".nic_name")
...
@register_command(
    "network private-endpoint list-types",
)
class ListTypes(AAZCommand):
    """Returns all of the resource types that can be linked to a Private Endpoint in this subscription in this region.

    :example: List all of the resource types
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.AvailablePrivateEndpointTypesListByResourceGroup(ctx=self.ctx)()
        if condition_1:
            self.AvailablePrivateEndpointTypesList(ctx=self.ctx)()
        self.post_operations()
    ...
    class AvailablePrivateEndpointTypesListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
    ...
    class AvailablePrivateEndpointTypesList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
__all__ = ["Create","Delete","List","ListTypes","Show","Update","Wait","__CMDGroup"]
