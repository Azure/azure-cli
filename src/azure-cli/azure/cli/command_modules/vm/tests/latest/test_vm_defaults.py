...
class TestVMCreateDefaultVnet(unittest.TestCase):
    ...
    @mock.patch('azure.cli.command_modules.vm.aaz.latest.network.vnet.List', _mock_network_client_with_existing_vnet)
    ...
    @mock.patch('azure.cli.command_modules.vm.aaz.latest.network.vnet.List', _mock_network_client_with_existing_vnet_location)
...
class TestVMSSCreateDefaultVnet(unittest.TestCase):
    ...
    @mock.patch('azure.cli.command_modules.vm.aaz.latest.network.vnet.List', _mock_network_client_with_existing_subnet)
