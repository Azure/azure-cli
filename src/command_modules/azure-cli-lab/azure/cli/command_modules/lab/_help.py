...
-   "name": |-
    ...
    "text": |-
        az lab vm delete --name MyVirtualMachine --lab-name MyLab --resource-group MyResourceGroup
    "crafted": |-
        True
"""
...
-   "name": |-
        --size
    "short-summary": |-
        The size of the VM to be created. See https://azure.microsoft.com/en-us/pricing/details/virtual-machines/ for size info.
-   "name": |-
        --admin-username
    "short-summary": |-
...
-   "name": |-
        Create a VM in a lab.
    "text": |-
        az lab vm create --size Standard_DS1_v2 --image-type gallery --image "Ubuntu Server 16.04 LTS" --name {VMName} --resource-group {ResourceGroup} --lab-name {LabName} --admin-password <admin-password>
    "crafted": |-
        True
"""
...
-   "name": |-
        List the VMs in an Azure DevTest Lab.
    "text": |-
        az lab vm list --all  --lab-name MyLab --resource-group MyResourceGroup
    "crafted": |-
        True
"""
