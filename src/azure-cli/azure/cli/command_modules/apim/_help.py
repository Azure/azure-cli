...
examples:
  - name: Place the CLI in a waiting state until a condition of a apim is met. (autogenerated)
    text: |
        az apim product wait --created --resource-group MyResourceGroup \
             --service-name MyServiceName --product-id MyProductID \
             --product-name MyProductName --description MyDescription \
             --legal-terms MyTerms --subscription-required true \
             --approval-required true --subscriptions-limit 8 --state "published"
    crafted: true
"""
