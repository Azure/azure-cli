...
@register_command(
    "netappfiles volume replication resume",
)
class Resume(AAZCommand):
    ...
    :example: Resume the replication process
    ...
    _aaz_info = {
        "version": "2025-09-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.netapp/netappaccounts/{}/capacitypools/{}/volumes/{}/resyncreplication", "2025-09-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.VolumesResyncReplication(ctx=self.ctx)()
    ...
    class VolumesResyncReplication(AAZHttpOperation):
