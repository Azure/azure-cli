...
class AdalAuthentication(Authentication):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, token_retriever, external_tenant_token_retriever=None):
        ...
        self.external_tenant_token_retriever = external_tenant_token_retriever
    ...
    def signed_session(self, session=None):
        ...
        try:
            ...
            if self.external_tenant_token_retriever:
                external_tenant_tokens = self.external_tenant_token_retriever()
        ...
        if external_tenant_tokens:
            session.headers['x-ms-authorization-auxiliary'] = ';'.join(['{} {}'.format(scheme2, tokens2)
                                                         for scheme2, tokens2, _ in external_tenant_tokens])
        return session
