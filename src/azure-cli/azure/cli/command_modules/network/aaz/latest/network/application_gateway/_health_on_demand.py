...
class HealthOnDemand(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema = cls._args_schema
        _args_schema.address_pool = AAZResourceIdArg(
            options=["--address-pool"],
            arg_group="Probe Operation",
            help="Name or ID of the backend address pool.",
            is_preview=True,
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{subscription}/resourceGroups/{resource_group}/providers/Microsoft.Network/applicationGateways/{name}/backendAddressPools/{}",
            ),
        )
        _args_schema.http_settings = AAZResourceIdArg(
            options=["--http-settings"],
            arg_group="Probe Operation",
            help="Name or ID of the HTTP settings.",
            is_preview=True,
            fmt=AAZResourceIdArgFormat(
                template="/subscriptions/{subscription}/resourceGroups/{resource_group}/providers/Microsoft.Network/applicationGateways/{name}/backendHttpSettingsCollection/{}",
            ),
        )
    ...
    class ApplicationGatewaysBackendHealthOnDemand(AAZHttpOperation):
        ...
        def content(self):
            ...
            _builder.set_prop("backendAddressPool", AAZObjectType)
            _builder.set_prop("backendHttpSettings", AAZObjectType)
            ...
            backend_address_pool = _builder.get(".backendAddressPool")
            if backend_address_pool is not None:
                backend_address_pool.set_prop("id", AAZStrType, ".address_pool")

            backend_http_settings = _builder.get(".backendHttpSettings")
        ...
        def _build_schema_on_200(cls):
            ...
            _build_schema_application_gateway_backend_address_pool_read(_schema_on_200.backend_address_pool)
