...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.PrivateLinkServicesList(ctx=self.ctx)()
        if condition_1:
            self.PrivateLinkServicesListBySubscription(ctx=self.ctx)()
        self.post_operations()
    ...
    class PrivateLinkServicesList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
        ...
        def _build_schema_on_200(cls):
            ...
            _ListHelper._build_schema_private_link_service_read(value.Element)

            return cls._schema_on_200

    class PrivateLinkServicesListBySubscription(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
...
@register_command(
    "network private-link-service wait",
)
class Wait(AAZWaitCommand):
    ...
    class PrivateLinkServicesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            cls._schema_on_200 = AAZObjectType()
            _WaitHelper._build_schema_private_link_service_read(cls._schema_on_200)
...
@link_helper(
    ...
    ("_build_schema_private_link_service_read", _Helper),
