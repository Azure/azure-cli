...
from azure.cli.command_modules.network.aaz.latest.network.watcher.connection_monitor.endpoint._show import Show as _WatcherConnectionMonitorEndpointShow
