...
class AutoscaleSettingCreateOrUpdateParameters(Model):
    """
    Parameters supplied to the Create or Update autoscale setting operation.

    :param location: Gets or sets the location of the setting.
    :type location: str
    ...
    def __init__(self, location=None, tags=None, profiles=None, notifications=None, enabled=None, name=None, target_resource_uri=None):
