...
class List(AAZCommand):
    ...
    class VirtualNetworksList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            allowed_subnets = cls._schema_on_200.value.Element.properties.allowed_subnets
            allowed_subnets.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.allowed_subnets.Element
            ...
            external_subnets = cls._schema_on_200.value.Element.properties.external_subnets
            external_subnets.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.external_subnets.Element
            _element.id = AAZStrType()
            _element.name = AAZStrType()

            subnet_overrides = cls._schema_on_200.value.Element.properties.subnet_overrides
            subnet_overrides.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.subnet_overrides.Element
            _element.lab_subnet_name = AAZStrType(
                serialized_name="labSubnetName",
            )
            _element.resource_id = AAZStrType(
            ...
            shared_public_ip_address_configuration = cls._schema_on_200.value.Element.properties.subnet_overrides.Element.shared_public_ip_address_configuration
            shared_public_ip_address_configuration.allowed_ports = AAZListType(
                serialized_name="allowedPorts",
            )

            allowed_ports = cls._schema_on_200.value.Element.properties.subnet_overrides.Element.shared_public_ip_address_configuration.allowed_ports
            allowed_ports.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.subnet_overrides.Element.shared_public_ip_address_configuration.allowed_ports.Element
