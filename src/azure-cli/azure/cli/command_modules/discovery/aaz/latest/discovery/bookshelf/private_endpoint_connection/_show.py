...
@register_command(
    "discovery bookshelf private-endpoint-connection show",
)
class Show(AAZCommand):
    """Get the specified private endpoint connection associated with the bookshelf.
    """

    _aaz_info = {
        "version": "2026-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.discovery/bookshelves/{}/privateendpointconnections/{}", "2026-06-01"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BookshelfPrivateEndpointConnectionsGet(ctx=self.ctx)()
    ...
    class BookshelfPrivateEndpointConnectionsGet(AAZHttpOperation):
