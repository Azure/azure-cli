...
class List(AAZCommand):
    """List all virtual network appliances in a subscription.

    :example: List all virtual network appliances
        az network virtual-network-appliance list
    """

    _aaz_info = {
        "version": "2025-05-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.network/virtualnetworkappliances", "2025-05-01"],
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.VirtualNetworkAppliancesListAll(ctx=self.ctx)()
        if condition_1:
            self.VirtualNetworkAppliancesList(ctx=self.ctx)()
    ...
    class VirtualNetworkAppliancesListAll(AAZHttpOperation):
    ...
    class VirtualNetworkAppliancesList(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
