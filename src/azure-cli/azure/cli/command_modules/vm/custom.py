...
def get_hyper_v_generation_from_vmss_by_aaz(cli_ctx, image_ref, location):  # pylint: disable=too-many-return-statements
    ...
    if image_ref.get("id", None) is not None:
        if is_valid_image_version_id(image_ref["id"]):
            ...
            command_args = {
                'gallery_image_definition': image_info[3],
                'gallery_name': image_info[2],
                'resource_group': image_info[1],
                'subscription': image_info[0]
            }
            gallery_image_info = SigImageDefinitionShow(cli_ctx=cli_ctx)(command_args=command_args)
            return gallery_image_info.get('hyperVGeneration')
        if is_valid_vm_image_id(image_ref["id"]):
            ...
            image_info = ImageShow(cli_ctx=cli_ctx)(command_args=command_args)
    ...
    if image_ref.get("sharedGalleryImageId", None) is not None:
        ...
        gallery_image_info = SigImageDefinitionShowShared(cli_ctx=cli_ctx)(command_args=command_args)
        return gallery_image_info.get('hyperVGeneration')
    ...
    if image_ref.get("communityGalleryImageId", None) is not None:
        ...
        gallery_image_info = SigImageDefinitionShowCommunity(cli_ctx=cli_ctx)(command_args=command_args)
        return gallery_image_info.get('hyperVGeneration')
    ...
    if image_ref.get("offer", None) is not None and image_ref.get("publisher", None) is not None \
        ...
        if version.lower() == 'latest':
            ...
            version = _get_latest_image_version_by_aaz(cli_ctx, location, image_ref["publisher"], image_ref["offer"],
                                                       image_ref["sku"])
        command_args = {
            'location': location,
        ...
        vm_image_info = VmImageShow(cli_ctx=cli_ctx)(command_args=command_args)
        return vm_image_info.get('hyperVGeneration')
...
def create_vm(cmd, vm_name, resource_group_name, image=None, size='Standard_D2s_v5', location=None, tags=None,
              ...
              scheduled_events_api_version=None, zone_placement_policy=None, include_zones=None, exclude_zones=None,
    ...
    vm_resource = build_vm_resource(
        ...
        enable_all_instance_down=enable_all_instance_down, scheduled_events_api_version=scheduled_events_api_version,
...
def update_vm(cmd, resource_group_name, vm_name, os_disk=None, disk_caching=None,
              ...
              enable_all_instance_down=None, scheduled_events_api_version=None, align_regional_disks_to_vm_zone=None,
    ...
    if additional_scheduled_events is not None or enable_user_reboot_scheduled_events is not None or \
            enable_user_redeploy_scheduled_events is not None or enable_all_instance_down is not None or \
            scheduled_events_api_version is not None:
        ...
        scheduled_events_policy = vm["scheduled_events_policy"]
        if additional_scheduled_events is not None or scheduled_events_api_version is not None:
            if scheduled_events_policy.get("scheduled_events_additional_publishing_targets", None) is None:
                scheduled_events_policy["scheduled_events_additional_publishing_targets"] = {}
            scheduled_events_additional_publishing_targets = scheduled_events_policy[
                "scheduled_events_additional_publishing_targets"]
            if scheduled_events_additional_publishing_targets.get("event_grid_and_resource_graph", None) is None:
                scheduled_events_additional_publishing_targets["event_grid_and_resource_graph"] = {}
            event_grid_and_resource_graph = scheduled_events_additional_publishing_targets[
                "event_grid_and_resource_graph"]
...
def create_av_set(cmd, availability_set_name, resource_group_name, platform_fault_domain_count=2,
                  ...
                  enable_user_reboot_scheduled_events=None, enable_user_redeploy_scheduled_events=None,
                  enable_all_instance_down=None, scheduled_events_api_version=None):
...
def create_vmss(cmd, vmss_name, resource_group_name, image=None,
                ...
                additional_scheduled_events=None, enable_user_reboot_scheduled_events=None,
                enable_user_redeploy_scheduled_events=None, enable_all_instance_down=None,
                scheduled_events_api_version=None, skuprofile_vmsizes=None, skuprofile_allostrat=None, skuprofile_rank=None,
...
def update_vmss(cmd, resource_group_name, name, license_type=None, no_wait=False, instance_id=None,
                ...
                enable_user_reboot_scheduled_events=None, enable_user_redeploy_scheduled_events=None,
                enable_all_instance_down=None, scheduled_events_api_version=None, upgrade_policy_mode=None,
                enable_auto_os_upgrade=None, skuprofile_vmsizes=None, skuprofile_allostrat=None, skuprofile_rank=None,
    ...
    if additional_scheduled_events is not None or enable_user_reboot_scheduled_events is not None or \
        ...
        scheduled_events_policy = vmss["scheduled_events_policy"]
        if additional_scheduled_events is not None or scheduled_events_api_version is not None:
            if scheduled_events_policy.get("scheduled_events_additional_publishing_targets", None) is None:
                scheduled_events_policy["scheduled_events_additional_publishing_targets"] = {}
            scheduled_events_additional_publishing_targets = scheduled_events_policy[
        ...
        if enable_user_redeploy_scheduled_events is not None:
            if scheduled_events_policy.get("user_initiated_redeploy", None) is None:
                scheduled_events_policy["user_initiated_redeploy"] = {}
            scheduled_events_policy["user_initiated_redeploy"]["automatically_approve"] = \
                enable_user_redeploy_scheduled_events

        if enable_user_reboot_scheduled_events is not None:
            if scheduled_events_policy.get("user_initiated_reboot", None) is None:
                scheduled_events_policy["user_initiated_reboot"] = {}
            scheduled_events_policy["user_initiated_reboot"]["automatically_approve"] = \
