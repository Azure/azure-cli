...
@register_command(
    "monitor tenant-action-group list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TenantActionGroupsListByManagementGroupId(ctx=self.ctx)()
    ...
    class TenantActionGroupsListByManagementGroupId(AAZHttpOperation):
