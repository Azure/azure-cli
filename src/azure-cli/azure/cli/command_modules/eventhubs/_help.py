...
helps['eventhubs namespace network-rule-set ip-rule list'] = """
type: command
...
examples:
  - name: Show list of ip-rule present in Network of the given Namespace
    text: az eventhubs namespace network-rule-set ip-rule list --resource-group myresourcegroup --namespace-name mynamespace
"""

helps['eventhubs namespace network-rule-set virtual-network-rule list'] = """
type: command
short-summary: Show properties of ip-rule in Network-rule of the given Namespace.
examples:
  - name: Show list of subnet present in Network of the given Namespace
    text: az eventhubs namespace network-rule-set virtual-network-rule list --resource-group myresourcegroup --namespace-name mynamespace
"""
...
examples:
  - name: remove IP rule from NetworkruleSet for a namespace
    text: az eventhubs namespace network-rule-set ip-rule remove --resource-group myresourcegroup --namespace-name mynamespace --ip-rule-index 1
"""

helps['eventhubs namespace network-rule-set ip-rule show'] = """
type: command
short-summary: Show ip-rule of network for a namespace
examples:
  - name: Show IP rule from NetworkruleSet for a namespace
    text: az eventhubs namespace network-rule-set ip-rule show --resource-group myresourcegroup --namespace-name mynamespace --ip-rule-index 1
"""

helps['eventhubs namespace network-rule-set ip-rule update'] = """
type: command
...
examples:
  - name: update the ip-rule of network for particular index
    text: az eventhubs namespace network-rule-set ip-rule update --resource-group myresourcegroup --namespace-name mynamespace --ip-rule-index 1 --ip-address 2.2.2.2
"""
...
helps['eventhubs namespace network-rule-set virtual-network-rule update'] = """
type: command
...
examples:
  - name: update the subnet-rule of network for particular index
    text: az eventhubs namespace network-rule-set virtual-network-rule update --resource-group myresourcegroup --namespace-name mynamespace --virtual-network-rule-index 0 --subnet mysubnetid --ignore-missing-endpoint True
"""
