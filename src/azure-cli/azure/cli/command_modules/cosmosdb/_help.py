...
parameters:
  ...
  -name: --minimal-tls-version
    short-summary: Indicate the minimal allowed Tls version
    long-summary: |
      Usage:    --minimal-tls-version TlsVersion
      Default:  Tls 1.0, except for Cassandra and Mongo API's, which only work with Tls 1.2
...
parameters:
  ...
  -name: --minimal-tls-version
    ...
    long-summary: |
      Usage:    --minimal-tls-version TlsVersion
      Default:  Tls, except for Cassandra and Mongo API's, which only work with Tls12
