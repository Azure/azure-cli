...
def load_command_table(self, _):
    ...
    with self.command_group('databoxedge', databoxedge_job, client_factory=cf_job, is_preview=True) as g:
    ...
    with self.command_group('databoxedge', databoxedge_node, client_factory=cf_node, is_preview=True) as g:
    ...
    with self.command_group('databoxedge', databoxedge_sku, client_factory=cf_sku, is_preview=True) as g:
