...
class Create(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-07-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{}", "2025-07-01", "properties.urlPathMaps[]"],
        ]
    }
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_common_sub_resource_update(_element.backend_address_pool)
        ...
        cls._build_args_common_sub_resource_update(_element.backend_http_settings)
        _element.firewall_policy = AAZObjectArg(
            options=["firewall-policy"],
            help="Reference to the FirewallPolicy resource.",
        )
        cls._build_args_common_sub_resource_update(_element.firewall_policy)
        ...
        cls._build_args_common_sub_resource_update(_element.load_distribution_policy)
        ...
        cls._build_args_common_sub_resource_update(_element.redirect_configuration)
        _element.rewrite_rule_set = AAZObjectArg(
            options=["rewrite-rule-set"],
            help="Rewrite rule set resource of URL path map path rule.",
        )
        cls._build_args_common_sub_resource_update(_element.rewrite_rule_set)

        paths = cls._args_schema.rules.Element.paths
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if properties is not None:
                properties.set_prop("defaultBackendAddressPool", AAZObjectType)
                properties.set_prop("defaultBackendHttpSettings", AAZObjectType)
                properties.set_prop("defaultRedirectConfiguration", AAZObjectType)
                properties.set_prop("defaultRewriteRuleSet", AAZObjectType)
                properties.set_prop("pathRules", AAZListType, ".rules")

            default_backend_address_pool = _builder.get(".properties.defaultBackendAddressPool")
            if default_backend_address_pool is not None:
                default_backend_address_pool.set_prop("id", AAZStrType, ".default_address_pool")

            default_backend_http_settings = _builder.get(".properties.defaultBackendHttpSettings")
            if default_backend_http_settings is not None:
                default_backend_http_settings.set_prop("id", AAZStrType, ".default_http_settings")

            default_redirect_configuration = _builder.get(".properties.defaultRedirectConfiguration")
            if default_redirect_configuration is not None:
                default_redirect_configuration.set_prop("id", AAZStrType, ".default_redirect_config")

            default_rewrite_rule_set = _builder.get(".properties.defaultRewriteRuleSet")
            if default_rewrite_rule_set is not None:
                default_rewrite_rule_set.set_prop("id", AAZStrType, ".default_rewrite_rule_set")

            path_rules = _builder.get(".properties.pathRules")
            if path_rules is not None:
                path_rules.set_elements(AAZObjectType, ".")

            _elements = _builder.get(".properties.pathRules[]")
            if _elements is not None:
                _elements.set_prop("id", AAZStrType, ".id")
                _elements.set_prop("name", AAZStrType, ".name")
                _elements.set_prop("properties", AAZObjectType, typ_kwargs={"flags": {"client_flatten": True}})

            properties = _builder.get(".properties.pathRules[].properties")
            if properties is not None:
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("backendAddressPool", AAZObjectType, ".backend_address_pool"))
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("backendHttpSettings", AAZObjectType, ".backend_http_settings"))
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("firewallPolicy", AAZObjectType, ".firewall_policy"))
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("loadDistributionPolicy", AAZObjectType, ".load_distribution_policy"))
                properties.set_prop("paths", AAZListType, ".paths")
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("redirectConfiguration", AAZObjectType, ".redirect_configuration"))
                _CreateHelper._build_schema_common_sub_resource_update(properties.set_prop("rewriteRuleSet", AAZObjectType, ".rewrite_rule_set"))

            paths = _builder.get(".properties.pathRules[].properties.paths")
