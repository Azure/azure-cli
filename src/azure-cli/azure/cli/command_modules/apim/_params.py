...
def load_arguments(self, _):
    ...
    with self.argument_context('apim graphql api resolver create') as c:
        ...
        c.argument('resolver_id',required=True, help='Resolver identifier within a GraphQL API. Must be unique in the current API Management service instance.')
    ...
    with self.argument_context('apim graphql api resolver policy create') as c:
        ...
        c.argument('format', help='Format of the policyContent.')
