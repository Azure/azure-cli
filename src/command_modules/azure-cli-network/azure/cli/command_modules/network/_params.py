...
register_cli_argument('network application-gateway', 'sku_name', options_list=('--sku',), arg_group='Gateway', **enum_choice_list(ApplicationGatewaySkuName))
register_cli_argument('network application-gateway', 'sku_tier', ignore_type, arg_group='Gateway')
...
register_cli_argument('network application-gateway', 'public_ip_address_allocation', arg_group='Network')
...
register_cli_argument('network application-gateway', 'http_settings_cookie_based_affinity', cookie_based_affinity_type, arg_group='Gateway')
register_cli_argument('network application-gateway', 'http_settings_protocol', http_protocol_type, arg_group='Gateway')
register_cli_argument('network application-gateway', 'subnet_address_prefix', action=MarkSpecifiedAction, arg_group='Network')
register_cli_argument('network application-gateway', 'vnet_address_prefix', action=MarkSpecifiedAction, arg_group='Network')
...
register_cli_argument('network application-gateway create', 'routing_rule_type', validator=process_ag_create_namespace, arg_group='Gateway', **enum_choice_list(ApplicationGatewayRequestRoutingRuleType))
...
register_cli_argument('network application-gateway create', 'frontend_port', arg_group='Gateway')
register_cli_argument('network application-gateway create', 'capacity', arg_group='Gateway')
register_cli_argument('network application-gateway create', 'cert_password', arg_group='Gateway')
register_cli_argument('network application-gateway create', 'http_settings_port', arg_group='Gateway')
register_cli_argument('network application-gateway create', 'http_listener_protocol', ignore_type, arg_group='Gateway')
