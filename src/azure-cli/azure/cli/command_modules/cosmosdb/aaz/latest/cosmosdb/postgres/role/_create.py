...
class Create(AAZCommand):
    ...
    :example: Create a new role for cluster
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.password = AAZPasswordArg(
            ...
            help="The password of the cluster role.",
            required=True,
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.RolesCreate(ctx=self.ctx)()
    ...
    class RolesCreate(AAZHttpOperation):
        ...
        def url_parameters(self):
            parameters = {
                ...
                **self.serialize_url_param(
                    "roleName", self.ctx.args.role_name,
                    required=True,
                ),
                **self.serialize_url_param(
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("password", AAZStrType, ".password", typ_kwargs={"flags": {"required": True, "secret": True}})
