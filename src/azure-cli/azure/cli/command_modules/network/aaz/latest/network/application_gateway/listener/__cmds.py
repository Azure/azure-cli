...
@register_command_group(
    "network application-gateway listener",
)
...
@register_command(
    "network application-gateway listener create",
)
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.frontend_ip = AAZStrArg(
            options=["--frontend-ip"],
            arg_group="Gateway",
            help="Name or ID of the frontend IP configuration. If only one exists, omit to use as default.",
        )
        ...
        _args_schema.ssl_cert = AAZStrArg(
            options=["--ssl-cert"],
            arg_group="Gateway",
            help="Name or ID of the SSL certificate to use.",
        )
        _args_schema.ssl_profile_id = AAZStrArg(
            options=["--ssl-profile-id"],
            arg_group="Gateway",
            help="Name or ID of the SSL profile to use.",
        )

        # define Arg Group "Parameters.properties.listeners[]"
    ...
    class SubresourceSelector(AAZJsonSelector):
        ...
        def _get(self):
            ...
            result = result.properties.listeners
    ...
    class InstanceCreateByJson(AAZJsonInstanceCreateOperation):
        ...
        def _create_instance(self):
            ...
            if ssl_certificate is not None:
                ssl_certificate.set_prop("id", AAZStrType, ".ssl_cert")

            ssl_profile = _builder.get(".properties.sslProfile")
            if ssl_profile is not None:
                ssl_profile.set_prop("id", AAZStrType, ".ssl_profile_id")

            return _instance_value


@register_command(
    "network application-gateway listener delete",
)
...
@register_command(
    "network application-gateway listener show",
)
class Show(AAZCommand):
    """Get the details of a listener.

    :example: Get the details of a listener.
...
@register_command(
    "network application-gateway listener update",
)
class Update(AAZCommand):
    """Update a listener.

    :example: Update a listener to use a different frontend port.
...
@register_command(
    "network application-gateway listener wait",
)
