...
@register_command(
    "search service network-security-perimeter-configuration list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.NetworkSecurityPerimeterConfigurationsListByService(ctx=self.ctx)()
    ...
    class NetworkSecurityPerimeterConfigurationsListByService(AAZHttpOperation):
