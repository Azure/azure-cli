...
class LiveOutput(ProxyResource):
    ...
    :vartype resource_state: str or ~encoding.models.LiveOutputResourceState
    """
    ...
    def __init__(self, description=None, asset_name=None, archive_window_length=None, manifest_name=None, hls=None, output_snap_time=None):
        super(LiveOutput, self).__init__()
