...
class VMGalleryImage(ScenarioTest):
    ...
    def test_gallery_image_version_vhd(self, resource_group):
        ...
        self.cmd('sig image-version create -g {rg} --gallery-name {gallery} --gallery-image-definition image1 --gallery-image-version 1.0.0 --vhd {vhd} --vhd-storage-account {stac} --replica-count 1', checks=[
