...
def load_arguments(self, _):
    ...
    for scope in ['identity federated-credential create', 'identity federated-credential update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('claims_matching_expression_language_version', type=int, options_list=['--cme-version'], help='The language version of the claims matching expression. Default is 1.')