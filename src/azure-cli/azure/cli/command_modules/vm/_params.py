...
def load_arguments(self, _):
    ...
    with self.argument_context('vmss create', arg_group='Network Balancer') as c:
        ...
        c.argument('nat_rule_name', help='Name to use for the NAT rule v2 when creating a new load balancer. (it is used to replace nat pool)', options_list=['--lb-nat-rule-name', '--nat-rule-name'])
