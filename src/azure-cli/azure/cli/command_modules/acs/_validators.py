...
def validate_azure_keyvault_kms_key_id(namespace):
    ...
    if key_id:
        ...
        err_msg = '--azure-keyvault-kms-key-id is not a valid Key Vault key ID. See https://learn.microsoft.com/azure/key-vault/general/about-keys-secrets-certificates#vault-name-and-object-name'
