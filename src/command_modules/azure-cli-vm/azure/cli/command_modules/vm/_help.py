...
examples:
  - name: Update a managed disk. (autogenerated)
    text: az disk update --name MyManagedDisk --resource-group MyResourceGroup --size-gb 10
    crafted: true
"""
...
examples:
  ...
  - name: Create a custom Virtual Machine Image from managed disks or snapshots. (autogenerated)
    text: az image create --name image1 --resource-group MyResourceGroup --source /subscriptions/db5eb68e-73e2-4fa8-b18a-0123456789999/resourceGroups/rg1/providers/Microsoft.Compute/snapshots/s1
    crafted: true
"""
...
examples:
  ...
  - name: create a gallery image definition (autogenerated)
    text: az sig image-definition create --gallery-image-definition MyImage --gallery-name MyGallery --offer GreatOffer --os-type linux --publisher GreatPublisher --resource-group MyResourceGroup --sku GreatSku
    crafted: true
"""
...
examples:
  ...
  - name: Create an Azure Availability Set. (autogenerated)
    text: az vm availability-set create --name MyAvSet --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: Delete a VM. (autogenerated)
    text: az vm delete --name MyVm --resource-group MyResourceGroup --yes
    crafted: true
"""
...
examples:
  ...
  - name: Attach a managed persistent disk to a VM. (autogenerated)
    text: az vm disk attach --resource-group MyResourceGroup --vm-name MyVm
    crafted: true
"""
...
examples:
  ...
  - name: Enable disk encryption on the OS disk and/or data disks. (autogenerated)
...
examples:
  ...
  - name: Set extensions for a VM. (autogenerated)
    text: "az vm extension set --name VMAccessForLinux --publisher Microsoft.OSTCExtensions --resource-group MyResourceGroup \\\n    --vm-name MyVm"
    crafted: true
parameters:
  - name: --name -n
    populator-commands:
...
examples:
  ...
  - name: List IP addresses associated with a VM
    text: az vm list-ip-addresses  --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: List available sizes for VMs. (autogenerated)
...
examples:
  ...
  - name: Execute a specific run command on a vm. (autogenerated)
    text: az vm run-command invoke --command-id RunShellScript --name MyVm --resource-group MyResourceGroup --scripts "sudo apt-get update && sudo apt-get install -y nginx"
    crafted: true
"""
...
examples:
  ...
  - name: Power off (stop) a running VM. (autogenerated)
    text: az vm stop --name MyVm --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  ...
  - name: List unmanaged disks of a VM. (autogenerated)
    text: az vm unmanaged-disk list --name MyVm --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Gets a list of all virtual machines in a VM scale sets. (autogenerated)
...
examples:
  - name: Change the number of VMs within a VMSS. (autogenerated)
    text: az vmss scale --name MyScaleSet --new-capacity 5 --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a VMSS. (autogenerated)
    text: az vmss update --name MyScaleSet --resource-group MyResourceGroup --set UpgradePolicy.AutomaticOSUpgradePolicy.EnableAutomaticOSUpgrade=true
    crafted: true
"""
...
examples:
  - name: Upgrade VMs within a VMSS. (autogenerated)
    text: az vmss update-instances --instance-ids 0 --name MyScaleSet --resource-group MyResourceGroup
    crafted: true
"""
